...
const string _CachePath = @".intermediate\OCCSharp\CastXml";
const string _WrapperBinPath = @"bin\{0}\WrapperGenerator.exe";
const string _WrapperProjectName = @"WrapperGenerator";
const string _TargetProjectName = @"OCCSharp";
const string _GeneratedSourcePath = @"Source\OCCSharp\Generated";
...
bool _GenerateWrapper()
{
    ...
    var solutionFile = Path.Combine(Common.GetRootFolder(), "RobotPlatform.Net.sln");
