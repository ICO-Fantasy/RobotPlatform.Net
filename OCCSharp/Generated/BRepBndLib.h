...
public ref class BRepBndLib sealed
    : public RDC::OCC::BaseClass<::BRepBndLib>
{
...
public:
    BRepBndLib(::BRepBndLib* nativeInstance)
        : RDC::OCC::BaseClass<::BRepBndLib>( nativeInstance, true )
    {}

    BRepBndLib(::BRepBndLib& nativeInstance)
        : RDC::OCC::BaseClass<::BRepBndLib>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void Add(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Bnd_Box^ B, bool useTriangulation);
    /// <summary>
    /// Adds the shape S to the bounding box B.
    /// More precisely are successively added to B:
    /// -   each face of S; the triangulation of the face is used if it exists,
    ...
    /// -   The resulting bounding box may be somewhat larger than the object.
    /// </summary>
    static void Add(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds the shape S to the bounding box B.
    ...
    /// </summary>
    static void AddClose(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds the shape S to the bounding box B.
    ...
    /// </summary>
    static void AddOptimal(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Bnd_Box^ B, bool useTriangulation, bool useShapeTolerance);
    /// <summary>
    /// Adds the shape S to the bounding box B.
    /// This algorithm builds precise bounding box,
    /// which differs from exact geometry boundaries of shape only on shape entities tolerances
    ...
    /// numerical calculation use tolerance Precision::Confusion().
    /// </summary>
    static void AddOptimal(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Bnd_Box^ B, bool useTriangulation);
    /// <summary>
    /// Adds the shape S to the bounding box B.
    /// This algorithm builds precise bounding box,
    /// which differs from exact geometry boundaries of shape only on shape entities tolerances
    ...
    /// numerical calculation use tolerance Precision::Confusion().
    /// </summary>
    static void AddOptimal(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    ...
    /// </summary>
    static void AddOBB(RDC::OCC::TopoDS_Shape^ theS, RDC::OCC::Bnd_OBB^ theOBB, bool theIsTriangulationUsed, bool theIsOptimal, bool theIsShapeToleranceUsed);
    /// <summary>
    /// Computes the Oriented Bounding box for the shape <theS>.
    /// Two independent methods of computation are implemented:
    /// first method based on set of points (so, it demands the
    ...
    /// OBB for the cost of performance or not.
    /// </summary>
    static void AddOBB(RDC::OCC::TopoDS_Shape^ theS, RDC::OCC::Bnd_OBB^ theOBB, bool theIsTriangulationUsed, bool theIsOptimal);
    /// <summary>
    /// Computes the Oriented Bounding box for the shape <theS>.
    /// Two independent methods of computation are implemented:
    /// first method based on set of points (so, it demands the
    ...
    /// OBB for the cost of performance or not.
    /// </summary>
    static void AddOBB(RDC::OCC::TopoDS_Shape^ theS, RDC::OCC::Bnd_OBB^ theOBB, bool theIsTriangulationUsed);
    /// <summary>
    /// Computes the Oriented Bounding box for the shape <theS>.
    /// Two independent methods of computation are implemented:
    /// first method based on set of points (so, it demands the
    ...
    /// OBB for the cost of performance or not.
    /// </summary>
    static void AddOBB(RDC::OCC::TopoDS_Shape^ theS, RDC::OCC::Bnd_OBB^ theOBB);
}; // class BRepBndLib
