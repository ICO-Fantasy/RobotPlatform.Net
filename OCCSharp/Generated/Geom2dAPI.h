...
public ref class Geom2dAPI_ExtremaCurveCurve sealed
    : public RDC::OCC::BaseClass<::Geom2dAPI_ExtremaCurveCurve>
{
...
public:
    Geom2dAPI_ExtremaCurveCurve(::Geom2dAPI_ExtremaCurveCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_ExtremaCurveCurve>( nativeInstance, true )
    {}

    Geom2dAPI_ExtremaCurveCurve(::Geom2dAPI_ExtremaCurveCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_ExtremaCurveCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dAPI_ExtremaCurveCurve(RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2, double U1min, double U1max, double U2min, double U2max);
    /// <summary>
    ...
    /// </summary>
    void Points(int Index, RDC::OCC::Pnt2d% P1, RDC::OCC::Pnt2d% P2);
    /// <summary>
    ...
    /// </summary>
    void NearestPoints(RDC::OCC::Pnt2d% P1, RDC::OCC::Pnt2d% P2);
    /// <summary>
    /// Returns the parameters U1 of the point on the first
    /// curve and U2 of the point on the second curve, which
...
public ref class Geom2dAPI_InterCurveCurve sealed
    : public RDC::OCC::BaseClass<::Geom2dAPI_InterCurveCurve>
{
...
public:
    Geom2dAPI_InterCurveCurve(::Geom2dAPI_InterCurveCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_InterCurveCurve>( nativeInstance, true )
    {}

    Geom2dAPI_InterCurveCurve(::Geom2dAPI_InterCurveCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_InterCurveCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dAPI_InterCurveCurve(RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2, double Tol);
    /// <summary>
    /// Creates an object and computes the
    /// intersections between the curves C1 and C2.
    /// </summary>
    Geom2dAPI_InterCurveCurve(RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2);
    /// <summary>
    ...
    /// NbSegments return 0.
    /// </summary>
    Geom2dAPI_InterCurveCurve(RDC::OCC::Geom2d_Curve^ C1, double Tol);
    /// <summary>
    /// Creates an object and computes self-intersections of the curve C1.
    /// Tolerance value Tol, defaulted to 1.0e-6, defines the precision of
    /// computing the intersection points.
    ...
    /// NbSegments return 0.
    /// </summary>
    Geom2dAPI_InterCurveCurve(RDC::OCC::Geom2d_Curve^ C1);
    /// <summary>
    /// Initializes an algorithm with the
    /// given arguments and computes the intersections between the curves C1. and C2.
    /// </summary>
    void Init(RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2, double Tol);
    /// <summary>
    /// Initializes an algorithm with the
    /// given arguments and computes the intersections between the curves C1. and C2.
    /// </summary>
    void Init(RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2);
    /// <summary>
    /// Initializes an algorithm with the
    ...
    /// </summary>
    void Init(RDC::OCC::Geom2d_Curve^ C1, double Tol);
    /// <summary>
    /// Initializes an algorithm with the
    /// given arguments and computes the self-intersections of the curve C1.
    /// Tolerance value Tol, defaulted to 1.0e-6, defines the precision of
    ...
    /// and NbSegments return 0.
    /// </summary>
    void Init(RDC::OCC::Geom2d_Curve^ C1);
    /// <summary>
    ...
    /// </summary>
    void Segment(int Index, RDC::OCC::Geom2d_Curve^ Curve1, RDC::OCC::Geom2d_Curve^ Curve2);
...
public ref class Geom2dAPI_Interpolate sealed
    : public RDC::OCC::BaseClass<::Geom2dAPI_Interpolate>
{
...
public:
    Geom2dAPI_Interpolate(::Geom2dAPI_Interpolate* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_Interpolate>( nativeInstance, true )
    {}

    Geom2dAPI_Interpolate(::Geom2dAPI_Interpolate& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_Interpolate>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dAPI_Interpolate(RDC::OCC::TColgp_HArray1OfPnt2d^ Points, bool PeriodicFlag, double Tolerance);
    /// <summary>
    /// if PeriodicFlag is True then the curve will be periodic
    /// Warning:
    ...
    /// </summary>
    Geom2dAPI_Interpolate(RDC::OCC::TColgp_HArray1OfPnt2d^ Points, RDC::OCC::TColStd_HArray1OfReal^ Parameters, bool PeriodicFlag, double Tolerance);
    /// <summary>
    ...
    /// </summary>
    void Load(RDC::OCC::Vec2d InitialTangent, RDC::OCC::Vec2d FinalTangent, bool Scale);
    /// <summary>
    /// Assigns this constrained BSpline curve to be
    /// tangential to vectors InitialTangent and FinalTangent
    /// at its first and last points respectively (i.e.
    ...
    /// be scaled according to derivatives of lagrange interpolation.
    /// </summary>
    void Load(RDC::OCC::Vec2d InitialTangent, RDC::OCC::Vec2d FinalTangent);
    /// <summary>
    /// Assigns this constrained BSpline curve to be
    ...
    /// be scaled according to derivatives of lagrange interpolation.
    /// </summary>
    void Load(RDC::OCC::TColgp_Array1OfVec2d^ Tangents, RDC::OCC::TColStd_HArray1OfBoolean^ TangentFlags, bool Scale);
    /// <summary>
    /// Assigns this constrained BSpline curve to be
    /// tangential to vectors defined in the table Tangents,
    /// which is parallel to the table of points
    ...
    /// be scaled according to derivatives of lagrange interpolation.
    /// </summary>
    void Load(RDC::OCC::TColgp_Array1OfVec2d^ Tangents, RDC::OCC::TColStd_HArray1OfBoolean^ TangentFlags);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_BSplineCurve^ Curve();
    /// <summary>
...
public ref class Geom2dAPI_PointsToBSpline sealed
    : public RDC::OCC::BaseClass<::Geom2dAPI_PointsToBSpline>
{
...
public:
    Geom2dAPI_PointsToBSpline(::Geom2dAPI_PointsToBSpline* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_PointsToBSpline>( nativeInstance, true )
    {}

    Geom2dAPI_PointsToBSpline(::Geom2dAPI_PointsToBSpline& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_PointsToBSpline>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol2D);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol2D);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX);
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol2D);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    ...
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3, int DegMax);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    Geom2dAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol2D);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, int DegMin);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol2D);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX, int DegMin);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  Of coordinates :
    /// 
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColStd_Array1OfReal^ YValues, double X0, double DX);
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol2D);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol2D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol2D);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3, int DegMax);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt2d^ Points, double Weight1, double Weight2, double Weight3);
    /// <summary>
...
public ref class Geom2dAPI_ProjectPointOnCurve sealed
    : public RDC::OCC::BaseClass<::Geom2dAPI_ProjectPointOnCurve>
{
...
public:
    Geom2dAPI_ProjectPointOnCurve(::Geom2dAPI_ProjectPointOnCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_ProjectPointOnCurve>( nativeInstance, true )
    {}

    Geom2dAPI_ProjectPointOnCurve(::Geom2dAPI_ProjectPointOnCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dAPI_ProjectPointOnCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// <Curve>
    /// </summary>
    Geom2dAPI_ProjectPointOnCurve(RDC::OCC::Pnt2d P, RDC::OCC::Geom2d_Curve^ Curve);
    /// <summary>
    /// Create  the projection  of a point <P>  on a curve
    ...
    /// </summary>
    Geom2dAPI_ProjectPointOnCurve(RDC::OCC::Pnt2d P, RDC::OCC::Geom2d_Curve^ Curve, double Umin, double Usup);
    /// <summary>
    /// Initializes this algorithm with the given arguments, and
    /// computes the orthogonal  projections  of a  point  <P> on a curve <Curve>
    /// </summary>
    void Init(RDC::OCC::Pnt2d P, RDC::OCC::Geom2d_Curve^ Curve);
    /// <summary>
    /// Initializes this algorithm with the given arguments, and
    ...
    /// </summary>
    void Init(RDC::OCC::Pnt2d P, RDC::OCC::Geom2d_Curve^ Curve, double Umin, double Usup);
    /// <summary>
