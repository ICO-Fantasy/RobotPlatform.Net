...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class ShapeUpgrade sealed
			: public RDC::OCC::BaseClass<::ShapeUpgrade>
		{
		...
		public:
			ShapeUpgrade(::ShapeUpgrade* nativeInstance)
				: RDC::OCC::BaseClass<::ShapeUpgrade>(nativeInstance, true)
			{}

			ShapeUpgrade(::ShapeUpgrade& nativeInstance)
				: RDC::OCC::BaseClass<::ShapeUpgrade>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			void Set(RDC::OCC::ShapeUpgrade_Tool^ tool);
			/// <summary>
			/// Sets context
			/// </summary>
			...
			static RDC::OCC::ShapeUpgrade_Tool^ CreateDowncasted(::ShapeUpgrade_Tool* instance);
		}; // class ShapeUpgrade_Tool
		...
		public:
			...
			/// </summary>
			void SetSplitValues(RDC::OCC::TColStd_HSequenceOfReal^ SplitValues);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TColStd_HSequenceOfReal^ SplitValues();
			/// <summary>
			...
			static RDC::OCC::ShapeUpgrade_SplitCurve^ CreateDowncasted(::ShapeUpgrade_SplitCurve* instance);
		}; // class ShapeUpgrade_SplitCurve
		...
		public ref class ShapeUpgrade_SplitCurve2d
			: public RDC::OCC::ShapeUpgrade_SplitCurve
		{
		...
		protected:
			ShapeUpgrade_SplitCurve2d(InitMode init)
				: RDC::OCC::ShapeUpgrade_SplitCurve(init)
			{}

		public:
			ShapeUpgrade_SplitCurve2d(::ShapeUpgrade_SplitCurve2d* nativeInstance)
				: RDC::OCC::ShapeUpgrade_SplitCurve(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			void Init(RDC::OCC::Geom2d_Curve^ C, double First, double Last);
			/// <summary>
			/// If Segment is True, the result is composed with
			/// segments of the curve bounded by the SplitValues.  If
			/// Segment is False, the result is composed with trimmed
			...
			static RDC::OCC::ShapeUpgrade_SplitCurve2d^ CreateDowncasted(::ShapeUpgrade_SplitCurve2d* instance);
		}; // class ShapeUpgrade_SplitCurve2d
		...
		public ref class ShapeUpgrade_EdgeDivide
			: public RDC::OCC::ShapeUpgrade_Tool
		{
		...
		protected:
			ShapeUpgrade_EdgeDivide(InitMode init)
				: RDC::OCC::ShapeUpgrade_Tool(init)
			{}

		public:
			ShapeUpgrade_EdgeDivide(::ShapeUpgrade_EdgeDivide* nativeInstance)
				: RDC::OCC::ShapeUpgrade_Tool(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			void SetFace(RDC::OCC::TopoDS_Face^ F);
			bool Compute(RDC::OCC::TopoDS_Edge^ E);
			bool HasCurve2d();
			bool HasCurve3d();
			RDC::OCC::TColStd_HSequenceOfReal^ Knots2d();
			RDC::OCC::TColStd_HSequenceOfReal^ Knots3d();
			/// <summary>
			/// Sets the tool for splitting pcurves.
			/// </summary>
			void SetSplitCurve2dTool(RDC::OCC::ShapeUpgrade_SplitCurve2d^ splitCurve2dTool);
			/// <summary>
			/// Sets the tool for splitting 3D curves.
			/// </summary>
			void SetSplitCurve3dTool(RDC::OCC::ShapeUpgrade_SplitCurve3d^ splitCurve3dTool);
			/// <summary>
			/// Returns the tool for splitting pcurves.
			/// </summary>
			RDC::OCC::ShapeUpgrade_SplitCurve2d^ GetSplitCurve2dTool();
			/// <summary>
			/// Returns the tool for splitting 3D curves.
			/// </summary>
			RDC::OCC::ShapeUpgrade_SplitCurve3d^ GetSplitCurve3dTool();
			static RDC::OCC::ShapeUpgrade_EdgeDivide^ CreateDowncasted(::ShapeUpgrade_EdgeDivide* instance);
		}; // class ShapeUpgrade_EdgeDivide
		...
		public ref class ShapeUpgrade_ClosedEdgeDivide sealed
			: public RDC::OCC::ShapeUpgrade_EdgeDivide
		{
		...
		public:
			ShapeUpgrade_ClosedEdgeDivide(::ShapeUpgrade_ClosedEdgeDivide* nativeInstance)
				: RDC::OCC::ShapeUpgrade_EdgeDivide(nativeInstance)
			{}
		...
		public:
			...
			bool Compute(RDC::OCC::TopoDS_Edge^ anEdge);
			static RDC::OCC::ShapeUpgrade_ClosedEdgeDivide^ CreateDowncasted(::ShapeUpgrade_ClosedEdgeDivide* instance);
		}; // class ShapeUpgrade_ClosedEdgeDivide
		...
		public:
			...
			/// </summary>
			void Init(RDC::OCC::Geom_Surface^ S, double UFirst, double ULast, double VFirst, double VLast, double theArea);
			/// <summary>
			/// Initializes with single supporting surface with bounding parameters.
			/// </summary>
			void Init(RDC::OCC::Geom_Surface^ S, double UFirst, double ULast, double VFirst, double VLast);
			/// <summary>
			/// Sets U parameters where splitting has to be done
			/// </summary>
			void SetUSplitValues(RDC::OCC::TColStd_HSequenceOfReal^ UValues);
			/// <summary>
			/// Sets V parameters where splitting has to be done
			/// </summary>
			void SetVSplitValues(RDC::OCC::TColStd_HSequenceOfReal^ VValues);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TColStd_HSequenceOfReal^ USplitValues();
			/// <summary>
			/// returns all the splitting V values including the
			/// First and Last parameters of the input surface
			/// </summary>
			RDC::OCC::TColStd_HSequenceOfReal^ VSplitValues();
			/* Method skipped due to unknown mapping: bool Status(ShapeExtend_Status status, ) */
			/* Method skipped due to unknown mapping: ShapeExtend_CompositeSurface ResSurfaces() */
			static RDC::OCC::ShapeUpgrade_SplitSurface^ CreateDowncasted(::ShapeUpgrade_SplitSurface* instance);
		}; // class ShapeUpgrade_SplitSurface
		...
		public:
			...
			/// </summary>
			void Init(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::Geom_Surface^ S);
			/// <summary>
			/// Loads working wire
			/// </summary>
			void Load(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Creates wire of one edge and calls Load for wire
			/// </summary>
			void Load(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			/// Sets supporting surface by face
			/// </summary>
			void SetFace(RDC::OCC::TopoDS_Face^ F);
			...
			/// </summary>
			void SetSurface(RDC::OCC::Geom_Surface^ S);
			/// <summary>
			/// Sets supporting surface with location
			/// </summary>
			void SetSurface(RDC::OCC::Geom_Surface^ S, RDC::OCC::TopLoc_Location^ L);
			/// <summary>
			...
			/// </summary>
			void SetEdgeDivideTool(RDC::OCC::ShapeUpgrade_EdgeDivide^ edgeDivideTool);
			/// <summary>
			/// returns tool for splitting edges
			/// </summary>
			RDC::OCC::ShapeUpgrade_EdgeDivide^ GetEdgeDivideTool();
			/// <summary>
			...
			/// </summary>
			void SetFixSmallCurveTool(RDC::OCC::ShapeUpgrade_FixSmallCurves^ FixSmallCurvesTool);
			/// <summary>
			/// Returns tool for fixing small curves
			/// </summary>
			RDC::OCC::ShapeUpgrade_FixSmallCurves^ GetFixSmallCurveTool();
			static RDC::OCC::ShapeUpgrade_WireDivide^ CreateDowncasted(::ShapeUpgrade_WireDivide* instance);
		}; // class ShapeUpgrade_WireDivide
		...
		public:
			...
			/// </summary>
			ShapeUpgrade_FaceDivide(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Initialize by a Face.
			/// </summary>
			...
			/// </summary>
			void SetSplitSurfaceTool(RDC::OCC::ShapeUpgrade_SplitSurface^ splitSurfaceTool);
			/// <summary>
			/// Sets the tool for dividing edges on Face.
			/// </summary>
			void SetWireDivideTool(RDC::OCC::ShapeUpgrade_WireDivide^ wireDivideTool);
			/// <summary>
			/// Returns the tool for splitting surfaces.
			/// This tool must be already initialized.
			/// </summary>
			RDC::OCC::ShapeUpgrade_SplitSurface^ GetSplitSurfaceTool();
			/// <summary>
			/// Returns the tool for dividing edges on Face.
			/// This tool must be already initialized.
			/// </summary>
			RDC::OCC::ShapeUpgrade_WireDivide^ GetWireDivideTool();
			static RDC::OCC::ShapeUpgrade_FaceDivide^ CreateDowncasted(::ShapeUpgrade_FaceDivide* instance);
		}; // class ShapeUpgrade_FaceDivide
		...
		public ref class ShapeUpgrade_ClosedFaceDivide sealed
			: public RDC::OCC::ShapeUpgrade_FaceDivide
		{
		...
		public:
			ShapeUpgrade_ClosedFaceDivide(::ShapeUpgrade_ClosedFaceDivide* nativeInstance)
				: RDC::OCC::ShapeUpgrade_FaceDivide(nativeInstance)
			{}
		...
		public:
			...
			/// Initialize by a Face.
			/// </summary>
			ShapeUpgrade_ClosedFaceDivide(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Performs splitting of surface and computes the shell
			/// from source face.
			/// </summary>
			...
			static RDC::OCC::ShapeUpgrade_ClosedFaceDivide^ CreateDowncasted(::ShapeUpgrade_ClosedFaceDivide* instance);
		}; // class ShapeUpgrade_ClosedFaceDivide
		...
		public:
			...
			/// </summary>
			void Init(RDC::OCC::Geom_Curve^ C, double First, double Last);
			/// <summary>
			/// If Segment is True, the result is composed with
			/// segments of the curve bounded by the SplitValues.  If
			/// Segment is False, the result is composed with trimmed
			...
			static RDC::OCC::ShapeUpgrade_SplitCurve3d^ CreateDowncasted(::ShapeUpgrade_SplitCurve3d* instance);
		}; // class ShapeUpgrade_SplitCurve3d
		...
		public ref class ShapeUpgrade_ConvertCurve2dToBezier sealed
			: public RDC::OCC::ShapeUpgrade_SplitCurve2d
		{
		...
		public:
			ShapeUpgrade_ConvertCurve2dToBezier(::ShapeUpgrade_ConvertCurve2dToBezier* nativeInstance)
				: RDC::OCC::ShapeUpgrade_SplitCurve2d(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			RDC::OCC::TColStd_HSequenceOfReal^ SplitParams();
			static RDC::OCC::ShapeUpgrade_ConvertCurve2dToBezier^ CreateDowncasted(::ShapeUpgrade_ConvertCurve2dToBezier* instance);
		}; // class ShapeUpgrade_ConvertCurve2dToBezier
		...
		public ref class ShapeUpgrade_ConvertCurve3dToBezier sealed
			: public RDC::OCC::ShapeUpgrade_SplitCurve3d
		{
		...
		public:
			ShapeUpgrade_ConvertCurve3dToBezier(::ShapeUpgrade_ConvertCurve3dToBezier* nativeInstance)
				: RDC::OCC::ShapeUpgrade_SplitCurve3d(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			RDC::OCC::TColStd_HSequenceOfReal^ SplitParams();
			static RDC::OCC::ShapeUpgrade_ConvertCurve3dToBezier^ CreateDowncasted(::ShapeUpgrade_ConvertCurve3dToBezier* instance);
		}; // class ShapeUpgrade_ConvertCurve3dToBezier
		...
		public ref class ShapeUpgrade_ConvertSurfaceToBezierBasis sealed
			: public RDC::OCC::ShapeUpgrade_SplitSurface
		{
		...
		public:
			ShapeUpgrade_ConvertSurfaceToBezierBasis(::ShapeUpgrade_ConvertSurfaceToBezierBasis* nativeInstance)
				: RDC::OCC::ShapeUpgrade_SplitSurface(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			bool GetBSplineMode();
			static RDC::OCC::ShapeUpgrade_ConvertSurfaceToBezierBasis^ CreateDowncasted(::ShapeUpgrade_ConvertSurfaceToBezierBasis* instance);
		}; // class ShapeUpgrade_ConvertSurfaceToBezierBasis
		...
		public:
			...
			ShapeUpgrade_FaceDivideArea(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Performs splitting and computes the resulting shell
			/// The context is used to keep track of former splittings
			/// </summary>
			...
			static RDC::OCC::ShapeUpgrade_FaceDivideArea^ CreateDowncasted(::ShapeUpgrade_FaceDivideArea* instance);
		}; // class ShapeUpgrade_FaceDivideArea
		...
		public:
			...
			bool Approx(RDC::OCC::Geom_Curve^ Curve3d, RDC::OCC::Geom2d_Curve^ Curve2d, RDC::OCC::Geom2d_Curve^ Curve2dR, double% First, double% Last);
			/// <summary>
			/// Sets the tool for splitting 3D curves.
			/// </summary>
			void SetSplitCurve3dTool(RDC::OCC::ShapeUpgrade_SplitCurve3d^ splitCurve3dTool);
			...
			void SetSplitCurve2dTool(RDC::OCC::ShapeUpgrade_SplitCurve2d^ splitCurve2dTool);
			/* Method skipped due to unknown mapping: bool Status(ShapeExtend_Status status, ) */
			static RDC::OCC::ShapeUpgrade_FixSmallCurves^ CreateDowncasted(::ShapeUpgrade_FixSmallCurves* instance);
		}; // class ShapeUpgrade_FixSmallCurves
		...
		public ref class ShapeUpgrade_FixSmallBezierCurves sealed
			: public RDC::OCC::ShapeUpgrade_FixSmallCurves
		{
		...
		public:
			ShapeUpgrade_FixSmallBezierCurves(::ShapeUpgrade_FixSmallBezierCurves* nativeInstance)
				: RDC::OCC::ShapeUpgrade_FixSmallCurves(nativeInstance)
			{}
		...
		public:
			...
			bool Approx(RDC::OCC::Geom_Curve^ Curve3d, RDC::OCC::Geom2d_Curve^ Curve2d, RDC::OCC::Geom2d_Curve^ Curve2dR, double% First, double% Last);
			static RDC::OCC::ShapeUpgrade_FixSmallBezierCurves^ CreateDowncasted(::ShapeUpgrade_FixSmallBezierCurves* instance);
		}; // class ShapeUpgrade_FixSmallBezierCurves
		...
		public:
			...
			ShapeUpgrade_RemoveInternalWires(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// Initialize by a Shape.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			...
			/// </summary>
			bool Perform(RDC::OCC::TopTools_SequenceOfShape^ theSeqShapes);
			/// <summary>
			/// Get result shape
			/// </summary>
			...
			/// </summary>
			RDC::OCC::TopTools_SequenceOfShape^ RemovedFaces();
			/// <summary>
			/// Returns sequence of removed faces.
			/// </summary>
			RDC::OCC::TopTools_SequenceOfShape^ RemovedWires();
			/* Method skipped due to unknown mapping: bool Status(ShapeExtend_Status theStatus, ) */
			static RDC::OCC::ShapeUpgrade_RemoveInternalWires^ CreateDowncasted(::ShapeUpgrade_RemoveInternalWires* instance);
		}; // class ShapeUpgrade_RemoveInternalWires
		...
		public:
			...
			/// </summary>
			bool Remove(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			...
			/// </summary>
			void SetRemoveLevel(RDC::OCC::TopAbs_ShapeEnum theLevel);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopAbs_ShapeEnum RemoveLevel();
			/// <summary>
			/// Returns modified shape obtained from initial shape.
			/// </summary>
			RDC::OCC::TopoDS_Shape^ ModifiedShape(RDC::OCC::TopoDS_Shape^ theInitShape);
			static RDC::OCC::ShapeUpgrade_RemoveLocations^ CreateDowncasted(::ShapeUpgrade_RemoveLocations* instance);
		}; // class ShapeUpgrade_RemoveLocations
		...
		public ref class ShapeUpgrade_ShapeDivide
			: public RDC::OCC::BaseClass<::ShapeUpgrade_ShapeDivide>
		{
		...
		protected:
			ShapeUpgrade_ShapeDivide(InitMode init)
				: RDC::OCC::BaseClass<::ShapeUpgrade_ShapeDivide>(init)
			{}

		public:
			ShapeUpgrade_ShapeDivide(::ShapeUpgrade_ShapeDivide* nativeInstance)
				: RDC::OCC::BaseClass<::ShapeUpgrade_ShapeDivide>(nativeInstance, true)
			{}

			ShapeUpgrade_ShapeDivide(::ShapeUpgrade_ShapeDivide& nativeInstance)
				: RDC::OCC::BaseClass<::ShapeUpgrade_ShapeDivide>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// Initialize by a Shape.
			/// </summary>
			ShapeUpgrade_ShapeDivide(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Initialize by a Shape.
			/// </summary>
			...
			/// </summary>
			RDC::OCC::ShapeBuild_ReShape^ GetContext();
			/// <summary>
			...
			/// </summary>
			void SetSplitFaceTool(RDC::OCC::ShapeUpgrade_FaceDivide^ splitFaceTool);
			/// <summary>
			/// Sets mode for splitting 3d curves from edges.
			/// 0 - only curve 3d from free edges.
			/// 1 - only curve 3d from shared edges.
		...
		public ref class ShapeUpgrade_ShapeConvertToBezier sealed
			: public RDC::OCC::ShapeUpgrade_ShapeDivide
		{
		...
		public:
			ShapeUpgrade_ShapeConvertToBezier(::ShapeUpgrade_ShapeConvertToBezier* nativeInstance)
				: RDC::OCC::ShapeUpgrade_ShapeDivide(nativeInstance)
			{}
		...
		public:
			...
			/// Initialize by a Shape.
			/// </summary>
			ShapeUpgrade_ShapeConvertToBezier(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
		...
		public:
			...
			/// Initialize by a Shape.
			/// </summary>
			ShapeUpgrade_ShapeDivideAngle(double MaxAngle, RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
		...
		public:
			...
			/// Initialize by a Shape.
			/// </summary>
			ShapeUpgrade_ShapeDivideArea(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Set fixed numbers of splits in U and V directions.
			/// Only for "Splitting By Numbers" mode
			/// </summary>
		...
		public:
			...
			/// </summary>
			ShapeUpgrade_ShapeDivideClosed(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
		...
		public:
			...
			/// Initialises tool with shape and default parameter.
			/// </summary>
			ShapeUpgrade_ShapeDivideClosedEdges(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
		...
		public:
			...
			/// Initialize by a Shape.
			/// </summary>
			ShapeUpgrade_ShapeDivideContinuity(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Sets tolerance.
			/// </summary>
			...
			/// </summary>
			void SetBoundaryCriterion(RDC::OCC::GeomAbs_Shape Criterion);
			/// <summary>
			/// Defines a criterion of continuity for the boundary (all the
			/// Wires)
			/// 
			...
			/// and G2 are not authorized.
			/// </summary>
			void SetPCurveCriterion(RDC::OCC::GeomAbs_Shape Criterion);
			/// <summary>
			/// Defines a criterion of continuity for the boundary (all the
			/// pcurves of Wires)
			/// 
			...
			/// and G2 are not authorized.
			/// </summary>
			void SetSurfaceCriterion(RDC::OCC::GeomAbs_Shape Criterion);
			/// <summary>
			/// Defines a criterion of continuity for the boundary (all the
			/// Wires)
			/// 
		...
		public ref class ShapeUpgrade_ShellSewing sealed
			: public RDC::OCC::BaseClass<::ShapeUpgrade_ShellSewing>
		{
		...
		public:
			ShapeUpgrade_ShellSewing(::ShapeUpgrade_ShellSewing* nativeInstance)
				: RDC::OCC::BaseClass<::ShapeUpgrade_ShellSewing>(nativeInstance, true)
			{}

			ShapeUpgrade_ShellSewing(::ShapeUpgrade_ShellSewing& nativeInstance)
				: RDC::OCC::BaseClass<::ShapeUpgrade_ShellSewing>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// shape
			/// </summary>
			RDC::OCC::TopoDS_Shape^ ApplySewing(RDC::OCC::TopoDS_Shape^ shape, double tol);
			/// <summary>
			/// Builds a new shape from a former one, by calling Sewing from
			/// BRepBuilderAPI. Rebuilt solids are oriented to be "not infinite"
			/// 
			...
			/// shape
			/// </summary>
			RDC::OCC::TopoDS_Shape^ ApplySewing(RDC::OCC::TopoDS_Shape^ shape);
		}; // class ShapeUpgrade_ShellSewing
		...
		public:
			...
			/// </summary>
			void SetCriterion(RDC::OCC::GeomAbs_Shape Criterion);
			/// <summary>
			/// Sets tolerance.
			/// </summary>
			void SetTolerance(double Tol);
			...
			/// </summary>
			void Compute();
			static RDC::OCC::ShapeUpgrade_SplitCurve2dContinuity^ CreateDowncasted(::ShapeUpgrade_SplitCurve2dContinuity* instance);
		}; // class ShapeUpgrade_SplitCurve2dContinuity
		...
		public:
			...
			/// </summary>
			void Compute();
			RDC::OCC::Geom_Curve^ GetCurve();
			static RDC::OCC::ShapeUpgrade_SplitCurve3dContinuity^ CreateDowncasted(::ShapeUpgrade_SplitCurve3dContinuity* instance);
		}; // class ShapeUpgrade_SplitCurve3dContinuity
		...
		public:
			...
			/// </summary>
			void Compute(bool Segment);
			static RDC::OCC::ShapeUpgrade_SplitSurfaceAngle^ CreateDowncasted(::ShapeUpgrade_SplitSurfaceAngle* instance);
		}; // class ShapeUpgrade_SplitSurfaceAngle
		...
		public:
			...
			void Compute(bool Segment);
			void Compute();
			static RDC::OCC::ShapeUpgrade_SplitSurfaceArea^ CreateDowncasted(::ShapeUpgrade_SplitSurfaceArea* instance);
		}; // class ShapeUpgrade_SplitSurfaceArea
		...
		public:
			...
			void SetTolerance(double Tol);
			void Compute(bool Segment);
			static RDC::OCC::ShapeUpgrade_SplitSurfaceContinuity^ CreateDowncasted(::ShapeUpgrade_SplitSurfaceContinuity* instance);
		}; // class ShapeUpgrade_SplitSurfaceContinuity
		...
		public:
			...
			/// </summary>
			ShapeUpgrade_UnifySameDomain(RDC::OCC::TopoDS_Shape^ aShape, bool UnifyEdges, bool UnifyFaces, bool ConcatBSplines);
			/// <summary>
			/// Constructor defining input shape and necessary flags.
			/// It does not perform unification.
			/// </summary>
			ShapeUpgrade_UnifySameDomain(RDC::OCC::TopoDS_Shape^ aShape, bool UnifyEdges, bool UnifyFaces);
			/// <summary>
			/// Constructor defining input shape and necessary flags.
			/// It does not perform unification.
			/// </summary>
			ShapeUpgrade_UnifySameDomain(RDC::OCC::TopoDS_Shape^ aShape, bool UnifyEdges);
			/// <summary>
			/// Constructor defining input shape and necessary flags.
			/// It does not perform unification.
			/// </summary>
			ShapeUpgrade_UnifySameDomain(RDC::OCC::TopoDS_Shape^ aShape);
			/// <summary>
			...
			/// initialization.
			/// </summary>
			void Initialize(RDC::OCC::TopoDS_Shape^ aShape, bool UnifyEdges, bool UnifyFaces, bool ConcatBSplines);
			/// <summary>
			/// Initializes with a shape and necessary flags.
			/// It does not perform unification.
			/// If you intend to nullify the History place holder do it after
			/// initialization.
			/// </summary>
			void Initialize(RDC::OCC::TopoDS_Shape^ aShape, bool UnifyEdges, bool UnifyFaces);
			/// <summary>
			/// Initializes with a shape and necessary flags.
			/// It does not perform unification.
			/// If you intend to nullify the History place holder do it after
			/// initialization.
			/// </summary>
			void Initialize(RDC::OCC::TopoDS_Shape^ aShape, bool UnifyEdges);
			/// <summary>
			/// Initializes with a shape and necessary flags.
			/// It does not perform unification.
			/// If you intend to nullify the History place holder do it after
			/// initialization.
			/// </summary>
			void Initialize(RDC::OCC::TopoDS_Shape^ aShape);
			/// <summary>
			...
			/// </summary>
			void KeepShape(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			...
			/// </summary>
			void KeepShapes(RDC::OCC::TopTools_MapOfShape^ theShapes);
			/// <summary>
			...
			static RDC::OCC::ShapeUpgrade_UnifySameDomain^ CreateDowncasted(::ShapeUpgrade_UnifySameDomain* instance);
		}; // class ShapeUpgrade_UnifySameDomain
