...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class NCollection_CellFilter_InspectorXYZ sealed
			: public RDC::OCC::BaseClass<::NCollection_CellFilter_InspectorXYZ>
		{
		...
		public:
			NCollection_CellFilter_InspectorXYZ(::NCollection_CellFilter_InspectorXYZ* nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_CellFilter_InspectorXYZ>(nativeInstance, true)
			{}

			NCollection_CellFilter_InspectorXYZ(::NCollection_CellFilter_InspectorXYZ& nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_CellFilter_InspectorXYZ>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			static double Coord(int i, RDC::OCC::XYZ thePnt);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::XYZ Shift(RDC::OCC::XYZ thePnt, double theTol);
		}; // class NCollection_CellFilter_InspectorXYZ
		...
		public ref class NCollection_CellFilter_InspectorXY sealed
			: public RDC::OCC::BaseClass<::NCollection_CellFilter_InspectorXY>
		{
		...
		public:
			NCollection_CellFilter_InspectorXY(::NCollection_CellFilter_InspectorXY* nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_CellFilter_InspectorXY>(nativeInstance, true)
			{}

			NCollection_CellFilter_InspectorXY(::NCollection_CellFilter_InspectorXY& nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_CellFilter_InspectorXY>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// 获取坐标系
			/// </summary>
			static double Coord(int i, RDC::OCC::XY thePnt);
			/// <summary>
			/// 将点按给定值在每个坐标上进行移动的辅助方法;
			/// 对于准备带有容差的点范围以进行检查非常有用
			/// </summary>
			RDC::OCC::XY Shift(RDC::OCC::XY thePnt, double theTol);
		}; // class NCollection_CellFilter_InspectorXY
		...
		public:
			...
			/// </summary>
			static RDC::OCC::NCollection_BaseAllocator^ CommonBaseAllocator();
			static RDC::OCC::NCollection_BaseAllocator^ CreateDowncasted(::NCollection_BaseAllocator* instance);
		}; // class NCollection_BaseAllocator
		...
		public ref class NCollection_BaseList
			: public RDC::OCC::BaseClass<::NCollection_BaseList>
		{
		...
		protected:
			NCollection_BaseList(InitMode init)
				: RDC::OCC::BaseClass<::NCollection_BaseList>(init)
			{}

		public:
			NCollection_BaseList(::NCollection_BaseList* nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_BaseList>(nativeInstance, true)
			{}

			NCollection_BaseList(::NCollection_BaseList& nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_BaseList>(&nativeInstance, false)
			{}
		...
		public:
			...
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::NCollection_BaseList::Iterator>
			{
			...
			public:
				Iterator(::NCollection_BaseList::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::NCollection_BaseList::Iterator>(nativeInstance, true)
				{}

				Iterator(::NCollection_BaseList::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::NCollection_BaseList::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				Iterator();
				Iterator(RDC::OCC::NCollection_BaseList^ theList);
				void Init(RDC::OCC::NCollection_BaseList^ theList);
				void Initialize(RDC::OCC::NCollection_BaseList^ theList);
				bool More();
				/// <summary>
				/// Performs comparison of two iterators
				/// </summary>
				bool IsEqual(RDC::OCC::NCollection_BaseList::Iterator^ theOther);
		...
		public ref class NCollection_BasePointerVector sealed
			: public RDC::OCC::BaseClass<::NCollection_BasePointerVector>
		{
		...
		public:
			NCollection_BasePointerVector(::NCollection_BasePointerVector* nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_BasePointerVector>(nativeInstance, true)
			{}

			NCollection_BasePointerVector(::NCollection_BasePointerVector& nativeInstance)
				: RDC::OCC::BaseClass<::NCollection_BasePointerVector>(&nativeInstance, false)
			{}
		...
		public ref class NCollection_AccAllocator sealed
			: public RDC::OCC::NCollection_BaseAllocator
		{
		...
		public:
			NCollection_AccAllocator(::NCollection_AccAllocator* nativeInstance)
				: RDC::OCC::NCollection_BaseAllocator(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			void Free(System::IntPtr theAddress);
			static RDC::OCC::NCollection_AccAllocator^ CreateDowncasted(::NCollection_AccAllocator* instance);
		}; // class NCollection_AccAllocator
		...
		public:
			...
			static RDC::OCC::NCollection_AlignedAllocator^ CreateDowncasted(::NCollection_AlignedAllocator* instance);
		}; // class NCollection_AlignedAllocator
		...
		public:
			...
			/// </param>
			NCollection_Buffer(RDC::OCC::NCollection_BaseAllocator^ theAlloc, long long unsigned int theSize, unsigned char% theData);
			/// <summary>
			/// Default constructor.
			/// When theData is NULL but theSize is not 0 than buffer of specified size will be allocated.
			/// </summary>
			...
			///  buffer data allocated by theAlloc
			/// </param>
			NCollection_Buffer(RDC::OCC::NCollection_BaseAllocator^ theAlloc, long long unsigned int theSize);
			/// <summary>
			/// Default constructor.
			/// When theData is NULL but theSize is not 0 than buffer of specified size will be allocated.
			/// </summary>
			...
			///  buffer data allocated by theAlloc
			/// </param>
			NCollection_Buffer(RDC::OCC::NCollection_BaseAllocator^ theAlloc);
			/// <summary>
			/// </summary>
			/// <returns>
			/// buffer data
			...
			/// </summary>
			void SetAllocator(RDC::OCC::NCollection_BaseAllocator^ theAlloc);
			/// <summary>
			/// Allocate the buffer.
			/// </summary>
			/// <param name="theSize">
			...
			static RDC::OCC::NCollection_Buffer^ CreateDowncasted(::NCollection_Buffer* instance);
		}; // class NCollection_Buffer
		...
		public:
			...
			/// for future allocations.
			void Reset();
			static RDC::OCC::NCollection_IncAllocator^ CreateDowncasted(::NCollection_IncAllocator* instance);
		}; // class NCollection_IncAllocator
		...
		public:
			...
			static RDC::OCC::NCollection_HeapAllocator^ GlobalHeapAllocator();
			static RDC::OCC::NCollection_HeapAllocator^ CreateDowncasted(::NCollection_HeapAllocator* instance);
		}; // class NCollection_HeapAllocator
		...
		public:
			...
			/// </summary>
			void Free(System::IntPtr theAddress);
			static RDC::OCC::NCollection_WinHeapAllocator^ CreateDowncasted(::NCollection_WinHeapAllocator* instance);
		}; // class NCollection_WinHeapAllocator
