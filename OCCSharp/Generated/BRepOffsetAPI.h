...
public ref class BRepOffsetAPI_SequenceOfSequenceOfShape sealed
    : public RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfShape>
    , public IIndexEnumerable<RDC::OCC::TopTools_SequenceOfShape^>
{
...
public:
    BRepOffsetAPI_SequenceOfSequenceOfShape(::BRepOffsetAPI_SequenceOfSequenceOfShape* nativeInstance)
        : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfShape>( nativeInstance, true )
    {}

    BRepOffsetAPI_SequenceOfSequenceOfShape(::BRepOffsetAPI_SequenceOfSequenceOfShape& nativeInstance)
        : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfShape>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator>
    {
    ...
    public:
        Iterator(::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator>( nativeInstance, true )
        {}

        Iterator(::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool IsEqual(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    BRepOffsetAPI_SequenceOfSequenceOfShape();
    BRepOffsetAPI_SequenceOfSequenceOfShape(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfShape^ Assign(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfShape^ theOther);
    void Remove(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator^ thePosition);
    void Append(RDC::OCC::TopTools_SequenceOfShape^ theItem);
    void Prepend(RDC::OCC::TopTools_SequenceOfShape^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::TopTools_SequenceOfShape^ theItem);
    void InsertAfter(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfShape::Iterator^ thePosition, RDC::OCC::TopTools_SequenceOfShape^ theItem);
    void Split(int theIndex, RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfShape^ theSeq);
    RDC::OCC::TopTools_SequenceOfShape^ First();
    RDC::OCC::TopTools_SequenceOfShape^ ChangeFirst();
    RDC::OCC::TopTools_SequenceOfShape^ Last();
    RDC::OCC::TopTools_SequenceOfShape^ ChangeLast();
    virtual RDC::OCC::TopTools_SequenceOfShape^ Value(int theIndex);
    RDC::OCC::TopTools_SequenceOfShape^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::TopTools_SequenceOfShape^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::TopTools_SequenceOfShape^>^ GetEnumerator();
...
public ref class BRepOffsetAPI_SequenceOfSequenceOfReal sealed
    : public RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfReal>
    , public IIndexEnumerable<RDC::OCC::TColStd_SequenceOfReal^>
{
...
public:
    BRepOffsetAPI_SequenceOfSequenceOfReal(::BRepOffsetAPI_SequenceOfSequenceOfReal* nativeInstance)
        : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfReal>( nativeInstance, true )
    {}

    BRepOffsetAPI_SequenceOfSequenceOfReal(::BRepOffsetAPI_SequenceOfSequenceOfReal& nativeInstance)
        : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfReal>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator>
    {
    ...
    public:
        Iterator(::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::TColStd_SequenceOfReal^ Value();
        RDC::OCC::TColStd_SequenceOfReal^ ChangeValue();
        bool IsEqual(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    BRepOffsetAPI_SequenceOfSequenceOfReal();
    BRepOffsetAPI_SequenceOfSequenceOfReal(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfReal^ Assign(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfReal^ theOther);
    void Remove(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator^ thePosition);
    void Append(RDC::OCC::TColStd_SequenceOfReal^ theItem);
    void Prepend(RDC::OCC::TColStd_SequenceOfReal^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::TColStd_SequenceOfReal^ theItem);
    void InsertAfter(RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfReal::Iterator^ thePosition, RDC::OCC::TColStd_SequenceOfReal^ theItem);
    void Split(int theIndex, RDC::OCC::BRepOffsetAPI_SequenceOfSequenceOfReal^ theSeq);
    RDC::OCC::TColStd_SequenceOfReal^ First();
    RDC::OCC::TColStd_SequenceOfReal^ ChangeFirst();
    RDC::OCC::TColStd_SequenceOfReal^ Last();
    RDC::OCC::TColStd_SequenceOfReal^ ChangeLast();
    virtual RDC::OCC::TColStd_SequenceOfReal^ Value(int theIndex);
    RDC::OCC::TColStd_SequenceOfReal^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::TColStd_SequenceOfReal^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::TColStd_SequenceOfReal^>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class BRepOffsetAPI_SequenceOfSequenceOfReal
...
public:
    ...
    /// </summary>
    BRepOffsetAPI_DraftAngle(RDC::OCC::TopoDS_Shape^ S);
    /// <summary>
    ...
    /// </summary>
    void Add(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Dir Direction, double Angle, RDC::OCC::Pln NeutralPlane, bool Flag);
    /// <summary>
    /// Adds the face F, the direction
    /// Direction, the angle Angle, the plane NeutralPlane, and the flag
    /// Flag to the framework created at construction time, and with this
    ...
    /// transformation and to retrieve the previous shape.
    /// </summary>
    void Add(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Dir Direction, double Angle, RDC::OCC::Pln NeutralPlane);
    /// <summary>
    ...
    /// </summary>
    void Remove(RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ ProblematicShape();
    ...
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ ConnectedFaces(RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// Returns all the faces  on which a modification has
    /// been given.
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ ModifiedFaces();
    /// <summary>
...
public ref class BRepOffsetAPI_FindContigousEdges sealed
    : public RDC::OCC::BaseClass<::BRepOffsetAPI_FindContigousEdges>
{
...
public:
    BRepOffsetAPI_FindContigousEdges(::BRepOffsetAPI_FindContigousEdges* nativeInstance)
        : RDC::OCC::BaseClass<::BRepOffsetAPI_FindContigousEdges>( nativeInstance, true )
    {}

    BRepOffsetAPI_FindContigousEdges(::BRepOffsetAPI_FindContigousEdges& nativeInstance)
        : RDC::OCC::BaseClass<::BRepOffsetAPI_FindContigousEdges>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    BRepOffsetAPI_MakeDraft(RDC::OCC::TopoDS_Shape^ Shape, RDC::OCC::Dir Dir, double Angle);
    /// <summary>
    ...
    /// </summary>
    void SetOptions(RDC::OCC::BRepBuilderAPI_TransitionMode Style, double AngleMin, double AngleMax);
    /// <summary>
    /// Sets the options of this draft tool.
    /// If a transition has to be performed, it can be defined by
    /// the mode Style as RightCorner or RoundCorner,
    ...
    /// AngleMin and AngleMax are expressed in radians.
    /// </summary>
    void SetOptions(RDC::OCC::BRepBuilderAPI_TransitionMode Style, double AngleMin);
    /// <summary>
    /// Sets the options of this draft tool.
    /// If a transition has to be performed, it can be defined by
    /// the mode Style as RightCorner or RoundCorner,
    ...
    /// AngleMin and AngleMax are expressed in radians.
    /// </summary>
    void SetOptions(RDC::OCC::BRepBuilderAPI_TransitionMode Style);
    /// <summary>
    /// Sets the options of this draft tool.
    /// If a transition has to be performed, it can be defined by
    /// the mode Style as RightCorner or RoundCorner,
    ...
    /// </summary>
    void Perform(RDC::OCC::Geom_Surface^ Surface, bool KeepInsideSurface);
    /// <summary>
    /// Performs the draft up to the surface Surface.
    /// If KeepInsideSurface is true, the part of Surface inside
    /// the draft is kept in the result.
    /// </summary>
    void Perform(RDC::OCC::Geom_Surface^ Surface);
    /// <summary>
    ...
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Shape^ StopShape, bool KeepOutSide);
    /// <summary>
    /// Performs the draft up to the shape StopShape.
    /// If KeepOutSide is true, the part of StopShape which is
    /// outside the Draft is kept in the result.
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Shape^ StopShape);
    /// <summary>
...
public:
    ...
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile, RDC::OCC::GeomAbs_JoinType theJoinType, bool theIsAxeProf, bool theIsSolid, bool theIsProfOnSpine, double theTol, bool theIsVolume, bool theRunInParallel);
    /// <summary>
    /// Constructs an evolved shape by sweeping the profile
    /// (theProfile) along the spine (theSpine).
    /// theSpine can be shape only of type wire or face.
    /// See description to this class for detailed information.
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile, RDC::OCC::GeomAbs_JoinType theJoinType, bool theIsAxeProf, bool theIsSolid, bool theIsProfOnSpine, double theTol, bool theIsVolume);
    /// <summary>
    /// Constructs an evolved shape by sweeping the profile
    /// (theProfile) along the spine (theSpine).
    /// theSpine can be shape only of type wire or face.
    /// See description to this class for detailed information.
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile, RDC::OCC::GeomAbs_JoinType theJoinType, bool theIsAxeProf, bool theIsSolid, bool theIsProfOnSpine, double theTol);
    /// <summary>
    /// Constructs an evolved shape by sweeping the profile
    /// (theProfile) along the spine (theSpine).
    /// theSpine can be shape only of type wire or face.
    /// See description to this class for detailed information.
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile, RDC::OCC::GeomAbs_JoinType theJoinType, bool theIsAxeProf, bool theIsSolid, bool theIsProfOnSpine);
    /// <summary>
    /// Constructs an evolved shape by sweeping the profile
    /// (theProfile) along the spine (theSpine).
    /// theSpine can be shape only of type wire or face.
    /// See description to this class for detailed information.
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile, RDC::OCC::GeomAbs_JoinType theJoinType, bool theIsAxeProf, bool theIsSolid);
    /// <summary>
    /// Constructs an evolved shape by sweeping the profile
    /// (theProfile) along the spine (theSpine).
    /// theSpine can be shape only of type wire or face.
    /// See description to this class for detailed information.
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile, RDC::OCC::GeomAbs_JoinType theJoinType, bool theIsAxeProf);
    /// <summary>
    /// Constructs an evolved shape by sweeping the profile
    /// (theProfile) along the spine (theSpine).
    /// theSpine can be shape only of type wire or face.
    /// See description to this class for detailed information.
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile, RDC::OCC::GeomAbs_JoinType theJoinType);
    /// <summary>
    /// Constructs an evolved shape by sweeping the profile
    /// (theProfile) along the spine (theSpine).
    /// theSpine can be shape only of type wire or face.
    /// See description to this class for detailed information.
    /// </summary>
    BRepOffsetAPI_MakeEvolved(RDC::OCC::TopoDS_Shape^ theSpine, RDC::OCC::TopoDS_Wire^ theProfile);
    ...
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ GeneratedShapes(RDC::OCC::TopoDS_Shape^ SpineShape, RDC::OCC::TopoDS_Shape^ ProfShape);
    /// <summary>
    /// Return the face Top if <Solid> is True in the constructor.
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Top();
    /// <summary>
    /// Return the face Bottom  if <Solid> is True in the constructor.
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Bottom();
}; // class BRepOffsetAPI_MakeEvolved
...
public:
    ...
    /// are possible.
    /// </summary>
    void LoadInitSurface(RDC::OCC::TopoDS_Face^ Surf);
    /// <summary>
    ...
    /// </summary>
    int Add(RDC::OCC::TopoDS_Edge^ Constr, RDC::OCC::GeomAbs_Shape Order, bool IsBound);
    /// <summary>
    /// Adds a new constraint which also defines an edge of the wire
    /// of the face
    /// Order: Order of the constraint:
    ...
    /// GeomAbs_G1 or GeomAbs_G2.
    /// </summary>
    int Add(RDC::OCC::TopoDS_Edge^ Constr, RDC::OCC::GeomAbs_Shape Order);
    /// <summary>
    /// Adds a new constraint which also defines an edge of the wire
    /// of the face
    /// Order: Order of the constraint:
    ...
    /// </summary>
    int Add(RDC::OCC::TopoDS_Edge^ Constr, RDC::OCC::TopoDS_Face^ Support, RDC::OCC::GeomAbs_Shape Order, bool IsBound);
    /// <summary>
    /// Adds a new constraint which also defines an edge of the wire
    /// of the face
    /// Order: Order of the constraint:
    ...
    /// Raises ConstructionError if the edge has no 2d representation on the given face
    /// </summary>
    int Add(RDC::OCC::TopoDS_Edge^ Constr, RDC::OCC::TopoDS_Face^ Support, RDC::OCC::GeomAbs_Shape Order);
    /// <summary>
    /// Adds a free constraint on a face. The corresponding edge has to
    /// be automatically recomputed. It is always a bound.
    /// </summary>
    int Add(RDC::OCC::TopoDS_Face^ Support, RDC::OCC::GeomAbs_Shape Order);
    /// <summary>
    /// Adds a punctual constraint.
    /// </summary>
    int Add(RDC::OCC::Pnt Point);
    /// <summary>
    /// Adds a punctual constraint.
    /// </summary>
    int Add(double U, double V, RDC::OCC::TopoDS_Face^ Support, RDC::OCC::GeomAbs_Shape Order);
    /// <summary>
...
public:
    ...
    /// </summary>
    BRepOffsetAPI_MakeOffset(RDC::OCC::TopoDS_Face^ Spine, RDC::OCC::GeomAbs_JoinType Join, bool IsOpenResult);
    /// <summary>
    /// Constructs an algorithm for creating an algorithm
    /// to build parallels to the spine Spine
    /// </summary>
    BRepOffsetAPI_MakeOffset(RDC::OCC::TopoDS_Face^ Spine, RDC::OCC::GeomAbs_JoinType Join);
    /// <summary>
    /// Constructs an algorithm for creating an algorithm
    /// to build parallels to the spine Spine
    /// </summary>
    BRepOffsetAPI_MakeOffset(RDC::OCC::TopoDS_Face^ Spine);
    BRepOffsetAPI_MakeOffset(RDC::OCC::TopoDS_Wire^ Spine, RDC::OCC::GeomAbs_JoinType Join, bool IsOpenResult);
    BRepOffsetAPI_MakeOffset(RDC::OCC::TopoDS_Wire^ Spine, RDC::OCC::GeomAbs_JoinType Join);
    BRepOffsetAPI_MakeOffset(RDC::OCC::TopoDS_Wire^ Spine);
    /// <summary>
    ...
    /// </summary>
    void Init(RDC::OCC::TopoDS_Face^ Spine, RDC::OCC::GeomAbs_JoinType Join, bool IsOpenResult);
    /// <summary>
    /// Initializes the algorithm to construct parallels to the spine Spine.
    /// Join defines the type of parallel generated by the
    /// salient vertices of the spine.
    ...
    /// prolonged until intersection.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Face^ Spine, RDC::OCC::GeomAbs_JoinType Join);
    /// <summary>
    /// Initializes the algorithm to construct parallels to the spine Spine.
    /// Join defines the type of parallel generated by the
    /// salient vertices of the spine.
    ...
    /// prolonged until intersection.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Face^ Spine);
    /// <summary>
    /// Initialize the evaluation of Offsetting.
    /// </summary>
    void Init(RDC::OCC::GeomAbs_JoinType Join, bool IsOpenResult);
    /// <summary>
    /// Initialize the evaluation of Offsetting.
    /// </summary>
    void Init(RDC::OCC::GeomAbs_JoinType Join);
    /// <summary>
    /// Initialize the evaluation of Offsetting.
    /// </summary>
    void Init();
    ...
    /// </summary>
    void AddWire(RDC::OCC::TopoDS_Wire^ Spine);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::TopoDS_Face^ ConvertFace(RDC::OCC::TopoDS_Face^ theFace, double theAngleTolerance);
}; // class BRepOffsetAPI_MakeOffset
...
public:
    ...
    /// </summary>
    void PerformBySimple(RDC::OCC::TopoDS_Shape^ theS, double theOffsetValue);
    /// <summary>
    ...
    /// </summary>
    void PerformByJoin(RDC::OCC::TopoDS_Shape^ S, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter, RDC::OCC::GeomAbs_JoinType Join, bool RemoveIntEdges, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Constructs a shape parallel to the shape S, where
    /// - S may be a face, a shell, a solid or a compound of these shape kinds;
    /// - Offset is the offset value. The offset shape is constructed:
    ...
    /// geometry of S is BSpline with continuity C0.
    /// </summary>
    void PerformByJoin(RDC::OCC::TopoDS_Shape^ S, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter, RDC::OCC::GeomAbs_JoinType Join, bool RemoveIntEdges);
    /// <summary>
    /// Constructs a shape parallel to the shape S, where
    /// - S may be a face, a shell, a solid or a compound of these shape kinds;
    /// - Offset is the offset value. The offset shape is constructed:
    ...
    /// geometry of S is BSpline with continuity C0.
    /// </summary>
    void PerformByJoin(RDC::OCC::TopoDS_Shape^ S, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter, RDC::OCC::GeomAbs_JoinType Join);
    /// <summary>
    /// Constructs a shape parallel to the shape S, where
    /// - S may be a face, a shell, a solid or a compound of these shape kinds;
    /// - Offset is the offset value. The offset shape is constructed:
    ...
    /// geometry of S is BSpline with continuity C0.
    /// </summary>
    void PerformByJoin(RDC::OCC::TopoDS_Shape^ S, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter);
    /// <summary>
    /// Constructs a shape parallel to the shape S, where
    /// - S may be a face, a shell, a solid or a compound of these shape kinds;
    /// - Offset is the offset value. The offset shape is constructed:
    ...
    /// geometry of S is BSpline with continuity C0.
    /// </summary>
    void PerformByJoin(RDC::OCC::TopoDS_Shape^ S, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection);
    /// <summary>
    /// Constructs a shape parallel to the shape S, where
    /// - S may be a face, a shell, a solid or a compound of these shape kinds;
    /// - Offset is the offset value. The offset shape is constructed:
    ...
    /// geometry of S is BSpline with continuity C0.
    /// </summary>
    void PerformByJoin(RDC::OCC::TopoDS_Shape^ S, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode);
    /// <summary>
    /// Constructs a shape parallel to the shape S, where
    /// - S may be a face, a shell, a solid or a compound of these shape kinds;
    /// - Offset is the offset value. The offset shape is constructed:
    ...
    /// geometry of S is BSpline with continuity C0.
    /// </summary>
    void PerformByJoin(RDC::OCC::TopoDS_Shape^ S, double Offset, double Tol);
    /// <summary>
    /// Returns instance of the unrelying intersection / arc algorithm.
    /// </summary>
    RDC::OCC::BRepOffset_MakeOffset^ MakeOffset();
    /// <summary>
    /// Does nothing.
    /// </summary>
    void Build(RDC::OCC::Message_ProgressRange^ theRange);
...
public:
    ...
    /// composite solid.
    /// </summary>
    BRepOffsetAPI_MakePipe(RDC::OCC::TopoDS_Wire^ Spine, RDC::OCC::TopoDS_Shape^ Profile);
    ...
    RDC::OCC::TopTools_ListOfShape^ Generated(RDC::OCC::TopoDS_Shape^ S);
    RDC::OCC::TopoDS_Shape^ Generated(RDC::OCC::TopoDS_Shape^ SSpine, RDC::OCC::TopoDS_Shape^ SProfile);
...
public:
    ...
    /// </summary>
    BRepOffsetAPI_MakePipeShell(RDC::OCC::TopoDS_Wire^ Spine);
    /// <summary>
    ...
    /// </summary>
    void SetMode(RDC::OCC::Dir BiNormal);
    /// <summary>
    ...
    /// </summary>
    bool SetMode(RDC::OCC::TopoDS_Shape^ SpineSupport);
    ...
    /// </summary>
    void SetMode(RDC::OCC::TopoDS_Wire^ AuxiliarySpine, bool CurvilinearEquivalence);
    /// <summary>
    ...
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ Profile, bool WithContact, bool WithCorrection);
    /// <summary>
    /// Adds the section Profile to this framework. First and last
    /// sections may be punctual, so the shape Profile may be
    /// both wire and vertex. Correspondent point on spine is
    ...
    /// (Profile is of type TopoDS_Vertex).
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ Profile, bool WithContact);
    /// <summary>
    /// Adds the section Profile to this framework. First and last
    /// sections may be punctual, so the shape Profile may be
    /// both wire and vertex. Correspondent point on spine is
    ...
    /// (Profile is of type TopoDS_Vertex).
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ Profile);
    /// <summary>
    ...
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ Profile, RDC::OCC::TopoDS_Vertex^ Location, bool WithContact, bool WithCorrection);
    /// <summary>
    /// Adds the section Profile to this framework.
    /// Correspondent point on the spine is given by Location.
    /// Warning:
    /// To be effective, it is not recommended to combine methods Add and SetLaw.
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ Profile, RDC::OCC::TopoDS_Vertex^ Location, bool WithContact);
    /// <summary>
    /// Adds the section Profile to this framework.
    /// Correspondent point on the spine is given by Location.
    /// Warning:
    /// To be effective, it is not recommended to combine methods Add and SetLaw.
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ Profile, RDC::OCC::TopoDS_Vertex^ Location);
    ...
    /// </summary>
    void Delete(RDC::OCC::TopoDS_Shape^ Profile);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::BRepBuilderAPI_PipeError GetStatus();
    /// <summary>
    ...
    /// </summary>
    void SetTransitionMode(RDC::OCC::BRepBuilderAPI_TransitionMode Mode);
    /// <summary>
    /// Sets the transition mode to manage discontinuities on
    /// the swept shape caused by fractures on the spine. The
    /// transition mode can be BRepBuilderAPI_Transformed
    ...
    /// </summary>
    void Simulate(int NumberOfSection, RDC::OCC::TopTools_ListOfShape^ Result);
    /// <summary>
    /// Builds the resulting shape (redefined from MakeShape).
    /// </summary>
    void Build(RDC::OCC::Message_ProgressRange^ theRange);
    ...
    /// </summary>
    void Profiles(RDC::OCC::TopTools_ListOfShape^ theProfiles);
    /// <summary>
    /// Returns the spine
    /// </summary>
    RDC::OCC::TopoDS_Wire^ Spine();
}; // class BRepOffsetAPI_MakePipeShell
...
public ref class BRepOffsetAPI_MakeThickSolid sealed
    : public RDC::OCC::BRepOffsetAPI_MakeOffsetShape
{
...
public:
    BRepOffsetAPI_MakeThickSolid(::BRepOffsetAPI_MakeThickSolid* nativeInstance)
        : RDC::OCC::BRepOffsetAPI_MakeOffsetShape( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    void MakeThickSolidBySimple(RDC::OCC::TopoDS_Shape^ theS, double theOffsetValue);
    /// <summary>
    ...
    /// MakeOffsetShape.
    /// </summary>
    void MakeThickSolidByJoin(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ ClosingFaces, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter, RDC::OCC::GeomAbs_JoinType Join, bool RemoveIntEdges, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Constructs a hollowed solid from
    /// the solid S by removing the set of faces ClosingFaces from S, where:
    /// Offset defines the thickness of the walls. Its sign indicates
    ...
    /// MakeOffsetShape.
    /// </summary>
    void MakeThickSolidByJoin(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ ClosingFaces, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter, RDC::OCC::GeomAbs_JoinType Join, bool RemoveIntEdges);
    /// <summary>
    /// Constructs a hollowed solid from
    /// the solid S by removing the set of faces ClosingFaces from S, where:
    /// Offset defines the thickness of the walls. Its sign indicates
    ...
    /// MakeOffsetShape.
    /// </summary>
    void MakeThickSolidByJoin(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ ClosingFaces, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter, RDC::OCC::GeomAbs_JoinType Join);
    /// <summary>
    /// Constructs a hollowed solid from
    /// the solid S by removing the set of faces ClosingFaces from S, where:
    /// Offset defines the thickness of the walls. Its sign indicates
    ...
    /// MakeOffsetShape.
    /// </summary>
    void MakeThickSolidByJoin(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ ClosingFaces, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection, bool SelfInter);
    /// <summary>
    /// Constructs a hollowed solid from
    /// the solid S by removing the set of faces ClosingFaces from S, where:
    /// Offset defines the thickness of the walls. Its sign indicates
    ...
    /// MakeOffsetShape.
    /// </summary>
    void MakeThickSolidByJoin(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ ClosingFaces, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode, bool Intersection);
    /// <summary>
    /// Constructs a hollowed solid from
    /// the solid S by removing the set of faces ClosingFaces from S, where:
    /// Offset defines the thickness of the walls. Its sign indicates
    ...
    /// MakeOffsetShape.
    /// </summary>
    void MakeThickSolidByJoin(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ ClosingFaces, double Offset, double Tol, RDC::OCC::BRepOffset_Mode Mode);
    /// <summary>
    /// Constructs a hollowed solid from
    /// the solid S by removing the set of faces ClosingFaces from S, where:
    /// Offset defines the thickness of the walls. Its sign indicates
    ...
    /// MakeOffsetShape.
    /// </summary>
    void MakeThickSolidByJoin(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ ClosingFaces, double Offset, double Tol);
    void Build(RDC::OCC::Message_ProgressRange^ theRange);
    void Build();
    /// <summary>
    /// Returns the list  of shapes modified from the shape
...
public:
    ...
    /// a wire or a face
    /// </summary>
    BRepOffsetAPI_MiddlePath(RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopoDS_Shape^ StartShape, RDC::OCC::TopoDS_Shape^ EndShape);
    void Build(RDC::OCC::Message_ProgressRange^ theRange);
    void Build();
}; // class BRepOffsetAPI_MiddlePath
...
public:
    ...
    /// </summary>
    BRepOffsetAPI_NormalProjection(RDC::OCC::TopoDS_Shape^ S);
    /// <summary>
    ...
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ ToProj);
    /// <summary>
    ...
    /// </summary>
    void SetParams(double Tol3D, double Tol2D, RDC::OCC::GeomAbs_Shape InternalContinuity, int MaxDegree, int MaxSeg);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Projection();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Couple(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// Returns the  list   of shapes generated   from the
    /// shape <S>.
    /// </summary>
    ...
    /// E has already been found.
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Ancestor(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// build the result as a list of wire if possible in --
    /// a first returns a wire only if there is only a wire.
    /// </summary>
    bool BuildWire(RDC::OCC::TopTools_ListOfShape^ Liste);
}; // class BRepOffsetAPI_NormalProjection
...
public:
    ...
    /// </summary>
    void AddWire(RDC::OCC::TopoDS_Wire^ wire);
    /// <summary>
    ...
    /// Use the Build function to construct the shape.
    /// </summary>
    void AddVertex(RDC::OCC::TopoDS_Vertex^ aVertex);
    /// <summary>
    ...
    /// </summary>
    void SetContinuity(RDC::OCC::GeomAbs_Shape C);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ GeneratedFace(RDC::OCC::TopoDS_Shape^ Edge);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ Wires();
    /// <summary>
