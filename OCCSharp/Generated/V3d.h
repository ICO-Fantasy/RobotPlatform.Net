...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::V3d_ListOfLight::Iterator>
    {
    ...
    public:
        Iterator(::V3d_ListOfLight::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::V3d_ListOfLight::Iterator>( nativeInstance, true )
        {}

        Iterator(::V3d_ListOfLight::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::V3d_ListOfLight::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        RDC::OCC::Graphic3d_CLight^ ChangeValue();
    }; // class Iterator

    V3d_ListOfLight();
    V3d_ListOfLight(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    RDC::OCC::V3d_ListOfLight^ Assign(RDC::OCC::V3d_ListOfLight^ theOther);
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::Graphic3d_CLight^ First();
    RDC::OCC::Graphic3d_CLight^ Last();
    RDC::OCC::Graphic3d_CLight^ Append(RDC::OCC::Graphic3d_CLight^ theItem);
    RDC::OCC::Graphic3d_CLight^ Prepend(RDC::OCC::Graphic3d_CLight^ theItem);
    void RemoveFirst();
    void Remove(RDC::OCC::V3d_ListOfLight::Iterator^ theIter);
    RDC::OCC::Graphic3d_CLight^ InsertBefore(RDC::OCC::Graphic3d_CLight^ theItem, RDC::OCC::V3d_ListOfLight::Iterator^ theIter);
    RDC::OCC::Graphic3d_CLight^ InsertAfter(RDC::OCC::Graphic3d_CLight^ theItem, RDC::OCC::V3d_ListOfLight::Iterator^ theIter);
    void Reverse();
}; // class V3d_ListOfLight
...
public ref class V3d_ListOfLightIterator sealed
    : public RDC::OCC::BaseClass<::V3d_ListOfLightIterator>
{
...
public:
    V3d_ListOfLightIterator(::V3d_ListOfLightIterator* nativeInstance)
        : RDC::OCC::BaseClass<::V3d_ListOfLightIterator>( nativeInstance, true )
    {}

    V3d_ListOfLightIterator(::V3d_ListOfLightIterator& nativeInstance)
        : RDC::OCC::BaseClass<::V3d_ListOfLightIterator>( &nativeInstance, false )
    {}
...
public:
    ...
    V3d_ListOfLightIterator(RDC::OCC::NCollection_BaseList^ theList);
    bool More();
    void Next();
    RDC::OCC::Graphic3d_CLight^ Value();
    RDC::OCC::Graphic3d_CLight^ ChangeValue();
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::V3d_ListOfView::Iterator>
    {
    ...
    public:
        Iterator(::V3d_ListOfView::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::V3d_ListOfView::Iterator>( nativeInstance, true )
        {}

        Iterator(::V3d_ListOfView::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::V3d_ListOfView::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::V3d_View^ Value();
        RDC::OCC::V3d_View^ ChangeValue();
    }; // class Iterator

    V3d_ListOfView();
    V3d_ListOfView(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    RDC::OCC::V3d_ListOfView^ Assign(RDC::OCC::V3d_ListOfView^ theOther);
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::V3d_View^ First();
    RDC::OCC::V3d_View^ Last();
    RDC::OCC::V3d_View^ Append(RDC::OCC::V3d_View^ theItem);
    RDC::OCC::V3d_View^ Prepend(RDC::OCC::V3d_View^ theItem);
    void RemoveFirst();
    void Remove(RDC::OCC::V3d_ListOfView::Iterator^ theIter);
    RDC::OCC::V3d_View^ InsertBefore(RDC::OCC::V3d_View^ theItem, RDC::OCC::V3d_ListOfView::Iterator^ theIter);
    RDC::OCC::V3d_View^ InsertAfter(RDC::OCC::V3d_View^ theItem, RDC::OCC::V3d_ListOfView::Iterator^ theIter);
    void Reverse();
}; // class V3d_ListOfView
...
public ref class V3d_ListOfViewIterator sealed
    : public RDC::OCC::BaseClass<::V3d_ListOfViewIterator>
{
...
public:
    V3d_ListOfViewIterator(::V3d_ListOfViewIterator* nativeInstance)
        : RDC::OCC::BaseClass<::V3d_ListOfViewIterator>( nativeInstance, true )
    {}

    V3d_ListOfViewIterator(::V3d_ListOfViewIterator& nativeInstance)
        : RDC::OCC::BaseClass<::V3d_ListOfViewIterator>( &nativeInstance, false )
    {}
...
public:
    ...
    V3d_ListOfViewIterator(RDC::OCC::NCollection_BaseList^ theList);
    bool More();
    void Next();
    RDC::OCC::V3d_View^ Value();
    RDC::OCC::V3d_View^ ChangeValue();
...
public ref class V3d_ImageDumpOptions sealed
    : public RDC::OCC::BaseClass<::V3d_ImageDumpOptions>
{
...
public:
    V3d_ImageDumpOptions(::V3d_ImageDumpOptions* nativeInstance)
        : RDC::OCC::BaseClass<::V3d_ImageDumpOptions>( nativeInstance, true )
    {}

    V3d_ImageDumpOptions(::V3d_ImageDumpOptions& nativeInstance)
        : RDC::OCC::BaseClass<::V3d_ImageDumpOptions>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    property RDC::OCC::Graphic3d_BufferType BufferType {
        RDC::OCC::Graphic3d_BufferType get() {
            return (RDC::OCC::Graphic3d_BufferType)(((::V3d_ImageDumpOptions*)_NativeInstance)->BufferType);
        }
        void set(RDC::OCC::Graphic3d_BufferType value) {
    ...
    /// </summary>
    property RDC::OCC::V3d_StereoDumpOptions StereoOptions {
        RDC::OCC::V3d_StereoDumpOptions get() {
            return (RDC::OCC::V3d_StereoDumpOptions)(((::V3d_ImageDumpOptions*)_NativeInstance)->StereoOptions);
        }
        void set(RDC::OCC::V3d_StereoDumpOptions value) {
...
public:
    ...
    /// </summary>
    V3d_View(RDC::OCC::V3d_Viewer^ theViewer, RDC::OCC::V3d_TypeOfView theType);
    /// <summary>
    /// Initializes the view.
    /// </summary>
    V3d_View(RDC::OCC::V3d_Viewer^ theViewer);
    /// <summary>
    /// Initializes the view by copying.
    /// </summary>
    V3d_View(RDC::OCC::V3d_Viewer^ theViewer, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// </summary>
    void SetWindow(RDC::OCC::Aspect_Window^ theWindow, System::IntPtr theContext);
    /// <summary>
    /// Activates the view in the specified Window
    /// If <aContext> is not NULL the graphic context is used
    /// to draw something in this view.
    ...
    /// the height/width ratio of the window.
    /// </summary>
    void SetWindow(RDC::OCC::Aspect_Window^ theWindow);
    /// <summary>
    ...
    /// </param>
    void SetWindow(RDC::OCC::V3d_View^ theParentView, RDC::OCC::Graphic3d_Vec2d^ theSize, RDC::OCC::Aspect_TypeOfTriedronPosition theCorner, RDC::OCC::Graphic3d_Vec2d^ theOffset, RDC::OCC::Graphic3d_Vec2i^ theMargins);
    /// <summary>
    /// Activates the view as subview of another view.
    /// </summary>
    /// <param name="in]">
    ...
    /// define one subview with Size=(0.5,1.0),Offset=(0.0,0.0), and 2nd with Size=(0.5,1.0),Offset=(5.0,0.0);
    /// </param>
    void SetWindow(RDC::OCC::V3d_View^ theParentView, RDC::OCC::Graphic3d_Vec2d^ theSize, RDC::OCC::Aspect_TypeOfTriedronPosition theCorner, RDC::OCC::Graphic3d_Vec2d^ theOffset);
    /// <summary>
    /// Activates the view as subview of another view.
    /// </summary>
    /// <param name="in]">
    ...
    /// define one subview with Size=(0.5,1.0),Offset=(0.0,0.0), and 2nd with Size=(0.5,1.0),Offset=(5.0,0.0);
    /// </param>
    void SetWindow(RDC::OCC::V3d_View^ theParentView, RDC::OCC::Graphic3d_Vec2d^ theSize, RDC::OCC::Aspect_TypeOfTriedronPosition theCorner);
    /// <summary>
    /// Activates the view as subview of another view.
    /// </summary>
    /// <param name="in]">
    ...
    /// define one subview with Size=(0.5,1.0),Offset=(0.0,0.0), and 2nd with Size=(0.5,1.0),Offset=(5.0,0.0);
    /// </param>
    void SetWindow(RDC::OCC::V3d_View^ theParentView, RDC::OCC::Graphic3d_Vec2d^ theSize);
    void SetMagnify(RDC::OCC::Aspect_Window^ theWindow, RDC::OCC::V3d_View^ thePreviousView, int theX1, int theY1, int theX2, int theY2);
    /// <summary>
    /// Destroys the view.
    /// </summary>
    void Remove();
    ...
    /// </summary>
    void SetBackgroundColor(RDC::OCC::Quantity_TypeOfColor theType, double theV1, double theV2, double theV3);
    /// <summary>
    /// Defines the background color of the view.
    /// </summary>
    void SetBackgroundColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Defines the gradient background colors of the view by supplying the colors
    /// and the fill method (horizontal by default).
    /// </summary>
    void SetBgGradientColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2, RDC::OCC::Aspect_GradientFillMethod theFillStyle, bool theToUpdate);
    /// <summary>
    /// Defines the gradient background colors of the view by supplying the colors
    /// and the fill method (horizontal by default).
    /// </summary>
    void SetBgGradientColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2, RDC::OCC::Aspect_GradientFillMethod theFillStyle);
    /// <summary>
    /// Defines the gradient background colors of the view by supplying the colors
    /// and the fill method (horizontal by default).
    /// </summary>
    void SetBgGradientColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2);
    /// <summary>
    /// Defines the gradient background fill method of the view.
    /// </summary>
    void SetBgGradientStyle(RDC::OCC::Aspect_GradientFillMethod theMethod, bool theToUpdate);
    /// <summary>
    /// Defines the gradient background fill method of the view.
    /// </summary>
    void SetBgGradientStyle(RDC::OCC::Aspect_GradientFillMethod theMethod);
    /// <summary>
    /// Defines the gradient background fill method of the view.
    /// </summary>
    ...
    /// </summary>
    void SetBackgroundImage(System::String^ theFileName, RDC::OCC::Aspect_FillMethod theFillStyle, bool theToUpdate);
    /// <summary>
    /// Defines the background texture of the view by supplying the texture image file name
    /// and fill method (centered by default).
    /// </summary>
    void SetBackgroundImage(System::String^ theFileName, RDC::OCC::Aspect_FillMethod theFillStyle);
    /// <summary>
    /// Defines the background texture of the view by supplying the texture image file name
    /// and fill method (centered by default).
    /// </summary>
    ...
    /// </summary>
    void SetBackgroundImage(RDC::OCC::Graphic3d_Texture2D^ theTexture, RDC::OCC::Aspect_FillMethod theFillStyle, bool theToUpdate);
    /// <summary>
    /// Defines the background texture of the view by supplying the texture and fill method (centered by default)
    /// </summary>
    void SetBackgroundImage(RDC::OCC::Graphic3d_Texture2D^ theTexture, RDC::OCC::Aspect_FillMethod theFillStyle);
    /// <summary>
    /// Defines the background texture of the view by supplying the texture and fill method (centered by default)
    /// </summary>
    void SetBackgroundImage(RDC::OCC::Graphic3d_Texture2D^ theTexture);
    /// <summary>
    /// Defines the textured background fill method of the view.
    /// </summary>
    void SetBgImageStyle(RDC::OCC::Aspect_FillMethod theFillStyle, bool theToUpdate);
    /// <summary>
    /// Defines the textured background fill method of the view.
    /// </summary>
    void SetBgImageStyle(RDC::OCC::Aspect_FillMethod theFillStyle);
    /// <summary>
    ...
    /// </param>
    void SetBackgroundCubeMap(RDC::OCC::Graphic3d_CubeMap^ theCubeMap, bool theToUpdatePBREnv, bool theToUpdate);
    /// <summary>
    /// Sets environment cubemap as background.
    /// </summary>
    /// <param name="theCubeMap">
    ...
    /// defines whether IBL maps will be generated or not (see 'GeneratePBREnvironment')
    /// </param>
    void SetBackgroundCubeMap(RDC::OCC::Graphic3d_CubeMap^ theCubeMap, bool theToUpdatePBREnv);
    /// <summary>
    /// Sets environment cubemap as background.
    /// </summary>
    /// <param name="theCubeMap">
    ...
    /// defines whether IBL maps will be generated or not (see 'GeneratePBREnvironment')
    /// </param>
    void SetBackgroundCubeMap(RDC::OCC::Graphic3d_CubeMap^ theCubeMap);
    /// <summary>
    ...
    /// </summary>
    void SetTextureEnv(RDC::OCC::Graphic3d_TextureEnv^ theTexture);
    /// <summary>
    ...
    /// </summary>
    void SetVisualization(RDC::OCC::V3d_TypeOfVisualization theType);
    /// <summary>
    /// Activates theLight in the view.
    /// </summary>
    void SetLightOn(RDC::OCC::Graphic3d_CLight^ theLight);
    /// <summary>
    ...
    /// </summary>
    void SetLightOff(RDC::OCC::Graphic3d_CLight^ theLight);
    /// <summary>
    ...
    /// </summary>
    bool IsActiveLight(RDC::OCC::Graphic3d_CLight^ theLight);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::V3d_Trihedron^ Trihedron(bool theToCreate);
    /// <summary>
    /// Returns trihedron object.
    /// </summary>
    RDC::OCC::V3d_Trihedron^ Trihedron();
    /// <summary>
    ...
    /// </summary>
    void ZBufferTriedronSetup(RDC::OCC::Quantity_Color^ theXColor, RDC::OCC::Quantity_Color^ theYColor, RDC::OCC::Quantity_Color^ theZColor, double theSizeRatio, double theAxisDiametr, int theNbFacettes);
    /// <summary>
    /// Customization of the ZBUFFER Triedron.
    /// XColor,YColor,ZColor - colors of axis
    /// SizeRatio - ratio of decreasing of the trihedron size when its physical
    ...
    /// NbFacettes - number of facets of cylinders and cones
    /// </summary>
    void ZBufferTriedronSetup(RDC::OCC::Quantity_Color^ theXColor, RDC::OCC::Quantity_Color^ theYColor, RDC::OCC::Quantity_Color^ theZColor, double theSizeRatio, double theAxisDiametr);
    /// <summary>
    /// Customization of the ZBUFFER Triedron.
    /// XColor,YColor,ZColor - colors of axis
    /// SizeRatio - ratio of decreasing of the trihedron size when its physical
    ...
    /// NbFacettes - number of facets of cylinders and cones
    /// </summary>
    void ZBufferTriedronSetup(RDC::OCC::Quantity_Color^ theXColor, RDC::OCC::Quantity_Color^ theYColor, RDC::OCC::Quantity_Color^ theZColor, double theSizeRatio);
    /// <summary>
    /// Customization of the ZBUFFER Triedron.
    /// XColor,YColor,ZColor - colors of axis
    /// SizeRatio - ratio of decreasing of the trihedron size when its physical
    ...
    /// NbFacettes - number of facets of cylinders and cones
    /// </summary>
    void ZBufferTriedronSetup(RDC::OCC::Quantity_Color^ theXColor, RDC::OCC::Quantity_Color^ theYColor, RDC::OCC::Quantity_Color^ theZColor);
    /// <summary>
    /// Customization of the ZBUFFER Triedron.
    /// XColor,YColor,ZColor - colors of axis
    /// SizeRatio - ratio of decreasing of the trihedron size when its physical
    ...
    /// NbFacettes - number of facets of cylinders and cones
    /// </summary>
    void ZBufferTriedronSetup(RDC::OCC::Quantity_Color^ theXColor, RDC::OCC::Quantity_Color^ theYColor);
    /// <summary>
    /// Customization of the ZBUFFER Triedron.
    /// XColor,YColor,ZColor - colors of axis
    /// SizeRatio - ratio of decreasing of the trihedron size when its physical
    ...
    /// NbFacettes - number of facets of cylinders and cones
    /// </summary>
    void ZBufferTriedronSetup(RDC::OCC::Quantity_Color^ theXColor);
    /// <summary>
    /// Customization of the ZBUFFER Triedron.
    /// XColor,YColor,ZColor - colors of axis
    /// SizeRatio - ratio of decreasing of the trihedron size when its physical
    ...
    /// </summary>
    void TriedronDisplay(RDC::OCC::Aspect_TypeOfTriedronPosition thePosition, RDC::OCC::Quantity_Color^ theColor, double theScale, RDC::OCC::V3d_TypeOfVisualization theMode);
    /// <summary>
    /// Display of the Triedron.
    /// Initialize position, color and length of Triedron axes.
    /// The scale is a percent of the window width.
    /// </summary>
    void TriedronDisplay(RDC::OCC::Aspect_TypeOfTriedronPosition thePosition, RDC::OCC::Quantity_Color^ theColor, double theScale);
    /// <summary>
    /// Display of the Triedron.
    /// Initialize position, color and length of Triedron axes.
    /// The scale is a percent of the window width.
    /// </summary>
    void TriedronDisplay(RDC::OCC::Aspect_TypeOfTriedronPosition thePosition, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Display of the Triedron.
    /// Initialize position, color and length of Triedron axes.
    /// The scale is a percent of the window width.
    /// </summary>
    void TriedronDisplay(RDC::OCC::Aspect_TypeOfTriedronPosition thePosition);
    /// <summary>
    /// Display of the Triedron.
    /// Initialize position, color and length of Triedron axes.
    /// The scale is a percent of the window width.
    ...
    /// Start = Standard_True
    /// </summary>
    void Rotate(RDC::OCC::V3d_TypeOfAxe Axe, double Angle, double X, double Y, double Z, bool Start);
    /// <summary>
    /// Rotates the eye about one of the coordinate axes of
    /// of the view for which the origin is the Gravity point{X,Y,Z}
    /// with an relative angular value in RADIANS with
    ...
    /// Start = Standard_True
    /// </summary>
    void Rotate(RDC::OCC::V3d_TypeOfAxe Axe, double Angle, double X, double Y, double Z);
    /// <summary>
    /// Rotates the eye about one of the coordinate axes of
    ...
    /// Start = Standard_True
    /// </summary>
    void Rotate(RDC::OCC::V3d_TypeOfAxe Axe, double Angle, bool Start);
    /// <summary>
    /// Rotates the eye about one of the coordinate axes of
    /// of the view for which the origin is the view point of the
    /// projection with an relative angular value in RADIANS with
    ...
    /// Start = Standard_True
    /// </summary>
    void Rotate(RDC::OCC::V3d_TypeOfAxe Axe, double Angle);
    /// <summary>
    ...
    /// Start = Standard_True.
    /// </summary>
    void Move(RDC::OCC::V3d_TypeOfAxe Axe, double Length, bool Start);
    /// <summary>
    /// Movement of the eye parallel to one of the axes of the
    /// coordinate system of reference of the view a distance
    /// relative to the initial position expressed by
    /// Start = Standard_True.
    /// </summary>
    void Move(RDC::OCC::V3d_TypeOfAxe Axe, double Length);
    /// <summary>
    ...
    /// expressed by Start = Standard_True
    /// </summary>
    void Translate(RDC::OCC::V3d_TypeOfAxe Axe, double Length, bool Start);
    /// <summary>
    /// Movement of the eye and the view point parallel to one
    /// of the axes of the fame of reference of the view a
    /// distance relative to the initial position
    /// expressed by Start = Standard_True
    /// </summary>
    void Translate(RDC::OCC::V3d_TypeOfAxe Axe, double Length);
    /// <summary>
    ...
    /// Start = Standard_True
    /// </summary>
    void Turn(RDC::OCC::V3d_TypeOfAxe Axe, double Angle, bool Start);
    /// <summary>
    /// Rotation of the view point around one of the axes of the
    /// frame of reference of the view for which the origin is
    /// the eye of the projection with an angular value in
    ...
    /// Start = Standard_True
    /// </summary>
    void Turn(RDC::OCC::V3d_TypeOfAxe Axe, double Angle);
    /// <summary>
    ...
    /// </param>
    void SetProj(RDC::OCC::V3d_TypeOfOrientation theOrientation, bool theIsYup);
    /// <summary>
    /// Defines the orientation of the projection .
    /// </summary>
    /// <param name="theOrientation">
    ...
    ///       flag indicating Y-up (TRUE) or Z-up (FALSE) convention
    /// </param>
    void SetProj(RDC::OCC::V3d_TypeOfOrientation theOrientation);
    /// <summary>
    ...
    /// </summary>
    void SetUp(RDC::OCC::V3d_TypeOfOrientation Orientation);
    /// <summary>
    ...
    /// [in] flag to perform view update.
    /// </param>
    void FitAll(RDC::OCC::Bnd_Box^ theBox, double theMargin, bool theToUpdate);
    /// <summary>
    /// Adjust view parameters to fit the displayed scene, respecting height / width ratio
    /// according to the custom bounding box given.
    /// Throws program error exception if margin coefficient is < 0 or >= 1.
    ...
    /// [in] flag to perform view update.
    /// </param>
    void FitAll(RDC::OCC::Bnd_Box^ theBox, double theMargin);
    /// <summary>
    /// Adjust view parameters to fit the displayed scene, respecting height / width ratio
    /// according to the custom bounding box given.
    /// Throws program error exception if margin coefficient is < 0 or >= 1.
    ...
    /// [in] flag to perform view update.
    /// </param>
    void FitAll(RDC::OCC::Bnd_Box^ theBox);
    /// <summary>
    ...
    /// </summary>
    void BackgroundColor(RDC::OCC::Quantity_TypeOfColor Type, double% V1, double% V2, double% V3);
    /// <summary>
    /// Returns the Background color object of the view.
    /// </summary>
    RDC::OCC::Quantity_Color^ BackgroundColor();
    /// <summary>
    /// Returns the gradient background colors of the view.
    /// </summary>
    void GradientBackgroundColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::V3d_TypeOfVisualization Visualization();
    /// <summary>
    /// Returns a list of active lights.
    /// </summary>
    RDC::OCC::V3d_ListOfLight^ ActiveLights();
    ...
    /// </summary>
    void AxialScale(int Dx, int Dy, RDC::OCC::V3d_TypeOfAxe Axis);
    /// <summary>
    ...
    /// </returns>
    bool FitMinMax(RDC::OCC::Graphic3d_Camera^ theCamera, RDC::OCC::Bnd_Box^ theBox, double theMargin, double theResolution, bool theToEnlargeIfLine);
    /// <summary>
    /// Transform camera eye, center and scale to fit in the passed bounding box specified in WCS.
    /// </summary>
    /// <param name="theCamera">
    ...
    /// TRUE if the fit all operation can be done
    /// </returns>
    bool FitMinMax(RDC::OCC::Graphic3d_Camera^ theCamera, RDC::OCC::Bnd_Box^ theBox, double theMargin, double theResolution);
    /// <summary>
    /// Transform camera eye, center and scale to fit in the passed bounding box specified in WCS.
    /// </summary>
    /// <param name="theCamera">
    ...
    /// TRUE if the fit all operation can be done
    /// </returns>
    bool FitMinMax(RDC::OCC::Graphic3d_Camera^ theCamera, RDC::OCC::Bnd_Box^ theBox, double theMargin);
    /// <summary>
    /// Defines or Updates the definition of the
    /// grid in <me>
    /// </summary>
    void SetGrid(RDC::OCC::Ax3 aPlane, RDC::OCC::Aspect_Grid^ aGrid);
    /// <summary>
    ...
    /// </returns>
    bool Dump(System::String^ theFile, RDC::OCC::Graphic3d_BufferType theBufferType);
    /// <summary>
    /// Dumps the full contents of the View into the image file. This is an alias for ToPixMap() with Image_AlienPixMap.
    /// </summary>
    /// <param name="theFile">
    ...
    /// </summary>
    bool ToPixMap(RDC::OCC::Image_PixMap^ theImage, RDC::OCC::V3d_ImageDumpOptions^ theParams);
    /// <summary>
    ...
    /// </param>
    bool ToPixMap(RDC::OCC::Image_PixMap^ theImage, int theWidth, int theHeight, RDC::OCC::Graphic3d_BufferType theBufferType, bool theToAdjustAspect, RDC::OCC::V3d_StereoDumpOptions theStereoOptions);
    /// <summary>
    /// Dumps the full contents of the view to a pixmap.
    /// Internally this method calls Redraw() with an offscreen render buffer of requested target size (theWidth x theHeight),
    /// so that there is no need resizing a window control for making a dump of different size.
    ...
    ///  how to dump stereographic camera
    /// </param>
    bool ToPixMap(RDC::OCC::Image_PixMap^ theImage, int theWidth, int theHeight, RDC::OCC::Graphic3d_BufferType theBufferType, bool theToAdjustAspect);
    /// <summary>
    /// Dumps the full contents of the view to a pixmap.
    /// Internally this method calls Redraw() with an offscreen render buffer of requested target size (theWidth x theHeight),
    /// so that there is no need resizing a window control for making a dump of different size.
    ...
    ///  how to dump stereographic camera
    /// </param>
    bool ToPixMap(RDC::OCC::Image_PixMap^ theImage, int theWidth, int theHeight, RDC::OCC::Graphic3d_BufferType theBufferType);
    /// <summary>
    /// Dumps the full contents of the view to a pixmap.
    /// Internally this method calls Redraw() with an offscreen render buffer of requested target size (theWidth x theHeight),
    /// so that there is no need resizing a window control for making a dump of different size.
    ...
    ///  how to dump stereographic camera
    /// </param>
    bool ToPixMap(RDC::OCC::Image_PixMap^ theImage, int theWidth, int theHeight);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Graphic3d_Camera^ DefaultCamera();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::V3d_View^ PickSubview(RDC::OCC::Graphic3d_Vec2i^ thePnt);
    /// <summary>
    /// Add subview to the list.
    /// </summary>
    void AddSubview(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Remove subview from the list.
    /// </summary>
    bool RemoveSubview(RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    RDC::OCC::Graphic3d_CLight^ ActiveLight();
    static RDC::OCC::V3d_View^ CreateDowncasted(::V3d_View* instance);
}; // class V3d_View
...
public:
    V3d(::V3d* nativeInstance)
        : RDC::OCC::BaseClass<::V3d>( nativeInstance, true )
    {}

    V3d(::V3d& nativeInstance)
        : RDC::OCC::BaseClass<::V3d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static RDC::OCC::Dir GetProjAxis(RDC::OCC::V3d_TypeOfOrientation theOrientation);
    /// <summary>
    ...
    /// Lng      : Length of arrow.
    /// </summary>
    static void ArrowOfRadius(RDC::OCC::Graphic3d_Group^ garrow, double X0, double Y0, double Z0, double DX, double DY, double DZ, double Alpha, double Lng);
    /// <summary>
    ...
    /// </summary>
    static void CircleInPlane(RDC::OCC::Graphic3d_Group^ gcircle, double X0, double Y0, double Z0, double VX, double VY, double VZ, double Radius);
    static void SwitchViewsinWindow(RDC::OCC::V3d_View^ aPreviousView, RDC::OCC::V3d_View^ aNextView);
    /// <summary>
    ...
    /// </returns>
    static System::String^ TypeOfOrientationToString(RDC::OCC::V3d_TypeOfOrientation theType);
    /// <summary>
    ...
    /// </returns>
    static RDC::OCC::V3d_TypeOfOrientation TypeOfOrientationFromString(System::String^ theTypeString);
    /// <summary>
    ...
    /// </returns>
    static bool TypeOfOrientationFromString(System::String^ theTypeString, RDC::OCC::V3d_TypeOfOrientation% theType);
}; // class V3d
...
public ref class V3d_AmbientLight sealed
    : public RDC::OCC::Graphic3d_CLight
{
...
public:
    V3d_AmbientLight(::V3d_AmbientLight* nativeInstance)
        : RDC::OCC::Graphic3d_CLight( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    V3d_AmbientLight(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Constructs an ambient light source in the viewer.
    /// The default Color of this light source is WHITE.
    /// </summary>
    V3d_AmbientLight();
    static RDC::OCC::V3d_AmbientLight^ CreateDowncasted(::V3d_AmbientLight* instance);
}; // class V3d_AmbientLight
...
public:
    ...
    static RDC::OCC::V3d_BadValue^ NewInstance(System::String^ theMessage);
    static RDC::OCC::V3d_BadValue^ NewInstance();
    static RDC::OCC::V3d_BadValue^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::V3d_BadValue^ CreateDowncasted(::V3d_BadValue* instance);
}; // class V3d_BadValue
...
public:
    ...
    /// </summary>
    V3d_Viewer(RDC::OCC::Graphic3d_GraphicDriver^ theDriver);
    /// <summary>
    ...
    /// </summary>
    void SetViewOn(RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// has been Iconified .
    /// </summary>
    void SetViewOff(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Deprecated, Redraw() should be used instead.
    /// </summary>
    void Update();
    ...
    /// </summary>
    RDC::OCC::Graphic3d_GraphicDriver^ Driver();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Graphic3d_RenderingParams^ DefaultRenderingParams();
    /// <summary>
    /// Set default Rendering Parameters.
    /// </summary>
    void SetDefaultRenderingParams(RDC::OCC::Graphic3d_RenderingParams^ theParams);
    /// <summary>
    /// Defines the default background colour of views
    /// attached to the viewer by supplying the color object
    /// </summary>
    void SetDefaultBackgroundColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Returns the gradient background of the view.
    /// </summary>
    RDC::OCC::Aspect_GradientBackground^ GetGradientBackground();
    /// <summary>
    /// Defines the default gradient background colours of views
    /// attached to the viewer by supplying the colour objects
    /// </summary>
    void SetDefaultBgGradientColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2, RDC::OCC::Aspect_GradientFillMethod theFillStyle);
    /// <summary>
    /// Defines the default gradient background colours of views
    /// attached to the viewer by supplying the colour objects
    /// </summary>
    void SetDefaultBgGradientColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::V3d_TypeOfOrientation DefaultViewProj();
    /// <summary>
    /// Sets the default projection for creating views in the viewer.
    /// </summary>
    void SetDefaultViewProj(RDC::OCC::V3d_TypeOfOrientation theOrientation);
    /// <summary>
    /// Returns the default type of Visualization.
    /// </summary>
    RDC::OCC::V3d_TypeOfVisualization DefaultVisualization();
    /// <summary>
    /// Gives the default visualization mode.
    /// </summary>
    void SetDefaultVisualization(RDC::OCC::V3d_TypeOfVisualization theType);
    /// <summary>
    /// Returns the default type of Shading; Graphic3d_TypeOfShadingModel_Phong by default.
    /// </summary>
    RDC::OCC::Graphic3d_TypeOfShadingModel DefaultShadingModel();
    /// <summary>
    /// Gives the default type of SHADING.
    /// </summary>
    void SetDefaultShadingModel(RDC::OCC::Graphic3d_TypeOfShadingModel theType);
    /// <summary>
    /// Returns the default type of View (orthographic or perspective projection) to be returned by CreateView() method.
    /// </summary>
    RDC::OCC::V3d_TypeOfView DefaultTypeOfView();
    /// <summary>
    /// Set the default type of View (orthographic or perspective projection) to be returned by CreateView() method.
    /// </summary>
    void SetDefaultTypeOfView(RDC::OCC::V3d_TypeOfView theType);
    /// <summary>
    /// Returns the default background colour object.
    /// </summary>
    RDC::OCC::Quantity_Color^ DefaultBackgroundColor();
    /// <summary>
    /// Returns the gradient background colour objects of the view.
    /// </summary>
    void DefaultBgGradientColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2);
    /// <summary>
    ...
    /// </summary>
    void GetAllZLayers(RDC::OCC::TColStd_SequenceOfInteger^ theLayerSeq);
    /// <summary>
    ...
    /// </returns>
    bool AddZLayer(int% theLayerId, RDC::OCC::Graphic3d_ZLayerSettings^ theSettings);
    /// <summary>
    /// Add a new top-level Z layer to all managed views and get its ID as <theLayerId> value.
    /// The Z layers are controlled entirely by viewer, it is not possible to add a layer to a particular view.
    /// Custom layers will be inserted before Graphic3d_ZLayerId_Top (e.g. between Graphic3d_ZLayerId_Default and before Graphic3d_ZLayerId_Top).
    ...
    /// FALSE if the layer can not be created
    /// </returns>
    bool InsertLayerBefore(int% theNewLayerId, RDC::OCC::Graphic3d_ZLayerSettings^ theSettings, int theLayerAfter);
    /// <summary>
    /// Add a new top-level Z layer to all managed views and get its ID as <theLayerId> value.
    /// The Z layers are controlled entirely by viewer, it is not possible to add a layer to a particular view.
    /// Layer rendering order is defined by its position in list (altered by theLayerAfter)
    ...
    /// FALSE if the layer can not be created
    /// </returns>
    bool InsertLayerAfter(int% theNewLayerId, RDC::OCC::Graphic3d_ZLayerSettings^ theSettings, int theLayerBefore);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::V3d_ListOfView^ ActiveViews();
    ...
    /// </summary>
    RDC::OCC::V3d_ListOfView^ DefinedViews();
    ...
    /// </summary>
    void AddLight(RDC::OCC::Graphic3d_CLight^ theLight);
    /// <summary>
    /// Delete Light in Sequence Of Lights.
    /// </summary>
    void DelLight(RDC::OCC::Graphic3d_CLight^ theLight);
    /// <summary>
    /// Updates the lights of all the views of a viewer.
    /// </summary>
    void UpdateLights();
    bool IsGlobalLight(RDC::OCC::Graphic3d_CLight^ TheLight);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::V3d_ListOfLight^ DefinedLights();
    ...
    RDC::OCC::Ax3 PrivilegedPlane();
    void SetPrivilegedPlane(RDC::OCC::Ax3 thePlane);
    ...
    /// </summary>
    void ActivateGrid(RDC::OCC::Aspect_GridType aGridType, RDC::OCC::Aspect_GridDrawMode aGridDrawMode);
    /// <summary>
    ...
    /// marker size : 3.0
    /// </summary>
    void SetGridEcho(RDC::OCC::Graphic3d_AspectMarker3d^ aMarker);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Aspect_Grid^ Grid(bool theToCreate);
    /// <summary>
    /// Returns the defined grid in <me>.
    /// </summary>
    RDC::OCC::Aspect_Grid^ Grid();
    /// <summary>
    /// Returns the defined grid in <me>.
    /// </summary>
    RDC::OCC::Aspect_Grid^ Grid(RDC::OCC::Aspect_GridType theGridType, bool theToCreate);
    /// <summary>
    /// Returns the defined grid in <me>.
    /// </summary>
    RDC::OCC::Aspect_Grid^ Grid(RDC::OCC::Aspect_GridType theGridType);
    /// <summary>
    /// Returns the current grid type defined in <me>.
    /// </summary>
    RDC::OCC::Aspect_GridType GridType();
    /// <summary>
    /// Returns the current grid draw mode defined in <me>.
    /// </summary>
    RDC::OCC::Aspect_GridDrawMode GridDrawMode();
    /// <summary>
    ...
    /// </summary>
    void ShowGridEcho(RDC::OCC::V3d_View^ theView, RDC::OCC::Graphic3d_Vertex^ thePoint);
    /// <summary>
    /// Temporarly hide grid echo.
    /// </summary>
    void HideGridEcho(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Returns Standard_True if a grid is activated in <me>.
    /// </summary>
    bool IsActive();
    ...
    RDC::OCC::Graphic3d_CLight^ DefinedLight();
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::V3d_Viewer^ CreateDowncasted(::V3d_Viewer* instance);
}; // class V3d_Viewer
...
public ref class V3d_CircularGrid sealed
    : public RDC::OCC::Aspect_CircularGrid
{
...
public:
    V3d_CircularGrid(::V3d_CircularGrid* nativeInstance)
        : RDC::OCC::Aspect_CircularGrid( nativeInstance )
    {}
...
public:
    V3d_CircularGrid(RDC::OCC::V3d_Viewer^ aViewer, RDC::OCC::Quantity_Color^ aColor, RDC::OCC::Quantity_Color^ aTenthColor);
    void SetColors(RDC::OCC::Quantity_Color^ aColor, RDC::OCC::Quantity_Color^ aTenthColor);
    void Display();
    void Erase();
    bool IsDisplayed();
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::V3d_CircularGrid^ CreateDowncasted(::V3d_CircularGrid* instance);
}; // class V3d_CircularGrid
...
public:
    static RDC::OCC::V3d_PositionLight^ CreateDowncasted(::V3d_PositionLight* instance);
}; // class V3d_PositionLight
...
public ref class V3d_DirectionalLight sealed
    : public RDC::OCC::V3d_PositionLight
{
...
public:
    V3d_DirectionalLight(::V3d_DirectionalLight* nativeInstance)
        : RDC::OCC::V3d_PositionLight( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    V3d_DirectionalLight(RDC::OCC::V3d_TypeOfOrientation theDirection, RDC::OCC::Quantity_Color^ theColor, bool theIsHeadlight);
    /// <summary>
    /// Creates a directional light source in the viewer.
    /// </summary>
    V3d_DirectionalLight(RDC::OCC::V3d_TypeOfOrientation theDirection, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Creates a directional light source in the viewer.
    /// </summary>
    V3d_DirectionalLight(RDC::OCC::V3d_TypeOfOrientation theDirection);
    /// <summary>
    /// Creates a directional light source in the viewer.
    /// </summary>
    ...
    /// Creates a directional light source in the viewer.
    /// </summary>
    V3d_DirectionalLight(RDC::OCC::Dir theDirection, RDC::OCC::Quantity_Color^ theColor, bool theIsHeadlight);
    /// <summary>
    /// Creates a directional light source in the viewer.
    /// </summary>
    V3d_DirectionalLight(RDC::OCC::Dir theDirection, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Creates a directional light source in the viewer.
    /// </summary>
    V3d_DirectionalLight(RDC::OCC::Dir theDirection);
    /// <summary>
    /// Defines the direction of the light source by a predefined orientation.
    /// </summary>
    void SetDirection(RDC::OCC::V3d_TypeOfOrientation theDirection);
    static RDC::OCC::V3d_DirectionalLight^ CreateDowncasted(::V3d_DirectionalLight* instance);
}; // class V3d_DirectionalLight
...
public ref class V3d_RectangularGrid sealed
    : public RDC::OCC::Aspect_RectangularGrid
{
...
public:
    V3d_RectangularGrid(::V3d_RectangularGrid* nativeInstance)
        : RDC::OCC::Aspect_RectangularGrid( nativeInstance )
    {}
...
public:
    V3d_RectangularGrid(RDC::OCC::V3d_Viewer^ aViewer, RDC::OCC::Quantity_Color^ aColor, RDC::OCC::Quantity_Color^ aTenthColor);
    void SetColors(RDC::OCC::Quantity_Color^ aColor, RDC::OCC::Quantity_Color^ aTenthColor);
    void Display();
    void Erase();
    bool IsDisplayed();
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::V3d_RectangularGrid^ CreateDowncasted(::V3d_RectangularGrid* instance);
}; // class V3d_RectangularGrid
...
public:
    ...
    /// </summary>
    void SetPosition(RDC::OCC::Aspect_TypeOfTriedronPosition thePosition);
    /// <summary>
    /// Return scale factor.
    /// </summary>
    double Scale();
    ...
    /// text aspect
    /// </returns>
    RDC::OCC::Prs3d_TextAspect^ LabelAspect(RDC::OCC::V3d_TypeOfAxe theAxis);
    /// <summary>
    /// Setup per-label color.
    /// </summary>
    void SetLabelsColor(RDC::OCC::Quantity_Color^ theXColor, RDC::OCC::Quantity_Color^ theYColor, RDC::OCC::Quantity_Color^ theZColor);
    /// <summary>
    /// Setup color of text labels.
    /// </summary>
    void SetLabelsColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// shading aspect
    /// </returns>
    RDC::OCC::Prs3d_ShadingAspect^ ArrowAspect(RDC::OCC::V3d_TypeOfAxe theAxis);
    /// <summary>
    /// Setup colors of arrows.
    /// </summary>
    void SetArrowsColor(RDC::OCC::Quantity_Color^ theXColor, RDC::OCC::Quantity_Color^ theYColor, RDC::OCC::Quantity_Color^ theZColor);
    /// <summary>
    /// Return shading aspect of origin sphere.
    /// </summary>
    RDC::OCC::Prs3d_ShadingAspect^ OriginAspect();
    /// <summary>
    /// Return axis text.
    /// </summary>
    /// <param name="theAxis">
    ...
    /// text of the label
    /// </returns>
    RDC::OCC::TCollection_AsciiString^ Label(RDC::OCC::V3d_TypeOfAxe theAxis);
    /// <summary>
    /// Setup per-axis text.
    /// </summary>
    void SetLabels(RDC::OCC::TCollection_AsciiString^ theX, RDC::OCC::TCollection_AsciiString^ theY, RDC::OCC::TCollection_AsciiString^ theZ);
    /// <summary>
    /// Display trihedron.
    /// </summary>
    void Display(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Erase trihedron.
    /// </summary>
    void Erase();
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::V3d_Trihedron^ CreateDowncasted(::V3d_Trihedron* instance);
}; // class V3d_Trihedron
...
public:
    ...
    /// </summary>
    void Display(RDC::OCC::V3d_View^ theView, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Display the plane representation in the chosen view.
    /// </summary>
    void Display(RDC::OCC::V3d_View^ theView);
    ...
    /// </returns>
    RDC::OCC::Graphic3d_ClipPlane^ ClipPlane();
    static RDC::OCC::V3d_Plane^ CreateDowncasted(::V3d_Plane* instance);
}; // class V3d_Plane
...
public:
    ...
    /// </summary>
    V3d_PositionalLight(RDC::OCC::Pnt thePos, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Creates an isolated light source in the viewer with default attenuation factors (1.0, 0.0).
    /// </summary>
    V3d_PositionalLight(RDC::OCC::Pnt thePos);
    static RDC::OCC::V3d_PositionalLight^ CreateDowncasted(::V3d_PositionalLight* instance);
}; // class V3d_PositionalLight
...
public:
    ...
    /// </summary>
    V3d_SpotLight(RDC::OCC::Pnt thePos, RDC::OCC::V3d_TypeOfOrientation theDirection, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Creates a light source of the Spot type in the viewer with default attenuation factors (1.0, 0.0),
    /// concentration factor 1.0 and spot angle 30 degrees.
    /// </summary>
    V3d_SpotLight(RDC::OCC::Pnt thePos, RDC::OCC::V3d_TypeOfOrientation theDirection);
    /// <summary>
    /// Creates a light source of the Spot type in the viewer with default attenuation factors (1.0, 0.0),
    /// concentration factor 1.0 and spot angle 30 degrees.
    /// </summary>
    V3d_SpotLight(RDC::OCC::Pnt thePos);
    /// <summary>
    /// Creates a light source of the Spot type in the viewer with default attenuation factors (1.0, 0.0),
    /// concentration factor 1.0 and spot angle 30 degrees.
    /// </summary>
    V3d_SpotLight(RDC::OCC::Pnt thePos, RDC::OCC::Dir theDirection, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Creates a light source of the Spot type in the viewer with default attenuation factors (1.0, 0.0),
    /// concentration factor 1.0 and spot angle 30 degrees.
    /// </summary>
    V3d_SpotLight(RDC::OCC::Pnt thePos, RDC::OCC::Dir theDirection);
    /// <summary>
    /// Defines the direction of the light source
    /// according to a predefined directional vector.
    /// </summary>
    void SetDirection(RDC::OCC::V3d_TypeOfOrientation theOrientation);
    static RDC::OCC::V3d_SpotLight^ CreateDowncasted(::V3d_SpotLight* instance);
}; // class V3d_SpotLight
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::V3d_UnMapped^ NewInstance(System::String^ theMessage);
    static RDC::OCC::V3d_UnMapped^ NewInstance();
    static RDC::OCC::V3d_UnMapped^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::V3d_UnMapped^ CreateDowncasted(::V3d_UnMapped* instance);
}; // class V3d_UnMapped
