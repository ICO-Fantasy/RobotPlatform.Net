...
public ref class GeomPlate_BuildAveragePlane sealed
    : public RDC::OCC::BaseClass<::GeomPlate_BuildAveragePlane>
{
...
public:
    GeomPlate_BuildAveragePlane(::GeomPlate_BuildAveragePlane* nativeInstance)
        : RDC::OCC::BaseClass<::GeomPlate_BuildAveragePlane>( nativeInstance, true )
    {}

    GeomPlate_BuildAveragePlane(::GeomPlate_BuildAveragePlane& nativeInstance)
        : RDC::OCC::BaseClass<::GeomPlate_BuildAveragePlane>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomPlate_BuildAveragePlane(RDC::OCC::TColgp_HArray1OfPnt^ Pts, int NbBoundPoints, double Tol, int POption, int NOption);
    /// <summary>
    /// Creates the plane from the "best vector"
    /// </summary>
    GeomPlate_BuildAveragePlane(RDC::OCC::TColgp_SequenceOfVec^ Normals, RDC::OCC::TColgp_HArray1OfPnt^ Pts);
    /// <summary>
