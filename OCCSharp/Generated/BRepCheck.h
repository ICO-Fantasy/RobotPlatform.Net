...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class BRepCheck_ListOfStatus sealed
			...
			, public IEnumerable<RDC::OCC::BRepCheck_Status>
		{
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::IteratorEnumerator<RDC::OCC::BRepCheck_Status, ::BRepCheck_ListOfStatus::Iterator>
			{
			...
			public:
				Iterator(::BRepCheck_ListOfStatus::Iterator* nativeInstance)
					: RDC::OCC::IteratorEnumerator<RDC::OCC::BRepCheck_Status, ::BRepCheck_ListOfStatus::Iterator>(nativeInstance, true)
				{}

				Iterator(::BRepCheck_ListOfStatus::Iterator& nativeInstance)
					: RDC::OCC::IteratorEnumerator<RDC::OCC::BRepCheck_Status, ::BRepCheck_ListOfStatus::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More() override;
				void Next() override;
				RDC::OCC::BRepCheck_Status Value() override;
				RDC::OCC::BRepCheck_Status ChangeValue();
			}; // class Iterator

			BRepCheck_ListOfStatus();
			BRepCheck_ListOfStatus(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			int Size();
			RDC::OCC::BRepCheck_ListOfStatus^ Assign(RDC::OCC::BRepCheck_ListOfStatus^ theOther);
			void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			void Clear();
			RDC::OCC::BRepCheck_Status First();
			RDC::OCC::BRepCheck_Status Last();
			RDC::OCC::BRepCheck_Status Append(RDC::OCC::BRepCheck_Status theItem);
			RDC::OCC::BRepCheck_Status Prepend(RDC::OCC::BRepCheck_Status theItem);
			void RemoveFirst();
			void Remove(RDC::OCC::BRepCheck_ListOfStatus::Iterator^ theIter);
			RDC::OCC::BRepCheck_Status InsertBefore(RDC::OCC::BRepCheck_Status theItem, RDC::OCC::BRepCheck_ListOfStatus::Iterator^ theIter);
			RDC::OCC::BRepCheck_Status InsertAfter(RDC::OCC::BRepCheck_Status theItem, RDC::OCC::BRepCheck_ListOfStatus::Iterator^ theIter);
			void Reverse();
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::BRepCheck_Status>^ GetEnumerator();
		...
		public ref class BRepCheck_ListIteratorOfListOfStatus sealed
			: public RDC::OCC::BaseClass<::BRepCheck_ListIteratorOfListOfStatus>
		{
		...
		public:
			BRepCheck_ListIteratorOfListOfStatus(::BRepCheck_ListIteratorOfListOfStatus* nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_ListIteratorOfListOfStatus>(nativeInstance, true)
			{}

			BRepCheck_ListIteratorOfListOfStatus(::BRepCheck_ListIteratorOfListOfStatus& nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_ListIteratorOfListOfStatus>(&nativeInstance, false)
			{}
		...
		public:
			...
			BRepCheck_ListIteratorOfListOfStatus(RDC::OCC::NCollection_BaseList^ theList);
			bool More();
			void Next();
			RDC::OCC::BRepCheck_Status Value();
			RDC::OCC::BRepCheck_Status ChangeValue();
		}; // class BRepCheck_ListIteratorOfListOfStatus
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::BRepCheck_HListOfStatus::Iterator>
			{
			...
			public:
				Iterator(::BRepCheck_HListOfStatus::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::BRepCheck_HListOfStatus::Iterator>(nativeInstance, true)
				{}

				Iterator(::BRepCheck_HListOfStatus::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::BRepCheck_HListOfStatus::Iterator>(&nativeInstance, false)
				{}
			...
			RDC::OCC::BRepCheck_Status Prepend(RDC::OCC::BRepCheck_Status theItem);
			void RemoveFirst();
			void Remove(RDC::OCC::BRepCheck_HListOfStatus::Iterator^ theIter);
			RDC::OCC::BRepCheck_Status InsertBefore(RDC::OCC::BRepCheck_Status theItem, RDC::OCC::BRepCheck_HListOfStatus::Iterator^ theIter);
			RDC::OCC::BRepCheck_Status InsertAfter(RDC::OCC::BRepCheck_Status theItem, RDC::OCC::BRepCheck_HListOfStatus::Iterator^ theIter);
			void Reverse();
			BRepCheck_HListOfStatus();
			static RDC::OCC::BRepCheck_HListOfStatus^ CreateDowncasted(::BRepCheck_HListOfStatus* instance);
		}; // class BRepCheck_HListOfStatus
		...
		public ref class BRepCheck_DataMapOfShapeListOfStatus sealed
			: public RDC::OCC::BaseClass<::BRepCheck_DataMapOfShapeListOfStatus>
		{
		...
		public:
			BRepCheck_DataMapOfShapeListOfStatus(::BRepCheck_DataMapOfShapeListOfStatus* nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_DataMapOfShapeListOfStatus>(nativeInstance, true)
			{}

			BRepCheck_DataMapOfShapeListOfStatus(::BRepCheck_DataMapOfShapeListOfStatus& nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_DataMapOfShapeListOfStatus>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::BRepCheck_DataMapOfShapeListOfStatus::Iterator>
			{
			...
			public:
				Iterator(::BRepCheck_DataMapOfShapeListOfStatus::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::BRepCheck_DataMapOfShapeListOfStatus::Iterator>(nativeInstance, true)
				{}

				Iterator(::BRepCheck_DataMapOfShapeListOfStatus::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::BRepCheck_DataMapOfShapeListOfStatus::Iterator>(&nativeInstance, false)
				{}
			...
			BRepCheck_DataMapOfShapeListOfStatus(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			BRepCheck_DataMapOfShapeListOfStatus(int theNbBuckets);
			void Exchange(RDC::OCC::BRepCheck_DataMapOfShapeListOfStatus^ theOther);
			RDC::OCC::BRepCheck_DataMapOfShapeListOfStatus^ Assign(RDC::OCC::BRepCheck_DataMapOfShapeListOfStatus^ theOther);
			void ReSize(int N);
		...
		public ref class BRepCheck_IndexedDataMapOfShapeResult sealed
			: public RDC::OCC::BaseClass<::BRepCheck_IndexedDataMapOfShapeResult>
		{
		...
		public:
			BRepCheck_IndexedDataMapOfShapeResult(::BRepCheck_IndexedDataMapOfShapeResult* nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_IndexedDataMapOfShapeResult>(nativeInstance, true)
			{}

			BRepCheck_IndexedDataMapOfShapeResult(::BRepCheck_IndexedDataMapOfShapeResult& nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_IndexedDataMapOfShapeResult>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::BRepCheck_IndexedDataMapOfShapeResult::Iterator>
			{
			...
			public:
				Iterator(::BRepCheck_IndexedDataMapOfShapeResult::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::BRepCheck_IndexedDataMapOfShapeResult::Iterator>(nativeInstance, true)
				{}

				Iterator(::BRepCheck_IndexedDataMapOfShapeResult::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::BRepCheck_IndexedDataMapOfShapeResult::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::BRepCheck_Result^ Value();
				RDC::OCC::BRepCheck_Result^ ChangeValue();
				RDC::OCC::TopoDS_Shape^ Key();
				bool IsEqual(RDC::OCC::BRepCheck_IndexedDataMapOfShapeResult::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			BRepCheck_IndexedDataMapOfShapeResult();
			BRepCheck_IndexedDataMapOfShapeResult(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			BRepCheck_IndexedDataMapOfShapeResult(int theNbBuckets);
			void Exchange(RDC::OCC::BRepCheck_IndexedDataMapOfShapeResult^ theOther);
			RDC::OCC::BRepCheck_IndexedDataMapOfShapeResult^ Assign(RDC::OCC::BRepCheck_IndexedDataMapOfShapeResult^ theOther);
			void ReSize(int N);
			int Add(RDC::OCC::TopoDS_Shape^ theKey1, RDC::OCC::BRepCheck_Result^ theItem);
			bool Contains(RDC::OCC::TopoDS_Shape^ theKey1);
			void Substitute(int theIndex, RDC::OCC::TopoDS_Shape^ theKey1, RDC::OCC::BRepCheck_Result^ theItem);
			...
			RDC::OCC::BRepCheck_Result^ FindFromIndex(int theIndex);
			RDC::OCC::BRepCheck_Result^ ChangeFromIndex(int theIndex);
			int FindIndex(RDC::OCC::TopoDS_Shape^ theKey1);
			RDC::OCC::BRepCheck_Result^ FindFromKey(RDC::OCC::TopoDS_Shape^ theKey1);
			RDC::OCC::BRepCheck_Result^ ChangeFromKey(RDC::OCC::TopoDS_Shape^ theKey1);
			RDC::OCC::BRepCheck_Result^ Seek(RDC::OCC::TopoDS_Shape^ theKey1);
			RDC::OCC::BRepCheck_Result^ ChangeSeek(RDC::OCC::TopoDS_Shape^ theKey1);
			void Clear(bool doReleaseMemory);
			void Clear();
			int Size();
		}; // class BRepCheck_IndexedDataMapOfShapeResult
		...
		public ref class BRepCheck sealed
			: public RDC::OCC::BaseClass<::BRepCheck>
		{
		...
		public:
			BRepCheck(::BRepCheck* nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck>(nativeInstance, true)
			{}

			BRepCheck(::BRepCheck& nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck>(&nativeInstance, false)
			{}
		...
		public:
			BRepCheck();
			static void Add(RDC::OCC::BRepCheck_ListOfStatus^ List, RDC::OCC::BRepCheck_Status Stat);
			static void Print(RDC::OCC::BRepCheck_Status Stat, System::IO::TextWriter^ OS);
			static bool SelfIntersection(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
			/// <summary>
			/// Returns the resolution on the 3d curve
			/// </summary>
			static double PrecCurve(RDC::OCC::Adaptor3d_Curve^ aAC3D);
			/// <summary>
			/// Returns the resolution on the surface
			/// </summary>
			static double PrecSurface(RDC::OCC::Adaptor3d_Surface^ aAHSurf);
		}; // class BRepCheck
		...
		public:
			...
			void InContext(RDC::OCC::TopoDS_Shape^ ContextShape);
			void Minimum();
			void Blind();
			void SetFailStatus(RDC::OCC::TopoDS_Shape^ S);
			RDC::OCC::BRepCheck_ListOfStatus^ Status();
			bool IsMinimum();
			bool IsBlind();
			void InitContextIterator();
			bool MoreShapeInContext();
			RDC::OCC::TopoDS_Shape^ ContextualShape();
			RDC::OCC::BRepCheck_ListOfStatus^ StatusOnShape();
			void NextShapeInContext();
			void SetParallel(bool theIsParallel);
			bool IsStatusOnShape(RDC::OCC::TopoDS_Shape^ theShape);
			RDC::OCC::BRepCheck_ListOfStatus^ StatusOnShape(RDC::OCC::TopoDS_Shape^ theShape);
			static RDC::OCC::BRepCheck_Result^ CreateDowncasted(::BRepCheck_Result* instance);
		}; // class BRepCheck_Result
		...
		public ref class BRepCheck_Analyzer sealed
			: public RDC::OCC::BaseClass<::BRepCheck_Analyzer>
		{
		...
		public:
			BRepCheck_Analyzer(::BRepCheck_Analyzer* nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_Analyzer>(nativeInstance, true)
			{}

			BRepCheck_Analyzer(::BRepCheck_Analyzer& nativeInstance)
				: RDC::OCC::BaseClass<::BRepCheck_Analyzer>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			BRepCheck_Analyzer(RDC::OCC::TopoDS_Shape^ S, bool GeomControls, bool theIsParallel, bool theIsExact);
			/// <summary>
			/// Constructs a shape validation object defined by the shape S.
			/// <S> is the  shape  to control.  <GeomControls>  If
			/// False   only topological informaions  are checked.
			...
			/// BRepCheck_SelfIntersectingWire
			/// </summary>
			BRepCheck_Analyzer(RDC::OCC::TopoDS_Shape^ S, bool GeomControls, bool theIsParallel);
			/// <summary>
			/// Constructs a shape validation object defined by the shape S.
			/// <S> is the  shape  to control.  <GeomControls>  If
			/// False   only topological informaions  are checked.
			...
			/// BRepCheck_SelfIntersectingWire
			/// </summary>
			BRepCheck_Analyzer(RDC::OCC::TopoDS_Shape^ S, bool GeomControls);
			/// <summary>
			/// Constructs a shape validation object defined by the shape S.
			/// <S> is the  shape  to control.  <GeomControls>  If
			/// False   only topological informaions  are checked.
			...
			/// BRepCheck_SelfIntersectingWire
			/// </summary>
			BRepCheck_Analyzer(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// <S> is the  shape  to control.  <GeomControls>  If
			/// False   only topological informaions  are checked.
			/// The geometricals controls are
			...
			/// BRepCheck_SelfIntersectingWire
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ S, bool GeomControls);
			/// <summary>
			/// <S> is the  shape  to control.  <GeomControls>  If
			/// False   only topological informaions  are checked.
			/// The geometricals controls are
			...
			/// </summary>
			bool IsValid(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			...
			/// </summary>
			bool IsValid();
			RDC::OCC::BRepCheck_Result^ Result(RDC::OCC::TopoDS_Shape^ theSubS);
		}; // class BRepCheck_Analyzer
		...
		public ref class BRepCheck_Edge sealed
			: public RDC::OCC::BRepCheck_Result
		{
		...
		public:
			BRepCheck_Edge(::BRepCheck_Edge* nativeInstance)
				: RDC::OCC::BRepCheck_Result(nativeInstance)
			{}
		...
		public:
			BRepCheck_Edge(RDC::OCC::TopoDS_Edge^ E);
			void InContext(RDC::OCC::TopoDS_Shape^ ContextShape);
			void Minimum();
			void Blind();
			...
			/// Sets status of Edge;
			/// </summary>
			void SetStatus(RDC::OCC::BRepCheck_Status theStatus);
			/// <summary>
			/// Sets method to calculate distance: Calculating in finite number of points (if theIsExact
			/// is false, faster, but possible not correct result) or exact calculating by using
			/// BRepLib_CheckCurveOnSurface class (if theIsExact is true, slowly, but more correctly).
			...
			/// </summary>
			RDC::OCC::BRepCheck_Status CheckPolygonOnTriangulation(RDC::OCC::TopoDS_Edge^ theEdge);
			static RDC::OCC::BRepCheck_Edge^ CreateDowncasted(::BRepCheck_Edge* instance);
		}; // class BRepCheck_Edge
		...
		public:
			BRepCheck_Face(RDC::OCC::TopoDS_Face^ F);
			void InContext(RDC::OCC::TopoDS_Shape^ ContextShape);
			void Minimum();
			void Blind();
			RDC::OCC::BRepCheck_Status IntersectWires(bool Update);
			RDC::OCC::BRepCheck_Status IntersectWires();
			RDC::OCC::BRepCheck_Status ClassifyWires(bool Update);
			RDC::OCC::BRepCheck_Status ClassifyWires();
			RDC::OCC::BRepCheck_Status OrientationOfWires(bool Update);
			RDC::OCC::BRepCheck_Status OrientationOfWires();
			...
			bool GeometricControls();
			void GeometricControls(bool B);
			static RDC::OCC::BRepCheck_Face^ CreateDowncasted(::BRepCheck_Face* instance);
		}; // class BRepCheck_Face
		...
		public:
			BRepCheck_Shell(RDC::OCC::TopoDS_Shell^ S);
			void InContext(RDC::OCC::TopoDS_Shape^ ContextShape);
			void Minimum();
			void Blind();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::BRepCheck_Status Closed(bool Update);
			/// <summary>
			/// Checks if the oriented  faces of the shell  give a
			/// closed shell.    If the  wire is  closed,  returns
			/// BRepCheck_NoError.If      <Update>     is  set  to
			/// Standard_True, registers the status in the list.
			/// </summary>
			RDC::OCC::BRepCheck_Status Closed();
			/// <summary>
			...
			/// Standard_True, registers the status in the list.
			/// </summary>
			RDC::OCC::BRepCheck_Status Orientation(bool Update);
			/// <summary>
			/// Checks if the   oriented faces  of  the shell  are
			/// correctly oriented.  An internal  call is  made to
			/// the  method  Closed.   If  <Update>    is set   to
			/// Standard_True, registers the status in the list.
			/// </summary>
			RDC::OCC::BRepCheck_Status Orientation();
			void SetUnorientable();
			bool IsUnorientable();
			int NbConnectedSet(RDC::OCC::TopTools_ListOfShape^ theSets);
			static RDC::OCC::BRepCheck_Shell^ CreateDowncasted(::BRepCheck_Shell* instance);
		}; // class BRepCheck_Shell
		...
		public:
			...
			/// </summary>
			BRepCheck_Solid(RDC::OCC::TopoDS_Solid^ theS);
			/// <summary>
			/// Checks the solid in context of
			/// the shape <theContextShape>
			/// </summary>
			void InContext(RDC::OCC::TopoDS_Shape^ theContextShape);
			/// <summary>
			...
			/// </summary>
			void Blind();
			static RDC::OCC::BRepCheck_Solid^ CreateDowncasted(::BRepCheck_Solid* instance);
		}; // class BRepCheck_Solid
		...
		public:
			BRepCheck_Vertex(RDC::OCC::TopoDS_Vertex^ V);
			void InContext(RDC::OCC::TopoDS_Shape^ ContextShape);
			void Minimum();
			void Blind();
			double Tolerance();
			static RDC::OCC::BRepCheck_Vertex^ CreateDowncasted(::BRepCheck_Vertex* instance);
		}; // class BRepCheck_Vertex
		...
		public:
			BRepCheck_Wire(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			...
			/// status in the list.
			/// </summary>
			RDC::OCC::BRepCheck_Status Closed2d(RDC::OCC::TopoDS_Face^ F, bool Update);
			/// <summary>
			/// Checks if edges of the  wire give a wire closed in
			/// 2d space.
			/// Returns BRepCheck_NoError,  or BRepCheck_NotClosed
			...
			/// status in the list.
			/// </summary>
			RDC::OCC::BRepCheck_Status Closed2d(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			...
			/// BRepCheck_NoError
			/// </summary>
			RDC::OCC::BRepCheck_Status Orientation(RDC::OCC::TopoDS_Face^ F, bool Update);
			/// <summary>
			/// Checks   if  the oriented edges   of  the wire are
			/// correctly oriented.  An  internal call is made  to
			/// the  method Closed.   If no face  exists, call the
			...
			/// BRepCheck_NoError
			/// </summary>
			RDC::OCC::BRepCheck_Status Orientation(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			...
			/// BRepCheck_NoError
			/// </summary>
			RDC::OCC::BRepCheck_Status SelfIntersect(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, bool Update);
			/// <summary>
			/// Checks if  the wire intersect   itself on the face
			/// <F>.  <E1>  and <E2>   are the first  intersecting
			/// edges  found.  <E2>  may  be a  null  edge when  a
			...
			/// BRepCheck_NoError
			/// </summary>
			RDC::OCC::BRepCheck_Status SelfIntersect(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
			/// <summary>
			...
			/// </summary>
			void SetStatus(RDC::OCC::BRepCheck_Status theStatus);
			static RDC::OCC::BRepCheck_Wire^ CreateDowncasted(::BRepCheck_Wire* instance);
		}; // class BRepCheck_Wire
