...
public:
    Message_ListOfAlert();
    Message_ListOfAlert(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    RDC::OCC::Message_ListOfAlert^ Assign(RDC::OCC::Message_ListOfAlert^ theOther);
...
public:
    ...
    /// </summary>
    RDC::OCC::Message_Gravity GetTraceLevel();
    /// <summary>
    /// Set trace level used for filtering messages.
    /// By default, trace level is Message_Info, so that all messages are output
    /// </summary>
    void SetTraceLevel(RDC::OCC::Message_Gravity theTraceLevel);
    /// <summary>
    /// Send a string message with specified trace level.
    /// The last Boolean argument is deprecated and unused.
    /// Default implementation redirects to send().
    /// </summary>
    void Send(RDC::OCC::TCollection_ExtendedString^ theString, RDC::OCC::Message_Gravity theGravity);
    /// <summary>
    /// Send a string message with specified trace level.
    /// The last Boolean argument is deprecated and unused.
    /// Default implementation redirects to send().
    /// </summary>
    void Send(System::String^ theString, RDC::OCC::Message_Gravity theGravity);
    /// <summary>
    /// Send a string message with specified trace level.
    /// The last Boolean argument is deprecated and unused.
    /// Default implementation redirects to send().
    /// </summary>
    void Send(RDC::OCC::TCollection_AsciiString^ theString, RDC::OCC::Message_Gravity theGravity);
    ...
    /// </summary>
    void SendObject(RDC::OCC::Standard_Transient^ theObject, RDC::OCC::Message_Gravity theGravity);
    static RDC::OCC::Message_Printer^ CreateDowncasted(::Message_Printer* instance);
}; // class Message_Printer
...
public:
    ...
    /// </summary>
    Message_Messenger(RDC::OCC::Message_Printer^ thePrinter);
    /// <summary>
    ...
    /// </summary>
    bool AddPrinter(RDC::OCC::Message_Printer^ thePrinter);
    /// <summary>
    /// Removes specified printer from the messenger.
    /// Returns True if this printer has been found in the list
    /// and removed.
    /// </summary>
    bool RemovePrinter(RDC::OCC::Message_Printer^ thePrinter);
    ...
    /// See above
    /// </summary>
    void Send(RDC::OCC::TCollection_AsciiString^ theString);
    /// <summary>
    /// See above
    /// </summary>
    void Send(RDC::OCC::TCollection_ExtendedString^ theString, RDC::OCC::Message_Gravity theGravity);
    ...
    /// See above
    /// </summary>
    void Send(RDC::OCC::TCollection_ExtendedString^ theString);
    /* Method skipped due to unknown mapping: StreamBuffer Send(Message_Gravity theGravity, ) */
    /// <summary>
    /// See above
    /// </summary>
    void Send(RDC::OCC::Standard_Transient^ theObject, RDC::OCC::Message_Gravity theGravity);
    /// <summary>
    /// See above
    /// </summary>
    void Send(RDC::OCC::Standard_Transient^ theObject);
    ...
    /// </summary>
    void SendFail(RDC::OCC::TCollection_AsciiString^ theMessage);
    /// <summary>
    /// Short-cut to Send (theMessage, Message_Alarm)
    /// </summary>
    void SendAlarm(RDC::OCC::TCollection_AsciiString^ theMessage);
    /// <summary>
    /// Short-cut to Send (theMessage, Message_Warning)
    /// </summary>
    void SendWarning(RDC::OCC::TCollection_AsciiString^ theMessage);
    /// <summary>
    /// Short-cut to Send (theMessage, Message_Info)
    /// </summary>
    void SendInfo(RDC::OCC::TCollection_AsciiString^ theMessage);
    /// <summary>
    /// Short-cut to Send (theMessage, Message_Trace)
    /// </summary>
    void SendTrace(RDC::OCC::TCollection_AsciiString^ theMessage);
    /// <summary>
    ...
    static RDC::OCC::Message_Messenger^ CreateDowncasted(::Message_Messenger* instance);
}; // class Message_Messenger
...
public:
    ...
    /// </summary>
    RDC::OCC::Message_ListOfAlert^ GetAlerts(RDC::OCC::Message_Gravity theGravity);
    ...
    /// </param>
    bool IsActiveInMessenger(RDC::OCC::Message_Messenger^ theMessenger);
    /// <summary>
    /// Returns true if a report printer for the current report is registered in the messenger
    /// </summary>
    /// <param name="theMessenger">
    ...
    /// the messenger. If it's NULL, the default messenger is used
    /// </param>
    void ActivateInMessenger(bool toActivate, RDC::OCC::Message_Messenger^ theMessenger);
    /// <summary>
    /// Creates an instance of Message_PrinterToReport with the current report and register it in messenger
    /// </summary>
    /// <param name="toActivate">
    ...
    /// the messenger. If it's NULL, the default messenger is used
    /// </param>
    void UpdateActiveInMessenger(RDC::OCC::Message_Messenger^ theMessenger);
    /// <summary>
    /// Updates internal flag IsActiveInMessenger.
    /// It becomes true if messenger contains at least one instance of Message_PrinterToReport.
    /// </summary>
    ...
    /// </summary>
    void Clear(RDC::OCC::Message_Gravity theGravity);
    ...
    /// </param>
    void SetActiveMetric(RDC::OCC::Message_MetricType theMetricType, bool theActivate);
    /// <summary>
    ...
    /// </summary>
    void Dump(System::IO::TextWriter^ theOS, RDC::OCC::Message_Gravity theGravity);
    /// <summary>
    /// Sends all collected alerts to messenger.
    /// </summary>
    void SendMessages(RDC::OCC::Message_Messenger^ theMessenger);
    /// <summary>
    ...
    /// </summary>
    void SendMessages(RDC::OCC::Message_Messenger^ theMessenger, RDC::OCC::Message_Gravity theGravity);
    /// <summary>
    /// Merges data from theOther report into this
    /// </summary>
    void Merge(RDC::OCC::Message_Report^ theOther);
    /// <summary>
    /// Merges alerts with specified gravity from theOther report into this
    /// </summary>
    void Merge(RDC::OCC::Message_Report^ theOther, RDC::OCC::Message_Gravity theGravity);
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Message_Report^ CreateDowncasted(::Message_Report* instance);
}; // class Message_Report
...
public ref class Message sealed
    : public RDC::OCC::BaseClass<::Message>
{
...
public:
    Message(::Message* nativeInstance)
        : RDC::OCC::BaseClass<::Message>( nativeInstance, true )
    {}

    Message(::Message& nativeInstance)
        : RDC::OCC::BaseClass<::Message>( &nativeInstance, false )
    {}
...
public:
    ...
    /// @endcode
    static RDC::OCC::Message_Messenger^ DefaultMessenger();
    /* Method skipped due to unknown mapping: StreamBuffer Send(Message_Gravity theGravity, ) */
    static void Send(RDC::OCC::TCollection_AsciiString^ theMessage, RDC::OCC::Message_Gravity theGravity);
    /* Method skipped due to unknown mapping: StreamBuffer SendFail() */
    /* Method skipped due to unknown mapping: StreamBuffer SendAlarm() */
    /* Method skipped due to unknown mapping: StreamBuffer SendWarning() */
    /* Method skipped due to unknown mapping: StreamBuffer SendInfo() */
    /* Method skipped due to unknown mapping: StreamBuffer SendTrace() */
    static void SendFail(RDC::OCC::TCollection_AsciiString^ theMessage);
    static void SendAlarm(RDC::OCC::TCollection_AsciiString^ theMessage);
    static void SendWarning(RDC::OCC::TCollection_AsciiString^ theMessage);
    static void SendInfo(RDC::OCC::TCollection_AsciiString^ theMessage);
    static void SendTrace(RDC::OCC::TCollection_AsciiString^ theMessage);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::TCollection_AsciiString^ FillTime(int Hour, int Minute, double Second);
    /// <summary>
    /// returns the only one instance of Report
    /// When theToCreate is true - automatically creates message report when not exist.
    /// </summary>
    static RDC::OCC::Message_Report^ DefaultReport(bool theToCreate);
    /// <summary>
    /// returns the only one instance of Report
    /// When theToCreate is true - automatically creates message report when not exist.
    /// </summary>
    static RDC::OCC::Message_Report^ DefaultReport();
    /// <summary>
    ...
    /// </returns>
    static bool MetricFromString(System::String^ theString, RDC::OCC::Message_MetricType% theType);
    /// <summary>
    ...
    /// </returns>
    static System::String^ MetricToString(RDC::OCC::Message_MetricType theType);
    /// <summary>
    ...
    /// </returns>
    static RDC::OCC::Message_MetricType MetricFromString(System::String^ theString);
...
public ref class Message_ProgressRange sealed
    : public RDC::OCC::BaseClass<::Message_ProgressRange>
{
...
public:
    Message_ProgressRange(::Message_ProgressRange* nativeInstance)
        : RDC::OCC::BaseClass<::Message_ProgressRange>( nativeInstance, true )
    {}

    Message_ProgressRange(::Message_ProgressRange& nativeInstance)
        : RDC::OCC::BaseClass<::Message_ProgressRange>( &nativeInstance, false )
    {}
