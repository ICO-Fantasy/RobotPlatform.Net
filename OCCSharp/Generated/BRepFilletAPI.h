...
public:
    ...
    /// </summary>
    int Contour(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Edge^ Edge(int I, int J);
    /// <summary>
    /// remove the contour containing the Edge E.
    /// </summary>
    void Remove(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ FirstVertex(int IC);
    /// <summary>
    /// Returns the last Vertex of the contour of index IC.
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ LastVertex(int IC);
    /// <summary>
    /// returns the abscissa of the vertex V on
    /// the contour of index IC.
    /// </summary>
    double Abscissa(int IC, RDC::OCC::TopoDS_Vertex^ V);
    /// <summary>
    /// returns the relative abscissa([0.,1.]) of the
    /// vertex V on the contour of index IC.
    /// </summary>
    double RelativeAbscissa(int IC, RDC::OCC::TopoDS_Vertex^ V);
    /// <summary>
...
public ref class BRepFilletAPI_MakeChamfer sealed
    : public RDC::OCC::BRepFilletAPI_LocalOperation
{
...
public:
    BRepFilletAPI_MakeChamfer(::BRepFilletAPI_MakeChamfer* nativeInstance)
        : RDC::OCC::BRepFilletAPI_LocalOperation( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    BRepFilletAPI_MakeChamfer(RDC::OCC::TopoDS_Shape^ S);
    /// <summary>
    ...
    /// </summary>
    void Add(double Dis, RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    ...
    /// </summary>
    void SetDist(double Dis, int IC, RDC::OCC::TopoDS_Face^ F);
    ...
    /// Nothing is done if edge E or the face F does not belong to the initial shape.
    /// </summary>
    void Add(double Dis1, double Dis2, RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// Sets the distances Dis1 and Dis2 which give the
    /// parameters of the chamfer along the contour of index
    /// IC generated using the Add function in the internal
    ...
    /// does not belong to the initial shape.
    /// </summary>
    void SetDists(double Dis1, double Dis2, int IC, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    ...
    /// </summary>
    void AddDA(double Dis, double Angle, RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    ...
    /// </summary>
    void SetDistAngle(double Dis, double Angle, int IC, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    ...
    /// shape <EorV>.
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ Generated(RDC::OCC::TopoDS_Shape^ EorV);
    /// <summary>
...
public:
    ...
    /// </summary>
    BRepFilletAPI_MakeFillet(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::ChFi3d_FilletShape FShape);
    /// <summary>
    /// Initializes   the computation    of   the  fillets.
    /// <FShape> sets   the type   of fillet  surface. The
    /// default value is ChFi3d_Rational (classical  nurbs
    ...
    /// representation of circles.
    /// </summary>
    BRepFilletAPI_MakeFillet(RDC::OCC::TopoDS_Shape^ S);
    ...
    /// and support'faces.
    /// </summary>
    void SetContinuity(RDC::OCC::GeomAbs_Shape InternalContinuity, double AngularTolerance);
    /// <summary>
    /// Adds a  fillet contour in  the  builder  (builds a
    /// contour  of tangent edges).
    ...
    /// - sets the radius.
    /// </summary>
    void Add(double Radius, RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// Adds a  fillet description in  the  builder
    /// - builds a contour  of tangent edges,
    ...
    /// </summary>
    void Add(double R1, double R2, RDC::OCC::TopoDS_Edge^ E);
    ...
    /// </summary>
    void Add(RDC::OCC::TColgp_Array1OfPnt2d^ UandR, RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    ...
    /// </summary>
    void SetRadius(RDC::OCC::TColgp_Array1OfPnt2d^ UandR, int IC, int IinC);
    /// <summary>
    ...
    /// of contours or if E does not belong to the contour of index IC.
    /// </summary>
    bool IsConstant(int IC, RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    ...
    /// table of contours or if E does not belong to the contour of index IC.
    /// </summary>
    double Radius(int IC, RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// Assigns Radius as the radius of the fillet on the edge E
    /// </summary>
    void SetRadius(double Radius, int IC, RDC::OCC::TopoDS_Edge^ E);
    void SetRadius(double Radius, int IC, RDC::OCC::TopoDS_Vertex^ V);
    bool GetBounds(int IC, RDC::OCC::TopoDS_Edge^ E, double% F, double% L);
    ...
    /// </summary>
    void SetFilletShape(RDC::OCC::ChFi3d_FilletShape FShape);
    /// <summary>
    /// Returns the type of fillet shape built by this algorithm.
    /// </summary>
    RDC::OCC::ChFi3d_FilletShape GetFilletShape();
    /// <summary>
    /// Returns the number of contours generated using the
    /// Add function in the internal data structure of this algorithm.
    /// </summary>
    ...
    /// </summary>
    RDC::OCC::Geom_Surface^ ComputedSurface(int IC, int IS);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ FaultyVertex(int IV);
    /// <summary>
...
public:
    ...
    /// -   ChFi2d_NoFace if F is a null face.
    /// </summary>
    BRepFilletAPI_MakeFillet2d(RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    ...
    /// </summary>
    void Init(RDC::OCC::TopoDS_Face^ RefFace, RDC::OCC::TopoDS_Face^ ModFace);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Edge^ AddFillet(RDC::OCC::TopoDS_Vertex^ V, double Radius);
    /// <summary>
    ...
    /// Standard_NegativeValue if Radius is less than or equal to zero.
    /// </summary>
    RDC::OCC::TopoDS_Edge^ ModifyFillet(RDC::OCC::TopoDS_Edge^ Fillet, double Radius);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ RemoveFillet(RDC::OCC::TopoDS_Edge^ Fillet);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Edge^ AddChamfer(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double D1, double D2);
    /// <summary>
    /// Adds a chamfer on the face modified by this algorithm
    ...
    /// </summary>
    RDC::OCC::TopoDS_Edge^ AddChamfer(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Vertex^ V, double D, double Ang);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Edge^ ModifyChamfer(RDC::OCC::TopoDS_Edge^ Chamfer, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double D1, double D2);
    /// <summary>
    /// Modifies the chamfer Chamfer on the face modified
    /// by this algorithm, where:
    ...
    /// construction is not ChFi2d_IsDone.
    /// </summary>
    RDC::OCC::TopoDS_Edge^ ModifyChamfer(RDC::OCC::TopoDS_Edge^ Chamfer, RDC::OCC::TopoDS_Edge^ E, double D, double Ang);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ RemoveChamfer(RDC::OCC::TopoDS_Edge^ Chamfer);
    /// <summary>
    ...
    /// </summary>
    bool IsModified(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// Returns the table of fillets on the face modified by this algorithm.
    /// </summary>
    RDC::OCC::TopTools_SequenceOfShape^ FilletEdges();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopTools_SequenceOfShape^ ChamferEdges();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ NewEdges(int I);
    bool HasDescendant(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    ...
    /// belong to the initial face.
    /// </summary>
    RDC::OCC::TopoDS_Edge^ DescendantEdge(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Edge^ BasisEdge(RDC::OCC::TopoDS_Edge^ E);
