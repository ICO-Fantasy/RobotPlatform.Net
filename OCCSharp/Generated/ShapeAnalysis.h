...
public ref class ShapeAnalysis_BoxBndTree sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_BoxBndTree>
{
...
public:
    ShapeAnalysis_BoxBndTree(::ShapeAnalysis_BoxBndTree* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_BoxBndTree>( nativeInstance, true )
    {}

    ShapeAnalysis_BoxBndTree(::ShapeAnalysis_BoxBndTree& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_BoxBndTree>( &nativeInstance, false )
    {}
...
public:
    ...
    ShapeAnalysis_BoxBndTree(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
...
public ref class ShapeAnalysis_DataMapOfShapeListOfReal sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal>
{
...
public:
    ShapeAnalysis_DataMapOfShapeListOfReal(::ShapeAnalysis_DataMapOfShapeListOfReal* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal>( nativeInstance, true )
    {}

    ShapeAnalysis_DataMapOfShapeListOfReal(::ShapeAnalysis_DataMapOfShapeListOfReal& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator>
    {
    ...
    public:
        Iterator(::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::TColStd_ListOfReal^ Value();
        RDC::OCC::TColStd_ListOfReal^ ChangeValue();
        RDC::OCC::TopoDS_Shape^ Key();
    }; // class Iterator

    ShapeAnalysis_DataMapOfShapeListOfReal();
    ShapeAnalysis_DataMapOfShapeListOfReal(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    ShapeAnalysis_DataMapOfShapeListOfReal(int theNbBuckets);
    void Exchange(RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ theOther);
    RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ Assign(RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ theOther);
    void ReSize(int N);
    bool Bind(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::TColStd_ListOfReal^ theItem);
    RDC::OCC::TColStd_ListOfReal^ Bound(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::TColStd_ListOfReal^ theItem);
    bool IsBound(RDC::OCC::TopoDS_Shape^ theKey);
    bool UnBind(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::TColStd_ListOfReal^ Seek(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::TColStd_ListOfReal^ Find(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::TColStd_ListOfReal^ ChangeSeek(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::TColStd_ListOfReal^ ChangeFind(RDC::OCC::TopoDS_Shape^ theKey);
...
public ref class ShapeAnalysis_SequenceOfFreeBounds sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds>
    , public IIndexEnumerable<RDC::OCC::ShapeAnalysis_FreeBoundData^>
{
...
public:
    ShapeAnalysis_SequenceOfFreeBounds(::ShapeAnalysis_SequenceOfFreeBounds* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds>( nativeInstance, true )
    {}

    ShapeAnalysis_SequenceOfFreeBounds(::ShapeAnalysis_SequenceOfFreeBounds& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds::Iterator>
    {
    ...
    public:
        Iterator(::ShapeAnalysis_SequenceOfFreeBounds::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds::Iterator>( nativeInstance, true )
        {}

        Iterator(::ShapeAnalysis_SequenceOfFreeBounds::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::ShapeAnalysis_FreeBoundData^ Value();
        RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeValue();
        bool IsEqual(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    ShapeAnalysis_SequenceOfFreeBounds();
    ShapeAnalysis_SequenceOfFreeBounds(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ Assign(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theOther);
    void Remove(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator^ thePosition);
    void Append(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void Prepend(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void InsertAfter(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator^ thePosition, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void Split(int theIndex, RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theSeq);
    RDC::OCC::ShapeAnalysis_FreeBoundData^ First();
    RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeFirst();
    RDC::OCC::ShapeAnalysis_FreeBoundData^ Last();
    RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeLast();
    virtual RDC::OCC::ShapeAnalysis_FreeBoundData^ Value(int theIndex);
    RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>^ GetEnumerator();
...
public ref class ShapeAnalysis sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis>
{
...
public:
    ShapeAnalysis(::ShapeAnalysis* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis>( nativeInstance, true )
    {}

    ShapeAnalysis(::ShapeAnalysis& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static RDC::OCC::TopoDS_Wire^ OuterWire(RDC::OCC::TopoDS_Face^ theFace);
    ...
    /// </summary>
    static double ContourArea(RDC::OCC::TopoDS_Wire^ theWire);
    /// <summary>
    /// Returns True if <F> has outer bound.
    /// </summary>
    static bool IsOuterBound(RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    ...
    /// </summary>
    static void FindBounds(RDC::OCC::TopoDS_Shape^ shape, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
    /// <summary>
    /// Computes exact UV bounds of all wires on the face
    /// </summary>
    static void GetFaceUVBounds(RDC::OCC::TopoDS_Face^ F, double% Umin, double% Umax, double% Vmin, double% Vmax);
}; // class ShapeAnalysis
...
public ref class ShapeAnalysis_CanonicalRecognition sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_CanonicalRecognition>
{
...
public:
    ShapeAnalysis_CanonicalRecognition(::ShapeAnalysis_CanonicalRecognition* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_CanonicalRecognition>( nativeInstance, true )
    {}

    ShapeAnalysis_CanonicalRecognition(::ShapeAnalysis_CanonicalRecognition& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_CanonicalRecognition>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    ShapeAnalysis_CanonicalRecognition(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    /// Sets shape
    /// </summary>
    ...
    /// </summary>
    bool IsPlane(double theTol, RDC::OCC::Pln% thePln);
    /// <summary>
    ...
    /// </summary>
    bool IsCylinder(double theTol, RDC::OCC::gp_Cylinder^ theCyl);
    /// <summary>
    ...
    /// </summary>
    bool IsCone(double theTol, RDC::OCC::gp_Cone^ theCone);
    /// <summary>
    ...
    /// </summary>
    bool IsCircle(double theTol, RDC::OCC::gp_Circ^ theCirc);
    /// <summary>
    ...
    /// </summary>
    bool IsEllipse(double theTol, RDC::OCC::gp_Elips^ theElips);
}; // class ShapeAnalysis_CanonicalRecognition
...
public ref class ShapeAnalysis_CheckSmallFace sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_CheckSmallFace>
{
...
public:
    ShapeAnalysis_CheckSmallFace(::ShapeAnalysis_CheckSmallFace* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_CheckSmallFace>( nativeInstance, true )
    {}

    ShapeAnalysis_CheckSmallFace(::ShapeAnalysis_CheckSmallFace& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_CheckSmallFace>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    int IsSpotFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Pnt% spot, double% spotol, double tol);
    /// <summary>
    /// Checks if a Face is as a Spot
    /// Returns 0 if not, 1 if yes, 2 if yes and all vertices are the
    /// same
    ...
    /// half of max dimension of min-max box of the face
    /// </summary>
    int IsSpotFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Pnt% spot, double% spotol);
    /// <summary>
    /// Acts as IsSpotFace, but records in <infos> a diagnostic
    /// "SpotFace" with the Pnt as value (data "Location")
    /// </summary>
    bool CheckSpotFace(RDC::OCC::TopoDS_Face^ F, double tol);
    /// <summary>
    /// Acts as IsSpotFace, but records in <infos> a diagnostic
    /// "SpotFace" with the Pnt as value (data "Location")
    /// </summary>
    bool CheckSpotFace(RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    ...
    /// </summary>
    bool IsStripSupport(RDC::OCC::TopoDS_Face^ F, double tol);
    /// <summary>
    /// Checks if a Face lies on a Surface which is a strip
    /// So the Face is a strip. But a Face may be a strip elsewhere ..
    /// 
    ...
    /// Returns 0 if not a strip support, 1 strip in U, 2 strip in V
    /// </summary>
    bool IsStripSupport(RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// Checks if two edges define a strip, i.e. distance maxi below
    /// tolerance, given or some of those of E1 and E2
    /// </summary>
    bool CheckStripEdges(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol, double% dmax);
    /// <summary>
    ...
    /// </summary>
    bool FindStripEdges(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol, double% dmax);
    /// <summary>
    ...
    /// </summary>
    bool CheckSingleStrip(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol);
    /// <summary>
    /// Checks if a Face is a single strip, i.e. brings two great
    /// edges which are confused on their whole length, possible other
    /// edges are small or null length
    ...
    /// Records diagnostic in info if it is a single strip
    /// </summary>
    bool CheckSingleStrip(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
    /// <summary>
    ...
    /// </summary>
    bool CheckStripFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol);
    /// <summary>
    /// Checks if a Face is as a Strip
    /// Returns 0 if not or non determined, 1 if in U, 2 if in V
    /// By default, considers the tolerance zone of its edges
    ...
    /// "List1" , "List2" (if they could be computed)
    /// </summary>
    bool CheckStripFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
    /// <summary>
    ...
    /// </summary>
    int CheckSplittingVertices(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ MapEdges, RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ MapParam, RDC::OCC::TopoDS_Compound^ theAllVert);
    /// <summary>
    ...
    /// </summary>
    bool CheckPin(RDC::OCC::TopoDS_Face^ F, int% whatrow, int% sence);
    /// <summary>
    /// Checks if a Face is twisted (apart from checking Pin, i.e. it
    /// does not give information on pin, only "it is twisted")
    /// </summary>
    bool CheckTwisted(RDC::OCC::TopoDS_Face^ F, double% paramu, double% paramv);
    bool CheckPinFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopTools_DataMapOfShapeShape^ mapEdges, double toler);
    bool CheckPinFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopTools_DataMapOfShapeShape^ mapEdges);
    bool CheckPinEdges(RDC::OCC::TopoDS_Edge^ theFirstEdge, RDC::OCC::TopoDS_Edge^ theSecondEdge, double coef1, double coef2, double toler);
...
public ref class ShapeAnalysis_Curve sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_Curve>
{
...
public:
    ShapeAnalysis_Curve(::ShapeAnalysis_Curve* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Curve>( nativeInstance, true )
    {}

    ShapeAnalysis_Curve(::ShapeAnalysis_Curve& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Curve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// computed one.
    /// </summary>
    double Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, bool AdjustToEnds);
    /// <summary>
    /// Projects a Point on a Curve.
    /// Computes the projected point and its parameter on the curve.
    /// <preci> is used as 3d precision (hence, 0 will produce
    ...
    /// computed one.
    /// </summary>
    double Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param);
    /// <summary>
    /// Projects a Point on a Curve.
    /// Computes the projected point and its parameter on the curve.
    /// <preci> is used as 3d precision (hence, 0 will produce
    ...
    /// computed one.
    /// </summary>
    double Project(RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, bool AdjustToEnds);
    /// <summary>
    /// Projects a Point on a Curve.
    /// Computes the projected point and its parameter on the curve.
    /// <preci> is used as 3d precision (hence, 0 will produce
    ...
    /// computed one.
    /// </summary>
    double Project(RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param);
    /// <summary>
    ...
    /// of the curve if distance is less than <preci>
    /// </summary>
    double Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl, bool AdjustToEnds);
    /// <summary>
    /// Projects a Point on a Curve, but parameters are limited
    /// between <cf> and <cl>.
    /// The range [cf, cl] is extended with help of Adaptor3d on the
    ...
    /// of the curve if distance is less than <preci>
    /// </summary>
    double Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl);
    double ProjectAct(RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param);
    /// <summary>
    ...
    /// of the curve if distance is less than <preci>
    /// </summary>
    double NextProject(double paramPrev, RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl, bool AdjustToEnds);
    /// <summary>
    /// Projects a Point on a Curve using Newton method.
    /// <paramPrev> is taken as the first approximation of solution.
    /// If Newton algorithm fails the method Project() is used.
    ...
    /// of the curve if distance is less than <preci>
    /// </summary>
    double NextProject(double paramPrev, RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl);
    /// <summary>
    /// Projects a Point on a Curve using Newton method.
    /// <paramPrev> is taken as the first approximation of solution.
    /// If Newton algorithm fails the method Project() is used.
    /// </summary>
    double NextProject(double paramPrev, RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param);
    /// <summary>
    ...
    /// </summary>
    bool ValidateRange(RDC::OCC::Geom_Curve^ Crv, double% First, double% Last, double prec);
    /// <summary>
    ...
    /// </summary>
    void FillBndBox(RDC::OCC::Geom2d_Curve^ C2d, double First, double Last, int NPoints, bool Exact, RDC::OCC::Bnd_Box2d^ Box);
    /// <summary>
    /// Defines which pcurve (C1 or C2) should be chosen for FORWARD
    /// seam edge.
    /// </summary>
    int SelectForwardSeam(RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2);
    /// <summary>
    /// Checks if points are planar with given preci. If Normal has not zero
    /// modulus, checks with given normal
    /// </summary>
    static bool IsPlanar(RDC::OCC::TColgp_Array1OfPnt^ pnts, RDC::OCC::XYZ% Normal, double preci);
    /// <summary>
    /// Checks if points are planar with given preci. If Normal has not zero
    /// modulus, checks with given normal
    /// </summary>
    static bool IsPlanar(RDC::OCC::TColgp_Array1OfPnt^ pnts, RDC::OCC::XYZ% Normal);
    /// <summary>
    /// Checks if curve is planar with given preci. If Normal has not zero
    /// modulus, checks with given normal
    /// </summary>
    static bool IsPlanar(RDC::OCC::Geom_Curve^ curve, RDC::OCC::XYZ% Normal, double preci);
    /// <summary>
    /// Checks if curve is planar with given preci. If Normal has not zero
    /// modulus, checks with given normal
    /// </summary>
    static bool IsPlanar(RDC::OCC::Geom_Curve^ curve, RDC::OCC::XYZ% Normal);
    /// <summary>
    ...
    /// </summary>
    static bool GetSamplePoints(RDC::OCC::Geom2d_Curve^ curve, double first, double last, RDC::OCC::TColgp_SequenceOfPnt2d^ seq);
    /// <summary>
    /// Returns sample points which will serve as linearisation
    /// of the curve in range (first, last)
    /// </summary>
    static bool GetSamplePoints(RDC::OCC::Geom_Curve^ curve, double first, double last, RDC::OCC::TColgp_SequenceOfPnt^ seq);
    /// <summary>
    /// Tells if the Curve is closed with given precision.
    /// If <preci> < 0 then Precision::Confusion is used.
    /// </summary>
    static bool IsClosed(RDC::OCC::Geom_Curve^ curve, double preci);
    /// <summary>
    /// Tells if the Curve is closed with given precision.
    /// If <preci> < 0 then Precision::Confusion is used.
    /// </summary>
    static bool IsClosed(RDC::OCC::Geom_Curve^ curve);
    /// <summary>
    ...
    /// </summary>
    static bool IsPeriodic(RDC::OCC::Geom_Curve^ curve);
    /// <summary>
    /// The same as for Curve3d.
    /// </summary>
    static bool IsPeriodic(RDC::OCC::Geom2d_Curve^ curve);
}; // class ShapeAnalysis_Curve
...
public ref class ShapeAnalysis_Edge sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_Edge>
{
...
public:
    ShapeAnalysis_Edge(::ShapeAnalysis_Edge* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Edge>( nativeInstance, true )
    {}

    ShapeAnalysis_Edge(::ShapeAnalysis_Edge& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Edge>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    bool HasCurve3d(RDC::OCC::TopoDS_Edge^ edge);
    /// <summary>
    ...
    /// </summary>
    bool Curve3d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Curve^ C3d, double% cf, double% cl, bool orient);
    /// <summary>
    /// Returns the 3d curve and bounding parameteres for the edge
    /// Returns False if no 3d curve.
    /// If <orient> is True (default), takes orientation into account:
    /// if the edge is reversed, cf and cl are toggled
    /// </summary>
    bool Curve3d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Curve^ C3d, double% cf, double% cl);
    /// <summary>
    /// Gives True if the edge has a 3d curve, this curve is closed,
    /// and the edge has the same vertex at start and end
    /// </summary>
    bool IsClosed3d(RDC::OCC::TopoDS_Edge^ edge);
    /// <summary>
    /// Tells if the Edge has a pcurve on the face.
    /// </summary>
    bool HasPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    /// Tells if the edge has a pcurve on the surface (with location).
    /// </summary>
    bool HasPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location);
    bool PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl, bool orient);
    bool PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl);
    /// <summary>
    ...
    /// if the edge is reversed, cf and cl are toggled
    /// </summary>
    bool PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl, bool orient);
    /// <summary>
    /// Returns the pcurve and bounding parameteres for the edge
    /// lying on the surface.
    /// Returns False if the edge has no pcurve on this surface.
    ...
    /// if the edge is reversed, cf and cl are toggled
    /// </summary>
    bool PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl);
    bool BoundUV(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, RDC::OCC::Pnt2d% first, RDC::OCC::Pnt2d% last);
    /// <summary>
    /// Returns the ends of pcurve
    /// Calls method PCurve with <orient> equal to True
    /// </summary>
    bool BoundUV(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, RDC::OCC::Pnt2d% first, RDC::OCC::Pnt2d% last);
    bool IsSeam(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    /// Returns True if the edge has two pcurves on one surface
    /// </summary>
    bool IsSeam(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location);
    /// <summary>
    /// Returns start vertex of the edge (taking edge orientation
    /// into account).
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ FirstVertex(RDC::OCC::TopoDS_Edge^ edge);
    /// <summary>
    /// Returns end vertex of the edge (taking edge orientation
    /// into account).
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ LastVertex(RDC::OCC::TopoDS_Edge^ edge);
    bool GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang, double dparam);
    bool GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang);
    /// <summary>
    ...
    /// </summary>
    bool GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang, double dparam);
    /// <summary>
    /// Returns tangent of the edge pcurve at its start (if atEnd is
    /// False) or end (if True), regarding the orientation of edge.
    /// If edge is REVERSED, tangent is reversed before return.
    ...
    /// and is not null, else False.
    /// </summary>
    bool GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang);
    /// <summary>
    ...
    /// </summary>
    bool CheckVerticesWithCurve3d(RDC::OCC::TopoDS_Edge^ edge, double preci, int vtx);
    /// <summary>
    /// Checks the start and/or end vertex of the edge for matching
    /// with 3d curve with the given precision.
    /// <vtx> = 1 : start vertex only
    ...
    /// tolerances, else with the given <preci>.
    /// </summary>
    bool CheckVerticesWithCurve3d(RDC::OCC::TopoDS_Edge^ edge, double preci);
    /// <summary>
    /// Checks the start and/or end vertex of the edge for matching
    /// with 3d curve with the given precision.
    /// <vtx> = 1 : start vertex only
    ...
    /// tolerances, else with the given <preci>.
    /// </summary>
    bool CheckVerticesWithCurve3d(RDC::OCC::TopoDS_Edge^ edge);
    bool CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, double preci, int vtx);
    bool CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, double preci);
    bool CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    /// Checks the start and/or end vertex of the edge for matching
    ...
    /// tolerances, else with the given <preci>.
    /// </summary>
    bool CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, double preci, int vtx);
    /// <summary>
    /// Checks the start and/or end vertex of the edge for matching
    /// with pcurve with the given precision.
    /// <vtx> = 1 : start vertex
    ...
    /// tolerances, else with the given <preci>.
    /// </summary>
    bool CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, double preci);
    /// <summary>
    /// Checks the start and/or end vertex of the edge for matching
    /// with pcurve with the given precision.
    /// <vtx> = 1 : start vertex
    ...
    /// tolerances, else with the given <preci>.
    /// </summary>
    bool CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location);
    bool CheckVertexTolerance(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, double% toler1, double% toler2);
    /// <summary>
    ...
    /// </summary>
    bool CheckVertexTolerance(RDC::OCC::TopoDS_Edge^ edge, double% toler1, double% toler2);
    bool CheckCurve3dWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    /// Checks mutual orientation of 3d curve and pcurve on the
    /// analysis of curves bounding points
    /// </summary>
    bool CheckCurve3dWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location);
    /* Method skipped due to unknown mapping: bool Status(ShapeExtend_Status status, ) */
    /// <summary>
    ...
    /// </summary>
    bool CheckSameParameter(RDC::OCC::TopoDS_Edge^ edge, double% maxdev, int NbControl);
    /// <summary>
    /// Checks the edge to be SameParameter.
    /// Calculates the maximal deviation between 3d curve and each
    /// pcurve of the edge on <NbControl> equidistant points (the same
    ...
    /// incorrect flag) returns False, else returns True.
    /// </summary>
    bool CheckSameParameter(RDC::OCC::TopoDS_Edge^ edge, double% maxdev);
    /// <summary>
    /// Checks the edge to be SameParameter.
    /// Calculates the maximal deviation between 3d curve and each
    /// pcurve of the edge on <NbControl> equidistant points (the same
    ...
    /// incorrect flag) returns False, else returns True.
    /// </summary>
    bool CheckSameParameter(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace, double% theMaxdev, int theNbControl);
    /// <summary>
    /// Checks the edge to be SameParameter.
    /// Calculates the maximal deviation between 3d curve and each
    /// pcurve of the edge on <NbControl> equidistant points (the same
    ...
    /// incorrect flag) returns False, else returns True.
    /// </summary>
    bool CheckSameParameter(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace, double% theMaxdev);
    /// <summary>
    ...
    /// </summary>
    bool CheckPCurveRange(double theFirst, double theLast, RDC::OCC::Geom2d_Curve^ thePC);
    /// <summary>
    ...
    /// </summary>
    bool CheckOverlapping(RDC::OCC::TopoDS_Edge^ theEdge1, RDC::OCC::TopoDS_Edge^ theEdge2, double% theTolOverlap, double theDomainDist);
    /// <summary>
    /// Checks the first edge is overlapped with second edge.
    /// If distance between two edges is less then theTolOverlap
    /// edges are overlapped.
    /// theDomainDis - length of part of edges on which edges are overlapped.
    /// </summary>
    bool CheckOverlapping(RDC::OCC::TopoDS_Edge^ theEdge1, RDC::OCC::TopoDS_Edge^ theEdge2, double% theTolOverlap);
}; // class ShapeAnalysis_Edge
...
public:
    ...
    /// </summary>
    ShapeAnalysis_FreeBoundData(RDC::OCC::TopoDS_Wire^ freebound);
    /// <summary>
    ...
    /// Sets contour
    /// </summary>
    void SetFreeBound(RDC::OCC::TopoDS_Wire^ freebound);
    /// <summary>
    ...
    /// </summary>
    void AddNotch(RDC::OCC::TopoDS_Wire^ notch, double width);
    /// <summary>
    /// Returns contour
    /// </summary>
    RDC::OCC::TopoDS_Wire^ FreeBound();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopTools_HSequenceOfShape^ Notches();
    /// <summary>
    /// Returns notch on the contour
    /// </summary>
    RDC::OCC::TopoDS_Wire^ Notch(int index);
    /// <summary>
    ...
    /// on the contour
    /// </summary>
    double NotchWidth(RDC::OCC::TopoDS_Wire^ notch);
    static RDC::OCC::ShapeAnalysis_FreeBoundData^ CreateDowncasted(::ShapeAnalysis_FreeBoundData* instance);
}; // class ShapeAnalysis_FreeBoundData
...
public ref class ShapeAnalysis_FreeBounds sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>
{
...
public:
    ShapeAnalysis_FreeBounds(::ShapeAnalysis_FreeBounds* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>( nativeInstance, true )
    {}

    ShapeAnalysis_FreeBounds(::ShapeAnalysis_FreeBounds& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>( &nativeInstance, false )
    {}
...
public:
    ...
    /// built open wires.
    /// </summary>
    ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double toler, bool splitclosed, bool splitopen);
    /// <summary>
    /// Builds forecasting free bounds of the <shape>.
    /// <shape> should be a compound of faces.
    /// This constructor is to be used for forecasting free edges
    ...
    /// built open wires.
    /// </summary>
    ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double toler, bool splitclosed);
    /// <summary>
    /// Builds forecasting free bounds of the <shape>.
    /// <shape> should be a compound of faces.
    /// This constructor is to be used for forecasting free edges
    ...
    /// built open wires.
    /// </summary>
    ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double toler);
    /// <summary>
    ...
    /// built open wires.
    /// </summary>
    ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed, bool splitopen, bool checkinternaledges);
    /// <summary>
    /// Builds actual free bounds of the <shape>.
    /// <shape> should be a compound of shells.
    /// This constructor is to be used for getting free edges (ones
    ...
    /// built open wires.
    /// </summary>
    ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed, bool splitopen);
    /// <summary>
    /// Builds actual free bounds of the <shape>.
    /// <shape> should be a compound of shells.
    /// This constructor is to be used for getting free edges (ones
    ...
    /// built open wires.
    /// </summary>
    ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed);
    /// <summary>
    /// Builds actual free bounds of the <shape>.
    /// <shape> should be a compound of shells.
    /// This constructor is to be used for getting free edges (ones
    ...
    /// built open wires.
    /// </summary>
    ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    /// Returns compound of closed wires out of free edges.
    /// </summary>
    RDC::OCC::TopoDS_Compound^ GetClosedWires();
    /// <summary>
    /// Returns compound of open wires out of free edges.
    /// </summary>
    RDC::OCC::TopoDS_Compound^ GetOpenWires();
    /// <summary>
    ...
    /// </summary>
    static void ConnectEdgesToWires(RDC::OCC::TopTools_HSequenceOfShape^ edges, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ wires);
    static void ConnectWiresToWires(RDC::OCC::TopTools_HSequenceOfShape^ iwires, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ owires);
    /// <summary>
    ...
    /// </summary>
    static void ConnectWiresToWires(RDC::OCC::TopTools_HSequenceOfShape^ iwires, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ owires, RDC::OCC::TopTools_DataMapOfShapeShape^ vertices);
    /// <summary>
    ...
    /// </summary>
    static void SplitWires(RDC::OCC::TopTools_HSequenceOfShape^ wires, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ closed, RDC::OCC::TopTools_HSequenceOfShape^ open);
    /// <summary>
    ...
    /// </summary>
    static void DispatchWires(RDC::OCC::TopTools_HSequenceOfShape^ wires, RDC::OCC::TopoDS_Compound^ closed, RDC::OCC::TopoDS_Compound^ open);
}; // class ShapeAnalysis_FreeBounds
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::ShapeAnalysis_HSequenceOfFreeBounds::Iterator>
    {
    ...
    public:
        Iterator(::ShapeAnalysis_HSequenceOfFreeBounds::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::ShapeAnalysis_HSequenceOfFreeBounds::Iterator>( nativeInstance, true )
        {}

        Iterator(::ShapeAnalysis_HSequenceOfFreeBounds::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::ShapeAnalysis_HSequenceOfFreeBounds::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        RDC::OCC::ShapeAnalysis_FreeBoundData^ Value();
        RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeValue();
        bool IsEqual(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    ShapeAnalysis_HSequenceOfFreeBounds();
    ShapeAnalysis_HSequenceOfFreeBounds(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theOther);
    RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ Sequence();
    void Append(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void Append(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theSequence);
    RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ ChangeSequence();
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ Assign(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ theOther);
    void Remove(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator^ thePosition);
    void Prepend(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void InsertAfter(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator^ thePosition, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    void Split(int theIndex, RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ theSeq);
    RDC::OCC::ShapeAnalysis_FreeBoundData^ First();
    RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeFirst();
    RDC::OCC::ShapeAnalysis_FreeBoundData^ Last();
    RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeLast();
    ...
    RDC::OCC::ShapeAnalysis_FreeBoundData^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem);
    static RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ CreateDowncasted(::ShapeAnalysis_HSequenceOfFreeBounds* instance);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class ShapeAnalysis_HSequenceOfFreeBounds
...
public ref class ShapeAnalysis_FreeBoundsProperties sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>
{
...
public:
    ShapeAnalysis_FreeBoundsProperties(::ShapeAnalysis_FreeBoundsProperties* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>( nativeInstance, true )
    {}

    ShapeAnalysis_FreeBoundsProperties(::ShapeAnalysis_FreeBoundsProperties& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>( &nativeInstance, false )
    {}
...
public:
    ...
    /// <shape> should be a compound of faces.
    /// </summary>
    ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, double tolerance, bool splitclosed, bool splitopen);
    /// <summary>
    /// Creates the object and calls corresponding Init.
    /// <shape> should be a compound of faces.
    /// </summary>
    ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, double tolerance, bool splitclosed);
    /// <summary>
    /// Creates the object and calls corresponding Init.
    /// <shape> should be a compound of faces.
    /// </summary>
    ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, double tolerance);
    /// <summary>
    /// Creates the object and calls corresponding Init.
    /// <shape> should be a compound of shells.
    /// </summary>
    ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed, bool splitopen);
    /// <summary>
    /// Creates the object and calls corresponding Init.
    /// <shape> should be a compound of shells.
    /// </summary>
    ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed);
    /// <summary>
    /// Creates the object and calls corresponding Init.
    /// <shape> should be a compound of shells.
    /// </summary>
    ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    /// Initializes the object with given parameters.
    /// <shape> should be a compound of faces.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ shape, double tolerance, bool splitclosed, bool splitopen);
    /// <summary>
    /// Initializes the object with given parameters.
    /// <shape> should be a compound of faces.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ shape, double tolerance, bool splitclosed);
    /// <summary>
    /// Initializes the object with given parameters.
    /// <shape> should be a compound of faces.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ shape, double tolerance);
    /// <summary>
    /// Initializes the object with given parameters.
    /// <shape> should be a compound of shells.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed, bool splitopen);
    /// <summary>
    /// Initializes the object with given parameters.
    /// <shape> should be a compound of shells.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed);
    /// <summary>
    /// Initializes the object with given parameters.
    /// <shape> should be a compound of shells.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ ClosedFreeBounds();
    /// <summary>
    /// Returns all open free bounds
    /// </summary>
    RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ OpenFreeBounds();
    /// <summary>
    /// Returns properties of closed free bound specified by its rank
    /// number
    /// </summary>
    RDC::OCC::ShapeAnalysis_FreeBoundData^ ClosedFreeBound(int index);
    /// <summary>
    /// Returns properties of open free bound specified by its rank
    /// number
    /// </summary>
    RDC::OCC::ShapeAnalysis_FreeBoundData^ OpenFreeBound(int index);
    bool DispatchBounds();
    bool CheckContours(double prec);
    bool CheckContours();
    bool CheckNotches(double prec);
    bool CheckNotches();
    bool CheckNotches(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData, double prec);
    bool CheckNotches(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData);
    bool CheckNotches(RDC::OCC::TopoDS_Wire^ freebound, int num, RDC::OCC::TopoDS_Wire^ notch, double% distMax, double prec);
    bool CheckNotches(RDC::OCC::TopoDS_Wire^ freebound, int num, RDC::OCC::TopoDS_Wire^ notch, double% distMax);
    bool FillProperties(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData, double prec);
    bool FillProperties(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData);
}; // class ShapeAnalysis_FreeBoundsProperties
...
public ref class ShapeAnalysis_Geom sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_Geom>
{
...
public:
    ShapeAnalysis_Geom(::ShapeAnalysis_Geom* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Geom>( nativeInstance, true )
    {}

    ShapeAnalysis_Geom(::ShapeAnalysis_Geom& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Geom>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static bool NearestPlane(RDC::OCC::TColgp_Array1OfPnt^ Pnts, RDC::OCC::Pln% aPln, double% Dmax);
    /// <summary>
    /// Builds transformation object out of matrix.
    /// Matrix must be 3 x 4.
    /// Unit is used as multiplier.
    /// </summary>
    static bool PositionTrsf(RDC::OCC::TColStd_HArray2OfReal^ coefs, RDC::OCC::Trsf% trsf, double unit, double prec);
}; // class ShapeAnalysis_Geom
...
public ref class ShapeAnalysis_ShapeContents sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_ShapeContents>
{
...
public:
    ShapeAnalysis_ShapeContents(::ShapeAnalysis_ShapeContents* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_ShapeContents>( nativeInstance, true )
    {}

    ShapeAnalysis_ShapeContents(::ShapeAnalysis_ShapeContents& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_ShapeContents>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Shape^ shape);
    int NbSolids();
    int NbShells();
    int NbFaces();
    int NbWires();
    ...
    RDC::OCC::TopTools_HSequenceOfShape^ BigSplineSec();
    RDC::OCC::TopTools_HSequenceOfShape^ IndirectSec();
    RDC::OCC::TopTools_HSequenceOfShape^ OffsetSurfaceSec();
    RDC::OCC::TopTools_HSequenceOfShape^ Trimmed3dSec();
    RDC::OCC::TopTools_HSequenceOfShape^ OffsetCurveSec();
    RDC::OCC::TopTools_HSequenceOfShape^ Trimmed2dSec();
}; // class ShapeAnalysis_ShapeContents
...
public ref class ShapeAnalysis_ShapeTolerance sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_ShapeTolerance>
{
...
public:
    ShapeAnalysis_ShapeTolerance(::ShapeAnalysis_ShapeTolerance* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_ShapeTolerance>( nativeInstance, true )
    {}

    ShapeAnalysis_ShapeTolerance(::ShapeAnalysis_ShapeTolerance& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_ShapeTolerance>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    double Tolerance(RDC::OCC::TopoDS_Shape^ shape, int mode, RDC::OCC::TopAbs_ShapeEnum type);
    /// <summary>
    /// Determines a tolerance from the ones stored in a shape
    /// Remark : calls InitTolerance and AddTolerance,
    /// hence, can be used to start a series for cumulating tolerance
    ...
    /// shell), also checks EDGE and VERTEX
    /// </summary>
    double Tolerance(RDC::OCC::TopoDS_Shape^ shape, int mode);
    /// <summary>
    /// Determines which shapes have a tolerance over the given value
    /// <type> is interpreted as in the method Tolerance
    /// </summary>
    RDC::OCC::TopTools_HSequenceOfShape^ OverTolerance(RDC::OCC::TopoDS_Shape^ shape, double value, RDC::OCC::TopAbs_ShapeEnum type);
    /// <summary>
    /// Determines which shapes have a tolerance over the given value
    /// <type> is interpreted as in the method Tolerance
    /// </summary>
    RDC::OCC::TopTools_HSequenceOfShape^ OverTolerance(RDC::OCC::TopoDS_Shape^ shape, double value);
    /// <summary>
    /// Determines which shapes have a tolerance within a given interval
    /// <type> is interpreted as in the method Tolerance
    /// </summary>
    RDC::OCC::TopTools_HSequenceOfShape^ InTolerance(RDC::OCC::TopoDS_Shape^ shape, double valmin, double valmax, RDC::OCC::TopAbs_ShapeEnum type);
    /// <summary>
    /// Determines which shapes have a tolerance within a given interval
    /// <type> is interpreted as in the method Tolerance
    /// </summary>
    RDC::OCC::TopTools_HSequenceOfShape^ InTolerance(RDC::OCC::TopoDS_Shape^ shape, double valmin, double valmax);
    /// <summary>
    ...
    /// </summary>
    void AddTolerance(RDC::OCC::TopoDS_Shape^ shape, RDC::OCC::TopAbs_ShapeEnum type);
    /// <summary>
    /// Adds data on new Shape to compute Cumulated Tolerance
    /// (prepares three computations : maximal, average, minimal)
    /// </summary>
    void AddTolerance(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
...
public ref class ShapeAnalysis_Shell sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_Shell>
{
...
public:
    ShapeAnalysis_Shell(::ShapeAnalysis_Shell* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Shell>( nativeInstance, true )
    {}

    ShapeAnalysis_Shell(::ShapeAnalysis_Shell& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_Shell>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void LoadShells(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    ...
    /// </summary>
    bool CheckOrientedShells(RDC::OCC::TopoDS_Shape^ shape, bool alsofree, bool checkinternaledges);
    /// <summary>
    /// Checks if shells fulfill orientation condition, i.e. if each
    /// edge is, either present once (free edge) or twice (connected
    /// edge) but with different orientations (FORWARD/REVERSED)
    ...
    /// Free edges can be queried but are not bad
    /// </summary>
    bool CheckOrientedShells(RDC::OCC::TopoDS_Shape^ shape, bool alsofree);
    /// <summary>
    /// Checks if shells fulfill orientation condition, i.e. if each
    /// edge is, either present once (free edge) or twice (connected
    /// edge) but with different orientations (FORWARD/REVERSED)
    ...
    /// Free edges can be queried but are not bad
    /// </summary>
    bool CheckOrientedShells(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    /// Tells if a shape is loaded (only shells are checked)
    /// </summary>
    bool IsLoaded(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Loaded(int num);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Compound^ BadEdges();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Compound^ FreeEdges();
    /// <summary>
...
public:
    ...
    /// </summary>
    ShapeAnalysis_Surface(RDC::OCC::Geom_Surface^ S);
    /// <summary>
    /// Loads existing surface
    /// </summary>
    void Init(RDC::OCC::Geom_Surface^ S);
    /// <summary>
    /// Reads all the data from another Surface, without recomputing
    /// </summary>
    void Init(RDC::OCC::ShapeAnalysis_Surface^ other);
    ...
    /// </summary>
    RDC::OCC::GeomAdaptor_Surface^ Adaptor3d();
    /// <summary>
    /// Returns the Adaptor (may be Null if method Adaptor() was not called)
    /// </summary>
    RDC::OCC::GeomAdaptor_Surface^ TrueAdaptor3d();
    /// <summary>
    ...
    /// parametrical space
    /// </summary>
    RDC::OCC::Pnt Value(RDC::OCC::Pnt2d p2d);
    /// <summary>
    ...
    /// </summary>
    bool Singularity(int num, double% preci, RDC::OCC::Pnt% P3d, RDC::OCC::Pnt2d% firstP2d, RDC::OCC::Pnt2d% lastP2d, double% firstpar, double% lastpar, bool% uisodeg);
    /// <summary>
    ...
    /// <preci>
    /// </summary>
    bool IsDegenerated(RDC::OCC::Pnt P3d, double preci);
    /// <summary>
    ...
    /// those criteria.
    /// </summary>
    bool DegeneratedValues(RDC::OCC::Pnt P3d, double preci, RDC::OCC::Pnt2d% firstP2d, RDC::OCC::Pnt2d% lastP2d, double% firstpar, double% lastpar, bool forward);
    /// <summary>
    /// Returns True if there is at least one surface iso-line which
    /// is considered as degenerated with <preci> and distance
    /// between P3d and corresponding singular point is less than
    ...
    /// those criteria.
    /// </summary>
    bool DegeneratedValues(RDC::OCC::Pnt P3d, double preci, RDC::OCC::Pnt2d% firstP2d, RDC::OCC::Pnt2d% lastP2d, double% firstpar, double% lastpar);
    /// <summary>
    ...
    /// </summary>
    bool ProjectDegenerated(RDC::OCC::Pnt P3d, double preci, RDC::OCC::Pnt2d neighbour, RDC::OCC::Pnt2d% result);
    /// <summary>
    ...
    /// </summary>
    bool ProjectDegenerated(int nbrPnt, RDC::OCC::TColgp_SequenceOfPnt^ points, RDC::OCC::TColgp_SequenceOfPnt2d^ pnt2d, double preci, bool direct);
    /// <summary>
    ...
    /// </summary>
    bool IsDegenerated(RDC::OCC::Pnt2d p2d1, RDC::OCC::Pnt2d p2d2, double tol, double ratio);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom_Curve^ UIso(double U);
    /// <summary>
    /// Returns a V-Iso. Null if not possible or failed
    /// Remark : bound isos are buffered
    /// </summary>
    RDC::OCC::Geom_Curve^ VIso(double V);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Pnt2d ValueOfUV(RDC::OCC::Pnt P3D, double preci);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Pnt2d NextValueOfUV(RDC::OCC::Pnt2d p2dPrev, RDC::OCC::Pnt P3D, double preci, double maxpreci);
    /// <summary>
    /// Projects a point P3D on the surface.
    /// Does the same thing as ValueOfUV but tries to optimize
    /// computations by taking into account previous point <p2dPrev>:
    ...
    /// If not succeeded, calls ValueOfUV()
    /// </summary>
    RDC::OCC::Pnt2d NextValueOfUV(RDC::OCC::Pnt2d p2dPrev, RDC::OCC::Pnt P3D, double preci);
    /// <summary>
    ...
    /// </summary>
    double UVFromIso(RDC::OCC::Pnt P3D, double preci, double% U, double% V);
    /// <summary>
    ...
    /// </summary>
    double VCloseVal();
    RDC::OCC::Bnd_Box^ GetBoxUF();
    RDC::OCC::Bnd_Box^ GetBoxUL();
    RDC::OCC::Bnd_Box^ GetBoxVF();
    RDC::OCC::Bnd_Box^ GetBoxVL();
    static RDC::OCC::ShapeAnalysis_Surface^ CreateDowncasted(::ShapeAnalysis_Surface* instance);
}; // class ShapeAnalysis_Surface
...
public:
    ...
    /// </summary>
    ShapeAnalysis_TransferParameters(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// Initialize a tool with edge and face
    /// </summary>
    void Init(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TColStd_HSequenceOfReal^ Perform(RDC::OCC::TColStd_HSequenceOfReal^ Params, bool To2d);
    /// <summary>
    ...
    /// </summary>
    void TransferRange(RDC::OCC::TopoDS_Edge^ newEdge, double prevPar, double currPar, bool To2d);
    /// <summary>
    /// Returns True if 3d curve of edge and pcurve are SameRange
    /// (in default implementation, if myScale == 1 and myShift == 0)
    /// </summary>
    bool IsSameRange();
    static RDC::OCC::ShapeAnalysis_TransferParameters^ CreateDowncasted(::ShapeAnalysis_TransferParameters* instance);
}; // class ShapeAnalysis_TransferParameters
...
public ref class ShapeAnalysis_TransferParametersProj sealed
    : public RDC::OCC::ShapeAnalysis_TransferParameters
{
...
public:
    ShapeAnalysis_TransferParametersProj(::ShapeAnalysis_TransferParametersProj* nativeInstance)
        : RDC::OCC::ShapeAnalysis_TransferParameters( nativeInstance )
    {}
...
public:
    ...
    ShapeAnalysis_TransferParametersProj(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    void Init(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// Transfers parameters given by sequence Params from 3d curve
    /// to pcurve (if To2d is True) or back (if To2d is False)
    /// </summary>
    RDC::OCC::TColStd_HSequenceOfReal^ Perform(RDC::OCC::TColStd_HSequenceOfReal^ Papams, bool To2d);
    /// <summary>
    ...
    /// If Is2d equals True parameters are recomputed by curve2d else by curve3d.
    /// </summary>
    void TransferRange(RDC::OCC::TopoDS_Edge^ newEdge, double prevPar, double currPar, bool Is2d);
    /// <summary>
    /// Returns False;
    /// </summary>
    bool IsSameRange();
    ...
    /// </summary>
    static RDC::OCC::TopoDS_Vertex^ CopyNMVertex(RDC::OCC::TopoDS_Vertex^ theVert, RDC::OCC::TopoDS_Edge^ toedge, RDC::OCC::TopoDS_Edge^ fromedge);
    /// <summary>
    /// Make a copy of non-manifold vertex theVert
    /// (i.e. create new  TVertex and replace PointRepresentations for this vertex
    /// from fromFace to toFace. Other representations were copied)
    /// </summary>
    static RDC::OCC::TopoDS_Vertex^ CopyNMVertex(RDC::OCC::TopoDS_Vertex^ theVert, RDC::OCC::TopoDS_Face^ toFace, RDC::OCC::TopoDS_Face^ fromFace);
    static RDC::OCC::ShapeAnalysis_TransferParametersProj^ CreateDowncasted(::ShapeAnalysis_TransferParametersProj* instance);
}; // class ShapeAnalysis_TransferParametersProj
...
public ref class ShapeAnalysis_WireOrder sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_WireOrder>
{
...
public:
    ShapeAnalysis_WireOrder(::ShapeAnalysis_WireOrder* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_WireOrder>( nativeInstance, true )
    {}

    ShapeAnalysis_WireOrder(::ShapeAnalysis_WireOrder& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_WireOrder>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void Add(RDC::OCC::XYZ theStart3d, RDC::OCC::XYZ theEnd3d);
    /// <summary>
    /// Adds a couple of points 2D (start, end)
    /// </summary>
    void Add(RDC::OCC::XY theStart2d, RDC::OCC::XY theEnd2d);
    /// <summary>
    /// Adds a couple of points 3D and 2D (start, end)
    /// </summary>
    void Add(RDC::OCC::XYZ theStart3d, RDC::OCC::XYZ theEnd3d, RDC::OCC::XY theStart2d, RDC::OCC::XY theEnd2d);
    /// <summary>
    ...
    /// </summary>
    void XYZ(int theIdx, RDC::OCC::XYZ% theStart3D, RDC::OCC::XYZ% theEnd3D);
    /// <summary>
    /// Returns the values of the couple <num>, as 2D values
    /// </summary>
    void XY(int theIdx, RDC::OCC::XY% theStart2D, RDC::OCC::XY% theEnd2D);
    /// <summary>
...
public:
    ...
    /// and precision
    /// </summary>
    ShapeAnalysis_Wire(RDC::OCC::TopoDS_Wire^ wire, RDC::OCC::TopoDS_Face^ face, double precision);
    ...
    /// and precision
    /// </summary>
    void Init(RDC::OCC::TopoDS_Wire^ wire, RDC::OCC::TopoDS_Face^ face, double precision);
    ...
    /// </summary>
    void Load(RDC::OCC::TopoDS_Wire^ wire);
    /* Method skipped due to unknown mapping: void Load(ShapeExtend_WireData sbwd, ) */
    /// <summary>
    /// Loads the face the wire lies on
    /// </summary>
    void SetFace(RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    /// Loads the surface the wire lies on
    /// </summary>
    void SetSurface(RDC::OCC::Geom_Surface^ surface);
    /// <summary>
    /// Loads the surface the wire lies on
    /// </summary>
    void SetSurface(RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location);
    ...
    /// </summary>
    RDC::OCC::ShapeAnalysis_Surface^ Surface();
    /// <summary>
    ...
    /// </summary>
    bool CheckOrder(RDC::OCC::ShapeAnalysis_WireOrder^ sawo, bool isClosed, bool theMode3D, bool theModeBoth);
    /// <summary>
    /// Analyzes the order of the edges in the wire,
    /// uses class WireOrder for that purpose.
    /// Flag <isClosed> defines if the wire is closed or not
    ...
    /// FAIL : algorithm failed (could not detect order)
    /// </summary>
    bool CheckOrder(RDC::OCC::ShapeAnalysis_WireOrder^ sawo, bool isClosed, bool theMode3D);
    /// <summary>
    /// Analyzes the order of the edges in the wire,
    /// uses class WireOrder for that purpose.
    /// Flag <isClosed> defines if the wire is closed or not
    ...
    /// FAIL : algorithm failed (could not detect order)
    /// </summary>
    bool CheckOrder(RDC::OCC::ShapeAnalysis_WireOrder^ sawo, bool isClosed);
    /// <summary>
    /// Analyzes the order of the edges in the wire,
    /// uses class WireOrder for that purpose.
    /// Flag <isClosed> defines if the wire is closed or not
    ...
    /// FAIL : algorithm failed (could not detect order)
    /// </summary>
    bool CheckOrder(RDC::OCC::ShapeAnalysis_WireOrder^ sawo);
    /// <summary>
    ...
    /// </summary>
    bool CheckSeam(int num, RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2, double% cf, double% cl);
    /// <summary>
    /// Checks if a seam pcurves are correct oriented
    ...
    /// </summary>
    bool CheckDegenerated(int num, RDC::OCC::Pnt2d% dgnr1, RDC::OCC::Pnt2d% dgnr2);
    /// <summary>
    /// Checks for degenerated edge between two adjacent ones.
    ...
    /// </summary>
    bool CheckLacking(int num, double Tolerance, RDC::OCC::Pnt2d% p2d1, RDC::OCC::Pnt2d% p2d2);
    /// <summary>
    ...
    /// </summary>
    bool CheckSmallArea(RDC::OCC::TopoDS_Wire^ theWire);
    /// <summary>
    ...
    /// otherwise reversed.
    /// </summary>
    bool CheckShapeConnect(RDC::OCC::TopoDS_Shape^ shape, double prec);
    /// <summary>
    /// Checks with what orientation <shape> (wire or edge) can be
    /// connected to the wire.
    /// Tests distances with starting <preci> from <SBWD> (close confusion),
    ...
    /// otherwise reversed.
    /// </summary>
    bool CheckShapeConnect(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    ...
    /// </summary>
    bool CheckShapeConnect(double% tailhead, double% tailtail, double% headtail, double% headhead, RDC::OCC::TopoDS_Shape^ shape, double prec);
    /// <summary>
    /// The same as previous CheckShapeConnect but is more advanced.
    /// It returns the distances between each end of <sbwd> and each
    /// end of <shape>. For example, <tailhead> stores distance
    ...
    /// Remark:  First method CheckShapeConnect calls this one
    /// </summary>
    bool CheckShapeConnect(double% tailhead, double% tailtail, double% headtail, double% headhead, RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    /// Checks existence of loop on wire and return vertices which are loop vertices
    /// (vertices belonging to a few pairs of edges)
    /// </summary>
    bool CheckLoop(RDC::OCC::TopTools_IndexedMapOfShape^ aMapLoopVertices, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ aMapVertexEdges, RDC::OCC::TopTools_MapOfShape^ aMapSmallEdges, RDC::OCC::TopTools_MapOfShape^ aMapSeemEdges);
    bool CheckTail(RDC::OCC::TopoDS_Edge^ theEdge1, RDC::OCC::TopoDS_Edge^ theEdge2, double theMaxSine, double theMaxWidth, double theMaxTolerance, RDC::OCC::TopoDS_Edge^ theEdge11, RDC::OCC::TopoDS_Edge^ theEdge12, RDC::OCC::TopoDS_Edge^ theEdge21, RDC::OCC::TopoDS_Edge^ theEdge22);
    ...
    static RDC::OCC::ShapeAnalysis_Wire^ CreateDowncasted(::ShapeAnalysis_Wire* instance);
}; // class ShapeAnalysis_Wire
...
public ref class ShapeAnalysis_WireVertex sealed
    : public RDC::OCC::BaseClass<::ShapeAnalysis_WireVertex>
{
...
public:
    ShapeAnalysis_WireVertex(::ShapeAnalysis_WireVertex* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_WireVertex>( nativeInstance, true )
    {}

    ShapeAnalysis_WireVertex(::ShapeAnalysis_WireVertex& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeAnalysis_WireVertex>( &nativeInstance, false )
    {}
...
public:
    ...
    void Init(RDC::OCC::TopoDS_Wire^ wire, double preci);
    ...
    /// </summary>
    void SetEnd(int num, RDC::OCC::XYZ pos, double ufol);
    /// <summary>
    ...
    /// </summary>
    void SetStart(int num, RDC::OCC::XYZ pos, double upre);
    /// <summary>
    /// <num> is the Intersection of both Edges
    /// <upre> is the parameter on preceding edge, <ufol> on
    /// following edge
    /// </summary>
    void SetInters(int num, RDC::OCC::XYZ pos, double upre, double ufol);
    /// <summary>
    ...
    /// </summary>
    int Data(int num, RDC::OCC::XYZ% pos, double% upre, double% ufol);
    /// <summary>
