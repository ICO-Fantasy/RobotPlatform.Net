...
public ref class BinTools sealed
    : public RDC::OCC::BaseClass<::BinTools>
{
...
public:
    BinTools(::BinTools* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools>( nativeInstance, true )
    {}

    BinTools(::BinTools& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </param>
    static void Write(RDC::OCC::TopoDS_Shape^ theShape, System::IO::TextWriter^ theStream, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the shape to the stream in binary format BinTools_FormatVersion_CURRENT.
    /// This alias writes shape with triangulation data.
    /// </summary>
    ...
    ///              the range of progress indicator to fill in
    /// </param>
    static void Write(RDC::OCC::TopoDS_Shape^ theShape, System::IO::TextWriter^ theStream, bool theWithTriangles, bool theWithNormals, RDC::OCC::BinTools_FormatVersion theVersion, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the shape to the stream in binary format of specified version.
    /// </summary>
    /// <param name="theShape">
    ...
    ///              the range of progress indicator to fill in
    /// </param>
    static void Write(RDC::OCC::TopoDS_Shape^ theShape, System::IO::TextWriter^ theStream, bool theWithTriangles, bool theWithNormals, RDC::OCC::BinTools_FormatVersion theVersion);
    ...
    ///      the range of progress indicator to fill in
    /// </param>
    static bool Write(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the shape to the file in binary format BinTools_FormatVersion_CURRENT.
    /// </summary>
    /// <param name="theShape">
    ...
    ///              the range of progress indicator to fill in
    /// </param>
    static bool Write(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile, bool theWithTriangles, bool theWithNormals, RDC::OCC::BinTools_FormatVersion theVersion, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the shape to the file in binary format of specified version.
    /// </summary>
    /// <param name="theShape">
    ...
    ///              the range of progress indicator to fill in
    /// </param>
    static bool Write(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile, bool theWithTriangles, bool theWithNormals, RDC::OCC::BinTools_FormatVersion theVersion);
    /// <summary>
    /// Reads a shape from <theFile> and returns it in <theShape>.
    /// </summary>
    static bool Read(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Reads a shape from <theFile> and returns it in <theShape>.
    /// </summary>
    static bool Read(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile);
}; // class BinTools
...
public ref class BinTools_OStream sealed
    : public RDC::OCC::BaseClass<::BinTools_OStream>
{
...
public:
    BinTools_OStream(::BinTools_OStream* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_OStream>( nativeInstance, true )
    {}

    BinTools_OStream(::BinTools_OStream& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_OStream>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void WriteShape(RDC::OCC::TopAbs_ShapeEnum theType, RDC::OCC::TopAbs_Orientation theOrientation);
    /// <summary>
...
public ref class BinTools_Curve2dSet sealed
    : public RDC::OCC::BaseClass<::BinTools_Curve2dSet>
{
...
public:
    BinTools_Curve2dSet(::BinTools_Curve2dSet* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_Curve2dSet>( nativeInstance, true )
    {}

    BinTools_Curve2dSet(::BinTools_Curve2dSet& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_Curve2dSet>( &nativeInstance, false )
    {}
...
public:
    ...
    /// its index.
    /// </summary>
    int Add(RDC::OCC::Geom2d_Curve^ C);
    /// <summary>
    /// Returns the Curve of index <I>.
    /// </summary>
    RDC::OCC::Geom2d_Curve^ Curve2d(int I);
    /// <summary>
    /// Returns the index of <L>.
    /// </summary>
    int Index(RDC::OCC::Geom2d_Curve^ C);
    /// <summary>
    /// Writes the content of  me  on the stream <OS> in a
    /// format that can be read back by Read.
    /// </summary>
    void Write(System::IO::TextWriter^ OS, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the content of  me  on the stream <OS> in a
    /// format that can be read back by Read.
    /// </summary>
    ...
    /// </summary>
    static void WriteCurve2d(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::BinTools_OStream^ OS);
...
public ref class BinTools_CurveSet sealed
    : public RDC::OCC::BaseClass<::BinTools_CurveSet>
{
...
public:
    BinTools_CurveSet(::BinTools_CurveSet* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_CurveSet>( nativeInstance, true )
    {}

    BinTools_CurveSet(::BinTools_CurveSet& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_CurveSet>( &nativeInstance, false )
    {}
...
public:
    ...
    /// its index.
    /// </summary>
    int Add(RDC::OCC::Geom_Curve^ C);
    /// <summary>
    /// Returns the Curve of index <I>.
    /// </summary>
    RDC::OCC::Geom_Curve^ Curve(int I);
    /// <summary>
    /// Returns the index of <L>.
    /// </summary>
    int Index(RDC::OCC::Geom_Curve^ C);
    /// <summary>
    /// Writes the content of  me  on the stream <OS> in a
    /// format that can be read back by Read.
    /// </summary>
    ...
    /// </summary>
    static void WriteCurve(RDC::OCC::Geom_Curve^ C, RDC::OCC::BinTools_OStream^ OS);
...
public ref class BinTools_IStream sealed
    : public RDC::OCC::BaseClass<::BinTools_IStream>
{
...
public:
    BinTools_IStream(::BinTools_IStream* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_IStream>( nativeInstance, true )
    {}

    BinTools_IStream(::BinTools_IStream& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_IStream>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    RDC::OCC::BinTools_ObjectType ReadType();
    /// <summary>
    /// Returns the last read type.
    /// </summary>
    RDC::OCC::BinTools_ObjectType LastType();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopAbs_Orientation ShapeOrientation();
    /// <summary>
...
public ref class BinTools_LocationSet sealed
    : public RDC::OCC::BaseClass<::BinTools_LocationSet>
{
...
public:
    BinTools_LocationSet(::BinTools_LocationSet* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_LocationSet>( nativeInstance, true )
    {}

    BinTools_LocationSet(::BinTools_LocationSet& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_LocationSet>( &nativeInstance, false )
    {}
...
public ref class BinTools_ShapeSetBase
    : public RDC::OCC::BaseClass<::BinTools_ShapeSetBase>
{
...
protected:
    BinTools_ShapeSetBase(InitMode init)
        : RDC::OCC::BaseClass<::BinTools_ShapeSetBase>( init )
    {}

public:
    BinTools_ShapeSetBase(::BinTools_ShapeSetBase* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_ShapeSetBase>( nativeInstance, true )
    {}

    BinTools_ShapeSetBase(::BinTools_ShapeSetBase& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_ShapeSetBase>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void Write(System::IO::TextWriter^ parameter1, RDC::OCC::Message_ProgressRange^ parameter2);
    /// <summary>
    /// Writes the content of  me  on the stream <OS> in binary
    /// format that can be read back by Read.
    /// 
    ...
    /// of the Location.
    /// </summary>
    void Write(RDC::OCC::TopoDS_Shape^ parameter1, System::IO::TextWriter^ parameter2);
...
public ref class BinTools_ShapeReader sealed
    : public RDC::OCC::BinTools_ShapeSetBase
{
...
public:
    BinTools_ShapeReader(::BinTools_ShapeReader* nativeInstance)
        : RDC::OCC::BinTools_ShapeSetBase( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    RDC::OCC::TopLoc_Location^ ReadLocation(RDC::OCC::BinTools_IStream^ theStream);
}; // class BinTools_ShapeReader
...
public ref class BinTools_SurfaceSet sealed
    : public RDC::OCC::BaseClass<::BinTools_SurfaceSet>
{
...
public:
    BinTools_SurfaceSet(::BinTools_SurfaceSet* nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_SurfaceSet>( nativeInstance, true )
    {}

    BinTools_SurfaceSet(::BinTools_SurfaceSet& nativeInstance)
        : RDC::OCC::BaseClass<::BinTools_SurfaceSet>( &nativeInstance, false )
    {}
...
public:
    ...
    /// its index.
    /// </summary>
    int Add(RDC::OCC::Geom_Surface^ S);
    /// <summary>
    /// Returns the Surface of index <I>.
    /// </summary>
    RDC::OCC::Geom_Surface^ Surface(int I);
    /// <summary>
    /// Returns the index of <L>.
    /// </summary>
    int Index(RDC::OCC::Geom_Surface^ S);
    /// <summary>
    ...
    /// </summary>
    static void WriteSurface(RDC::OCC::Geom_Surface^ S, RDC::OCC::BinTools_OStream^ OS);
...
public:
    ...
    RDC::OCC::BinTools_LocationSet^ Locations();
    RDC::OCC::BinTools_LocationSet^ ChangeLocations();
    /// <summary>
    ...
    /// binary format that can be read back by Read.
    /// </summary>
    void WriteGeometry(System::IO::TextWriter^ OS, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the geometry of  me  on the stream <OS> in a
    /// binary format that can be read back by Read.
    /// </summary>
    ...
    /// binary format that can be read back by Read.
    /// </summary>
    void WriteShape(RDC::OCC::TopoDS_Shape^ S, System::IO::TextWriter^ OS);
    /* Method skipped due to unknown mapping: void ReadShape(TopAbs_ShapeEnum T, istream IS, TopoDS_Shape S, ) */
    /// <summary>
    /// Stores the shape <S>.
    /// </summary>
    void AddShape(RDC::OCC::TopoDS_Shape^ S);
    /// <summary>
    ...
    /// </summary>
    void WritePolygon3D(System::IO::TextWriter^ OS, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the 3d polygons
    /// on the stream <OS> in a format that can
    /// be read back by Read.
    ...
    /// be read back by Read.
    /// </summary>
    void WriteTriangulation(System::IO::TextWriter^ OS, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the triangulation
    /// on the stream <OS> in a format that can
    /// be read back by Read.
    ...
    /// be read back by Read.
    /// </summary>
    void WritePolygonOnTriangulation(System::IO::TextWriter^ OS, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Writes the polygons on triangulation
    /// on the stream <OS> in a format that can
    /// be read back by Read.
