...
public ref class Image_ColorRGB sealed
    : public RDC::OCC::BaseClass<::Image_ColorRGB>
{
...
public:
    Image_ColorRGB(::Image_ColorRGB* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGB>( nativeInstance, true )
    {}

    Image_ColorRGB(::Image_ColorRGB& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGB>( &nativeInstance, false )
    {}
...
public ref class Image_ColorRGB32 sealed
    : public RDC::OCC::BaseClass<::Image_ColorRGB32>
{
...
public:
    Image_ColorRGB32(::Image_ColorRGB32* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGB32>( nativeInstance, true )
    {}

    Image_ColorRGB32(::Image_ColorRGB32& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGB32>( &nativeInstance, false )
    {}
...
public ref class Image_ColorRGBA sealed
    : public RDC::OCC::BaseClass<::Image_ColorRGBA>
{
...
public:
    Image_ColorRGBA(::Image_ColorRGBA* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGBA>( nativeInstance, true )
    {}

    Image_ColorRGBA(::Image_ColorRGBA& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGBA>( &nativeInstance, false )
    {}
...
public ref class Image_ColorBGR sealed
    : public RDC::OCC::BaseClass<::Image_ColorBGR>
{
...
public:
    Image_ColorBGR(::Image_ColorBGR* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGR>( nativeInstance, true )
    {}

    Image_ColorBGR(::Image_ColorBGR& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGR>( &nativeInstance, false )
    {}
...
public ref class Image_ColorBGR32 sealed
    : public RDC::OCC::BaseClass<::Image_ColorBGR32>
{
...
public:
    Image_ColorBGR32(::Image_ColorBGR32* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGR32>( nativeInstance, true )
    {}

    Image_ColorBGR32(::Image_ColorBGR32& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGR32>( &nativeInstance, false )
    {}
...
public ref class Image_ColorBGRA sealed
    : public RDC::OCC::BaseClass<::Image_ColorBGRA>
{
...
public:
    Image_ColorBGRA(::Image_ColorBGRA* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGRA>( nativeInstance, true )
    {}

    Image_ColorBGRA(::Image_ColorBGRA& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGRA>( &nativeInstance, false )
    {}
...
public ref class Image_ColorRGF sealed
    : public RDC::OCC::BaseClass<::Image_ColorRGF>
{
...
public:
    Image_ColorRGF(::Image_ColorRGF* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGF>( nativeInstance, true )
    {}

    Image_ColorRGF(::Image_ColorRGF& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGF>( &nativeInstance, false )
    {}
...
public ref class Image_ColorRGBF sealed
    : public RDC::OCC::BaseClass<::Image_ColorRGBF>
{
...
public:
    Image_ColorRGBF(::Image_ColorRGBF* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGBF>( nativeInstance, true )
    {}

    Image_ColorRGBF(::Image_ColorRGBF& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGBF>( &nativeInstance, false )
    {}
...
public ref class Image_ColorBGRF sealed
    : public RDC::OCC::BaseClass<::Image_ColorBGRF>
{
...
public:
    Image_ColorBGRF(::Image_ColorBGRF* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGRF>( nativeInstance, true )
    {}

    Image_ColorBGRF(::Image_ColorBGRF& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGRF>( &nativeInstance, false )
    {}
...
public ref class Image_ColorRGBAF sealed
    : public RDC::OCC::BaseClass<::Image_ColorRGBAF>
{
...
public:
    Image_ColorRGBAF(::Image_ColorRGBAF* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGBAF>( nativeInstance, true )
    {}

    Image_ColorRGBAF(::Image_ColorRGBAF& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorRGBAF>( &nativeInstance, false )
    {}
...
public ref class Image_ColorBGRAF sealed
    : public RDC::OCC::BaseClass<::Image_ColorBGRAF>
{
...
public:
    Image_ColorBGRAF(::Image_ColorBGRAF* nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGRAF>( nativeInstance, true )
    {}

    Image_ColorBGRAF(::Image_ColorBGRAF& nativeInstance)
        : RDC::OCC::BaseClass<::Image_ColorBGRAF>( &nativeInstance, false )
    {}
...
public ref class Image_VideoParams sealed
    : public RDC::OCC::BaseClass<::Image_VideoParams>
{
...
public:
    Image_VideoParams(::Image_VideoParams* nativeInstance)
        : RDC::OCC::BaseClass<::Image_VideoParams>( nativeInstance, true )
    {}

    Image_VideoParams(::Image_VideoParams& nativeInstance)
        : RDC::OCC::BaseClass<::Image_VideoParams>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Initializer.
    /// </summary>
    bool Init(RDC::OCC::NCollection_BaseAllocator^ theAlloc, long long unsigned int theSizeBPP, long long unsigned int theSizeX, long long unsigned int theSizeY, long long unsigned int theSizeRowBytes, unsigned char% theDataPtr);
    ...
    static RDC::OCC::Image_PixMapData^ CreateDowncasted(::Image_PixMapData* instance);
}; // class Image_PixMapData
...
public:
    ...
    /// </summary>
    static long long unsigned int SizePixelBytes(RDC::OCC::Image_Format thePixelFormat);
    /// <summary>
    ...
    /// </summary>
    static bool SwapRgbaBgra(RDC::OCC::Image_PixMap^ theImage);
    /// <summary>
    /// Convert image to Black/White.
    /// </summary>
    static void ToBlackWhite(RDC::OCC::Image_PixMap^ theImage);
    /// <summary>
    /// Reverse line order as it draws it from bottom to top.
    /// </summary>
    static bool FlipY(RDC::OCC::Image_PixMap^ theImage);
    /// <summary>
    /// Return default image data allocator.
    /// </summary>
    static RDC::OCC::NCollection_BaseAllocator^ DefaultAllocator();
    /// <summary>
    /// Return string representation of pixel format.
    /// </summary>
    static System::String^ ImageFormatToString(RDC::OCC::Image_Format theFormat);
    /// <summary>
    /// Return string representation of compressed pixel format.
    /// </summary>
    static System::String^ ImageFormatToString(RDC::OCC::Image_CompressedFormat theFormat);
    /// <summary>
    ...
    /// the pixel color
    /// </returns>
    static RDC::OCC::Quantity_ColorRGBA^ ColorFromRawPixel(unsigned char theRawValue, RDC::OCC::Image_Format theFormat, bool theToLinearize);
    /// <summary>
    /// Convert raw pixel value into Quantity_ColorRGBA. This function is relatively slow.
    /// </summary>
    /// <param name="in]">
    ...
    /// the pixel color
    /// </returns>
    static RDC::OCC::Quantity_ColorRGBA^ ColorFromRawPixel(unsigned char theRawValue, RDC::OCC::Image_Format theFormat);
    /// <summary>
    ...
    /// </param>
    static void ColorToRawPixel(unsigned char% theRawValue, RDC::OCC::Image_Format theFormat, RDC::OCC::Quantity_ColorRGBA^ theColor, bool theToDeLinearize);
    /// <summary>
    /// Set raw pixel value from Quantity_ColorRGBA. This function is relatively slow.
    /// </summary>
    /// <param name="out]">
    ...
    /// theToDeLinearize when TRUE, the gamma correction will be applied for storing in non-linear color space (e.g. Image_Format_RGB)
    /// </param>
    static void ColorToRawPixel(unsigned char% theRawValue, RDC::OCC::Image_Format theFormat, RDC::OCC::Quantity_ColorRGBA^ theColor);
    /// <summary>
    /// Return pixel format.
    /// </summary>
    RDC::OCC::Image_Format Format();
    /// <summary>
    ...
    /// </summary>
    void SetFormat(RDC::OCC::Image_Format thePixelFormat);
    /// <summary>
    ...
    /// the pixel color
    /// </returns>
    RDC::OCC::Quantity_ColorRGBA^ PixelColor(int theX, int theY, bool theToLinearize);
    /// <summary>
    /// Returns the pixel color. This function is relatively slow.
    /// Beware that this method takes coordinates in opposite order in contrast to ::Value() and ::ChangeValue().
    /// </summary>
    ...
    /// the pixel color
    /// </returns>
    RDC::OCC::Quantity_ColorRGBA^ PixelColor(int theX, int theY);
    /// <summary>
    ...
    /// theToDeLinearize when TRUE, the gamma correction will be applied for storing in non-linear color space (e.g. Image_Format_RGB)
    /// </param>
    void SetPixelColor(int theX, int theY, RDC::OCC::Quantity_Color^ theColor, bool theToDeLinearize);
    /// <summary>
    /// Sets the pixel color. This function is relatively slow.
    /// Beware that this method takes coordinates in opposite order in contrast to ::Value() and ::ChangeValue().
    /// </summary>
    ...
    /// theToDeLinearize when TRUE, the gamma correction will be applied for storing in non-linear color space (e.g. Image_Format_RGB)
    /// </param>
    void SetPixelColor(int theX, int theY, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Sets the pixel color. This function is relatively slow.
    /// Beware that this method takes coordinates in opposite order in contrast to ::Value() and ::ChangeValue().
    /// </summary>
    ...
    /// theToDeLinearize when TRUE, the gamma correction will be applied for storing in non-linear color space (e.g. Image_Format_RGB)
    /// </param>
    void SetPixelColor(int theX, int theY, RDC::OCC::Quantity_ColorRGBA^ theColor, bool theToDeLinearize);
    /// <summary>
    /// Sets the pixel color. This function is relatively slow.
    /// Beware that this method takes coordinates in opposite order in contrast to ::Value() and ::ChangeValue().
    /// </summary>
    ...
    /// theToDeLinearize when TRUE, the gamma correction will be applied for storing in non-linear color space (e.g. Image_Format_RGB)
    /// </param>
    void SetPixelColor(int theX, int theY, RDC::OCC::Quantity_ColorRGBA^ theColor);
    /// <summary>
    ...
    /// </summary>
    bool InitWrapper(RDC::OCC::Image_Format thePixelFormat, unsigned char% theDataPtr, long long unsigned int theSizeX, long long unsigned int theSizeY, long long unsigned int theSizeRowBytes);
    /// <summary>
    /// Initialize image plane as wrapper over alien data.
    /// Data will not be copied! Notice that caller should ensure
    /// that data pointer will not be released during this wrapper lifetime.
    /// You may call InitCopy() to perform data copying.
    /// </summary>
    bool InitWrapper(RDC::OCC::Image_Format thePixelFormat, unsigned char% theDataPtr, long long unsigned int theSizeX, long long unsigned int theSizeY);
    /// <summary>
    /// Initialize image plane with required dimensions.
    /// Memory will be left uninitialized (performance trick).
    /// </summary>
    bool InitTrash(RDC::OCC::Image_Format thePixelFormat, long long unsigned int theSizeX, long long unsigned int theSizeY, long long unsigned int theSizeRowBytes);
    /// <summary>
    /// Initialize image plane with required dimensions.
    /// Memory will be left uninitialized (performance trick).
    /// </summary>
    bool InitTrash(RDC::OCC::Image_Format thePixelFormat, long long unsigned int theSizeX, long long unsigned int theSizeY);
    /// <summary>
    /// Initialize by copying data.
    /// If you want to copy alien data you should create wrapper using InitWrapper() before.
    /// </summary>
    bool InitCopy(RDC::OCC::Image_PixMap^ theCopy);
    /// <summary>
    /// Initialize image plane with required dimensions.
    /// Buffer will be zeroed (black color for most formats).
    /// </summary>
    bool InitZero(RDC::OCC::Image_Format thePixelFormat, long long unsigned int theSizeX, long long unsigned int theSizeY, long long unsigned int theSizeRowBytes, unsigned char theValue);
    /// <summary>
    /// Initialize image plane with required dimensions.
    /// Buffer will be zeroed (black color for most formats).
    /// </summary>
    bool InitZero(RDC::OCC::Image_Format thePixelFormat, long long unsigned int theSizeX, long long unsigned int theSizeY, long long unsigned int theSizeRowBytes);
    /// <summary>
    /// Initialize image plane with required dimensions.
    /// Buffer will be zeroed (black color for most formats).
    /// </summary>
    bool InitZero(RDC::OCC::Image_Format thePixelFormat, long long unsigned int theSizeX, long long unsigned int theSizeY);
    /// <summary>
    ...
    static RDC::OCC::Image_PixMap^ CreateDowncasted(::Image_PixMap* instance);
}; // class Image_PixMap
...
public:
    Image_AlienPixMap(::Image_AlienPixMap* nativeInstance)
        : RDC::OCC::Image_PixMap( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    bool Load(RDC::OCC::TCollection_AsciiString^ theFileName);
    ...
    /// </param>
    bool Load(unsigned char theData, long long unsigned int theLength, RDC::OCC::TCollection_AsciiString^ theFileName);
    /// <summary>
    ...
    /// </param>
    bool Save(RDC::OCC::TCollection_AsciiString^ theFileName);
    ...
    /// </param>
    bool Save(unsigned char% theBuffer, long long unsigned int theLength, RDC::OCC::TCollection_AsciiString^ theFileName);
    /// <summary>
    /// Initialize image plane with required dimensions.
    /// </summary>
    /// <param name="in]">
    ...
    static RDC::OCC::Image_AlienPixMap^ CreateDowncasted(::Image_AlienPixMap* instance);
}; // class Image_AlienPixMap
...
public:
    ...
    /// </summary>
    RDC::OCC::Image_Format BaseFormat();
    /// <summary>
    /// Set base (uncompressed) pixel format.
    /// </summary>
    void SetBaseFormat(RDC::OCC::Image_Format theFormat);
    /// <summary>
    /// Return compressed format.
    /// </summary>
    RDC::OCC::Image_CompressedFormat CompressedFormat();
    /// <summary>
    /// Set compressed format.
    /// </summary>
    void SetCompressedFormat(RDC::OCC::Image_CompressedFormat theFormat);
    /// <summary>
    /// Return raw (compressed) data.
    /// </summary>
    RDC::OCC::NCollection_Buffer^ FaceData();
    /// <summary>
    /// Set raw (compressed) data.
    /// </summary>
    void SetFaceData(RDC::OCC::NCollection_Buffer^ theBuffer);
    /// <summary>
    /// Return Array of mipmap sizes, including base level.
    /// </summary>
    RDC::OCC::TColStd_Array1OfInteger^ MipMaps();
    /// <summary>
    /// Return Array of mipmap sizes, including base level.
    /// </summary>
    RDC::OCC::TColStd_Array1OfInteger^ ChangeMipMaps();
    /// <summary>
    ...
    static RDC::OCC::Image_CompressedPixMap^ CreateDowncasted(::Image_CompressedPixMap* instance);
}; // class Image_CompressedPixMap
...
public:
    ...
    /// </summary>
    bool IsSupported(RDC::OCC::Image_Format theFormat);
    /// <summary>
    /// Set if image format is supported or not.
    /// </summary>
    void Add(RDC::OCC::Image_Format theFormat);
    /// <summary>
    ...
    /// </summary>
    bool IsSupported(RDC::OCC::Image_CompressedFormat theFormat);
    /// <summary>
    /// Set if compressed image format is supported or not.
    /// </summary>
    void Add(RDC::OCC::Image_CompressedFormat theFormat);
    /// <summary>
    /// Reset flags.
    /// </summary>
    void Clear();
    static RDC::OCC::Image_SupportedFormats^ CreateDowncasted(::Image_SupportedFormats* instance);
}; // class Image_SupportedFormats
...
public ref class Image_DDSParser sealed
    : public RDC::OCC::BaseClass<::Image_DDSParser>
{
...
public:
    Image_DDSParser(::Image_DDSParser* nativeInstance)
        : RDC::OCC::BaseClass<::Image_DDSParser>( nativeInstance, true )
    {}

    Image_DDSParser(::Image_DDSParser& nativeInstance)
        : RDC::OCC::BaseClass<::Image_DDSParser>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </returns>
    static RDC::OCC::Image_CompressedPixMap^ Load(RDC::OCC::Image_SupportedFormats^ theSupported, RDC::OCC::TCollection_AsciiString^ theFile, int theFaceIndex, long long int theFileOffset);
    /// <summary>
    /// Load the face from DDS file.
    /// </summary>
    /// <param name="theSupported">
    ...
    /// loaded face or NULL if file cannot be read or not valid DDS file
    /// </returns>
    static RDC::OCC::Image_CompressedPixMap^ Load(RDC::OCC::Image_SupportedFormats^ theSupported, RDC::OCC::TCollection_AsciiString^ theFile, int theFaceIndex);
    /// <summary>
    /// Load the face from DDS file.
    /// </summary>
    /// <param name="theSupported">
    ...
    /// loaded face or NULL if file cannot be read or not valid DDS file
    /// </returns>
    static RDC::OCC::Image_CompressedPixMap^ Load(RDC::OCC::Image_SupportedFormats^ theSupported, RDC::OCC::NCollection_Buffer^ theBuffer, int theFaceIndex);
}; // class Image_DDSParser
...
public:
    ...
    /// </returns>
    bool Init(RDC::OCC::Image_PixMap^ theImageRef, RDC::OCC::Image_PixMap^ theImageNew, bool theToBlackWhite);
    /// <summary>
    /// Initialize algorithm by two images.
    /// </summary>
    /// <returns>
    /// false if images has different or unsupported pixel format.
    /// </returns>
    bool Init(RDC::OCC::Image_PixMap^ theImageRef, RDC::OCC::Image_PixMap^ theImageNew);
    /// <summary>
    ...
    /// </returns>
    bool Init(RDC::OCC::TCollection_AsciiString^ theImgPathRef, RDC::OCC::TCollection_AsciiString^ theImgPathNew, bool theToBlackWhite);
    /// <summary>
    /// Initialize algorithm by two images (will be loaded from files).
    /// </summary>
    /// <returns>
    /// false if images couldn't be opened or their format is unsupported.
    /// </returns>
    bool Init(RDC::OCC::TCollection_AsciiString^ theImgPathRef, RDC::OCC::TCollection_AsciiString^ theImgPathNew);
    /// <summary>
    ...
    /// </summary>
    bool SaveDiffImage(RDC::OCC::Image_PixMap^ theDiffImage);
    /// <summary>
    /// Saves a difference between two images as white pixels on black background.
    /// </summary>
    bool SaveDiffImage(RDC::OCC::TCollection_AsciiString^ theDiffPath);
    static RDC::OCC::Image_Diff^ CreateDowncasted(::Image_Diff* instance);
}; // class Image_Diff
...
public:
    ...
    /// </summary>
    Image_Texture(RDC::OCC::TCollection_AsciiString^ theFileName);
    /// <summary>
    /// Constructor pointing to file part.
    /// </summary>
    Image_Texture(RDC::OCC::TCollection_AsciiString^ theFileName, long long int theOffset, long long int theLength);
    /// <summary>
    /// Constructor pointing to buffer.
    /// </summary>
    Image_Texture(RDC::OCC::NCollection_Buffer^ theBuffer, RDC::OCC::TCollection_AsciiString^ theId);
    /// <summary>
    /// Return generated texture id.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ TextureId();
    /// <summary>
    /// Return image file path.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ FilePath();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::NCollection_Buffer^ DataBuffer();
    /// <summary>
    /// Return mime-type of image file based on ProbeImageFileFormat().
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ MimeType();
    /// <summary>
    /// Return image file format.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ ProbeImageFileFormat();
    /// <summary>
    /// Image reader without decoding data for formats supported natively by GPUs.
    /// </summary>
    RDC::OCC::Image_CompressedPixMap^ ReadCompressedImage(RDC::OCC::Image_SupportedFormats^ theSupported);
    /// <summary>
    /// Image reader.
    /// </summary>
    RDC::OCC::Image_PixMap^ ReadImage(RDC::OCC::Image_SupportedFormats^ theSupported);
    /// <summary>
    /// Write image to specified file without decoding data.
    /// </summary>
    bool WriteImage(RDC::OCC::TCollection_AsciiString^ theFile);
    ...
    static RDC::OCC::Image_Texture^ CreateDowncasted(::Image_Texture* instance);
}; // class Image_Texture
...
public:
    ...
    ///   [in] video parameters
    /// </param>
    bool Open(char theFileName, RDC::OCC::Image_VideoParams^ theParams);
    /// <summary>
    ...
    /// </summary>
    bool PushFrame();
    static RDC::OCC::Image_VideoRecorder^ CreateDowncasted(::Image_VideoRecorder* instance);
}; // class Image_VideoRecorder
