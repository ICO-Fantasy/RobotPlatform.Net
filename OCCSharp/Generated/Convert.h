...
public ref class Convert_SequenceOfArray1OfPoles2d sealed
    : public RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles2d>
...
public:
    Convert_SequenceOfArray1OfPoles2d(::Convert_SequenceOfArray1OfPoles2d* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles2d>( nativeInstance, true )
    {}

    Convert_SequenceOfArray1OfPoles2d(::Convert_SequenceOfArray1OfPoles2d& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles2d>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles2d::Iterator>
    {
    ...
    public:
        Iterator(::Convert_SequenceOfArray1OfPoles2d::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles2d::Iterator>( nativeInstance, true )
        {}

        Iterator(::Convert_SequenceOfArray1OfPoles2d::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles2d::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool IsEqual(RDC::OCC::Convert_SequenceOfArray1OfPoles2d::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    Convert_SequenceOfArray1OfPoles2d();
    Convert_SequenceOfArray1OfPoles2d(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::Convert_SequenceOfArray1OfPoles2d^ Assign(RDC::OCC::Convert_SequenceOfArray1OfPoles2d^ theOther);
    void Remove(RDC::OCC::Convert_SequenceOfArray1OfPoles2d::Iterator^ thePosition);
    ...
    void InsertAfter(RDC::OCC::Convert_SequenceOfArray1OfPoles2d::Iterator^ thePosition, RDC::OCC::TColgp_HArray1OfPnt2d^ theItem);
    void Split(int theIndex, RDC::OCC::Convert_SequenceOfArray1OfPoles2d^ theSeq);
...
public ref class Convert_SequenceOfArray1OfPoles sealed
    : public RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles>
    , public IIndexEnumerable<RDC::OCC::TColgp_HArray1OfPnt^>
{
...
public:
    Convert_SequenceOfArray1OfPoles(::Convert_SequenceOfArray1OfPoles* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles>( nativeInstance, true )
    {}

    Convert_SequenceOfArray1OfPoles(::Convert_SequenceOfArray1OfPoles& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles::Iterator>
    {
    ...
    public:
        Iterator(::Convert_SequenceOfArray1OfPoles::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles::Iterator>( nativeInstance, true )
        {}

        Iterator(::Convert_SequenceOfArray1OfPoles::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Convert_SequenceOfArray1OfPoles::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::TColgp_HArray1OfPnt^ Value();
        RDC::OCC::TColgp_HArray1OfPnt^ ChangeValue();
        bool IsEqual(RDC::OCC::Convert_SequenceOfArray1OfPoles::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    Convert_SequenceOfArray1OfPoles();
    Convert_SequenceOfArray1OfPoles(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::Convert_SequenceOfArray1OfPoles^ Assign(RDC::OCC::Convert_SequenceOfArray1OfPoles^ theOther);
    void Remove(RDC::OCC::Convert_SequenceOfArray1OfPoles::Iterator^ thePosition);
    void Append(RDC::OCC::TColgp_HArray1OfPnt^ theItem);
    void Prepend(RDC::OCC::TColgp_HArray1OfPnt^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::TColgp_HArray1OfPnt^ theItem);
    void InsertAfter(RDC::OCC::Convert_SequenceOfArray1OfPoles::Iterator^ thePosition, RDC::OCC::TColgp_HArray1OfPnt^ theItem);
    void Split(int theIndex, RDC::OCC::Convert_SequenceOfArray1OfPoles^ theSeq);
    RDC::OCC::TColgp_HArray1OfPnt^ First();
    RDC::OCC::TColgp_HArray1OfPnt^ ChangeFirst();
    RDC::OCC::TColgp_HArray1OfPnt^ Last();
    RDC::OCC::TColgp_HArray1OfPnt^ ChangeLast();
    virtual RDC::OCC::TColgp_HArray1OfPnt^ Value(int theIndex);
    RDC::OCC::TColgp_HArray1OfPnt^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::TColgp_HArray1OfPnt^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::TColgp_HArray1OfPnt^>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class Convert_SequenceOfArray1OfPoles
...
public ref class Convert_ConicToBSplineCurve
    : public RDC::OCC::BaseClass<::Convert_ConicToBSplineCurve>
{
...
protected:
    Convert_ConicToBSplineCurve(InitMode init)
        : RDC::OCC::BaseClass<::Convert_ConicToBSplineCurve>( init )
    {}

public:
    Convert_ConicToBSplineCurve(::Convert_ConicToBSplineCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_ConicToBSplineCurve>( nativeInstance, true )
    {}

    Convert_ConicToBSplineCurve(::Convert_ConicToBSplineCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_ConicToBSplineCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    void BuildCosAndSin(RDC::OCC::Convert_ParameterisationType Parametrisation, RDC::OCC::TColStd_HArray1OfReal^ CosNumerator, RDC::OCC::TColStd_HArray1OfReal^ SinNumerator, RDC::OCC::TColStd_HArray1OfReal^ Denominator, int% Degree, RDC::OCC::TColStd_HArray1OfReal^ Knots, RDC::OCC::TColStd_HArray1OfInteger^ Mults);
    void BuildCosAndSin(RDC::OCC::Convert_ParameterisationType Parametrisation, double UFirst, double ULast, RDC::OCC::TColStd_HArray1OfReal^ CosNumerator, RDC::OCC::TColStd_HArray1OfReal^ SinNumerator, RDC::OCC::TColStd_HArray1OfReal^ Denominator, int% Degree, RDC::OCC::TColStd_HArray1OfReal^ Knots, RDC::OCC::TColStd_HArray1OfInteger^ Mults);
}; // class Convert_ConicToBSplineCurve
...
public ref class Convert_CircleToBSplineCurve sealed
    : public RDC::OCC::Convert_ConicToBSplineCurve
{
...
public:
    Convert_CircleToBSplineCurve(::Convert_CircleToBSplineCurve* nativeInstance)
        : RDC::OCC::Convert_ConicToBSplineCurve( nativeInstance )
    {}
...
public:
    ...
    /// as the circle C.
    /// </summary>
    Convert_CircleToBSplineCurve(RDC::OCC::gp_Circ2d^ C, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// The equivalent B-spline curve has the same orientation
    /// as the circle C.
    /// </summary>
    Convert_CircleToBSplineCurve(RDC::OCC::gp_Circ2d^ C);
    /// <summary>
    ...
    /// </summary>
    Convert_CircleToBSplineCurve(RDC::OCC::gp_Circ2d^ C, double U1, double U2, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// The circle C is limited between the parametric values U1, U2
    /// in radians. U1 and U2 [0.0, 2*Pi] .
    /// The equivalent B-spline curve is oriented from U1 to U2 and has
    ...
    /// Raised if U1 = U2 or U1 = U2 + 2.0 * Pi
    /// </summary>
    Convert_CircleToBSplineCurve(RDC::OCC::gp_Circ2d^ C, double U1, double U2);
}; // class Convert_CircleToBSplineCurve
...
public ref class Convert_CompBezierCurves2dToBSplineCurve2d sealed
    : public RDC::OCC::BaseClass<::Convert_CompBezierCurves2dToBSplineCurve2d>
{
...
public:
    Convert_CompBezierCurves2dToBSplineCurve2d(::Convert_CompBezierCurves2dToBSplineCurve2d* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_CompBezierCurves2dToBSplineCurve2d>( nativeInstance, true )
    {}

    Convert_CompBezierCurves2dToBSplineCurve2d(::Convert_CompBezierCurves2dToBSplineCurve2d& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_CompBezierCurves2dToBSplineCurve2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void AddCurve(RDC::OCC::TColgp_Array1OfPnt2d^ Poles);
    /// <summary>
    ...
    /// </summary>
    void Poles(RDC::OCC::TColgp_Array1OfPnt2d^ Poles);
    /// <summary>
    /// Returns the number of knots of the BSpline curve whose
    /// data is computed in this framework.
    /// Warning
    ...
    /// these conditions are not checked, and an error may occur.
    /// </summary>
    void KnotsAndMults(RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults);
}; // class Convert_CompBezierCurves2dToBSplineCurve2d
...
public ref class Convert_CompBezierCurvesToBSplineCurve sealed
    : public RDC::OCC::BaseClass<::Convert_CompBezierCurvesToBSplineCurve>
{
...
public:
    Convert_CompBezierCurvesToBSplineCurve(::Convert_CompBezierCurvesToBSplineCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_CompBezierCurvesToBSplineCurve>( nativeInstance, true )
    {}

    Convert_CompBezierCurvesToBSplineCurve(::Convert_CompBezierCurvesToBSplineCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_CompBezierCurvesToBSplineCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void AddCurve(RDC::OCC::TColgp_Array1OfPnt^ Poles);
    /// <summary>
    /// Computes all the data needed to build a BSpline curve
    ...
    /// these conditions are not checked, and an error may occur.
    /// </summary>
    void Poles(RDC::OCC::TColgp_Array1OfPnt^ Poles);
    /// <summary>
    /// Returns the number of knots of the BSpline curve whose
    /// data is computed in this framework.
    /// Warning
...
public ref class Convert_CompPolynomialToPoles sealed
    : public RDC::OCC::BaseClass<::Convert_CompPolynomialToPoles>
{
...
public:
    Convert_CompPolynomialToPoles(::Convert_CompPolynomialToPoles* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_CompPolynomialToPoles>( nativeInstance, true )
    {}

    Convert_CompPolynomialToPoles(::Convert_CompPolynomialToPoles& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_CompPolynomialToPoles>( &nativeInstance, false )
    {}
...
public:
    ...
    /// TrueIntervals[2] = {-1, 1}
    /// </summary>
    Convert_CompPolynomialToPoles(int NumCurves, int Continuity, int Dimension, int MaxDegree, RDC::OCC::TColStd_HArray1OfInteger^ NumCoeffPerCurve, RDC::OCC::TColStd_HArray1OfReal^ Coefficients, RDC::OCC::TColStd_HArray2OfReal^ PolynomialIntervals, RDC::OCC::TColStd_HArray1OfReal^ TrueIntervals);
    /// <summary>
    /// To Convert sevral span with different order of Continuity.
    /// Warning: The Length of Continuity have to be NumCurves-1
    /// </summary>
    Convert_CompPolynomialToPoles(int NumCurves, int Dimension, int MaxDegree, RDC::OCC::TColStd_Array1OfInteger^ Continuity, RDC::OCC::TColStd_Array1OfInteger^ NumCoeffPerCurve, RDC::OCC::TColStd_Array1OfReal^ Coefficients, RDC::OCC::TColStd_Array2OfReal^ PolynomialIntervals, RDC::OCC::TColStd_Array1OfReal^ TrueIntervals);
    /// <summary>
    /// To Convert only one span.
    /// </summary>
    Convert_CompPolynomialToPoles(int Dimension, int MaxDegree, int Degree, RDC::OCC::TColStd_Array1OfReal^ Coefficients, RDC::OCC::TColStd_Array1OfReal^ PolynomialIntervals, RDC::OCC::TColStd_Array1OfReal^ TrueIntervals);
    /// <summary>
    ...
    /// </summary>
    void Poles(RDC::OCC::TColStd_HArray2OfReal^ Poles);
    int Degree();
    /// <summary>
    ...
    /// </summary>
    void Knots(RDC::OCC::TColStd_HArray1OfReal^ K);
    /// <summary>
    /// Multiplicities of the knots in the BSpline
    /// </summary>
    void Multiplicities(RDC::OCC::TColStd_HArray1OfInteger^ M);
    bool IsDone();
}; // class Convert_CompPolynomialToPoles
...
public ref class Convert_ElementarySurfaceToBSplineSurface
    : public RDC::OCC::BaseClass<::Convert_ElementarySurfaceToBSplineSurface>
{
...
protected:
    Convert_ElementarySurfaceToBSplineSurface(InitMode init)
        : RDC::OCC::BaseClass<::Convert_ElementarySurfaceToBSplineSurface>( init )
    {}

public:
    Convert_ElementarySurfaceToBSplineSurface(::Convert_ElementarySurfaceToBSplineSurface* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_ElementarySurfaceToBSplineSurface>( nativeInstance, true )
    {}

    Convert_ElementarySurfaceToBSplineSurface(::Convert_ElementarySurfaceToBSplineSurface& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_ElementarySurfaceToBSplineSurface>( &nativeInstance, false )
    {}
...
public ref class Convert_ConeToBSplineSurface sealed
    : public RDC::OCC::Convert_ElementarySurfaceToBSplineSurface
{
...
public:
    Convert_ConeToBSplineSurface(::Convert_ConeToBSplineSurface* nativeInstance)
        : RDC::OCC::Convert_ElementarySurfaceToBSplineSurface( nativeInstance )
    {}
...
public:
    ...
    /// Raised if V1 = V2.
    /// </summary>
    Convert_ConeToBSplineSurface(RDC::OCC::gp_Cone^ C, double U1, double U2, double V1, double V2);
    /// <summary>
    /// The equivalent B-spline surface as the same orientation as the
    /// Cone in the U and V parametric directions.
    /// 
    /// Raised if V1 = V2.
    /// </summary>
    Convert_ConeToBSplineSurface(RDC::OCC::gp_Cone^ C, double V1, double V2);
}; // class Convert_ConeToBSplineSurface
...
public:
    ...
    /// Raised if V1 = V2.
    /// </summary>
    Convert_CylinderToBSplineSurface(RDC::OCC::gp_Cylinder^ Cyl, double U1, double U2, double V1, double V2);
    /// <summary>
    /// The equivalent B-splineSurface as the same orientation as the
    /// cylinder in the U and V parametric directions.
    /// 
    /// Raised if V1 = V2.
    /// </summary>
    Convert_CylinderToBSplineSurface(RDC::OCC::gp_Cylinder^ Cyl, double V1, double V2);
}; // class Convert_CylinderToBSplineSurface
...
public:
    ...
    /// as the ellipse E.
    /// </summary>
    Convert_EllipseToBSplineCurve(RDC::OCC::gp_Elips2d^ E, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// The equivalent B-spline curve has the same orientation
    /// as the ellipse E.
    /// </summary>
    Convert_EllipseToBSplineCurve(RDC::OCC::gp_Elips2d^ E);
    /// <summary>
    ...
    /// Raised if U1 = U2 or U1 = U2 + 2.0 * Pi
    /// </summary>
    Convert_EllipseToBSplineCurve(RDC::OCC::gp_Elips2d^ E, double U1, double U2, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// The ellipse E is limited between the parametric values U1, U2.
    /// The equivalent B-spline curve is oriented from U1 to U2 and has
    /// the same orientation as E.
    ...
    /// Raised if U1 = U2 or U1 = U2 + 2.0 * Pi
    /// </summary>
    Convert_EllipseToBSplineCurve(RDC::OCC::gp_Elips2d^ E, double U1, double U2);
}; // class Convert_EllipseToBSplineCurve
...
public ref class Convert_GridPolynomialToPoles sealed
    : public RDC::OCC::BaseClass<::Convert_GridPolynomialToPoles>
{
...
public:
    Convert_GridPolynomialToPoles(::Convert_GridPolynomialToPoles* nativeInstance)
        : RDC::OCC::BaseClass<::Convert_GridPolynomialToPoles>( nativeInstance, true )
    {}

    Convert_GridPolynomialToPoles(::Convert_GridPolynomialToPoles& nativeInstance)
        : RDC::OCC::BaseClass<::Convert_GridPolynomialToPoles>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Convert_GridPolynomialToPoles(int MaxUDegree, int MaxVDegree, RDC::OCC::TColStd_HArray1OfInteger^ NumCoeff, RDC::OCC::TColStd_HArray1OfReal^ Coefficients, RDC::OCC::TColStd_HArray1OfReal^ PolynomialUIntervals, RDC::OCC::TColStd_HArray1OfReal^ PolynomialVIntervals);
    /// <summary>
...
public:
    ...
    /// hyperbola.
    /// </summary>
    Convert_HyperbolaToBSplineCurve(RDC::OCC::gp_Hypr2d^ H, double U1, double U2);
}; // class Convert_HyperbolaToBSplineCurve
...
public:
    ...
    /// parabola Prb.
    /// </summary>
    Convert_ParabolaToBSplineCurve(RDC::OCC::gp_Parab2d^ Prb, double U1, double U2);
}; // class Convert_ParabolaToBSplineCurve
...
public:
    ...
    /// Raised if V1 = V2.
    /// </summary>
    Convert_SphereToBSplineSurface(RDC::OCC::gp_Sphere^ Sph, double U1, double U2, double V1, double V2);
    /// <summary>
    ...
    /// </summary>
    Convert_SphereToBSplineSurface(RDC::OCC::gp_Sphere^ Sph, double Param1, double Param2, bool UTrim);
    /// <summary>
    /// The equivalent B-spline surface as the same orientation
    /// as the sphere in the U and V parametric directions.
    /// 
    ...
    /// Raised if UTrim = False and Param1 = Param2
    /// </summary>
    Convert_SphereToBSplineSurface(RDC::OCC::gp_Sphere^ Sph, double Param1, double Param2);
    /// <summary>
    /// The equivalent B-spline surface as the same orientation
    /// as the sphere in the U and V parametric directions.
    /// </summary>
    Convert_SphereToBSplineSurface(RDC::OCC::gp_Sphere^ Sph);
}; // class Convert_SphereToBSplineSurface
...
public:
    ...
    /// </summary>
    Convert_TorusToBSplineSurface(RDC::OCC::gp_Torus^ T, double U1, double U2, double V1, double V2);
    /// <summary>
    /// The equivalent B-spline surface as the same orientation as the
    /// torus in the U and V parametric directions.
    /// 
    ...
    /// </summary>
    Convert_TorusToBSplineSurface(RDC::OCC::gp_Torus^ T, double Param1, double Param2, bool UTrim);
    /// <summary>
    /// The equivalent B-spline surface as the same orientation as the
    /// torus in the U and V parametric directions.
    /// 
    /// Raised if Param1 = Param2 or Param1 = Param2 + 2.0 * Pi
    /// </summary>
    Convert_TorusToBSplineSurface(RDC::OCC::gp_Torus^ T, double Param1, double Param2);
    /// <summary>
    /// The equivalent B-spline surface as the same orientation as the
    /// torus in the U and V parametric directions.
    /// </summary>
    Convert_TorusToBSplineSurface(RDC::OCC::gp_Torus^ T);
}; // class Convert_TorusToBSplineSurface
