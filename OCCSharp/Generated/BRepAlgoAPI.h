...
public ref class BRepAlgoAPI_BuilderAlgo
    : public RDC::OCC::BRepAlgoAPI_Algo
{
...
protected:
    BRepAlgoAPI_BuilderAlgo(InitMode init)
        : RDC::OCC::BRepAlgoAPI_Algo( init )
    {}

public:
    BRepAlgoAPI_BuilderAlgo(::BRepAlgoAPI_BuilderAlgo* nativeInstance)
        : RDC::OCC::BRepAlgoAPI_Algo( nativeInstance )
    {}
...
public:
    ...
    /// Sets the arguments
    /// </summary>
    void SetArguments(RDC::OCC::TopTools_ListOfShape^ theLS);
    /// <summary>
    /// Gets the arguments
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ Arguments();
    /// <summary>
    ...
    /// of the input shapes.
    /// </summary>
    void SetGlue(RDC::OCC::BOPAlgo_GlueEnum theGlue);
    /// <summary>
    /// Returns the glue option of the algorithm
    /// </summary>
    RDC::OCC::BOPAlgo_GlueEnum Glue();
    /// <summary>
    ...
    /// </summary>
    bool IsDeleted(RDC::OCC::TopoDS_Shape^ aS);
    /// <summary>
...
public ref class BRepAlgoAPI_BooleanOperation
    : public RDC::OCC::BRepAlgoAPI_BuilderAlgo
{
...
protected:
    BRepAlgoAPI_BooleanOperation(InitMode init)
        : RDC::OCC::BRepAlgoAPI_BuilderAlgo( init )
    {}

public:
    BRepAlgoAPI_BooleanOperation(::BRepAlgoAPI_BooleanOperation* nativeInstance)
        : RDC::OCC::BRepAlgoAPI_BuilderAlgo( nativeInstance )
    {}
...
public:
    ...
    /// Obsolete
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Shape1();
    /// <summary>
    /// Returns the second argument involved in this Boolean operation.
    /// Obsolete
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Shape2();
    /// <summary>
    /// Sets the Tool arguments
    /// </summary>
    void SetTools(RDC::OCC::TopTools_ListOfShape^ theLS);
    /// <summary>
    /// Returns the Tools arguments
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ Tools();
    /// <summary>
    /// Sets the type of Boolean operation
    /// </summary>
    void SetOperation(RDC::OCC::BOPAlgo_Operation theBOP);
    /// <summary>
    /// Returns the type of Boolean Operation
    /// </summary>
    RDC::OCC::BOPAlgo_Operation Operation();
    /// <summary>
...
public ref class BRepAlgoAPI_Check sealed
    : public RDC::OCC::BOPAlgo_Options
{
...
public:
    BRepAlgoAPI_Check(::BRepAlgoAPI_Check* nativeInstance)
        : RDC::OCC::BOPAlgo_Options( nativeInstance )
    {}
...
public:
    ...
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS, bool bTestSE, bool bTestSI, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Constructor for checking single shape.
    /// 
    /// </summary>
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS, bool bTestSE, bool bTestSI);
    /// <summary>
    /// Constructor for checking single shape.
    /// 
    /// </summary>
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS, bool bTestSE);
    /// <summary>
    /// Constructor for checking single shape.
    /// 
    /// </summary>
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS);
    /// <summary>
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::BOPAlgo_Operation theOp, bool bTestSE, bool bTestSI, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Constructor for checking the couple of shapes.
    /// Additionally to the validity checks of each given shape,
    /// the types of the given shapes will be checked on validity
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::BOPAlgo_Operation theOp, bool bTestSE, bool bTestSI);
    /// <summary>
    /// Constructor for checking the couple of shapes.
    /// Additionally to the validity checks of each given shape,
    /// the types of the given shapes will be checked on validity
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::BOPAlgo_Operation theOp, bool bTestSE);
    /// <summary>
    /// Constructor for checking the couple of shapes.
    /// Additionally to the validity checks of each given shape,
    /// the types of the given shapes will be checked on validity
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::BOPAlgo_Operation theOp);
    /// <summary>
    /// Constructor for checking the couple of shapes.
    /// Additionally to the validity checks of each given shape,
    /// the types of the given shapes will be checked on validity
    ...
    /// [in] - parameter to use progress indicator
    /// </param>
    BRepAlgoAPI_Check(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2);
    /// <summary>
    ...
    /// on self-interference or not; by default it is set to TRUE;
    /// </param>
    void SetData(RDC::OCC::TopoDS_Shape^ theS, bool bTestSE, bool bTestSI);
    /// <summary>
    /// Initializes the algorithm with single shape.
    /// 
    /// </summary>
    ...
    /// on self-interference or not; by default it is set to TRUE;
    /// </param>
    void SetData(RDC::OCC::TopoDS_Shape^ theS, bool bTestSE);
    /// <summary>
    /// Initializes the algorithm with single shape.
    /// 
    /// </summary>
    ...
    /// on self-interference or not; by default it is set to TRUE;
    /// </param>
    void SetData(RDC::OCC::TopoDS_Shape^ theS);
    /// <summary>
    ...
    /// on self-interference or not; by default it is set to TRUE;
    /// </param>
    void SetData(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::BOPAlgo_Operation theOp, bool bTestSE, bool bTestSI);
    /// <summary>
    /// Initializes the algorithm with couple of shapes.
    /// Additionally to the validity checks of each given shape,
    /// the types of the given shapes will be checked on validity
    ...
    /// on self-interference or not; by default it is set to TRUE;
    /// </param>
    void SetData(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::BOPAlgo_Operation theOp, bool bTestSE);
    /// <summary>
    /// Initializes the algorithm with couple of shapes.
    /// Additionally to the validity checks of each given shape,
    /// the types of the given shapes will be checked on validity
    ...
    /// on self-interference or not; by default it is set to TRUE;
    /// </param>
    void SetData(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::BOPAlgo_Operation theOp);
    /// <summary>
    /// Initializes the algorithm with couple of shapes.
    /// Additionally to the validity checks of each given shape,
    /// the types of the given shapes will be checked on validity
    ...
    /// on self-interference or not; by default it is set to TRUE;
    /// </param>
    void SetData(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2);
    /// <summary>
    /// Performs the check.
    /// </summary>
    void Perform(RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Performs the check.
    /// </summary>
    void Perform();
...
public ref class BRepAlgoAPI_Common sealed
    : public RDC::OCC::BRepAlgoAPI_BooleanOperation
{
...
public:
    BRepAlgoAPI_Common(::BRepAlgoAPI_Common* nativeInstance)
        : RDC::OCC::BRepAlgoAPI_BooleanOperation( nativeInstance )
    {}
...
public:
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Common(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Constructor with two shapes
    /// <S1>  -argument
    /// <S2>  -tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Common(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2);
...
public:
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Cut(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Constructor with two shapes
    /// <S1>  -argument
    /// <S2>  -tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Cut(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2);
...
public:
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ InputShape();
    /// <summary>
    ...
    /// </param>
    void AddFaceToRemove(RDC::OCC::TopoDS_Shape^ theFace);
    /// <summary>
    ...
    /// </param>
    void AddFacesToRemove(RDC::OCC::TopTools_ListOfShape^ theFaces);
    /// <summary>
    /// Returns the list of faces which have been requested for removal
    /// from the input shape.
    /// </summary>
    RDC::OCC::TopTools_ListOfShape^ FacesToRemove();
    /// <summary>
    ...
    /// </summary>
    bool IsDeleted(RDC::OCC::TopoDS_Shape^ theS);
    /// <summary>
    /// Returns true if any of the input shapes has been modified during operation.
    /// </summary>
    bool HasModified();
...
public:
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Fuse(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Constructor with two shapes
    /// <S1>  -argument
    /// <S2>  -tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Fuse(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2);
...
public:
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2, bool PerformNow);
    /// <summary>
    /// Constructor with two shapes
    /// <S1>  -argument
    /// <S2>  -tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2);
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::Pln Pl, bool PerformNow);
    /// <summary>
    /// Constructor with two shapes
    /// <S1>  - argument
    /// <Pl>  - tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::Pln Pl);
    /// <summary>
    /// Constructor with two shapes
    /// <S1>  - argument
    /// <Sf>  - tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::Geom_Surface^ Sf, bool PerformNow);
    /// <summary>
    /// Constructor with two shapes
    /// <S1>  - argument
    /// <Sf>  - tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::Geom_Surface^ Sf);
    /// <summary>
    /// Constructor with two shapes
    /// <Sf>  - argument
    /// <S2>  - tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::Geom_Surface^ Sf, RDC::OCC::TopoDS_Shape^ S2, bool PerformNow);
    /// <summary>
    /// Constructor with two shapes
    /// <Sf>  - argument
    /// <S2>  - tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::Geom_Surface^ Sf, RDC::OCC::TopoDS_Shape^ S2);
    /// <summary>
    /// Constructor with two shapes
    /// <Sf1>  - argument
    /// <Sf2>  - tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::Geom_Surface^ Sf1, RDC::OCC::Geom_Surface^ Sf2, bool PerformNow);
    /// <summary>
    /// Constructor with two shapes
    /// <Sf1>  - argument
    /// <Sf2>  - tool
    ...
    /// Obsolete
    /// </summary>
    BRepAlgoAPI_Section(RDC::OCC::Geom_Surface^ Sf1, RDC::OCC::Geom_Surface^ Sf2);
    /// <summary>
    /// initialize the argument
    /// <S1>  - argument
    /// Obsolete
    /// </summary>
    void Init1(RDC::OCC::TopoDS_Shape^ S1);
    /// <summary>
    /// initialize the argument
    /// <Pl>  - argument
    /// Obsolete
    /// </summary>
    void Init1(RDC::OCC::Pln Pl);
    /// <summary>
    /// initialize the argument
    /// <Sf>  - argument
    /// Obsolete
    /// </summary>
    void Init1(RDC::OCC::Geom_Surface^ Sf);
    /// <summary>
    /// initialize the tool
    /// <S2>  - tool
    /// Obsolete
    /// </summary>
    void Init2(RDC::OCC::TopoDS_Shape^ S2);
    /// <summary>
    /// initialize the tool
    /// <Pl>  - tool
    /// Obsolete
    /// </summary>
    void Init2(RDC::OCC::Pln Pl);
    /// <summary>
    /// initialize the tool
    /// <Sf>  - tool
    /// Obsolete
    /// </summary>
    void Init2(RDC::OCC::Geom_Surface^ Sf);
    ...
    /// Obsolete
    /// </summary>
    bool HasAncestorFaceOn1(RDC::OCC::TopoDS_Shape^ E, RDC::OCC::TopoDS_Shape^ F);
    /// <summary>
    ...
    /// Obsolete
    /// </summary>
    bool HasAncestorFaceOn2(RDC::OCC::TopoDS_Shape^ E, RDC::OCC::TopoDS_Shape^ F);
}; // class BRepAlgoAPI_Section
