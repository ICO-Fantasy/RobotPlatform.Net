...
public ref class StdSelect sealed
    : public RDC::OCC::BaseClass<::StdSelect>
{
...
public:
    StdSelect(::StdSelect* nativeInstance)
        : RDC::OCC::BaseClass<::StdSelect>( nativeInstance, true )
    {}

    StdSelect(::StdSelect& nativeInstance)
        : RDC::OCC::BaseClass<::StdSelect>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void SetDrawerForBRepOwner(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::Prs3d_Drawer^ aDrawer);
}; // class StdSelect
...
public:
    StdSelect_Shape(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::Prs3d_Drawer^ theDrawer);
    StdSelect_Shape(RDC::OCC::TopoDS_Shape^ theShape);
    ...
    void Shape(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    ...
    static RDC::OCC::StdSelect_Shape^ CreateDowncasted(::StdSelect_Shape* instance);
}; // class StdSelect_Shape
...
public:
    ...
    /// </summary>
    StdSelect_BRepOwner(RDC::OCC::TopoDS_Shape^ aShape, int aPriority, bool ComesFromDecomposition);
    /// <summary>
    /// Constructs an owner specification framework defined
    /// by the shape aShape and the priority aPriority.
    /// aShape and aPriority are stored in this framework. If
    ...
    /// selection, the one with the highest priority is the one stored.
    /// </summary>
    StdSelect_BRepOwner(RDC::OCC::TopoDS_Shape^ aShape, int aPriority);
    /// <summary>
    /// Constructs an owner specification framework defined
    /// by the shape aShape and the priority aPriority.
    /// aShape and aPriority are stored in this framework. If
    ...
    /// selection, the one with the highest priority is the one stored.
    /// </summary>
    StdSelect_BRepOwner(RDC::OCC::TopoDS_Shape^ aShape);
    /// <summary>
    /// Constructs an owner specification framework defined
    ...
    /// </summary>
    StdSelect_BRepOwner(RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::SelectMgr_SelectableObject^ theOrigin, int aPriority, bool FromDecomposition);
    /// <summary>
    /// Constructs an owner specification framework defined
    /// by the shape aShape, the selectable object theOrigin
    /// and the priority aPriority.
    ...
    /// priority is the one stored.
    /// </summary>
    StdSelect_BRepOwner(RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::SelectMgr_SelectableObject^ theOrigin, int aPriority);
    /// <summary>
    /// Constructs an owner specification framework defined
    /// by the shape aShape, the selectable object theOrigin
    /// and the priority aPriority.
    ...
    /// priority is the one stored.
    /// </summary>
    StdSelect_BRepOwner(RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::SelectMgr_SelectableObject^ theOrigin);
    /// <summary>
    ...
    /// </summary>
    bool IsHilighted(RDC::OCC::PrsMgr_PresentationManager^ aPM, int aMode);
    /// <summary>
    /// Returns true if an object with the selection mode
    /// aMode is highlighted in the presentation manager aPM.
    /// </summary>
    bool IsHilighted(RDC::OCC::PrsMgr_PresentationManager^ aPM);
    ...
    /// </summary>
    void Unhilight(RDC::OCC::PrsMgr_PresentationManager^ aPM, int aMode);
    /// <summary>
    /// Removes highlighting from the type of shape
    /// identified the selection mode aMode in the presentation manager aPM.
    /// </summary>
    void Unhilight(RDC::OCC::PrsMgr_PresentationManager^ aPM);
    /// <summary>
    /// Clears the presentation manager object aPM of all
    /// shapes with the selection mode aMode.
    /// </summary>
    void Clear(RDC::OCC::PrsMgr_PresentationManager^ aPM, int aMode);
    /// <summary>
    /// Clears the presentation manager object aPM of all
    /// shapes with the selection mode aMode.
    /// </summary>
    void Clear(RDC::OCC::PrsMgr_PresentationManager^ aPM);
    void SetLocation(RDC::OCC::TopLoc_Location^ aLoc);
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::StdSelect_BRepOwner^ CreateDowncasted(::StdSelect_BRepOwner* instance);
}; // class StdSelect_BRepOwner
...
public ref class StdSelect_BRepSelectionTool sealed
    : public RDC::OCC::BaseClass<::StdSelect_BRepSelectionTool>
{
...
public:
    StdSelect_BRepSelectionTool(::StdSelect_BRepSelectionTool* nativeInstance)
        : RDC::OCC::BaseClass<::StdSelect_BRepSelectionTool>( nativeInstance, true )
    {}

    StdSelect_BRepSelectionTool(::StdSelect_BRepSelectionTool& nativeInstance)
        : RDC::OCC::BaseClass<::StdSelect_BRepSelectionTool>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation, int aPriority, int NbPOnEdge, double MaximalParameter);
    /// <summary>
    /// Decomposition of <aShape> into sensitive entities following
    /// a mode of decomposition <aType>. These entities are stored in <aSelection>.
    /// BrepOwners are created to store the identity of the picked shapes
    ...
    /// called to compute sensitive entities on faces.
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation, int aPriority, int NbPOnEdge);
    /// <summary>
    /// Decomposition of <aShape> into sensitive entities following
    /// a mode of decomposition <aType>. These entities are stored in <aSelection>.
    /// BrepOwners are created to store the identity of the picked shapes
    ...
    /// called to compute sensitive entities on faces.
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation, int aPriority);
    /// <summary>
    /// Decomposition of <aShape> into sensitive entities following
    /// a mode of decomposition <aType>. These entities are stored in <aSelection>.
    /// BrepOwners are created to store the identity of the picked shapes
    ...
    /// called to compute sensitive entities on faces.
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation);
    /// <summary>
    /// Decomposition of <aShape> into sensitive entities following
    /// a mode of decomposition <aType>. These entities are stored in <aSelection>.
    /// BrepOwners are created to store the identity of the picked shapes
    ...
    /// called to compute sensitive entities on faces.
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle);
    /// <summary>
    ...
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::SelectMgr_SelectableObject^ Origin, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation, int aPriority, int NbPOnEdge, double MaximalParameter);
    /// <summary>
    /// Same  functionalities  ; the  only
    /// difference is that  the selectable object from which the
    /// selection comes is stored in each Sensitive EntityOwner;
    ...
    /// (see EntityOwner from SelectBasics and BrepOwner)...
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::SelectMgr_SelectableObject^ Origin, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation, int aPriority, int NbPOnEdge);
    /// <summary>
    /// Same  functionalities  ; the  only
    /// difference is that  the selectable object from which the
    /// selection comes is stored in each Sensitive EntityOwner;
    ...
    /// (see EntityOwner from SelectBasics and BrepOwner)...
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::SelectMgr_SelectableObject^ Origin, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation, int aPriority);
    /// <summary>
    /// Same  functionalities  ; the  only
    /// difference is that  the selectable object from which the
    /// selection comes is stored in each Sensitive EntityOwner;
    ...
    /// (see EntityOwner from SelectBasics and BrepOwner)...
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::SelectMgr_SelectableObject^ Origin, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle, bool AutoTriangulation);
    /// <summary>
    /// Same  functionalities  ; the  only
    /// difference is that  the selectable object from which the
    /// selection comes is stored in each Sensitive EntityOwner;
    ...
    /// (see EntityOwner from SelectBasics and BrepOwner)...
    /// </summary>
    static void Load(RDC::OCC::SelectMgr_Selection^ aSelection, RDC::OCC::SelectMgr_SelectableObject^ Origin, RDC::OCC::TopoDS_Shape^ aShape, RDC::OCC::TopAbs_ShapeEnum aType, double theDeflection, double theDeviationAngle);
    /// <summary>
    ...
    /// </summary>
    static int GetStandardPriority(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::TopAbs_ShapeEnum theType);
    /// <summary>
    ...
    /// </param>
    static void ComputeSensitive(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::SelectMgr_EntityOwner^ theOwner, RDC::OCC::SelectMgr_Selection^ theSelection, double theDeflection, double theDeflAngle, int theNbPOnEdge, double theMaxiParam, bool theAutoTriang);
    /// <summary>
    /// Computes the sensitive primitives, stores them in the SelectMgr_Selection object, and returns this object.
    /// </summary>
    /// <param name="in]">
    ...
    /// theAutoTriang   flag to compute triangulation for the faces which have none
    /// </param>
    static void ComputeSensitive(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::SelectMgr_EntityOwner^ theOwner, RDC::OCC::SelectMgr_Selection^ theSelection, double theDeflection, double theDeflAngle, int theNbPOnEdge, double theMaxiParam);
    ...
    /// theSelection   selection to append new sensitive entities
    /// </param>
    static bool GetSensitiveForCylinder(RDC::OCC::TopTools_IndexedMapOfShape^ theSubfacesMap, RDC::OCC::SelectMgr_EntityOwner^ theOwner, RDC::OCC::SelectMgr_Selection^ theSelection);
    ...
    /// </summary>
    static void PreBuildBVH(RDC::OCC::SelectMgr_Selection^ theSelection);
}; // class StdSelect_BRepSelectionTool
...
public:
    ...
    /// </summary>
    StdSelect_FaceFilter(RDC::OCC::StdSelect_TypeOfFace aTypeOfFace);
    /// <summary>
    /// Sets the type of face aNewType. aNewType is to be highlighted in selection.
    /// </summary>
    void SetType(RDC::OCC::StdSelect_TypeOfFace aNewType);
    /// <summary>
    /// Returns the type of face to be highlighted in selection.
    /// </summary>
    RDC::OCC::StdSelect_TypeOfFace Type();
    bool IsOk(RDC::OCC::SelectMgr_EntityOwner^ anobj);
    bool ActsOn(RDC::OCC::TopAbs_ShapeEnum aStandardMode);
    static RDC::OCC::StdSelect_FaceFilter^ CreateDowncasted(::StdSelect_FaceFilter* instance);
}; // class StdSelect_FaceFilter
...
public:
    ...
    /// </summary>
    StdSelect_ShapeTypeFilter(RDC::OCC::TopAbs_ShapeEnum aType);
    /// <summary>
    /// Returns the type of shape selected by the filter.
    /// </summary>
    RDC::OCC::TopAbs_ShapeEnum Type();
    bool IsOk(RDC::OCC::SelectMgr_EntityOwner^ anobj);
    bool ActsOn(RDC::OCC::TopAbs_ShapeEnum aStandardMode);
    static RDC::OCC::StdSelect_ShapeTypeFilter^ CreateDowncasted(::StdSelect_ShapeTypeFilter* instance);
}; // class StdSelect_ShapeTypeFilter
