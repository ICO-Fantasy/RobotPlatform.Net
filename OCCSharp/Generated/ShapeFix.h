...
public ref class ShapeFix_SequenceOfWireSegment sealed
    : public RDC::OCC::BaseClass<::ShapeFix_SequenceOfWireSegment>
    , public IIndexEnumerable<RDC::OCC::ShapeFix_WireSegment^>
{
...
public:
    ShapeFix_SequenceOfWireSegment(::ShapeFix_SequenceOfWireSegment* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_SequenceOfWireSegment>( nativeInstance, true )
    {}

    ShapeFix_SequenceOfWireSegment(::ShapeFix_SequenceOfWireSegment& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_SequenceOfWireSegment>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::ShapeFix_SequenceOfWireSegment::Iterator>
    {
    ...
    public:
        Iterator(::ShapeFix_SequenceOfWireSegment::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::ShapeFix_SequenceOfWireSegment::Iterator>( nativeInstance, true )
        {}

        Iterator(::ShapeFix_SequenceOfWireSegment::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::ShapeFix_SequenceOfWireSegment::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::ShapeFix_WireSegment^ Value();
        RDC::OCC::ShapeFix_WireSegment^ ChangeValue();
        bool IsEqual(RDC::OCC::ShapeFix_SequenceOfWireSegment::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    ShapeFix_SequenceOfWireSegment();
    ShapeFix_SequenceOfWireSegment(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::ShapeFix_SequenceOfWireSegment^ Assign(RDC::OCC::ShapeFix_SequenceOfWireSegment^ theOther);
    void Remove(RDC::OCC::ShapeFix_SequenceOfWireSegment::Iterator^ thePosition);
    void Append(RDC::OCC::ShapeFix_WireSegment^ theItem);
    void Prepend(RDC::OCC::ShapeFix_WireSegment^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::ShapeFix_WireSegment^ theItem);
    void InsertAfter(RDC::OCC::ShapeFix_SequenceOfWireSegment::Iterator^ thePosition, RDC::OCC::ShapeFix_WireSegment^ theItem);
    void Split(int theIndex, RDC::OCC::ShapeFix_SequenceOfWireSegment^ theSeq);
    RDC::OCC::ShapeFix_WireSegment^ First();
    RDC::OCC::ShapeFix_WireSegment^ ChangeFirst();
    RDC::OCC::ShapeFix_WireSegment^ Last();
    RDC::OCC::ShapeFix_WireSegment^ ChangeLast();
    virtual RDC::OCC::ShapeFix_WireSegment^ Value(int theIndex);
    RDC::OCC::ShapeFix_WireSegment^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::ShapeFix_WireSegment^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::ShapeFix_WireSegment^>^ GetEnumerator();
...
public ref class ShapeFix_DataMapOfShapeBox2d sealed
    : public RDC::OCC::BaseClass<::ShapeFix_DataMapOfShapeBox2d>
{
...
public:
    ShapeFix_DataMapOfShapeBox2d(::ShapeFix_DataMapOfShapeBox2d* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_DataMapOfShapeBox2d>( nativeInstance, true )
    {}

    ShapeFix_DataMapOfShapeBox2d(::ShapeFix_DataMapOfShapeBox2d& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_DataMapOfShapeBox2d>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::ShapeFix_DataMapOfShapeBox2d::Iterator>
    {
    ...
    public:
        Iterator(::ShapeFix_DataMapOfShapeBox2d::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::ShapeFix_DataMapOfShapeBox2d::Iterator>( nativeInstance, true )
        {}

        Iterator(::ShapeFix_DataMapOfShapeBox2d::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::ShapeFix_DataMapOfShapeBox2d::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::Bnd_Box2d^ Value();
        RDC::OCC::Bnd_Box2d^ ChangeValue();
        RDC::OCC::TopoDS_Shape^ Key();
    }; // class Iterator

    ShapeFix_DataMapOfShapeBox2d();
    ShapeFix_DataMapOfShapeBox2d(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    ShapeFix_DataMapOfShapeBox2d(int theNbBuckets);
    void Exchange(RDC::OCC::ShapeFix_DataMapOfShapeBox2d^ theOther);
    RDC::OCC::ShapeFix_DataMapOfShapeBox2d^ Assign(RDC::OCC::ShapeFix_DataMapOfShapeBox2d^ theOther);
    void ReSize(int N);
    bool Bind(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::Bnd_Box2d^ theItem);
    RDC::OCC::Bnd_Box2d^ Bound(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::Bnd_Box2d^ theItem);
    bool IsBound(RDC::OCC::TopoDS_Shape^ theKey);
    bool UnBind(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::Bnd_Box2d^ Seek(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::Bnd_Box2d^ Find(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::Bnd_Box2d^ ChangeSeek(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::Bnd_Box2d^ ChangeFind(RDC::OCC::TopoDS_Shape^ theKey);
...
public ref class ShapeFix sealed
    : public RDC::OCC::BaseClass<::ShapeFix>
{
...
public:
    ShapeFix(::ShapeFix* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix>( nativeInstance, true )
    {}

    ShapeFix(::ShapeFix& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix>( &nativeInstance, false )
    {}
...
public:
    ...
    /// if needed.
    /// </summary>
    static bool SameParameter(RDC::OCC::TopoDS_Shape^ shape, bool enforce, double preci, RDC::OCC::Message_ProgressRange^ theProgress);
    /// <summary>
    /// Runs SameParameter from BRepLib with these adaptations :
    /// <enforce> forces computations, else they are made only on
    /// Edges with flag SameParameter false
    ...
    /// if needed.
    /// </summary>
    static bool SameParameter(RDC::OCC::TopoDS_Shape^ shape, bool enforce, double preci);
    /// <summary>
    /// Runs SameParameter from BRepLib with these adaptations :
    /// <enforce> forces computations, else they are made only on
    /// Edges with flag SameParameter false
    ...
    /// if needed.
    /// </summary>
    static bool SameParameter(RDC::OCC::TopoDS_Shape^ shape, bool enforce);
    /// <summary>
    /// Runs EncodeRegularity from BRepLib taking into account
    /// shared components of assemblies, so that each component
    /// is processed only once
    /// </summary>
    static void EncodeRegularity(RDC::OCC::TopoDS_Shape^ shape, double tolang);
    /// <summary>
    /// Runs EncodeRegularity from BRepLib taking into account
    /// shared components of assemblies, so that each component
    /// is processed only once
    /// </summary>
    static void EncodeRegularity(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    /// Removes edges which are less than given tolerance from shape
    /// with help of ShapeFix_Wire::FixSmall()
    /// </summary>
    static RDC::OCC::TopoDS_Shape^ RemoveSmallEdges(RDC::OCC::TopoDS_Shape^ shape, double Tolerance, RDC::OCC::ShapeBuild_ReShape^ context);
    /// <summary>
    /// Fix position of the vertices having tolerance more tnan specified one.;
    /// </summary>
    static bool FixVertexPosition(RDC::OCC::TopoDS_Shape^ theshape, double theTolerance, RDC::OCC::ShapeBuild_ReShape^ thecontext);
    /// <summary>
    /// Calculate size of least edge;
    /// </summary>
    static double LeastEdgeSize(RDC::OCC::TopoDS_Shape^ theshape);
}; // class ShapeFix
...
public:
    ...
    /// </summary>
    void Set(RDC::OCC::ShapeFix_Root^ Root);
    /// <summary>
    /// Sets context
    /// </summary>
    void SetContext(RDC::OCC::ShapeBuild_ReShape^ context);
    /// <summary>
    /// Returns context
    /// </summary>
    RDC::OCC::ShapeBuild_ReShape^ Context();
    ...
    static RDC::OCC::ShapeFix_Root^ CreateDowncasted(::ShapeFix_Root* instance);
}; // class ShapeFix_Root
...
public ref class ShapeFix_WireSegment sealed
    : public RDC::OCC::BaseClass<::ShapeFix_WireSegment>
{
...
public:
    ShapeFix_WireSegment(::ShapeFix_WireSegment* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_WireSegment>( nativeInstance, true )
    {}

    ShapeFix_WireSegment(::ShapeFix_WireSegment& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_WireSegment>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void Orientation(RDC::OCC::TopAbs_Orientation ori);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Edge^ Edge(int i);
    /// <summary>
    /// Replaces edge at index i by new one.
    /// </summary>
    void SetEdge(int i, RDC::OCC::TopoDS_Edge^ edge);
    /// <summary>
    ...
    /// </summary>
    void AddEdge(int i, RDC::OCC::TopoDS_Edge^ edge);
    /// <summary>
    /// Insert a new edge with index i and explicitly defined
    /// patch indices. If i==0, edge is inserted at end of wire.
    /// </summary>
    void AddEdge(int i, RDC::OCC::TopoDS_Edge^ edge, int iumin, int iumax, int ivmin, int ivmax);
    /// <summary>
    ...
    void SetVertex(RDC::OCC::TopoDS_Vertex^ theVertex);
    RDC::OCC::TopoDS_Vertex^ GetVertex();
    bool IsVertex();
}; // class ShapeFix_WireSegment
...
public:
    ShapeFix_ComposeShell(::ShapeFix_ComposeShell* nativeInstance)
        : RDC::OCC::ShapeFix_Root( nativeInstance )
    {}
...
public:
    ...
    /// face is created.
    /// </summary>
    void DispatchWires(RDC::OCC::TopTools_SequenceOfShape^ faces, RDC::OCC::ShapeFix_SequenceOfWireSegment^ wires);
    /// <summary>
    /// Sets tool for transfer parameters from 3d to 2d and vice versa.
    /// </summary>
    void SetTransferParamTool(RDC::OCC::ShapeAnalysis_TransferParameters^ TransferParam);
    /// <summary>
    /// Gets tool for transfer parameters from 3d to 2d and vice versa.
    /// </summary>
    RDC::OCC::ShapeAnalysis_TransferParameters^ GetTransferParamTool();
    static RDC::OCC::ShapeFix_ComposeShell^ CreateDowncasted(::ShapeFix_ComposeShell* instance);
}; // class ShapeFix_ComposeShell
...
public:
    ...
    /// </summary>
    RDC::OCC::ShapeConstruct_ProjectCurveOnSurface^ Projector();
    bool FixRemovePCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    ...
    /// nothing done
    /// </summary>
    bool FixRemovePCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location);
    /// <summary>
    ...
    /// nothing done
    /// </summary>
    bool FixRemoveCurve3d(RDC::OCC::TopoDS_Edge^ edge);
    /// <summary>
    /// See method below for information
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool isSeam, double prec);
    /// <summary>
    /// See method below for information
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool isSeam);
    /// <summary>
    /// See method below for information
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool isSeam, double prec);
    /// <summary>
    /// See method below for information
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool isSeam);
    /// <summary>
    /// See method below for information
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool isSeam, RDC::OCC::ShapeAnalysis_Surface^ surfana, double prec);
    /// <summary>
    /// See method below for information
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool isSeam, RDC::OCC::ShapeAnalysis_Surface^ surfana);
    /// <summary>
    ...
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool isSeam, RDC::OCC::ShapeAnalysis_Surface^ surfana, double prec);
    /// <summary>
    /// Adds pcurve(s) of the edge if missing (by projecting 3d curve)
    /// Parameter isSeam indicates if the edge is a seam.
    /// The parameter <prec> defines the precision for calculations.
    ...
    /// ShapeConstruct_ProjectCurveOnSurface for more info)
    /// </summary>
    bool FixAddPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool isSeam, RDC::OCC::ShapeAnalysis_Surface^ surfana);
    /// <summary>
    ...
    /// </summary>
    bool FixAddCurve3d(RDC::OCC::TopoDS_Edge^ edge);
    bool FixVertexTolerance(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    ...
    /// </summary>
    bool FixVertexTolerance(RDC::OCC::TopoDS_Edge^ edge);
    bool FixReversed2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    ...
    /// </summary>
    bool FixReversed2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location);
    /// <summary>
    ...
    /// </summary>
    bool FixSameParameter(RDC::OCC::TopoDS_Edge^ edge, double tolerance);
    /// <summary>
    /// Tries to make edge SameParameter and sets corresponding
    /// tolerance and SameParameter flag.
    /// First, it makes edge same range if SameRange flag is not set.
    ...
    /// (only for edges with not set SameParameter)
    /// </summary>
    bool FixSameParameter(RDC::OCC::TopoDS_Edge^ edge);
    /// <summary>
    /// Tries to make edge SameParameter and sets corresponding
    /// tolerance and SameParameter flag.
    /// First, it makes edge same range if SameRange flag is not set.
    ...
    /// (only for edges with not set SameParameter)
    /// </summary>
    bool FixSameParameter(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, double tolerance);
    /// <summary>
    /// Tries to make edge SameParameter and sets corresponding
    /// tolerance and SameParameter flag.
    /// First, it makes edge same range if SameRange flag is not set.
    ...
    /// (only for edges with not set SameParameter)
    /// </summary>
    bool FixSameParameter(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face);
    /* Method skipped due to unknown mapping: bool Status(ShapeExtend_Status status, ) */
    /// <summary>
    /// Sets context
    /// </summary>
    ...
    /// </summary>
    RDC::OCC::ShapeBuild_ReShape^ Context();
    static RDC::OCC::ShapeFix_Edge^ CreateDowncasted(::ShapeFix_Edge* instance);
}; // class ShapeFix_Edge
...
public ref class ShapeFix_EdgeConnect sealed
    : public RDC::OCC::BaseClass<::ShapeFix_EdgeConnect>
{
...
public:
    ShapeFix_EdgeConnect(::ShapeFix_EdgeConnect* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_EdgeConnect>( nativeInstance, true )
    {}

    ShapeFix_EdgeConnect(::ShapeFix_EdgeConnect& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_EdgeConnect>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void Add(RDC::OCC::TopoDS_Edge^ aFirst, RDC::OCC::TopoDS_Edge^ aSecond);
    /// <summary>
    ...
    /// </summary>
    void Add(RDC::OCC::TopoDS_Shape^ aShape);
    /// <summary>
...
public:
    ...
    ShapeFix_EdgeProjAux(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E);
    void Init(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E);
    void Compute(double preci);
    bool IsFirstDone();
    bool IsLastDone();
    double FirstParam();
    double LastParam();
    bool IsIso(RDC::OCC::Geom2d_Curve^ C);
    static RDC::OCC::ShapeFix_EdgeProjAux^ CreateDowncasted(::ShapeFix_EdgeProjAux* instance);
}; // class ShapeFix_EdgeProjAux
...
public:
    ...
    /// </summary>
    ShapeFix_Wire(RDC::OCC::TopoDS_Wire^ wire, RDC::OCC::TopoDS_Face^ face, double prec);
    /// <summary>
    ...
    /// </summary>
    void Init(RDC::OCC::TopoDS_Wire^ wire, RDC::OCC::TopoDS_Face^ face, double prec);
    /// <summary>
    ...
    /// </summary>
    void Init(RDC::OCC::ShapeAnalysis_Wire^ saw);
    /// <summary>
    ...
    /// Set surface for the wire
    /// </summary>
    void SetSurface(RDC::OCC::Geom_Surface^ surf, RDC::OCC::TopLoc_Location^ loc);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Wire^ WireAPIMake();
    /// <summary>
    /// returns field Analyzer (working tool)
    /// </summary>
    RDC::OCC::ShapeAnalysis_Wire^ Analyzer();
    /* Method skipped due to unknown mapping: ShapeExtend_WireData WireData() */
    /// <summary>
    ...
    /// </summary>
    bool FixReorder(RDC::OCC::ShapeAnalysis_WireOrder^ wi);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::ShapeFix_Edge^ FixEdgeTool();
    static RDC::OCC::ShapeFix_Wire^ CreateDowncasted(::ShapeFix_Wire* instance);
}; // class ShapeFix_Wire
...
public:
    ...
    /// </summary>
    ShapeFix_Face(RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    /// Sets all modes to default
    /// </summary>
    void ClearModes();
    ...
    /// location
    /// </summary>
    void Init(RDC::OCC::TopoDS_Face^ face);
    /// <summary>
    /// Starts the creation of the face
    /// By default it will be FORWARD, or REVERSED if <fwd> is False
    /// </summary>
    void Init(RDC::OCC::Geom_Surface^ surf, double preci, bool fwd);
    /// <summary>
    /// Starts the creation of the face
    /// By default it will be FORWARD, or REVERSED if <fwd> is False
    /// </summary>
    ...
    /// By default it will be FORWARD, or REVERSED if <fwd> is False
    /// </summary>
    void Init(RDC::OCC::ShapeAnalysis_Surface^ surf, double preci, bool fwd);
    /// <summary>
    /// Starts the creation of the face
    /// By default it will be FORWARD, or REVERSED if <fwd> is False
    /// </summary>
    ...
    /// </summary>
    void Add(RDC::OCC::TopoDS_Wire^ wire);
    /// <summary>
    ...
    /// </summary>
    bool FixOrientation(RDC::OCC::TopTools_DataMapOfShapeListOfShape^ MapWires);
    /// <summary>
    ...
    /// </summary>
    bool FixLoopWire(RDC::OCC::TopTools_SequenceOfShape^ aResWires);
    /// <summary>
    ...
    /// </summary>
    bool FixSplitFace(RDC::OCC::TopTools_DataMapOfShapeListOfShape^ MapWires);
    /// <summary>
    ...
    /// Returns tool for fixing wires.
    /// </summary>
    RDC::OCC::ShapeFix_Wire^ FixWireTool();
    static RDC::OCC::ShapeFix_Face^ CreateDowncasted(::ShapeFix_Face* instance);
}; // class ShapeFix_Face
...
public ref class ShapeFix_FaceConnect sealed
    : public RDC::OCC::BaseClass<::ShapeFix_FaceConnect>
{
...
public:
    ShapeFix_FaceConnect(::ShapeFix_FaceConnect* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_FaceConnect>( nativeInstance, true )
    {}

    ShapeFix_FaceConnect(::ShapeFix_FaceConnect& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_FaceConnect>( &nativeInstance, false )
    {}
...
public:
    ...
    bool Add(RDC::OCC::TopoDS_Face^ aFirst, RDC::OCC::TopoDS_Face^ aSecond);
    RDC::OCC::TopoDS_Shell^ Build(RDC::OCC::TopoDS_Shell^ shell, double sewtoler, double fixtoler);
    /// <summary>
    /// Clears internal data structure
    /// </summary>
    void Clear();
...
public:
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ FixSpotFace();
    /// <summary>
    /// Compute average vertex and replacing vertices by new one.
    /// </summary>
    bool ReplaceVerticesInCaseOfSpot(RDC::OCC::TopoDS_Face^ F, double tol);
    /// <summary>
    /// Remove spot face from compound
    /// </summary>
    bool RemoveFacesInCaseOfSpot(RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// Fixing case of strip face, if tol = -1 used local tolerance
    /// </summary>
    RDC::OCC::TopoDS_Shape^ FixStripFace(bool wasdone);
    /// <summary>
    /// Fixing case of strip face, if tol = -1 used local tolerance
    /// </summary>
    RDC::OCC::TopoDS_Shape^ FixStripFace();
    /// <summary>
    /// Replace veretces and edges.
    /// </summary>
    bool ReplaceInCaseOfStrip(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol);
    /// <summary>
    /// Remove strip face from compound.
    /// </summary>
    bool RemoveFacesInCaseOfStrip(RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// Compute average edge for strip face
    /// </summary>
    RDC::OCC::TopoDS_Edge^ ComputeSharedEdgeForStripFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, RDC::OCC::TopoDS_Face^ F1, double tol);
    RDC::OCC::TopoDS_Shape^ FixSplitFace(RDC::OCC::TopoDS_Shape^ S);
    /// <summary>
    /// Compute data for face splitting.
    /// </summary>
    bool SplitOneFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Compound^ theSplittedFaces);
    RDC::OCC::TopoDS_Face^ FixFace(RDC::OCC::TopoDS_Face^ F);
    RDC::OCC::TopoDS_Shape^ FixShape();
    RDC::OCC::TopoDS_Shape^ Shape();
    bool FixPinFace(RDC::OCC::TopoDS_Face^ F);
    static RDC::OCC::ShapeFix_FixSmallFace^ CreateDowncasted(::ShapeFix_FixSmallFace* instance);
}; // class ShapeFix_FixSmallFace
...
public:
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Remove(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::ShapeBuild_ReShape^ theContext);
    /// <summary>
    /// Merge small solids in the given shape to adjacent non-small ones
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Merge(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::ShapeBuild_ReShape^ theContext);
    static RDC::OCC::ShapeFix_FixSmallSolid^ CreateDowncasted(::ShapeFix_FixSmallSolid* instance);
}; // class ShapeFix_FixSmallSolid
...
public ref class ShapeFix_FreeBounds sealed
    : public RDC::OCC::BaseClass<::ShapeFix_FreeBounds>
{
...
public:
    ShapeFix_FreeBounds(::ShapeFix_FreeBounds* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_FreeBounds>( nativeInstance, true )
    {}

    ShapeFix_FreeBounds(::ShapeFix_FreeBounds& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_FreeBounds>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    ShapeFix_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double sewtoler, double closetoler, bool splitclosed, bool splitopen);
    /// <summary>
    /// Builds actual free bounds of the <shape> and connects
    /// open wires with tolerance <closetoler>.
    /// <shape> should be a compound of shells.
    /// </summary>
    ShapeFix_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double closetoler, bool splitclosed, bool splitopen);
    /// <summary>
...
public ref class ShapeFix_IntersectionTool sealed
    : public RDC::OCC::BaseClass<::ShapeFix_IntersectionTool>
{
...
public:
    ShapeFix_IntersectionTool(::ShapeFix_IntersectionTool* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_IntersectionTool>( nativeInstance, true )
    {}

    ShapeFix_IntersectionTool(::ShapeFix_IntersectionTool& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_IntersectionTool>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Constructor
    /// </summary>
    ShapeFix_IntersectionTool(RDC::OCC::ShapeBuild_ReShape^ context, double preci, double maxtol);
    /// <summary>
    /// Constructor
    /// </summary>
    ShapeFix_IntersectionTool(RDC::OCC::ShapeBuild_ReShape^ context, double preci);
    /// <summary>
    /// Returns context
    /// </summary>
    RDC::OCC::ShapeBuild_ReShape^ Context();
    ...
    /// </summary>
    bool SplitEdge(RDC::OCC::TopoDS_Edge^ edge, double param, RDC::OCC::TopoDS_Vertex^ vert, RDC::OCC::TopoDS_Face^ face, RDC::OCC::TopoDS_Edge^ newE1, RDC::OCC::TopoDS_Edge^ newE2, double preci);
    /// <summary>
    /// Cut edge by parameters pend and cut
    /// </summary>
    bool CutEdge(RDC::OCC::TopoDS_Edge^ edge, double pend, double cut, RDC::OCC::TopoDS_Face^ face, bool% iscutline);
    ...
    bool FixIntersectingWires(RDC::OCC::TopoDS_Face^ face);
}; // class ShapeFix_IntersectionTool
...
public:
    ...
    /// </summary>
    ShapeFix_Solid(RDC::OCC::TopoDS_Solid^ solid);
    /// <summary>
    /// Initializes by solid .
    /// </summary>
    void Init(RDC::OCC::TopoDS_Solid^ solid);
    /// <summary>
    ...
    /// </summary>
    bool Perform(RDC::OCC::Message_ProgressRange^ theProgress);
    /// <summary>
    /// Iterates on shells and performs fixes
    /// (calls ShapeFix_Shell for each subshell). The passed
    /// progress indicator allows user to consult the current
    ...
    /// </summary>
    RDC::OCC::TopoDS_Solid^ SolidFromShell(RDC::OCC::TopoDS_Shell^ shell);
    /* Method skipped due to unknown mapping: bool Status(ShapeExtend_Status status, ) */
    /// <summary>
    /// Returns resulting solid.
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Solid();
    /// <summary>
    /// Returns tool for fixing shells.
    /// </summary>
    RDC::OCC::ShapeFix_Shell^ FixShellTool();
    /* Method skipped due to unknown mapping: void SetMsgRegistrator(ShapeExtend_BasicMsgRegistrator msgreg, ) */
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ Shape();
    static RDC::OCC::ShapeFix_Solid^ CreateDowncasted(::ShapeFix_Solid* instance);
}; // class ShapeFix_Solid
...
public:
    ...
    /// </summary>
    ShapeFix_Shell(RDC::OCC::TopoDS_Shell^ shape);
    /// <summary>
    /// Initializes by shell.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shell^ shell);
    /// <summary>
    ...
    /// </summary>
    bool FixFaceOrientation(RDC::OCC::TopoDS_Shell^ shell, bool isAccountMultiConex, bool NonManifold);
    /// <summary>
    /// Fixes orientation of faces in shell.
    /// Changes orientation of face in the shell, if it is oriented opposite
    /// to neighbouring faces. If it is not possible to orient all faces in the
    ...
    /// manifold shells will be created. By default - Standard_False.
    /// </summary>
    bool FixFaceOrientation(RDC::OCC::TopoDS_Shell^ shell, bool isAccountMultiConex);
    /// <summary>
    /// Fixes orientation of faces in shell.
    /// Changes orientation of face in the shell, if it is oriented opposite
    /// to neighbouring faces. If it is not possible to orient all faces in the
    ...
    /// manifold shells will be created. By default - Standard_False.
    /// </summary>
    bool FixFaceOrientation(RDC::OCC::TopoDS_Shell^ shell);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Compound^ ErrorFaces();
    /* Method skipped due to unknown mapping: bool Status(ShapeExtend_Status status, ) */
    /// <summary>
    /// Returns tool for fixing faces.
    /// </summary>
    RDC::OCC::ShapeFix_Face^ FixFaceTool();
    /* Method skipped due to unknown mapping: void SetMsgRegistrator(ShapeExtend_BasicMsgRegistrator msgreg, ) */
    /// <summary>
    /// Sets basic precision value (also to FixWireTool)
    /// </summary>
    ...
    static RDC::OCC::ShapeFix_Shell^ CreateDowncasted(::ShapeFix_Shell* instance);
}; // class ShapeFix_Shell
...
public:
    ...
    /// </summary>
    ShapeFix_Shape(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    /// Initislises by shape.
    /// </summary>
    ...
    /// </summary>
    RDC::OCC::ShapeFix_Solid^ FixSolidTool();
    /// <summary>
    /// Returns tool for fixing shells.
    /// </summary>
    RDC::OCC::ShapeFix_Shell^ FixShellTool();
    ...
    /// </summary>
    void SetMaxTolerance(double maxtol);
    static RDC::OCC::ShapeFix_Shape^ CreateDowncasted(::ShapeFix_Shape* instance);
}; // class ShapeFix_Shape
...
public ref class ShapeFix_ShapeTolerance sealed
    : public RDC::OCC::BaseClass<::ShapeFix_ShapeTolerance>
{
...
public:
    ShapeFix_ShapeTolerance(::ShapeFix_ShapeTolerance* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_ShapeTolerance>( nativeInstance, true )
    {}

    ShapeFix_ShapeTolerance(::ShapeFix_ShapeTolerance& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_ShapeTolerance>( &nativeInstance, false )
    {}
...
public:
    ...
    /// been modified
    /// </summary>
    bool LimitTolerance(RDC::OCC::TopoDS_Shape^ shape, double tmin, double tmax, RDC::OCC::TopAbs_ShapeEnum styp);
    /// <summary>
    /// Limits tolerances in a shape as follows :
    /// tmin = tmax -> as SetTolerance (forces)
    /// tmin = 0   -> maximum tolerance will be <tmax>
    ...
    /// been modified
    /// </summary>
    bool LimitTolerance(RDC::OCC::TopoDS_Shape^ shape, double tmin, double tmax);
    /// <summary>
    /// Limits tolerances in a shape as follows :
    /// tmin = tmax -> as SetTolerance (forces)
    /// tmin = 0   -> maximum tolerance will be <tmax>
    ...
    /// been modified
    /// </summary>
    bool LimitTolerance(RDC::OCC::TopoDS_Shape^ shape, double tmin);
    /// <summary>
    ...
    /// styp = other value : all (vertices,edges,faces) are set
    /// </summary>
    void SetTolerance(RDC::OCC::TopoDS_Shape^ shape, double preci, RDC::OCC::TopAbs_ShapeEnum styp);
    /// <summary>
    /// Sets (enforces) tolerances in a shape to the given value
    /// styp = VERTEX : only vertices are set
    /// styp = EDGE   : only edges are set
    ...
    /// styp = other value : all (vertices,edges,faces) are set
    /// </summary>
    void SetTolerance(RDC::OCC::TopoDS_Shape^ shape, double preci);
}; // class ShapeFix_ShapeTolerance
...
public:
    ...
    void Perform();
    RDC::OCC::TopoDS_Shape^ Shape();
    static RDC::OCC::ShapeFix_SplitCommonVertex^ CreateDowncasted(::ShapeFix_SplitCommonVertex* instance);
}; // class ShapeFix_SplitCommonVertex
...
public ref class ShapeFix_SplitTool sealed
    : public RDC::OCC::BaseClass<::ShapeFix_SplitTool>
{
...
public:
    ShapeFix_SplitTool(::ShapeFix_SplitTool* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_SplitTool>( nativeInstance, true )
    {}

    ShapeFix_SplitTool(::ShapeFix_SplitTool& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_SplitTool>( &nativeInstance, false )
    {}
...
public:
    ...
    /// The "face" is necessary for pcurves and using TransferParameterProj
    /// </summary>
    bool SplitEdge(RDC::OCC::TopoDS_Edge^ edge, double param, RDC::OCC::TopoDS_Vertex^ vert, RDC::OCC::TopoDS_Face^ face, RDC::OCC::TopoDS_Edge^ newE1, RDC::OCC::TopoDS_Edge^ newE2, double tol3d, double tol2d);
    /// <summary>
    /// Split edge on two new edges using new vertex "vert"
    /// and "param1" and "param2" - parameter for splitting and cutting
    /// The "face" is necessary for pcurves and using TransferParameterProj
    /// </summary>
    bool SplitEdge(RDC::OCC::TopoDS_Edge^ edge, double param1, double param2, RDC::OCC::TopoDS_Vertex^ vert, RDC::OCC::TopoDS_Face^ face, RDC::OCC::TopoDS_Edge^ newE1, RDC::OCC::TopoDS_Edge^ newE2, double tol3d, double tol2d);
    /// <summary>
    /// Cut edge by parameters pend and cut
    /// </summary>
    bool CutEdge(RDC::OCC::TopoDS_Edge^ edge, double pend, double cut, RDC::OCC::TopoDS_Face^ face, bool% iscutline);
    ...
    /// </summary>
    bool SplitEdge(RDC::OCC::TopoDS_Edge^ edge, double fp, RDC::OCC::TopoDS_Vertex^ V1, double lp, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Face^ face, RDC::OCC::TopTools_SequenceOfShape^ SeqE, int% aNum, RDC::OCC::ShapeBuild_ReShape^ context, double tol3d, double tol2d);
}; // class ShapeFix_SplitTool
...
public:
    ...
    ShapeFix_Wireframe();
    ShapeFix_Wireframe(RDC::OCC::TopoDS_Shape^ shape);
    /// <summary>
    /// Clears all statuses
    /// </summary>
    void ClearStatuses();
    ...
    /// </summary>
    bool CheckSmallEdges(RDC::OCC::TopTools_MapOfShape^ theSmallEdges, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theEdgeToFaces, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theFaceWithSmall, RDC::OCC::TopTools_MapOfShape^ theMultyEdges);
    /// <summary>
    ...
    /// </summary>
    bool MergeSmallEdges(RDC::OCC::TopTools_MapOfShape^ theSmallEdges, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theEdgeToFaces, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theFaceWithSmall, RDC::OCC::TopTools_MapOfShape^ theMultyEdges, bool theModeDrop, double theLimitAngle);
    /// <summary>
    /// Auxiliary tool for FixSmallEdges which merges small edges.
    /// If theModeDrop is equal to Standard_True then small edges,
    /// which cannot be connected with adjacent edges are dropped.
    ...
    /// If theLimitAngle is equal to -1, this angle is not taken into account.
    /// </summary>
    bool MergeSmallEdges(RDC::OCC::TopTools_MapOfShape^ theSmallEdges, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theEdgeToFaces, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theFaceWithSmall, RDC::OCC::TopTools_MapOfShape^ theMultyEdges, bool theModeDrop);
    /// <summary>
    /// Auxiliary tool for FixSmallEdges which merges small edges.
    /// If theModeDrop is equal to Standard_True then small edges,
    /// which cannot be connected with adjacent edges are dropped.
    ...
    /// If theLimitAngle is equal to -1, this angle is not taken into account.
    /// </summary>
    bool MergeSmallEdges(RDC::OCC::TopTools_MapOfShape^ theSmallEdges, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theEdgeToFaces, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ theFaceWithSmall, RDC::OCC::TopTools_MapOfShape^ theMultyEdges);
    ...
    /// </summary>
    double LimitAngle();
    static RDC::OCC::ShapeFix_Wireframe^ CreateDowncasted(::ShapeFix_Wireframe* instance);
}; // class ShapeFix_Wireframe
...
public ref class ShapeFix_WireVertex sealed
    : public RDC::OCC::BaseClass<::ShapeFix_WireVertex>
{
...
public:
    ShapeFix_WireVertex(::ShapeFix_WireVertex* nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_WireVertex>( nativeInstance, true )
    {}

    ShapeFix_WireVertex(::ShapeFix_WireVertex& nativeInstance)
        : RDC::OCC::BaseClass<::ShapeFix_WireVertex>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void Init(RDC::OCC::ShapeAnalysis_WireVertex^ sawv);
    /// <summary>
    /// returns internal analyzer
    /// </summary>
    RDC::OCC::ShapeAnalysis_WireVertex^ Analyzer();
    /* Method skipped due to unknown mapping: ShapeExtend_WireData WireData() */
    /// <summary>
