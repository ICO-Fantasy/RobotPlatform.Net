...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class BRepTools_MapOfVertexPnt2d sealed
			: public RDC::OCC::BaseClass<::BRepTools_MapOfVertexPnt2d>
		{
		...
		public:
			BRepTools_MapOfVertexPnt2d(::BRepTools_MapOfVertexPnt2d* nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_MapOfVertexPnt2d>(nativeInstance, true)
			{}

			BRepTools_MapOfVertexPnt2d(::BRepTools_MapOfVertexPnt2d& nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_MapOfVertexPnt2d>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::BRepTools_MapOfVertexPnt2d::Iterator>
			{
			...
			public:
				Iterator(::BRepTools_MapOfVertexPnt2d::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::BRepTools_MapOfVertexPnt2d::Iterator>(nativeInstance, true)
				{}

				Iterator(::BRepTools_MapOfVertexPnt2d::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::BRepTools_MapOfVertexPnt2d::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::TColgp_SequenceOfPnt2d^ Value();
				RDC::OCC::TColgp_SequenceOfPnt2d^ ChangeValue();
				RDC::OCC::TopoDS_Shape^ Key();
			}; // class Iterator

			BRepTools_MapOfVertexPnt2d();
			BRepTools_MapOfVertexPnt2d(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			BRepTools_MapOfVertexPnt2d(int theNbBuckets);
			void Exchange(RDC::OCC::BRepTools_MapOfVertexPnt2d^ theOther);
			RDC::OCC::BRepTools_MapOfVertexPnt2d^ Assign(RDC::OCC::BRepTools_MapOfVertexPnt2d^ theOther);
			void ReSize(int N);
			bool Bind(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::TColgp_SequenceOfPnt2d^ theItem);
			RDC::OCC::TColgp_SequenceOfPnt2d^ Bound(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::TColgp_SequenceOfPnt2d^ theItem);
			bool IsBound(RDC::OCC::TopoDS_Shape^ theKey);
			bool UnBind(RDC::OCC::TopoDS_Shape^ theKey);
			RDC::OCC::TColgp_SequenceOfPnt2d^ Seek(RDC::OCC::TopoDS_Shape^ theKey);
			RDC::OCC::TColgp_SequenceOfPnt2d^ Find(RDC::OCC::TopoDS_Shape^ theKey);
			RDC::OCC::TColgp_SequenceOfPnt2d^ ChangeSeek(RDC::OCC::TopoDS_Shape^ theKey);
			RDC::OCC::TColgp_SequenceOfPnt2d^ ChangeFind(RDC::OCC::TopoDS_Shape^ theKey);
		...
		public ref class BRepTools sealed
			: public RDC::OCC::BaseClass<::BRepTools>
		{
		...
		public:
			BRepTools(::BRepTools* nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools>(nativeInstance, true)
			{}

			BRepTools(::BRepTools& nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			static void UVBounds(RDC::OCC::TopoDS_Face^ F, double% UMin, double% UMax, double% VMin, double% VMax);
			/// <summary>
			/// Returns in UMin,  UMax, VMin,  VMax  the  bounding
			/// values of the wire in the parametric space of F.
			/// </summary>
			static void UVBounds(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Wire^ W, double% UMin, double% UMax, double% VMin, double% VMax);
			/// <summary>
			/// Returns in UMin,  UMax, VMin,  VMax  the  bounding
			/// values of the edge in the parametric space of F.
			/// </summary>
			static void UVBounds(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E, double% UMin, double% UMax, double% VMin, double% VMax);
			/// <summary>
			/// Adds  to  the box <B>  the bounding values in  the
			/// parametric space of F.
			/// </summary>
			static void AddUVBounds(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Bnd_Box2d^ B);
			/// <summary>
			/// Adds  to the box  <B>  the bounding  values of the
			/// wire in the parametric space of F.
			/// </summary>
			static void AddUVBounds(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Wire^ W, RDC::OCC::Bnd_Box2d^ B);
			/// <summary>
			/// Adds to  the box <B>  the  bounding values  of the
			/// edge in the parametric space of F.
			/// </summary>
			static void AddUVBounds(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E, RDC::OCC::Bnd_Box2d^ B);
			/// <summary>
			/// Update a vertex (nothing is done)
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Vertex^ V);
			/// <summary>
			/// Update an edge, compute 2d bounding boxes.
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			/// Update a wire (nothing is done)
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Update a Face, update UV points.
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Update a shell (nothing is done)
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Shell^ S);
			/// <summary>
			/// Update a solid (nothing is done)
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Solid^ S);
			/// <summary>
			/// Update a composite solid (nothing is done)
			/// </summary>
			static void Update(RDC::OCC::TopoDS_CompSolid^ C);
			/// <summary>
			/// Update a compound (nothing is done)
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Compound^ C);
			/// <summary>
			/// Update a shape, call the correct update.
			/// </summary>
			static void Update(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// For each edge of the face <F> reset the UV points
			/// to the bounding points of the parametric curve of the
			/// edge on the face.
			/// </summary>
			static void UpdateFaceUVPoints(RDC::OCC::TopoDS_Face^ theF);
			/// <summary>
			...
			/// </param>
			static void Clean(RDC::OCC::TopoDS_Shape^ theShape, bool theForce);
			/// <summary>
			/// Removes all cached polygonal representation of the shape,
			/// i.e. the triangulations of the faces of <S> and polygons on
			/// triangulations and polygons 3d of the edges.
			...
			/// </returns>
			static bool Triangulation(RDC::OCC::TopoDS_Shape^ theShape, double theLinDefl, bool theToCheckFreeEdges);
			/// <summary>
			/// Verifies that each Face from the shape has got a triangulation with a deflection smaller or equal to specified one
			/// and the Edges a discretization on this triangulation.
			/// </summary>
			...
			/// or free Edges in Shape lack 3D polygons
			/// </returns>
			static bool Triangulation(RDC::OCC::TopoDS_Shape^ theShape, double theLinDefl);
			...
			/// </returns>
			static bool LoadTriangulation(RDC::OCC::TopoDS_Shape^ theShape, int theTriangulationIdx, bool theToSetAsActive);
			/// <summary>
			/// Loads triangulation data for each face of the shape
			/// from some deferred storage using specified shared input file system
			/// </summary>
			...
			/// TRUE if at least one triangulation is loaded.
			/// </returns>
			static bool LoadTriangulation(RDC::OCC::TopoDS_Shape^ theShape, int theTriangulationIdx);
			/// <summary>
			/// Loads triangulation data for each face of the shape
			/// from some deferred storage using specified shared input file system
			/// </summary>
			...
			/// TRUE if at least one triangulation is loaded.
			/// </returns>
			static bool LoadTriangulation(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			...
			/// </returns>
			static bool UnloadTriangulation(RDC::OCC::TopoDS_Shape^ theShape, int theTriangulationIdx);
			/// <summary>
			/// Releases triangulation data for each face of the shape if there is deferred storage to load it later
			/// </summary>
			/// <param name="theShape">
			...
			/// TRUE if at least one triangulation is unloaded.
			/// </returns>
			static bool UnloadTriangulation(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			...
			/// </returns>
			static bool ActivateTriangulation(RDC::OCC::TopoDS_Shape^ theShape, int theTriangulationIdx, bool theToActivateStrictly);
			/// <summary>
			/// Activates triangulation data for each face of the shape
			/// from some deferred storage using specified shared input file system
			/// </summary>
			...
			/// TRUE if at least one active triangulation was changed.
			/// </returns>
			static bool ActivateTriangulation(RDC::OCC::TopoDS_Shape^ theShape, int theTriangulationIdx);
			...
			/// TRUE if at least one triangulation is loaded.
			/// </returns>
			static bool LoadAllTriangulations(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			...
			/// TRUE if at least one triangulation is unloaded.
			/// </returns>
			static bool UnloadAllTriangulations(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// Returns  True if  the    distance between the  two
			/// vertices is lower than their tolerance.
			/// </summary>
			static bool Compare(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			/// <summary>
			/// Returns  True if  the    distance between the  two
			/// edges is lower than their tolerance.
			/// </summary>
			static bool Compare(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
			/// <summary>
			/// Returns the outer most wire of <F>. Returns a Null
			/// wire if <F> has no wires.
			/// </summary>
			static RDC::OCC::TopoDS_Wire^ OuterWire(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Stores in the map  <M> all the 3D topology edges
			/// of <S>.
			/// </summary>
			static void Map3DEdges(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_IndexedMapOfShape^ M);
			/// <summary>
			/// Verifies that the edge  <E> is found two  times on
			/// the face <F> before calling BRep_Tool::IsClosed.
			/// </summary>
			static bool IsReallyClosed(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Detect closedness of face in U and V directions
			/// </summary>
			static void DetectClosedness(RDC::OCC::TopoDS_Face^ theFace, bool% theUclosed, bool% theVclosed);
			/// <summary>
			...
			/// </param>
			static void Write(RDC::OCC::TopoDS_Shape^ theShape, System::IO::TextWriter^ theStream, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Writes the shape to the stream in an ASCII format TopTools_FormatVersion_VERSION_1.
			/// This alias writes shape with triangulation data.
			/// </summary>
			...
			///            the range of progress indicator to fill in
			/// </param>
			static void Write(RDC::OCC::TopoDS_Shape^ theShape, System::IO::TextWriter^ theStream);
			/// <summary>
			...
			/// the range of progress indicator to fill in
			/// </param>
			static void Write(RDC::OCC::TopoDS_Shape^ theShape, System::IO::TextWriter^ theStream, bool theWithTriangles, bool theWithNormals, RDC::OCC::TopTools_FormatVersion theVersion, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Writes the shape to the stream in an ASCII format of specified version.
			/// </summary>
			/// <param name="theShape">
			...
			/// the range of progress indicator to fill in
			/// </param>
			static void Write(RDC::OCC::TopoDS_Shape^ theShape, System::IO::TextWriter^ theStream, bool theWithTriangles, bool theWithNormals, RDC::OCC::TopTools_FormatVersion theVersion);
			...
			/// the range of progress indicator to fill in
			/// </param>
			static bool Write(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Writes the shape to the file in an ASCII format TopTools_FormatVersion_VERSION_1.
			/// This alias writes shape with triangulation data.
			/// </summary>
			...
			/// the range of progress indicator to fill in
			/// </param>
			static bool Write(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile);
			/// <summary>
			...
			/// the range of progress indicator to fill in
			/// </param>
			static bool Write(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile, bool theWithTriangles, bool theWithNormals, RDC::OCC::TopTools_FormatVersion theVersion, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Writes the shape to the file in an ASCII format of specified version.
			/// </summary>
			/// <param name="theShape">
			...
			/// the range of progress indicator to fill in
			/// </param>
			static bool Write(RDC::OCC::TopoDS_Shape^ theShape, System::String^ theFile, bool theWithTriangles, bool theWithNormals, RDC::OCC::TopTools_FormatVersion theVersion);
			/// <summary>
			/// Reads a Shape  from <File>,  returns it in  <Sh>.
			/// <B> is used to build the shape.
			/// </summary>
			static bool Read(RDC::OCC::TopoDS_Shape^ Sh, System::String^ File, RDC::OCC::BRep_Builder^ B, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Reads a Shape  from <File>,  returns it in  <Sh>.
			/// <B> is used to build the shape.
			/// </summary>
			static bool Read(RDC::OCC::TopoDS_Shape^ Sh, System::String^ File, RDC::OCC::BRep_Builder^ B);
			/// <summary>
			...
			/// </summary>
			static double EvalAndUpdateTol(RDC::OCC::TopoDS_Edge^ theE, RDC::OCC::Geom_Curve^ theC3d, RDC::OCC::Geom2d_Curve^ theC2d, RDC::OCC::Geom_Surface^ theS, double theF, double theL);
			/// <summary>
			/// returns the cumul  of the orientation  of <Edge>
			/// and thc containing wire in <Face>
			/// </summary>
			static RDC::OCC::TopAbs_Orientation OriEdgeInFace(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace);
			/// <summary>
			...
			/// </summary>
			static void RemoveInternals(RDC::OCC::TopoDS_Shape^ theS, bool theForce);
			/// <summary>
			/// Removes internal sub-shapes from the shape.
			/// The check on internal status is based on orientation of sub-shapes,
			/// classification is not performed.
			...
			/// the given shape from all sub-shapes with internal orientation.
			/// </summary>
			static void RemoveInternals(RDC::OCC::TopoDS_Shape^ theS);
			/// <summary>
			...
			/// </summary>
			static void CheckLocations(RDC::OCC::TopoDS_Shape^ theS, RDC::OCC::TopTools_ListOfShape^ theProblemShapes);
		}; // class BRepTools
		...
		public:
			...
			/// </summary>
			bool NewSurface(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Geom_Surface^ S, RDC::OCC::TopLoc_Location^ L, double% Tol, bool% RevWires, bool% RevFace);
			...
			/// </summary>
			bool NewCurve(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::Geom_Curve^ C, RDC::OCC::TopLoc_Location^ L, double% Tol);
			...
			/// </summary>
			bool NewPoint(RDC::OCC::TopoDS_Vertex^ V, RDC::OCC::Pnt% P, double% Tol);
			/// <summary>
			...
			/// returns false, and the values of C, L and Tol are not significant.
			/// </summary>
			bool NewCurve2d(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ NewE, RDC::OCC::TopoDS_Face^ NewF, RDC::OCC::Geom2d_Curve^ C, double% Tol);
			/// <summary>
			...
			/// </summary>
			bool NewParameter(RDC::OCC::TopoDS_Vertex^ V, RDC::OCC::TopoDS_Edge^ E, double% P, double% Tol);
			/// <summary>
			...
			/// (resp. <F2>).
			/// </summary>
			RDC::OCC::GeomAbs_Shape Continuity(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F1, RDC::OCC::TopoDS_Face^ F2, RDC::OCC::TopoDS_Edge^ NewE, RDC::OCC::TopoDS_Face^ NewF1, RDC::OCC::TopoDS_Face^ NewF2);
			static RDC::OCC::BRepTools_Modification^ CreateDowncasted(::BRepTools_Modification* instance);
		}; // class BRepTools_Modification
		...
		public ref class BRepTools_CopyModification
			: public RDC::OCC::BRepTools_Modification
		{
		...
		protected:
			BRepTools_CopyModification(InitMode init)
				: RDC::OCC::BRepTools_Modification(init)
			{}

		public:
			BRepTools_CopyModification(::BRepTools_CopyModification* nativeInstance)
				: RDC::OCC::BRepTools_Modification(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			bool NewSurface(RDC::OCC::TopoDS_Face^ theFace, RDC::OCC::Geom_Surface^ theSurf, RDC::OCC::TopLoc_Location^ theLoc, double% theTol, bool% theRevWires, bool% theRevFace);
			/// <summary>
			...
			/// </summary>
			bool NewCurve(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::Geom_Curve^ theCurve, RDC::OCC::TopLoc_Location^ theLoc, double% theTol);
			/// <summary>
			...
			/// </summary>
			bool NewPoint(RDC::OCC::TopoDS_Vertex^ theVertex, RDC::OCC::Pnt% thePnt, double% theTol);
			/// <summary>
			...
			/// </summary>
			bool NewCurve2d(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace, RDC::OCC::TopoDS_Edge^ theNewEdge, RDC::OCC::TopoDS_Face^ theNewFace, RDC::OCC::Geom2d_Curve^ theCurve, double% theTol);
			/// <summary>
			...
			/// </summary>
			bool NewParameter(RDC::OCC::TopoDS_Vertex^ theVertex, RDC::OCC::TopoDS_Edge^ theEdge, double% thePnt, double% theTol);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::GeomAbs_Shape Continuity(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace1, RDC::OCC::TopoDS_Face^ theFace2, RDC::OCC::TopoDS_Edge^ theNewEdge, RDC::OCC::TopoDS_Face^ theNewFace1, RDC::OCC::TopoDS_Face^ theNewFace2);
			...
			static RDC::OCC::BRepTools_CopyModification^ CreateDowncasted(::BRepTools_CopyModification* instance);
		}; // class BRepTools_CopyModification
		...
		public:
			BRepTools_GTrsfModification(RDC::OCC::gp_GTrsf^ T);
			/// <summary>
			/// Gives an access on the GTrsf.
			/// </summary>
			RDC::OCC::gp_GTrsf^ GTrsf();
			/// <summary>
			...
			/* Method skipped due to unknown mapping: bool NewPolygon(TopoDS_Edge theEdge, Poly_Polygon3D thePoly, ) */
			/* Method skipped due to unknown mapping: bool NewPolygonOnTriangulation(TopoDS_Edge theEdge, TopoDS_Face theFace, Poly_PolygonOnTriangulation thePoly, ) */
			static RDC::OCC::BRepTools_GTrsfModification^ CreateDowncasted(::BRepTools_GTrsfModification* instance);
		}; // class BRepTools_GTrsfModification
		...
		public:
			...
			/// </summary>
			static bool IsSupportedType(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// Set the second shape as generated one from the first shape.
			/// </summary>
			void AddGenerated(RDC::OCC::TopoDS_Shape^ theInitial, RDC::OCC::TopoDS_Shape^ theGenerated);
			/// <summary>
			/// Set the second shape as modified one from the first shape.
			/// </summary>
			void AddModified(RDC::OCC::TopoDS_Shape^ theInitial, RDC::OCC::TopoDS_Shape^ theModified);
			/// <summary>
			/// Set the shape as removed one.
			/// </summary>
			void Remove(RDC::OCC::TopoDS_Shape^ theRemoved);
			/// <summary>
			/// Set the second shape as the only generated one from the first one.
			/// </summary>
			void ReplaceGenerated(RDC::OCC::TopoDS_Shape^ theInitial, RDC::OCC::TopoDS_Shape^ theGenerated);
			/// <summary>
			/// Set the second shape as the only modified one from the first one.
			/// </summary>
			void ReplaceModified(RDC::OCC::TopoDS_Shape^ theInitial, RDC::OCC::TopoDS_Shape^ theModified);
			/// <summary>
			/// Clears the history.
			/// </summary>
			void Clear();
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Generated(RDC::OCC::TopoDS_Shape^ theInitial);
			/// <summary>
			/// Returns all shapes modified from the shape.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Modified(RDC::OCC::TopoDS_Shape^ theInitial);
			/// <summary>
			/// Returns 'true' if the shape is removed.
			/// </summary>
			bool IsRemoved(RDC::OCC::TopoDS_Shape^ theInitial);
			/// <summary>
			...
			/// </summary>
			void Merge(RDC::OCC::BRepTools_History^ theHistory23);
			/// <summary>
			/// Prints the brief description of the history into a stream
			/// </summary>
			void Dump(System::IO::TextWriter^ theS);
			static RDC::OCC::BRepTools_History^ CreateDowncasted(::BRepTools_History* instance);
		}; // class BRepTools_History
		...
		public ref class BRepTools_Modifier sealed
			: public RDC::OCC::BaseClass<::BRepTools_Modifier>
		{
		...
		public:
			BRepTools_Modifier(::BRepTools_Modifier* nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_Modifier>(nativeInstance, true)
			{}

			BRepTools_Modifier(::BRepTools_Modifier& nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_Modifier>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			BRepTools_Modifier(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Creates a modifier on  the shape <S>, and performs
			/// the modifications described by <M>.
			/// </summary>
			BRepTools_Modifier(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::BRepTools_Modification^ M);
			/// <summary>
			...
			/// </summary>
			void Perform(RDC::OCC::BRepTools_Modification^ M, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Performs the modifications described by <M>.
			/// </summary>
			void Perform(RDC::OCC::BRepTools_Modification^ M);
			/// <summary>
		...
		public ref class BRepTools_NurbsConvertModification sealed
			: public RDC::OCC::BRepTools_CopyModification
		{
		...
		public:
			BRepTools_NurbsConvertModification(::BRepTools_NurbsConvertModification* nativeInstance)
				: RDC::OCC::BRepTools_CopyModification(nativeInstance)
			{}
		...
		public:
			...
			/* Method skipped due to unknown mapping: bool NewPolygon(TopoDS_Edge theEdge, Poly_Polygon3D thePoly, ) */
			/* Method skipped due to unknown mapping: bool NewPolygonOnTriangulation(TopoDS_Edge theEdge, TopoDS_Face theFace, Poly_PolygonOnTriangulation thePoly, ) */
			RDC::OCC::TopTools_ListOfShape^ GetUpdatedEdges();
			static RDC::OCC::BRepTools_NurbsConvertModification^ CreateDowncasted(::BRepTools_NurbsConvertModification* instance);
		}; // class BRepTools_NurbsConvertModification
		...
		public:
			...
			/// </summary>
			void Remove(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			/// Sets a request to Replace a Shape by a new one.
			/// </summary>
			void Replace(RDC::OCC::TopoDS_Shape^ shape, RDC::OCC::TopoDS_Shape^ newshape);
			/// <summary>
			/// Tells if a shape is recorded for Replace/Remove
			/// </summary>
			bool IsRecorded(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Shape^ Value(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Shape^ Apply(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::TopAbs_ShapeEnum theUntil);
			/// <summary>
			/// Applies the substitutions requests to a shape.
			/// 
			/// theUntil gives the level of type until which requests are taken into account.
			...
			/// If incompatible shape type is encountered, it is ignored and flag FAIL1 is set in Status.
			/// </summary>
			RDC::OCC::TopoDS_Shape^ Apply(RDC::OCC::TopoDS_Shape^ theShape);
			RDC::OCC::TopoDS_Vertex^ CopyVertex(RDC::OCC::TopoDS_Vertex^ theV, double theTol);
			RDC::OCC::TopoDS_Vertex^ CopyVertex(RDC::OCC::TopoDS_Vertex^ theV);
			RDC::OCC::TopoDS_Vertex^ CopyVertex(RDC::OCC::TopoDS_Vertex^ theV, RDC::OCC::Pnt theNewPos, double aTol);
			bool IsNewShape(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// Returns the history of the substituted shapes.
			/// </summary>
			RDC::OCC::BRepTools_History^ History();
			static RDC::OCC::BRepTools_ReShape^ CreateDowncasted(::BRepTools_ReShape* instance);
		}; // class BRepTools_ReShape
		...
		public ref class BRepTools_PurgeLocations sealed
			: public RDC::OCC::BaseClass<::BRepTools_PurgeLocations>
		{
		...
		public:
			BRepTools_PurgeLocations(::BRepTools_PurgeLocations* nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_PurgeLocations>(nativeInstance, true)
			{}

			BRepTools_PurgeLocations(::BRepTools_PurgeLocations& nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_PurgeLocations>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			bool Perform(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
		...
		public ref class BRepTools_Quilt sealed
			: public RDC::OCC::BaseClass<::BRepTools_Quilt>
		{
		...
		public:
			BRepTools_Quilt(::BRepTools_Quilt* nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_Quilt>(nativeInstance, true)
			{}

			BRepTools_Quilt(::BRepTools_Quilt& nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_Quilt>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			void Bind(RDC::OCC::TopoDS_Edge^ Eold, RDC::OCC::TopoDS_Edge^ Enew);
			/// <summary>
		...
		public ref class BRepTools_ShapeSet sealed
			: public RDC::OCC::TopTools_ShapeSet
		{
		...
		public:
			BRepTools_ShapeSet(::BRepTools_ShapeSet* nativeInstance)
				: RDC::OCC::TopTools_ShapeSet(nativeInstance)
			{}
		...
		public:
			...
			/// flag to write triangulation data
			/// </param>
			BRepTools_ShapeSet(RDC::OCC::BRep_Builder^ theBuilder, bool theWithTriangles, bool theWithNormals);
			/// <summary>
			/// Builds an empty ShapeSet.
			/// </summary>
			/// <param name="theWithTriangles">
			/// flag to write triangulation data
			/// </param>
			BRepTools_ShapeSet(RDC::OCC::BRep_Builder^ theBuilder, bool theWithTriangles);
			/// <summary>
			/// Builds an empty ShapeSet.
			/// </summary>
			/// <param name="theWithTriangles">
			/// flag to write triangulation data
			/// </param>
			BRepTools_ShapeSet(RDC::OCC::BRep_Builder^ theBuilder);
			/// <summary>
			...
			/// </summary>
			void WritePolygon3D(System::IO::TextWriter^ OS, bool Compact, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Writes the 3d polygons
			/// on the stream <OS> in a format that can
			/// be read back by Read.
			...
			/// be read back by Read.
			/// </summary>
			void WriteTriangulation(System::IO::TextWriter^ OS, bool Compact, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Writes the triangulation
			/// on the stream <OS> in a format that can
			/// be read back by Read.
			...
			/// be read back by Read.
			/// </summary>
			void WritePolygonOnTriangulation(System::IO::TextWriter^ OS, bool Compact, RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Writes the polygons on triangulation
			/// on the stream <OS> in a format that can
			/// be read back by Read.
		...
		public ref class BRepTools_Substitution sealed
			: public RDC::OCC::BaseClass<::BRepTools_Substitution>
		{
		...
		public:
			BRepTools_Substitution(::BRepTools_Substitution* nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_Substitution>(nativeInstance, true)
			{}

			BRepTools_Substitution(::BRepTools_Substitution& nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_Substitution>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			void Substitute(RDC::OCC::TopoDS_Shape^ OldShape, RDC::OCC::TopTools_ListOfShape^ NewShapes);
			/// <summary>
			...
			/// the resul of <Build>
			/// </summary>
			void Build(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Copy(RDC::OCC::TopoDS_Shape^ S);
		}; // class BRepTools_Substitution
		...
		public:
			...
			BRepTools_TrsfModification(RDC::OCC::Trsf T);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::GeomAbs_Shape Continuity(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F1, RDC::OCC::TopoDS_Face^ F2, RDC::OCC::TopoDS_Edge^ NewE, RDC::OCC::TopoDS_Face^ NewF1, RDC::OCC::TopoDS_Face^ NewF2);
			static RDC::OCC::BRepTools_TrsfModification^ CreateDowncasted(::BRepTools_TrsfModification* instance);
		}; // class BRepTools_TrsfModification
		...
		public ref class BRepTools_WireExplorer sealed
			: public RDC::OCC::BaseClass<::BRepTools_WireExplorer>
		{
		...
		public:
			BRepTools_WireExplorer(::BRepTools_WireExplorer* nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_WireExplorer>(nativeInstance, true)
			{}

			BRepTools_WireExplorer(::BRepTools_WireExplorer& nativeInstance)
				: RDC::OCC::BaseClass<::BRepTools_WireExplorer>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			BRepTools_WireExplorer(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			...
			/// </summary>
			BRepTools_WireExplorer(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Initializes an exploration of the wire <W>.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Initializes an exploration of the wire <W>.
			/// F is used to select the edge connected to the
			/// previous in the parametric representation of <F>.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Initializes an exploration of the wire <W>.
			/// F is used to select the edge connected to the
			/// previous in the parametric representation of <F>.
			...
			/// </summary>
			void Init(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Face^ F, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			...
			/// the previous one.
			/// </summary>
			RDC::OCC::TopoDS_Vertex^ CurrentVertex();
			/// <summary>
