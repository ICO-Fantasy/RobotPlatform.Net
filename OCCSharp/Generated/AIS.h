...
public ref class AIS_DataMapOfIOStatus sealed
    : public RDC::OCC::BaseClass<::AIS_DataMapOfIOStatus>
{
...
public:
    AIS_DataMapOfIOStatus(::AIS_DataMapOfIOStatus* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_DataMapOfIOStatus>( nativeInstance, true )
    {}

    AIS_DataMapOfIOStatus(::AIS_DataMapOfIOStatus& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_DataMapOfIOStatus>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_DataMapOfIOStatus::Iterator>
    {
    ...
    public:
        Iterator(::AIS_DataMapOfIOStatus::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_DataMapOfIOStatus::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_DataMapOfIOStatus::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_DataMapOfIOStatus::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::AIS_GlobalStatus^ Value();
        RDC::OCC::AIS_GlobalStatus^ ChangeValue();
        RDC::OCC::AIS_InteractiveObject^ Key();
    }; // class Iterator

    AIS_DataMapOfIOStatus();
    AIS_DataMapOfIOStatus(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    AIS_DataMapOfIOStatus(int theNbBuckets);
    void Exchange(RDC::OCC::AIS_DataMapOfIOStatus^ theOther);
    RDC::OCC::AIS_DataMapOfIOStatus^ Assign(RDC::OCC::AIS_DataMapOfIOStatus^ theOther);
    void ReSize(int N);
    bool Bind(RDC::OCC::AIS_InteractiveObject^ theKey, RDC::OCC::AIS_GlobalStatus^ theItem);
    RDC::OCC::AIS_GlobalStatus^ Bound(RDC::OCC::AIS_InteractiveObject^ theKey, RDC::OCC::AIS_GlobalStatus^ theItem);
    bool IsBound(RDC::OCC::AIS_InteractiveObject^ theKey);
    bool UnBind(RDC::OCC::AIS_InteractiveObject^ theKey);
    RDC::OCC::AIS_GlobalStatus^ Seek(RDC::OCC::AIS_InteractiveObject^ theKey);
    RDC::OCC::AIS_GlobalStatus^ Find(RDC::OCC::AIS_InteractiveObject^ theKey);
    RDC::OCC::AIS_GlobalStatus^ ChangeSeek(RDC::OCC::AIS_InteractiveObject^ theKey);
    RDC::OCC::AIS_GlobalStatus^ ChangeFind(RDC::OCC::AIS_InteractiveObject^ theKey);
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_ListOfInteractive::Iterator>
    {
    ...
    public:
        Iterator(::AIS_ListOfInteractive::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_ListOfInteractive::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_ListOfInteractive::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_ListOfInteractive::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::AIS_InteractiveObject^ Value();
        RDC::OCC::AIS_InteractiveObject^ ChangeValue();
    }; // class Iterator

    AIS_ListOfInteractive();
    AIS_ListOfInteractive(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    RDC::OCC::AIS_ListOfInteractive^ Assign(RDC::OCC::AIS_ListOfInteractive^ theOther);
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::AIS_InteractiveObject^ First();
    RDC::OCC::AIS_InteractiveObject^ Last();
    RDC::OCC::AIS_InteractiveObject^ Append(RDC::OCC::AIS_InteractiveObject^ theItem);
    RDC::OCC::AIS_InteractiveObject^ Prepend(RDC::OCC::AIS_InteractiveObject^ theItem);
    void RemoveFirst();
    void Remove(RDC::OCC::AIS_ListOfInteractive::Iterator^ theIter);
    RDC::OCC::AIS_InteractiveObject^ InsertBefore(RDC::OCC::AIS_InteractiveObject^ theItem, RDC::OCC::AIS_ListOfInteractive::Iterator^ theIter);
    RDC::OCC::AIS_InteractiveObject^ InsertAfter(RDC::OCC::AIS_InteractiveObject^ theItem, RDC::OCC::AIS_ListOfInteractive::Iterator^ theIter);
    void Reverse();
}; // class AIS_ListOfInteractive
...
public ref class AIS_ListIteratorOfListOfInteractive sealed
    : public RDC::OCC::BaseClass<::AIS_ListIteratorOfListOfInteractive>
{
...
public:
    AIS_ListIteratorOfListOfInteractive(::AIS_ListIteratorOfListOfInteractive* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_ListIteratorOfListOfInteractive>( nativeInstance, true )
    {}

    AIS_ListIteratorOfListOfInteractive(::AIS_ListIteratorOfListOfInteractive& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_ListIteratorOfListOfInteractive>( &nativeInstance, false )
    {}
...
public:
    ...
    AIS_ListIteratorOfListOfInteractive(RDC::OCC::NCollection_BaseList^ theList);
    bool More();
    void Next();
    RDC::OCC::AIS_InteractiveObject^ Value();
    RDC::OCC::AIS_InteractiveObject^ ChangeValue();
...
public ref class AIS_NArray1OfEntityOwner sealed
    : public RDC::OCC::BaseClass<::AIS_NArray1OfEntityOwner>
...
public:
    AIS_NArray1OfEntityOwner(::AIS_NArray1OfEntityOwner* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_NArray1OfEntityOwner>( nativeInstance, true )
    {}

    AIS_NArray1OfEntityOwner(::AIS_NArray1OfEntityOwner& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_NArray1OfEntityOwner>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_NArray1OfEntityOwner::Iterator>
    {
    ...
    public:
        Iterator(::AIS_NArray1OfEntityOwner::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_NArray1OfEntityOwner::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_NArray1OfEntityOwner::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_NArray1OfEntityOwner::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        void Init(RDC::OCC::AIS_NArray1OfEntityOwner^ theList);
        bool More();
        void Initialize(RDC::OCC::AIS_NArray1OfEntityOwner^ theList);
    ...
    AIS_NArray1OfEntityOwner(RDC::OCC::SelectMgr_EntityOwner^ theBegin, int theLower, int theUpper, bool theUseBuffer);
    AIS_NArray1OfEntityOwner(RDC::OCC::SelectMgr_EntityOwner^ theBegin, int theLower, int theUpper);
    void Init(RDC::OCC::SelectMgr_EntityOwner^ theValue);
    int Size();
    int Length();
    bool IsEmpty();
    int Lower();
    int Upper();
    RDC::OCC::AIS_NArray1OfEntityOwner^ Assign(RDC::OCC::AIS_NArray1OfEntityOwner^ theOther);
    RDC::OCC::AIS_NArray1OfEntityOwner^ Move(RDC::OCC::AIS_NArray1OfEntityOwner^ theOther);
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_NListOfEntityOwner::Iterator>
    {
    ...
    public:
        Iterator(::AIS_NListOfEntityOwner::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_NListOfEntityOwner::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_NListOfEntityOwner::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_NListOfEntityOwner::Iterator>( &nativeInstance, false )
        {}
    ...
    AIS_NListOfEntityOwner(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    RDC::OCC::AIS_NListOfEntityOwner^ Assign(RDC::OCC::AIS_NListOfEntityOwner^ theOther);
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::SelectMgr_EntityOwner^ First();
    RDC::OCC::SelectMgr_EntityOwner^ Last();
    RDC::OCC::SelectMgr_EntityOwner^ Append(RDC::OCC::SelectMgr_EntityOwner^ theItem);
    RDC::OCC::SelectMgr_EntityOwner^ Prepend(RDC::OCC::SelectMgr_EntityOwner^ theItem);
    void RemoveFirst();
    void Remove(RDC::OCC::AIS_NListOfEntityOwner::Iterator^ theIter);
    RDC::OCC::SelectMgr_EntityOwner^ InsertBefore(RDC::OCC::SelectMgr_EntityOwner^ theItem, RDC::OCC::AIS_NListOfEntityOwner::Iterator^ theIter);
    RDC::OCC::SelectMgr_EntityOwner^ InsertAfter(RDC::OCC::SelectMgr_EntityOwner^ theItem, RDC::OCC::AIS_NListOfEntityOwner::Iterator^ theIter);
    void Reverse();
}; // class AIS_NListOfEntityOwner
...
public ref class AIS_DataMapOfShapeDrawer sealed
    : public RDC::OCC::BaseClass<::AIS_DataMapOfShapeDrawer>
{
...
public:
    AIS_DataMapOfShapeDrawer(::AIS_DataMapOfShapeDrawer* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_DataMapOfShapeDrawer>( nativeInstance, true )
    {}

    AIS_DataMapOfShapeDrawer(::AIS_DataMapOfShapeDrawer& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_DataMapOfShapeDrawer>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_DataMapOfShapeDrawer::Iterator>
    {
    ...
    public:
        Iterator(::AIS_DataMapOfShapeDrawer::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_DataMapOfShapeDrawer::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_DataMapOfShapeDrawer::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_DataMapOfShapeDrawer::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::AIS_ColoredDrawer^ Value();
        RDC::OCC::AIS_ColoredDrawer^ ChangeValue();
        RDC::OCC::TopoDS_Shape^ Key();
    }; // class Iterator

    AIS_DataMapOfShapeDrawer();
    AIS_DataMapOfShapeDrawer(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    AIS_DataMapOfShapeDrawer(int theNbBuckets);
    void Exchange(RDC::OCC::AIS_DataMapOfShapeDrawer^ theOther);
    RDC::OCC::AIS_DataMapOfShapeDrawer^ Assign(RDC::OCC::AIS_DataMapOfShapeDrawer^ theOther);
    void ReSize(int N);
    bool Bind(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::AIS_ColoredDrawer^ theItem);
    RDC::OCC::AIS_ColoredDrawer^ Bound(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::AIS_ColoredDrawer^ theItem);
    bool IsBound(RDC::OCC::TopoDS_Shape^ theKey);
    bool UnBind(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::AIS_ColoredDrawer^ Seek(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::AIS_ColoredDrawer^ Find(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::AIS_ColoredDrawer^ ChangeSeek(RDC::OCC::TopoDS_Shape^ theKey);
    RDC::OCC::AIS_ColoredDrawer^ ChangeFind(RDC::OCC::TopoDS_Shape^ theKey);
    void Clear(bool doReleaseMemory);
    void Clear();
    int Size();
}; // class AIS_DataMapOfShapeDrawer
...
public ref class AIS_MouseGestureMap sealed
    : public RDC::OCC::BaseClass<::AIS_MouseGestureMap>
{
...
public:
    AIS_MouseGestureMap(::AIS_MouseGestureMap* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_MouseGestureMap>( nativeInstance, true )
    {}

    AIS_MouseGestureMap(::AIS_MouseGestureMap& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_MouseGestureMap>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_MouseGestureMap::Iterator>
    {
    ...
    public:
        Iterator(::AIS_MouseGestureMap::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_MouseGestureMap::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_MouseGestureMap::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_MouseGestureMap::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::AIS_MouseGesture Value();
        RDC::OCC::AIS_MouseGesture ChangeValue();
        unsigned int Key();
    }; // class Iterator

    AIS_MouseGestureMap();
    AIS_MouseGestureMap(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    AIS_MouseGestureMap(int theNbBuckets);
    void Exchange(RDC::OCC::AIS_MouseGestureMap^ theOther);
    RDC::OCC::AIS_MouseGestureMap^ Assign(RDC::OCC::AIS_MouseGestureMap^ theOther);
    void ReSize(int N);
    bool Bind(unsigned int theKey, RDC::OCC::AIS_MouseGesture theItem);
    RDC::OCC::AIS_MouseGesture Bound(unsigned int theKey, RDC::OCC::AIS_MouseGesture theItem);
    bool IsBound(unsigned int theKey);
    bool UnBind(unsigned int theKey);
    RDC::OCC::AIS_MouseGesture Seek(unsigned int theKey);
    RDC::OCC::AIS_MouseGesture Find(unsigned int theKey);
    RDC::OCC::AIS_MouseGesture ChangeSeek(unsigned int theKey);
    RDC::OCC::AIS_MouseGesture ChangeFind(unsigned int theKey);
    void Clear(bool doReleaseMemory);
    void Clear();
    int Size();
}; // class AIS_MouseGestureMap
...
public ref class AIS_MouseSelectionSchemeMap sealed
    : public RDC::OCC::BaseClass<::AIS_MouseSelectionSchemeMap>
{
...
public:
    AIS_MouseSelectionSchemeMap(::AIS_MouseSelectionSchemeMap* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_MouseSelectionSchemeMap>( nativeInstance, true )
    {}

    AIS_MouseSelectionSchemeMap(::AIS_MouseSelectionSchemeMap& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_MouseSelectionSchemeMap>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_MouseSelectionSchemeMap::Iterator>
    {
    ...
    public:
        Iterator(::AIS_MouseSelectionSchemeMap::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_MouseSelectionSchemeMap::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_MouseSelectionSchemeMap::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_MouseSelectionSchemeMap::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::AIS_SelectionScheme Value();
        RDC::OCC::AIS_SelectionScheme ChangeValue();
        unsigned int Key();
    }; // class Iterator

    AIS_MouseSelectionSchemeMap();
    AIS_MouseSelectionSchemeMap(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    AIS_MouseSelectionSchemeMap(int theNbBuckets);
    void Exchange(RDC::OCC::AIS_MouseSelectionSchemeMap^ theOther);
    RDC::OCC::AIS_MouseSelectionSchemeMap^ Assign(RDC::OCC::AIS_MouseSelectionSchemeMap^ theOther);
    void ReSize(int N);
    bool Bind(unsigned int theKey, RDC::OCC::AIS_SelectionScheme theItem);
    RDC::OCC::AIS_SelectionScheme Bound(unsigned int theKey, RDC::OCC::AIS_SelectionScheme theItem);
    bool IsBound(unsigned int theKey);
    bool UnBind(unsigned int theKey);
    RDC::OCC::AIS_SelectionScheme Seek(unsigned int theKey);
    RDC::OCC::AIS_SelectionScheme Find(unsigned int theKey);
    RDC::OCC::AIS_SelectionScheme ChangeSeek(unsigned int theKey);
    RDC::OCC::AIS_SelectionScheme ChangeFind(unsigned int theKey);
    void Clear(bool doReleaseMemory);
    void Clear();
    int Size();
}; // class AIS_MouseSelectionSchemeMap
...
public ref class AIS_AnimationProgress sealed
    : public RDC::OCC::BaseClass<::AIS_AnimationProgress>
{
...
public:
    AIS_AnimationProgress(::AIS_AnimationProgress* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_AnimationProgress>( nativeInstance, true )
    {}

    AIS_AnimationProgress(::AIS_AnimationProgress& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_AnimationProgress>( &nativeInstance, false )
    {}
...
public ref class AIS_WalkPart sealed
    : public RDC::OCC::BaseClass<::AIS_WalkPart>
{
...
public:
    AIS_WalkPart(::AIS_WalkPart* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_WalkPart>( nativeInstance, true )
    {}

    AIS_WalkPart(::AIS_WalkPart& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_WalkPart>( &nativeInstance, false )
    {}
...
public ref class AIS_WalkDelta sealed
    : public RDC::OCC::BaseClass<::AIS_WalkDelta>
{
...
public:
    AIS_WalkDelta(::AIS_WalkDelta* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_WalkDelta>( nativeInstance, true )
    {}

    AIS_WalkDelta(::AIS_WalkDelta& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_WalkDelta>( &nativeInstance, false )
    {}
...
public:
    AIS(::AIS* nativeInstance)
        : RDC::OCC::BaseClass<::AIS>( nativeInstance, true )
    {}

    AIS(::AIS& nativeInstance)
        : RDC::OCC::BaseClass<::AIS>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    AIS_InteractiveContext(RDC::OCC::V3d_Viewer^ MainViewer);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::PrsMgr_DisplayStatus DisplayStatus(RDC::OCC::AIS_InteractiveObject^ anIobj);
    /// <summary>
    /// Returns the status of the Interactive Context for the view of the Interactive Object.
    /// </summary>
    void Status(RDC::OCC::AIS_InteractiveObject^ anObj, RDC::OCC::TCollection_ExtendedString^ astatus);
    /// <summary>
    /// Returns true if Object is displayed in the interactive context.
    /// </summary>
    bool IsDisplayed(RDC::OCC::AIS_InteractiveObject^ anIobj);
    bool IsDisplayed(RDC::OCC::AIS_InteractiveObject^ aniobj, int aMode);
    /// <summary>
    ...
    /// </summary>
    void Display(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void Display(RDC::OCC::AIS_InteractiveObject^ theIObj, int theDispMode, int theSelectionMode, bool theToUpdateViewer, RDC::OCC::PrsMgr_DisplayStatus theDispStatus);
    /// <summary>
    /// Sets status, display mode and selection mode for specified Object
    /// If theSelectionMode equals -1, theIObj will not be activated: it will be displayed but will not be selectable.
    /// </summary>
    void Display(RDC::OCC::AIS_InteractiveObject^ theIObj, int theDispMode, int theSelectionMode, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void Load(RDC::OCC::AIS_InteractiveObject^ theObj, int theSelectionMode);
    /// <summary>
    /// Allows you to load the Interactive Object with a given selection mode,
    /// and/or with the desired decomposition option, whether the object is visualized or not.
    /// The loaded objects will be selectable but displayable in highlighting only when detected by the Selector.
    /// </summary>
    void Load(RDC::OCC::AIS_InteractiveObject^ theObj);
    /// <summary>
    ...
    /// </summary>
    void Erase(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void ClearPrs(RDC::OCC::AIS_InteractiveObject^ theIObj, int theMode, bool theToUpdateViewer);
    /// <summary>
    /// Removes Object from every viewer.
    /// </summary>
    void Remove(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void Redisplay(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer, bool theAllModes);
    /// <summary>
    /// Recomputes the seen parts presentation of the Object.
    /// If theAllModes equals true, all presentations are present in the object even if unseen.
    /// </summary>
    void Redisplay(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void Redisplay(RDC::OCC::AIS_KindOfInteractive theTypeOfObject, int theSignature, bool theToUpdateViewer);
    /// <summary>
    /// Recomputes the displayed presentations, flags the others.
    /// Doesn't update presentations.
    /// </summary>
    void RecomputePrsOnly(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer, bool theAllModes);
    /// <summary>
    /// Recomputes the displayed presentations, flags the others.
    /// Doesn't update presentations.
    /// </summary>
    void RecomputePrsOnly(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Recomputes the active selections, flags the others.
    /// Doesn't update presentations.
    /// </summary>
    void RecomputeSelectionOnly(RDC::OCC::AIS_InteractiveObject^ anIObj);
    /// <summary>
    ...
    /// </summary>
    void Update(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theUpdateViewer);
    /// <summary>
    ...
    RDC::OCC::Prs3d_Drawer^ HighlightStyle(RDC::OCC::Prs3d_TypeOfHighlight theStyleType);
    /// <summary>
    ...
    /// </summary>
    void SetHighlightStyle(RDC::OCC::Prs3d_TypeOfHighlight theStyleType, RDC::OCC::Prs3d_Drawer^ theStyle);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Prs3d_Drawer^ HighlightStyle();
    /// <summary>
    ...
    /// </summary>
    void SetHighlightStyle(RDC::OCC::Prs3d_Drawer^ theStyle);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Prs3d_Drawer^ SelectionStyle();
    /// <summary>
    ...
    /// </summary>
    void SetSelectionStyle(RDC::OCC::Prs3d_Drawer^ theStyle);
    /// <summary>
    ...
    /// </param>
    bool HighlightStyle(RDC::OCC::AIS_InteractiveObject^ theObj, RDC::OCC::Prs3d_Drawer^ theStyle);
    /// <summary>
    ...
    /// </param>
    bool HighlightStyle(RDC::OCC::SelectMgr_EntityOwner^ theOwner, RDC::OCC::Prs3d_Drawer^ theStyle);
    /// <summary>
    ...
    /// [in] the object to check
    /// </param>
    bool IsHilighted(RDC::OCC::AIS_InteractiveObject^ theObj);
    /// <summary>
    ...
    /// [in] the owner to check
    /// </param>
    bool IsHilighted(RDC::OCC::SelectMgr_EntityOwner^ theOwner);
    /// <summary>
    /// Changes the color of all the lines of the object in view.
    /// </summary>
    void HilightWithColor(RDC::OCC::AIS_InteractiveObject^ theObj, RDC::OCC::Prs3d_Drawer^ theStyle, bool theToUpdateViewer);
    /// <summary>
    /// Removes hilighting from the Object.
    /// </summary>
    void Unhilight(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Returns the display priority of the Object.
    /// </summary>
    RDC::OCC::Graphic3d_DisplayPriority DisplayPriority(RDC::OCC::AIS_InteractiveObject^ theIObj);
    /// <summary>
    /// Sets the display priority of the seen parts presentation of the Object.
    /// </summary>
    void SetDisplayPriority(RDC::OCC::AIS_InteractiveObject^ theIObj, RDC::OCC::Graphic3d_DisplayPriority thePriority);
    void SetDisplayPriority(RDC::OCC::AIS_InteractiveObject^ theIObj, int thePriority);
    /// <summary>
    /// Get Z layer id set for displayed interactive object.
    /// </summary>
    int GetZLayer(RDC::OCC::AIS_InteractiveObject^ theIObj);
    /// <summary>
    ...
    /// </summary>
    void SetZLayer(RDC::OCC::AIS_InteractiveObject^ theIObj, int theLayerId);
    /// <summary>
    /// Setup object visibility in specified view.
    /// Has no effect if object is not displayed in this context.
    /// </summary>
    void SetViewAffinity(RDC::OCC::AIS_InteractiveObject^ theIObj, RDC::OCC::V3d_View^ theView, bool theIsVisible);
    /// <summary>
    ...
    /// </summary>
    void SetDisplayMode(RDC::OCC::AIS_InteractiveObject^ theIObj, int theMode, bool theToUpdateViewer);
    /// <summary>
    /// Unsets the display mode of seen Interactive Objects.
    /// </summary>
    void UnsetDisplayMode(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Puts the location on the initial graphic representation and the selection for the Object.
    /// </summary>
    void SetLocation(RDC::OCC::AIS_InteractiveObject^ theObject, RDC::OCC::TopLoc_Location^ theLocation);
    /// <summary>
    /// Puts the Object back into its initial position.
    /// </summary>
    void ResetLocation(RDC::OCC::AIS_InteractiveObject^ theObject);
    /// <summary>
    /// Returns true if the Object has a location.
    /// </summary>
    bool HasLocation(RDC::OCC::AIS_InteractiveObject^ theObject);
    /// <summary>
    /// Returns the location of the Object.
    /// </summary>
    RDC::OCC::TopLoc_Location^ Location(RDC::OCC::AIS_InteractiveObject^ theObject);
    /// <summary>
    /// Sets transform persistence.
    /// </summary>
    void SetTransformPersistence(RDC::OCC::AIS_InteractiveObject^ theObject, RDC::OCC::Graphic3d_TransformPers^ theTrsfPers);
    /// <summary>
    ...
    /// </summary>
    void SetSelectionSensitivity(RDC::OCC::AIS_InteractiveObject^ theObject, int theMode, int theNewSensitivity);
    /// <summary>
    /// Returns last active View (argument of MoveTo()/Select() methods).
    /// </summary>
    RDC::OCC::V3d_View^ LastActiveView();
    /// <summary>
    ...
    RDC::OCC::AIS_StatusOfDetection MoveTo(int theXPix, int theYPix, RDC::OCC::V3d_View^ theView, bool theToRedrawOnUpdate);
    /// <summary>
    ...
    /// </summary>
    /// @sa PickingStrategy()
    RDC::OCC::AIS_StatusOfDetection MoveTo(RDC::OCC::Ax1 theAxis, RDC::OCC::V3d_View^ theView, bool theToRedrawOnUpdate);
    /// <summary>
    ...
    RDC::OCC::SelectMgr_EntityOwner^ DetectedOwner();
    /// <summary>
    ...
    /// </summary>
    /// @sa DetectedOwner()
    RDC::OCC::AIS_InteractiveObject^ DetectedInteractive();
    /// <summary>
    ...
    /// </summary>
    /// @sa DetectedOwner()
    RDC::OCC::TopoDS_Shape^ DetectedShape();
    /// <summary>
    ...
    int HilightNextDetected(RDC::OCC::V3d_View^ theView, bool theToRedrawImmediate);
    /// <summary>
    /// If more than 1 object is detected by the selector, only the "best" owner is hilighted at the mouse position.
    /// This Method allows the user to hilight one after another the other detected entities.
    /// If The method select is called, the selected entity will be the hilighted one!
    ...
    /// </returns>
    /// @sa HasNextDetected(), HilightPreviousDetected().
    int HilightNextDetected(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Same as previous methods in reverse direction.
    /// </summary>
    /// @sa HasNextDetected(), HilightNextDetected().
    int HilightPreviousDetected(RDC::OCC::V3d_View^ theView, bool theToRedrawImmediate);
    /// <summary>
    /// Same as previous methods in reverse direction.
    /// </summary>
    /// @sa HasNextDetected(), HilightNextDetected().
    int HilightPreviousDetected(RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    RDC::OCC::SelectMgr_EntityOwner^ DetectedCurrentOwner();
    /// <summary>
    /// Adds object in the selection.
    /// </summary>
    RDC::OCC::AIS_StatusOfPick AddSelect(RDC::OCC::SelectMgr_EntityOwner^ theObject);
    /// <summary>
    /// Adds object in the selection.
    /// </summary>
    RDC::OCC::AIS_StatusOfPick AddSelect(RDC::OCC::AIS_InteractiveObject^ theObject);
    /// <summary>
    ...
    RDC::OCC::AIS_StatusOfPick SelectRectangle(RDC::OCC::Graphic3d_Vec2i^ thePntMin, RDC::OCC::Graphic3d_Vec2i^ thePntMax, RDC::OCC::V3d_View^ theView, RDC::OCC::AIS_SelectionScheme theSelScheme);
    /// <summary>
    /// Selects objects within the bounding rectangle.
    /// Viewer should be explicitly redrawn after selection.
    /// </summary>
    ...
    /// </returns>
    /// @sa StdSelect_ViewerSelector3d::AllowOverlapDetection()
    RDC::OCC::AIS_StatusOfPick SelectRectangle(RDC::OCC::Graphic3d_Vec2i^ thePntMin, RDC::OCC::Graphic3d_Vec2i^ thePntMax, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// picking status
    /// </returns>
    RDC::OCC::AIS_StatusOfPick SelectPolygon(RDC::OCC::TColgp_Array1OfPnt2d^ thePolyline, RDC::OCC::V3d_View^ theView, RDC::OCC::AIS_SelectionScheme theSelScheme);
    /// <summary>
    /// Select everything found in the polygon defined by bounding polyline.
    /// Viewer should be explicitly redrawn after selection.
    /// </summary>
    ...
    /// picking status
    /// </returns>
    RDC::OCC::AIS_StatusOfPick SelectPolygon(RDC::OCC::TColgp_Array1OfPnt2d^ thePolyline, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// picking status
    /// </returns>
    RDC::OCC::AIS_StatusOfPick SelectPoint(RDC::OCC::Graphic3d_Vec2i^ thePnt, RDC::OCC::V3d_View^ theView, RDC::OCC::AIS_SelectionScheme theSelScheme);
    /// <summary>
    /// Selects the topmost object picked by the point in the view,
    /// Viewer should be explicitly redrawn after selection.
    /// </summary>
    ...
    /// picking status
    /// </returns>
    RDC::OCC::AIS_StatusOfPick SelectPoint(RDC::OCC::Graphic3d_Vec2i^ thePnt, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    RDC::OCC::AIS_StatusOfPick SelectDetected(RDC::OCC::AIS_SelectionScheme theSelScheme);
    /// <summary>
    /// Select and hilights the previous detected via AIS_InteractiveContext::MoveTo() method;
    /// unhilights the previous picked.
    /// Viewer should be explicitly redrawn after selection.
    ...
    /// @sa HighlightStyle() defining default highlight styles of selected owners (Prs3d_TypeOfHighlight_Selected and Prs3d_TypeOfHighlight_LocalSelected)
    /// @sa PrsMgr_PresentableObject::HilightAttributes() defining per-object highlight style of selected owners (overrides defaults)
    RDC::OCC::AIS_StatusOfPick SelectDetected();
    /// <summary>
    /// Returns bounding box of selected objects.
    /// </summary>
    RDC::OCC::Bnd_Box^ BoundingBoxOfSelection(RDC::OCC::V3d_View^ theView);
    RDC::OCC::Bnd_Box^ BoundingBoxOfSelection();
    /// <summary>
    ...
    /// picking status
    /// </returns>
    RDC::OCC::AIS_StatusOfPick Select(RDC::OCC::AIS_NArray1OfEntityOwner^ theOwners, RDC::OCC::AIS_SelectionScheme theSelScheme);
    /// <summary>
    ...
    /// </summary>
    void FitSelected(RDC::OCC::V3d_View^ theView, double theMargin, bool theToUpdate);
    /// <summary>
    /// Fits the view correspondingly to the bounds of selected objects.
    /// Infinite objects are ignored if infinite state of AIS_InteractiveObject is set to true.
    /// </summary>
    void FitSelected(RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// </summary>
    void SetSelected(RDC::OCC::SelectMgr_EntityOwner^ theOwners, bool theToUpdateViewer);
    /// <summary>
    /// Puts the interactive object aniObj in the list of selected objects.
    /// Performs selection filters check.
    /// </summary>
    void SetSelected(RDC::OCC::AIS_InteractiveObject^ theObject, bool theToUpdateViewer);
    /// <summary>
    /// Allows to highlight or unhighlight the owner given depending on its selection status
    /// </summary>
    void AddOrRemoveSelected(RDC::OCC::AIS_InteractiveObject^ theObject, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </returns>
    bool SetSelectedState(RDC::OCC::SelectMgr_EntityOwner^ theOwner, bool theIsSelected);
    /// <summary>
    ...
    /// Allows to highlight or unhighlight the owner given depending on its selection status
    /// </summary>
    void AddOrRemoveSelected(RDC::OCC::SelectMgr_EntityOwner^ theOwner, bool theToUpdateViewer);
    /// <summary>
    /// Returns true is the owner given is selected
    /// </summary>
    bool IsSelected(RDC::OCC::SelectMgr_EntityOwner^ theOwner);
    /// <summary>
    /// Returns true is the object given is selected
    /// </summary>
    bool IsSelected(RDC::OCC::AIS_InteractiveObject^ theObj);
    /// <summary>
    /// Returns the first selected object in the list of current selected.
    /// </summary>
    RDC::OCC::AIS_InteractiveObject^ FirstSelectedObject();
    /// <summary>
    ...
    RDC::OCC::SelectMgr_EntityOwner^ SelectedOwner();
    /// <summary>
    /// Return Handle(AIS_InteractiveObject)::DownCast (SelectedOwner()->Selectable()).
    /// </summary>
    /// @sa SelectedOwner().
    RDC::OCC::AIS_InteractiveObject^ SelectedInteractive();
    /// <summary>
    ...
    RDC::OCC::TopoDS_Shape^ SelectedShape();
    /// <summary>
    ...
    /// </summary>
    /// @sa SelectedOwner().
    RDC::OCC::Standard_Transient^ Applicative();
    /// <summary>
    ...
    /// </summary>
    bool ImmediateAdd(RDC::OCC::AIS_InteractiveObject^ theObj, int theMode);
    /// <summary>
    /// returns True if <anIObj> has been stored in the list.
    /// </summary>
    bool ImmediateAdd(RDC::OCC::AIS_InteractiveObject^ theObj);
    /// <summary>
    /// returns True if the immediate display has been done.
    /// </summary>
    bool EndImmediateDraw(RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// </param>
    void SetSelectionModeActive(RDC::OCC::AIS_InteractiveObject^ theObj, int theMode, bool theToActivate, RDC::OCC::AIS_SelectionModesConcurrency theConcurrency, bool theIsForce);
    /// <summary>
    /// Activates or deactivates the selection mode for specified object.
    /// Has no effect if selection mode was already active/deactivated.
    /// </summary>
    ...
    ///     when set to TRUE, the display status will be ignored while activating selection mode
    /// </param>
    void SetSelectionModeActive(RDC::OCC::AIS_InteractiveObject^ theObj, int theMode, bool theToActivate, RDC::OCC::AIS_SelectionModesConcurrency theConcurrency);
    /// <summary>
    /// Activates or deactivates the selection mode for specified object.
    /// Has no effect if selection mode was already active/deactivated.
    /// </summary>
    ...
    ///     when set to TRUE, the display status will be ignored while activating selection mode
    /// </param>
    void SetSelectionModeActive(RDC::OCC::AIS_InteractiveObject^ theObj, int theMode, bool theToActivate);
    /// <summary>
    /// Activates the selection mode aMode whose index is given, for the given interactive entity anIobj.
    /// </summary>
    void Activate(RDC::OCC::AIS_InteractiveObject^ theObj, int theMode, bool theIsForce);
    /// <summary>
    /// Activates the selection mode aMode whose index is given, for the given interactive entity anIobj.
    /// </summary>
    void Activate(RDC::OCC::AIS_InteractiveObject^ theObj, int theMode);
    /// <summary>
    /// Activates the selection mode aMode whose index is given, for the given interactive entity anIobj.
    /// </summary>
    void Activate(RDC::OCC::AIS_InteractiveObject^ theObj);
    /// <summary>
    ...
    /// </summary>
    void Deactivate(RDC::OCC::AIS_InteractiveObject^ theObj);
    /// <summary>
    /// Deactivates all the activated selection modes of the interactive object anIobj with a given selection mode aMode.
    /// </summary>
    void Deactivate(RDC::OCC::AIS_InteractiveObject^ theObj, int theMode);
    /// <summary>
    ...
    /// </summary>
    void ActivatedModes(RDC::OCC::AIS_InteractiveObject^ anIobj, RDC::OCC::TColStd_ListOfInteger^ theList);
    ...
    /// </summary>
    RDC::OCC::SelectMgr_ListOfFilter^ Filters();
    /// <summary>
    /// </summary>
    /// <returns>
    /// the context selection global context filter.
    /// </returns>
    RDC::OCC::SelectMgr_AndOrFilter^ GlobalFilter();
    /// <summary>
    /// Allows you to add the filter.
    /// </summary>
    void AddFilter(RDC::OCC::SelectMgr_Filter^ theFilter);
    /// <summary>
    /// Removes a filter from context.
    /// </summary>
    void RemoveFilter(RDC::OCC::SelectMgr_Filter^ theFilter);
    /// <summary>
    ...
    /// </summary>
    /// @sa MoveTo(), Filters()
    RDC::OCC::SelectMgr_PickingStrategy PickingStrategy();
    /// <summary>
    ...
    /// </summary>
    void SetPickingStrategy(RDC::OCC::SelectMgr_PickingStrategy theStrategy);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Prs3d_Drawer^ DefaultDrawer();
    /// <summary>
    ...
    /// </summary>
    void SetDefaultDrawer(RDC::OCC::Prs3d_Drawer^ theDrawer);
    /// <summary>
    /// Returns the current viewer.
    /// </summary>
    RDC::OCC::V3d_Viewer^ CurrentViewer();
    RDC::OCC::SelectMgr_SelectionManager^ SelectionManager();
    RDC::OCC::PrsMgr_PresentationManager^ MainPrsMgr();
    RDC::OCC::SelectMgr_ViewerSelector^ MainSelector();
    /// <summary>
    ...
    /// </summary>
    void DisplayedObjects(RDC::OCC::AIS_ListOfInteractive^ aListOfIO);
    /// <summary>
    ...
    /// </summary>
    void DisplayedObjects(RDC::OCC::AIS_KindOfInteractive theWhichKind, int theWhichSignature, RDC::OCC::AIS_ListOfInteractive^ theListOfIO);
    /// <summary>
    /// Returns the list theListOfIO of erased objects (hidden objects) particular Type WhichKind and Signature WhichSignature.
    /// By Default, WhichSignature equals 1. This means that there is a check on type only.
    /// </summary>
    void ErasedObjects(RDC::OCC::AIS_ListOfInteractive^ theListOfIO);
    /// <summary>
    ...
    /// </summary>
    void ErasedObjects(RDC::OCC::AIS_KindOfInteractive theWhichKind, int theWhichSignature, RDC::OCC::AIS_ListOfInteractive^ theListOfIO);
    /// <summary>
    ...
    /// By Default, WhichSignature equals 1. This means that there is a check on type only.
    /// </summary>
    void ObjectsByDisplayStatus(RDC::OCC::PrsMgr_DisplayStatus theStatus, RDC::OCC::AIS_ListOfInteractive^ theListOfIO);
    /// <summary>
    /// gives the list of objects with indicated display status
    /// Type and signature by Default, <WhichSignature> = -1 means control only on <WhichKind>.
    /// </summary>
    void ObjectsByDisplayStatus(RDC::OCC::AIS_KindOfInteractive WhichKind, int WhichSignature, RDC::OCC::PrsMgr_DisplayStatus theStatus, RDC::OCC::AIS_ListOfInteractive^ theListOfIO);
    /// <summary>
    ...
    /// </summary>
    void ObjectsInside(RDC::OCC::AIS_ListOfInteractive^ aListOfIO, RDC::OCC::AIS_KindOfInteractive WhichKind, int WhichSignature);
    /// <summary>
    /// fills <aListOfIO> with objects of a particular Type and Signature with no consideration of display status.
    /// by Default, <WhichSignature> = -1 means control only on <WhichKind>.
    /// if <WhichKind> = AIS_KindOfInteractive_None and <WhichSignature> = -1, all the objects are put into the list.
    /// </summary>
    void ObjectsInside(RDC::OCC::AIS_ListOfInteractive^ aListOfIO, RDC::OCC::AIS_KindOfInteractive WhichKind);
    /// <summary>
    /// fills <aListOfIO> with objects of a particular Type and Signature with no consideration of display status.
    /// by Default, <WhichSignature> = -1 means control only on <WhichKind>.
    /// if <WhichKind> = AIS_KindOfInteractive_None and <WhichSignature> = -1, all the objects are put into the list.
    /// </summary>
    void ObjectsInside(RDC::OCC::AIS_ListOfInteractive^ aListOfIO);
    ...
    /// </summary>
    void Disconnect(RDC::OCC::AIS_InteractiveObject^ theAssembly, RDC::OCC::AIS_InteractiveObject^ theObjToDisconnect);
    /// <summary>
    /// Disconnects theObjToDisconnect from theAssembly and removes dependent selection structures
    /// </summary>
    void Disconnect(RDC::OCC::AIS_InteractiveObject^ theAssembly);
    /// <summary>
    /// Query objects visible or hidden in specified view due to affinity mask.
    /// </summary>
    void ObjectsForView(RDC::OCC::AIS_ListOfInteractive^ theListOfIO, RDC::OCC::V3d_View^ theView, bool theIsVisibleInView, RDC::OCC::PrsMgr_DisplayStatus theStatus);
    /// <summary>
    /// Query objects visible or hidden in specified view due to affinity mask.
    /// </summary>
    void ObjectsForView(RDC::OCC::AIS_ListOfInteractive^ theListOfIO, RDC::OCC::V3d_View^ theView, bool theIsVisibleInView);
    /// <summary>
    /// Return rotation gravity point.
    /// </summary>
    RDC::OCC::Pnt GravityPoint(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Visualization of sensitives - for debugging purposes!
    /// </summary>
    void DisplayActiveSensitive(RDC::OCC::V3d_View^ aView);
    /// <summary>
    /// Clear visualization of sensitives.
    /// </summary>
    void ClearActiveSensitive(RDC::OCC::V3d_View^ aView);
    /// <summary>
    /// Visualization of sensitives - for debugging purposes!
    /// </summary>
    void DisplayActiveSensitive(RDC::OCC::AIS_InteractiveObject^ anObject, RDC::OCC::V3d_View^ aView);
    /// <summary>
    /// Sets the graphic attributes of the interactive object, such as visualization mode, color, and material.
    /// </summary>
    void SetLocalAttributes(RDC::OCC::AIS_InteractiveObject^ theIObj, RDC::OCC::Prs3d_Drawer^ theDrawer, bool theToUpdateViewer);
    /// <summary>
    /// Removes the settings for local attributes of the Object and returns to defaults.
    /// </summary>
    void UnsetLocalAttributes(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void SetCurrentFacingModel(RDC::OCC::AIS_InteractiveObject^ aniobj, RDC::OCC::Aspect_TypeOfFacingModel aModel);
    /// <summary>
    /// change the current facing model apply on polygons for SetColor(), SetTransparency(), SetMaterial() methods default facing model is Aspect_TOFM_TWO_SIDE.
    /// This mean that attributes is applying both on the front and back face.
    /// </summary>
    void SetCurrentFacingModel(RDC::OCC::AIS_InteractiveObject^ aniobj);
    /// <summary>
    /// Returns true if a view of the Interactive Object has color.
    /// </summary>
    bool HasColor(RDC::OCC::AIS_InteractiveObject^ aniobj);
    /// <summary>
    /// Returns the color of the Object in the interactive context.
    /// </summary>
    void Color(RDC::OCC::AIS_InteractiveObject^ aniobj, RDC::OCC::Quantity_Color^ acolor);
    /// <summary>
    /// Sets the color of the selected entity.
    /// </summary>
    void SetColor(RDC::OCC::AIS_InteractiveObject^ theIObj, RDC::OCC::Quantity_Color^ theColor, bool theToUpdateViewer);
    /// <summary>
    /// Removes the color selection for the selected entity.
    /// </summary>
    void UnsetColor(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Returns the width of the Interactive Object in the interactive context.
    /// </summary>
    double Width(RDC::OCC::AIS_InteractiveObject^ aniobj);
    /// <summary>
    /// Sets the width of the Object.
    /// </summary>
    void SetWidth(RDC::OCC::AIS_InteractiveObject^ theIObj, double theValue, bool theToUpdateViewer);
    /// <summary>
    /// Removes the width setting of the Object.
    /// </summary>
    void UnsetWidth(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Provides the type of material setting for the view of the Object.
    /// </summary>
    void SetMaterial(RDC::OCC::AIS_InteractiveObject^ theIObj, RDC::OCC::Graphic3d_MaterialAspect^ theMaterial, bool theToUpdateViewer);
    /// <summary>
    /// Removes the type of material setting for viewing the Object.
    /// </summary>
    void UnsetMaterial(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void SetTransparency(RDC::OCC::AIS_InteractiveObject^ theIObj, double theValue, bool theToUpdateViewer);
    /// <summary>
    /// Removes the transparency settings for viewing the Object.
    /// </summary>
    void UnsetTransparency(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Sets up polygon offsets for the given AIS_InteractiveObject.
    /// It simply calls AIS_InteractiveObject::SetPolygonOffsets().
    /// </summary>
    void SetPolygonOffsets(RDC::OCC::AIS_InteractiveObject^ theIObj, int theMode, float theFactor, float theUnits, bool theToUpdateViewer);
    /// <summary>
    /// Simply calls AIS_InteractiveObject::HasPolygonOffsets().
    /// </summary>
    bool HasPolygonOffsets(RDC::OCC::AIS_InteractiveObject^ anObj);
    /// <summary>
    /// Retrieves current polygon offsets settings for Object.
    /// </summary>
    void PolygonOffsets(RDC::OCC::AIS_InteractiveObject^ anObj, int% aMode, float% aFactor, float% aUnits);
    /// <summary>
    ...
    /// </summary>
    void SetDeviationCoefficient(RDC::OCC::AIS_InteractiveObject^ theIObj, double theCoefficient, bool theToUpdateViewer);
    void SetDeviationAngle(RDC::OCC::AIS_InteractiveObject^ theIObj, double theAngle, bool theToUpdateViewer);
    /// <summary>
    /// Calls the AIS_Shape SetAngleAndDeviation to set both Angle and Deviation coefficients
    /// </summary>
    void SetAngleAndDeviation(RDC::OCC::AIS_InteractiveObject^ theIObj, double theAngle, bool theToUpdateViewer);
    /// <summary>
    /// Sets the deviation coefficient theCoefficient.
    /// Drawings of curves or patches are made with respect to a maximal chordal deviation.
    /// A Deviation coefficient is used in the shading display mode.
    ...
    /// </summary>
    void SetIsoNumber(int NbIsos, RDC::OCC::AIS_TypeOfIso WhichIsos);
    /// <summary>
    /// Sets the number of U and V isoparameters displayed.
    /// </summary>
    ...
    /// </summary>
    int IsoNumber(RDC::OCC::AIS_TypeOfIso WhichIsos);
    /// <summary>
    /// Returns the number of U and V isoparameters displayed.
    /// </summary>
    int IsoNumber();
    ...
    /// </summary>
    void IsoOnTriangulation(bool theIsEnabled, RDC::OCC::AIS_InteractiveObject^ theObject);
    /// <summary>
    ...
    void Display(RDC::OCC::AIS_InteractiveObject^ theIObj, int theDispMode, int theSelectionMode, bool theToUpdateViewer, bool theToAllowDecomposition, RDC::OCC::PrsMgr_DisplayStatus theDispStatus);
    /// <summary>
    /// </summary>
    /// @name obsolete methods
    void Display(RDC::OCC::AIS_InteractiveObject^ theIObj, int theDispMode, int theSelectionMode, bool theToUpdateViewer, bool theToAllowDecomposition);
    void Load(RDC::OCC::AIS_InteractiveObject^ theObj, int theSelectionMode, bool parameter1);
    /// <summary>
    ...
    /// </summary>
    void Hilight(RDC::OCC::AIS_InteractiveObject^ theObj, bool theIsToUpdateViewer);
    /// <summary>
    /// Sets the graphic basic aspect to the current presentation of ALL selected objects.
    /// </summary>
    void SetSelectedAspect(RDC::OCC::Prs3d_BasicAspect^ theAspect, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_StatusOfPick Select(int theXPMin, int theYPMin, int theXPMax, int theYPMax, RDC::OCC::V3d_View^ theView, bool theToUpdateViewer);
    /// <summary>
    /// polyline selection; clears the previous picked list
    /// </summary>
    RDC::OCC::AIS_StatusOfPick Select(RDC::OCC::TColgp_Array1OfPnt2d^ thePolyline, RDC::OCC::V3d_View^ theView, bool theToUpdateViewer);
    /// <summary>
    /// Stores and hilights the previous detected; Unhilights the previous picked.
    /// </summary>
    /// @sa MoveTo().
    RDC::OCC::AIS_StatusOfPick Select(bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    /// @sa MoveTo().
    RDC::OCC::AIS_StatusOfPick ShiftSelect(bool theToUpdateViewer);
    /// <summary>
    /// Adds the last detected to the list of previous picked.
    /// If the last detected was already declared as picked, removes it from the Picked List.
    /// </summary>
    RDC::OCC::AIS_StatusOfPick ShiftSelect(RDC::OCC::TColgp_Array1OfPnt2d^ thePolyline, RDC::OCC::V3d_View^ theView, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_StatusOfPick ShiftSelect(int theXPMin, int theYPMin, int theXPMax, int theYPMax, RDC::OCC::V3d_View^ theView, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void SetCurrentObject(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    void AddOrRemoveCurrentObject(RDC::OCC::AIS_InteractiveObject^ theObj, bool theIsToUpdateViewer);
    /// <summary>
    ...
    /// </summary>
    bool IsCurrent(RDC::OCC::AIS_InteractiveObject^ theObject);
    /// <summary>
    ...
    /// Objects selected when there is no open local context are called current objects; those selected in open local context, selected objects.
    /// </summary>
    RDC::OCC::AIS_InteractiveObject^ Current();
    int NbCurrents();
    /// <summary>
    ...
    RDC::OCC::TopoDS_Shape^ DetectedCurrentShape();
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    /// </returns>
    /// @sa DetectedCurrentOwner(), InitDetected(), MoreDetected(), NextDetected().
    RDC::OCC::AIS_InteractiveObject^ DetectedCurrentObject();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Quantity_Color^ SubIntensityColor();
    /// <summary>
    /// Sub-intensity allows temporary highlighting of particular objects with specified color in a manner of selection highlight,
    /// but without actual selection (e.g., global status and owner's selection state will not be updated).
    ...
    /// </summary>
    void SetSubIntensityColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// </summary>
    void SubIntensityOn(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Removes the subintensity option for the entity.
    /// If a local context is open, the presentation of the Interactive Object activates the selection mode.
    /// </summary>
    void SubIntensityOff(RDC::OCC::AIS_InteractiveObject^ theIObj, bool theToUpdateViewer);
    /// <summary>
    /// Returns selection instance
    /// </summary>
    RDC::OCC::AIS_Selection^ Selection();
    /// <summary>
    ...
    /// </param>
    void SetSelection(RDC::OCC::AIS_Selection^ theSelection);
    /// <summary>
    ...
    static RDC::OCC::AIS_InteractiveContext^ CreateDowncasted(::AIS_InteractiveContext* instance);
}; // class AIS_InteractiveContext
...
public ref class AIS_InteractiveObject
    : public RDC::OCC::SelectMgr_SelectableObject
{
...
protected:
    AIS_InteractiveObject(InitMode init)
        : RDC::OCC::SelectMgr_SelectableObject( init )
    {}

public:
    AIS_InteractiveObject(::AIS_InteractiveObject* nativeInstance)
        : RDC::OCC::SelectMgr_SelectableObject( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    RDC::OCC::AIS_KindOfInteractive Type();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Standard_Transient^ GetOwner();
    /// <summary>
    ...
    /// </summary>
    void SetOwner(RDC::OCC::Standard_Transient^ theApplicativeEntity);
    /// <summary>
    ...
    /// </returns>
    bool ProcessDragging(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, RDC::OCC::SelectMgr_EntityOwner^ theOwner, RDC::OCC::Graphic3d_Vec2i^ theDragFrom, RDC::OCC::Graphic3d_Vec2i^ theDragTo, RDC::OCC::AIS_DragAction theAction);
    /// <summary>
    /// Returns the context pointer to the interactive context.
    /// </summary>
    RDC::OCC::AIS_InteractiveContext^ GetContext();
    /// <summary>
    ...
    /// </summary>
    void SetAspect(RDC::OCC::Prs3d_BasicAspect^ anAspect);
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::AIS_InteractiveObject^ CreateDowncasted(::AIS_InteractiveObject* instance);
}; // class AIS_InteractiveObject
...
public:
    ...
    /// </summary>
    AIS_Animation(RDC::OCC::TCollection_AsciiString^ theAnimationName);
    /// <summary>
    /// Animation name.
    /// </summary>
    ...
    /// input animation
    /// </param>
    void Add(RDC::OCC::AIS_Animation^ theAnimation);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_Animation^ Find(RDC::OCC::TCollection_AsciiString^ theAnimationName);
    /// <summary>
    /// Remove the child animation.
    /// </summary>
    bool Remove(RDC::OCC::AIS_Animation^ theAnimation);
    /// <summary>
    /// Replace the child animation.
    /// </summary>
    bool Replace(RDC::OCC::AIS_Animation^ theAnimationOld, RDC::OCC::AIS_Animation^ theAnimationNew);
    /// <summary>
    /// Clears own children and then copy child animations from another object.
    /// Copy also Start Time and Duration values.
    /// </summary>
    void CopyFrom(RDC::OCC::AIS_Animation^ theOther);
    ...
    static RDC::OCC::AIS_Animation^ CreateDowncasted(::AIS_Animation* instance);
}; // class AIS_Animation
...
public:
    ...
    /// </summary>
    void SetHilightStyle(RDC::OCC::Prs3d_Drawer^ theStyle);
    /// <summary>
    /// Returns applied highlight style for a particular object
    /// </summary>
    RDC::OCC::Prs3d_Drawer^ HilightStyle();
    /// <summary>
    /// Returns active selection modes of the object.
    /// </summary>
    RDC::OCC::TColStd_ListOfInteger^ SelectionModes();
    /// <summary>
    ...
    static RDC::OCC::AIS_GlobalStatus^ CreateDowncasted(::AIS_GlobalStatus* instance);
}; // class AIS_GlobalStatus
...
public:
    ...
    /// result of selection
    /// </returns>
    RDC::OCC::AIS_SelectStatus Select(RDC::OCC::SelectMgr_EntityOwner^ theOwner, RDC::OCC::SelectMgr_Filter^ theFilter, RDC::OCC::AIS_SelectionScheme theSelScheme, bool theIsDetected);
    /// <summary>
    /// the object is always add int the selection.
    /// faster when the number of objects selected is great.
    /// </summary>
    RDC::OCC::AIS_SelectStatus AddSelect(RDC::OCC::SelectMgr_EntityOwner^ theObject);
    /// <summary>
    ...
    /// theIsDetected flag of object detection
    /// </param>
    void ClearAndSelect(RDC::OCC::SelectMgr_EntityOwner^ theObject, RDC::OCC::SelectMgr_Filter^ theFilter, bool theIsDetected);
    /// <summary>
    /// checks if the object is in the selection.
    /// </summary>
    bool IsSelected(RDC::OCC::SelectMgr_EntityOwner^ theObject);
    /// <summary>
    /// Return the list of selected objects.
    /// </summary>
    RDC::OCC::AIS_NListOfEntityOwner^ Objects();
    /// <summary>
    ...
    /// </param>
    void SelectOwners(RDC::OCC::AIS_NArray1OfEntityOwner^ thePickedOwners, RDC::OCC::AIS_SelectionScheme theSelScheme, bool theToAllowSelOverlap, RDC::OCC::SelectMgr_Filter^ theFilter);
    static RDC::OCC::AIS_Selection^ CreateDowncasted(::AIS_Selection* instance);
}; // class AIS_Selection
...
protected:
    AIS_BaseAnimationObject(InitMode init)
        : RDC::OCC::AIS_Animation( init )
    {}

public:
    AIS_BaseAnimationObject(::AIS_BaseAnimationObject* nativeInstance)
        : RDC::OCC::AIS_Animation( nativeInstance )
    {}
...
public:
    static RDC::OCC::AIS_BaseAnimationObject^ CreateDowncasted(::AIS_BaseAnimationObject* instance);
}; // class AIS_BaseAnimationObject
...
public ref class AIS_AnimationAxisRotation sealed
    : public RDC::OCC::AIS_BaseAnimationObject
{
...
public:
    AIS_AnimationAxisRotation(::AIS_AnimationAxisRotation* nativeInstance)
        : RDC::OCC::AIS_BaseAnimationObject( nativeInstance )
    {}
...
public:
    ...
    /// </param>
    AIS_AnimationAxisRotation(RDC::OCC::TCollection_AsciiString^ theAnimationName, RDC::OCC::AIS_InteractiveContext^ theContext, RDC::OCC::AIS_InteractiveObject^ theObject, RDC::OCC::Ax1 theAxis, double theAngleStart, double theAngleEnd);
    static RDC::OCC::AIS_AnimationAxisRotation^ CreateDowncasted(::AIS_AnimationAxisRotation* instance);
}; // class AIS_AnimationAxisRotation
...
public:
    ...
    /// Main constructor.
    /// </summary>
    AIS_AnimationCamera(RDC::OCC::TCollection_AsciiString^ theAnimationName, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Return the target view.
    /// </summary>
    RDC::OCC::V3d_View^ View();
    /// <summary>
    /// Set target view.
    /// </summary>
    void SetView(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Return camera start position.
    /// </summary>
    RDC::OCC::Graphic3d_Camera^ CameraStart();
    /// <summary>
    /// Define camera start position.
    /// </summary>
    void SetCameraStart(RDC::OCC::Graphic3d_Camera^ theCameraStart);
    /// <summary>
    /// Return camera end position.
    /// </summary>
    RDC::OCC::Graphic3d_Camera^ CameraEnd();
    /// <summary>
    /// Define camera end position.
    /// </summary>
    void SetCameraEnd(RDC::OCC::Graphic3d_Camera^ theCameraEnd);
    static RDC::OCC::AIS_AnimationCamera^ CreateDowncasted(::AIS_AnimationCamera* instance);
}; // class AIS_AnimationCamera
...
public:
    ...
    /// </param>
    AIS_AnimationObject(RDC::OCC::TCollection_AsciiString^ theAnimationName, RDC::OCC::AIS_InteractiveContext^ theContext, RDC::OCC::AIS_InteractiveObject^ theObject, RDC::OCC::Trsf theTrsfStart, RDC::OCC::Trsf theTrsfEnd);
    static RDC::OCC::AIS_AnimationObject^ CreateDowncasted(::AIS_AnimationObject* instance);
}; // class AIS_AnimationObject
...
public:
    ...
    /// </summary>
    AIS_AttributeFilter(RDC::OCC::Quantity_NameOfColor aCol);
    /// <summary>
    ...
    /// Sets the color.
    /// </summary>
    void SetColor(RDC::OCC::Quantity_NameOfColor theCol);
    /// <summary>
    /// Sets the line width.
    /// </summary>
    ...
    static RDC::OCC::AIS_AttributeFilter^ CreateDowncasted(::AIS_AttributeFilter* instance);
}; // class AIS_AttributeFilter
...
public ref class AIS_Axis sealed
    : public RDC::OCC::AIS_InteractiveObject
{
...
public:
    AIS_Axis(::AIS_Axis* nativeInstance)
        : RDC::OCC::AIS_InteractiveObject( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    AIS_Axis(RDC::OCC::Geom_Line^ aComponent);
    /// <summary>
    /// initializes the axis2 position
    /// aComponent. The coordinate system used is right-handed.
    /// </summary>
    AIS_Axis(RDC::OCC::Geom_Axis2Placement^ aComponent, RDC::OCC::AIS_TypeOfAxis anAxisType);
    /// <summary>
    /// Initializes the axis1 position anAxis.
    /// </summary>
    AIS_Axis(RDC::OCC::Geom_Axis1Placement^ anAxis);
    /// <summary>
    ...
    /// </param>
    AIS_Axis(RDC::OCC::Ax1 theAxis, double theLength);
    /// <summary>
    /// Initializes the ray as axis with start point and direction
    /// </summary>
    /// <param name="in]">
    ...
    /// </summary>
    RDC::OCC::Geom_Axis2Placement^ Axis2Placement();
    /// <summary>
    ...
    /// </summary>
    void SetAxis2Placement(RDC::OCC::Geom_Axis2Placement^ aComponent, RDC::OCC::AIS_TypeOfAxis anAxisType);
    /// <summary>
    /// Constructs a new line to serve as the axis anAxis in 3D space.
    /// </summary>
    void SetAxis1Placement(RDC::OCC::Geom_Axis1Placement^ anAxis);
    /// <summary>
    /// Returns the type of axis.
    /// </summary>
    RDC::OCC::AIS_TypeOfAxis TypeOfAxis();
    /// <summary>
    /// Constructs the entity theTypeAxis to stock information
    /// concerning type of axis.
    /// </summary>
    void SetTypeOfAxis(RDC::OCC::AIS_TypeOfAxis theTypeAxis);
    /// <summary>
    ...
    /// </summary>
    void SetDisplayAspect(RDC::OCC::Prs3d_LineAspect^ theNewDatumAspect);
    void UnsetColor();
    void UnsetWidth();
    static RDC::OCC::AIS_Axis^ CreateDowncasted(::AIS_Axis* instance);
}; // class AIS_Axis
...
public:
    ...
    /// </summary>
    AIS_BadEdgeFilter();
    bool ActsOn(RDC::OCC::TopAbs_ShapeEnum aType);
    bool IsOk(RDC::OCC::SelectMgr_EntityOwner^ EO);
    /// <summary>
    ...
    /// edges.
    /// </summary>
    void AddEdge(RDC::OCC::TopoDS_Edge^ anEdge, int Index);
    /// <summary>
    /// removes from the  list of non-selectionnable edges
    /// all edges in the contour <Index>.
    /// </summary>
    void RemoveEdges(int Index);
    static RDC::OCC::AIS_BadEdgeFilter^ CreateDowncasted(::AIS_BadEdgeFilter* instance);
}; // class AIS_BadEdgeFilter
...
public:
    AIS_C0RegularityFilter(RDC::OCC::TopoDS_Shape^ aShape);
    bool ActsOn(RDC::OCC::TopAbs_ShapeEnum aType);
    bool IsOk(RDC::OCC::SelectMgr_EntityOwner^ EO);
    static RDC::OCC::AIS_C0RegularityFilter^ CreateDowncasted(::AIS_C0RegularityFilter* instance);
}; // class AIS_C0RegularityFilter
...
public:
    ...
    /// Sets camera frustum.
    /// </summary>
    void SetCameraFrustum(RDC::OCC::Graphic3d_Camera^ theCamera);
    /// <summary>
    /// Setup custom color.
    /// </summary>
    ...
    static RDC::OCC::AIS_CameraFrustum^ CreateDowncasted(::AIS_CameraFrustum* instance);
}; // class AIS_CameraFrustum
...
public:
    ...
    /// </summary>
    AIS_Circle(RDC::OCC::Geom_Circle^ aCircle);
    /// <summary>
    ...
    /// </summary>
    AIS_Circle(RDC::OCC::Geom_Circle^ theCircle, double theUStart, double theUEnd, bool theIsFilledCircleSens);
    /// <summary>
    /// Initializes this algorithm for constructing AIS circle datums.
    /// Initializes the circle theCircle, the arc
    /// starting point theUStart, the arc ending point theUEnd,
    /// and the type of sensitivity theIsFilledCircleSens.
    /// </summary>
    AIS_Circle(RDC::OCC::Geom_Circle^ theCircle, double theUStart, double theUEnd);
    /// <summary>
    ...
    /// </summary>
    void SetCircle(RDC::OCC::Geom_Circle^ theCircle);
    /// <summary>
    ...
    static RDC::OCC::AIS_Circle^ CreateDowncasted(::AIS_Circle* instance);
}; // class AIS_Circle
...
public:
    AIS_ColoredDrawer(::AIS_ColoredDrawer* nativeInstance)
        : RDC::OCC::Prs3d_Drawer( nativeInstance )
    {}
...
public:
    ...
    /// Default constructor.
    /// </summary>
    AIS_ColoredDrawer(RDC::OCC::Prs3d_Drawer^ theLink);
    bool IsHidden();
    ...
    bool HasOwnColor();
    void UnsetOwnColor();
    void SetOwnColor(RDC::OCC::Quantity_Color^ parameter1);
    ...
    static RDC::OCC::AIS_ColoredDrawer^ CreateDowncasted(::AIS_ColoredDrawer* instance);
}; // class AIS_ColoredDrawer
...
protected:
    AIS_Shape(InitMode init)
        : RDC::OCC::AIS_InteractiveObject( init )
    {}
...
public:
    ...
    /// edges and vertices.
    /// </summary>
    AIS_Shape(RDC::OCC::TopoDS_Shape^ shap);
    /// <summary>
    ...
    /// </summary>
    void SetShape(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    /// Alias for ::SetShape().
    /// </summary>
    void Set(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Bnd_Box^ BoundingBox();
    /// <summary>
    /// Returns the Color attributes of the shape accordingly to
    /// the current facing model;
    /// </summary>
    void Color(RDC::OCC::Quantity_Color^ aColor);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::TopAbs_ShapeEnum SelectionType(int theSelMode);
    /// <summary>
    /// Return selection mode for specified shape type.
    /// </summary>
    static int SelectionMode(RDC::OCC::TopAbs_ShapeEnum theShapeType);
    /// <summary>
    /// Return texture repeat UV values; (1, 1) by default.
    /// </summary>
    RDC::OCC::Pnt2d TextureRepeatUV();
    /// <summary>
    ...
    /// </summary>
    void SetTextureScaleUV(RDC::OCC::Pnt2d theScaleUV);
    /// <summary>
    /// Compute HLR presentation for specified shape.
    /// </summary>
    static void computeHlrPresentation(RDC::OCC::Graphic3d_Camera^ theProjector, RDC::OCC::Graphic3d_Structure^ thePrs, RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::Prs3d_Drawer^ theDrawer);
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::AIS_Shape^ CreateDowncasted(::AIS_Shape* instance);
}; // class AIS_Shape
...
public:
    AIS_ColoredShape(::AIS_ColoredShape* nativeInstance)
        : RDC::OCC::AIS_Shape( nativeInstance )
    {}
...
public:
    ...
    /// Default constructor
    /// </summary>
    AIS_ColoredShape(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    /// Copy constructor
    /// </summary>
    AIS_ColoredShape(RDC::OCC::AIS_Shape^ theShape);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_ColoredDrawer^ CustomAspects(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    ...
    /// </param>
    void UnsetCustomAspects(RDC::OCC::TopoDS_Shape^ theShape, bool theToUnregister);
    /// <summary>
    /// Reset custom properties of specified sub-shape.
    /// </summary>
    /// <param name="theToUnregister">
    /// unregister or not sub-shape from the map
    /// </param>
    void UnsetCustomAspects(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    /// Customize color of specified sub-shape
    /// </summary>
    void SetCustomColor(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Customize transparency of specified sub-shape
    /// </summary>
    void SetCustomTransparency(RDC::OCC::TopoDS_Shape^ theShape, double theTransparency);
    /// <summary>
    /// Customize line width of specified sub-shape
    /// </summary>
    void SetCustomWidth(RDC::OCC::TopoDS_Shape^ theShape, double theLineWidth);
    /// <summary>
    /// Return the map of custom aspects.
    /// </summary>
    RDC::OCC::AIS_DataMapOfShapeDrawer^ CustomAspectsMap();
    /// <summary>
    /// Return the map of custom aspects.
    /// </summary>
    RDC::OCC::AIS_DataMapOfShapeDrawer^ ChangeCustomAspectsMap();
    /// <summary>
    ...
    /// </summary>
    void SetMaterial(RDC::OCC::Graphic3d_MaterialAspect^ theAspect);
    /// <summary>
    /// Removes the setting for transparency in the reconstructed compound shape.
    /// </summary>
    void UnsetTransparency();
    ...
    /// </summary>
    void UnsetWidth();
    static RDC::OCC::AIS_ColoredShape^ CreateDowncasted(::AIS_ColoredShape* instance);
}; // class AIS_ColoredShape
...
public:
    ...
    /// </summary>
    static bool FindColor(double theValue, double theMin, double theMax, int theColorsCount, RDC::OCC::Graphic3d_Vec3d^ theColorHlsMin, RDC::OCC::Graphic3d_Vec3d^ theColorHlsMax, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Calculate color according passed value; returns true if value is in range or false, if isn't
    /// </summary>
    static bool FindColor(double theValue, double theMin, double theMax, int theColorsCount, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// Calculate color according passed value; returns true if value is in range or false, if isn't
    /// </summary>
    bool FindColor(double theValue, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// </summary>
    void ColorRange(RDC::OCC::Quantity_Color^ theMinColor, RDC::OCC::Quantity_Color^ theMaxColor);
    /// <summary>
    /// Sets color range corresponding to minimum and maximum values.
    /// </summary>
    void SetColorRange(RDC::OCC::Quantity_Color^ theMinColor, RDC::OCC::Quantity_Color^ theMaxColor);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Aspect_TypeOfColorScaleData GetLabelType();
    /// <summary>
    /// Sets the type of labels.
    /// Aspect_TOCSD_AUTO - labels as boundary values for intervals
    /// Aspect_TOCSD_USER - user specified label is used
    /// </summary>
    void SetLabelType(RDC::OCC::Aspect_TypeOfColorScaleData theType);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Aspect_TypeOfColorScaleData GetColorType();
    /// <summary>
    /// Sets the type of colors.
    /// Aspect_TOCSD_AUTO - value between Red and Blue
    /// Aspect_TOCSD_USER - user specified color from color map
    /// </summary>
    void SetColorType(RDC::OCC::Aspect_TypeOfColorScaleData theType);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TCollection_ExtendedString^ GetTitle();
    /// <summary>
    /// Sets the color scale title string.
    /// </summary>
    void SetTitle(RDC::OCC::TCollection_ExtendedString^ theTitle);
    /// <summary>
    /// Returns the format for numbers, "%.4g" by default.
    /// The same like format for function printf().
    /// Used if GetLabelType() is TOCSD_AUTO;
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ GetFormat();
    /// <summary>
    /// Returns the format of text.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ Format();
    /// <summary>
    /// Sets the color scale auto label format specification.
    /// </summary>
    void SetFormat(RDC::OCC::TCollection_AsciiString^ theFormat);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TCollection_ExtendedString^ GetLabel(int theIndex);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Quantity_Color^ GetIntervalColor(int theIndex);
    /// <summary>
    ...
    /// </param>
    void SetIntervalColor(RDC::OCC::Quantity_Color^ theColor, int theIndex);
    /// <summary>
    /// Returns the user specified labels.
    /// </summary>
    void GetLabels(RDC::OCC::TColStd_SequenceOfExtendedString^ theLabels);
    /// <summary>
    /// Returns the user specified labels.
    /// </summary>
    RDC::OCC::TColStd_SequenceOfExtendedString^ Labels();
    /// <summary>
    ...
    /// </summary>
    void SetLabels(RDC::OCC::TColStd_SequenceOfExtendedString^ theSeq);
    /// <summary>
    /// Returns the user specified colors.
    /// </summary>
    void GetColors(RDC::OCC::Aspect_SequenceOfColor^ theColors);
    /// <summary>
    /// Returns the user specified colors.
    /// </summary>
    RDC::OCC::Aspect_SequenceOfColor^ GetColors();
    /// <summary>
    /// Sets the color scale colors.
    /// The length of the sequence should be equal to GetNumberOfIntervals().
    /// </summary>
    void SetColors(RDC::OCC::Aspect_SequenceOfColor^ theSeq);
    /// <summary>
    ...
    /// </param>
    static RDC::OCC::Aspect_SequenceOfColor^ MakeUniformColors(int theNbColors, double theLightness, double theHueFrom, double theHueTo);
    /// <summary>
    /// Returns the position of labels concerning color filled rectangles, Aspect_TOCSP_RIGHT by default.
    /// </summary>
    RDC::OCC::Aspect_TypeOfColorScalePosition GetLabelPosition();
    /// <summary>
    /// Sets the color scale labels position relative to color bar.
    /// </summary>
    void SetLabelPosition(RDC::OCC::Aspect_TypeOfColorScalePosition thePos);
    /// <summary>
    /// Returns the position of color scale title, Aspect_TOCSP_LEFT by default.
    /// </summary>
    RDC::OCC::Aspect_TypeOfColorScalePosition GetTitlePosition();
    /// <summary>
    /// Sets the color scale title position.
    /// </summary>
    void SetTitlePosition(RDC::OCC::Aspect_TypeOfColorScalePosition thePos);
    /// <summary>
    ...
    /// </param>
    void SetLabel(RDC::OCC::TCollection_ExtendedString^ theLabel, int theIndex);
    /// <summary>
    ...
    /// </param>
    int TextWidth(RDC::OCC::TCollection_ExtendedString^ theText);
    /// <summary>
    ...
    /// </param>
    int TextHeight(RDC::OCC::TCollection_ExtendedString^ theText);
    void TextSize(RDC::OCC::TCollection_ExtendedString^ theText, int theHeight, int% theWidth, int% theAscent, int% theDescent);
    /// <summary>
    /// Return true if specified display mode is supported.
    /// </summary>
    bool AcceptDisplayMode(int theMode);
    ...
    /// </summary>
    void Compute(RDC::OCC::PrsMgr_PresentationManager^ thePrsMgr, RDC::OCC::Graphic3d_Structure^ thePresentation, int theMode);
    /// <summary>
    /// Compute selection - not implemented for color scale.
    /// </summary>
    void ComputeSelection(RDC::OCC::SelectMgr_Selection^ parameter1, int parameter2);
    static RDC::OCC::AIS_ColorScale^ CreateDowncasted(::AIS_ColorScale* instance);
}; // class AIS_ColorScale
...
public:
    ...
    /// </summary>
    AIS_ConnectedInteractive(RDC::OCC::PrsMgr_TypeOfPresentation3d aTypeOfPresentation3d);
    /// <summary>
    /// Disconnects the previous view and sets highlight
    /// mode to 0. This highlights the wireframe presentation
    /// aTypeOfPresentation3d.
    ...
    /// </summary>
    void Connect(RDC::OCC::AIS_InteractiveObject^ theAnotherObj);
    /// <summary>
    /// Establishes the connection between the Connected
    /// Interactive Object, anotherIobj, and its reference.
    /// Locates instance in aLocation.
    /// </summary>
    void Connect(RDC::OCC::AIS_InteractiveObject^ theAnotherObj, RDC::OCC::Trsf theLocation);
    /// <summary>
    /// Establishes the connection between the Connected
    /// Interactive Object, anotherIobj, and its reference.
    /// Locates instance in aLocation.
    /// </summary>
    void Connect(RDC::OCC::AIS_InteractiveObject^ theAnotherObj, RDC::OCC::TopLoc_Datum3D^ theLocation);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_InteractiveObject^ ConnectedTo();
    /// <summary>
    ...
    /// </summary>
    bool AcceptDisplayMode(int theMode);
    static RDC::OCC::AIS_ConnectedInteractive^ CreateDowncasted(::AIS_ConnectedInteractive* instance);
}; // class AIS_ConnectedInteractive
...
public:
    ...
    /// </summary>
    AIS_ExclusionFilter(RDC::OCC::AIS_KindOfInteractive TypeToExclude, bool ExclusionFlagOn);
    /// <summary>
    /// All the AIS objects of <TypeToExclude>
    /// Will be rejected by the IsOk Method.
    /// </summary>
    AIS_ExclusionFilter(RDC::OCC::AIS_KindOfInteractive TypeToExclude);
    /// <summary>
    ...
    /// By default, the flag is set to true.
    /// </summary>
    AIS_ExclusionFilter(RDC::OCC::AIS_KindOfInteractive TypeToExclude, int SignatureInType, bool ExclusionFlagOn);
    /// <summary>
    /// Constructs an exclusion filter object defined by the
    /// enumeration value TypeToExclude, the signature
    /// SignatureInType, and the flag setting ExclusionFlagOn.
    /// By default, the flag is set to true.
    /// </summary>
    AIS_ExclusionFilter(RDC::OCC::AIS_KindOfInteractive TypeToExclude, int SignatureInType);
    bool IsOk(RDC::OCC::SelectMgr_EntityOwner^ anObj);
    /// <summary>
    /// Adds the type TypeToExclude to the list of types.
    /// </summary>
    bool Add(RDC::OCC::AIS_KindOfInteractive TypeToExclude);
    bool Add(RDC::OCC::AIS_KindOfInteractive TypeToExclude, int SignatureInType);
    bool Remove(RDC::OCC::AIS_KindOfInteractive TypeToExclude);
    bool Remove(RDC::OCC::AIS_KindOfInteractive TypeToExclude, int SignatureInType);
    void Clear();
    bool IsExclusionFlagOn();
    void SetExclusionFlag(bool theStatus);
    bool IsStored(RDC::OCC::AIS_KindOfInteractive aType);
    void ListOfStoredTypes(RDC::OCC::TColStd_ListOfInteger^ TheList);
    void ListOfSignature(RDC::OCC::AIS_KindOfInteractive aType, RDC::OCC::TColStd_ListOfInteger^ TheStoredList);
    static RDC::OCC::AIS_ExclusionFilter^ CreateDowncasted(::AIS_ExclusionFilter* instance);
}; // class AIS_ExclusionFilter
...
public ref class AIS_GraphicTool sealed
    : public RDC::OCC::BaseClass<::AIS_GraphicTool>
{
...
public:
    AIS_GraphicTool(::AIS_GraphicTool* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_GraphicTool>( nativeInstance, true )
    {}

    AIS_GraphicTool(::AIS_GraphicTool& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_GraphicTool>( &nativeInstance, false )
    {}
...
public:
    AIS_GraphicTool();
    static RDC::OCC::Quantity_NameOfColor GetLineColor(RDC::OCC::Prs3d_Drawer^ aDrawer, RDC::OCC::AIS_TypeOfAttribute TheTypeOfAttributes);
    static void GetLineColor(RDC::OCC::Prs3d_Drawer^ aDrawer, RDC::OCC::AIS_TypeOfAttribute TheTypeOfAttributes, RDC::OCC::Quantity_Color^ TheLineColor);
    static double GetLineWidth(RDC::OCC::Prs3d_Drawer^ aDrawer, RDC::OCC::AIS_TypeOfAttribute TheTypeOfAttributes);
    static RDC::OCC::Aspect_TypeOfLine GetLineType(RDC::OCC::Prs3d_Drawer^ aDrawer, RDC::OCC::AIS_TypeOfAttribute TheTypeOfAttributes);
    static void GetLineAtt(RDC::OCC::Prs3d_Drawer^ aDrawer, RDC::OCC::AIS_TypeOfAttribute TheTypeOfAttributes, RDC::OCC::Quantity_NameOfColor% aCol, double% aWidth, RDC::OCC::Aspect_TypeOfLine% aTyp);
    static RDC::OCC::Quantity_NameOfColor GetInteriorColor(RDC::OCC::Prs3d_Drawer^ aDrawer);
    static void GetInteriorColor(RDC::OCC::Prs3d_Drawer^ aDrawer, RDC::OCC::Quantity_Color^ aColor);
    static RDC::OCC::Graphic3d_MaterialAspect^ GetMaterial(RDC::OCC::Prs3d_Drawer^ aDrawer);
}; // class AIS_GraphicTool
...
public:
    ...
    /// </summary>
    AIS_LightSource(RDC::OCC::Graphic3d_CLight^ theLightSource);
    /// <summary>
    /// Returns the light.
    /// </summary>
    RDC::OCC::Graphic3d_CLight^ Light();
    /// <summary>
    /// Set the light.
    /// </summary>
    void SetLight(RDC::OCC::Graphic3d_CLight^ theLight);
    /// <summary>
    ...
    /// </param>
    RDC::OCC::Graphic3d_MarkerImage^ MarkerImage(bool theIsEnabled);
    /// <summary>
    /// Returns light source icon.
    /// </summary>
    /// <param name="theIsEnabled">
    /// [in] marker index for enabled/disabled light source states
    /// </param>
    RDC::OCC::Aspect_TypeOfMarker MarkerType(bool theIsEnabled);
    /// <summary>
    /// Sets custom icon to light source.
    /// </summary>
    void SetMarkerImage(RDC::OCC::Graphic3d_MarkerImage^ theImage, bool theIsEnabled);
    /// <summary>
    /// Sets standard icon to light source.
    /// </summary>
    void SetMarkerType(RDC::OCC::Aspect_TypeOfMarker theType, bool theIsEnabled);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_KindOfInteractive Type();
    static RDC::OCC::AIS_LightSource^ CreateDowncasted(::AIS_LightSource* instance);
}; // class AIS_LightSource
...
public ref class AIS_LightSourceOwner sealed
    : public RDC::OCC::SelectMgr_EntityOwner
{
...
public:
    AIS_LightSourceOwner(::AIS_LightSourceOwner* nativeInstance)
        : RDC::OCC::SelectMgr_EntityOwner( nativeInstance )
    {}
...
public:
    ...
    /// Main constructor.
    /// </summary>
    AIS_LightSourceOwner(RDC::OCC::AIS_LightSource^ theObject, int thePriority);
    /// <summary>
    /// Main constructor.
    /// </summary>
    AIS_LightSourceOwner(RDC::OCC::AIS_LightSource^ theObject);
    /// <summary>
    ...
    static RDC::OCC::AIS_LightSourceOwner^ CreateDowncasted(::AIS_LightSourceOwner* instance);
}; // class AIS_LightSourceOwner
...
public:
    ...
    /// </summary>
    AIS_Line(RDC::OCC::Geom_Line^ aLine);
    /// <summary>
    /// Initializes a starting point aStartPoint
    /// and a finishing point aEndPoint for the line.
    /// </summary>
    AIS_Line(RDC::OCC::Geom_Point^ aStartPoint, RDC::OCC::Geom_Point^ aEndPoint);
    /// <summary>
    ...
    /// </summary>
    void UnsetWidth();
    static RDC::OCC::AIS_Line^ CreateDowncasted(::AIS_Line* instance);
}; // class AIS_Line
...
public ref class AIS_ManipulatorObjectSequence sealed
    : public RDC::OCC::Standard_Transient
    , public IIndexEnumerable<RDC::OCC::AIS_InteractiveObject^>
{
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::AIS_ManipulatorObjectSequence::Iterator>
    {
    ...
    public:
        Iterator(::AIS_ManipulatorObjectSequence::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::AIS_ManipulatorObjectSequence::Iterator>( nativeInstance, true )
        {}

        Iterator(::AIS_ManipulatorObjectSequence::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::AIS_ManipulatorObjectSequence::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        RDC::OCC::AIS_InteractiveObject^ Value();
        RDC::OCC::AIS_InteractiveObject^ ChangeValue();
        bool IsEqual(RDC::OCC::AIS_ManipulatorObjectSequence::Iterator^ theOther);
    ...
    void Append(RDC::OCC::AIS_InteractiveObject^ theItem);
    ...
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::AIS_ManipulatorObjectSequence^ Assign(RDC::OCC::AIS_ManipulatorObjectSequence^ theOther);
    void Remove(RDC::OCC::AIS_ManipulatorObjectSequence::Iterator^ thePosition);
    void Prepend(RDC::OCC::AIS_InteractiveObject^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::AIS_InteractiveObject^ theItem);
    void InsertAfter(RDC::OCC::AIS_ManipulatorObjectSequence::Iterator^ thePosition, RDC::OCC::AIS_InteractiveObject^ theItem);
    void Split(int theIndex, RDC::OCC::AIS_ManipulatorObjectSequence^ theSeq);
    RDC::OCC::AIS_InteractiveObject^ First();
    RDC::OCC::AIS_InteractiveObject^ ChangeFirst();
    RDC::OCC::AIS_InteractiveObject^ Last();
    RDC::OCC::AIS_InteractiveObject^ ChangeLast();
    virtual RDC::OCC::AIS_InteractiveObject^ Value(int theIndex);
    RDC::OCC::AIS_InteractiveObject^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::AIS_InteractiveObject^ theItem);
    static RDC::OCC::AIS_ManipulatorObjectSequence^ CreateDowncasted(::AIS_ManipulatorObjectSequence* instance);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::AIS_InteractiveObject^>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class AIS_ManipulatorObjectSequence
...
public:
    ...
    /// </summary>
    AIS_Manipulator(RDC::OCC::Ax2 thePosition);
    /// <summary>
    ...
    void SetPart(int theAxisIndex, RDC::OCC::AIS_ManipulatorMode theMode, bool theIsEnabled);
    /// <summary>
    ...
    /// @warning Enabling or disabling of visual parts of manipulator does not manage the manipulation (selection) mode.
    /// @warning Raises program error if axis index is < 0 or > 2.
    void SetPart(RDC::OCC::AIS_ManipulatorMode theMode, bool theIsEnabled);
    ...
    /// </summary>
    void Attach(RDC::OCC::AIS_InteractiveObject^ theObject);
    ...
    /// It is placed in the center of object bounding box, and its size is adjusted to the object bounding box.
    /// </summary>
    void Attach(RDC::OCC::AIS_ManipulatorObjectSequence^ theObject);
    /// <summary>
    ...
    void EnableMode(RDC::OCC::AIS_ManipulatorMode theMode);
    /// <summary>
    ...
    void StartTransform(int theX, int theY, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    void Transform(RDC::OCC::Trsf aTrsf);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Trsf Transform(int theX, int theY, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// </returns>
    bool ObjectTransformation(int theX, int theY, RDC::OCC::V3d_View^ theView, RDC::OCC::Trsf% theTrsf);
    /// <summary>
    ...
    /// all owning objects.
    /// </returns>
    RDC::OCC::AIS_ManipulatorObjectSequence^ Objects();
    /// <summary>
    /// </summary>
    /// <returns>
    /// the first (leading) object of the owning objects.
    /// </returns>
    RDC::OCC::AIS_InteractiveObject^ Object();
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    RDC::OCC::AIS_InteractiveObject^ Object(int theIndex);
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    RDC::OCC::Trsf StartTransformation();
    RDC::OCC::Trsf StartTransformation(int theIndex);
    /// <summary>
    ...
    RDC::OCC::AIS_ManipulatorMode ActiveMode();
    int ActiveAxisIndex();
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    /// </returns>
    RDC::OCC::Ax2 Position();
    /// <summary>
    /// Sets position of the manipulator object.
    /// </summary>
    void SetPosition(RDC::OCC::Ax2 thePosition);
    float Size();
    /// <summary>
    ...
    void Compute(RDC::OCC::PrsMgr_PresentationManager^ thePrsMgr, RDC::OCC::Graphic3d_Structure^ thePrs, int theMode);
    /// <summary>
    /// Fills presentation.
    /// </summary>
    /// @note Manipulator presentation does not use display mode and for all modes has the same presentation.
    void Compute(RDC::OCC::PrsMgr_PresentationManager^ thePrsMgr, RDC::OCC::Graphic3d_Structure^ thePrs);
    /// <summary>
    ...
    /// </summary>
    void HilightSelected(RDC::OCC::PrsMgr_PresentationManager^ thePM, RDC::OCC::SelectMgr_SequenceOfOwner^ theSeq);
    /// <summary>
    ...
    static RDC::OCC::AIS_Manipulator^ CreateDowncasted(::AIS_Manipulator* instance);
}; // class AIS_Manipulator
...
public:
    AIS_ManipulatorOwner(RDC::OCC::SelectMgr_SelectableObject^ theSelObject, int theIndex, RDC::OCC::AIS_ManipulatorMode theMode, int thePriority);
    AIS_ManipulatorOwner(RDC::OCC::SelectMgr_SelectableObject^ theSelObject, int theIndex, RDC::OCC::AIS_ManipulatorMode theMode);
    void HilightWithColor(RDC::OCC::PrsMgr_PresentationManager^ thePM, RDC::OCC::Prs3d_Drawer^ theStyle, int theMode);
    bool IsHilighted(RDC::OCC::PrsMgr_PresentationManager^ thePM, int theMode);
    void Unhilight(RDC::OCC::PrsMgr_PresentationManager^ thePM, int theMode);
    RDC::OCC::AIS_ManipulatorMode Mode();
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    /// </returns>
    int Index();
    static RDC::OCC::AIS_ManipulatorOwner^ CreateDowncasted(::AIS_ManipulatorOwner* instance);
}; // class AIS_ManipulatorOwner
...
public:
    ...
    /// Open specified file.
    /// </summary>
    void OpenInput(RDC::OCC::TCollection_AsciiString^ thePath, bool theToWait);
    /// <summary>
    /// Display new frame.
    /// </summary>
    bool PresentFrame(RDC::OCC::Graphic3d_Vec2i^ theLeftCorner, RDC::OCC::Graphic3d_Vec2i^ theMaxSize);
    ...
    /// </summary>
    double Duration();
    static RDC::OCC::AIS_MediaPlayer^ CreateDowncasted(::AIS_MediaPlayer* instance);
}; // class AIS_MediaPlayer
...
public:
    ...
    /// </returns>
    RDC::OCC::AIS_InteractiveObject^ Connect(RDC::OCC::AIS_InteractiveObject^ theAnotherObj, RDC::OCC::TopLoc_Datum3D^ theLocation, RDC::OCC::Graphic3d_TransformPers^ theTrsfPers);
    RDC::OCC::AIS_KindOfInteractive Type();
    int Signature();
    /// <summary>
    ...
    /// </summary>
    void Disconnect(RDC::OCC::AIS_InteractiveObject^ theInteractive);
    /// <summary>
    ...
    /// </summary>
    void SetContext(RDC::OCC::AIS_InteractiveContext^ theCtx);
    /// <summary>
    /// Establishes the connection between the Connected Interactive Object, theInteractive, and its reference.
    ...
    /// created instance object (AIS_ConnectedInteractive or AIS_MultipleConnectedInteractive)
    /// </returns>
    RDC::OCC::AIS_InteractiveObject^ Connect(RDC::OCC::AIS_InteractiveObject^ theAnotherObj);
    /// <summary>
    /// Establishes the connection between the Connected Interactive Object, theInteractive, and its reference.
    ...
    /// created instance object (AIS_ConnectedInteractive or AIS_MultipleConnectedInteractive)
    /// </returns>
    RDC::OCC::AIS_InteractiveObject^ Connect(RDC::OCC::AIS_InteractiveObject^ theAnotherObj, RDC::OCC::Trsf theLocation);
    /// <summary>
    /// Establishes the connection between the Connected Interactive Object, theInteractive, and its reference.
    /// Locates instance in theLocation and applies specified transformation persistence mode.
    /// </summary>
    ...
    /// created instance object (AIS_ConnectedInteractive or AIS_MultipleConnectedInteractive)
    /// </returns>
    RDC::OCC::AIS_InteractiveObject^ Connect(RDC::OCC::AIS_InteractiveObject^ theAnotherObj, RDC::OCC::Trsf theLocation, RDC::OCC::Graphic3d_TransformPers^ theTrsfPers);
    static RDC::OCC::AIS_MultipleConnectedInteractive^ CreateDowncasted(::AIS_MultipleConnectedInteractive* instance);
}; // class AIS_MultipleConnectedInteractive
...
public:
    ...
    /// </summary>
    AIS_Plane(RDC::OCC::Geom_Plane^ aComponent, bool aCurrentMode);
    /// <summary>
    /// initializes the plane aComponent. If
    /// the mode aCurrentMode equals true, the drawing
    /// tool, "Drawer" is not initialized.
    /// </summary>
    AIS_Plane(RDC::OCC::Geom_Plane^ aComponent);
    /// <summary>
    ...
    /// tool, "Drawer" is not initialized.
    /// </summary>
    AIS_Plane(RDC::OCC::Geom_Plane^ aComponent, RDC::OCC::Pnt aCenter, bool aCurrentMode);
    /// <summary>
    /// initializes the plane aComponent and
    /// the point aCenter. If the mode aCurrentMode
    /// equals true, the drawing tool, "Drawer" is not
    ...
    /// tool, "Drawer" is not initialized.
    /// </summary>
    AIS_Plane(RDC::OCC::Geom_Plane^ aComponent, RDC::OCC::Pnt aCenter);
    /// <summary>
    ...
    /// </summary>
    AIS_Plane(RDC::OCC::Geom_Plane^ aComponent, RDC::OCC::Pnt aCenter, RDC::OCC::Pnt aPmin, RDC::OCC::Pnt aPmax, bool aCurrentMode);
    /// <summary>
    /// initializes the plane aComponent, the
    /// point aCenter, and the minimum and maximum
    /// points, aPmin and aPmax. If the mode
    /// aCurrentMode equals true, the drawing tool, "Drawer" is not initialized.
    /// </summary>
    AIS_Plane(RDC::OCC::Geom_Plane^ aComponent, RDC::OCC::Pnt aCenter, RDC::OCC::Pnt aPmin, RDC::OCC::Pnt aPmax);
    AIS_Plane(RDC::OCC::Geom_Axis2Placement^ aComponent, RDC::OCC::AIS_TypeOfPlane aPlaneType, bool aCurrentMode);
    AIS_Plane(RDC::OCC::Geom_Axis2Placement^ aComponent, RDC::OCC::AIS_TypeOfPlane aPlaneType);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom_Plane^ Component();
    /// <summary>
    /// Creates an instance of the plane aComponent.
    /// </summary>
    void SetComponent(RDC::OCC::Geom_Plane^ aComponent);
    /// <summary>
    ...
    /// </summary>
    bool PlaneAttributes(RDC::OCC::Geom_Plane^ aComponent, RDC::OCC::Pnt% aCenter, RDC::OCC::Pnt% aPmin, RDC::OCC::Pnt% aPmax);
    /// <summary>
    ...
    /// </summary>
    void SetPlaneAttributes(RDC::OCC::Geom_Plane^ aComponent, RDC::OCC::Pnt aCenter, RDC::OCC::Pnt aPmin, RDC::OCC::Pnt aPmax);
    /// <summary>
    ...
    /// -   AIS_ TOPL_YZPlane}.
    /// </summary>
    void SetAxis2Placement(RDC::OCC::Geom_Axis2Placement^ aComponent, RDC::OCC::AIS_TypeOfPlane aPlaneType);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_TypeOfPlane TypeOfPlane();
    /// <summary>
    ...
    void SetColor(RDC::OCC::Quantity_Color^ aColor);
    void UnsetColor();
    static RDC::OCC::AIS_Plane^ CreateDowncasted(::AIS_Plane* instance);
}; // class AIS_Plane
...
public:
    ...
    /// datum will be built.
    /// </summary>
    AIS_Point(RDC::OCC::Geom_Point^ aComponent);
    /// <summary>
    ...
    /// Returns the component specified in SetComponent.
    /// </summary>
    RDC::OCC::Geom_Point^ Component();
    /// <summary>
    /// Constructs an instance of the point aComponent.
    /// </summary>
    void SetComponent(RDC::OCC::Geom_Point^ aComponent);
    /// <summary>
    ...
    /// -   scale factor.
    /// </summary>
    void SetMarker(RDC::OCC::Aspect_TypeOfMarker aType);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Vertex^ Vertex();
    static RDC::OCC::AIS_Point^ CreateDowncasted(::AIS_Point* instance);
}; // class AIS_Point
...
public:
    ...
    /// </summary>
    AIS_PlaneTrihedron(RDC::OCC::Geom_Plane^ aPlane);
    /// <summary>
    /// Returns the component specified in SetComponent.
    /// </summary>
    RDC::OCC::Geom_Plane^ Component();
    ...
    /// </summary>
    void SetComponent(RDC::OCC::Geom_Plane^ aPlane);
    /// <summary>
    /// Returns the "XAxis".
    /// </summary>
    RDC::OCC::AIS_Line^ XAxis();
    /// <summary>
    /// Returns the "YAxis".
    /// </summary>
    RDC::OCC::AIS_Line^ YAxis();
    /// <summary>
    /// Returns the point of origin of the plane trihedron.
    /// </summary>
    RDC::OCC::AIS_Point^ Position();
    /// <summary>
    ...
    /// </summary>
    void SetColor(RDC::OCC::Quantity_Color^ theColor);
    void SetXLabel(RDC::OCC::TCollection_AsciiString^ theLabel);
    void SetYLabel(RDC::OCC::TCollection_AsciiString^ theLabel);
    static RDC::OCC::AIS_PlaneTrihedron^ CreateDowncasted(::AIS_PlaneTrihedron* instance);
}; // class AIS_PlaneTrihedron
...
public:
    ...
    /// </param>
    void SetPoints(RDC::OCC::Graphic3d_ArrayOfPoints^ thePoints);
    /// <summary>
    ...
    /// </param>
    void SetPoints(RDC::OCC::TColgp_HArray1OfPnt^ theCoords, RDC::OCC::Quantity_HArray1OfColor^ theColors, RDC::OCC::TColgp_HArray1OfDir^ theNormals);
    /// <summary>
    /// Sets the points with optional colors.
    /// The input data will be copied into internal buffer.
    /// The input arrays should have equal length, otherwise
    ...
    /// [in] optional array of normals
    /// </param>
    void SetPoints(RDC::OCC::TColgp_HArray1OfPnt^ theCoords, RDC::OCC::Quantity_HArray1OfColor^ theColors);
    /// <summary>
    /// Sets the points with optional colors.
    /// The input data will be copied into internal buffer.
    /// The input arrays should have equal length, otherwise
    ...
    /// [in] optional array of normals
    /// </param>
    void SetPoints(RDC::OCC::TColgp_HArray1OfPnt^ theCoords);
    /// <summary>
    ...
    /// the array of points
    /// </returns>
    RDC::OCC::Graphic3d_ArrayOfPoints^ GetPoints();
    /// <summary>
    /// Get bounding box for presentation.
    /// </summary>
    RDC::OCC::Bnd_Box^ GetBoundingBox();
    /// <summary>
    ...
    /// </summary>
    void SetMaterial(RDC::OCC::Graphic3d_MaterialAspect^ theMat);
    /// <summary>
    /// Restore default material.
    /// </summary>
    void UnsetMaterial();
    static RDC::OCC::AIS_PointCloud^ CreateDowncasted(::AIS_PointCloud* instance);
}; // class AIS_PointCloud
...
public:
    ...
    /// Main constructor.
    /// </summary>
    AIS_PointCloudOwner(RDC::OCC::AIS_PointCloud^ theOrigin);
    /// <summary>
    /// Return selected points.
    /// WARNING! Indexation starts with 0 (shifted by -1 comparing to Graphic3d_ArrayOfPoints::Vertice()).
    /// </summary>
    RDC::OCC::TColStd_HPackedMapOfInteger^ SelectedPoints();
    /// <summary>
    /// Return last detected points.
    /// WARNING! Indexation starts with 0 (shifted by -1 comparing to Graphic3d_ArrayOfPoints::Vertice()).
    /// </summary>
    RDC::OCC::TColStd_HPackedMapOfInteger^ DetectedPoints();
    /// <summary>
    /// Always update dynamic highlighting.
    /// </summary>
    bool IsForcedHilight();
    ...
    static RDC::OCC::AIS_PointCloudOwner^ CreateDowncasted(::AIS_PointCloudOwner* instance);
}; // class AIS_PointCloudOwner
...
public:
    ...
    /// </param>
    /// @warning It binds this object with Graphic3d_ZLayerId_TopOSD layer.
    AIS_RubberBand(RDC::OCC::Quantity_Color^ theLineColor, RDC::OCC::Aspect_TypeOfLine theType, double theLineWidth, bool theIsPolygonClosed);
    /// <summary>
    /// Consructs the rubber band with empty filling and defined line style.
    /// </summary>
    /// <param name="theLineColor">
    ...
    /// </param>
    /// @warning It binds this object with Graphic3d_ZLayerId_TopOSD layer.
    AIS_RubberBand(RDC::OCC::Quantity_Color^ theLineColor, RDC::OCC::Aspect_TypeOfLine theType, double theLineWidth);
    /// <summary>
    /// Consructs the rubber band with empty filling and defined line style.
    /// </summary>
    /// <param name="theLineColor">
    ...
    /// </param>
    /// @warning It binds this object with Graphic3d_ZLayerId_TopOSD layer.
    AIS_RubberBand(RDC::OCC::Quantity_Color^ theLineColor, RDC::OCC::Aspect_TypeOfLine theType);
    /// <summary>
    ...
    /// </param>
    /// @warning It binds this object with Graphic3d_ZLayerId_TopOSD layer.
    AIS_RubberBand(RDC::OCC::Quantity_Color^ theLineColor, RDC::OCC::Aspect_TypeOfLine theType, RDC::OCC::Quantity_Color^ theFillColor, double theTransparency, double theLineWidth, bool theIsPolygonClosed);
    /// <summary>
    /// Constructs the rubber band with defined filling and line parameters.
    /// </summary>
    /// <param name="theLineColor">
    ...
    /// </param>
    /// @warning It binds this object with Graphic3d_ZLayerId_TopOSD layer.
    AIS_RubberBand(RDC::OCC::Quantity_Color^ theLineColor, RDC::OCC::Aspect_TypeOfLine theType, RDC::OCC::Quantity_Color^ theFillColor, double theTransparency, double theLineWidth);
    /// <summary>
    /// Constructs the rubber band with defined filling and line parameters.
    /// </summary>
    /// <param name="theLineColor">
    ...
    /// </param>
    /// @warning It binds this object with Graphic3d_ZLayerId_TopOSD layer.
    AIS_RubberBand(RDC::OCC::Quantity_Color^ theLineColor, RDC::OCC::Aspect_TypeOfLine theType, RDC::OCC::Quantity_Color^ theFillColor, double theTransparency);
    /// <summary>
    /// Constructs the rubber band with defined filling and line parameters.
    /// </summary>
    /// <param name="theLineColor">
    ...
    /// </param>
    /// @warning It binds this object with Graphic3d_ZLayerId_TopOSD layer.
    AIS_RubberBand(RDC::OCC::Quantity_Color^ theLineColor, RDC::OCC::Aspect_TypeOfLine theType, RDC::OCC::Quantity_Color^ theFillColor);
    /// <summary>
    ...
    void AddPoint(RDC::OCC::Graphic3d_Vec2i^ thePoint);
    /// <summary>
    ...
    /// </returns>
    RDC::OCC::Quantity_Color^ LineColor();
    /// <summary>
    /// Sets color of lines for rubber band presentation.
    /// </summary>
    void SetLineColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// </summary>
    /// <returns>
    /// the color of rubber band filling.
    /// </returns>
    RDC::OCC::Quantity_Color^ FillColor();
    /// <summary>
    /// Sets color of rubber band filling.
    /// </summary>
    void SetFillColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// </param>
    void SetFilling(RDC::OCC::Quantity_Color^ theColor, double theTransparency);
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    static RDC::OCC::AIS_RubberBand^ CreateDowncasted(::AIS_RubberBand* instance);
}; // class AIS_RubberBand
...
public:
    ...
    /// </summary>
    AIS_TypeFilter(RDC::OCC::AIS_KindOfInteractive aGivenKind);
    /// <summary>
    ...
    /// </summary>
    bool IsOk(RDC::OCC::SelectMgr_EntityOwner^ anobj);
    static RDC::OCC::AIS_TypeFilter^ CreateDowncasted(::AIS_TypeFilter* instance);
}; // class AIS_TypeFilter
...
public:
    AIS_SignatureFilter(::AIS_SignatureFilter* nativeInstance)
        : RDC::OCC::AIS_TypeFilter( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    AIS_SignatureFilter(RDC::OCC::AIS_KindOfInteractive aGivenKind, int aGivenSignature);
    /// <summary>
    ...
    /// </summary>
    bool IsOk(RDC::OCC::SelectMgr_EntityOwner^ anobj);
    static RDC::OCC::AIS_SignatureFilter^ CreateDowncasted(::AIS_SignatureFilter* instance);
}; // class AIS_SignatureFilter
...
public:
    ...
    /// </summary>
    void SetMaterial(RDC::OCC::Graphic3d_MaterialAspect^ parameter1);
    /// <summary>
    /// Setup text.
    /// </summary>
    void SetText(RDC::OCC::TCollection_ExtendedString^ theText);
    /// <summary>
    /// Setup position.
    /// </summary>
    ...
    /// </summary>
    void SetHJustification(RDC::OCC::Graphic3d_HorizontalTextAlignment theHJust);
    /// <summary>
    /// Setup vertical justification.
    /// </summary>
    void SetVJustification(RDC::OCC::Graphic3d_VerticalTextAlignment theVJust);
    /// <summary>
    /// Setup angle.
    /// </summary>
    ...
    /// </summary>
    void SetOrientation3D(RDC::OCC::Ax2 theOrientation);
    /// <summary>
    ...
    static RDC::OCC::AIS_TextLabel^ CreateDowncasted(::AIS_TextLabel* instance);
}; // class AIS_TextLabel
...
public:
    ...
    /// </summary>
    AIS_TexturedShape(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    ...
    /// </summary>
    void SetTextureFileName(RDC::OCC::TCollection_AsciiString^ theTextureFileName);
    /// <summary>
    ...
    /// </summary>
    void SetTexturePixMap(RDC::OCC::Image_PixMap^ theTexturePixMap);
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    /// </returns>
    RDC::OCC::Image_PixMap^ TexturePixMap();
    /// <summary>
    ...
    /// </summary>
    bool AcceptDisplayMode(int theMode);
    static RDC::OCC::AIS_TexturedShape^ CreateDowncasted(::AIS_TexturedShape* instance);
}; // class AIS_TexturedShape
...
public:
    ...
    /// </summary>
    void SetColors(RDC::OCC::TColStd_HArray1OfInteger^ aColor);
    /// <summary>
    /// Get the color for each node.
    /// Each 32-bit color is Alpha << 24 + Blue << 16 + Green << 8 + Red
    /// </summary>
    RDC::OCC::TColStd_HArray1OfInteger^ GetColors();
    /// <summary>
    ...
    /// </summary>
    void UnsetTransparency();
    static RDC::OCC::AIS_Triangulation^ CreateDowncasted(::AIS_Triangulation* instance);
}; // class AIS_Triangulation
...
public:
    ...
    /// </summary>
    AIS_Trihedron(RDC::OCC::Geom_Axis2Placement^ theComponent);
    /// <summary>
    /// Returns datum display mode.
    /// </summary>
    RDC::OCC::Prs3d_DatumMode DatumDisplayMode();
    /// <summary>
    /// Sets Shading or Wireframe display mode, triangle or segment graphic group is used relatively.
    /// </summary>
    void SetDatumDisplayMode(RDC::OCC::Prs3d_DatumMode theMode);
    /// <summary>
    /// Returns the right-handed coordinate system set in SetComponent.
    /// </summary>
    RDC::OCC::Geom_Axis2Placement^ Component();
    /// <summary>
    /// Constructs the right-handed coordinate system aComponent.
    /// </summary>
    void SetComponent(RDC::OCC::Geom_Axis2Placement^ theComponent);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Quantity_Color^ TextColor();
    /// <summary>
    /// Sets color of label of trihedron axes.
    /// </summary>
    void SetTextColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Sets color of label of trihedron axis.
    /// </summary>
    void SetTextColor(RDC::OCC::Prs3d_DatumParts thePart, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Quantity_Color^ ArrowColor();
    /// <summary>
    /// Sets color of arrow of trihedron axes.
    /// </summary>
    void SetArrowColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Sets color of arrow of trihedron axes.
    /// </summary>
    void SetArrowColor(RDC::OCC::Prs3d_DatumParts thePart, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Returns color of datum part: origin or some of trihedron axes.
    /// </summary>
    RDC::OCC::Quantity_Color^ DatumPartColor(RDC::OCC::Prs3d_DatumParts thePart);
    /// <summary>
    ...
    /// </summary>
    void SetDatumPartColor(RDC::OCC::Prs3d_DatumParts thePart, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Sets color of origin.
    /// Standard_DEPRECATED("This method is deprecated - SetColor() should be called instead")
    /// </summary>
    void SetOriginColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Sets color of x-axis.
    /// Standard_DEPRECATED("This method is deprecated - SetColor() should be called instead")
    /// </summary>
    void SetXAxisColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Sets color of y-axis.
    /// Standard_DEPRECATED("This method is deprecated - SetColor() should be called instead")
    /// </summary>
    void SetYAxisColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Sets color of z-axis.
    /// Standard_DEPRECATED("This method is deprecated - SetColor() should be called instead")
    /// </summary>
    void SetAxisColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// </summary>
    int SelectionPriority(RDC::OCC::Prs3d_DatumParts thePart);
    /// <summary>
    /// Sets priority of selection for owner of the given type
    /// </summary>
    void SetSelectionPriority(RDC::OCC::Prs3d_DatumParts thePart, int thePriority);
    /// <summary>
    /// Returns text of axis. Parameter thePart should be XAxis, YAxis or ZAxis
    /// </summary>
    RDC::OCC::TCollection_ExtendedString^ Label(RDC::OCC::Prs3d_DatumParts thePart);
    /// <summary>
    /// Sets text label for trihedron axis. Parameter thePart should be XAxis, YAxis or ZAxis
    /// </summary>
    void SetLabel(RDC::OCC::Prs3d_DatumParts thePart, RDC::OCC::TCollection_ExtendedString^ theName);
    /// <summary>
    ...
    /// Method which draws selected owners ( for fast presentation draw ).
    /// </summary>
    void HilightSelected(RDC::OCC::PrsMgr_PresentationManager^ thePM, RDC::OCC::SelectMgr_SequenceOfOwner^ theOwners);
    /// <summary>
    /// Method which hilight an owner belonging to
    /// this selectable object  ( for fast presentation draw ).
    /// </summary>
    void HilightOwnerWithColor(RDC::OCC::PrsMgr_PresentationManager^ thePM, RDC::OCC::Prs3d_Drawer^ theStyle, RDC::OCC::SelectMgr_EntityOwner^ theOwner);
    static RDC::OCC::AIS_Trihedron^ CreateDowncasted(::AIS_Trihedron* instance);
}; // class AIS_Trihedron
...
public:
    ...
    /// </summary>
    AIS_TrihedronOwner(RDC::OCC::SelectMgr_SelectableObject^ theSelObject, RDC::OCC::Prs3d_DatumParts theDatumPart, int thePriority);
    /// <summary>
    /// Returns the datum part identifier.
    /// </summary>
    RDC::OCC::Prs3d_DatumParts DatumPart();
    /// <summary>
    ...
    /// </summary>
    void Unhilight(RDC::OCC::PrsMgr_PresentationManager^ thePM, int theMode);
    static RDC::OCC::AIS_TrihedronOwner^ CreateDowncasted(::AIS_TrihedronOwner* instance);
}; // class AIS_TrihedronOwner
...
public ref class AIS_ViewInputBuffer sealed
    : public RDC::OCC::BaseClass<::AIS_ViewInputBuffer>
{
...
public:
    AIS_ViewInputBuffer(::AIS_ViewInputBuffer* nativeInstance)
        : RDC::OCC::BaseClass<::AIS_ViewInputBuffer>( nativeInstance, true )
    {}

    AIS_ViewInputBuffer(::AIS_ViewInputBuffer& nativeInstance)
        : RDC::OCC::BaseClass<::AIS_ViewInputBuffer>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Main constructor.
    /// </summary>
    AIS_XRTrackedDevice(RDC::OCC::Graphic3d_ArrayOfTriangles^ theTris, RDC::OCC::Image_Texture^ theTexture);
    /// <summary>
    /// Empty constructor.
    /// </summary>
    AIS_XRTrackedDevice();
    ...
    /// Return device role.
    /// </summary>
    RDC::OCC::Aspect_XRTrackedDeviceRole Role();
    /// <summary>
    /// Set device role.
    /// </summary>
    void SetRole(RDC::OCC::Aspect_XRTrackedDeviceRole theRole);
    /// <summary>
    /// Return laser color.
    /// </summary>
    RDC::OCC::Quantity_Color^ LaserColor();
    /// <summary>
    /// Set laser color.
    /// </summary>
    void SetLaserColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Return laser length.
    /// </summary>
    float LaserLength();
    ...
    static RDC::OCC::AIS_XRTrackedDevice^ CreateDowncasted(::AIS_XRTrackedDevice* instance);
}; // class AIS_XRTrackedDevice
...
public ref class AIS_ViewController sealed
    : public RDC::OCC::Aspect_WindowInputListener
{
...
public:
    AIS_ViewController(::AIS_ViewController* nativeInstance)
        : RDC::OCC::Aspect_WindowInputListener( nativeInstance )
    {}
...
public:
    ...
    /// Return input buffer.
    /// </summary>
    RDC::OCC::AIS_ViewInputBuffer^ InputBuffer(RDC::OCC::AIS_ViewInputBufferType theType);
    /// <summary>
    /// Return input buffer.
    /// </summary>
    RDC::OCC::AIS_ViewInputBuffer^ ChangeInputBuffer(RDC::OCC::AIS_ViewInputBufferType theType);
    /// <summary>
    /// Return view animation; empty (but not NULL) animation by default.
    /// </summary>
    RDC::OCC::AIS_AnimationCamera^ ViewAnimation();
    /// <summary>
    /// Set view animation to be handled within handleViewRedraw().
    /// </summary>
    void SetViewAnimation(RDC::OCC::AIS_AnimationCamera^ theAnimation);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_Animation^ ObjectsAnimation();
    /// <summary>
    /// Set object animation to be handled within handleViewRedraw().
    /// </summary>
    void SetObjectsAnimation(RDC::OCC::AIS_Animation^ theAnimation);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_RotationMode RotationMode();
    /// <summary>
    /// Set camera rotation mode.
    /// </summary>
    void SetRotationMode(RDC::OCC::AIS_RotationMode theMode);
    /// <summary>
    /// Return camera navigation mode; AIS_NavigationMode_Orbit by default.
    /// </summary>
    RDC::OCC::AIS_NavigationMode NavigationMode();
    /// <summary>
    /// Set camera navigation mode.
    /// </summary>
    void SetNavigationMode(RDC::OCC::AIS_NavigationMode theMode);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Graphic3d_Vec2i^ PreviousMoveTo();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::AIS_WalkDelta^ FetchNavigationKeys(double theCrouchRatio, double theRunRatio);
    /// <summary>
    /// Return map defining mouse gestures.
    /// </summary>
    RDC::OCC::AIS_MouseGestureMap^ MouseGestureMap();
    /// <summary>
    /// Return map defining mouse gestures.
    /// </summary>
    RDC::OCC::AIS_MouseGestureMap^ ChangeMouseGestureMap();
    /// <summary>
    /// Return map defining mouse selection schemes.
    /// </summary>
    RDC::OCC::AIS_MouseSelectionSchemeMap^ MouseSelectionSchemes();
    /// <summary>
    /// Return map defining mouse gestures.
    /// </summary>
    RDC::OCC::AIS_MouseSelectionSchemeMap^ ChangeMouseSelectionSchemes();
    /// <summary>
    ...
    /// selection scheme
    /// </param>
    void SelectInViewer(RDC::OCC::Graphic3d_Vec2i^ thePnt, RDC::OCC::AIS_SelectionScheme theScheme);
    /// <summary>
    /// Perform selection in 3D viewer.
    /// This method is expected to be called from UI thread.
    /// </summary>
    ...
    /// selection scheme
    /// </param>
    void SelectInViewer(RDC::OCC::Graphic3d_Vec2i^ thePnt);
    ...
    /// </param>
    void UpdateRubberBand(RDC::OCC::Graphic3d_Vec2i^ thePntFrom, RDC::OCC::Graphic3d_Vec2i^ thePntTo);
    /// <summary>
    ...
    /// </param>
    void UpdatePolySelection(RDC::OCC::Graphic3d_Vec2i^ thePnt, bool theToAppend);
    /// <summary>
    ...
    /// </returns>
    bool UpdateZoom(RDC::OCC::Aspect_ScrollDelta^ theDelta);
    /// <summary>
    ...
    /// </returns>
    bool UpdateMouseScroll(RDC::OCC::Aspect_ScrollDelta^ theDelta);
    /// <summary>
    ...
    /// </returns>
    bool UpdateMouseButtons(RDC::OCC::Graphic3d_Vec2i^ thePoint, unsigned int theButtons, unsigned int theModifiers, bool theIsEmulated);
    /// <summary>
    ...
    /// TRUE if View should be redrawn
    /// </returns>
    bool UpdateMousePosition(RDC::OCC::Graphic3d_Vec2i^ thePoint, unsigned int theButtons, unsigned int theModifiers, bool theIsEmulated);
    /// <summary>
    ...
    /// TRUE if View should be redrawn
    /// </returns>
    bool UpdateMouseClick(RDC::OCC::Graphic3d_Vec2i^ thePoint, unsigned int theButton, unsigned int theModifiers, bool theIsDoubleClick);
    /// <summary>
    ...
    /// </param>
    void AddTouchPoint(long long unsigned int theId, RDC::OCC::Graphic3d_Vec2d^ thePnt, bool theClearBefore);
    /// <summary>
    /// Add touch point with the given ID.
    /// This method is expected to be called from UI thread.
    /// </summary>
    ...
    /// if TRUE previously registered touches will be removed
    /// </param>
    void AddTouchPoint(long long unsigned int theId, RDC::OCC::Graphic3d_Vec2d^ thePnt);
    /// <summary>
    ...
    /// touch coordinates
    /// </param>
    void UpdateTouchPoint(long long unsigned int theId, RDC::OCC::Graphic3d_Vec2d^ thePnt);
    ...
    /// This method is expected to be called from UI thread.
    /// </summary>
    void UpdateViewOrientation(RDC::OCC::V3d_TypeOfOrientation theOrientation, bool theToFitAll);
    /// <summary>
    ...
    /// </param>
    void FlushViewEvents(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, bool theToHandle);
    /// <summary>
    /// Update buffer for rendering thread.
    /// This method is expected to be called within synchronization barrier between GUI
    /// and Rendering threads (e.g. GUI thread should be locked beforehand to avoid data races).
    ...
    /// if TRUE, the HandleViewEvents() will be called
    /// </param>
    void FlushViewEvents(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Process events within rendering thread.
    /// </summary>
    void HandleViewEvents(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Callback called by handleMoveTo() on Selection in 3D Viewer.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void OnSelectionChanged(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Callback called by handleMoveTo() on dragging object in 3D Viewer.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void OnObjectDragged(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, RDC::OCC::AIS_DragAction theAction);
    /// <summary>
    /// Callback called by HandleViewEvents() on Selection of another (sub)view.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void OnSubviewChanged(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theOldView, RDC::OCC::V3d_View^ theNewView);
    /// <summary>
    ...
    /// </returns>
    bool PickPoint(RDC::OCC::Pnt% thePnt, RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, RDC::OCC::Graphic3d_Vec2i^ theCursor, bool theToStickToPickRay);
    /// <summary>
    ...
    /// TRUE if result has been found
    /// </returns>
    bool PickAxis(RDC::OCC::Pnt% theTopPnt, RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, RDC::OCC::Ax1 theAxis);
    /// <summary>
    /// Compute rotation gravity center point depending on rotation mode.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    RDC::OCC::Pnt GravityPoint(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// </summary>
    void FitAllAuto(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void handleViewOrientationKeys(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Perform navigation (Aspect_VKey_NavForward and similar keys).
    /// This method is expected to be called from rendering thread.
    /// </summary>
    RDC::OCC::AIS_WalkDelta^ handleNavigationKeys(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Perform immediate camera actions (rotate/zoom/pan) on gesture progress.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void handleCameraActions(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, RDC::OCC::AIS_WalkDelta^ theWalk);
    /// <summary>
    /// Perform moveto/selection/dragging.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void handleMoveTo(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Pnt panningAnchorPoint();
    /// <summary>
    /// Set active panning anchor point.
    /// </summary>
    void setPanningAnchorPoint(RDC::OCC::Pnt thePnt);
    /// <summary>
    /// Handle panning event myGL.Panning.
    /// </summary>
    void handlePanning(RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Handle Z rotation event myGL.ZRotate.
    /// </summary>
    void handleZRotate(RDC::OCC::V3d_View^ theView);
    /// <summary>
    ...
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void handleZoom(RDC::OCC::V3d_View^ theView, RDC::OCC::Aspect_ScrollDelta^ theParams, RDC::OCC::Pnt thePnt);
    /// <summary>
    /// Handle ZScroll event myGL.ZoomActions.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void handleZFocusScroll(RDC::OCC::V3d_View^ theView, RDC::OCC::Aspect_ScrollDelta^ theParams);
    /// <summary>
    ...
    /// </param>
    void handleOrbitRotation(RDC::OCC::V3d_View^ theView, RDC::OCC::Pnt thePnt, bool theToLockZUp);
    /// <summary>
    ...
    /// </param>
    void handleViewRotation(RDC::OCC::V3d_View^ theView, double theYawExtra, double thePitchExtra, double theRoll, bool theToRestartOnIncrement);
    /// <summary>
    /// Handle view redraw.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void handleViewRedraw(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Perform XR input.
    /// This method is expected to be called from rendering thread.
    /// </summary>
    void handleXRInput(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, RDC::OCC::AIS_WalkDelta^ theWalk);
    /// <summary>
    /// Handle trackpad view turn action.
    /// </summary>
    void handleXRTurnPad(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Handle trackpad teleportation action.
    /// </summary>
    void handleXRTeleport(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Handle picking on trigger click.
    /// </summary>
    void handleXRPicking(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Perform dynamic highlighting for active hand.
    /// </summary>
    void handleXRHighlight(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Display auxiliary XR presentations.
    /// </summary>
    void handleXRPresentations(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView);
    /// <summary>
    /// Perform picking with/without dynamic highlighting for XR pose.
    /// </summary>
    int handleXRMoveTo(RDC::OCC::AIS_InteractiveContext^ theCtx, RDC::OCC::V3d_View^ theView, RDC::OCC::Trsf thePose, bool theToHighlight);
}; // class AIS_ViewController
...
public:
    ...
    /// Main constructor.
    /// </summary>
    AIS_ViewCubeOwner(RDC::OCC::AIS_ViewCube^ theObject, RDC::OCC::V3d_TypeOfOrientation theOrient, int thePriority);
    /// <summary>
    /// Main constructor.
    /// </summary>
    AIS_ViewCubeOwner(RDC::OCC::AIS_ViewCube^ theObject, RDC::OCC::V3d_TypeOfOrientation theOrient);
    /// <summary>
    /// </summary>
    /// <returns>
    ...
    /// </summary>
    RDC::OCC::V3d_TypeOfOrientation MainOrientation();
    /// <summary>
    /// Handle mouse button click event.
    /// </summary>
    bool HandleMouseClick(RDC::OCC::Graphic3d_Vec2i^ thePoint, unsigned int theButton, unsigned int theModifiers, bool theIsDoubleClick);
    static RDC::OCC::AIS_ViewCubeOwner^ CreateDowncasted(::AIS_ViewCubeOwner* instance);
}; // class AIS_ViewCubeOwner
...
public:
    ...
    /// </summary>
    static bool IsBoxSide(RDC::OCC::V3d_TypeOfOrientation theOrient);
    /// <summary>
    /// Return TRUE if specified orientation belongs to box edge.
    /// </summary>
    static bool IsBoxEdge(RDC::OCC::V3d_TypeOfOrientation theOrient);
    /// <summary>
    /// Return TRUE if specified orientation belongs to box corner (vertex).
    /// </summary>
    static bool IsBoxCorner(RDC::OCC::V3d_TypeOfOrientation theOrient);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Prs3d_ShadingAspect^ BoxSideStyle();
    /// <summary>
    /// Return shading style of box edges.
    /// </summary>
    RDC::OCC::Prs3d_ShadingAspect^ BoxEdgeStyle();
    /// <summary>
    /// Return shading style of box corners.
    /// </summary>
    RDC::OCC::Prs3d_ShadingAspect^ BoxCornerStyle();
    /// <summary>
    /// Return value of front color for the 3D part of object.
    /// </summary>
    RDC::OCC::Quantity_Color^ BoxColor();
    /// <summary>
    ...
    /// </param>
    void SetBoxColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Quantity_Color^ InnerColor();
    /// <summary>
    /// Set color of sides back material. Alias for:
    /// </summary>
    /// @code Attributes()->ShadingAspect()->Aspect()->ChangeBackMaterial().SetColor() @endcode
    void SetInnerColor(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Return box side label or empty string if undefined.
    /// Default labels: FRONT, BACK, LEFT, RIGHT, TOP, BOTTOM.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ BoxSideLabel(RDC::OCC::V3d_TypeOfOrientation theSide);
    /// <summary>
    /// Set box side label.
    /// </summary>
    void SetBoxSideLabel(RDC::OCC::V3d_TypeOfOrientation theSide, RDC::OCC::TCollection_AsciiString^ theLabel);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ AxisLabel(RDC::OCC::Prs3d_DatumParts theAxis);
    /// <summary>
    /// Set axes labels.
    /// </summary>
    void SetAxesLabels(RDC::OCC::TCollection_AsciiString^ theX, RDC::OCC::TCollection_AsciiString^ theY, RDC::OCC::TCollection_AsciiString^ theZ);
    /// <summary>
    ...
    /// [in] detected owner.
    /// </param>
    void StartAnimation(RDC::OCC::AIS_ViewCubeOwner^ theOwner);
    /// <summary>
    ...
    /// </summary>
    void HandleClick(RDC::OCC::AIS_ViewCubeOwner^ theOwner);
    /// <summary>
    /// Return TRUE for supported display mode.
    /// </summary>
    bool AcceptDisplayMode(int theMode);
    ...
    static RDC::OCC::AIS_ViewCube^ CreateDowncasted(::AIS_ViewCube* instance);
}; // class AIS_ViewCube
