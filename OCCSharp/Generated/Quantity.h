...
public ref class Quantity_Array1OfColor sealed
    : public RDC::OCC::BaseClass<::Quantity_Array1OfColor>
...
public:
    Quantity_Array1OfColor(::Quantity_Array1OfColor* nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Array1OfColor>( nativeInstance, true )
    {}

    Quantity_Array1OfColor(::Quantity_Array1OfColor& nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Array1OfColor>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Quantity_Array1OfColor::Iterator>
    {
    ...
    public:
        Iterator(::Quantity_Array1OfColor::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Quantity_Array1OfColor::Iterator>( nativeInstance, true )
        {}

        Iterator(::Quantity_Array1OfColor::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Quantity_Array1OfColor::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        void Init(RDC::OCC::Quantity_Array1OfColor^ theList);
        bool More();
        void Initialize(RDC::OCC::Quantity_Array1OfColor^ theList);
    ...
    Quantity_Array1OfColor(RDC::OCC::Quantity_Color^ theBegin, int theLower, int theUpper, bool theUseBuffer);
    Quantity_Array1OfColor(RDC::OCC::Quantity_Color^ theBegin, int theLower, int theUpper);
    void Init(RDC::OCC::Quantity_Color^ theValue);
    int Size();
    int Length();
    bool IsEmpty();
    int Lower();
    int Upper();
    RDC::OCC::Quantity_Array1OfColor^ Assign(RDC::OCC::Quantity_Array1OfColor^ theOther);
    RDC::OCC::Quantity_Array1OfColor^ Move(RDC::OCC::Quantity_Array1OfColor^ theOther);
...
public ref class Quantity_Color sealed
    : public RDC::OCC::BaseClass<::Quantity_Color>
{
...
public:
    Quantity_Color(::Quantity_Color* nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Color>( nativeInstance, true )
    {}

    Quantity_Color(::Quantity_Color& nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Color>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Quantity_Color(RDC::OCC::Quantity_NameOfColor theName);
    /// <summary>
    /// Creates a color according to the definition system theType.
    /// Throws exception if values are out of range.
    /// </summary>
    Quantity_Color(double theC1, double theC2, double theC3, RDC::OCC::Quantity_TypeOfColor theType);
    /// <summary>
    /// Define color from linear RGB values.
    /// </summary>
    Quantity_Color(RDC::OCC::gp_Vec3f^ theRgb);
    /// <summary>
    /// Returns the name of the nearest color from the Quantity_NameOfColor enumeration.
    /// </summary>
    RDC::OCC::Quantity_NameOfColor Name();
    /// <summary>
    /// Updates the color from specified named color.
    /// </summary>
    void SetValues(RDC::OCC::Quantity_NameOfColor theName);
    /// <summary>
    ...
    /// </summary>
    void Values(double% theC1, double% theC2, double% theC3, RDC::OCC::Quantity_TypeOfColor theType);
    /// <summary>
    /// Updates a color according to the mode specified by theType.
    /// Throws exception if values are out of range.
    /// </summary>
    void SetValues(double theC1, double theC2, double theC3, RDC::OCC::Quantity_TypeOfColor theType);
    /// <summary>
    ...
    /// </summary>
    void Delta(RDC::OCC::Quantity_Color^ theColor, double% DC, double% DI);
    /// <summary>
    ...
    /// </returns>
    static bool ColorFromName(System::String^ theColorNameString, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    /// </returns>
    static bool ColorFromHex(System::String^ theHexColorString, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Returns hex sRGB string in format "#FFAAFF".
    /// </summary>
    static RDC::OCC::TCollection_AsciiString^ ColorToHex(RDC::OCC::Quantity_Color^ theColor, bool theToPrefixHash);
    /// <summary>
    /// Returns hex sRGB string in format "#FFAAFF".
    /// </summary>
    static RDC::OCC::TCollection_AsciiString^ ColorToHex(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Converts sRGB components into HLS ones.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_sRGB_To_HLS(RDC::OCC::gp_Vec3f^ theRgb);
    /// <summary>
    /// Converts HLS components into RGB ones.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_HLS_To_sRGB(RDC::OCC::gp_Vec3f^ theHls);
    /// <summary>
    /// Converts Linear RGB components into HLS ones.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_LinearRGB_To_HLS(RDC::OCC::gp_Vec3f^ theRgb);
    /// <summary>
    /// Converts HLS components into linear RGB ones.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_HLS_To_LinearRGB(RDC::OCC::gp_Vec3f^ theHls);
    /// <summary>
    /// Converts linear RGB components into CIE Lab ones.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_LinearRGB_To_Lab(RDC::OCC::gp_Vec3f^ theRgb);
    /// <summary>
    /// Converts CIE Lab components into CIE Lch ones.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_Lab_To_Lch(RDC::OCC::gp_Vec3f^ theLab);
    /// <summary>
    /// Converts CIE Lab components into linear RGB ones.
    /// Note that the resulting values may be out of the valid range for RGB.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_Lab_To_LinearRGB(RDC::OCC::gp_Vec3f^ theLab);
    /// <summary>
    /// Converts CIE Lch components into CIE Lab ones.
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_Lch_To_Lab(RDC::OCC::gp_Vec3f^ theLch);
    /// <summary>
    ...
    /// </param>
    static void Color2argb(RDC::OCC::Quantity_Color^ theColor, int% theARGB);
    /// <summary>
    ...
    /// </summary>
    static void Argb2color(int theARGB, RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    ...
    static RDC::OCC::gp_Vec3f^ Convert_LinearRGB_To_sRGB(RDC::OCC::gp_Vec3f^ theRGB);
    static RDC::OCC::gp_Vec3f^ Convert_sRGB_To_LinearRGB(RDC::OCC::gp_Vec3f^ theRGB);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_LinearRGB_To_sRGB_approx22(RDC::OCC::gp_Vec3f^ theRGB);
    /// <summary>
    /// Convert sRGB components into linear RGB using approximated uniform gamma coefficient 2.2
    /// </summary>
    static RDC::OCC::gp_Vec3f^ Convert_sRGB_To_LinearRGB_approx22(RDC::OCC::gp_Vec3f^ theRGB);
    /// <summary>
...
public ref class Quantity_ColorRGBA sealed
    : public RDC::OCC::BaseClass<::Quantity_ColorRGBA>
{
...
public:
    Quantity_ColorRGBA(::Quantity_ColorRGBA* nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_ColorRGBA>( nativeInstance, true )
    {}

    Quantity_ColorRGBA(::Quantity_ColorRGBA& nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_ColorRGBA>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Quantity_ColorRGBA(RDC::OCC::Quantity_Color^ theRgb);
    /// <summary>
    /// Creates the color with specified RGBA values.
    /// </summary>
    Quantity_ColorRGBA(RDC::OCC::Quantity_Color^ theRgb, float theAlpha);
    /// <summary>
    /// Creates the color from RGBA vector.
    /// </summary>
    Quantity_ColorRGBA(RDC::OCC::Graphic3d_Vec4^ theRgba);
    /// <summary>
    ...
    /// </summary>
    bool IsDifferent(RDC::OCC::Quantity_ColorRGBA^ theOther);
    /// <summary>
    /// Two colors are considered to be equal if their distance is no greater than Epsilon().
    /// </summary>
    bool IsEqual(RDC::OCC::Quantity_ColorRGBA^ theOther);
    /// <summary>
    /// Finds color from predefined names.
    /// For example, the name of the color which corresponds to "BLACK" is Quantity_NOC_BLACK.
    ...
    /// false if the color name is unknown, or true if the search by color name was successful
    /// </returns>
    static bool ColorFromName(System::String^ theColorNameString, RDC::OCC::Quantity_ColorRGBA^ theColor);
    /// <summary>
    ...
    /// true if parsing was successful, or false otherwise
    /// </returns>
    static bool ColorFromHex(char theHexColorString, RDC::OCC::Quantity_ColorRGBA^ theColor, bool theAlphaComponentIsOff);
    /// <summary>
    /// Parses the string as a hex color (like "#FF0" for short sRGB color, "#FF0F" for short sRGBA color,
    /// "#FFFF00" for RGB color, or "#FFFF00FF" for RGBA color)
    /// </summary>
    ...
    /// true if parsing was successful, or false otherwise
    /// </returns>
    static bool ColorFromHex(char theHexColorString, RDC::OCC::Quantity_ColorRGBA^ theColor);
    /// <summary>
    /// Returns hex sRGBA string in format "#RRGGBBAA".
    /// </summary>
    static RDC::OCC::TCollection_AsciiString^ ColorToHex(RDC::OCC::Quantity_ColorRGBA^ theColor, bool theToPrefixHash);
    /// <summary>
    /// Returns hex sRGBA string in format "#RRGGBBAA".
    /// </summary>
    static RDC::OCC::TCollection_AsciiString^ ColorToHex(RDC::OCC::Quantity_ColorRGBA^ theColor);
    /// <summary>
    /// Convert linear RGB components into sRGB using OpenGL specs formula.
    /// </summary>
    static RDC::OCC::Graphic3d_Vec4^ Convert_LinearRGB_To_sRGB(RDC::OCC::Graphic3d_Vec4^ theRGB);
    /// <summary>
    /// Convert sRGB components into linear RGB using OpenGL specs formula.
    /// </summary>
    static RDC::OCC::Graphic3d_Vec4^ Convert_sRGB_To_LinearRGB(RDC::OCC::Graphic3d_Vec4^ theRGB);
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
...
public ref class Quantity_Period sealed
    : public RDC::OCC::BaseClass<::Quantity_Period>
{
...
public:
    Quantity_Period(::Quantity_Period* nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Period>( nativeInstance, true )
    {}

    Quantity_Period(::Quantity_Period& nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Period>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    RDC::OCC::Quantity_Period^ Subtract(RDC::OCC::Quantity_Period^ anOther);
    /// <summary>
    /// Adds one Period to another one.
    /// </summary>
    RDC::OCC::Quantity_Period^ Add(RDC::OCC::Quantity_Period^ anOther);
    /// <summary>
    /// Returns TRUE if both <me> and <other> are equal.
    /// </summary>
    bool IsEqual(RDC::OCC::Quantity_Period^ anOther);
    /// <summary>
    /// Returns TRUE if <me> is shorter than <other>.
    /// </summary>
    bool IsShorter(RDC::OCC::Quantity_Period^ anOther);
    /// <summary>
    /// Returns TRUE if <me> is longer then <other>.
    /// </summary>
    bool IsLonger(RDC::OCC::Quantity_Period^ anOther);
    /// <summary>
...
public ref class Quantity_Date sealed
    : public RDC::OCC::BaseClass<::Quantity_Date>
{
...
public:
    Quantity_Date(::Quantity_Date* nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Date>( nativeInstance, true )
    {}

    Quantity_Date(::Quantity_Date& nativeInstance)
        : RDC::OCC::BaseClass<::Quantity_Date>( &nativeInstance, false )
    {}
...
public:
    ...
    /// of two dates.
    /// </summary>
    RDC::OCC::Quantity_Period^ Difference(RDC::OCC::Quantity_Date^ anOther);
    /// <summary>
    /// Subtracts a period from a Date and returns the new Date.
    /// Raises an exception if the result date is anterior to
    /// Jan 1, 1979.
    /// </summary>
    RDC::OCC::Quantity_Date^ Subtract(RDC::OCC::Quantity_Period^ aPeriod);
    /// <summary>
    /// Adds a Period to a Date and returns the new Date.
    /// </summary>
    RDC::OCC::Quantity_Date^ Add(RDC::OCC::Quantity_Period^ aPeriod);
    /// <summary>
    ...
    /// </summary>
    bool IsEqual(RDC::OCC::Quantity_Date^ anOther);
    /// <summary>
    /// Returns TRUE if <me> is earlier than <other>.
    /// </summary>
    bool IsEarlier(RDC::OCC::Quantity_Date^ anOther);
    /// <summary>
    /// Returns TRUE if <me> is later then <other>.
    /// </summary>
    bool IsLater(RDC::OCC::Quantity_Date^ anOther);
    /// <summary>
...
public:
    ...
    static RDC::OCC::Quantity_DateDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Quantity_DateDefinitionError^ NewInstance();
    static RDC::OCC::Quantity_DateDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Quantity_DateDefinitionError^ CreateDowncasted(::Quantity_DateDefinitionError* instance);
}; // class Quantity_DateDefinitionError
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Quantity_HArray1OfColor::Iterator>
    {
    ...
    public:
        Iterator(::Quantity_HArray1OfColor::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Quantity_HArray1OfColor::Iterator>( nativeInstance, true )
        {}

        Iterator(::Quantity_HArray1OfColor::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Quantity_HArray1OfColor::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        void Init(RDC::OCC::Quantity_HArray1OfColor^ theList);
        bool More();
        void Initialize(RDC::OCC::Quantity_HArray1OfColor^ theList);
        /* Method skipped due to unknown mapping: iterator ValueIter() */
        /* Method skipped due to unknown mapping: iterator ChangeValueIter() */
        /* Method skipped due to unknown mapping: iterator EndIter() */
        /* Method skipped due to unknown mapping: iterator ChangeEndIter() */
    ...
    Quantity_HArray1OfColor(int theLower, int theUpper, RDC::OCC::Quantity_Color^ theValue);
    Quantity_HArray1OfColor(RDC::OCC::Quantity_Color^ theBegin, int theLower, int theUpper, bool parameter1);
    Quantity_HArray1OfColor(RDC::OCC::Quantity_Array1OfColor^ theOther);
    RDC::OCC::Quantity_Array1OfColor^ Array1();
    RDC::OCC::Quantity_Array1OfColor^ ChangeArray1();
    void Init(RDC::OCC::Quantity_Color^ theValue);
    int Size();
    int Length();
    bool IsEmpty();
    int Lower();
    int Upper();
    RDC::OCC::Quantity_HArray1OfColor^ Assign(RDC::OCC::Quantity_HArray1OfColor^ theOther);
    RDC::OCC::Quantity_HArray1OfColor^ Move(RDC::OCC::Quantity_HArray1OfColor^ theOther);
    RDC::OCC::Quantity_Color^ First();
    RDC::OCC::Quantity_Color^ ChangeFirst();
    RDC::OCC::Quantity_Color^ Last();
    RDC::OCC::Quantity_Color^ ChangeLast();
    ...
    void Resize(int theLower, int theUpper, bool theToCopyData);
    bool IsDeletable();
    static RDC::OCC::Quantity_HArray1OfColor^ CreateDowncasted(::Quantity_HArray1OfColor* instance);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::Quantity_Color^>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class Quantity_HArray1OfColor
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Quantity_PeriodDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Quantity_PeriodDefinitionError^ NewInstance();
    static RDC::OCC::Quantity_PeriodDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Quantity_PeriodDefinitionError^ CreateDowncasted(::Quantity_PeriodDefinitionError* instance);
}; // class Quantity_PeriodDefinitionError
