...
public ref class TopExp sealed
    : public RDC::OCC::BaseClass<::TopExp>
{
...
public:
    TopExp(::TopExp* nativeInstance)
        : RDC::OCC::BaseClass<::TopExp>( nativeInstance, true )
    {}

    TopExp(::TopExp& nativeInstance)
        : RDC::OCC::BaseClass<::TopExp>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void MapShapes(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum T, RDC::OCC::TopTools_IndexedMapOfShape^ M);
    /// <summary>
    /// Stores in the map <M> all  the sub-shapes of <S>.
    ...
    /// </summary>
    static void MapShapes(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_IndexedMapOfShape^ M, bool cumOri, bool cumLoc);
    /// <summary>
    /// Stores in the map <M> all  the sub-shapes of <S>.
    /// - If cumOri is true, the function composes all
    /// sub-shapes with the orientation of S.
    ...
    /// each sub-shape the transformation that is associated with S.
    /// </summary>
    static void MapShapes(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_IndexedMapOfShape^ M, bool cumOri);
    /// <summary>
    /// Stores in the map <M> all  the sub-shapes of <S>.
    /// - If cumOri is true, the function composes all
    /// sub-shapes with the orientation of S.
    ...
    /// each sub-shape the transformation that is associated with S.
    /// </summary>
    static void MapShapes(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_IndexedMapOfShape^ M);
    /// <summary>
    /// Stores in the map <M> all  the sub-shapes of <S>.
    /// - If cumOri is true, the function composes all
    /// sub-shapes with the orientation of S.
    ...
    /// each sub-shape the transformation that is associated with S.
    /// </summary>
    static void MapShapes(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_MapOfShape^ M, bool cumOri, bool cumLoc);
    /// <summary>
    /// Stores in the map <M> all  the sub-shapes of <S>.
    /// - If cumOri is true, the function composes all
    /// sub-shapes with the orientation of S.
    ...
    /// each sub-shape the transformation that is associated with S.
    /// </summary>
    static void MapShapes(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_MapOfShape^ M, bool cumOri);
    /// <summary>
    /// Stores in the map <M> all  the sub-shapes of <S>.
    /// - If cumOri is true, the function composes all
    /// sub-shapes with the orientation of S.
    ...
    /// each sub-shape the transformation that is associated with S.
    /// </summary>
    static void MapShapes(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_MapOfShape^ M);
    /// <summary>
    ...
    /// Warning: The map is not cleared at first.
    /// </summary>
    static void MapShapesAndAncestors(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum TS, RDC::OCC::TopAbs_ShapeEnum TA, RDC::OCC::TopTools_IndexedDataMapOfShapeListOfShape^ M);
    /// <summary>
    /// Stores in the map <M> all the subshape of <S> of
    /// type <TS> for each one append to the list all
    ...
    /// Warning: The map is not cleared at first.
    /// </summary>
    static void MapShapesAndUniqueAncestors(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum TS, RDC::OCC::TopAbs_ShapeEnum TA, RDC::OCC::TopTools_IndexedDataMapOfShapeListOfShape^ M, bool useOrientation);
    /// <summary>
    /// Stores in the map <M> all the subshape of <S> of
    /// type <TS> for each one append to the list all
    /// unique ancestors of type <TA>.  For example map all
    ...
    /// Warning: The map is not cleared at first.
    /// </summary>
    static void MapShapesAndUniqueAncestors(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum TS, RDC::OCC::TopAbs_ShapeEnum TA, RDC::OCC::TopTools_IndexedDataMapOfShapeListOfShape^ M);
    /// <summary>
    /// Returns the Vertex of orientation FORWARD in E. If
    /// there is none returns a Null Shape.
    /// CumOri = True : taking account the edge orientation
    /// </summary>
    static RDC::OCC::TopoDS_Vertex^ FirstVertex(RDC::OCC::TopoDS_Edge^ E, bool CumOri);
    /// <summary>
    /// Returns the Vertex of orientation FORWARD in E. If
    /// there is none returns a Null Shape.
    /// CumOri = True : taking account the edge orientation
    /// </summary>
    static RDC::OCC::TopoDS_Vertex^ FirstVertex(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// Returns the Vertex of orientation REVERSED in E. If
    /// there is none returns a Null Shape.
    /// CumOri = True : taking account the edge orientation
    /// </summary>
    static RDC::OCC::TopoDS_Vertex^ LastVertex(RDC::OCC::TopoDS_Edge^ E, bool CumOri);
    /// <summary>
    /// Returns the Vertex of orientation REVERSED in E. If
    /// there is none returns a Null Shape.
    /// CumOri = True : taking account the edge orientation
    /// </summary>
    static RDC::OCC::TopoDS_Vertex^ LastVertex(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// Returns in Vfirst, Vlast the  FORWARD and REVERSED
    /// vertices of the edge <E>. May be null shapes.
    /// CumOri = True : taking account the edge orientation
    /// </summary>
    static void Vertices(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Vertex^ Vfirst, RDC::OCC::TopoDS_Vertex^ Vlast, bool CumOri);
    /// <summary>
    /// Returns in Vfirst, Vlast the  FORWARD and REVERSED
    /// vertices of the edge <E>. May be null shapes.
    /// CumOri = True : taking account the edge orientation
    /// </summary>
    static void Vertices(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Vertex^ Vfirst, RDC::OCC::TopoDS_Vertex^ Vlast);
    /// <summary>
    ...
    /// shapes.
    /// </summary>
    static void Vertices(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Vertex^ Vfirst, RDC::OCC::TopoDS_Vertex^ Vlast);
    /// <summary>
    ...
    /// </summary>
    static bool CommonVertex(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, RDC::OCC::TopoDS_Vertex^ V);
}; // class TopExp
...
public ref class TopExp_Explorer sealed
    : public RDC::OCC::BaseClass<::TopExp_Explorer>
{
...
public:
    TopExp_Explorer(::TopExp_Explorer* nativeInstance)
        : RDC::OCC::BaseClass<::TopExp_Explorer>( nativeInstance, true )
    {}

    TopExp_Explorer(::TopExp_Explorer& nativeInstance)
        : RDC::OCC::BaseClass<::TopExp_Explorer>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    TopExp_Explorer(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum ToFind, RDC::OCC::TopAbs_ShapeEnum ToAvoid);
    /// <summary>
    /// Creates an Explorer on the Shape <S>.
    /// 
    /// <ToFind> is the type of shapes to search.
    ...
    /// has no effect on the exploration.
    /// </summary>
    TopExp_Explorer(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum ToFind);
    /// <summary>
    ...
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum ToFind, RDC::OCC::TopAbs_ShapeEnum ToAvoid);
    /// <summary>
    /// Resets this explorer on the shape S. It is initialized to
    /// search the shape S, for shapes of type ToFind, that
    /// are not part of a shape ToAvoid.
    ...
    /// ToFind it has no effect on the search.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopAbs_ShapeEnum ToFind);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ ExploredShape();
    /// <summary>
