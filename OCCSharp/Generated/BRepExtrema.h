...
public ref class BRepExtrema_SeqOfSolution sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_SeqOfSolution>
    , public IIndexEnumerable<RDC::OCC::BRepExtrema_SolutionElem^>
{
...
public:
    BRepExtrema_SeqOfSolution(::BRepExtrema_SeqOfSolution* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_SeqOfSolution>( nativeInstance, true )
    {}

    BRepExtrema_SeqOfSolution(::BRepExtrema_SeqOfSolution& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_SeqOfSolution>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::BRepExtrema_SeqOfSolution::Iterator>
    {
    ...
    public:
        Iterator(::BRepExtrema_SeqOfSolution::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::BRepExtrema_SeqOfSolution::Iterator>( nativeInstance, true )
        {}

        Iterator(::BRepExtrema_SeqOfSolution::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::BRepExtrema_SeqOfSolution::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::BRepExtrema_SolutionElem^ Value();
        RDC::OCC::BRepExtrema_SolutionElem^ ChangeValue();
        bool IsEqual(RDC::OCC::BRepExtrema_SeqOfSolution::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    BRepExtrema_SeqOfSolution();
    BRepExtrema_SeqOfSolution(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::BRepExtrema_SeqOfSolution^ Assign(RDC::OCC::BRepExtrema_SeqOfSolution^ theOther);
    void Remove(RDC::OCC::BRepExtrema_SeqOfSolution::Iterator^ thePosition);
    void Append(RDC::OCC::BRepExtrema_SolutionElem^ theItem);
    void Prepend(RDC::OCC::BRepExtrema_SolutionElem^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::BRepExtrema_SolutionElem^ theItem);
    void InsertAfter(RDC::OCC::BRepExtrema_SeqOfSolution::Iterator^ thePosition, RDC::OCC::BRepExtrema_SolutionElem^ theItem);
    void Split(int theIndex, RDC::OCC::BRepExtrema_SeqOfSolution^ theSeq);
    RDC::OCC::BRepExtrema_SolutionElem^ First();
    RDC::OCC::BRepExtrema_SolutionElem^ ChangeFirst();
    RDC::OCC::BRepExtrema_SolutionElem^ Last();
    RDC::OCC::BRepExtrema_SolutionElem^ ChangeLast();
    virtual RDC::OCC::BRepExtrema_SolutionElem^ Value(int theIndex);
    RDC::OCC::BRepExtrema_SolutionElem^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::BRepExtrema_SolutionElem^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::BRepExtrema_SolutionElem^>^ GetEnumerator();
...
public ref class BRepExtrema_MapOfIntegerPackedMapOfInteger sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_MapOfIntegerPackedMapOfInteger>
{
...
public:
    BRepExtrema_MapOfIntegerPackedMapOfInteger(::BRepExtrema_MapOfIntegerPackedMapOfInteger* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_MapOfIntegerPackedMapOfInteger>( nativeInstance, true )
    {}

    BRepExtrema_MapOfIntegerPackedMapOfInteger(::BRepExtrema_MapOfIntegerPackedMapOfInteger& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_MapOfIntegerPackedMapOfInteger>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::BRepExtrema_MapOfIntegerPackedMapOfInteger::Iterator>
    {
    ...
    public:
        Iterator(::BRepExtrema_MapOfIntegerPackedMapOfInteger::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::BRepExtrema_MapOfIntegerPackedMapOfInteger::Iterator>( nativeInstance, true )
        {}

        Iterator(::BRepExtrema_MapOfIntegerPackedMapOfInteger::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::BRepExtrema_MapOfIntegerPackedMapOfInteger::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::TColStd_PackedMapOfInteger^ Value();
        RDC::OCC::TColStd_PackedMapOfInteger^ ChangeValue();
        int Key();
    }; // class Iterator

    BRepExtrema_MapOfIntegerPackedMapOfInteger();
    BRepExtrema_MapOfIntegerPackedMapOfInteger(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    BRepExtrema_MapOfIntegerPackedMapOfInteger(int theNbBuckets);
    void Exchange(RDC::OCC::BRepExtrema_MapOfIntegerPackedMapOfInteger^ theOther);
    RDC::OCC::BRepExtrema_MapOfIntegerPackedMapOfInteger^ Assign(RDC::OCC::BRepExtrema_MapOfIntegerPackedMapOfInteger^ theOther);
    void ReSize(int N);
    bool Bind(int theKey, RDC::OCC::TColStd_PackedMapOfInteger^ theItem);
    RDC::OCC::TColStd_PackedMapOfInteger^ Bound(int theKey, RDC::OCC::TColStd_PackedMapOfInteger^ theItem);
    bool IsBound(int theKey);
    bool UnBind(int theKey);
    RDC::OCC::TColStd_PackedMapOfInteger^ Seek(int theKey);
    RDC::OCC::TColStd_PackedMapOfInteger^ Find(int theKey);
    RDC::OCC::TColStd_PackedMapOfInteger^ ChangeSeek(int theKey);
    RDC::OCC::TColStd_PackedMapOfInteger^ ChangeFind(int theKey);
...
public ref class BRepExtrema_ShapeList sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ShapeList>
...
public:
    BRepExtrema_ShapeList(::BRepExtrema_ShapeList* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ShapeList>( nativeInstance, true )
    {}

    BRepExtrema_ShapeList(::BRepExtrema_ShapeList& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ShapeList>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::BRepExtrema_ShapeList::Iterator>
    {
    ...
    public:
        Iterator(::BRepExtrema_ShapeList::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::BRepExtrema_ShapeList::Iterator>( nativeInstance, true )
        {}

        Iterator(::BRepExtrema_ShapeList::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::BRepExtrema_ShapeList::Iterator>( &nativeInstance, false )
        {}
    ...
    BRepExtrema_ShapeList(int theIncrement, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    ...
    int Upper();
    bool IsEmpty();
    RDC::OCC::BRepExtrema_ShapeList^ Assign(RDC::OCC::BRepExtrema_ShapeList^ theOther, bool theOwnAllocator);
    RDC::OCC::BRepExtrema_ShapeList^ Assign(RDC::OCC::BRepExtrema_ShapeList^ theOther);
    RDC::OCC::TopoDS_Shape^ Append(RDC::OCC::TopoDS_Shape^ theValue);
    void EraseLast();
    RDC::OCC::TopoDS_Shape^ Appended();
    ...
    RDC::OCC::TopoDS_Shape^ SetValue(int theIndex, RDC::OCC::TopoDS_Shape^ theValue);
...
public ref class BRepExtrema_ElementFilter sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ElementFilter>
{
...
public:
    BRepExtrema_ElementFilter(::BRepExtrema_ElementFilter* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ElementFilter>( nativeInstance, true )
    {}

    BRepExtrema_ElementFilter(::BRepExtrema_ElementFilter& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ElementFilter>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    RDC::OCC::BRepExtrema_ElementFilter::FilterResult PreCheckElements(int parameter1, int parameter2);
}; // class BRepExtrema_ElementFilter
...
public ref class BRepExtrema_SolutionElem sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_SolutionElem>
{
...
public:
    BRepExtrema_SolutionElem(::BRepExtrema_SolutionElem* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_SolutionElem>( nativeInstance, true )
    {}

    BRepExtrema_SolutionElem(::BRepExtrema_SolutionElem& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_SolutionElem>( &nativeInstance, false )
    {}
...
public:
    ...
    ///  and the Vertex
    /// </param>
    BRepExtrema_SolutionElem(double theDist, RDC::OCC::Pnt thePoint, RDC::OCC::BRepExtrema_SupportType theSolType, RDC::OCC::TopoDS_Vertex^ theVertex);
    /// <summary>
    ...
    /// </param>
    BRepExtrema_SolutionElem(double theDist, RDC::OCC::Pnt thePoint, RDC::OCC::BRepExtrema_SupportType theSolType, RDC::OCC::TopoDS_Edge^ theEdge, double theParam);
    /// <summary>
    ...
    /// </param>
    BRepExtrema_SolutionElem(double theDist, RDC::OCC::Pnt thePoint, RDC::OCC::BRepExtrema_SupportType theSolType, RDC::OCC::TopoDS_Face^ theFace, double theU, double theV);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::BRepExtrema_SupportType SupportKind();
    /// <summary>
...
public ref class BRepExtrema_DistanceSS sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_DistanceSS>
{
...
public:
    BRepExtrema_DistanceSS(::BRepExtrema_DistanceSS* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_DistanceSS>( nativeInstance, true )
    {}

    BRepExtrema_DistanceSS(::BRepExtrema_DistanceSS& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_DistanceSS>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </param>
    BRepExtrema_DistanceSS(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::Bnd_Box^ theBox1, RDC::OCC::Bnd_Box^ theBox2, double theDstRef, double theDeflection, RDC::OCC::Extrema_ExtFlag theExtFlag, RDC::OCC::Extrema_ExtAlgo theExtAlgo);
    /// <summary>
    /// Computes the distance between two Shapes (face edge vertex).
    /// </summary>
    /// <param name="theS1">
    ...
    /// (default is Grad algo, applied only to point-face extrema)
    /// </param>
    BRepExtrema_DistanceSS(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::Bnd_Box^ theBox1, RDC::OCC::Bnd_Box^ theBox2, double theDstRef, double theDeflection, RDC::OCC::Extrema_ExtFlag theExtFlag);
    /// <summary>
    /// Computes the distance between two Shapes (face edge vertex).
    /// </summary>
    /// <param name="theS1">
    ...
    /// (default is Grad algo, applied only to point-face extrema)
    /// </param>
    BRepExtrema_DistanceSS(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::Bnd_Box^ theBox1, RDC::OCC::Bnd_Box^ theBox2, double theDstRef, double theDeflection);
    /// <summary>
    /// Computes the distance between two Shapes (face edge vertex).
    /// </summary>
    /// <param name="theS1">
    ...
    /// (default is Grad algo, applied only to point-face extrema)
    /// </param>
    BRepExtrema_DistanceSS(RDC::OCC::TopoDS_Shape^ theS1, RDC::OCC::TopoDS_Shape^ theS2, RDC::OCC::Bnd_Box^ theBox1, RDC::OCC::Bnd_Box^ theBox2, double theDstRef);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::BRepExtrema_SeqOfSolution^ Seq1Value();
    /// <summary>
    /// Returns the list of solutions on the second shape.
    /// </summary>
    RDC::OCC::BRepExtrema_SeqOfSolution^ Seq2Value();
}; // class BRepExtrema_DistanceSS
...
public ref class BRepExtrema_DistShapeShape sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_DistShapeShape>
{
...
public:
    BRepExtrema_DistShapeShape(::BRepExtrema_DistShapeShape* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_DistShapeShape>( nativeInstance, true )
    {}

    BRepExtrema_DistShapeShape(::BRepExtrema_DistShapeShape& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_DistShapeShape>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2, RDC::OCC::Extrema_ExtFlag F, RDC::OCC::Extrema_ExtAlgo A, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// create tool and computation of the minimum distance (value and pair of points)
    /// using default deflection in single thread mode. <br>
    /// Default deflection value is Precision::Confusion(). <br>
    ...
    /// - the progress indicator of algorithm
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2, RDC::OCC::Extrema_ExtFlag F, RDC::OCC::Extrema_ExtAlgo A);
    /// <summary>
    /// create tool and computation of the minimum distance (value and pair of points)
    /// using default deflection in single thread mode. <br>
    /// Default deflection value is Precision::Confusion(). <br>
    ...
    /// - the progress indicator of algorithm
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2, RDC::OCC::Extrema_ExtFlag F);
    /// <summary>
    /// create tool and computation of the minimum distance (value and pair of points)
    /// using default deflection in single thread mode. <br>
    /// Default deflection value is Precision::Confusion(). <br>
    ...
    /// - the progress indicator of algorithm
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2);
    /// <summary>
    ...
    /// - the progress indicator of algorithm
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2, double theDeflection, RDC::OCC::Extrema_ExtFlag F, RDC::OCC::Extrema_ExtAlgo A, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// create tool and computation of the minimum distance
    /// (value and pair of points) in single thread mode. <br>
    /// Default deflection value is Precision::Confusion(). <br>
    ...
    /// - the progress indicator of algorithm
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2, double theDeflection, RDC::OCC::Extrema_ExtFlag F, RDC::OCC::Extrema_ExtAlgo A);
    /// <summary>
    /// create tool and computation of the minimum distance
    /// (value and pair of points) in single thread mode. <br>
    /// Default deflection value is Precision::Confusion(). <br>
    ...
    /// - the progress indicator of algorithm
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2, double theDeflection, RDC::OCC::Extrema_ExtFlag F);
    /// <summary>
    /// create tool and computation of the minimum distance
    /// (value and pair of points) in single thread mode. <br>
    /// Default deflection value is Precision::Confusion(). <br>
    ...
    /// - the progress indicator of algorithm
    /// </param>
    BRepExtrema_DistShapeShape(RDC::OCC::TopoDS_Shape^ Shape1, RDC::OCC::TopoDS_Shape^ Shape2, double theDeflection);
    /// <summary>
    ...
    /// </summary>
    void LoadS1(RDC::OCC::TopoDS_Shape^ Shape1);
    /// <summary>
    /// load second shape into extrema <br>
    /// </summary>
    void LoadS2(RDC::OCC::TopoDS_Shape^ Shape1);
    /// <summary>
    ...
    /// </summary>
    bool Perform(RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// computation of  the minimum  distance  (value  and <br>
    /// couple  of points). Parameter theDeflection is used <br>
    /// to specify a maximum deviation of extreme distances <br>
    ...
    /// </summary>
    RDC::OCC::BRepExtrema_SupportType SupportTypeShape1(int N);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::BRepExtrema_SupportType SupportTypeShape2(int N);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TopoDS_Shape^ SupportOnShape1(int N);
    /// <summary>
    /// gives the support where the Nth solution on the second shape is situated. <br>
    /// This support can be a Vertex, an Edge or a Face. <br>
    /// </summary>
    RDC::OCC::TopoDS_Shape^ SupportOnShape2(int N);
    /// <summary>
    ...
    /// Obsolete
    /// </summary>
    void SetFlag(RDC::OCC::Extrema_ExtFlag F);
    /// <summary>
    /// Sets unused parameter
    /// Obsolete
    /// </summary>
    void SetAlgo(RDC::OCC::Extrema_ExtAlgo A);
    /// <summary>
...
public ref class BRepExtrema_ExtCC sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ExtCC>
{
...
public:
    BRepExtrema_ExtCC(::BRepExtrema_ExtCC* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtCC>( nativeInstance, true )
    {}

    BRepExtrema_ExtCC(::BRepExtrema_ExtCC& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtCC>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    BRepExtrema_ExtCC(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
    void Initialize(RDC::OCC::TopoDS_Edge^ E2);
    /// <summary>
    /// An exception is raised if the fields have not been initialized. <br>
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Edge^ E1);
    /// <summary>
    ...
    /// </summary>
    void TrimmedSquareDistances(double% dist11, double% distP12, double% distP21, double% distP22, RDC::OCC::Pnt% P11, RDC::OCC::Pnt% P12, RDC::OCC::Pnt% P21, RDC::OCC::Pnt% P22);
}; // class BRepExtrema_ExtCC
...
public ref class BRepExtrema_ExtCF sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ExtCF>
{
...
public:
    BRepExtrema_ExtCF(::BRepExtrema_ExtCF* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtCF>( nativeInstance, true )
    {}

    BRepExtrema_ExtCF(::BRepExtrema_ExtCF& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtCF>( &nativeInstance, false )
    {}
...
public:
    ...
    /// It calculates all the distances. <br>
    /// </summary>
    BRepExtrema_ExtCF(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    ...
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
    /// <summary>
    /// True if the distances are found. <br>
    /// </summary>
    bool IsDone();
    ...
    /// </summary>
    RDC::OCC::Pnt PointOnEdge(int N);
    /// <summary>
    /// Returns the Point of the <N>th extremum distance. <br>
    /// </summary>
    RDC::OCC::Pnt PointOnFace(int N);
}; // class BRepExtrema_ExtCF
...
public ref class BRepExtrema_ExtFF sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ExtFF>
{
...
public:
    BRepExtrema_ExtFF(::BRepExtrema_ExtFF* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtFF>( nativeInstance, true )
    {}

    BRepExtrema_ExtFF(::BRepExtrema_ExtFF& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtFF>( &nativeInstance, false )
    {}
...
public:
    ...
    /// It calculates all the distances. <br>
    /// </summary>
    BRepExtrema_ExtFF(RDC::OCC::TopoDS_Face^ F1, RDC::OCC::TopoDS_Face^ F2);
    void Initialize(RDC::OCC::TopoDS_Face^ F2);
    /// <summary>
    /// An exception is raised if the fields have not been initialized. <br>
    /// Be careful: this method uses the Face F2 only for classify, not for the fields. <br>
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Face^ F1, RDC::OCC::TopoDS_Face^ F2);
    /// <summary>
    /// True if the distances are found. <br>
    /// </summary>
    bool IsDone();
    ...
    /// Returns the Point of the <N>th extremum distance. <br>
    /// </summary>
    RDC::OCC::Pnt PointOnFace1(int N);
    /// <summary>
    /// Returns the Point of the <N>th extremum distance. <br>
    /// </summary>
    RDC::OCC::Pnt PointOnFace2(int N);
}; // class BRepExtrema_ExtFF
...
public ref class BRepExtrema_ExtPC sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ExtPC>
{
...
public:
    BRepExtrema_ExtPC(::BRepExtrema_ExtPC* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtPC>( nativeInstance, true )
    {}

    BRepExtrema_ExtPC(::BRepExtrema_ExtPC& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtPC>( &nativeInstance, false )
    {}
...
public:
    ...
    /// It calculates all the distances. <br>
    /// </summary>
    BRepExtrema_ExtPC(RDC::OCC::TopoDS_Vertex^ V, RDC::OCC::TopoDS_Edge^ E);
    void Initialize(RDC::OCC::TopoDS_Edge^ E);
    /// <summary>
    /// An exception is raised if the fields have not been initialized. <br>
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Vertex^ V);
    /// <summary>
    /// True if the distances are found. <br>
    /// </summary>
    bool IsDone();
    ...
    /// </summary>
    void TrimmedSquareDistances(double% dist1, double% dist2, RDC::OCC::Pnt% pnt1, RDC::OCC::Pnt% pnt2);
}; // class BRepExtrema_ExtPC
...
public ref class BRepExtrema_ExtPF sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ExtPF>
{
...
public:
    BRepExtrema_ExtPF(::BRepExtrema_ExtPF* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtPF>( nativeInstance, true )
    {}

    BRepExtrema_ExtPF(::BRepExtrema_ExtPF& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ExtPF>( &nativeInstance, false )
    {}
...
public:
    ...
    /// It calculates all the distances. <br>
    /// </summary>
    BRepExtrema_ExtPF(RDC::OCC::TopoDS_Vertex^ TheVertex, RDC::OCC::TopoDS_Face^ TheFace, RDC::OCC::Extrema_ExtFlag TheFlag, RDC::OCC::Extrema_ExtAlgo TheAlgo);
    /// <summary>
    /// It calculates all the distances. <br>
    /// </summary>
    BRepExtrema_ExtPF(RDC::OCC::TopoDS_Vertex^ TheVertex, RDC::OCC::TopoDS_Face^ TheFace, RDC::OCC::Extrema_ExtFlag TheFlag);
    /// <summary>
    /// It calculates all the distances. <br>
    /// </summary>
    BRepExtrema_ExtPF(RDC::OCC::TopoDS_Vertex^ TheVertex, RDC::OCC::TopoDS_Face^ TheFace);
    void Initialize(RDC::OCC::TopoDS_Face^ TheFace, RDC::OCC::Extrema_ExtFlag TheFlag, RDC::OCC::Extrema_ExtAlgo TheAlgo);
    void Initialize(RDC::OCC::TopoDS_Face^ TheFace, RDC::OCC::Extrema_ExtFlag TheFlag);
    void Initialize(RDC::OCC::TopoDS_Face^ TheFace);
    /// <summary>
    /// An exception is raised if the fields have not been initialized. <br>
    /// Be careful: this method uses the Face only for classify not for the fields. <br>
    /// </summary>
    void Perform(RDC::OCC::TopoDS_Vertex^ TheVertex, RDC::OCC::TopoDS_Face^ TheFace);
    /// <summary>
    /// True if the distances are found. <br>
    /// </summary>
    bool IsDone();
...
public ref class BRepExtrema_Poly sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_Poly>
{
...
public:
    BRepExtrema_Poly(::BRepExtrema_Poly* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_Poly>( nativeInstance, true )
    {}

    BRepExtrema_Poly(::BRepExtrema_Poly& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_Poly>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static bool Distance(RDC::OCC::TopoDS_Shape^ S1, RDC::OCC::TopoDS_Shape^ S2, RDC::OCC::Pnt% P1, RDC::OCC::Pnt% P2, double% dist);
}; // class BRepExtrema_Poly
...
public ref class BRepExtrema_VertexInspector sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_VertexInspector>
{
...
public:
    BRepExtrema_VertexInspector(::BRepExtrema_VertexInspector* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_VertexInspector>( nativeInstance, true )
    {}

    BRepExtrema_VertexInspector(::BRepExtrema_VertexInspector& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_VertexInspector>( &nativeInstance, false )
    {}
...
public ref class BRepExtrema_ProximityValueTool sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ProximityValueTool>
{
...
public:
    BRepExtrema_ProximityValueTool(::BRepExtrema_ProximityValueTool* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ProximityValueTool>( nativeInstance, true )
    {}

    BRepExtrema_ProximityValueTool(::BRepExtrema_ProximityValueTool& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ProximityValueTool>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void LoadShapeLists(RDC::OCC::BRepExtrema_ShapeList^ theShapeList1, RDC::OCC::BRepExtrema_ShapeList^ theShapeList2);
    /// <summary>
    ...
    /// </summary>
    void ProximityPoints(RDC::OCC::Pnt% thePoint1, RDC::OCC::Pnt% thePoint2);
...
public ref class BRepExtrema_SelfIntersection sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_SelfIntersection>
{
...
public:
    BRepExtrema_SelfIntersection(::BRepExtrema_SelfIntersection* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_SelfIntersection>( nativeInstance, true )
    {}

    BRepExtrema_SelfIntersection(::BRepExtrema_SelfIntersection& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_SelfIntersection>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    BRepExtrema_SelfIntersection(RDC::OCC::TopoDS_Shape^ theShape, double theTolerance);
    /// <summary>
    /// Creates self-intersection tool for the given shape.
    /// </summary>
    BRepExtrema_SelfIntersection(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    ...
    /// </summary>
    bool LoadShape(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::BRepExtrema_MapOfIntegerPackedMapOfInteger^ OverlapElements();
    /// <summary>
    /// Returns sub-shape from the shape for the given index (started from 0).
    /// </summary>
    RDC::OCC::TopoDS_Face^ GetSubShape(int theID);
...
public ref class BRepExtrema_ShapeProximity sealed
    : public RDC::OCC::BaseClass<::BRepExtrema_ShapeProximity>
{
...
public:
    BRepExtrema_ShapeProximity(::BRepExtrema_ShapeProximity* nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ShapeProximity>( nativeInstance, true )
    {}

    BRepExtrema_ShapeProximity(::BRepExtrema_ShapeProximity& nativeInstance)
        : RDC::OCC::BaseClass<::BRepExtrema_ShapeProximity>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    BRepExtrema_ShapeProximity(RDC::OCC::TopoDS_Shape^ theShape1, RDC::OCC::TopoDS_Shape^ theShape2, double theTolerance);
    /// <summary>
    /// Creates proximity tool for the given two shapes.
    /// </summary>
    BRepExtrema_ShapeProximity(RDC::OCC::TopoDS_Shape^ theShape1, RDC::OCC::TopoDS_Shape^ theShape2);
    /// <summary>
    ...
    /// </summary>
    bool LoadShape1(RDC::OCC::TopoDS_Shape^ theShape1);
    /// <summary>
    /// Loads 2nd shape into proximity tool.
    /// </summary>
    bool LoadShape2(RDC::OCC::TopoDS_Shape^ theShape2);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::BRepExtrema_MapOfIntegerPackedMapOfInteger^ OverlapSubShapes1();
    /// <summary>
    /// Returns set of IDs of overlapped faces of 2nd shape (started from 0).
    /// </summary>
    RDC::OCC::BRepExtrema_MapOfIntegerPackedMapOfInteger^ OverlapSubShapes2();
    /// <summary>
    /// Returns sub-shape from 1st shape with the given index (started from 0).
    /// </summary>
    RDC::OCC::TopoDS_Shape^ GetSubShape1(int theID);
    /// <summary>
    /// Returns sub-shape from 1st shape with the given index (started from 0).
    /// </summary>
    RDC::OCC::TopoDS_Shape^ GetSubShape2(int theID);
...
public:
    ...
    static RDC::OCC::BRepExtrema_UnCompatibleShape^ NewInstance(System::String^ theMessage);
    static RDC::OCC::BRepExtrema_UnCompatibleShape^ NewInstance();
    static RDC::OCC::BRepExtrema_UnCompatibleShape^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::BRepExtrema_UnCompatibleShape^ CreateDowncasted(::BRepExtrema_UnCompatibleShape* instance);
}; // class BRepExtrema_UnCompatibleShape
