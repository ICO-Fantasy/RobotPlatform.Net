...
public ref class Geom2dConvert_SequenceOfPPoint sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert_SequenceOfPPoint>
    , public IIndexEnumerable<RDC::OCC::Geom2dConvert_PPoint^>
{
...
public:
    Geom2dConvert_SequenceOfPPoint(::Geom2dConvert_SequenceOfPPoint* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_SequenceOfPPoint>( nativeInstance, true )
    {}

    Geom2dConvert_SequenceOfPPoint(::Geom2dConvert_SequenceOfPPoint& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_SequenceOfPPoint>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Geom2dConvert_SequenceOfPPoint::Iterator>
    {
    ...
    public:
        Iterator(::Geom2dConvert_SequenceOfPPoint::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Geom2dConvert_SequenceOfPPoint::Iterator>( nativeInstance, true )
        {}

        Iterator(::Geom2dConvert_SequenceOfPPoint::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Geom2dConvert_SequenceOfPPoint::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::Geom2dConvert_PPoint^ Value();
        RDC::OCC::Geom2dConvert_PPoint^ ChangeValue();
        bool IsEqual(RDC::OCC::Geom2dConvert_SequenceOfPPoint::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    Geom2dConvert_SequenceOfPPoint();
    Geom2dConvert_SequenceOfPPoint(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::Geom2dConvert_SequenceOfPPoint^ Assign(RDC::OCC::Geom2dConvert_SequenceOfPPoint^ theOther);
    void Remove(RDC::OCC::Geom2dConvert_SequenceOfPPoint::Iterator^ thePosition);
    void Append(RDC::OCC::Geom2dConvert_PPoint^ theItem);
    void Prepend(RDC::OCC::Geom2dConvert_PPoint^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::Geom2dConvert_PPoint^ theItem);
    void InsertAfter(RDC::OCC::Geom2dConvert_SequenceOfPPoint::Iterator^ thePosition, RDC::OCC::Geom2dConvert_PPoint^ theItem);
    void Split(int theIndex, RDC::OCC::Geom2dConvert_SequenceOfPPoint^ theSeq);
    RDC::OCC::Geom2dConvert_PPoint^ First();
    RDC::OCC::Geom2dConvert_PPoint^ ChangeFirst();
    RDC::OCC::Geom2dConvert_PPoint^ Last();
    RDC::OCC::Geom2dConvert_PPoint^ ChangeLast();
    virtual RDC::OCC::Geom2dConvert_PPoint^ Value(int theIndex);
    RDC::OCC::Geom2dConvert_PPoint^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::Geom2dConvert_PPoint^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::Geom2dConvert_PPoint^>^ GetEnumerator();
...
public ref class Geom2dConvert sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert>
{
...
public:
    Geom2dConvert(::Geom2dConvert* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert>( nativeInstance, true )
    {}

    Geom2dConvert(::Geom2dConvert& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static RDC::OCC::Geom2d_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom2d_BSplineCurve^ C, int FromK1, int ToK2, bool SameOrientation);
    /// <summary>
    /// -- Convert a curve to BSpline  by Approximation
    /// 
    /// This method computes the arc of B-spline curve between the two
    ...
    /// Raised if FromK1 = ToK2
    /// </summary>
    static RDC::OCC::Geom2d_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom2d_BSplineCurve^ C, int FromK1, int ToK2);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom2d_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom2d_BSplineCurve^ C, double FromU1, double ToU2, double ParametricTolerance, bool SameOrientation);
    /// <summary>
    /// This function computes the segment of B-spline curve between the
    /// parametric values FromU1, ToU2.
    /// If C is periodic the arc has the same orientation as C if
    ...
    /// Raised if ParametricTolerance < Resolution from gp.
    /// </summary>
    static RDC::OCC::Geom2d_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom2d_BSplineCurve^ C, double FromU1, double ToU2, double ParametricTolerance);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom2d_BSplineCurve^ CurveToBSplineCurve(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// This function converts a non infinite curve from
    /// Geom into a  B-spline curve.  C must  be  an ellipse or a
    /// circle or a trimmed conic  or a trimmed  line or a Bezier
    ...
    /// cannot be used to convert a quasi-complete circle or ellipse).
    /// </summary>
    static RDC::OCC::Geom2d_BSplineCurve^ CurveToBSplineCurve(RDC::OCC::Geom2d_Curve^ C);
    ...
    /// </summary>
    static void C0BSplineToC1BSplineCurve(RDC::OCC::Geom2d_BSplineCurve^ BS, double Tolerance);
...
public ref class Geom2dConvert_PPoint sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert_PPoint>
{
...
public:
    Geom2dConvert_PPoint(::Geom2dConvert_PPoint* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_PPoint>( nativeInstance, true )
    {}

    Geom2dConvert_PPoint(::Geom2dConvert_PPoint& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_PPoint>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Constructor.
    /// </summary>
    Geom2dConvert_PPoint(double theParameter, RDC::OCC::XY thePoint, RDC::OCC::XY theD1);
    /// <summary>
    /// Constructor.
    /// </summary>
    Geom2dConvert_PPoint(double theParameter, RDC::OCC::Adaptor2d_Curve2d^ theAdaptor);
    /// <summary>
    /// Compute the distance betwwen two 2d points.
    /// </summary>
    double Dist(RDC::OCC::Geom2dConvert_PPoint^ theOth);
    /// <summary>
...
public ref class Geom2dConvert_ApproxArcsSegments sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert_ApproxArcsSegments>
{
...
public:
    Geom2dConvert_ApproxArcsSegments(::Geom2dConvert_ApproxArcsSegments* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_ApproxArcsSegments>( nativeInstance, true )
    {}

    Geom2dConvert_ApproxArcsSegments(::Geom2dConvert_ApproxArcsSegments& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_ApproxArcsSegments>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Constructor.
    /// </summary>
    Geom2dConvert_ApproxArcsSegments(RDC::OCC::Adaptor2d_Curve2d^ theCurve, double theTolerance, double theAngleTol);
...
public ref class Geom2dConvert_ApproxCurve sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert_ApproxCurve>
{
...
public:
    Geom2dConvert_ApproxCurve(::Geom2dConvert_ApproxCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_ApproxCurve>( nativeInstance, true )
    {}

    Geom2dConvert_ApproxCurve(::Geom2dConvert_ApproxCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_ApproxCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dConvert_ApproxCurve(RDC::OCC::Geom2d_Curve^ Curve, double Tol2d, RDC::OCC::GeomAbs_Shape Order, int MaxSegments, int MaxDegree);
    /// <summary>
    /// Constructs an approximation framework defined by
    /// -   the 2D conic Curve
    /// -   the tolerance value Tol2d
    ...
    /// polynomial defining the BSpline is allowed to have.
    /// </summary>
    Geom2dConvert_ApproxCurve(RDC::OCC::Adaptor2d_Curve2d^ Curve, double Tol2d, RDC::OCC::GeomAbs_Shape Order, int MaxSegments, int MaxDegree);
    /// <summary>
...
public ref class Geom2dConvert_BSplineCurveKnotSplitting sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert_BSplineCurveKnotSplitting>
{
...
public:
    Geom2dConvert_BSplineCurveKnotSplitting(::Geom2dConvert_BSplineCurveKnotSplitting* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_BSplineCurveKnotSplitting>( nativeInstance, true )
    {}

    Geom2dConvert_BSplineCurveKnotSplitting(::Geom2dConvert_BSplineCurveKnotSplitting& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_BSplineCurveKnotSplitting>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dConvert_BSplineCurveKnotSplitting(RDC::OCC::Geom2d_BSplineCurve^ BasisCurve, int ContinuityRange);
    /// <summary>
...
public ref class Geom2dConvert_BSplineCurveToBezierCurve sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert_BSplineCurveToBezierCurve>
{
...
public:
    Geom2dConvert_BSplineCurveToBezierCurve(::Geom2dConvert_BSplineCurveToBezierCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_BSplineCurveToBezierCurve>( nativeInstance, true )
    {}

    Geom2dConvert_BSplineCurveToBezierCurve(::Geom2dConvert_BSplineCurveToBezierCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_BSplineCurveToBezierCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dConvert_BSplineCurveToBezierCurve(RDC::OCC::Geom2d_BSplineCurve^ BasisCurve);
    /// <summary>
    /// Computes all the data needed to convert
    ...
    /// </summary>
    Geom2dConvert_BSplineCurveToBezierCurve(RDC::OCC::Geom2d_BSplineCurve^ BasisCurve, double U1, double U2, double ParametricTolerance);
    /// <summary>
    ...
    /// computed by this algorithm.
    /// </summary>
    RDC::OCC::Geom2d_BezierCurve^ Arc(int Index);
...
public ref class Geom2dConvert_CompCurveToBSplineCurve sealed
    : public RDC::OCC::BaseClass<::Geom2dConvert_CompCurveToBSplineCurve>
{
...
public:
    Geom2dConvert_CompCurveToBSplineCurve(::Geom2dConvert_CompCurveToBSplineCurve* nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_CompCurveToBSplineCurve>( nativeInstance, true )
    {}

    Geom2dConvert_CompCurveToBSplineCurve(::Geom2dConvert_CompCurveToBSplineCurve& nativeInstance)
        : RDC::OCC::BaseClass<::Geom2dConvert_CompCurveToBSplineCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Geom2dConvert_CompCurveToBSplineCurve(RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// Initialize the algorithme
    /// - Parameterisation is used to convert
    /// </summary>
    ...
    /// - Parameterisation is used to convert
    /// </summary>
    Geom2dConvert_CompCurveToBSplineCurve(RDC::OCC::Geom2d_BoundedCurve^ BasisCurve, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// Initialize the algorithme with one curve
    /// - Parameterisation is used to convert
    /// </summary>
    Geom2dConvert_CompCurveToBSplineCurve(RDC::OCC::Geom2d_BoundedCurve^ BasisCurve);
    /// <summary>
    ...
    /// </summary>
    bool Add(RDC::OCC::Geom2d_BoundedCurve^ NewCurve, double Tolerance, bool After);
    /// <summary>
    /// Append a curve in the BSpline
    /// Return False if the curve is not G0 with the BSplineCurve.
    /// Tolerance is used to check continuity and decrease
    ...
    /// After is useful if BasisCurve is a closed curve .
    /// </summary>
    bool Add(RDC::OCC::Geom2d_BoundedCurve^ NewCurve, double Tolerance);
    RDC::OCC::Geom2d_BSplineCurve^ BSplineCurve();
    /// <summary>
    /// Clear result curve
    /// </summary>
    void Clear();
