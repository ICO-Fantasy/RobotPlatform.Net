...
public ref class Aspect_XRActionMap sealed
    : public RDC::OCC::BaseClass<::Aspect_XRActionMap>
{
...
public:
    Aspect_XRActionMap(::Aspect_XRActionMap* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRActionMap>( nativeInstance, true )
    {}

    Aspect_XRActionMap(::Aspect_XRActionMap& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRActionMap>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Aspect_XRActionMap::Iterator>
    {
    ...
    public:
        Iterator(::Aspect_XRActionMap::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_XRActionMap::Iterator>( nativeInstance, true )
        {}

        Iterator(::Aspect_XRActionMap::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_XRActionMap::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::Aspect_XRAction^ Value();
        RDC::OCC::Aspect_XRAction^ ChangeValue();
        RDC::OCC::TCollection_AsciiString^ Key();
        bool IsEqual(RDC::OCC::Aspect_XRActionMap::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    Aspect_XRActionMap();
    Aspect_XRActionMap(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    Aspect_XRActionMap(int theNbBuckets);
    void Exchange(RDC::OCC::Aspect_XRActionMap^ theOther);
    RDC::OCC::Aspect_XRActionMap^ Assign(RDC::OCC::Aspect_XRActionMap^ theOther);
    void ReSize(int N);
    int Add(RDC::OCC::TCollection_AsciiString^ theKey1, RDC::OCC::Aspect_XRAction^ theItem);
    bool Contains(RDC::OCC::TCollection_AsciiString^ theKey1);
    void Substitute(int theIndex, RDC::OCC::TCollection_AsciiString^ theKey1, RDC::OCC::Aspect_XRAction^ theItem);
    ...
    RDC::OCC::Aspect_XRAction^ FindFromIndex(int theIndex);
    RDC::OCC::Aspect_XRAction^ ChangeFromIndex(int theIndex);
    int FindIndex(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRAction^ FindFromKey(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRAction^ ChangeFromKey(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRAction^ Seek(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRAction^ ChangeSeek(RDC::OCC::TCollection_AsciiString^ theKey1);
...
public ref class Aspect_XRActionSetMap sealed
    : public RDC::OCC::BaseClass<::Aspect_XRActionSetMap>
{
...
public:
    Aspect_XRActionSetMap(::Aspect_XRActionSetMap* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRActionSetMap>( nativeInstance, true )
    {}

    Aspect_XRActionSetMap(::Aspect_XRActionSetMap& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRActionSetMap>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Aspect_XRActionSetMap::Iterator>
    {
    ...
    public:
        Iterator(::Aspect_XRActionSetMap::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_XRActionSetMap::Iterator>( nativeInstance, true )
        {}

        Iterator(::Aspect_XRActionSetMap::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_XRActionSetMap::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::Aspect_XRActionSet^ Value();
        RDC::OCC::Aspect_XRActionSet^ ChangeValue();
        RDC::OCC::TCollection_AsciiString^ Key();
        bool IsEqual(RDC::OCC::Aspect_XRActionSetMap::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    Aspect_XRActionSetMap();
    Aspect_XRActionSetMap(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    Aspect_XRActionSetMap(int theNbBuckets);
    void Exchange(RDC::OCC::Aspect_XRActionSetMap^ theOther);
    RDC::OCC::Aspect_XRActionSetMap^ Assign(RDC::OCC::Aspect_XRActionSetMap^ theOther);
    void ReSize(int N);
    int Add(RDC::OCC::TCollection_AsciiString^ theKey1, RDC::OCC::Aspect_XRActionSet^ theItem);
    bool Contains(RDC::OCC::TCollection_AsciiString^ theKey1);
    void Substitute(int theIndex, RDC::OCC::TCollection_AsciiString^ theKey1, RDC::OCC::Aspect_XRActionSet^ theItem);
    void Swap(int theIndex1, int theIndex2);
    void RemoveLast();
    void RemoveFromIndex(int theIndex);
    void RemoveKey(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::TCollection_AsciiString^ FindKey(int theIndex);
    RDC::OCC::Aspect_XRActionSet^ FindFromIndex(int theIndex);
    RDC::OCC::Aspect_XRActionSet^ ChangeFromIndex(int theIndex);
    int FindIndex(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRActionSet^ FindFromKey(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRActionSet^ ChangeFromKey(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRActionSet^ Seek(RDC::OCC::TCollection_AsciiString^ theKey1);
    RDC::OCC::Aspect_XRActionSet^ ChangeSeek(RDC::OCC::TCollection_AsciiString^ theKey1);
    void Clear(bool doReleaseMemory);
    void Clear();
    int Size();
}; // class Aspect_XRActionSetMap
...
public ref class Aspect_TrackedDevicePoseArray sealed
    : public RDC::OCC::BaseClass<::Aspect_TrackedDevicePoseArray>
    , public IIndexEnumerable<RDC::OCC::Aspect_TrackedDevicePose^>
{
...
public:
    Aspect_TrackedDevicePoseArray(::Aspect_TrackedDevicePoseArray* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_TrackedDevicePoseArray>( nativeInstance, true )
    {}

    Aspect_TrackedDevicePoseArray(::Aspect_TrackedDevicePoseArray& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_TrackedDevicePoseArray>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Aspect_TrackedDevicePoseArray::Iterator>
    {
    ...
    public:
        Iterator(::Aspect_TrackedDevicePoseArray::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_TrackedDevicePoseArray::Iterator>( nativeInstance, true )
        {}

        Iterator(::Aspect_TrackedDevicePoseArray::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_TrackedDevicePoseArray::Iterator>( &nativeInstance, false )
        {}
    ...
    Aspect_TrackedDevicePoseArray(RDC::OCC::Aspect_TrackedDevicePose^ theBegin, int theLower, int theUpper, bool theUseBuffer);
    Aspect_TrackedDevicePoseArray(RDC::OCC::Aspect_TrackedDevicePose^ theBegin, int theLower, int theUpper);
    void Init(RDC::OCC::Aspect_TrackedDevicePose^ theValue);
    int Size();
    int Length();
    bool IsEmpty();
    int Lower();
    int Upper();
    RDC::OCC::Aspect_TrackedDevicePoseArray^ Assign(RDC::OCC::Aspect_TrackedDevicePoseArray^ theOther);
    RDC::OCC::Aspect_TrackedDevicePoseArray^ Move(RDC::OCC::Aspect_TrackedDevicePoseArray^ theOther);
    RDC::OCC::Aspect_TrackedDevicePose^ First();
    RDC::OCC::Aspect_TrackedDevicePose^ ChangeFirst();
    RDC::OCC::Aspect_TrackedDevicePose^ Last();
    RDC::OCC::Aspect_TrackedDevicePose^ ChangeLast();
    virtual RDC::OCC::Aspect_TrackedDevicePose^ Value(int theIndex);
    RDC::OCC::Aspect_TrackedDevicePose^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::Aspect_TrackedDevicePose^ theItem);
    ...
    bool IsDeletable();
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::Aspect_TrackedDevicePose^>^ GetEnumerator();
...
public ref class Aspect_SequenceOfColor sealed
    : public RDC::OCC::BaseClass<::Aspect_SequenceOfColor>
    , public IIndexEnumerable<RDC::OCC::Quantity_Color^>
{
...
public:
    Aspect_SequenceOfColor(::Aspect_SequenceOfColor* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_SequenceOfColor>( nativeInstance, true )
    {}

    Aspect_SequenceOfColor(::Aspect_SequenceOfColor& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_SequenceOfColor>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Aspect_SequenceOfColor::Iterator>
    {
    ...
    public:
        Iterator(::Aspect_SequenceOfColor::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_SequenceOfColor::Iterator>( nativeInstance, true )
        {}

        Iterator(::Aspect_SequenceOfColor::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_SequenceOfColor::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::Quantity_Color^ Value();
        RDC::OCC::Quantity_Color^ ChangeValue();
        bool IsEqual(RDC::OCC::Aspect_SequenceOfColor::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    Aspect_SequenceOfColor();
    Aspect_SequenceOfColor(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::Aspect_SequenceOfColor^ Assign(RDC::OCC::Aspect_SequenceOfColor^ theOther);
    void Remove(RDC::OCC::Aspect_SequenceOfColor::Iterator^ thePosition);
    void Append(RDC::OCC::Quantity_Color^ theItem);
    void Prepend(RDC::OCC::Quantity_Color^ theItem);
    void InsertBefore(int theIndex, RDC::OCC::Quantity_Color^ theItem);
    void InsertAfter(RDC::OCC::Aspect_SequenceOfColor::Iterator^ thePosition, RDC::OCC::Quantity_Color^ theItem);
    void Split(int theIndex, RDC::OCC::Aspect_SequenceOfColor^ theSeq);
    RDC::OCC::Quantity_Color^ First();
    RDC::OCC::Quantity_Color^ ChangeFirst();
    RDC::OCC::Quantity_Color^ Last();
    RDC::OCC::Quantity_Color^ ChangeLast();
    virtual RDC::OCC::Quantity_Color^ Value(int theIndex);
    RDC::OCC::Quantity_Color^ ChangeValue(int theIndex);
    void SetValue(int theIndex, RDC::OCC::Quantity_Color^ theItem);
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::Quantity_Color^>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class Aspect_SequenceOfColor
...
public ref class Aspect_TouchMap sealed
    : public RDC::OCC::BaseClass<::Aspect_TouchMap>
{
...
public:
    Aspect_TouchMap(::Aspect_TouchMap* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_TouchMap>( nativeInstance, true )
    {}

    Aspect_TouchMap(::Aspect_TouchMap& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_TouchMap>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::Aspect_TouchMap::Iterator>
    {
    ...
    public:
        Iterator(::Aspect_TouchMap::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_TouchMap::Iterator>( nativeInstance, true )
        {}

        Iterator(::Aspect_TouchMap::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::Aspect_TouchMap::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More();
        void Next();
        RDC::OCC::Aspect_Touch^ Value();
        RDC::OCC::Aspect_Touch^ ChangeValue();
        /* Method skipped due to unknown mapping: unsigned long long Key() */
        bool IsEqual(RDC::OCC::Aspect_TouchMap::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator

    Aspect_TouchMap();
    Aspect_TouchMap(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    Aspect_TouchMap(int theNbBuckets);
    void Exchange(RDC::OCC::Aspect_TouchMap^ theOther);
    RDC::OCC::Aspect_TouchMap^ Assign(RDC::OCC::Aspect_TouchMap^ theOther);
    void ReSize(int N);
    int Add(long long unsigned int theKey1, RDC::OCC::Aspect_Touch^ theItem);
    bool Contains(long long unsigned int theKey1);
    void Substitute(int theIndex, long long unsigned int theKey1, RDC::OCC::Aspect_Touch^ theItem);
    void Swap(int theIndex1, int theIndex2);
    void RemoveLast();
    void RemoveFromIndex(int theIndex);
    void RemoveKey(long long unsigned int theKey1);
    long long unsigned int FindKey(int theIndex);
    RDC::OCC::Aspect_Touch^ FindFromIndex(int theIndex);
    RDC::OCC::Aspect_Touch^ ChangeFromIndex(int theIndex);
    int FindIndex(long long unsigned int theKey1);
    RDC::OCC::Aspect_Touch^ FindFromKey(long long unsigned int theKey1);
    RDC::OCC::Aspect_Touch^ ChangeFromKey(long long unsigned int theKey1);
    RDC::OCC::Aspect_Touch^ Seek(long long unsigned int theKey1);
    RDC::OCC::Aspect_Touch^ ChangeSeek(long long unsigned int theKey1);
    void Clear(bool doReleaseMemory);
    void Clear();
    int Size();
}; // class Aspect_TouchMap
...
public ref class Aspect_XRAnalogActionData sealed
    : public RDC::OCC::BaseClass<::Aspect_XRAnalogActionData>
{
...
public:
    Aspect_XRAnalogActionData(::Aspect_XRAnalogActionData* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRAnalogActionData>( nativeInstance, true )
    {}

    Aspect_XRAnalogActionData(::Aspect_XRAnalogActionData& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRAnalogActionData>( &nativeInstance, false )
    {}
...
public ref class Aspect_XRDigitalActionData sealed
    : public RDC::OCC::BaseClass<::Aspect_XRDigitalActionData>
{
...
public:
    Aspect_XRDigitalActionData(::Aspect_XRDigitalActionData* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRDigitalActionData>( nativeInstance, true )
    {}

    Aspect_XRDigitalActionData(::Aspect_XRDigitalActionData& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRDigitalActionData>( &nativeInstance, false )
    {}
...
public ref class Aspect_XRHapticActionData sealed
    : public RDC::OCC::BaseClass<::Aspect_XRHapticActionData>
{
...
public:
    Aspect_XRHapticActionData(::Aspect_XRHapticActionData* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRHapticActionData>( nativeInstance, true )
    {}

    Aspect_XRHapticActionData(::Aspect_XRHapticActionData& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRHapticActionData>( &nativeInstance, false )
    {}
...
public ref class Aspect_TrackedDevicePose sealed
    : public RDC::OCC::BaseClass<::Aspect_TrackedDevicePose>
{
...
public:
    Aspect_TrackedDevicePose(::Aspect_TrackedDevicePose* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_TrackedDevicePose>( nativeInstance, true )
    {}

    Aspect_TrackedDevicePose(::Aspect_TrackedDevicePose& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_TrackedDevicePose>( &nativeInstance, false )
    {}
...
public ref class Aspect_XRPoseActionData sealed
    : public RDC::OCC::BaseClass<::Aspect_XRPoseActionData>
{
...
public:
    Aspect_XRPoseActionData(::Aspect_XRPoseActionData* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRPoseActionData>( nativeInstance, true )
    {}

    Aspect_XRPoseActionData(::Aspect_XRPoseActionData& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_XRPoseActionData>( &nativeInstance, false )
    {}
...
public ref class Aspect_ScrollDelta sealed
    : public RDC::OCC::BaseClass<::Aspect_ScrollDelta>
{
...
public:
    Aspect_ScrollDelta(::Aspect_ScrollDelta* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_ScrollDelta>( nativeInstance, true )
    {}

    Aspect_ScrollDelta(::Aspect_ScrollDelta& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_ScrollDelta>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Constructor.
    /// </summary>
    Aspect_ScrollDelta(RDC::OCC::Graphic3d_Vec2i^ thePnt, double theValue, unsigned int theFlags);
    /// <summary>
    /// Constructor.
    /// </summary>
    Aspect_ScrollDelta(RDC::OCC::Graphic3d_Vec2i^ thePnt, double theValue);
    /// <summary>
...
public:
    ...
    static RDC::OCC::Aspect_AspectFillAreaDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_AspectFillAreaDefinitionError^ NewInstance();
    static RDC::OCC::Aspect_AspectFillAreaDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_AspectFillAreaDefinitionError^ CreateDowncasted(::Aspect_AspectFillAreaDefinitionError* instance);
}; // class Aspect_AspectFillAreaDefinitionError
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Aspect_AspectLineDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_AspectLineDefinitionError^ NewInstance();
    static RDC::OCC::Aspect_AspectLineDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_AspectLineDefinitionError^ CreateDowncasted(::Aspect_AspectLineDefinitionError* instance);
}; // class Aspect_AspectLineDefinitionError
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Aspect_AspectMarkerDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_AspectMarkerDefinitionError^ NewInstance();
    static RDC::OCC::Aspect_AspectMarkerDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_AspectMarkerDefinitionError^ CreateDowncasted(::Aspect_AspectMarkerDefinitionError* instance);
}; // class Aspect_AspectMarkerDefinitionError
...
public ref class Aspect_Background
    : public RDC::OCC::BaseClass<::Aspect_Background>
{
...
protected:
    Aspect_Background(InitMode init)
        : RDC::OCC::BaseClass<::Aspect_Background>( init )
    {}

public:
    Aspect_Background(::Aspect_Background* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_Background>( nativeInstance, true )
    {}

    Aspect_Background(::Aspect_Background& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_Background>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Aspect_Background(RDC::OCC::Quantity_Color^ AColor);
    /// <summary>
...
public:
    ...
    /// </summary>
    void Colors(RDC::OCC::Quantity_Color^ aColor, RDC::OCC::Quantity_Color^ aTenthColor);
    /// <summary>
    /// Change the grid aspect.
    /// </summary>
    void SetDrawMode(RDC::OCC::Aspect_GridDrawMode aDrawMode);
    /// <summary>
    /// Returns the grid aspect.
    /// </summary>
    RDC::OCC::Aspect_GridDrawMode DrawMode();
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Aspect_Grid^ CreateDowncasted(::Aspect_Grid* instance);
}; // class Aspect_Grid
...
protected:
    Aspect_CircularGrid(InitMode init)
        : RDC::OCC::Aspect_Grid( init )
    {}

public:
    Aspect_CircularGrid(::Aspect_CircularGrid* nativeInstance)
        : RDC::OCC::Aspect_Grid( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Aspect_CircularGrid^ CreateDowncasted(::Aspect_CircularGrid* instance);
}; // class Aspect_CircularGrid
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Aspect_DisplayConnectionDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_DisplayConnectionDefinitionError^ NewInstance();
    static RDC::OCC::Aspect_DisplayConnectionDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_DisplayConnectionDefinitionError^ CreateDowncasted(::Aspect_DisplayConnectionDefinitionError* instance);
}; // class Aspect_DisplayConnectionDefinitionError
...
public ref class Aspect_GenId sealed
    : public RDC::OCC::BaseClass<::Aspect_GenId>
{
...
public:
    Aspect_GenId(::Aspect_GenId* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_GenId>( nativeInstance, true )
    {}

    Aspect_GenId(::Aspect_GenId& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_GenId>( &nativeInstance, false )
    {}
...
public ref class Aspect_GradientBackground sealed
    : public RDC::OCC::Aspect_Background
{
...
public:
    Aspect_GradientBackground(::Aspect_GradientBackground* nativeInstance)
        : RDC::OCC::Aspect_Background( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    Aspect_GradientBackground(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2, RDC::OCC::Aspect_GradientFillMethod theMethod);
    /// <summary>
    /// Creates a window gradient background with two colours.
    /// </summary>
    Aspect_GradientBackground(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2);
    /// <summary>
    /// Modifies the colours of the window gradient background.
    /// </summary>
    void SetColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2, RDC::OCC::Aspect_GradientFillMethod theMethod);
    /// <summary>
    /// Modifies the colours of the window gradient background.
    /// </summary>
    void SetColors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2);
    /// <summary>
    /// Returns colours of the window gradient background.
    /// </summary>
    void Colors(RDC::OCC::Quantity_Color^ theColor1, RDC::OCC::Quantity_Color^ theColor2);
    /// <summary>
    /// Returns the current gradient background fill mode.
    /// </summary>
    RDC::OCC::Aspect_GradientFillMethod BgGradientFillMethod();
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Aspect_GraphicDeviceDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_GraphicDeviceDefinitionError^ NewInstance();
    static RDC::OCC::Aspect_GraphicDeviceDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_GraphicDeviceDefinitionError^ CreateDowncasted(::Aspect_GraphicDeviceDefinitionError* instance);
}; // class Aspect_GraphicDeviceDefinitionError
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Aspect_IdentDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_IdentDefinitionError^ NewInstance();
    static RDC::OCC::Aspect_IdentDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_IdentDefinitionError^ CreateDowncasted(::Aspect_IdentDefinitionError* instance);
}; // class Aspect_IdentDefinitionError
...
public:
    ...
    /// </summary>
    RDC::OCC::Graphic3d_Vec2i^ TopLeft();
    /// <summary>
    /// Returns window dimensions.
    /// </summary>
    RDC::OCC::Graphic3d_Vec2i^ Dimensions();
    ...
    /// </summary>
    RDC::OCC::Aspect_FillMethod BackgroundFillMethod();
    /// <summary>
    ...
    /// </summary>
    void SetBackground(RDC::OCC::Aspect_Background^ theBack);
    /// <summary>
    /// Modifies the window background.
    /// </summary>
    void SetBackground(RDC::OCC::Quantity_Color^ theColor);
    /// <summary>
    /// Modifies the window gradient background.
    /// </summary>
    void SetBackground(RDC::OCC::Aspect_GradientBackground^ theBackground);
    /// <summary>
    /// Modifies the window gradient background.
    /// </summary>
    void SetBackground(RDC::OCC::Quantity_Color^ theFirstColor, RDC::OCC::Quantity_Color^ theSecondColor, RDC::OCC::Aspect_GradientFillMethod theFillMethod);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Aspect_TypeOfResize DoResize();
    /// <summary>
    ...
    /// Sets window title.
    /// </summary>
    void SetTitle(RDC::OCC::TCollection_AsciiString^ theTitle);
    ...
    /// </summary>
    RDC::OCC::Graphic3d_Vec2d^ ConvertPointToBacking(RDC::OCC::Graphic3d_Vec2d^ thePnt);
    /// <summary>
    /// Convert point from backing store units to logical units.
    /// </summary>
    RDC::OCC::Graphic3d_Vec2d^ ConvertPointFromBacking(RDC::OCC::Graphic3d_Vec2d^ thePnt);
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Aspect_Window^ CreateDowncasted(::Aspect_Window* instance);
}; // class Aspect_Window
...
public:
    ...
    /// Main constructor.
    /// </summary>
    Aspect_XRAction(RDC::OCC::TCollection_AsciiString^ theId, RDC::OCC::Aspect_XRActionType theType);
    /// <summary>
    /// Return action id.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ Id();
    /// <summary>
    /// Return action type.
    /// </summary>
    RDC::OCC::Aspect_XRActionType Type();
    /// <summary>
    ...
    static RDC::OCC::Aspect_XRAction^ CreateDowncasted(::Aspect_XRAction* instance);
}; // class Aspect_XRAction
...
public:
    ...
    /// Main constructor.
    /// </summary>
    Aspect_XRActionSet(RDC::OCC::TCollection_AsciiString^ theId);
    /// <summary>
    /// Return action id.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ Id();
    ...
    /// Add action.
    /// </summary>
    void AddAction(RDC::OCC::Aspect_XRAction^ theAction);
    /// <summary>
    /// Return map of actions.
    /// </summary>
    RDC::OCC::Aspect_XRActionMap^ Actions();
    static RDC::OCC::Aspect_XRActionSet^ CreateDowncasted(::Aspect_XRActionSet* instance);
}; // class Aspect_XRActionSet
...
public:
    ...
    /// </summary>
    RDC::OCC::Graphic3d_Vec2i^ RecommendedViewport();
    /// <summary>
    /// Return transformation from eye to head.
    /// </summary>
    RDC::OCC::Graphic3d_Mat4d^ EyeToHeadTransform(RDC::OCC::Aspect_Eye theEye);
    /// <summary>
    /// Return transformation from head to eye.
    /// </summary>
    RDC::OCC::Graphic3d_Mat4d^ HeadToEyeTransform(RDC::OCC::Aspect_Eye theEye);
    /// <summary>
    /// Return projection matrix.
    /// </summary>
    RDC::OCC::Graphic3d_Mat4d^ ProjectionMatrix(RDC::OCC::Aspect_Eye theEye, double theZNear, double theZFar);
    /// <summary>
    ...
    /// FALSE on error
    /// </returns>
    bool SubmitEye(System::IntPtr theTexture, RDC::OCC::Aspect_GraphicsLibrary theGraphicsLib, RDC::OCC::Aspect_ColorSpace theColorSpace, RDC::OCC::Aspect_Eye theEye);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Trsf HeadPose();
    /// <summary>
    /// Return left hand orientation.
    /// </summary>
    RDC::OCC::Trsf LeftHandPose();
    /// <summary>
    /// Return right hand orientation.
    /// </summary>
    RDC::OCC::Trsf RightHandPose();
    /// <summary>
    /// Return number of tracked poses array.
    /// </summary>
    RDC::OCC::Aspect_TrackedDevicePoseArray^ TrackedPoses();
    /// <summary>
    ...
    /// </summary>
    int NamedTrackedDevice(RDC::OCC::Aspect_XRTrackedDeviceRole theDevice);
    /// <summary>
    ...
    /// </returns>
    RDC::OCC::Graphic3d_ArrayOfTriangles^ LoadRenderModel(int theDevice, RDC::OCC::Image_Texture^ theTexture);
    /// <summary>
    /// Load model for displaying device.
    /// </summary>
    /// <param name="theDevice">
    ...
    /// model triangulation or NULL if not found
    /// </returns>
    RDC::OCC::Graphic3d_ArrayOfTriangles^ LoadRenderModel(int theDevice, bool theToApplyUnitFactor, RDC::OCC::Image_Texture^ theTexture);
    /// <summary>
    ...
    /// </param>
    RDC::OCC::Aspect_XRDigitalActionData^ GetDigitalActionData(RDC::OCC::Aspect_XRAction^ theAction);
    /// <summary>
    ...
    /// </param>
    RDC::OCC::Aspect_XRAnalogActionData^ GetAnalogActionData(RDC::OCC::Aspect_XRAction^ theAction);
    /// <summary>
    ...
    /// </param>
    RDC::OCC::Aspect_XRPoseActionData^ GetPoseActionDataForNextFrame(RDC::OCC::Aspect_XRAction^ theAction);
    /// <summary>
    /// Trigger vibration.
    /// </summary>
    void TriggerHapticVibrationAction(RDC::OCC::Aspect_XRAction^ theAction, RDC::OCC::Aspect_XRHapticActionData^ theParams);
    /// <summary>
    /// Abort vibration.
    /// </summary>
    void AbortHapticVibrationAction(RDC::OCC::Aspect_XRAction^ theAction);
    /// <summary>
    /// Return tracking origin.
    /// </summary>
    RDC::OCC::Aspect_XRSession::TrackingUniverseOrigin TrackingOrigin();
    /// <summary>
    /// Set tracking origin.
    /// </summary>
    void SetTrackingOrigin(RDC::OCC::Aspect_XRSession::TrackingUniverseOrigin theOrigin);
    /// <summary>
    /// Return generic action for specific hand or NULL if undefined.
    /// </summary>
    RDC::OCC::Aspect_XRAction^ GenericAction(RDC::OCC::Aspect_XRTrackedDeviceRole theDevice, RDC::OCC::Aspect_XRGenericAction theAction);
    /// <summary>
    /// Query information.
    /// </summary>
    RDC::OCC::TCollection_AsciiString^ GetString(RDC::OCC::Aspect_XRSession::InfoString theInfo);
    static RDC::OCC::Aspect_XRSession^ CreateDowncasted(::Aspect_XRSession* instance);
}; // class Aspect_XRSession
...
public ref class Aspect_OpenVRSession sealed
    : public RDC::OCC::Aspect_XRSession
{
...
public:
    Aspect_OpenVRSession(::Aspect_OpenVRSession* nativeInstance)
        : RDC::OCC::Aspect_XRSession( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    void SetTrackingOrigin(RDC::OCC::Aspect_XRSession::TrackingUniverseOrigin theOrigin);
    static RDC::OCC::Aspect_OpenVRSession^ CreateDowncasted(::Aspect_OpenVRSession* instance);
}; // class Aspect_OpenVRSession
...
public:
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Aspect_RectangularGrid^ CreateDowncasted(::Aspect_RectangularGrid* instance);
}; // class Aspect_RectangularGrid
...
public ref class Aspect_SkydomeBackground sealed
    : public RDC::OCC::BaseClass<::Aspect_SkydomeBackground>
{
...
public:
    Aspect_SkydomeBackground(::Aspect_SkydomeBackground* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_SkydomeBackground>( nativeInstance, true )
    {}

    Aspect_SkydomeBackground(::Aspect_SkydomeBackground& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_SkydomeBackground>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </param>
    Aspect_SkydomeBackground(RDC::OCC::Dir theSunDirection, float theCloudiness, float theTime, float theFogginess, int theSize);
    /// <summary>
    ...
    /// Sun direction with negative Y component represents moon with (-X, -Y, -Z) direction.
    /// </summary>
    void SetSunDirection(RDC::OCC::Dir theSunDirection);
    /// <summary>
...
public ref class Aspect_Touch sealed
    : public RDC::OCC::BaseClass<::Aspect_Touch>
{
...
public:
    Aspect_Touch(::Aspect_Touch* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_Touch>( nativeInstance, true )
    {}

    Aspect_Touch(::Aspect_Touch& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_Touch>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    Aspect_Touch(RDC::OCC::Graphic3d_Vec2d^ thePnt, bool theIsPreciseDevice);
    /// <summary>
    /// Constructor with initialization.
    /// </summary>
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Aspect_WindowDefinitionError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_WindowDefinitionError^ NewInstance();
    static RDC::OCC::Aspect_WindowDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_WindowDefinitionError^ CreateDowncasted(::Aspect_WindowDefinitionError* instance);
}; // class Aspect_WindowDefinitionError
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Aspect_WindowError^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Aspect_WindowError^ NewInstance();
    static RDC::OCC::Aspect_WindowError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Aspect_WindowError^ CreateDowncasted(::Aspect_WindowError* instance);
}; // class Aspect_WindowError
...
public ref class Aspect_WindowInputListener
    : public RDC::OCC::BaseClass<::Aspect_WindowInputListener>
{
...
protected:
    Aspect_WindowInputListener(InitMode init)
        : RDC::OCC::BaseClass<::Aspect_WindowInputListener>( init )
    {}

public:
    Aspect_WindowInputListener(::Aspect_WindowInputListener* nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_WindowInputListener>( nativeInstance, true )
    {}

    Aspect_WindowInputListener(::Aspect_WindowInputListener& nativeInstance)
        : RDC::OCC::BaseClass<::Aspect_WindowInputListener>( &nativeInstance, false )
    {}
...
public:
    ...
    /// TRUE if window content should be redrawn
    /// </returns>
    bool PressMouseButton(RDC::OCC::Graphic3d_Vec2i^ thePoint, unsigned int theButton, unsigned int theModifiers, bool theIsEmulated);
    /// <summary>
    ...
    /// TRUE if window content should be redrawn
    /// </returns>
    bool ReleaseMouseButton(RDC::OCC::Graphic3d_Vec2i^ thePoint, unsigned int theButton, unsigned int theModifiers, bool theIsEmulated);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Graphic3d_Vec2i^ LastMousePosition();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Aspect_TouchMap^ TouchPoints();
    /// <summary>
