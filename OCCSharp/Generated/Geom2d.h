...
public:
    ...
    /// </summary>
    void Mirror(RDC::OCC::Pnt2d P);
    /// <summary>
    /// Performs the symmetrical transformation of a Geometry
    /// with respect to an axis placement which is the axis of the symmetry.
    /// </summary>
    void Mirror(RDC::OCC::Ax2d A);
    /// <summary>
    /// Rotates a Geometry. P is the center of the rotation.
    /// Ang is the angular value of the rotation in radians.
    /// </summary>
    void Rotate(RDC::OCC::Pnt2d P, double Ang);
    /// <summary>
    /// Scales a Geometry. S is the scaling value.
    /// </summary>
    void Scale(RDC::OCC::Pnt2d P, double S);
    /// <summary>
    /// Translates a Geometry.  V is the vector of the translation.
    /// </summary>
    void Translate(RDC::OCC::Vec2d V);
    /// <summary>
    /// Translates a Geometry from the point P1 to the point P2.
    /// </summary>
    void Translate(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
    /// <summary>
    ...
    /// </summary>
    void Transform(RDC::OCC::Trsf2d T);
    RDC::OCC::Geom2d_Geometry^ Mirrored(RDC::OCC::Pnt2d P);
    RDC::OCC::Geom2d_Geometry^ Mirrored(RDC::OCC::Ax2d A);
    RDC::OCC::Geom2d_Geometry^ Rotated(RDC::OCC::Pnt2d P, double Ang);
    RDC::OCC::Geom2d_Geometry^ Scaled(RDC::OCC::Pnt2d P, double S);
    RDC::OCC::Geom2d_Geometry^ Transformed(RDC::OCC::Trsf2d T);
    RDC::OCC::Geom2d_Geometry^ Translated(RDC::OCC::Vec2d V);
    RDC::OCC::Geom2d_Geometry^ Translated(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
    RDC::OCC::Geom2d_Geometry^ Copy();
    /// <summary>
    ...
    static RDC::OCC::Geom2d_Geometry^ CreateDowncasted(::Geom2d_Geometry* instance);
}; // class Geom2d_Geometry
...
public ref class Geom2d_AxisPlacement sealed
    : public RDC::OCC::Geom2d_Geometry
{
...
public:
    Geom2d_AxisPlacement(::Geom2d_AxisPlacement* nativeInstance)
        : RDC::OCC::Geom2d_Geometry( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    Geom2d_AxisPlacement(RDC::OCC::Ax2d A);
    /// <summary>
    /// Constructs an axis from a given origin P and unit vector V.
    /// </summary>
    Geom2d_AxisPlacement(RDC::OCC::Pnt2d P, RDC::OCC::Dir2d V);
    void Reverse();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_Geometry^ Copy();
    static RDC::OCC::Geom2d_AxisPlacement^ CreateDowncasted(::Geom2d_AxisPlacement* instance);
}; // class Geom2d_AxisPlacement
...
public:
    ...
    /// </summary>
    double TransformedParameter(double U, RDC::OCC::Trsf2d T);
    /// <summary>
    ...
    /// redefined (for example, on a line).
    /// </summary>
    double ParametricTransformation(RDC::OCC::Trsf2d T);
    /// <summary>
    ...
    /// </summary>
    void D1(double U, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1);
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Curve^ CreateDowncasted(::Geom2d_Curve* instance);
}; // class Geom2d_Curve
...
protected:
    Geom2d_BoundedCurve(InitMode init)
        : RDC::OCC::Geom2d_Curve( init )
    {}

public:
    Geom2d_BoundedCurve(::Geom2d_BoundedCurve* nativeInstance)
        : RDC::OCC::Geom2d_Curve( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_BoundedCurve^ CreateDowncasted(::Geom2d_BoundedCurve* instance);
}; // class Geom2d_BoundedCurve
...
public ref class Geom2d_BezierCurve sealed
    : public RDC::OCC::Geom2d_BoundedCurve
{
...
public:
    Geom2d_BezierCurve(::Geom2d_BezierCurve* nativeInstance)
        : RDC::OCC::Geom2d_BoundedCurve( nativeInstance )
    {}
...
public:
    ...
    /// or lower than 2.
    /// </summary>
    Geom2d_BezierCurve(RDC::OCC::TColgp_Array1OfPnt2d^ CurvePoles);
    /// <summary>
    ...
    /// package gp.
    /// </summary>
    Geom2d_BezierCurve(RDC::OCC::TColgp_Array1OfPnt2d^ CurvePoles, RDC::OCC::TColStd_Array1OfReal^ PoleWeights);
    /// <summary>
    ...
    /// MaxDegree + 1.
    /// </summary>
    void InsertPoleAfter(int Index, RDC::OCC::Pnt2d P, double Weight);
    /// <summary>
    /// Inserts a pole with its weight in the set of poles after the
    /// pole of range Index. If the curve was non rational it can
    /// become rational if all the weights are not identical.
    ...
    /// MaxDegree + 1.
    /// </summary>
    void InsertPoleAfter(int Index, RDC::OCC::Pnt2d P);
    /// <summary>
    ...
    /// MaxDegree + 1.
    /// </summary>
    void InsertPoleBefore(int Index, RDC::OCC::Pnt2d P, double Weight);
    /// <summary>
    /// Inserts a pole with its weight in the set of poles after
    /// the pole of range Index. If the curve was non rational it
    /// can become rational if all the weights are not identical.
    ...
    /// MaxDegree + 1.
    /// </summary>
    void InsertPoleBefore(int Index, RDC::OCC::Pnt2d P);
    /// <summary>
    ...
    /// raiseD if Index is not in the range [1, NbPoles]
    /// </summary>
    void SetPole(int Index, RDC::OCC::Pnt2d P);
    /// <summary>
    ...
    /// </summary>
    void SetPole(int Index, RDC::OCC::Pnt2d P, double Weight);
    /// <summary>
    ...
    /// Raised if Index is not in the range [1, NbPoles]
    /// </summary>
    RDC::OCC::Pnt2d Pole(int Index);
    /// <summary>
    /// Returns all the poles of the curve.
    /// 
    /// Raised if the length of P is not equal to the number of poles.
    /// </summary>
    void Poles(RDC::OCC::TColgp_Array1OfPnt2d^ P);
    /// <summary>
    /// Returns all the poles of the curve.
    /// </summary>
    RDC::OCC::TColgp_Array1OfPnt2d^ Poles();
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_BezierCurve^ CreateDowncasted(::Geom2d_BezierCurve* instance);
}; // class Geom2d_BezierCurve
...
public:
    ...
    /// </summary>
    Geom2d_BSplineCurve(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Multiplicities, int Degree, bool Periodic);
    /// <summary>
    /// Creates a  non-rational B_spline curve   on  the
    /// basis <Knots, Multiplicities> of degree <Degree>.
    /// The following conditions must be verified.
    ...
    /// Poles.Length() == Sum(Mults(i)) except the first or last
    /// </summary>
    Geom2d_BSplineCurve(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Multiplicities, int Degree);
    /// <summary>
    ...
    /// Poles.Length() == Sum(Mults(i)) except the first or last
    /// </summary>
    Geom2d_BSplineCurve(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Multiplicities, int Degree, bool Periodic);
    /// <summary>
    /// Creates  a rational B_spline  curve  on the basis
    /// <Knots, Multiplicities> of degree <Degree>.
    /// The following conditions must be verified.
    ...
    /// Poles.Length() == Sum(Mults(i)) except the first or last
    /// </summary>
    Geom2d_BSplineCurve(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Multiplicities, int Degree);
    /// <summary>
    ...
    /// </summary>
    void MovePoint(double U, RDC::OCC::Pnt2d P, int Index1, int Index2, int% FirstModifiedPole, int% LastModifiedPole);
    /// <summary>
    ...
    /// </summary>
    void MovePointAndTangent(double U, RDC::OCC::Pnt2d P, RDC::OCC::Vec2d Tangent, double Tolerance, int StartingCondition, int EndingCondition, int% ErrorStatus);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Pnt2d LocalValue(double U, int FromK1, int ToK2);
    /// <summary>
    /// Raised if FromK1 = ToK2.
    /// </summary>
    void LocalD0(double U, int FromK1, int ToK2, RDC::OCC::Pnt2d% P);
    /// <summary>
    /// Raised if the local continuity of the curve is not C1
    /// between the knot K1 and the knot K2.
    /// Raised if FromK1 = ToK2.
    /// </summary>
    void LocalD1(double U, int FromK1, int ToK2, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1);
    /// <summary>
    /// Raised if the local continuity of the curve is not C2
    /// between the knot K1 and the knot K2.
    /// Raised if FromK1 = ToK2.
    /// </summary>
    void LocalD2(double U, int FromK1, int ToK2, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1, RDC::OCC::Vec2d% V2);
    /// <summary>
    /// Raised if the local continuity of the curve is not C3
    /// between the knot K1 and the knot K2.
    /// Raised if FromK1 = ToK2.
    /// </summary>
    void LocalD3(double U, int FromK1, int ToK2, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1, RDC::OCC::Vec2d% V2, RDC::OCC::Vec2d% V3);
    /// <summary>
    ...
    /// Raised if N < 1.
    /// </summary>
    RDC::OCC::Vec2d LocalDN(double U, int FromK1, int ToK2, int N);
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_BSplineCurve^ CreateDowncasted(::Geom2d_BSplineCurve* instance);
}; // class Geom2d_BSplineCurve
...
public:
    ...
    /// </summary>
    double Distance(RDC::OCC::Geom2d_Point^ Other);
    /// <summary>
    /// computes the square distance between <me> and <Other>.
    /// </summary>
    double SquareDistance(RDC::OCC::Geom2d_Point^ Other);
    /// <summary>
    /// Dumps the content of me into the stream
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Point^ CreateDowncasted(::Geom2d_Point* instance);
}; // class Geom2d_Point
...
public:
    Geom2d_CartesianPoint(::Geom2d_CartesianPoint* nativeInstance)
        : RDC::OCC::Geom2d_Point( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    Geom2d_CartesianPoint(RDC::OCC::Pnt2d P);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_CartesianPoint^ CreateDowncasted(::Geom2d_CartesianPoint* instance);
}; // class Geom2d_CartesianPoint
...
public:
    ...
    /// </summary>
    void SetXAxis(RDC::OCC::Ax2d theAX);
    /// <summary>
    /// Assigns the origin and unit vector of axis theA to the
    ...
    /// system (right-handed or left-handed).
    /// </summary>
    void SetYAxis(RDC::OCC::Ax2d theAY);
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Conic^ CreateDowncasted(::Geom2d_Conic* instance);
}; // class Geom2d_Conic
...
public:
    Geom2d_Circle(::Geom2d_Circle* nativeInstance)
        : RDC::OCC::Geom2d_Conic( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    Geom2d_Circle(RDC::OCC::gp_Circ2d^ C);
    /// <summary>
    ...
    /// </summary>
    Geom2d_Circle(RDC::OCC::Ax2d A, double Radius, bool Sense);
    /// <summary>
    /// Constructs a circle of radius Radius, whose center is the origin of axis
    /// A; A is the "X Axis" of the local coordinate system
    /// of the circle; this coordinate system is direct if
    ...
    /// Exceptions Standard_ConstructionError if Radius is negative.
    /// </summary>
    Geom2d_Circle(RDC::OCC::Ax2d A, double Radius);
    /// <summary>
    /// Constructs a circle
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Circle^ CreateDowncasted(::Geom2d_Circle* instance);
}; // class Geom2d_Circle
...
public:
    ...
    /// </summary>
    RDC::OCC::Geom2d_Vector^ Reversed();
    /// <summary>
    ...
    /// </summary>
    double Angle(RDC::OCC::Geom2d_Vector^ Other);
    /// <summary>
    /// Returns the coordinates of <me>.
    /// </summary>
    void Coord(double% X, double% Y);
    ...
    /// </summary>
    double Crossed(RDC::OCC::Geom2d_Vector^ Other);
    /// <summary>
    /// Returns the scalar product of 2 Vectors.
    /// </summary>
    double Dot(RDC::OCC::Geom2d_Vector^ Other);
    /// <summary>
    /// Returns a non persistent copy of <me>.
    /// </summary>
    RDC::OCC::Vec2d Vec2d();
    static RDC::OCC::Geom2d_Vector^ CreateDowncasted(::Geom2d_Vector* instance);
}; // class Geom2d_Vector
...
public:
    Geom2d_Direction(::Geom2d_Direction* nativeInstance)
        : RDC::OCC::Geom2d_Vector( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    Geom2d_Direction(RDC::OCC::Dir2d V);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_Geometry^ Copy();
    static RDC::OCC::Geom2d_Direction^ CreateDowncasted(::Geom2d_Direction* instance);
}; // class Geom2d_Direction
...
public:
    ...
    /// </summary>
    Geom2d_Ellipse(RDC::OCC::gp_Elips2d^ E);
    /// <summary>
    ...
    /// </summary>
    Geom2d_Ellipse(RDC::OCC::Ax2d MajorAxis, double MajorRadius, double MinorRadius, bool Sense);
    /// <summary>
    /// Creates an ellipse defined by its major and minor radii,
    /// MajorRadius and MinorRadius, and positioned
    /// in the plane by its major axis MajorAxis; the
    ...
    /// - MinorRadius is less than 0.
    /// </summary>
    Geom2d_Ellipse(RDC::OCC::Ax2d MajorAxis, double MajorRadius, double MinorRadius);
    /// <summary>
    /// Creates an ellipse defined by its major and minor radii,
    ...
    /// - MinorRadius is less than 0.
    /// </summary>
    Geom2d_Ellipse(RDC::OCC::Ax22d Axis, double MajorRadius, double MinorRadius);
    /// <summary>
    /// Converts the gp_Elips2d ellipse E into this ellipse.
    /// </summary>
    void SetElips2d(RDC::OCC::gp_Elips2d^ E);
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Ellipse^ CreateDowncasted(::Geom2d_Ellipse* instance);
}; // class Geom2d_Ellipse
...
public:
    ...
    /// </summary>
    Geom2d_Hyperbola(RDC::OCC::gp_Hypr2d^ H);
    /// <summary>
    ...
    /// </summary>
    Geom2d_Hyperbola(RDC::OCC::Ax2d MajorAxis, double MajorRadius, double MinorRadius, bool Sense);
    /// <summary>
    /// MajorAxis is the "XAxis" of the hyperbola.
    /// The YAxis is in the direct sense if "Sense" is True;
    /// The major radius of the hyperbola is on this "XAxis" and
    ...
    /// Raised if MajorRadius < 0.0 or if MinorRadius < 0.0
    /// </summary>
    Geom2d_Hyperbola(RDC::OCC::Ax2d MajorAxis, double MajorRadius, double MinorRadius);
    /// <summary>
    ...
    /// Raised if MajorRadius < 0.0 or if MinorRadius < 0.0
    /// </summary>
    Geom2d_Hyperbola(RDC::OCC::Ax22d Axis, double MajorRadius, double MinorRadius);
    /// <summary>
    /// Converts the gp_Hypr2d hyperbola H into this hyperbola.
    /// </summary>
    void SetHypr2d(RDC::OCC::gp_Hypr2d^ H);
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Hyperbola^ CreateDowncasted(::Geom2d_Hyperbola* instance);
}; // class Geom2d_Hyperbola
...
public:
    ...
    /// </summary>
    Geom2d_Line(RDC::OCC::Ax2d A);
    /// <summary>
    /// Creates a line by conversion of the gp_Lin2d line L.
    /// </summary>
    Geom2d_Line(RDC::OCC::gp_Lin2d^ L);
    /// <summary>
    ...
    /// </summary>
    Geom2d_Line(RDC::OCC::Pnt2d P, RDC::OCC::Dir2d V);
    /// <summary>
    /// Set <me> so that <me> has the same geometric properties as L.
    /// </summary>
    void SetLin2d(RDC::OCC::gp_Lin2d^ L);
    /// <summary>
    ...
    /// </summary>
    double Distance(RDC::OCC::Pnt2d P);
    /// <summary>
    /// Returns True.
    /// </summary>
    bool IsCN(int N);
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Line^ CreateDowncasted(::Geom2d_Line* instance);
}; // class Geom2d_Line
...
public:
    ...
    /// </summary>
    Geom2d_OffsetCurve(RDC::OCC::Geom2d_Curve^ C, double Offset, bool isNotCheckC0);
    /// <summary>
    /// Constructs a curve offset from the basis curve C,
    /// where Offset is the distance between the offset
    /// curve and the basis curve at any point.
    ...
    /// No check is done to know if ||V^Z|| != 0.0 at any point.
    /// </summary>
    Geom2d_OffsetCurve(RDC::OCC::Geom2d_Curve^ C, double Offset);
    /// <summary>
    /// Changes the direction of parametrization of <me>.
    /// As a result:
    ...
    /// </summary>
    void SetBasisCurve(RDC::OCC::Geom2d_Curve^ C, bool isNotCheckC0);
    /// <summary>
    /// Changes this offset curve by assigning C as the
    /// basis curve from which it is built.
    /// If isNotCheckC0 = TRUE checking if basis curve has C0-continuity
    ...
    /// Standard_ConstructionError if the curve C is not at least "C1" continuous.
    /// </summary>
    void SetBasisCurve(RDC::OCC::Geom2d_Curve^ C);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_Curve^ BasisCurve();
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_OffsetCurve^ CreateDowncasted(::Geom2d_OffsetCurve* instance);
}; // class Geom2d_OffsetCurve
...
public:
    ...
    /// </summary>
    Geom2d_Parabola(RDC::OCC::gp_Parab2d^ Prb);
    /// <summary>
    ...
    /// Raised if Focal < 0.0
    /// </summary>
    Geom2d_Parabola(RDC::OCC::Ax2d MirrorAxis, double Focal, bool Sense);
    /// <summary>
    /// Creates a parabola with its "MirrorAxis" and it's focal
    /// length "Focal".
    /// MirrorAxis is the axis of symmetry of the curve, it is the
    ...
    /// Raised if Focal < 0.0
    /// </summary>
    Geom2d_Parabola(RDC::OCC::Ax2d MirrorAxis, double Focal);
    /// <summary>
    ...
    /// Raised if Focal < 0.0
    /// </summary>
    Geom2d_Parabola(RDC::OCC::Ax22d Axis, double Focal);
    /// <summary>
    ...
    /// </summary>
    Geom2d_Parabola(RDC::OCC::Ax2d D, RDC::OCC::Pnt2d F);
    /// <summary>
    ...
    /// </summary>
    void SetParab2d(RDC::OCC::gp_Parab2d^ Prb);
    /// <summary>
    /// Returns the non persistent parabola from gp with the same
    /// geometric properties as <me>.
    /// </summary>
    RDC::OCC::gp_Parab2d^ Parab2d();
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_Parabola^ CreateDowncasted(::Geom2d_Parabola* instance);
}; // class Geom2d_Parabola
...
public:
    ...
    /// </summary>
    void SetTransformation(RDC::OCC::Ax2d ToSystem);
    /// <summary>
    /// Makes the transformation into a translation.
    /// V is the vector of the translation.
    /// </summary>
    void SetTranslation(RDC::OCC::Vec2d V);
    /// <summary>
    /// Makes the transformation into a translation from the point
    /// P1 to the point P2.
    /// </summary>
    void SetTranslation(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
    /// <summary>
    /// Makes the transformation into a transformation T from
    /// package gp.
    /// </summary>
    void SetTrsf2d(RDC::OCC::Trsf2d T);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_Transformation^ Inverted();
    /// <summary>
    /// Computes the transformation composed with Other and <me>.
    /// <me> * Other.
    /// Returns a new transformation
    /// </summary>
    RDC::OCC::Geom2d_Transformation^ Multiplied(RDC::OCC::Geom2d_Transformation^ Other);
    /// <summary>
    /// Computes the transformation composed with Other and <me> .
    /// <me> = <me> * Other.
    /// 
    ...
    /// </summary>
    void Multiply(RDC::OCC::Geom2d_Transformation^ Other);
    /// <summary>
    ...
    /// Raised if N < 0 and if the transformation is not inversible
    /// </summary>
    RDC::OCC::Geom2d_Transformation^ Powered(int N);
    /// <summary>
    /// Computes the matrix of the transformation composed with
    /// <me> and Other.     <me> = Other * <me>
    /// </summary>
    void PreMultiply(RDC::OCC::Geom2d_Transformation^ Other);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_Transformation^ Copy();
    static RDC::OCC::Geom2d_Transformation^ CreateDowncasted(::Geom2d_Transformation* instance);
}; // class Geom2d_Transformation
...
public:
    ...
    /// Raised if U1 = U2.
    /// </summary>
    Geom2d_TrimmedCurve(RDC::OCC::Geom2d_Curve^ C, double U1, double U2, bool Sense, bool theAdjustPeriodic);
    /// <summary>
    /// Creates a trimmed curve from the basis curve C limited between
    /// U1 and U2.
    /// 
    ...
    /// Raised if U1 = U2.
    /// </summary>
    Geom2d_TrimmedCurve(RDC::OCC::Geom2d_Curve^ C, double U1, double U2, bool Sense);
    /// <summary>
    /// Creates a trimmed curve from the basis curve C limited between
    /// U1 and U2.
    /// 
    ...
    /// Raised if U1 = U2.
    /// </summary>
    Geom2d_TrimmedCurve(RDC::OCC::Geom2d_Curve^ C, double U1, double U2);
    /// <summary>
    ...
    /// </summary>
    void DumpJson(System::IO::TextWriter^ theOStream);
    static RDC::OCC::Geom2d_TrimmedCurve^ CreateDowncasted(::Geom2d_TrimmedCurve* instance);
}; // class Geom2d_TrimmedCurve
...
public:
    ...
    static RDC::OCC::Geom2d_UndefinedDerivative^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Geom2d_UndefinedDerivative^ NewInstance();
    static RDC::OCC::Geom2d_UndefinedDerivative^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Geom2d_UndefinedDerivative^ CreateDowncasted(::Geom2d_UndefinedDerivative* instance);
}; // class Geom2d_UndefinedDerivative
...
public:
    ...
    static void Raise();
    /* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
    static RDC::OCC::Geom2d_UndefinedValue^ NewInstance(System::String^ theMessage);
    static RDC::OCC::Geom2d_UndefinedValue^ NewInstance();
    static RDC::OCC::Geom2d_UndefinedValue^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::Geom2d_UndefinedValue^ CreateDowncasted(::Geom2d_UndefinedValue* instance);
}; // class Geom2d_UndefinedValue
...
public:
    ...
    /// </summary>
    Geom2d_VectorWithMagnitude(RDC::OCC::Vec2d V);
    /// <summary>
    ...
    /// </summary>
    Geom2d_VectorWithMagnitude(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
    /// <summary>
    /// Set <me> to X, Y coordinates.
    /// </summary>
    void SetCoord(double X, double Y);
    void SetVec2d(RDC::OCC::Vec2d V);
    /// <summary>
    /// Changes the X coordinate of <me>.
    /// </summary>
    void SetX(double X);
    ...
    /// </summary>
    void Add(RDC::OCC::Geom2d_Vector^ Other);
    /// <summary>
    /// Adds the vector Other to <me>.
    /// </summary>
    RDC::OCC::Geom2d_VectorWithMagnitude^ Added(RDC::OCC::Geom2d_Vector^ Other);
    /// <summary>
    /// Computes the cross product  between <me> and Other
    ...
    /// </summary>
    RDC::OCC::Geom2d_VectorWithMagnitude^ Divided(double Scalar);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_VectorWithMagnitude^ Multiplied(double Scalar);
    /// <summary>
    /// Computes the product of the vector <me> by a scalar.
    /// </summary>
    ...
    /// Resolution from package gp.
    /// </summary>
    RDC::OCC::Geom2d_VectorWithMagnitude^ Normalized();
    /// <summary>
    /// Subtracts the Vector Other to <me>.
    /// </summary>
    void Subtract(RDC::OCC::Geom2d_Vector^ Other);
    /// <summary>
    /// Subtracts the vector Other to <me>. A new vector is returned.
    /// </summary>
    RDC::OCC::Geom2d_VectorWithMagnitude^ Subtracted(RDC::OCC::Geom2d_Vector^ Other);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom2d_Geometry^ Copy();
    static RDC::OCC::Geom2d_VectorWithMagnitude^ CreateDowncasted(::Geom2d_VectorWithMagnitude* instance);
}; // class Geom2d_VectorWithMagnitude
