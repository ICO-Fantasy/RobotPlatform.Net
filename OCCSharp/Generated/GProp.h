...
public ref class GProp sealed
    : public RDC::OCC::BaseClass<::GProp>
{
...
public:
    GProp(::GProp* nativeInstance)
        : RDC::OCC::BaseClass<::GProp>( nativeInstance, true )
    {}

    GProp(::GProp& nativeInstance)
        : RDC::OCC::BaseClass<::GProp>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void HOperator(RDC::OCC::Pnt G, RDC::OCC::Pnt Q, double Mass, RDC::OCC::Mat% Operator);
}; // class GProp
...
public ref class GProp_PrincipalProps sealed
    : public RDC::OCC::BaseClass<::GProp_PrincipalProps>
{
...
public:
    GProp_PrincipalProps(::GProp_PrincipalProps* nativeInstance)
        : RDC::OCC::BaseClass<::GProp_PrincipalProps>( nativeInstance, true )
    {}

    GProp_PrincipalProps(::GProp_PrincipalProps& nativeInstance)
        : RDC::OCC::BaseClass<::GProp_PrincipalProps>( &nativeInstance, false )
    {}
...
public:
    ...
    /// inertia.
    /// </summary>
    RDC::OCC::Vec FirstAxisOfInertia();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Vec SecondAxisOfInertia();
    /// <summary>
    ...
    /// second and the third axis of symmetry are undefined.
    /// </summary>
    RDC::OCC::Vec ThirdAxisOfInertia();
    /// <summary>
...
public ref class GProp_GProps
    : public RDC::OCC::BaseClass<::GProp_GProps>
{
...
protected:
    GProp_GProps(InitMode init)
        : RDC::OCC::BaseClass<::GProp_GProps>( init )
    {}

public:
    GProp_GProps(::GProp_GProps* nativeInstance)
        : RDC::OCC::BaseClass<::GProp_GProps>( nativeInstance, true )
    {}

    GProp_GProps(::GProp_GProps& nativeInstance)
        : RDC::OCC::BaseClass<::GProp_GProps>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GProp_GProps(RDC::OCC::Pnt SystemLocation);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::GProp_PrincipalProps^ PrincipalProperties();
    /// <summary>
    /// Either
    ...
    /// </summary>
    void Add(RDC::OCC::GProp_GProps^ Item, double Density);
    /// <summary>
    /// Either
    /// - initializes the global properties retained by this
    /// framework from those retained by the framework Item, or
    ...
    /// equal to gp::Resolution().
    /// </summary>
    void Add(RDC::OCC::GProp_GProps^ Item);
    /// <summary>
    ...
    /// axis A.
    /// </summary>
    double MomentOfInertia(RDC::OCC::Ax1 A);
    /// <summary>
    /// Returns the radius of gyration of the current system about the axis A.
    /// </summary>
    double RadiusOfGyration(RDC::OCC::Ax1 A);
}; // class GProp_GProps
...
public:
    GProp_CelGProps();
    GProp_CelGProps(RDC::OCC::gp_Circ^ C, RDC::OCC::Pnt CLocation);
    GProp_CelGProps(RDC::OCC::gp_Circ^ C, double U1, double U2, RDC::OCC::Pnt CLocation);
    GProp_CelGProps(RDC::OCC::gp_Lin^ C, double U1, double U2, RDC::OCC::Pnt CLocation);
    void SetLocation(RDC::OCC::Pnt CLocation);
    void Perform(RDC::OCC::gp_Circ^ C, double U1, double U2);
    void Perform(RDC::OCC::gp_Lin^ C, double U1, double U2);
}; // class GProp_CelGProps
...
public ref class GProp_PEquation sealed
    : public RDC::OCC::BaseClass<::GProp_PEquation>
{
...
public:
    GProp_PEquation(::GProp_PEquation* nativeInstance)
        : RDC::OCC::BaseClass<::GProp_PEquation>( nativeInstance, true )
    {}

    GProp_PEquation(::GProp_PEquation& nativeInstance)
        : RDC::OCC::BaseClass<::GProp_PEquation>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GProp_PEquation(RDC::OCC::TColgp_Array1OfPnt^ Pnts, double Tol);
    /// <summary>
    ...
    /// </summary>
    void Box(RDC::OCC::Pnt% P, RDC::OCC::Vec% V1, RDC::OCC::Vec% V2, RDC::OCC::Vec% V3);
}; // class GProp_PEquation
...
public:
    ...
    /// </summary>
    GProp_PGProps(RDC::OCC::TColgp_Array1OfPnt^ Pnts);
    /// <summary>
    /// computes the global properties of the system of points Pnts.
    /// The density of the points are defaulted to all being 1
    /// </summary>
    GProp_PGProps(RDC::OCC::TColgp_Array2OfPnt^ Pnts);
    /// <summary>
    /// computes the global properties of the system of points Pnts.
    ...
    /// is not the same.
    /// </summary>
    GProp_PGProps(RDC::OCC::TColgp_Array1OfPnt^ Pnts, RDC::OCC::TColStd_Array1OfReal^ Density);
    /// <summary>
    /// computes the global properties of the system of points Pnts.
    /// A density is associated with each point.
    /// 
    ...
    /// is not the same.
    /// </summary>
    GProp_PGProps(RDC::OCC::TColgp_Array2OfPnt^ Pnts, RDC::OCC::TColStd_Array2OfReal^ Density);
    /// <summary>
    ...
    /// </summary>
    void AddPoint(RDC::OCC::Pnt P, double Density);
    /// <summary>
    /// Computes the barycentre of a set of points. The density of the
    /// points is defaulted to 1.
    /// </summary>
    static RDC::OCC::Pnt Barycentre(RDC::OCC::TColgp_Array1OfPnt^ Pnts);
    /// <summary>
    /// Computes the barycentre of a set of points. The density of the
    /// points is defaulted to 1.
    /// </summary>
    static RDC::OCC::Pnt Barycentre(RDC::OCC::TColgp_Array2OfPnt^ Pnts);
    /// <summary>
    ...
    /// is not the same.
    /// </summary>
    static void Barycentre(RDC::OCC::TColgp_Array1OfPnt^ Pnts, RDC::OCC::TColStd_Array1OfReal^ Density, double% Mass, RDC::OCC::Pnt% G);
    /// <summary>
    /// Computes the barycentre of a set of points. A density is associated
    /// with each point.
    /// 
    ...
    /// is not the same.
    /// </summary>
    static void Barycentre(RDC::OCC::TColgp_Array2OfPnt^ Pnts, RDC::OCC::TColStd_Array2OfReal^ Density, double% Mass, RDC::OCC::Pnt% G);
}; // class GProp_PGProps
...
public:
    GProp_SelGProps();
    GProp_SelGProps(RDC::OCC::gp_Cylinder^ S, double Alpha1, double Alpha2, double Z1, double Z2, RDC::OCC::Pnt SLocation);
    GProp_SelGProps(RDC::OCC::gp_Cone^ S, double Alpha1, double Alpha2, double Z1, double Z2, RDC::OCC::Pnt SLocation);
    GProp_SelGProps(RDC::OCC::gp_Sphere^ S, double Teta1, double Teta2, double Alpha1, double Alpha2, RDC::OCC::Pnt SLocation);
    GProp_SelGProps(RDC::OCC::gp_Torus^ S, double Teta1, double Teta2, double Alpha1, double Alpha2, RDC::OCC::Pnt SLocation);
    void SetLocation(RDC::OCC::Pnt SLocation);
    void Perform(RDC::OCC::gp_Cylinder^ S, double Alpha1, double Alpha2, double Z1, double Z2);
    void Perform(RDC::OCC::gp_Cone^ S, double Alpha1, double Alpha2, double Z1, double Z2);
    void Perform(RDC::OCC::gp_Sphere^ S, double Teta1, double Teta2, double Alpha1, double Alpha2);
    void Perform(RDC::OCC::gp_Torus^ S, double Teta1, double Teta2, double Alpha1, double Alpha2);
}; // class GProp_SelGProps
...
public:
    ...
    static RDC::OCC::GProp_UndefinedAxis^ NewInstance(System::String^ theMessage);
    static RDC::OCC::GProp_UndefinedAxis^ NewInstance();
    static RDC::OCC::GProp_UndefinedAxis^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::GProp_UndefinedAxis^ CreateDowncasted(::GProp_UndefinedAxis* instance);
}; // class GProp_UndefinedAxis
...
public:
    GProp_VelGProps();
    GProp_VelGProps(RDC::OCC::gp_Cylinder^ S, double Alpha1, double Alpha2, double Z1, double Z2, RDC::OCC::Pnt VLocation);
    GProp_VelGProps(RDC::OCC::gp_Cone^ S, double Alpha1, double Alpha2, double Z1, double Z2, RDC::OCC::Pnt VLocation);
    GProp_VelGProps(RDC::OCC::gp_Sphere^ S, double Teta1, double Teta2, double Alpha1, double Alpha2, RDC::OCC::Pnt VLocation);
    GProp_VelGProps(RDC::OCC::gp_Torus^ S, double Teta1, double Teta2, double Alpha1, double Alpha2, RDC::OCC::Pnt VLocation);
