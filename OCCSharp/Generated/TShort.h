...
public ref class TShort_Array1OfShortReal sealed
    : public RDC::OCC::BaseClass<::TShort_Array1OfShortReal>
...
public:
    TShort_Array1OfShortReal(::TShort_Array1OfShortReal* nativeInstance)
        : RDC::OCC::BaseClass<::TShort_Array1OfShortReal>( nativeInstance, true )
    {}

    TShort_Array1OfShortReal(::TShort_Array1OfShortReal& nativeInstance)
        : RDC::OCC::BaseClass<::TShort_Array1OfShortReal>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::TShort_Array1OfShortReal::Iterator>
    {
    ...
    public:
        Iterator(::TShort_Array1OfShortReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::TShort_Array1OfShortReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::TShort_Array1OfShortReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::TShort_Array1OfShortReal::Iterator>( &nativeInstance, false )
        {}
    ...
    int Lower();
    int Upper();
    RDC::OCC::TShort_Array1OfShortReal^ Assign(RDC::OCC::TShort_Array1OfShortReal^ theOther);
    RDC::OCC::TShort_Array1OfShortReal^ Move(RDC::OCC::TShort_Array1OfShortReal^ theOther);
    float First();
    float Last();
...
public ref class TShort_Array2OfShortReal sealed
    : public RDC::OCC::BaseClass<::TShort_Array2OfShortReal>
{
...
public:
    TShort_Array2OfShortReal(::TShort_Array2OfShortReal* nativeInstance)
        : RDC::OCC::BaseClass<::TShort_Array2OfShortReal>( nativeInstance, true )
    {}

    TShort_Array2OfShortReal(::TShort_Array2OfShortReal& nativeInstance)
        : RDC::OCC::BaseClass<::TShort_Array2OfShortReal>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::TShort_Array2OfShortReal::Iterator>
    {
    ...
    public:
        Iterator(::TShort_Array2OfShortReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::TShort_Array2OfShortReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::TShort_Array2OfShortReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::TShort_Array2OfShortReal::Iterator>( &nativeInstance, false )
        {}
    ...
    int LowerCol();
    int UpperCol();
    RDC::OCC::TShort_Array2OfShortReal^ Assign(RDC::OCC::TShort_Array2OfShortReal^ theOther);
    RDC::OCC::TShort_Array2OfShortReal^ Move(RDC::OCC::TShort_Array2OfShortReal^ theOther);
...
public ref class TShort_SequenceOfShortReal sealed
    : public RDC::OCC::BaseClass<::TShort_SequenceOfShortReal>
    , public IIndexEnumerable<float>
{
...
public:
    TShort_SequenceOfShortReal(::TShort_SequenceOfShortReal* nativeInstance)
        : RDC::OCC::BaseClass<::TShort_SequenceOfShortReal>( nativeInstance, true )
    {}

    TShort_SequenceOfShortReal(::TShort_SequenceOfShortReal& nativeInstance)
        : RDC::OCC::BaseClass<::TShort_SequenceOfShortReal>( &nativeInstance, false )
    {}
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::TShort_SequenceOfShortReal::Iterator>
    {
    ...
    public:
        Iterator(::TShort_SequenceOfShortReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::TShort_SequenceOfShortReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::TShort_SequenceOfShortReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::TShort_SequenceOfShortReal::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        void Next();
        float Value();
        bool IsEqual(RDC::OCC::TShort_SequenceOfShortReal::Iterator^ theOther);
    ...
    TShort_SequenceOfShortReal(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear();
    RDC::OCC::TShort_SequenceOfShortReal^ Assign(RDC::OCC::TShort_SequenceOfShortReal^ theOther);
    void Remove(RDC::OCC::TShort_SequenceOfShortReal::Iterator^ thePosition);
    void Append(float theItem);
    void Prepend(float theItem);
    void InsertBefore(int theIndex, float theItem);
    void InsertAfter(RDC::OCC::TShort_SequenceOfShortReal::Iterator^ thePosition, float theItem);
    void Split(int theIndex, RDC::OCC::TShort_SequenceOfShortReal^ theSeq);
    float First();
    float Last();
    virtual float Value(int theIndex);
    float ChangeValue(int theIndex);
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::TShort_HArray1OfShortReal::Iterator>
    {
    ...
    public:
        Iterator(::TShort_HArray1OfShortReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::TShort_HArray1OfShortReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::TShort_HArray1OfShortReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::TShort_HArray1OfShortReal::Iterator>( &nativeInstance, false )
        {}
    ...
    TShort_HArray1OfShortReal(RDC::OCC::TShort_Array1OfShortReal^ theOther);
    RDC::OCC::TShort_Array1OfShortReal^ Array1();
    RDC::OCC::TShort_Array1OfShortReal^ ChangeArray1();
    void Init(float theValue);
    int Size();
    int Length();
    bool IsEmpty();
    int Lower();
    int Upper();
    RDC::OCC::TShort_HArray1OfShortReal^ Assign(RDC::OCC::TShort_HArray1OfShortReal^ theOther);
    RDC::OCC::TShort_HArray1OfShortReal^ Move(RDC::OCC::TShort_HArray1OfShortReal^ theOther);
    float First();
    float Last();
    virtual float Value(int theIndex);
    float ChangeValue(int theIndex);
    ...
    void Resize(int theLower, int theUpper, bool theToCopyData);
    bool IsDeletable();
    static RDC::OCC::TShort_HArray1OfShortReal^ CreateDowncasted(::TShort_HArray1OfShortReal* instance);
    virtual System::Collections::Generic::IEnumerator<float>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class TShort_HArray1OfShortReal
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::TShort_HArray2OfShortReal::Iterator>
    {
    ...
    public:
        Iterator(::TShort_HArray2OfShortReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::TShort_HArray2OfShortReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::TShort_HArray2OfShortReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::TShort_HArray2OfShortReal::Iterator>( &nativeInstance, false )
        {}
    ...
    TShort_HArray2OfShortReal(RDC::OCC::TShort_Array2OfShortReal^ theOther);
    RDC::OCC::TShort_Array2OfShortReal^ Array2();
    RDC::OCC::TShort_Array2OfShortReal^ ChangeArray2();
    static int BeginPosition(int theRowLower, int parameter1, int theColLower, int theColUpper);
    static int LastPosition(int theRowLower, int theRowUpper, int theColLower, int theColUpper);
    int Size();
    int Length();
    ...
    int LowerCol();
    int UpperCol();
    RDC::OCC::TShort_HArray2OfShortReal^ Assign(RDC::OCC::TShort_HArray2OfShortReal^ theOther);
    RDC::OCC::TShort_HArray2OfShortReal^ Move(RDC::OCC::TShort_HArray2OfShortReal^ theOther);
    float Value(int theRow, int theCol);
    float ChangeValue(int theRow, int theCol);
    void SetValue(int theRow, int theCol, float theItem);
    void Resize(int theRowLower, int theRowUpper, int theColLower, int theColUpper, bool theToCopyData);
    ...
    void UpdateUpperBound(int theUpper);
    bool IsDeletable();
    static RDC::OCC::TShort_HArray2OfShortReal^ CreateDowncasted(::TShort_HArray2OfShortReal* instance);
}; // class TShort_HArray2OfShortReal
...
public:
    ref class Iterator sealed
        : public RDC::OCC::BaseClass<::TShort_HSequenceOfShortReal::Iterator>
    {
    ...
    public:
        Iterator(::TShort_HSequenceOfShortReal::Iterator* nativeInstance)
            : RDC::OCC::BaseClass<::TShort_HSequenceOfShortReal::Iterator>( nativeInstance, true )
        {}

        Iterator(::TShort_HSequenceOfShortReal::Iterator& nativeInstance)
            : RDC::OCC::BaseClass<::TShort_HSequenceOfShortReal::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        void Next();
        float Value();
        bool IsEqual(RDC::OCC::TShort_HSequenceOfShortReal::Iterator^ theOther);
        bool Equals(System::Object^ obj) override;
    }; // class Iterator
    ...
    TShort_HSequenceOfShortReal(RDC::OCC::TShort_SequenceOfShortReal^ theOther);
    RDC::OCC::TShort_SequenceOfShortReal^ Sequence();
    void Append(float theItem);
    void Append(RDC::OCC::TShort_SequenceOfShortReal^ theSequence);
    RDC::OCC::TShort_SequenceOfShortReal^ ChangeSequence();
    int Size();
    int Length();
    int Lower();
    int Upper();
    ...
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::TShort_HSequenceOfShortReal^ Assign(RDC::OCC::TShort_HSequenceOfShortReal^ theOther);
    void Remove(RDC::OCC::TShort_HSequenceOfShortReal::Iterator^ thePosition);
    void Prepend(float theItem);
    void InsertBefore(int theIndex, float theItem);
    void InsertAfter(RDC::OCC::TShort_HSequenceOfShortReal::Iterator^ thePosition, float theItem);
    void Split(int theIndex, RDC::OCC::TShort_HSequenceOfShortReal^ theSeq);
    float First();
    float Last();
    virtual float Value(int theIndex);
    float ChangeValue(int theIndex);
    void SetValue(int theIndex, float theItem);
    static RDC::OCC::TShort_HSequenceOfShortReal^ CreateDowncasted(::TShort_HSequenceOfShortReal* instance);
    virtual System::Collections::Generic::IEnumerator<float>^ GetEnumerator();
    virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
}; // class TShort_HSequenceOfShortReal
