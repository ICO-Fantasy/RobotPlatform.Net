...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class BRepFeat sealed
			: public RDC::OCC::BaseClass<::BRepFeat>
		{
		...
		public:
			BRepFeat(::BRepFeat* nativeInstance)
				: RDC::OCC::BaseClass<::BRepFeat>(nativeInstance, true)
			{}

			BRepFeat(::BRepFeat& nativeInstance)
				: RDC::OCC::BaseClass<::BRepFeat>(&nativeInstance, false)
			{}
		...
		public:
			BRepFeat();
			static void SampleEdges(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TColgp_SequenceOfPnt^ Pt);
			static void Barycenter(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Pnt% Pt);
			static double ParametricBarycenter(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Geom_Curve^ C);
			/// <summary>
			/// Ori = True taking account the orientation
			/// </summary>
			static void ParametricMinMax(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Geom_Curve^ C, double% prmin, double% prmax, double% prbmin, double% prbmax, bool% flag, bool Ori);
			/// <summary>
			/// Ori = True taking account the orientation
			/// </summary>
			static void ParametricMinMax(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Geom_Curve^ C, double% prmin, double% prmax, double% prbmin, double% prbmax, bool% flag);
			static bool IsInside(RDC::OCC::TopoDS_Face^ F1, RDC::OCC::TopoDS_Face^ F2);
			/* Method skipped due to unknown mapping: bool IsInOut(BRepTopAdaptor_FClass2d FC, Geom2dAdaptor_Curve AC, ) */
			static void FaceUntil(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopoDS_Face^ F);
			static RDC::OCC::TopoDS_Solid^ Tool(RDC::OCC::TopoDS_Shape^ SRef, RDC::OCC::TopoDS_Face^ Fac, RDC::OCC::TopAbs_Orientation Orf);
			/// <summary>
			/// Prints the Error description of the State <St> as a String on
			/// the Stream <S> and returns <S>.
			/// </summary>
			static System::IO::TextWriter^ Print(RDC::OCC::BRepFeat_StatusError SE, System::IO::TextWriter^ S);
		}; // class BRepFeat
		...
		protected:
			BRepFeat_Builder(InitMode init)
				: RDC::OCC::BOPAlgo_BOP(init)
			{}

		public:
			BRepFeat_Builder(::BRepFeat_Builder* nativeInstance)
				: RDC::OCC::BOPAlgo_BOP(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::TopoDS_Shape^ theTool);
			/// <summary>
			...
			/// </summary>
			void RebuildEdge(RDC::OCC::TopoDS_Shape^ theE, RDC::OCC::TopoDS_Face^ theF, RDC::OCC::TopTools_MapOfShape^ theME, RDC::OCC::TopTools_ListOfShape^ aLEIm);
			/// <summary>
			...
			/// </summary>
			void FillRemoved(RDC::OCC::TopoDS_Shape^ theS, RDC::OCC::TopTools_MapOfShape^ theM);
		}; // class BRepFeat_Builder
		...
		public:
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Modified(RDC::OCC::TopoDS_Shape^ F);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ NewEdges();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ TgtEdges();
			/// <summary>
			...
			RDC::OCC::Geom_Curve^ BarycCurve();
			RDC::OCC::BRepFeat_StatusError CurrentStatusError();
		}; // class BRepFeat_Form
		...
		public:
			...
			/// </summary>
			BRepFeat_Gluer(RDC::OCC::TopoDS_Shape^ Snew, RDC::OCC::TopoDS_Shape^ Sbase);
			/// <summary>
			/// Initializes the new shape Snew and the basis shape
			/// Sbase for the local glueing operation.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ Snew, RDC::OCC::TopoDS_Shape^ Sbase);
			/// <summary>
			...
			/// </summary>
			void Bind(RDC::OCC::TopoDS_Face^ Fnew, RDC::OCC::TopoDS_Face^ Fbase);
			/// <summary>
			...
			/// the shape creation.
			/// </summary>
			bool IsDeleted(RDC::OCC::TopoDS_Shape^ F);
			/// <summary>
			/// returns the list of generated Faces.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Modified(RDC::OCC::TopoDS_Shape^ F);
		...
		public ref class BRepFeat_MakeCylindricalHole sealed
			: public RDC::OCC::BRepFeat_Builder
		{
		...
		public:
			BRepFeat_MakeCylindricalHole(::BRepFeat_MakeCylindricalHole* nativeInstance)
				: RDC::OCC::BRepFeat_Builder(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			void Init(RDC::OCC::Ax1 Axis);
			/// <summary>
			/// Sets the shape and  axis on which hole(s)  will be
			/// performed.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::Ax1 Axis);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::BRepFeat_Status Status();
			/// <summary>
		...
		public:
			BRepFeat_MakeDPrism(::BRepFeat_MakeDPrism* nativeInstance)
				: RDC::OCC::BRepFeat_Form(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			BRepFeat_MakeDPrism(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Face^ Pbase, RDC::OCC::TopoDS_Face^ Skface, double Angle, int Fuse, bool Modify);
			BRepFeat_MakeDPrism();
			/// <summary>
			...
			/// operation such as glueing can be performed.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Face^ Pbase, RDC::OCC::TopoDS_Face^ Skface, double Angle, int Fuse, bool Modify);
			/// <summary>
			...
			/// </summary>
			void Add(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ OnFace);
			void Perform(double Height);
			void Perform(RDC::OCC::TopoDS_Shape^ Until);
			/// <summary>
			...
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ From, RDC::OCC::TopoDS_Shape^ Until);
			/// <summary>
			...
			/// </summary>
			void PerformFromEnd(RDC::OCC::TopoDS_Shape^ FUntil);
			/// <summary>
			...
			/// </summary>
			void PerformUntilHeight(RDC::OCC::TopoDS_Shape^ Until, double Height);
			/* Method skipped due to unknown mapping: void Curves(TColGeom_SequenceOfCurve S, ) */
			RDC::OCC::Geom_Curve^ BarycCurve();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ TopEdges();
			/// <summary>
			/// Returns the list of TopoDS Edges of the bottom of the boss.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ LatEdges();
		}; // class BRepFeat_MakeDPrism
		...
		public:
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ FacesForDraft();
			/// <summary>
			/// Returns a list of the limiting and glueing edges
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ TgtEdges();
			static double IntPar(RDC::OCC::Geom_Curve^ C, RDC::OCC::Pnt P);
			static RDC::OCC::TopoDS_Face^ ChoiceOfFaces(RDC::OCC::TopTools_ListOfShape^ faces, RDC::OCC::Geom_Curve^ cc, double par, double bnd, RDC::OCC::Geom_Plane^ Pln);
			RDC::OCC::BRepFeat_StatusError CurrentStatusError();
		}; // class BRepFeat_RibSlot
		...
		public ref class BRepFeat_MakeLinearForm sealed
			: public RDC::OCC::BRepFeat_RibSlot
		{
		...
		public:
			BRepFeat_MakeLinearForm(::BRepFeat_MakeLinearForm* nativeInstance)
				: RDC::OCC::BRepFeat_RibSlot(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			BRepFeat_MakeLinearForm(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Wire^ W, RDC::OCC::Geom_Plane^ P, RDC::OCC::Vec Direction, RDC::OCC::Vec Direction1, int Fuse, bool Modify);
			/// <summary>
			...
			/// in case of the rib.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Wire^ W, RDC::OCC::Geom_Plane^ P, RDC::OCC::Vec Direction, RDC::OCC::Vec Direction1, int Fuse, bool Modify);
			/// <summary>
			/// Indicates that the edge <E> will slide on the face
			/// <OnFace>.
			/// Raises ConstructionError if the  face does not belong to the
			...
			/// </summary>
			void Perform();
			bool Propagate(RDC::OCC::TopTools_ListOfShape^ L, RDC::OCC::TopoDS_Face^ F, RDC::OCC::Pnt FPoint, RDC::OCC::Pnt LPoint, bool% falseside);
		}; // class BRepFeat_MakeLinearForm
		...
		public:
			...
			/// </summary>
			BRepFeat_MakePipe(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Shape^ Pbase, RDC::OCC::TopoDS_Face^ Skface, RDC::OCC::TopoDS_Wire^ Spine, int Fuse, bool Modify);
			/// <summary>
			...
			/// shape, a local operation such as glueing can be performed.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Shape^ Pbase, RDC::OCC::TopoDS_Face^ Skface, RDC::OCC::TopoDS_Wire^ Spine, int Fuse, bool Modify);
			/// <summary>
			/// Indicates that the edge <E> will slide on the face
		...
		public:
			...
			/// </summary>
			BRepFeat_MakePrism(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Shape^ Pbase, RDC::OCC::TopoDS_Face^ Skface, RDC::OCC::Dir Direction, int Fuse, bool Modify);
			/// <summary>
			...
			/// shape, a local operation such as glueing can be performed.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Shape^ Pbase, RDC::OCC::TopoDS_Face^ Skface, RDC::OCC::Dir Direction, int Fuse, bool Modify);
			/// <summary>
			/// Indicates that the edge <E> will slide on the face
			/// <OnFace>. Raises ConstructionError if the  face does not belong to the
			/// basis shape, or the edge to the prismed shape.
			...
			/// </summary>
			void PerformUntilHeight(RDC::OCC::TopoDS_Shape^ Until, double Length);
			/* Method skipped due to unknown mapping: void Curves(TColGeom_SequenceOfCurve S, ) */
			/// <summary>
		...
		public:
			...
			/// shape, a local operation such as glueing can be performed.
			/// </summary>
			BRepFeat_MakeRevol(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Shape^ Pbase, RDC::OCC::TopoDS_Face^ Skface, RDC::OCC::Ax1 Axis, int Fuse, bool Modify);
			void Init(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Shape^ Pbase, RDC::OCC::TopoDS_Face^ Skface, RDC::OCC::Ax1 Axis, int Fuse, bool Modify);
			/// <summary>
			/// Indicates that the edge <E> will slide on the face
			/// <OnFace>. Raises ConstructionError if the  face does not belong to the
			/// basis shape, or the edge to the prismed shape.
			...
			/// </summary>
			void PerformUntilAngle(RDC::OCC::TopoDS_Shape^ Until, double Angle);
			/* Method skipped due to unknown mapping: void Curves(TColGeom_SequenceOfCurve S, ) */
			RDC::OCC::Geom_Curve^ BarycCurve();
		}; // class BRepFeat_MakeRevol
		...
		public:
			...
			/// </summary>
			BRepFeat_MakeRevolutionForm(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Wire^ W, RDC::OCC::Geom_Plane^ Plane, RDC::OCC::Ax1 Axis, double Height1, double Height2, int Fuse, bool% Sliding);
			/// <summary>
			/// Initializes this construction algorithm
			...
			/// -   adding matter with Boolean fusion using the setting 1 in case of the rib.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ Sbase, RDC::OCC::TopoDS_Wire^ W, RDC::OCC::Geom_Plane^ Plane, RDC::OCC::Ax1 Axis, double Height1, double Height2, int Fuse, bool% Sliding);
			/// <summary>
			/// Indicates that the edge <E> will slide on the face
			/// <OnFace>. Raises ConstructionError  if the  face does not belong to the
			/// basis shape, or the edge to the prismed shape.
		...
		public:
			...
			/// </summary>
			BRepFeat_SplitShape(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			...
			/// </summary>
			bool Add(RDC::OCC::TopTools_SequenceOfShape^ theEdges);
			/// <summary>
			...
			/// </summary>
			void Add(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Adds the edge <E> on the face <F>.
			/// </summary>
			void Add(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			...
			/// Raises NoSuchObject  if <F> does not belong to the original shape.
			/// </summary>
			void Add(RDC::OCC::TopoDS_Compound^ Comp, RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Adds the edge <E> on the existing edge <EOn>.
			/// </summary>
			void Add(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Edge^ EOn);
			/// <summary>
			/// Returns  the faces   which  are the  left of   the
			/// projected wires.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ DirectLeft();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Left();
			/// <summary>
			/// Returns the faces of the "right" part on the shape.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Right();
			/// <summary>
