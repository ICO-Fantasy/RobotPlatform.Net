...
public ref class IntAna_ListOfCurve sealed
    ...
    , public IEnumerable<RDC::OCC::IntAna_Curve^>
{
...
public:
    ref class Iterator sealed
        : public RDC::OCC::IteratorEnumerator<RDC::OCC::IntAna_Curve^, ::IntAna_ListOfCurve::Iterator>
    {
    ...
    public:
        Iterator(::IntAna_ListOfCurve::Iterator* nativeInstance)
            : RDC::OCC::IteratorEnumerator<RDC::OCC::IntAna_Curve^, ::IntAna_ListOfCurve::Iterator>( nativeInstance, true )
        {}

        Iterator(::IntAna_ListOfCurve::Iterator& nativeInstance)
            : RDC::OCC::IteratorEnumerator<RDC::OCC::IntAna_Curve^, ::IntAna_ListOfCurve::Iterator>( &nativeInstance, false )
        {}
    ...
    public:
        ...
        bool More() override;
        void Next() override;
        RDC::OCC::IntAna_Curve^ Value() override;
        RDC::OCC::IntAna_Curve^ ChangeValue();
    }; // class Iterator

    IntAna_ListOfCurve();
    IntAna_ListOfCurve(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    int Size();
    RDC::OCC::IntAna_ListOfCurve^ Assign(RDC::OCC::IntAna_ListOfCurve^ theOther);
    void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    void Clear();
    RDC::OCC::IntAna_Curve^ First();
    RDC::OCC::IntAna_Curve^ Last();
    RDC::OCC::IntAna_Curve^ Append(RDC::OCC::IntAna_Curve^ theItem);
    RDC::OCC::IntAna_Curve^ Prepend(RDC::OCC::IntAna_Curve^ theItem);
    void RemoveFirst();
    void Remove(RDC::OCC::IntAna_ListOfCurve::Iterator^ theIter);
    RDC::OCC::IntAna_Curve^ InsertBefore(RDC::OCC::IntAna_Curve^ theItem, RDC::OCC::IntAna_ListOfCurve::Iterator^ theIter);
    RDC::OCC::IntAna_Curve^ InsertAfter(RDC::OCC::IntAna_Curve^ theItem, RDC::OCC::IntAna_ListOfCurve::Iterator^ theIter);
    void Reverse();
    virtual System::Collections::Generic::IEnumerator<RDC::OCC::IntAna_Curve^>^ GetEnumerator();
...
public ref class IntAna_ListIteratorOfListOfCurve sealed
    : public RDC::OCC::BaseClass<::IntAna_ListIteratorOfListOfCurve>
{
...
public:
    IntAna_ListIteratorOfListOfCurve(::IntAna_ListIteratorOfListOfCurve* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_ListIteratorOfListOfCurve>( nativeInstance, true )
    {}

    IntAna_ListIteratorOfListOfCurve(::IntAna_ListIteratorOfListOfCurve& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_ListIteratorOfListOfCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    IntAna_ListIteratorOfListOfCurve(RDC::OCC::NCollection_BaseList^ theList);
    bool More();
    void Next();
    RDC::OCC::IntAna_Curve^ Value();
    RDC::OCC::IntAna_Curve^ ChangeValue();
}; // class IntAna_ListIteratorOfListOfCurve
...
public ref class IntAna_Curve sealed
    : public RDC::OCC::BaseClass<::IntAna_Curve>
{
...
public:
    IntAna_Curve(::IntAna_Curve* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_Curve>( nativeInstance, true )
    {}

    IntAna_Curve(::IntAna_Curve& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_Curve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// on the curve.
    /// </summary>
    void SetCylinderQuadValues(RDC::OCC::gp_Cylinder^ Cylinder, double Qxx, double Qyy, double Qzz, double Qxy, double Qxz, double Qyz, double Qx, double Qy, double Qz, double Q1, double Tol, double DomInf, double DomSup, bool TwoZForATheta, bool ZIsPositive);
    /// <summary>
    /// Sets  the parameters used    to compute Points  and
    /// Derivative on the curve.
    /// </summary>
    void SetConeQuadValues(RDC::OCC::gp_Cone^ Cone, double Qxx, double Qyy, double Qzz, double Qxy, double Qxz, double Qyz, double Qx, double Qy, double Qz, double Q1, double Tol, double DomInf, double DomSup, bool TwoZForATheta, bool ZIsPositive);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Pnt Value(double Theta);
    /// <summary>
    /// Returns the point and the first derivative at parameter
    /// Theta on the curve.
    /// </summary>
    bool D1u(double Theta, RDC::OCC::Pnt% P, RDC::OCC::Vec% V);
    /// <summary>
    ...
    /// </summary>
    void FindParameter(RDC::OCC::Pnt P, RDC::OCC::TColStd_ListOfReal^ theParams);
    /// <summary>
...
public ref class IntAna_Int3Pln sealed
    : public RDC::OCC::BaseClass<::IntAna_Int3Pln>
{
...
public:
    IntAna_Int3Pln(::IntAna_Int3Pln* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_Int3Pln>( nativeInstance, true )
    {}

    IntAna_Int3Pln(::IntAna_Int3Pln& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_Int3Pln>( &nativeInstance, false )
    {}
...
public:
    ...
    /// 3 planes.
    /// </summary>
    IntAna_Int3Pln(RDC::OCC::Pln P1, RDC::OCC::Pln P2, RDC::OCC::Pln P3);
    /// <summary>
    /// Determination of the intersection point between
    /// 3 planes.
    /// </summary>
    void Perform(RDC::OCC::Pln P1, RDC::OCC::Pln P2, RDC::OCC::Pln P3);
    /// <summary>
...
public ref class IntAna_Quadric sealed
    : public RDC::OCC::BaseClass<::IntAna_Quadric>
{
...
public:
    IntAna_Quadric(::IntAna_Quadric* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_Quadric>( nativeInstance, true )
    {}

    IntAna_Quadric(::IntAna_Quadric& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_Quadric>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    IntAna_Quadric(RDC::OCC::Pln P);
    /// <summary>
    /// Creates a Quadric from a Sphere
    /// </summary>
    IntAna_Quadric(RDC::OCC::gp_Sphere^ Sph);
    /// <summary>
    /// Creates a Quadric from a Cylinder
    /// </summary>
    IntAna_Quadric(RDC::OCC::gp_Cylinder^ Cyl);
    /// <summary>
    /// Creates a Quadric from a Cone
    /// </summary>
    IntAna_Quadric(RDC::OCC::gp_Cone^ Cone);
    /// <summary>
    /// Initializes the quadric with a Pln
    /// </summary>
    void SetQuadric(RDC::OCC::Pln P);
    /// <summary>
    /// Initialize the quadric with a Sphere
    /// </summary>
    void SetQuadric(RDC::OCC::gp_Sphere^ Sph);
    /// <summary>
    /// Initializes the quadric with a Cone
    /// </summary>
    void SetQuadric(RDC::OCC::gp_Cone^ Con);
    /// <summary>
    /// Initializes the quadric with a Cylinder
    /// </summary>
    void SetQuadric(RDC::OCC::gp_Cylinder^ Cyl);
    /// <summary>
    ...
    /// </summary>
    void NewCoefficients(double% xCXX, double% xCYY, double% xCZZ, double% xCXY, double% xCXZ, double% xCYZ, double% xCX, double% xCY, double% xCZ, double% xCCte, RDC::OCC::Ax3 Axis);
...
public ref class IntAna_IntConicQuad sealed
    : public RDC::OCC::BaseClass<::IntAna_IntConicQuad>
{
...
public:
    IntAna_IntConicQuad(::IntAna_IntConicQuad* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_IntConicQuad>( nativeInstance, true )
    {}

    IntAna_IntConicQuad(::IntAna_IntConicQuad& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_IntConicQuad>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Lin^ L, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Creates the intersection between a circle and a quadric.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Circ^ C, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Creates the intersection between an ellipse and a quadric.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Elips^ E, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Creates the intersection between a parabola and a quadric.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Parab^ P, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Creates the intersection between an hyperbola and
    /// a quadric.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Hypr^ H, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    ...
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Lin^ L, RDC::OCC::Pln P, double Tolang, double Tol, double Len);
    /// <summary>
    /// Intersection between a line and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    ...
    /// on the distance <Len> from the origin of the line.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Lin^ L, RDC::OCC::Pln P, double Tolang, double Tol);
    /// <summary>
    /// Intersection between a line and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    ...
    /// on the distance <Len> from the origin of the line.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Lin^ L, RDC::OCC::Pln P, double Tolang);
    /// <summary>
    ...
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Circ^ C, RDC::OCC::Pln P, double Tolang, double Tol);
    /// <summary>
    ...
    /// Tol is used to determine if a distance is null.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Elips^ E, RDC::OCC::Pln P, double Tolang, double Tol);
    /// <summary>
    /// Intersection between a parabola and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Parab^ Pb, RDC::OCC::Pln P, double Tolang);
    /// <summary>
    /// Intersection between an hyperbola and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    /// </summary>
    IntAna_IntConicQuad(RDC::OCC::gp_Hypr^ H, RDC::OCC::Pln P, double Tolang);
    /// <summary>
    /// Intersects a line and a quadric.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin^ L, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Intersects a circle and a quadric.
    /// </summary>
    void Perform(RDC::OCC::gp_Circ^ C, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Intersects an ellipse and a quadric.
    /// </summary>
    void Perform(RDC::OCC::gp_Elips^ E, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Intersects a parabola and a quadric.
    /// </summary>
    void Perform(RDC::OCC::gp_Parab^ P, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    /// Intersects an hyperbola and a quadric.
    /// </summary>
    void Perform(RDC::OCC::gp_Hypr^ H, RDC::OCC::IntAna_Quadric^ Q);
    /// <summary>
    ...
    /// on the distance <Len> from the origin of the line.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin^ L, RDC::OCC::Pln P, double Tolang, double Tol, double Len);
    /// <summary>
    /// Intersects a line and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    ...
    /// on the distance <Len> from the origin of the line.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin^ L, RDC::OCC::Pln P, double Tolang, double Tol);
    /// <summary>
    /// Intersects a line and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    ...
    /// on the distance <Len> from the origin of the line.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin^ L, RDC::OCC::Pln P, double Tolang);
    /// <summary>
    ...
    /// Tol is used to determine if a distance is null.
    /// </summary>
    void Perform(RDC::OCC::gp_Circ^ C, RDC::OCC::Pln P, double Tolang, double Tol);
    /// <summary>
    ...
    /// Tol is used to determine if a distance is null.
    /// </summary>
    void Perform(RDC::OCC::gp_Elips^ E, RDC::OCC::Pln P, double Tolang, double Tol);
    /// <summary>
    /// Intersects a parabola and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    /// </summary>
    void Perform(RDC::OCC::gp_Parab^ Pb, RDC::OCC::Pln P, double Tolang);
    /// <summary>
    /// Intersects an hyperbola and a plane.
    /// Tolang is used to determine if the angle between two
    /// vectors is null.
    /// </summary>
    void Perform(RDC::OCC::gp_Hypr^ H, RDC::OCC::Pln P, double Tolang);
    /// <summary>
...
public ref class IntAna_IntLinTorus sealed
    : public RDC::OCC::BaseClass<::IntAna_IntLinTorus>
{
...
public:
    IntAna_IntLinTorus(::IntAna_IntLinTorus* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_IntLinTorus>( nativeInstance, true )
    {}

    IntAna_IntLinTorus(::IntAna_IntLinTorus& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_IntLinTorus>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    IntAna_IntLinTorus(RDC::OCC::gp_Lin^ L, RDC::OCC::gp_Torus^ T);
    /// <summary>
    /// Intersects a line and a torus.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin^ L, RDC::OCC::gp_Torus^ T);
    /// <summary>
    /// Returns True if the computation was successful.
    /// </summary>
    bool IsDone();
...
public ref class IntAna_IntQuadQuad sealed
    : public RDC::OCC::BaseClass<::IntAna_IntQuadQuad>
{
...
public:
    IntAna_IntQuadQuad(::IntAna_IntQuadQuad* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_IntQuadQuad>( nativeInstance, true )
    {}

    IntAna_IntQuadQuad(::IntAna_IntQuadQuad& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_IntQuadQuad>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    IntAna_IntQuadQuad(RDC::OCC::gp_Cylinder^ C, RDC::OCC::IntAna_Quadric^ Q, double Tol);
    /// <summary>
    /// Creates the intersection between a cone and a quadric.
    /// Tol est a definir plus precisemment.
    /// </summary>
    IntAna_IntQuadQuad(RDC::OCC::gp_Cone^ C, RDC::OCC::IntAna_Quadric^ Q, double Tol);
    /// <summary>
    /// Intersects a cylinder and a quadric .
    /// Tol est a definir plus precisemment.
    /// </summary>
    void Perform(RDC::OCC::gp_Cylinder^ C, RDC::OCC::IntAna_Quadric^ Q, double Tol);
    /// <summary>
    /// Intersects a cone and a quadric.
    /// Tol est a definir plus precisemment.
    /// </summary>
    void Perform(RDC::OCC::gp_Cone^ C, RDC::OCC::IntAna_Quadric^ Q, double Tol);
    /// <summary>
    /// Returns True if the computation was successful.
    /// </summary>
    bool IsDone();
    ...
    /// </summary>
    RDC::OCC::IntAna_Curve^ Curve(int N);
    /// <summary>
...
public ref class IntAna_QuadQuadGeo sealed
    : public RDC::OCC::BaseClass<::IntAna_QuadQuadGeo>
{
...
public:
    IntAna_QuadQuadGeo(::IntAna_QuadQuadGeo* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_QuadQuadGeo>( nativeInstance, true )
    {}

    IntAna_QuadQuadGeo(::IntAna_QuadQuadGeo& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna_QuadQuadGeo>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::Pln P1, RDC::OCC::Pln P2, double TolAng, double Tol);
    /// <summary>
    ...
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::Pln P, RDC::OCC::gp_Cylinder^ C, double Tolang, double Tol, double H);
    /// <summary>
    /// Creates the intersection between a plane and a cylinder.
    /// TolAng is the angular tolerance used to determine
    /// if the axis of the cylinder is parallel to the plane.
    ...
    /// whether the plane and cylinder are parallel.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::Pln P, RDC::OCC::gp_Cylinder^ C, double Tolang, double Tol);
    /// <summary>
    /// Creates the intersection between a plane and a sphere.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::Pln P, RDC::OCC::gp_Sphere^ S);
    /// <summary>
    ...
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::Pln P, RDC::OCC::gp_Cone^ C, double Tolang, double Tol);
    /// <summary>
    /// Creates the intersection between two cylinders.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Cylinder^ Cyl1, RDC::OCC::gp_Cylinder^ Cyl2, double Tol);
    /// <summary>
    /// Creates the intersection between a Cylinder and a Sphere.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Cylinder^ Cyl, RDC::OCC::gp_Sphere^ Sph, double Tol);
    /// <summary>
    /// Creates the intersection between a Cylinder and a Cone
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Cylinder^ Cyl, RDC::OCC::gp_Cone^ Con, double Tol);
    /// <summary>
    /// Creates the intersection between two Spheres.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Sphere^ Sph1, RDC::OCC::gp_Sphere^ Sph2, double Tol);
    /// <summary>
    /// Creates the intersection between a Sphere and a Cone.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Sphere^ Sph, RDC::OCC::gp_Cone^ Con, double Tol);
    /// <summary>
    /// Creates the intersection between two cones.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Cone^ Con1, RDC::OCC::gp_Cone^ Con2, double Tol);
    /// <summary>
    /// Creates the intersection between plane and torus.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::Pln Pln, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Creates the intersection between cylinder and torus.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Cylinder^ Cyl, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Creates the intersection between cone and torus.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Cone^ Con, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Creates the intersection between sphere and torus.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Sphere^ Sph, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Creates the intersection between two toruses.
    /// </summary>
    IntAna_QuadQuadGeo(RDC::OCC::gp_Torus^ Tor1, RDC::OCC::gp_Torus^ Tor2, double Tol);
    /// <summary>
    ...
    /// are identical (only when they are parallel).
    /// </summary>
    void Perform(RDC::OCC::Pln P1, RDC::OCC::Pln P2, double TolAng, double Tol);
    /// <summary>
    ...
    /// whether the plane and cylinder are parallel.
    /// </summary>
    void Perform(RDC::OCC::Pln P, RDC::OCC::gp_Cylinder^ C, double Tolang, double Tol, double H);
    /// <summary>
    /// Intersects a plane and a cylinder.
    /// TolAng is the angular tolerance used to determine
    /// if the axis of the cylinder is parallel to the plane.
    ...
    /// whether the plane and cylinder are parallel.
    /// </summary>
    void Perform(RDC::OCC::Pln P, RDC::OCC::gp_Cylinder^ C, double Tolang, double Tol);
    /// <summary>
    /// Intersects a plane and a sphere.
    /// </summary>
    void Perform(RDC::OCC::Pln P, RDC::OCC::gp_Sphere^ S);
    /// <summary>
    ...
    /// of the cone is in the plane.
    /// </summary>
    void Perform(RDC::OCC::Pln P, RDC::OCC::gp_Cone^ C, double Tolang, double Tol);
    /// <summary>
    /// Intersects two cylinders
    /// </summary>
    void Perform(RDC::OCC::gp_Cylinder^ Cyl1, RDC::OCC::gp_Cylinder^ Cyl2, double Tol);
    /// <summary>
    /// Intersects a cylinder and a sphere.
    /// </summary>
    void Perform(RDC::OCC::gp_Cylinder^ Cyl, RDC::OCC::gp_Sphere^ Sph, double Tol);
    /// <summary>
    /// Intersects a cylinder and a cone.
    /// </summary>
    void Perform(RDC::OCC::gp_Cylinder^ Cyl, RDC::OCC::gp_Cone^ Con, double Tol);
    /// <summary>
    /// Intersects a two spheres.
    /// </summary>
    void Perform(RDC::OCC::gp_Sphere^ Sph1, RDC::OCC::gp_Sphere^ Sph2, double Tol);
    /// <summary>
    /// Intersects a sphere and a cone.
    /// </summary>
    void Perform(RDC::OCC::gp_Sphere^ Sph, RDC::OCC::gp_Cone^ Con, double Tol);
    /// <summary>
    /// Intersects two cones.
    /// </summary>
    void Perform(RDC::OCC::gp_Cone^ Con1, RDC::OCC::gp_Cone^ Con2, double Tol);
    /// <summary>
    /// Intersects plane and torus.
    /// </summary>
    void Perform(RDC::OCC::Pln Pln, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Intersects cylinder and torus.
    /// </summary>
    void Perform(RDC::OCC::gp_Cylinder^ Cyl, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Intersects cone and torus.
    /// </summary>
    void Perform(RDC::OCC::gp_Cone^ Con, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Intersects sphere and torus.
    /// </summary>
    void Perform(RDC::OCC::gp_Sphere^ Sph, RDC::OCC::gp_Torus^ Tor, double Tol);
    /// <summary>
    /// Intersects two toruses.
    /// </summary>
    void Perform(RDC::OCC::gp_Torus^ Tor1, RDC::OCC::gp_Torus^ Tor2, double Tol);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::IntAna_ResultType TypeInter();
    /// <summary>
