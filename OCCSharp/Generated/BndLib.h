...
public ref class BndLib sealed
    : public RDC::OCC::BaseClass<::BndLib>
{
...
public:
    BndLib(::BndLib* nativeInstance)
        : RDC::OCC::BaseClass<::BndLib>( nativeInstance, true )
    {}

    BndLib(::BndLib& nativeInstance)
        : RDC::OCC::BaseClass<::BndLib>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void Add(RDC::OCC::gp_Lin^ L, double P1, double P2, double Tol, RDC::OCC::Bnd_Box^ B);
    static void Add(RDC::OCC::gp_Lin2d^ L, double P1, double P2, double Tol, RDC::OCC::Bnd_Box2d^ B);
    static void Add(RDC::OCC::gp_Circ^ C, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// P2-P1 can be in [0,2*pi]
    /// </summary>
    static void Add(RDC::OCC::gp_Circ^ C, double P1, double P2, double Tol, RDC::OCC::Bnd_Box^ B);
    static void Add(RDC::OCC::gp_Circ2d^ C, double Tol, RDC::OCC::Bnd_Box2d^ B);
    /// <summary>
    ...
    /// P2-P1 can be in [0,2*pi]
    /// </summary>
    static void Add(RDC::OCC::gp_Circ2d^ C, double P1, double P2, double Tol, RDC::OCC::Bnd_Box2d^ B);
    static void Add(RDC::OCC::gp_Elips^ C, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// P2-P1 can be in [0,2*pi]
    /// </summary>
    static void Add(RDC::OCC::gp_Elips^ C, double P1, double P2, double Tol, RDC::OCC::Bnd_Box^ B);
    static void Add(RDC::OCC::gp_Elips2d^ C, double Tol, RDC::OCC::Bnd_Box2d^ B);
    /// <summary>
    ...
    /// P2-P1 can be in [0,2*pi]
    /// </summary>
    static void Add(RDC::OCC::gp_Elips2d^ C, double P1, double P2, double Tol, RDC::OCC::Bnd_Box2d^ B);
    static void Add(RDC::OCC::gp_Parab^ P, double P1, double P2, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    ...
    /// infinite real numbers, or two positive infinite real numbers.
    /// </summary>
    static void Add(RDC::OCC::gp_Parab2d^ P, double P1, double P2, double Tol, RDC::OCC::Bnd_Box2d^ B);
    static void Add(RDC::OCC::gp_Hypr^ H, double P1, double P2, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    ...
    /// infinite real numbers, or two positive infinite real numbers.
    /// </summary>
    static void Add(RDC::OCC::gp_Hypr2d^ H, double P1, double P2, double Tol, RDC::OCC::Bnd_Box2d^ B);
    /// <summary>
    /// UMax -UMin can be in [0,2*pi]
    /// </summary>
    static void Add(RDC::OCC::gp_Cylinder^ S, double UMin, double UMax, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    ...
    /// </summary>
    static void Add(RDC::OCC::gp_Cylinder^ S, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// UMax-UMin can be in [0,2*pi]
    /// </summary>
    static void Add(RDC::OCC::gp_Cone^ S, double UMin, double UMax, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    ...
    /// negative infinite real numbers, or two positive infinite real numbers.
    /// </summary>
    static void Add(RDC::OCC::gp_Cone^ S, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
    static void Add(RDC::OCC::gp_Sphere^ S, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    ...
    /// </summary>
    static void Add(RDC::OCC::gp_Sphere^ S, double UMin, double UMax, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
    static void Add(RDC::OCC::gp_Torus^ P, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    ...
    /// VMin,VMax can be [-pi/2,pi/2]
    /// </summary>
    static void Add(RDC::OCC::gp_Torus^ P, double UMin, double UMax, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
}; // class BndLib
...
public ref class BndLib_Add2dCurve sealed
    : public RDC::OCC::BaseClass<::BndLib_Add2dCurve>
{
...
public:
    BndLib_Add2dCurve(::BndLib_Add2dCurve* nativeInstance)
        : RDC::OCC::BaseClass<::BndLib_Add2dCurve>( nativeInstance, true )
    {}

    BndLib_Add2dCurve(::BndLib_Add2dCurve& nativeInstance)
        : RDC::OCC::BaseClass<::BndLib_Add2dCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void Add(RDC::OCC::Adaptor2d_Curve2d^ C, double Tol, RDC::OCC::Bnd_Box2d^ B);
    /// <summary>
    ...
    /// numbers, or two positive infinite real numbers.
    /// </summary>
    static void Add(RDC::OCC::Adaptor2d_Curve2d^ C, double U1, double U2, double Tol, RDC::OCC::Bnd_Box2d^ B);
    /// <summary>
    /// Adds to the bounding box B the curve C
    /// B is then enlarged by the tolerance value Tol.
    /// Note: depending on the type of curve, one of the following
    ...
    /// -   if not, the points of an approximation of the curve C.
    /// </summary>
    static void Add(RDC::OCC::Geom2d_Curve^ C, double Tol, RDC::OCC::Bnd_Box2d^ Box);
    /// <summary>
    ...
    /// -   if not, the points of an approximation of the curve C.
    /// </summary>
    static void Add(RDC::OCC::Geom2d_Curve^ C, double U1, double U2, double Tol, RDC::OCC::Bnd_Box2d^ B);
    /// <summary>
    /// Adds to the bounding box B the part of curve C
    /// B is then enlarged by the tolerance value Tol.
    /// U1, U2 - the parametric range to compute the bounding box;
    ...
    /// </summary>
    static void AddOptimal(RDC::OCC::Geom2d_Curve^ C, double U1, double U2, double Tol, RDC::OCC::Bnd_Box2d^ B);
}; // class BndLib_Add2dCurve
...
public ref class BndLib_Add3dCurve sealed
    : public RDC::OCC::BaseClass<::BndLib_Add3dCurve>
{
...
public:
    BndLib_Add3dCurve(::BndLib_Add3dCurve* nativeInstance)
        : RDC::OCC::BaseClass<::BndLib_Add3dCurve>( nativeInstance, true )
    {}

    BndLib_Add3dCurve(::BndLib_Add3dCurve& nativeInstance)
        : RDC::OCC::BaseClass<::BndLib_Add3dCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// numbers, or two positive infinite real numbers.
    /// </summary>
    static void Add(RDC::OCC::Adaptor3d_Curve^ C, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds to the bounding box B the curve C
    ...
    /// numbers, or two positive infinite real numbers.
    /// </summary>
    static void Add(RDC::OCC::Adaptor3d_Curve^ C, double U1, double U2, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds to the bounding box B the curve C
    /// These methods use more precise algorithms for building bnd box
    /// then methods Add(...)
    /// </summary>
    static void AddOptimal(RDC::OCC::Adaptor3d_Curve^ C, double Tol, RDC::OCC::Bnd_Box^ B);
    static void AddOptimal(RDC::OCC::Adaptor3d_Curve^ C, double U1, double U2, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds to the bounding box B the curve C
    ...
    /// </summary>
    static void AddGenCurv(RDC::OCC::Adaptor3d_Curve^ C, double UMin, double UMax, double Tol, RDC::OCC::Bnd_Box^ B);
}; // class BndLib_Add3dCurve
...
public ref class BndLib_AddSurface sealed
    : public RDC::OCC::BaseClass<::BndLib_AddSurface>
{
...
public:
    BndLib_AddSurface(::BndLib_AddSurface* nativeInstance)
        : RDC::OCC::BaseClass<::BndLib_AddSurface>( nativeInstance, true )
    {}

    BndLib_AddSurface(::BndLib_AddSurface& nativeInstance)
        : RDC::OCC::BaseClass<::BndLib_AddSurface>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void Add(RDC::OCC::Adaptor3d_Surface^ S, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds to the bounding box B the surface S
    ...
    /// AddSurface::Add ( S, Tol, B );
    /// </summary>
    static void Add(RDC::OCC::Adaptor3d_Surface^ S, double UMin, double UMax, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds the surface S to the bounding box B.
    /// This algorithm builds precise bounding box
    /// </summary>
    static void AddOptimal(RDC::OCC::Adaptor3d_Surface^ S, double Tol, RDC::OCC::Bnd_Box^ B);
    static void AddOptimal(RDC::OCC::Adaptor3d_Surface^ S, double UMin, double UMax, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
    /// <summary>
    /// Adds to the bounding box B the surface S
    /// using numerical minimization algorithms
    ...
    /// if Tol < Precision::Confusion(), Precision::Confusion is used as computation tolerance
    /// </summary>
    static void AddGenSurf(RDC::OCC::Adaptor3d_Surface^ S, double UMin, double UMax, double VMin, double VMax, double Tol, RDC::OCC::Bnd_Box^ B);
}; // class BndLib_AddSurface
