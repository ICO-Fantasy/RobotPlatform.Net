...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class gce_Root
			: public RDC::OCC::BaseClass<::gce_Root>
		{
		...
		protected:
			gce_Root(InitMode init)
				: RDC::OCC::BaseClass<::gce_Root>(init)
			{}

		public:
			gce_Root(::gce_Root* nativeInstance)
				: RDC::OCC::BaseClass<::gce_Root>(nativeInstance, true)
			{}

			gce_Root(::gce_Root& nativeInstance)
				: RDC::OCC::BaseClass<::gce_Root>(&nativeInstance, false)
			{}
		...
		public:
			gce_MakeCirc(::gce_MakeCirc* nativeInstance)
				: RDC::OCC::gce_Root(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			gce_MakeCirc(RDC::OCC::Ax2 A2, double Radius);
			/// <summary>
			...
			/// circle <Circ>.
			/// </summary>
			gce_MakeCirc(RDC::OCC::gp_Circ^ Circ, double Dist);
			/// <summary>
			/// Makes a Circ from gp <TheCirc> coaxial to another
			/// Circ <Circ> and passing through a Pnt2d <Point>.
			/// </summary>
			gce_MakeCirc(RDC::OCC::gp_Circ^ Circ, RDC::OCC::Pnt Point);
			/// <summary>
			/// Makes a Circ from gp <TheCirc> passing through 3
			/// Pnt2d <P1>,<P2>,<P3>.
			/// </summary>
			gce_MakeCirc(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3);
			/// <summary>
			/// Makes a Circ from gp <TheCirc> with its center
			/// <Center> and the normal of its plane <Norm> and
			/// its radius <Radius>.
			/// </summary>
			gce_MakeCirc(RDC::OCC::Pnt Center, RDC::OCC::Dir Norm, double Radius);
			/// <summary>
			/// Makes a Circ from gp <TheCirc> with its center
			/// <Center> and the normal of its plane <Plane> and
			/// its radius <Radius>.
			/// </summary>
			gce_MakeCirc(RDC::OCC::Pnt Center, RDC::OCC::Pln Plane, double Radius);
			/// <summary>
			/// Makes a Circ from gp <TheCirc> with its center
			/// <Center> and a point <Ptaxis> giving the normal
			/// of its plane <Plane> and its radius <Radius>.
			/// </summary>
			gce_MakeCirc(RDC::OCC::Pnt Center, RDC::OCC::Pnt Ptaxis, double Radius);
			/// <summary>
			/// Makes a Circ from gp <TheCirc> with its center
			...
			/// </summary>
			gce_MakeCirc(RDC::OCC::Ax1 Axis, double Radius);
			/// <summary>
			/// Returns the constructed circle.
			/// Exceptions StdFail_NotDone if no circle is constructed.
			/// </summary>
			RDC::OCC::gp_Circ^ Value();
			RDC::OCC::gp_Circ^ Operator();
		}; // class gce_MakeCirc
		...
		public:
			...
			/// The status is "NegativeRadius" if Radius < 0.0.
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Ax2d XAxis, double Radius, bool Sense);
			/// <summary>
			/// The location point of XAxis is the center of the circle.
			/// Warnings :
			/// It is not forbidden to create a circle with Radius = 0.0
			...
			/// The status is "NegativeRadius" if Radius < 0.0.
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Ax2d XAxis, double Radius);
			/// <summary>
			/// The location point of Axis is the center of the circle.
			/// Warnings :
			/// It is not forbidden to create a circle with Radius = 0.0
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Ax22d Axis, double Radius);
			/// <summary>
			...
			/// same as Circ.
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::gp_Circ2d^ Circ, double Dist);
			/// <summary>
			/// Makes a Circ2d from gp <TheCirc> concentric with another
			...
			/// same as Circ.
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::gp_Circ2d^ Circ, RDC::OCC::Pnt2d Point);
			/// <summary>
			...
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2, RDC::OCC::Pnt2d P3);
			/// <summary>
			...
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Pnt2d Center, double Radius, bool Sense);
			/// <summary>
			/// Makes a Circ2d from gp <TheCirc> with its center
			/// <Center> and its radius <Radius>.
			/// If Sense is true the local coordinate system of
			/// the solution is direct and non direct in the other case.
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Pnt2d Center, double Radius);
			/// <summary>
			/// Makes a Circ2d from gp <TheCirc> with its center
			...
			/// the solution is direct and non direct in the other case.
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Pnt2d Center, RDC::OCC::Pnt2d Point, bool Sense);
			/// <summary>
			/// Makes a Circ2d from gp <TheCirc> with its center
			/// <Center> and a point giving the radius.
			/// If Sense is true the local coordinate system of
			/// the solution is direct and non direct in the other case.
			/// </summary>
			gce_MakeCirc2d(RDC::OCC::Pnt2d Center, RDC::OCC::Pnt2d Point);
			/// <summary>
			/// Returns the constructed circle.
			/// Exceptions StdFail_NotDone if no circle is constructed.
			/// </summary>
			RDC::OCC::gp_Circ2d^ Value();
			RDC::OCC::gp_Circ2d^ Operator();
		}; // class gce_MakeCirc2d
		...
		public:
			...
			/// </summary>
			gce_MakeCone(RDC::OCC::Ax2 A2, double Ang, double Radius);
			/// <summary>
			/// Makes a Cone from gp <TheCone> coaxial to another
			/// Cone <Cone> and passing through a Pnt <Point>.
			/// </summary>
			gce_MakeCone(RDC::OCC::gp_Cone^ Cone, RDC::OCC::Pnt Point);
			/// <summary>
			/// Makes a Cone from gp <TheCone> coaxial to another
			/// Cone <Cone> at the distance <Dist> which can
			/// be greater or lower than zero.
			/// </summary>
			gce_MakeCone(RDC::OCC::gp_Cone^ Cone, double Dist);
			/// <summary>
			...
			/// "NullAngle".
			/// </summary>
			gce_MakeCone(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3, RDC::OCC::Pnt P4);
			/// <summary>
			...
			/// "ConfusedPoints"
			/// </summary>
			gce_MakeCone(RDC::OCC::Ax1 Axis, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			/// <summary>
			/// Makes a Cone by its axis <Axis> and two points.
			/// The distance between <P1> and the axis is the radius
			/// of the section passing through <P1>
			...
			/// "ConfusedPoints"
			/// </summary>
			gce_MakeCone(RDC::OCC::gp_Lin^ Axis, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			/// <summary>
			...
			/// </summary>
			gce_MakeCone(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double R1, double R2);
			/// <summary>
			/// Returns the constructed cone.
			/// Exceptions StdFail_NotDone if no cone is constructed.
			/// </summary>
			RDC::OCC::gp_Cone^ Value();
			RDC::OCC::gp_Cone^ Operator();
		}; // class gce_MakeCone
		...
		public:
			...
			/// </summary>
			gce_MakeCylinder(RDC::OCC::gp_Cylinder^ Cyl, double Dist);
			/// <summary>
			...
			/// between <P3> and <P1P2>
			/// </summary>
			gce_MakeCylinder(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3);
			/// <summary>
			/// Makes a Cylinder by its axis <Axis> and radius <Radius>.
			/// </summary>
			gce_MakeCylinder(RDC::OCC::Ax1 Axis, double Radius);
			/// <summary>
			...
			/// </summary>
			gce_MakeCylinder(RDC::OCC::gp_Circ^ Circ);
			/// <summary>
			/// Returns the constructed cylinder.
			/// Exceptions StdFail_NotDone if no cylinder is constructed.
			/// </summary>
			RDC::OCC::gp_Cylinder^ Value();
			RDC::OCC::gp_Cylinder^ Operator();
		}; // class gce_MakeCylinder
		...
		public:
			...
			/// Status is "NullVector" if V.Magnitude() <= Resolution.
			/// </summary>
			gce_MakeDir2d(RDC::OCC::Vec2d V);
			/// <summary>
			/// Creates a direction from a triplet of coordinates.
			/// Status is "NullVector" if Coord.Modulus() <=
			/// Resolution from gp.
			/// </summary>
			gce_MakeDir2d(RDC::OCC::XY Coord);
			/// <summary>
			/// Creates a direction with its 3 cartesian coordinates.
			...
			/// -   Sqrt(Xv*Xv + Yv*Yv).
			/// </summary>
			gce_MakeDir2d(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			/// <summary>
			/// Returns the constructed unit vector.
			/// Exceptions StdFail_NotDone if no unit vector is constructed.
			/// </summary>
			RDC::OCC::Dir2d Value();
			RDC::OCC::Dir2d Operator();
		}; // class gce_MakeDir2d
		...
		public:
			...
			/// </summary>
			gce_MakeElips(RDC::OCC::Ax2 A2, double MajorRadius, double MinorRadius);
			/// <summary>
			...
			/// </summary>
			gce_MakeElips(RDC::OCC::Pnt S1, RDC::OCC::Pnt S2, RDC::OCC::Pnt Center);
			/// <summary>
			/// Returns the constructed ellipse.
			/// Exceptions StdFail_NotDone if no ellipse is constructed.
			/// </summary>
			RDC::OCC::gp_Elips^ Value();
			RDC::OCC::gp_Elips^ Operator();
		}; // class gce_MakeElips
		...
		public:
			...
			/// </summary>
			gce_MakeElips2d(RDC::OCC::Ax2d MajorAxis, double MajorRadius, double MinorRadius, bool Sense);
			/// <summary>
			/// Creates an ellipse with the major axis, the major and the
			/// minor radius. The location of the MajorAxis is the center
			/// of the  ellipse.
			...
			/// "NegativeRadius" if MinorRadius < 0.0
			/// </summary>
			gce_MakeElips2d(RDC::OCC::Ax2d MajorAxis, double MajorRadius, double MinorRadius);
			/// <summary>
			...
			/// "NegativeRadius" if MinorRadius < 0.0
			/// </summary>
			gce_MakeElips2d(RDC::OCC::Ax22d A, double MajorRadius, double MinorRadius);
			/// <summary>
			...
			/// </summary>
			gce_MakeElips2d(RDC::OCC::Pnt2d S1, RDC::OCC::Pnt2d S2, RDC::OCC::Pnt2d Center);
			/// <summary>
			/// Returns the constructed ellipse.
			/// Exceptions StdFail_NotDone if no ellipse is constructed.
			/// </summary>
			RDC::OCC::gp_Elips2d^ Value();
			RDC::OCC::gp_Elips2d^ Operator();
		}; // class gce_MakeElips2d
		...
		public:
			...
			/// </summary>
			gce_MakeHypr(RDC::OCC::Ax2 A2, double MajorRadius, double MinorRadius);
			/// <summary>
			...
			/// </summary>
			gce_MakeHypr(RDC::OCC::Pnt S1, RDC::OCC::Pnt S2, RDC::OCC::Pnt Center);
			/// <summary>
			/// Returns the constructed hyperbola.
			/// Exceptions StdFail_NotDone if no hyperbola is constructed.
			/// </summary>
			RDC::OCC::gp_Hypr^ Value();
			RDC::OCC::gp_Hypr^ Operator();
		}; // class gce_MakeHypr
		...
		public:
			...
			/// </summary>
			gce_MakeHypr2d(RDC::OCC::Pnt2d S1, RDC::OCC::Pnt2d S2, RDC::OCC::Pnt2d Center);
			/// <summary>
			...
			/// </summary>
			gce_MakeHypr2d(RDC::OCC::Ax2d MajorAxis, double MajorRadius, double MinorRadius, bool Sense);
			/// <summary>
			...
			/// of A (A is the local coordinate system of the hyperbola).
			/// </summary>
			gce_MakeHypr2d(RDC::OCC::Ax22d A, double MajorRadius, double MinorRadius);
			/// <summary>
			/// Returns the constructed hyperbola.
			/// Exceptions StdFail_NotDone if no hyperbola is constructed.
			/// </summary>
			RDC::OCC::gp_Hypr2d^ Value();
			RDC::OCC::gp_Hypr2d^ Operator();
		}; // class gce_MakeHypr2d
		...
		public:
			...
			/// </summary>
			gce_MakeLin(RDC::OCC::Ax1 A1);
			/// <summary>
			/// <P> is the location point (origin) of the line and
			/// <V> is the direction of the line.
			/// </summary>
			gce_MakeLin(RDC::OCC::Pnt P, RDC::OCC::Dir V);
			/// <summary>
			/// Make a Lin from gp <TheLin> parallel to another
			/// Lin <Lin> and passing through a Pnt <Point>.
			/// </summary>
			gce_MakeLin(RDC::OCC::gp_Lin^ Lin, RDC::OCC::Pnt Point);
			/// <summary>
			/// Make a Lin from gp <TheLin> passing through 2
			/// Pnt <P1>,<P2>.
			/// It returns false if <p1> and <P2> are confused.
			/// </summary>
			gce_MakeLin(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			/// <summary>
			/// Returns the constructed line.
			/// Exceptions StdFail_NotDone is raised if no line is constructed.
			/// </summary>
			RDC::OCC::gp_Lin^ Value();
			RDC::OCC::gp_Lin^ Operator();
		}; // class gce_MakeLin
		...
		public:
			...
			/// </summary>
			gce_MakeLin2d(RDC::OCC::Ax2d A);
			/// <summary>
			/// <P> is the location point (origin) of the line and
			/// <V> is the direction of the line.
			/// </summary>
			gce_MakeLin2d(RDC::OCC::Pnt2d P, RDC::OCC::Dir2d V);
			/// <summary>
			...
			/// </summary>
			gce_MakeLin2d(RDC::OCC::gp_Lin2d^ Lin, double Dist);
			/// <summary>
			/// Make a Lin2d from gp <TheLin> parallel to another
			/// Lin2d <Lin> and passing through a Pnt2d <Point>.
			/// </summary>
			gce_MakeLin2d(RDC::OCC::gp_Lin2d^ Lin, RDC::OCC::Pnt2d Point);
			/// <summary>
			...
			/// -   gce_ConfusedPoints if points P1 and P2 are coincident.
			/// </summary>
			gce_MakeLin2d(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			/// <summary>
			/// Returns the constructed line.
			/// Exceptions StdFail_NotDone if no line is constructed.
			/// </summary>
			RDC::OCC::gp_Lin2d^ Value();
			RDC::OCC::gp_Lin2d^ Operator();
		}; // class gce_MakeLin2d
		...
		public ref class gce_MakeMirror sealed
			: public RDC::OCC::BaseClass<::gce_MakeMirror>
		{
		...
		public:
			gce_MakeMirror(::gce_MakeMirror* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeMirror>(nativeInstance, true)
			{}

			gce_MakeMirror(::gce_MakeMirror& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeMirror>(&nativeInstance, false)
			{}
		...
		public:
			gce_MakeMirror(RDC::OCC::Pnt Point);
			gce_MakeMirror(RDC::OCC::Ax1 Axis);
			gce_MakeMirror(RDC::OCC::gp_Lin^ Line);
			/// <summary>
			/// Makes a symmetry transformation af axis defined by
			/// <Point> and <Direc>.
			/// </summary>
			gce_MakeMirror(RDC::OCC::Pnt Point, RDC::OCC::Dir Direc);
			/// <summary>
			/// Makes a symmetry transformation of plane <Plane>.
			/// </summary>
			gce_MakeMirror(RDC::OCC::Pln Plane);
			/// <summary>
			/// Makes a symmetry transformation of plane <Plane>.
			/// </summary>
			gce_MakeMirror(RDC::OCC::Ax2 Plane);
			/// <summary>
			/// Returns the constructed transformation.
			/// </summary>
			RDC::OCC::Trsf Value();
			RDC::OCC::Trsf Operator();
		}; // class gce_MakeMirror
		...
		public ref class gce_MakeMirror2d sealed
			: public RDC::OCC::BaseClass<::gce_MakeMirror2d>
		{
		...
		public:
			gce_MakeMirror2d(::gce_MakeMirror2d* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeMirror2d>(nativeInstance, true)
			{}

			gce_MakeMirror2d(::gce_MakeMirror2d& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeMirror2d>(&nativeInstance, false)
			{}
		...
		public:
			gce_MakeMirror2d(RDC::OCC::Pnt2d Point);
			gce_MakeMirror2d(RDC::OCC::Ax2d Axis);
			gce_MakeMirror2d(RDC::OCC::gp_Lin2d^ Line);
			/// <summary>
			/// Makes a symmetry transformation af axis defined by
			/// <Point> and <Direc>.
			/// </summary>
			gce_MakeMirror2d(RDC::OCC::Pnt2d Point, RDC::OCC::Dir2d Direc);
			/// <summary>
			/// Returns the constructed transformation.
			/// </summary>
			RDC::OCC::Trsf2d Value();
			RDC::OCC::Trsf2d Operator();
		}; // class gce_MakeMirror2d
		...
		public:
			...
			/// </summary>
			gce_MakeParab(RDC::OCC::Ax2 A2, double Focal);
			/// <summary>
			...
			/// YAxis.
			/// </summary>
			gce_MakeParab(RDC::OCC::Ax1 D, RDC::OCC::Pnt F);
			/// <summary>
			/// Returns the constructed parabola.
			/// Exceptions StdFail_NotDone if no parabola is constructed.
			/// </summary>
			RDC::OCC::gp_Parab^ Value();
			RDC::OCC::gp_Parab^ Operator();
		}; // class gce_MakeParab
		...
		public:
			...
			/// </summary>
			gce_MakeParab2d(RDC::OCC::Ax2d MirrorAxis, double Focal, bool Sense);
			/// <summary>
			/// Creates a parabola with its axis of symmetry ("MirrorAxis")
			/// and its focal length.
			/// Warnings : It is possible to have Focal = 0.
			/// The status is "NullFocalLength" Raised if Focal < 0.0
			/// </summary>
			gce_MakeParab2d(RDC::OCC::Ax2d MirrorAxis, double Focal);
			/// <summary>
			...
			/// The status is "NullFocalLength" Raised if Focal < 0.0
			/// </summary>
			gce_MakeParab2d(RDC::OCC::Ax22d A, double Focal);
			/// <summary>
			/// Creates a parabola with the directrix and the focus point.
			/// The sense of parametrization is given by Sense.
			/// </summary>
			gce_MakeParab2d(RDC::OCC::Ax2d D, RDC::OCC::Pnt2d F, bool Sense);
			/// <summary>
			/// Creates a parabola with the directrix and the focus point.
			/// The sense of parametrization is given by Sense.
			/// </summary>
			gce_MakeParab2d(RDC::OCC::Ax2d D, RDC::OCC::Pnt2d F);
			/// <summary>
			...
			/// </summary>
			gce_MakeParab2d(RDC::OCC::Pnt2d S1, RDC::OCC::Pnt2d Center, bool Sense);
			/// <summary>
			/// Make an Parab2d with S1 as the Focal point and Center
			/// as the apex of the parabola
			/// Warning
			...
			/// -   gce_NullAxis if S1 and Center are coincident.
			/// </summary>
			gce_MakeParab2d(RDC::OCC::Pnt2d S1, RDC::OCC::Pnt2d Center);
			/// <summary>
			/// Returns the constructed parabola.
			/// Exceptions StdFail_NotDone if no parabola is constructed.
			/// </summary>
			RDC::OCC::gp_Parab2d^ Value();
			RDC::OCC::gp_Parab2d^ Operator();
		}; // class gce_MakeParab2d
		...
		public:
			...
			/// </summary>
			gce_MakePln(RDC::OCC::Ax2 A2);
			/// <summary>
			/// Creates a plane with the  "Location" point <P>
			/// and the normal direction <V>.
			/// </summary>
			gce_MakePln(RDC::OCC::Pnt P, RDC::OCC::Dir V);
			/// <summary>
			...
			/// </summary>
			gce_MakePln(RDC::OCC::Pln Pln, RDC::OCC::Pnt Point);
			/// <summary>
			/// Make a Pln from gp <ThePln> parallel to another
			...
			/// </summary>
			gce_MakePln(RDC::OCC::Pln Pln, double Dist);
			/// <summary>
			/// Make a Pln from gp <ThePln> passing through 3
			/// Pnt <P1>,<P2>,<P3>.
			/// It returns false if <P1> <P2> <P3> are confused.
			/// </summary>
			gce_MakePln(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3);
			/// <summary>
			...
			/// </summary>
			gce_MakePln(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			/// <summary>
			...
			/// </summary>
			gce_MakePln(RDC::OCC::Ax1 Axis);
			/// <summary>
			/// Returns the constructed plane.
			/// Exceptions StdFail_NotDone if no plane is constructed.
			/// </summary>
			RDC::OCC::Pln Value();
			RDC::OCC::Pln Operator();
		}; // class gce_MakePln
		...
		public ref class gce_MakeRotation sealed
			: public RDC::OCC::BaseClass<::gce_MakeRotation>
		{
		...
		public:
			gce_MakeRotation(::gce_MakeRotation* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeRotation>(nativeInstance, true)
			{}

			gce_MakeRotation(::gce_MakeRotation& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeRotation>(&nativeInstance, false)
			{}
		...
		public ref class gce_MakeRotation2d sealed
			: public RDC::OCC::BaseClass<::gce_MakeRotation2d>
		{
		...
		public:
			gce_MakeRotation2d(::gce_MakeRotation2d* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeRotation2d>(nativeInstance, true)
			{}

			gce_MakeRotation2d(::gce_MakeRotation2d& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeRotation2d>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			gce_MakeRotation2d(RDC::OCC::Pnt2d Point, double Angle);
			/// <summary>
			/// Returns the constructed transformation.
			/// </summary>
			RDC::OCC::Trsf2d Value();
		...
		public ref class gce_MakeScale sealed
			: public RDC::OCC::BaseClass<::gce_MakeScale>
		{
		...
		public:
			gce_MakeScale(::gce_MakeScale* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeScale>(nativeInstance, true)
			{}

			gce_MakeScale(::gce_MakeScale& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeScale>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			gce_MakeScale(RDC::OCC::Pnt Point, double Scale);
			/// <summary>
			/// Returns the constructed transformation.
			/// </summary>
			RDC::OCC::Trsf Value();
		...
		public ref class gce_MakeScale2d sealed
			: public RDC::OCC::BaseClass<::gce_MakeScale2d>
		{
		...
		public:
			gce_MakeScale2d(::gce_MakeScale2d* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeScale2d>(nativeInstance, true)
			{}

			gce_MakeScale2d(::gce_MakeScale2d& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeScale2d>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// -   Scale as the scale factor.
			/// </summary>
			gce_MakeScale2d(RDC::OCC::Pnt2d Point, double Scale);
			/// <summary>
			/// Returns the constructed transformation.
			/// </summary>
			RDC::OCC::Trsf2d Value();
		...
		public ref class gce_MakeTranslation sealed
			: public RDC::OCC::BaseClass<::gce_MakeTranslation>
		{
		...
		public:
			gce_MakeTranslation(::gce_MakeTranslation* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeTranslation>(nativeInstance, true)
			{}

			gce_MakeTranslation(::gce_MakeTranslation& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeTranslation>(&nativeInstance, false)
			{}
		...
		public ref class gce_MakeTranslation2d sealed
			: public RDC::OCC::BaseClass<::gce_MakeTranslation2d>
		{
		...
		public:
			gce_MakeTranslation2d(::gce_MakeTranslation2d* nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeTranslation2d>(nativeInstance, true)
			{}

			gce_MakeTranslation2d(::gce_MakeTranslation2d& nativeInstance)
				: RDC::OCC::BaseClass<::gce_MakeTranslation2d>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// Constructs a translation along the vector Vect.
			/// </summary>
			gce_MakeTranslation2d(RDC::OCC::Vec2d Vect);
			/// <summary>
			/// Constructs a translation along the vector
			/// (Point1,Point2) defined from the point Point1 to the point Point2.
			/// </summary>
			gce_MakeTranslation2d(RDC::OCC::Pnt2d Point1, RDC::OCC::Pnt2d Point2);
			/// <summary>
			/// Returns the constructed transformation.
			/// </summary>
			RDC::OCC::Trsf2d Value();
