...
public ref class IntAna2d_IntPoint sealed
    : public RDC::OCC::BaseClass<::IntAna2d_IntPoint>
{
...
public:
    IntAna2d_IntPoint(::IntAna2d_IntPoint* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna2d_IntPoint>( nativeInstance, true )
    {}

    IntAna2d_IntPoint(::IntAna2d_IntPoint& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna2d_IntPoint>( &nativeInstance, false )
    {}
...
public ref class IntAna2d_Conic sealed
    : public RDC::OCC::BaseClass<::IntAna2d_Conic>
{
...
public:
    IntAna2d_Conic(::IntAna2d_Conic* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna2d_Conic>( nativeInstance, true )
    {}

    IntAna2d_Conic(::IntAna2d_Conic& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna2d_Conic>( &nativeInstance, false )
    {}
...
public:
    IntAna2d_Conic(RDC::OCC::gp_Circ2d^ C);
    IntAna2d_Conic(RDC::OCC::gp_Lin2d^ C);
    IntAna2d_Conic(RDC::OCC::gp_Parab2d^ C);
    IntAna2d_Conic(RDC::OCC::gp_Hypr2d^ C);
    IntAna2d_Conic(RDC::OCC::gp_Elips2d^ C);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::XY Grad(double X, double Y);
    /// <summary>
    /// Returns the value of the function and its gradient at
    /// the point X,Y.
    /// </summary>
    void ValAndGrad(double X, double Y, double% Val, RDC::OCC::XY% Grd);
    /// <summary>
    ...
    /// </summary>
    void NewCoefficients(double% A, double% B, double% C, double% D, double% E, double% F, RDC::OCC::Ax2d Axis);
}; // class IntAna2d_Conic
...
public ref class IntAna2d_AnaIntersection sealed
    : public RDC::OCC::BaseClass<::IntAna2d_AnaIntersection>
{
...
public:
    IntAna2d_AnaIntersection(::IntAna2d_AnaIntersection* nativeInstance)
        : RDC::OCC::BaseClass<::IntAna2d_AnaIntersection>( nativeInstance, true )
    {}

    IntAna2d_AnaIntersection(::IntAna2d_AnaIntersection& nativeInstance)
        : RDC::OCC::BaseClass<::IntAna2d_AnaIntersection>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Lin2d^ L1, RDC::OCC::gp_Lin2d^ L2);
    /// <summary>
    /// Intersection between two circles.
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Circ2d^ C1, RDC::OCC::gp_Circ2d^ C2);
    /// <summary>
    /// Intersection between a line and a circle.
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Lin2d^ L, RDC::OCC::gp_Circ2d^ C);
    /// <summary>
    /// Intersection between a line and a conic.
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Lin2d^ L, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    /// Intersection between a circle and another conic.
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Circ2d^ C, RDC::OCC::IntAna2d_Conic^ Co);
    /// <summary>
    /// Intersection between an ellipse and another conic.
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Elips2d^ E, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    /// Intersection between a parabola and another conic.
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Parab2d^ P, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    /// Intersection between an hyperbola and another conic.
    /// </summary>
    IntAna2d_AnaIntersection(RDC::OCC::gp_Hypr2d^ H, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    /// Intersection between two lines.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin2d^ L1, RDC::OCC::gp_Lin2d^ L2);
    /// <summary>
    /// Intersection between two circles.
    /// </summary>
    void Perform(RDC::OCC::gp_Circ2d^ C1, RDC::OCC::gp_Circ2d^ C2);
    /// <summary>
    /// Intersection between a line and a circle.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin2d^ L, RDC::OCC::gp_Circ2d^ C);
    /// <summary>
    /// Intersection between a line and a conic.
    /// </summary>
    void Perform(RDC::OCC::gp_Lin2d^ L, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    /// Intersection between a circle and another conic.
    /// </summary>
    void Perform(RDC::OCC::gp_Circ2d^ C, RDC::OCC::IntAna2d_Conic^ Co);
    /// <summary>
    /// Intersection between an ellipse and another conic.
    /// </summary>
    void Perform(RDC::OCC::gp_Elips2d^ E, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    /// Intersection between a parabola and another conic.
    /// </summary>
    void Perform(RDC::OCC::gp_Parab2d^ P, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    /// Intersection between an hyperbola and another conic.
    /// </summary>
    void Perform(RDC::OCC::gp_Hypr2d^ H, RDC::OCC::IntAna2d_Conic^ C);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::IntAna2d_IntPoint^ Point(int N);
}; // class IntAna2d_AnaIntersection
