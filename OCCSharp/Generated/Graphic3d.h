...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class Graphic3d_Vec2 sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec2>
		{
		...
		public:
			Graphic3d_Vec2(::Graphic3d_Vec2* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2>(nativeInstance, true)
			{}

			Graphic3d_Vec2(::Graphic3d_Vec2& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2>(&nativeInstance, false)
			{}
		...
		public:
			...
			float x();
			float y();
			RDC::OCC::Graphic3d_Vec2^ xy();
			RDC::OCC::Graphic3d_Vec2^ yx();
			bool IsEqual(RDC::OCC::Graphic3d_Vec2^ theOther);
			float GetData();
			float ChangeData();
			void Multiply(float theFactor);
			RDC::OCC::Graphic3d_Vec2^ Multiplied(float theFactor);
			RDC::OCC::Graphic3d_Vec2^ cwiseMin(RDC::OCC::Graphic3d_Vec2^ theVec);
			RDC::OCC::Graphic3d_Vec2^ cwiseMax(RDC::OCC::Graphic3d_Vec2^ theVec);
			RDC::OCC::Graphic3d_Vec2^ cwiseAbs();
			float maxComp();
			float minComp();
			float Dot(RDC::OCC::Graphic3d_Vec2^ theOther);
			float Modulus();
			float SquareModulus();
			static RDC::OCC::Graphic3d_Vec2^ DX();
			static RDC::OCC::Graphic3d_Vec2^ DY();
		...
		public ref class Graphic3d_Vec2d sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec2d>
		{
		...
		public:
			Graphic3d_Vec2d(::Graphic3d_Vec2d* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2d>(nativeInstance, true)
			{}

			Graphic3d_Vec2d(::Graphic3d_Vec2d& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2d>(&nativeInstance, false)
			{}
		...
		public:
			...
			bool IsEqual(RDC::OCC::Graphic3d_Vec2d^ theOther);
			double GetData();
			double ChangeData();
			void Multiply(double theFactor);
			RDC::OCC::Graphic3d_Vec2d^ Multiplied(double theFactor);
			RDC::OCC::Graphic3d_Vec2d^ cwiseMin(RDC::OCC::Graphic3d_Vec2d^ theVec);
			RDC::OCC::Graphic3d_Vec2d^ cwiseMax(RDC::OCC::Graphic3d_Vec2d^ theVec);
			RDC::OCC::Graphic3d_Vec2d^ cwiseAbs();
			double maxComp();
			double minComp();
			double Dot(RDC::OCC::Graphic3d_Vec2d^ theOther);
			double Modulus();
			double SquareModulus();
			static RDC::OCC::Graphic3d_Vec2d^ DX();
			static RDC::OCC::Graphic3d_Vec2d^ DY();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec2d
		...
		public ref class Graphic3d_Vec2i sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec2i>
		{
		...
		public:
			Graphic3d_Vec2i(::Graphic3d_Vec2i* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2i>(nativeInstance, true)
			{}

			Graphic3d_Vec2i(::Graphic3d_Vec2i& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2i>(&nativeInstance, false)
			{}
		...
		public:
			...
			int x();
			int y();
			RDC::OCC::Graphic3d_Vec2i^ xy();
			RDC::OCC::Graphic3d_Vec2i^ yx();
			bool IsEqual(RDC::OCC::Graphic3d_Vec2i^ theOther);
			int GetData();
			int ChangeData();
			void Multiply(int theFactor);
			RDC::OCC::Graphic3d_Vec2i^ Multiplied(int theFactor);
			RDC::OCC::Graphic3d_Vec2i^ cwiseMin(RDC::OCC::Graphic3d_Vec2i^ theVec);
			RDC::OCC::Graphic3d_Vec2i^ cwiseMax(RDC::OCC::Graphic3d_Vec2i^ theVec);
			RDC::OCC::Graphic3d_Vec2i^ cwiseAbs();
			int maxComp();
			int minComp();
			int Dot(RDC::OCC::Graphic3d_Vec2i^ theOther);
			int Modulus();
			int SquareModulus();
			static RDC::OCC::Graphic3d_Vec2i^ DX();
			static RDC::OCC::Graphic3d_Vec2i^ DY();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec2i
		...
		public ref class Graphic3d_Vec2u sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec2u>
		{
		...
		public:
			Graphic3d_Vec2u(::Graphic3d_Vec2u* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2u>(nativeInstance, true)
			{}

			Graphic3d_Vec2u(::Graphic3d_Vec2u& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2u>(&nativeInstance, false)
			{}
		...
		public:
			...
			unsigned int x();
			unsigned int y();
			RDC::OCC::Graphic3d_Vec2u^ xy();
			RDC::OCC::Graphic3d_Vec2u^ yx();
			bool IsEqual(RDC::OCC::Graphic3d_Vec2u^ theOther);
			unsigned int GetData();
			unsigned int ChangeData();
			void Multiply(unsigned int theFactor);
			RDC::OCC::Graphic3d_Vec2u^ Multiplied(unsigned int theFactor);
			RDC::OCC::Graphic3d_Vec2u^ cwiseMin(RDC::OCC::Graphic3d_Vec2u^ theVec);
			RDC::OCC::Graphic3d_Vec2u^ cwiseMax(RDC::OCC::Graphic3d_Vec2u^ theVec);
			RDC::OCC::Graphic3d_Vec2u^ cwiseAbs();
			unsigned int maxComp();
			unsigned int minComp();
			unsigned int Dot(RDC::OCC::Graphic3d_Vec2u^ theOther);
			unsigned int Modulus();
			unsigned int SquareModulus();
			static RDC::OCC::Graphic3d_Vec2u^ DX();
			static RDC::OCC::Graphic3d_Vec2u^ DY();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec2u
		...
		public ref class Graphic3d_Vec2ub sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec2ub>
		{
		...
		public:
			Graphic3d_Vec2ub(::Graphic3d_Vec2ub* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2ub>(nativeInstance, true)
			{}

			Graphic3d_Vec2ub(::Graphic3d_Vec2ub& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2ub>(&nativeInstance, false)
			{}
		...
		public:
			...
			unsigned char x();
			unsigned char y();
			RDC::OCC::Graphic3d_Vec2ub^ xy();
			RDC::OCC::Graphic3d_Vec2ub^ yx();
			bool IsEqual(RDC::OCC::Graphic3d_Vec2ub^ theOther);
			unsigned char GetData();
			unsigned char ChangeData();
			void Multiply(unsigned char theFactor);
			RDC::OCC::Graphic3d_Vec2ub^ Multiplied(unsigned char theFactor);
			RDC::OCC::Graphic3d_Vec2ub^ cwiseMin(RDC::OCC::Graphic3d_Vec2ub^ theVec);
			RDC::OCC::Graphic3d_Vec2ub^ cwiseMax(RDC::OCC::Graphic3d_Vec2ub^ theVec);
			RDC::OCC::Graphic3d_Vec2ub^ cwiseAbs();
			unsigned char maxComp();
			unsigned char minComp();
			unsigned char Dot(RDC::OCC::Graphic3d_Vec2ub^ theOther);
			unsigned char Modulus();
			unsigned char SquareModulus();
			static RDC::OCC::Graphic3d_Vec2ub^ DX();
			static RDC::OCC::Graphic3d_Vec2ub^ DY();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec2ub
		...
		public ref class Graphic3d_Vec2b sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec2b>
		{
		...
		public:
			Graphic3d_Vec2b(::Graphic3d_Vec2b* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2b>(nativeInstance, true)
			{}

			Graphic3d_Vec2b(::Graphic3d_Vec2b& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec2b>(&nativeInstance, false)
			{}
		...
		public:
			...
			char x();
			char y();
			RDC::OCC::Graphic3d_Vec2b^ xy();
			RDC::OCC::Graphic3d_Vec2b^ yx();
			bool IsEqual(RDC::OCC::Graphic3d_Vec2b^ theOther);
			char GetData();
			char ChangeData();
			void Multiply(char theFactor);
			RDC::OCC::Graphic3d_Vec2b^ Multiplied(char theFactor);
			RDC::OCC::Graphic3d_Vec2b^ cwiseMin(RDC::OCC::Graphic3d_Vec2b^ theVec);
			RDC::OCC::Graphic3d_Vec2b^ cwiseMax(RDC::OCC::Graphic3d_Vec2b^ theVec);
			RDC::OCC::Graphic3d_Vec2b^ cwiseAbs();
			char maxComp();
			char minComp();
			char Dot(RDC::OCC::Graphic3d_Vec2b^ theOther);
			char Modulus();
			char SquareModulus();
			static RDC::OCC::Graphic3d_Vec2b^ DX();
			static RDC::OCC::Graphic3d_Vec2b^ DY();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec2b
		...
		public ref class Graphic3d_Vec3 sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec3>
		{
		...
		public:
			Graphic3d_Vec3(::Graphic3d_Vec3* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec3>(nativeInstance, true)
			{}

			Graphic3d_Vec3(::Graphic3d_Vec3& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec3>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_Vec3(RDC::OCC::gp_Vec2f^ theVec2, float theZ);
			Graphic3d_Vec3(RDC::OCC::gp_Vec2f^ theVec2);
			static int Length();
			...
			RDC::OCC::gp_Vec2f^ yz();
			RDC::OCC::gp_Vec2f^ zy();
			RDC::OCC::Graphic3d_Vec3^ xyz();
			RDC::OCC::Graphic3d_Vec3^ xzy();
			RDC::OCC::Graphic3d_Vec3^ yxz();
			RDC::OCC::Graphic3d_Vec3^ yzx();
			RDC::OCC::Graphic3d_Vec3^ zyx();
			RDC::OCC::Graphic3d_Vec3^ zxy();
			bool IsEqual(RDC::OCC::Graphic3d_Vec3^ theOther);
			float GetData();
			float ChangeData();
			void Multiply(float theFactor);
			RDC::OCC::Graphic3d_Vec3^ Multiplied(float theFactor);
			RDC::OCC::Graphic3d_Vec3^ cwiseMin(RDC::OCC::Graphic3d_Vec3^ theVec);
			RDC::OCC::Graphic3d_Vec3^ cwiseMax(RDC::OCC::Graphic3d_Vec3^ theVec);
			RDC::OCC::Graphic3d_Vec3^ cwiseAbs();
			float maxComp();
			float minComp();
			float Dot(RDC::OCC::Graphic3d_Vec3^ theOther);
			float Modulus();
			float SquareModulus();
			void Normalize();
			RDC::OCC::Graphic3d_Vec3^ Normalized();
			static RDC::OCC::Graphic3d_Vec3^ Cross(RDC::OCC::Graphic3d_Vec3^ theVec1, RDC::OCC::Graphic3d_Vec3^ theVec2);
			static RDC::OCC::Graphic3d_Vec3^ GetLERP(RDC::OCC::Graphic3d_Vec3^ theFrom, RDC::OCC::Graphic3d_Vec3^ theTo, float theT);
			static RDC::OCC::Graphic3d_Vec3^ DX();
			static RDC::OCC::Graphic3d_Vec3^ DY();
			static RDC::OCC::Graphic3d_Vec3^ DZ();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec3
		...
		public ref class Graphic3d_Vec3d sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec3d>
		{
		...
		public:
			Graphic3d_Vec3d(::Graphic3d_Vec3d* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec3d>(nativeInstance, true)
			{}

			Graphic3d_Vec3d(::Graphic3d_Vec3d& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec3d>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_Vec3d(RDC::OCC::Graphic3d_Vec2d^ theVec2, double theZ);
			Graphic3d_Vec3d(RDC::OCC::Graphic3d_Vec2d^ theVec2);
			static int Length();
			...
			bool IsEqual(RDC::OCC::Graphic3d_Vec3d^ theOther);
			double GetData();
			double ChangeData();
			void Multiply(double theFactor);
			RDC::OCC::Graphic3d_Vec3d^ Multiplied(double theFactor);
			RDC::OCC::Graphic3d_Vec3d^ cwiseMin(RDC::OCC::Graphic3d_Vec3d^ theVec);
			RDC::OCC::Graphic3d_Vec3d^ cwiseMax(RDC::OCC::Graphic3d_Vec3d^ theVec);
			RDC::OCC::Graphic3d_Vec3d^ cwiseAbs();
			double maxComp();
			double minComp();
			double Dot(RDC::OCC::Graphic3d_Vec3d^ theOther);
			double Modulus();
			double SquareModulus();
			void Normalize();
			RDC::OCC::Graphic3d_Vec3d^ Normalized();
			static RDC::OCC::Graphic3d_Vec3d^ Cross(RDC::OCC::Graphic3d_Vec3d^ theVec1, RDC::OCC::Graphic3d_Vec3d^ theVec2);
			static RDC::OCC::Graphic3d_Vec3d^ GetLERP(RDC::OCC::Graphic3d_Vec3d^ theFrom, RDC::OCC::Graphic3d_Vec3d^ theTo, double theT);
			static RDC::OCC::Graphic3d_Vec3d^ DX();
			static RDC::OCC::Graphic3d_Vec3d^ DY();
			static RDC::OCC::Graphic3d_Vec3d^ DZ();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec3d
		...
		public ref class Graphic3d_Vec3i sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec3i>
		{
		...
		public:
			Graphic3d_Vec3i(::Graphic3d_Vec3i* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec3i>(nativeInstance, true)
			{}

			Graphic3d_Vec3i(::Graphic3d_Vec3i& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec3i>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_Vec3i(RDC::OCC::Graphic3d_Vec2i^ theVec2, int theZ);
			Graphic3d_Vec3i(RDC::OCC::Graphic3d_Vec2i^ theVec2);
			Graphic3d_Vec3i(RDC::OCC::gp_Vec3f^ theOtherVec3);
			static int Length();
			...
			RDC::OCC::Graphic3d_Vec2i^ xy();
			RDC::OCC::Graphic3d_Vec2i^ yx();
			RDC::OCC::Graphic3d_Vec2i^ xz();
			RDC::OCC::Graphic3d_Vec2i^ zx();
			RDC::OCC::Graphic3d_Vec2i^ yz();
			RDC::OCC::Graphic3d_Vec2i^ zy();
			RDC::OCC::Graphic3d_Vec3i^ xyz();
			RDC::OCC::Graphic3d_Vec3i^ xzy();
			RDC::OCC::Graphic3d_Vec3i^ yxz();
			RDC::OCC::Graphic3d_Vec3i^ yzx();
			RDC::OCC::Graphic3d_Vec3i^ zyx();
			RDC::OCC::Graphic3d_Vec3i^ zxy();
			bool IsEqual(RDC::OCC::Graphic3d_Vec3i^ theOther);
			int GetData();
			int ChangeData();
			void Multiply(int theFactor);
			RDC::OCC::Graphic3d_Vec3i^ Multiplied(int theFactor);
			RDC::OCC::Graphic3d_Vec3i^ cwiseMin(RDC::OCC::Graphic3d_Vec3i^ theVec);
			RDC::OCC::Graphic3d_Vec3i^ cwiseMax(RDC::OCC::Graphic3d_Vec3i^ theVec);
			RDC::OCC::Graphic3d_Vec3i^ cwiseAbs();
			int maxComp();
			int minComp();
			int Dot(RDC::OCC::Graphic3d_Vec3i^ theOther);
			int Modulus();
			int SquareModulus();
			void Normalize();
			RDC::OCC::Graphic3d_Vec3i^ Normalized();
			static RDC::OCC::Graphic3d_Vec3i^ Cross(RDC::OCC::Graphic3d_Vec3i^ theVec1, RDC::OCC::Graphic3d_Vec3i^ theVec2);
			static RDC::OCC::Graphic3d_Vec3i^ GetLERP(RDC::OCC::Graphic3d_Vec3i^ theFrom, RDC::OCC::Graphic3d_Vec3i^ theTo, int theT);
			static RDC::OCC::Graphic3d_Vec3i^ DX();
			static RDC::OCC::Graphic3d_Vec3i^ DY();
			static RDC::OCC::Graphic3d_Vec3i^ DZ();
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec3i
		...
		public ref class Graphic3d_Vec4 sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec4>
		{
		...
		public:
			Graphic3d_Vec4(::Graphic3d_Vec4* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4>(nativeInstance, true)
			{}

			Graphic3d_Vec4(::Graphic3d_Vec4& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_Vec4(RDC::OCC::gp_Vec2f^ theVec2);
			Graphic3d_Vec4(RDC::OCC::gp_Vec3f^ theVec3, float theW);
			Graphic3d_Vec4(RDC::OCC::gp_Vec3f^ theVec3);
			static int Length();
			...
			RDC::OCC::gp_Vec2f^ zw();
			RDC::OCC::gp_Vec2f^ wz();
			RDC::OCC::gp_Vec3f^ xyz();
			RDC::OCC::gp_Vec3f^ xzy();
			RDC::OCC::gp_Vec3f^ yxz();
			RDC::OCC::gp_Vec3f^ yzx();
			RDC::OCC::gp_Vec3f^ zyx();
			RDC::OCC::gp_Vec3f^ zxy();
			RDC::OCC::gp_Vec3f^ xyw();
			RDC::OCC::gp_Vec3f^ xwy();
			RDC::OCC::gp_Vec3f^ yxw();
			RDC::OCC::gp_Vec3f^ ywx();
			RDC::OCC::gp_Vec3f^ wyx();
			RDC::OCC::gp_Vec3f^ wxy();
			RDC::OCC::gp_Vec3f^ xzw();
			RDC::OCC::gp_Vec3f^ xwz();
			RDC::OCC::gp_Vec3f^ zxw();
			RDC::OCC::gp_Vec3f^ zwx();
			RDC::OCC::gp_Vec3f^ wzx();
			RDC::OCC::gp_Vec3f^ wxz();
			RDC::OCC::gp_Vec3f^ yzw();
			RDC::OCC::gp_Vec3f^ ywz();
			RDC::OCC::gp_Vec3f^ zyw();
			RDC::OCC::gp_Vec3f^ zwy();
			RDC::OCC::gp_Vec3f^ wzy();
			RDC::OCC::gp_Vec3f^ wyz();
			RDC::OCC::gp_Vec3f^ rgb();
			RDC::OCC::gp_Vec3f^ rbg();
			RDC::OCC::gp_Vec3f^ grb();
			RDC::OCC::gp_Vec3f^ gbr();
			RDC::OCC::gp_Vec3f^ bgr();
			RDC::OCC::gp_Vec3f^ brg();
			bool IsEqual(RDC::OCC::Graphic3d_Vec4^ theOther);
			float GetData();
			float ChangeData();
			void Multiply(float theFactor);
			RDC::OCC::Graphic3d_Vec4^ Multiplied(float theFactor);
			RDC::OCC::Graphic3d_Vec4^ cwiseMin(RDC::OCC::Graphic3d_Vec4^ theVec);
			RDC::OCC::Graphic3d_Vec4^ cwiseMax(RDC::OCC::Graphic3d_Vec4^ theVec);
			RDC::OCC::Graphic3d_Vec4^ cwiseAbs();
			float maxComp();
			float minComp();
			float Dot(RDC::OCC::Graphic3d_Vec4^ theOther);
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec4
		...
		public ref class Graphic3d_Vec4d sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec4d>
		{
		...
		public:
			Graphic3d_Vec4d(::Graphic3d_Vec4d* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4d>(nativeInstance, true)
			{}

			Graphic3d_Vec4d(::Graphic3d_Vec4d& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4d>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_Vec4d(RDC::OCC::Graphic3d_Vec2d^ theVec2);
			Graphic3d_Vec4d(RDC::OCC::Graphic3d_Vec3d^ theVec3, double theW);
			Graphic3d_Vec4d(RDC::OCC::Graphic3d_Vec3d^ theVec3);
			static int Length();
			...
			bool IsEqual(RDC::OCC::Graphic3d_Vec4d^ theOther);
			double GetData();
			double ChangeData();
			void Multiply(double theFactor);
			RDC::OCC::Graphic3d_Vec4d^ Multiplied(double theFactor);
			RDC::OCC::Graphic3d_Vec4d^ cwiseMin(RDC::OCC::Graphic3d_Vec4d^ theVec);
			RDC::OCC::Graphic3d_Vec4d^ cwiseMax(RDC::OCC::Graphic3d_Vec4d^ theVec);
			RDC::OCC::Graphic3d_Vec4d^ cwiseAbs();
			double maxComp();
			double minComp();
			double Dot(RDC::OCC::Graphic3d_Vec4d^ theOther);
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec4d
		...
		public ref class Graphic3d_Vec4i sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec4i>
		{
		...
		public:
			Graphic3d_Vec4i(::Graphic3d_Vec4i* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4i>(nativeInstance, true)
			{}

			Graphic3d_Vec4i(::Graphic3d_Vec4i& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4i>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_Vec4i(RDC::OCC::Graphic3d_Vec2i^ theVec2);
			Graphic3d_Vec4i(RDC::OCC::Graphic3d_Vec3i^ theVec3, int theW);
			Graphic3d_Vec4i(RDC::OCC::Graphic3d_Vec3i^ theVec3);
			Graphic3d_Vec4i(RDC::OCC::Graphic3d_Vec4^ theOtherVec4);
			static int Length();
			...
			RDC::OCC::Graphic3d_Vec2i^ xz();
			RDC::OCC::Graphic3d_Vec2i^ zx();
			RDC::OCC::Graphic3d_Vec2i^ xw();
			RDC::OCC::Graphic3d_Vec2i^ wx();
			RDC::OCC::Graphic3d_Vec2i^ yz();
			RDC::OCC::Graphic3d_Vec2i^ zy();
			RDC::OCC::Graphic3d_Vec2i^ yw();
			RDC::OCC::Graphic3d_Vec2i^ wy();
			RDC::OCC::Graphic3d_Vec2i^ zw();
			RDC::OCC::Graphic3d_Vec2i^ wz();
			RDC::OCC::Graphic3d_Vec3i^ xyz();
			RDC::OCC::Graphic3d_Vec3i^ xzy();
			RDC::OCC::Graphic3d_Vec3i^ yxz();
			RDC::OCC::Graphic3d_Vec3i^ yzx();
			RDC::OCC::Graphic3d_Vec3i^ zyx();
			RDC::OCC::Graphic3d_Vec3i^ zxy();
			RDC::OCC::Graphic3d_Vec3i^ xyw();
			RDC::OCC::Graphic3d_Vec3i^ xwy();
			RDC::OCC::Graphic3d_Vec3i^ yxw();
			RDC::OCC::Graphic3d_Vec3i^ ywx();
			RDC::OCC::Graphic3d_Vec3i^ wyx();
			RDC::OCC::Graphic3d_Vec3i^ wxy();
			RDC::OCC::Graphic3d_Vec3i^ xzw();
			RDC::OCC::Graphic3d_Vec3i^ xwz();
			RDC::OCC::Graphic3d_Vec3i^ zxw();
			RDC::OCC::Graphic3d_Vec3i^ zwx();
			RDC::OCC::Graphic3d_Vec3i^ wzx();
			RDC::OCC::Graphic3d_Vec3i^ wxz();
			RDC::OCC::Graphic3d_Vec3i^ yzw();
			RDC::OCC::Graphic3d_Vec3i^ ywz();
			RDC::OCC::Graphic3d_Vec3i^ zyw();
			RDC::OCC::Graphic3d_Vec3i^ zwy();
			RDC::OCC::Graphic3d_Vec3i^ wzy();
			RDC::OCC::Graphic3d_Vec3i^ wyz();
			RDC::OCC::Graphic3d_Vec3i^ rgb();
			RDC::OCC::Graphic3d_Vec3i^ rbg();
			RDC::OCC::Graphic3d_Vec3i^ grb();
			RDC::OCC::Graphic3d_Vec3i^ gbr();
			RDC::OCC::Graphic3d_Vec3i^ bgr();
			RDC::OCC::Graphic3d_Vec3i^ brg();
			bool IsEqual(RDC::OCC::Graphic3d_Vec4i^ theOther);
			int GetData();
			int ChangeData();
			void Multiply(int theFactor);
			RDC::OCC::Graphic3d_Vec4i^ Multiplied(int theFactor);
			RDC::OCC::Graphic3d_Vec4i^ cwiseMin(RDC::OCC::Graphic3d_Vec4i^ theVec);
			RDC::OCC::Graphic3d_Vec4i^ cwiseMax(RDC::OCC::Graphic3d_Vec4i^ theVec);
			RDC::OCC::Graphic3d_Vec4i^ cwiseAbs();
			int maxComp();
			int minComp();
			int Dot(RDC::OCC::Graphic3d_Vec4i^ theOther);
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec4i
		...
		public ref class Graphic3d_Vec4ub sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vec4ub>
		{
		...
		public:
			Graphic3d_Vec4ub(::Graphic3d_Vec4ub* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4ub>(nativeInstance, true)
			{}

			Graphic3d_Vec4ub(::Graphic3d_Vec4ub& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vec4ub>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_Vec4ub(RDC::OCC::Graphic3d_Vec2ub^ theVec2);
			...
			RDC::OCC::Graphic3d_Vec2ub^ xy();
			RDC::OCC::Graphic3d_Vec2ub^ yx();
			RDC::OCC::Graphic3d_Vec2ub^ xz();
			RDC::OCC::Graphic3d_Vec2ub^ zx();
			RDC::OCC::Graphic3d_Vec2ub^ xw();
			RDC::OCC::Graphic3d_Vec2ub^ wx();
			RDC::OCC::Graphic3d_Vec2ub^ yz();
			RDC::OCC::Graphic3d_Vec2ub^ zy();
			RDC::OCC::Graphic3d_Vec2ub^ yw();
			RDC::OCC::Graphic3d_Vec2ub^ wy();
			RDC::OCC::Graphic3d_Vec2ub^ zw();
			RDC::OCC::Graphic3d_Vec2ub^ wz();
			...
			bool IsEqual(RDC::OCC::Graphic3d_Vec4ub^ theOther);
			unsigned char GetData();
			unsigned char ChangeData();
			void Multiply(unsigned char theFactor);
			RDC::OCC::Graphic3d_Vec4ub^ Multiplied(unsigned char theFactor);
			RDC::OCC::Graphic3d_Vec4ub^ cwiseMin(RDC::OCC::Graphic3d_Vec4ub^ theVec);
			RDC::OCC::Graphic3d_Vec4ub^ cwiseMax(RDC::OCC::Graphic3d_Vec4ub^ theVec);
			RDC::OCC::Graphic3d_Vec4ub^ cwiseAbs();
			unsigned char maxComp();
			unsigned char minComp();
			unsigned char Dot(RDC::OCC::Graphic3d_Vec4ub^ theOther);
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Vec4ub
		...
		public ref class Graphic3d_Mat4 sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Mat4>
		{
		...
		public:
			Graphic3d_Mat4(::Graphic3d_Mat4* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Mat4>(nativeInstance, true)
			{}

			Graphic3d_Mat4(::Graphic3d_Mat4& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Mat4>(&nativeInstance, false)
			{}
		...
		public:
			...
			static RDC::OCC::Graphic3d_Mat4^ Identity();
			static RDC::OCC::Graphic3d_Mat4^ Zero();
			...
			RDC::OCC::Graphic3d_Vec4^ GetRow(long long unsigned int theRow);
			void SetRow(long long unsigned int theRow, RDC::OCC::gp_Vec3f^ theVec);
			RDC::OCC::Graphic3d_Vec4^ GetColumn(long long unsigned int theCol);
			void SetColumn(long long unsigned int theCol, RDC::OCC::gp_Vec3f^ theVec);
			RDC::OCC::Graphic3d_Vec4^ GetDiagonal();
			void SetDiagonal(RDC::OCC::gp_Vec3f^ theVec);
			/* Method skipped due to unknown mapping: NCollection_Mat3<float> GetMat3() */
			void InitZero();
			bool IsZero();
			void InitIdentity();
			bool IsIdentity();
			bool IsEqual(RDC::OCC::Graphic3d_Mat4^ theOther);
			float GetData();
			float ChangeData();
			static RDC::OCC::Graphic3d_Mat4^ Multiply(RDC::OCC::Graphic3d_Mat4^ theMatA, RDC::OCC::Graphic3d_Mat4^ theMatB);
			RDC::OCC::Graphic3d_Mat4^ Multiplied(RDC::OCC::Graphic3d_Mat4^ theMat);
			void Divide(float theFactor);
			RDC::OCC::Graphic3d_Mat4^ Divided(float theScalar);
			void Add(RDC::OCC::Graphic3d_Mat4^ theMat);
			void Subtract(RDC::OCC::Graphic3d_Mat4^ theMat);
			RDC::OCC::Graphic3d_Mat4^ Added(RDC::OCC::Graphic3d_Mat4^ theMat);
			RDC::OCC::Graphic3d_Mat4^ Subtracted(RDC::OCC::Graphic3d_Mat4^ theMat);
			RDC::OCC::Graphic3d_Mat4^ Negated();
			void Translate(RDC::OCC::gp_Vec3f^ theVec);
			RDC::OCC::Graphic3d_Mat4^ Transposed();
			void Transpose();
			bool Inverted(RDC::OCC::Graphic3d_Mat4^ theOutMx, float% theDet);
			float DeterminantMat3();
			RDC::OCC::Graphic3d_Mat4^ Adjoint();
			static RDC::OCC::Graphic3d_Mat4^ Map(float% theData);
		...
		public ref class Graphic3d_Mat4d sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Mat4d>
		{
		...
		public:
			Graphic3d_Mat4d(::Graphic3d_Mat4d* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Mat4d>(nativeInstance, true)
			{}

			Graphic3d_Mat4d(::Graphic3d_Mat4d& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Mat4d>(&nativeInstance, false)
			{}
		...
		public:
			...
			static long long unsigned int Rows();
			static long long unsigned int Cols();
			static RDC::OCC::Graphic3d_Mat4d^ Identity();
			static RDC::OCC::Graphic3d_Mat4d^ Zero();
			...
			void InitIdentity();
			bool IsIdentity();
			bool IsEqual(RDC::OCC::Graphic3d_Mat4d^ theOther);
			double GetData();
			double ChangeData();
			static RDC::OCC::Graphic3d_Mat4d^ Multiply(RDC::OCC::Graphic3d_Mat4d^ theMatA, RDC::OCC::Graphic3d_Mat4d^ theMatB);
			RDC::OCC::Graphic3d_Mat4d^ Multiplied(RDC::OCC::Graphic3d_Mat4d^ theMat);
			void Divide(double theFactor);
			RDC::OCC::Graphic3d_Mat4d^ Divided(double theScalar);
			void Add(RDC::OCC::Graphic3d_Mat4d^ theMat);
			void Subtract(RDC::OCC::Graphic3d_Mat4d^ theMat);
			RDC::OCC::Graphic3d_Mat4d^ Added(RDC::OCC::Graphic3d_Mat4d^ theMat);
			RDC::OCC::Graphic3d_Mat4d^ Subtracted(RDC::OCC::Graphic3d_Mat4d^ theMat);
			RDC::OCC::Graphic3d_Mat4d^ Negated();
			void Translate(RDC::OCC::Graphic3d_Vec3d^ theVec);
			RDC::OCC::Graphic3d_Mat4d^ Transposed();
			void Transpose();
			bool Inverted(RDC::OCC::Graphic3d_Mat4d^ theOutMx, double% theDet);
			double DeterminantMat3();
			RDC::OCC::Graphic3d_Mat4d^ Adjoint();
			static RDC::OCC::Graphic3d_Mat4d^ Map(double% theData);
			/* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int parameter1, ) */
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Mat4d
		...
		public ref class Graphic3d_Array1OfAttribute sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Array1OfAttribute>
			, public IIndexEnumerable<RDC::OCC::Graphic3d_Attribute^>
		{
		...
		public:
			Graphic3d_Array1OfAttribute(::Graphic3d_Array1OfAttribute* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Array1OfAttribute>(nativeInstance, true)
			{}

			Graphic3d_Array1OfAttribute(::Graphic3d_Array1OfAttribute& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Array1OfAttribute>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_Array1OfAttribute::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_Array1OfAttribute::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_Array1OfAttribute::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_Array1OfAttribute::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_Array1OfAttribute::Iterator>(&nativeInstance, false)
				{}
			...
			Graphic3d_Array1OfAttribute(RDC::OCC::Graphic3d_Attribute^ theBegin, int theLower, int theUpper, bool theUseBuffer);
			Graphic3d_Array1OfAttribute(RDC::OCC::Graphic3d_Attribute^ theBegin, int theLower, int theUpper);
			void Init(RDC::OCC::Graphic3d_Attribute^ theValue);
			int Size();
			int Length();
			bool IsEmpty();
			int Lower();
			int Upper();
			RDC::OCC::Graphic3d_Array1OfAttribute^ Assign(RDC::OCC::Graphic3d_Array1OfAttribute^ theOther);
			RDC::OCC::Graphic3d_Array1OfAttribute^ Move(RDC::OCC::Graphic3d_Array1OfAttribute^ theOther);
			RDC::OCC::Graphic3d_Attribute^ First();
			RDC::OCC::Graphic3d_Attribute^ ChangeFirst();
			RDC::OCC::Graphic3d_Attribute^ Last();
			RDC::OCC::Graphic3d_Attribute^ ChangeLast();
			virtual RDC::OCC::Graphic3d_Attribute^ Value(int theIndex);
			RDC::OCC::Graphic3d_Attribute^ ChangeValue(int theIndex);
			void SetValue(int theIndex, RDC::OCC::Graphic3d_Attribute^ theItem);
			...
			bool IsDeletable();
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_Attribute^>^ GetEnumerator();
		...
		public ref class Graphic3d_ShaderObjectList sealed
			: public RDC::OCC::BaseClass<::Graphic3d_ShaderObjectList>
			, public IIndexEnumerable<RDC::OCC::Graphic3d_ShaderObject^>
		{
		...
		public:
			Graphic3d_ShaderObjectList(::Graphic3d_ShaderObjectList* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ShaderObjectList>(nativeInstance, true)
			{}

			Graphic3d_ShaderObjectList(::Graphic3d_ShaderObjectList& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ShaderObjectList>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_ShaderObjectList::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_ShaderObjectList::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_ShaderObjectList::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_ShaderObjectList::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_ShaderObjectList::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::Graphic3d_ShaderObject^ Value();
				RDC::OCC::Graphic3d_ShaderObject^ ChangeValue();
				bool IsEqual(RDC::OCC::Graphic3d_ShaderObjectList::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			Graphic3d_ShaderObjectList();
			Graphic3d_ShaderObjectList(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			int Size();
			int Length();
			int Lower();
			int Upper();
			...
			void Clear();
			RDC::OCC::Graphic3d_ShaderObjectList^ Assign(RDC::OCC::Graphic3d_ShaderObjectList^ theOther);
			void Remove(RDC::OCC::Graphic3d_ShaderObjectList::Iterator^ thePosition);
			void Append(RDC::OCC::Graphic3d_ShaderObject^ theItem);
			void Prepend(RDC::OCC::Graphic3d_ShaderObject^ theItem);
			void InsertBefore(int theIndex, RDC::OCC::Graphic3d_ShaderObject^ theItem);
			void InsertAfter(RDC::OCC::Graphic3d_ShaderObjectList::Iterator^ thePosition, RDC::OCC::Graphic3d_ShaderObject^ theItem);
			void Split(int theIndex, RDC::OCC::Graphic3d_ShaderObjectList^ theSeq);
			RDC::OCC::Graphic3d_ShaderObject^ First();
			RDC::OCC::Graphic3d_ShaderObject^ ChangeFirst();
			RDC::OCC::Graphic3d_ShaderObject^ Last();
			RDC::OCC::Graphic3d_ShaderObject^ ChangeLast();
			virtual RDC::OCC::Graphic3d_ShaderObject^ Value(int theIndex);
			RDC::OCC::Graphic3d_ShaderObject^ ChangeValue(int theIndex);
			void SetValue(int theIndex, RDC::OCC::Graphic3d_ShaderObject^ theItem);
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_ShaderObject^>^ GetEnumerator();
			virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
		}; // class Graphic3d_ShaderObjectList
		...
		public ref class Graphic3d_ShaderVariableList sealed
			: public RDC::OCC::BaseClass<::Graphic3d_ShaderVariableList>
			, public IIndexEnumerable<RDC::OCC::Graphic3d_ShaderVariable^>
		{
		...
		public:
			Graphic3d_ShaderVariableList(::Graphic3d_ShaderVariableList* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ShaderVariableList>(nativeInstance, true)
			{}

			Graphic3d_ShaderVariableList(::Graphic3d_ShaderVariableList& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ShaderVariableList>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_ShaderVariableList::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_ShaderVariableList::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_ShaderVariableList::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_ShaderVariableList::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_ShaderVariableList::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::Graphic3d_ShaderVariable^ Value();
				RDC::OCC::Graphic3d_ShaderVariable^ ChangeValue();
				bool IsEqual(RDC::OCC::Graphic3d_ShaderVariableList::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			Graphic3d_ShaderVariableList();
			Graphic3d_ShaderVariableList(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			int Size();
			int Length();
			int Lower();
			int Upper();
			...
			void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			void Clear();
			RDC::OCC::Graphic3d_ShaderVariableList^ Assign(RDC::OCC::Graphic3d_ShaderVariableList^ theOther);
			void Remove(RDC::OCC::Graphic3d_ShaderVariableList::Iterator^ thePosition);
			void Append(RDC::OCC::Graphic3d_ShaderVariable^ theItem);
			void Prepend(RDC::OCC::Graphic3d_ShaderVariable^ theItem);
			void InsertBefore(int theIndex, RDC::OCC::Graphic3d_ShaderVariable^ theItem);
			void InsertAfter(RDC::OCC::Graphic3d_ShaderVariableList::Iterator^ thePosition, RDC::OCC::Graphic3d_ShaderVariable^ theItem);
			void Split(int theIndex, RDC::OCC::Graphic3d_ShaderVariableList^ theSeq);
			RDC::OCC::Graphic3d_ShaderVariable^ First();
			RDC::OCC::Graphic3d_ShaderVariable^ ChangeFirst();
			RDC::OCC::Graphic3d_ShaderVariable^ Last();
			RDC::OCC::Graphic3d_ShaderVariable^ ChangeLast();
			virtual RDC::OCC::Graphic3d_ShaderVariable^ Value(int theIndex);
			RDC::OCC::Graphic3d_ShaderVariable^ ChangeValue(int theIndex);
			void SetValue(int theIndex, RDC::OCC::Graphic3d_ShaderVariable^ theItem);
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_ShaderVariable^>^ GetEnumerator();
			virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
		}; // class Graphic3d_ShaderVariableList
		...
		public ref class Graphic3d_ShaderAttributeList sealed
			: public RDC::OCC::BaseClass<::Graphic3d_ShaderAttributeList>
			, public IIndexEnumerable<RDC::OCC::Graphic3d_ShaderAttribute^>
		{
		...
		public:
			Graphic3d_ShaderAttributeList(::Graphic3d_ShaderAttributeList* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ShaderAttributeList>(nativeInstance, true)
			{}

			Graphic3d_ShaderAttributeList(::Graphic3d_ShaderAttributeList& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ShaderAttributeList>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_ShaderAttributeList::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_ShaderAttributeList::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_ShaderAttributeList::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_ShaderAttributeList::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_ShaderAttributeList::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::Graphic3d_ShaderAttribute^ Value();
				RDC::OCC::Graphic3d_ShaderAttribute^ ChangeValue();
				bool IsEqual(RDC::OCC::Graphic3d_ShaderAttributeList::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			Graphic3d_ShaderAttributeList();
			Graphic3d_ShaderAttributeList(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			int Size();
			int Length();
			int Lower();
			int Upper();
			...
			void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			void Clear();
			RDC::OCC::Graphic3d_ShaderAttributeList^ Assign(RDC::OCC::Graphic3d_ShaderAttributeList^ theOther);
			void Remove(RDC::OCC::Graphic3d_ShaderAttributeList::Iterator^ thePosition);
			void Append(RDC::OCC::Graphic3d_ShaderAttribute^ theItem);
			void Prepend(RDC::OCC::Graphic3d_ShaderAttribute^ theItem);
			void InsertBefore(int theIndex, RDC::OCC::Graphic3d_ShaderAttribute^ theItem);
			void InsertAfter(RDC::OCC::Graphic3d_ShaderAttributeList::Iterator^ thePosition, RDC::OCC::Graphic3d_ShaderAttribute^ theItem);
			void Split(int theIndex, RDC::OCC::Graphic3d_ShaderAttributeList^ theSeq);
			RDC::OCC::Graphic3d_ShaderAttribute^ First();
			RDC::OCC::Graphic3d_ShaderAttribute^ ChangeFirst();
			RDC::OCC::Graphic3d_ShaderAttribute^ Last();
			RDC::OCC::Graphic3d_ShaderAttribute^ ChangeLast();
			virtual RDC::OCC::Graphic3d_ShaderAttribute^ Value(int theIndex);
			RDC::OCC::Graphic3d_ShaderAttribute^ ChangeValue(int theIndex);
			void SetValue(int theIndex, RDC::OCC::Graphic3d_ShaderAttribute^ theItem);
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_ShaderAttribute^>^ GetEnumerator();
			virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
		}; // class Graphic3d_ShaderAttributeList
		...
		public ref class Graphic3d_CameraLerp sealed
			: public RDC::OCC::BaseClass<::Graphic3d_CameraLerp>
		{
		...
		public:
			Graphic3d_CameraLerp(::Graphic3d_CameraLerp* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CameraLerp>(nativeInstance, true)
			{}

			Graphic3d_CameraLerp(::Graphic3d_CameraLerp& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CameraLerp>(&nativeInstance, false)
			{}
		...
		public:
			...
			Graphic3d_CameraLerp(RDC::OCC::Graphic3d_Camera^ theStart, RDC::OCC::Graphic3d_Camera^ theEnd);
			static RDC::OCC::Graphic3d_Camera^ Interpolate(RDC::OCC::Graphic3d_Camera^ theStart, RDC::OCC::Graphic3d_Camera^ theEnd, double theT);
			void Init(RDC::OCC::Graphic3d_Camera^ theStart, RDC::OCC::Graphic3d_Camera^ theEnd);
		}; // class Graphic3d_CameraLerp
		...
		public ref class Graphic3d_MapOfAspectsToAspects sealed
			: public RDC::OCC::BaseClass<::Graphic3d_MapOfAspectsToAspects>
		{
		...
		public:
			Graphic3d_MapOfAspectsToAspects(::Graphic3d_MapOfAspectsToAspects* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MapOfAspectsToAspects>(nativeInstance, true)
			{}

			Graphic3d_MapOfAspectsToAspects(::Graphic3d_MapOfAspectsToAspects& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MapOfAspectsToAspects>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_MapOfAspectsToAspects::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_MapOfAspectsToAspects::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_MapOfAspectsToAspects::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_MapOfAspectsToAspects::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_MapOfAspectsToAspects::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::Graphic3d_Aspects^ Value();
				RDC::OCC::Graphic3d_Aspects^ ChangeValue();
				RDC::OCC::Graphic3d_Aspects^ Key();
			}; // class Iterator

			Graphic3d_MapOfAspectsToAspects();
			Graphic3d_MapOfAspectsToAspects(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			Graphic3d_MapOfAspectsToAspects(int theNbBuckets);
			void Exchange(RDC::OCC::Graphic3d_MapOfAspectsToAspects^ theOther);
			RDC::OCC::Graphic3d_MapOfAspectsToAspects^ Assign(RDC::OCC::Graphic3d_MapOfAspectsToAspects^ theOther);
			void ReSize(int N);
			bool Bind(RDC::OCC::Graphic3d_Aspects^ theKey, RDC::OCC::Graphic3d_Aspects^ theItem);
			RDC::OCC::Graphic3d_Aspects^ Bound(RDC::OCC::Graphic3d_Aspects^ theKey, RDC::OCC::Graphic3d_Aspects^ theItem);
			bool IsBound(RDC::OCC::Graphic3d_Aspects^ theKey);
			bool UnBind(RDC::OCC::Graphic3d_Aspects^ theKey);
			RDC::OCC::Graphic3d_Aspects^ Seek(RDC::OCC::Graphic3d_Aspects^ theKey);
			RDC::OCC::Graphic3d_Aspects^ Find(RDC::OCC::Graphic3d_Aspects^ theKey);
			RDC::OCC::Graphic3d_Aspects^ ChangeSeek(RDC::OCC::Graphic3d_Aspects^ theKey);
			RDC::OCC::Graphic3d_Aspects^ ChangeFind(RDC::OCC::Graphic3d_Aspects^ theKey);
		...
		public ref class Graphic3d_SequenceOfGroup sealed
			: public RDC::OCC::BaseClass<::Graphic3d_SequenceOfGroup>
			, public IIndexEnumerable<RDC::OCC::Graphic3d_Group^>
		{
		...
		public:
			Graphic3d_SequenceOfGroup(::Graphic3d_SequenceOfGroup* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_SequenceOfGroup>(nativeInstance, true)
			{}

			Graphic3d_SequenceOfGroup(::Graphic3d_SequenceOfGroup& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_SequenceOfGroup>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_SequenceOfGroup::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_SequenceOfGroup::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_SequenceOfGroup::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_SequenceOfGroup::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_SequenceOfGroup::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::Graphic3d_Group^ Value();
				RDC::OCC::Graphic3d_Group^ ChangeValue();
				bool IsEqual(RDC::OCC::Graphic3d_SequenceOfGroup::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			Graphic3d_SequenceOfGroup();
			Graphic3d_SequenceOfGroup(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			int Size();
			int Length();
			int Lower();
			int Upper();
			...
			void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			void Clear();
			RDC::OCC::Graphic3d_SequenceOfGroup^ Assign(RDC::OCC::Graphic3d_SequenceOfGroup^ theOther);
			void Remove(RDC::OCC::Graphic3d_SequenceOfGroup::Iterator^ thePosition);
			void Append(RDC::OCC::Graphic3d_Group^ theItem);
			void Prepend(RDC::OCC::Graphic3d_Group^ theItem);
			void InsertBefore(int theIndex, RDC::OCC::Graphic3d_Group^ theItem);
			void InsertAfter(RDC::OCC::Graphic3d_SequenceOfGroup::Iterator^ thePosition, RDC::OCC::Graphic3d_Group^ theItem);
			void Split(int theIndex, RDC::OCC::Graphic3d_SequenceOfGroup^ theSeq);
			RDC::OCC::Graphic3d_Group^ First();
			RDC::OCC::Graphic3d_Group^ ChangeFirst();
			RDC::OCC::Graphic3d_Group^ Last();
			RDC::OCC::Graphic3d_Group^ ChangeLast();
			virtual RDC::OCC::Graphic3d_Group^ Value(int theIndex);
			RDC::OCC::Graphic3d_Group^ ChangeValue(int theIndex);
			void SetValue(int theIndex, RDC::OCC::Graphic3d_Group^ theItem);
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_Group^>^ GetEnumerator();
			virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
		}; // class Graphic3d_SequenceOfGroup
		...
		public ref class Graphic3d_MapOfStructure sealed
			: public RDC::OCC::BaseClass<::Graphic3d_MapOfStructure>
		{
		...
		public:
			Graphic3d_MapOfStructure(::Graphic3d_MapOfStructure* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MapOfStructure>(nativeInstance, true)
			{}

			Graphic3d_MapOfStructure(::Graphic3d_MapOfStructure& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MapOfStructure>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_MapOfStructure::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_MapOfStructure::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_MapOfStructure::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_MapOfStructure::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_MapOfStructure::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				RDC::OCC::Graphic3d_Structure^ Key();
			}; // class Iterator

			Graphic3d_MapOfStructure();
			Graphic3d_MapOfStructure(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			Graphic3d_MapOfStructure(int theNbBuckets);
			void Exchange(RDC::OCC::Graphic3d_MapOfStructure^ theOther);
			RDC::OCC::Graphic3d_MapOfStructure^ Assign(RDC::OCC::Graphic3d_MapOfStructure^ theOther);
			void ReSize(int N);
			bool Add(RDC::OCC::Graphic3d_Structure^ theKey);
			RDC::OCC::Graphic3d_Structure^ Added(RDC::OCC::Graphic3d_Structure^ theKey);
			bool Contains(RDC::OCC::Graphic3d_Structure^ theKey);
			bool Remove(RDC::OCC::Graphic3d_Structure^ K);
			void Clear(bool doReleaseMemory);
			void Clear();
			int Size();
			bool IsEqual(RDC::OCC::Graphic3d_MapOfStructure^ theOther);
			void Union(RDC::OCC::Graphic3d_MapOfStructure^ theLeft, RDC::OCC::Graphic3d_MapOfStructure^ theRight);
			bool Unite(RDC::OCC::Graphic3d_MapOfStructure^ theOther);
			bool HasIntersection(RDC::OCC::Graphic3d_MapOfStructure^ theMap);
			void Intersection(RDC::OCC::Graphic3d_MapOfStructure^ theLeft, RDC::OCC::Graphic3d_MapOfStructure^ theRight);
			bool Intersect(RDC::OCC::Graphic3d_MapOfStructure^ theOther);
			void Subtraction(RDC::OCC::Graphic3d_MapOfStructure^ theLeft, RDC::OCC::Graphic3d_MapOfStructure^ theRight);
			bool Subtract(RDC::OCC::Graphic3d_MapOfStructure^ theOther);
			void Difference(RDC::OCC::Graphic3d_MapOfStructure^ theLeft, RDC::OCC::Graphic3d_MapOfStructure^ theRight);
			bool Differ(RDC::OCC::Graphic3d_MapOfStructure^ theOther);
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_MapOfStructure
		...
		public ref class Graphic3d_SequenceOfStructure sealed
			: public RDC::OCC::BaseClass<::Graphic3d_SequenceOfStructure>
			, public IIndexEnumerable<RDC::OCC::Graphic3d_Structure^>
		{
		...
		public:
			Graphic3d_SequenceOfStructure(::Graphic3d_SequenceOfStructure* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_SequenceOfStructure>(nativeInstance, true)
			{}

			Graphic3d_SequenceOfStructure(::Graphic3d_SequenceOfStructure& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_SequenceOfStructure>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_SequenceOfStructure::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_SequenceOfStructure::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_SequenceOfStructure::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_SequenceOfStructure::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_SequenceOfStructure::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool IsEqual(RDC::OCC::Graphic3d_SequenceOfStructure::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			Graphic3d_SequenceOfStructure();
			Graphic3d_SequenceOfStructure(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			int Size();
			int Length();
			int Lower();
			int Upper();
			...
			void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			void Clear();
			RDC::OCC::Graphic3d_SequenceOfStructure^ Assign(RDC::OCC::Graphic3d_SequenceOfStructure^ theOther);
			void Remove(RDC::OCC::Graphic3d_SequenceOfStructure::Iterator^ thePosition);
			void Append(RDC::OCC::Graphic3d_Structure^ theItem);
			void Prepend(RDC::OCC::Graphic3d_Structure^ theItem);
			void InsertBefore(int theIndex, RDC::OCC::Graphic3d_Structure^ theItem);
			void InsertAfter(RDC::OCC::Graphic3d_SequenceOfStructure::Iterator^ thePosition, RDC::OCC::Graphic3d_Structure^ theItem);
			void Split(int theIndex, RDC::OCC::Graphic3d_SequenceOfStructure^ theSeq);
			RDC::OCC::Graphic3d_Structure^ First();
			RDC::OCC::Graphic3d_Structure^ ChangeFirst();
			RDC::OCC::Graphic3d_Structure^ Last();
			RDC::OCC::Graphic3d_Structure^ ChangeLast();
			virtual RDC::OCC::Graphic3d_Structure^ Value(int theIndex);
			RDC::OCC::Graphic3d_Structure^ ChangeValue(int theIndex);
			void SetValue(int theIndex, RDC::OCC::Graphic3d_Structure^ theItem);
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_Structure^>^ GetEnumerator();
			virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
		}; // class Graphic3d_SequenceOfStructure
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_GraphicDriverFactoryList::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_GraphicDriverFactoryList::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_GraphicDriverFactoryList::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_GraphicDriverFactoryList::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_GraphicDriverFactoryList::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				bool More();
				void Next();
				RDC::OCC::Graphic3d_GraphicDriverFactory^ Value();
				RDC::OCC::Graphic3d_GraphicDriverFactory^ ChangeValue();
			}; // class Iterator

			Graphic3d_GraphicDriverFactoryList();
			Graphic3d_GraphicDriverFactoryList(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			int Size();
			RDC::OCC::Graphic3d_GraphicDriverFactoryList^ Assign(RDC::OCC::Graphic3d_GraphicDriverFactoryList^ theOther);
			void Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			void Clear();
			RDC::OCC::Graphic3d_GraphicDriverFactory^ First();
			RDC::OCC::Graphic3d_GraphicDriverFactory^ Last();
			RDC::OCC::Graphic3d_GraphicDriverFactory^ Append(RDC::OCC::Graphic3d_GraphicDriverFactory^ theItem);
			RDC::OCC::Graphic3d_GraphicDriverFactory^ Prepend(RDC::OCC::Graphic3d_GraphicDriverFactory^ theItem);
			void RemoveFirst();
			void Remove(RDC::OCC::Graphic3d_GraphicDriverFactoryList::Iterator^ theIter);
			RDC::OCC::Graphic3d_GraphicDriverFactory^ InsertBefore(RDC::OCC::Graphic3d_GraphicDriverFactory^ theItem, RDC::OCC::Graphic3d_GraphicDriverFactoryList::Iterator^ theIter);
			RDC::OCC::Graphic3d_GraphicDriverFactory^ InsertAfter(RDC::OCC::Graphic3d_GraphicDriverFactory^ theItem, RDC::OCC::Graphic3d_GraphicDriverFactoryList::Iterator^ theIter);
			void Reverse();
		}; // class Graphic3d_GraphicDriverFactoryList
		...
		public ref class Graphic3d_IndexedMapOfStructure sealed
			: public RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfStructure>
		{
		...
		public:
			Graphic3d_IndexedMapOfStructure(::Graphic3d_IndexedMapOfStructure* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfStructure>(nativeInstance, true)
			{}

			Graphic3d_IndexedMapOfStructure(::Graphic3d_IndexedMapOfStructure& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfStructure>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfStructure::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_IndexedMapOfStructure::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfStructure::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_IndexedMapOfStructure::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfStructure::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::Graphic3d_CStructure^ Value();
				bool IsEqual(RDC::OCC::Graphic3d_IndexedMapOfStructure::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			Graphic3d_IndexedMapOfStructure();
			Graphic3d_IndexedMapOfStructure(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			Graphic3d_IndexedMapOfStructure(int theNbBuckets);
			void Exchange(RDC::OCC::Graphic3d_IndexedMapOfStructure^ theOther);
			RDC::OCC::Graphic3d_IndexedMapOfStructure^ Assign(RDC::OCC::Graphic3d_IndexedMapOfStructure^ theOther);
			void ReSize(int theExtent);
			int Add(RDC::OCC::Graphic3d_CStructure^ theKey1);
			bool Contains(RDC::OCC::Graphic3d_CStructure^ theKey1);
			void Substitute(int theIndex, RDC::OCC::Graphic3d_CStructure^ theKey1);
			void Swap(int theIndex1, int theIndex2);
			void RemoveLast();
			void RemoveFromIndex(int theIndex);
			bool RemoveKey(RDC::OCC::Graphic3d_CStructure^ theKey1);
			RDC::OCC::Graphic3d_CStructure^ FindKey(int theIndex);
			int FindIndex(RDC::OCC::Graphic3d_CStructure^ theKey1);
			void Clear(bool doReleaseMemory);
			void Clear();
			int Size();
		}; // class Graphic3d_IndexedMapOfStructure
		...
		public ref class Graphic3d_MapOfObject sealed
			: public RDC::OCC::BaseClass<::Graphic3d_MapOfObject>
		{
		...
		public:
			Graphic3d_MapOfObject(::Graphic3d_MapOfObject* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MapOfObject>(nativeInstance, true)
			{}

			Graphic3d_MapOfObject(::Graphic3d_MapOfObject& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MapOfObject>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_MapOfObject::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_MapOfObject::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_MapOfObject::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_MapOfObject::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_MapOfObject::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool More();
				void Next();
				RDC::OCC::Graphic3d_ViewAffinity^ Value();
				RDC::OCC::Graphic3d_ViewAffinity^ ChangeValue();
				RDC::OCC::Standard_Transient^ Key();
			}; // class Iterator

			Graphic3d_MapOfObject();
			Graphic3d_MapOfObject(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			Graphic3d_MapOfObject(int theNbBuckets);
			void Exchange(RDC::OCC::Graphic3d_MapOfObject^ theOther);
			RDC::OCC::Graphic3d_MapOfObject^ Assign(RDC::OCC::Graphic3d_MapOfObject^ theOther);
			void ReSize(int N);
			bool Bind(RDC::OCC::Standard_Transient^ theKey, RDC::OCC::Graphic3d_ViewAffinity^ theItem);
			RDC::OCC::Graphic3d_ViewAffinity^ Bound(RDC::OCC::Standard_Transient^ theKey, RDC::OCC::Graphic3d_ViewAffinity^ theItem);
			bool IsBound(RDC::OCC::Standard_Transient^ theKey);
			bool UnBind(RDC::OCC::Standard_Transient^ theKey);
			RDC::OCC::Graphic3d_ViewAffinity^ Seek(RDC::OCC::Standard_Transient^ theKey);
			RDC::OCC::Graphic3d_ViewAffinity^ Find(RDC::OCC::Standard_Transient^ theKey);
			RDC::OCC::Graphic3d_ViewAffinity^ ChangeSeek(RDC::OCC::Standard_Transient^ theKey);
			RDC::OCC::Graphic3d_ViewAffinity^ ChangeFind(RDC::OCC::Standard_Transient^ theKey);
			void Clear(bool doReleaseMemory);
			void Clear();
			int Size();
		}; // class Graphic3d_MapOfObject
		...
		public ref class Graphic3d_IndexedMapOfView sealed
			: public RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfView>
		{
		...
		public:
			Graphic3d_IndexedMapOfView(::Graphic3d_IndexedMapOfView* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfView>(nativeInstance, true)
			{}

			Graphic3d_IndexedMapOfView(::Graphic3d_IndexedMapOfView& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfView>(&nativeInstance, false)
			{}
		...
		public:
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfView::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_IndexedMapOfView::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfView::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_IndexedMapOfView::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_IndexedMapOfView::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				bool IsEqual(RDC::OCC::Graphic3d_IndexedMapOfView::Iterator^ theOther);
				bool Equals(System::Object^ obj) override;
			}; // class Iterator

			Graphic3d_IndexedMapOfView();
			Graphic3d_IndexedMapOfView(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator);
			Graphic3d_IndexedMapOfView(int theNbBuckets);
			void Exchange(RDC::OCC::Graphic3d_IndexedMapOfView^ theOther);
			RDC::OCC::Graphic3d_IndexedMapOfView^ Assign(RDC::OCC::Graphic3d_IndexedMapOfView^ theOther);
			void ReSize(int theExtent);
			int Add(RDC::OCC::Graphic3d_CView^ theKey1);
			bool Contains(RDC::OCC::Graphic3d_CView^ theKey1);
			void Substitute(int theIndex, RDC::OCC::Graphic3d_CView^ theKey1);
			void Swap(int theIndex1, int theIndex2);
			void RemoveLast();
			void RemoveFromIndex(int theIndex);
			bool RemoveKey(RDC::OCC::Graphic3d_CView^ theKey1);
			RDC::OCC::Graphic3d_CView^ FindKey(int theIndex);
			int FindIndex(RDC::OCC::Graphic3d_CView^ theKey1);
			void Clear(bool doReleaseMemory);
			void Clear();
			int Size();
		}; // class Graphic3d_IndexedMapOfView
		...
		public ref class Graphic3d_BufferRange sealed
			: public RDC::OCC::BaseClass<::Graphic3d_BufferRange>
		{
		...
		public:
			Graphic3d_BufferRange(::Graphic3d_BufferRange* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_BufferRange>(nativeInstance, true)
			{}

			Graphic3d_BufferRange(::Graphic3d_BufferRange& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_BufferRange>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			void Unite(RDC::OCC::Graphic3d_BufferRange^ theRange);
		}; // class Graphic3d_BufferRange
		...
		public ref class Graphic3d_Attribute sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Attribute>
		{
		...
		public:
			Graphic3d_Attribute(::Graphic3d_Attribute* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Attribute>(nativeInstance, true)
			{}

			Graphic3d_Attribute(::Graphic3d_Attribute& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Attribute>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			property RDC::OCC::Graphic3d_TypeOfAttribute Id {
				RDC::OCC::Graphic3d_TypeOfAttribute get() {
					return (RDC::OCC::Graphic3d_TypeOfAttribute)(((::Graphic3d_Attribute*)_NativeInstance)->Id);
				}
				void set(RDC::OCC::Graphic3d_TypeOfAttribute value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_TypeOfData DataType {
				RDC::OCC::Graphic3d_TypeOfData get() {
					return (RDC::OCC::Graphic3d_TypeOfData)(((::Graphic3d_Attribute*)_NativeInstance)->DataType);
				}
				void set(RDC::OCC::Graphic3d_TypeOfData value) {
			...
			/// </returns>
			static int Stride(RDC::OCC::Graphic3d_TypeOfData theType);
		}; // class Graphic3d_Attribute
		...
		public ref class Graphic3d_PolygonOffset sealed
			: public RDC::OCC::BaseClass<::Graphic3d_PolygonOffset>
		{
		...
		public:
			Graphic3d_PolygonOffset(::Graphic3d_PolygonOffset* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_PolygonOffset>(nativeInstance, true)
			{}

			Graphic3d_PolygonOffset(::Graphic3d_PolygonOffset& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_PolygonOffset>(&nativeInstance, false)
			{}
		...
		public:
			property RDC::OCC::Aspect_PolygonOffsetMode Mode {
				RDC::OCC::Aspect_PolygonOffsetMode get() {
					return (RDC::OCC::Aspect_PolygonOffsetMode)(((::Graphic3d_PolygonOffset*)_NativeInstance)->Mode);
				}
				void set(RDC::OCC::Aspect_PolygonOffsetMode value) {
		...
		public ref class Graphic3d_ValueInterface
			: public RDC::OCC::BaseClass<::Graphic3d_ValueInterface>
		{
		...
		public:
			Graphic3d_ValueInterface(::Graphic3d_ValueInterface* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ValueInterface>(nativeInstance, true)
			{}

			Graphic3d_ValueInterface(::Graphic3d_ValueInterface& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ValueInterface>(&nativeInstance, false)
			{}
		...
		public ref class Graphic3d_ZLayerSettings sealed
			: public RDC::OCC::BaseClass<::Graphic3d_ZLayerSettings>
		{
		...
		public:
			Graphic3d_ZLayerSettings(::Graphic3d_ZLayerSettings* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ZLayerSettings>(nativeInstance, true)
			{}

			Graphic3d_ZLayerSettings(::Graphic3d_ZLayerSettings& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ZLayerSettings>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ Name();
			/// <summary>
			/// Set custom name.
			/// </summary>
			void SetName(RDC::OCC::TCollection_AsciiString^ theName);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_LightSet^ Lights();
			/// <summary>
			/// Assign lights list to be used.
			/// </summary>
			void SetLights(RDC::OCC::Graphic3d_LightSet^ theLights);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopLoc_Datum3D^ OriginTransformation();
			/// <summary>
			/// Set the origin of all objects within the layer.
			/// </summary>
			void SetOrigin(RDC::OCC::XYZ theOrigin);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_PolygonOffset^ PolygonOffset();
			/// <summary>
			/// Setup glPolygonOffset() arguments.
			/// </summary>
			void SetPolygonOffset(RDC::OCC::Graphic3d_PolygonOffset^ theParams);
			/// <summary>
			/// Modify glPolygonOffset() arguments.
			/// </summary>
			RDC::OCC::Graphic3d_PolygonOffset^ ChangePolygonOffset();
			/// <summary>
		...
		public ref class Graphic3d_BoundBuffer sealed
			: public RDC::OCC::NCollection_Buffer
		{
		...
		public:
			Graphic3d_BoundBuffer(::Graphic3d_BoundBuffer* nativeInstance)
				: RDC::OCC::NCollection_Buffer(nativeInstance)
			{}
		...
		public:
			...
			/// Empty constructor.
			/// </summary>
			Graphic3d_BoundBuffer(RDC::OCC::NCollection_BaseAllocator^ theAlloc);
			/// <summary>
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_BoundBuffer^ CreateDowncasted(::Graphic3d_BoundBuffer* instance);
		}; // class Graphic3d_BoundBuffer
		...
		public:
			...
			/// </summary>
			static RDC::OCC::Graphic3d_ArrayOfPrimitives^ CreateArray(RDC::OCC::Graphic3d_TypeOfPrimitiveArray theType, int theMaxVertexs, int theMaxEdges, int theArrayFlags);
			/// <summary>
			/// Create an array of specified type.
			/// </summary>
			static RDC::OCC::Graphic3d_ArrayOfPrimitives^ CreateArray(RDC::OCC::Graphic3d_TypeOfPrimitiveArray theType, int theMaxVertexs, int theMaxBounds, int theMaxEdges, int theArrayFlags);
			/* Method skipped due to unknown mapping: Graphic3d_Buffer Attributes() */
			/// <summary>
			/// Returns the type of this primitive
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfPrimitiveArray Type();
			/// <summary>
			...
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex);
			/// <summary>
			/// Adds a vertice in the array.
			/// </summary>
			/// <returns>
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Graphic3d_Vec3^ theVertex);
			/// <summary>
			/// Adds a vertice in the array.
			/// </summary>
			/// <returns>
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Adds a vertice and vertex color in the vertex array.
			/// Warning: theColor is ignored when the hasVColors constructor parameter is FALSE
			/// </summary>
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, int theColor32);
			/// <summary>
			/// Adds a vertice and vertex color in the vertex array.
			/// Warning: theColor is ignored when the hasVColors constructor parameter is FALSE
			/// </summary>
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, RDC::OCC::Graphic3d_Vec4ub^ theColor);
			/// <summary>
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, RDC::OCC::Dir theNormal);
			/// <summary>
			/// Adds a vertice and vertex normal in the vertex array.
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, RDC::OCC::Dir theNormal, RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Adds a vertice,vertex normal and color in the vertex array.
			/// Warning: theNormal is ignored when the hasVNormals constructor parameter is FALSE
			/// and      theColor  is ignored when the hasVColors  constructor parameter is FALSE.
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, RDC::OCC::Dir theNormal, int theColor32);
			/// <summary>
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, RDC::OCC::Pnt2d theTexel);
			/// <summary>
			...
			/// the actual vertex number
			/// </returns>
			int AddVertex(RDC::OCC::Pnt theVertex, RDC::OCC::Dir theNormal, RDC::OCC::Pnt2d theTexel);
			/// <summary>
			/// Adds a vertice,vertex normal and texture in the vertex array.
			/// Warning: Normal is ignored when the hasVNormals constructor parameter is FALSE
			...
			/// </param>
			void SetVertice(int theIndex, RDC::OCC::Pnt theVertex);
			/// <summary>
			...
			/// theColor node color
			/// </param>
			void SetVertexColor(int theIndex, RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Change the vertex color in the array.
			/// </summary>
			/// <param name="in]">
			...
			/// </param>
			void SetVertexColor(int theIndex, RDC::OCC::Graphic3d_Vec4ub^ theColor);
			/// <summary>
			/// Change the vertex color in the array.
			/// </summary>
			/// @code
			...
			/// </param>
			void SetVertexNormal(int theIndex, RDC::OCC::Dir theNormal);
			/// <summary>
			/// Change the vertex normal in the array.
			/// </summary>
			/// <param name="in]">
			...
			/// </param>
			void SetVertexTexel(int theIndex, RDC::OCC::Pnt2d theTexel);
			/// <summary>
			/// Change the vertex texel in the array.
			/// </summary>
			/// <param name="in]">
			...
			/// node 3D coordinates
			/// </returns>
			RDC::OCC::Pnt Vertice(int theRank);
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Quantity_Color^ VertexColor(int theRank);
			/// <summary>
			...
			/// theColor node RGBA color values within [0, 255] range
			/// </param>
			void VertexColor(int theIndex, RDC::OCC::Graphic3d_Vec4ub^ theColor);
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Dir VertexNormal(int theRank);
			/// <summary>
			...
			/// UV coordinates
			/// </returns>
			RDC::OCC::Pnt2d VertexTexel(int theRank);
			/// <summary>
			...
			/// the actual edges number
			/// </returns>
			int AddTriangleEdges(RDC::OCC::Graphic3d_Vec3i^ theIndexes);
			/// <summary>
			...
			/// the actual edges number
			/// </returns>
			int AddTriangleEdges(RDC::OCC::Graphic3d_Vec4i^ theIndexes);
			/// <summary>
			...
			/// the actual edges number
			/// </returns>
			int AddQuadTriangleEdges(RDC::OCC::Graphic3d_Vec4i^ theIndexes);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_BoundBuffer^ Bounds();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Quantity_Color^ BoundColor(int theRank);
			/// <summary>
			...
			/// the actual bounds number
			/// </returns>
			int AddBound(int theEdgeNumber, RDC::OCC::Quantity_Color^ theBColor);
			/// <summary>
			...
			/// </summary>
			void SetBoundColor(int theIndex, RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Change the bound color of rank theIndex in the array.
			/// </summary>
			void SetBoundColor(int theIndex, double theR, double theG, double theB);
			static RDC::OCC::Graphic3d_ArrayOfPrimitives^ CreateDowncasted(::Graphic3d_ArrayOfPrimitives* instance);
		}; // class Graphic3d_ArrayOfPrimitives
		...
		public ref class Graphic3d_ArrayOfPoints sealed
			: public RDC::OCC::Graphic3d_ArrayOfPrimitives
		{
		...
		public:
			Graphic3d_ArrayOfPoints(::Graphic3d_ArrayOfPoints* nativeInstance)
				: RDC::OCC::Graphic3d_ArrayOfPrimitives(nativeInstance)
			{}
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfPoints^ CreateDowncasted(::Graphic3d_ArrayOfPoints* instance);
		}; // class Graphic3d_ArrayOfPoints
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfPolygons^ CreateDowncasted(::Graphic3d_ArrayOfPolygons* instance);
		}; // class Graphic3d_ArrayOfPolygons
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfPolylines^ CreateDowncasted(::Graphic3d_ArrayOfPolylines* instance);
		}; // class Graphic3d_ArrayOfPolylines
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfQuadrangles^ CreateDowncasted(::Graphic3d_ArrayOfQuadrangles* instance);
		}; // class Graphic3d_ArrayOfQuadrangles
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfQuadrangleStrips^ CreateDowncasted(::Graphic3d_ArrayOfQuadrangleStrips* instance);
		}; // class Graphic3d_ArrayOfQuadrangleStrips
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfSegments^ CreateDowncasted(::Graphic3d_ArrayOfSegments* instance);
		}; // class Graphic3d_ArrayOfSegments
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfTriangleFans^ CreateDowncasted(::Graphic3d_ArrayOfTriangleFans* instance);
		}; // class Graphic3d_ArrayOfTriangleFans
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfTriangles^ CreateDowncasted(::Graphic3d_ArrayOfTriangles* instance);
		}; // class Graphic3d_ArrayOfTriangles
		...
		public:
			...
			static RDC::OCC::Graphic3d_ArrayOfTriangleStrips^ CreateDowncasted(::Graphic3d_ArrayOfTriangleStrips* instance);
		}; // class Graphic3d_ArrayOfTriangleStrips
		...
		public:
			...
			/// [in] colorless image
			/// </param>
			Graphic3d_MarkerImage(RDC::OCC::Image_PixMap^ theImage, RDC::OCC::Image_PixMap^ theImageAlpha);
			/// <summary>
			/// Constructor from existing pixmap.
			/// </summary>
			/// <param name="theImage">
			...
			/// [in] colorless image
			/// </param>
			Graphic3d_MarkerImage(RDC::OCC::Image_PixMap^ theImage);
			/// <summary>
			...
			/// </param>
			Graphic3d_MarkerImage(RDC::OCC::TColStd_HArray1OfByte^ theBitMap, int theWidth, int theHeight);
			/// <summary>
			/// Returns a marker image for the marker of the specified type, scale and color.
			/// </summary>
			static RDC::OCC::Graphic3d_MarkerImage^ StandardMarker(RDC::OCC::Aspect_TypeOfMarker theMarkerType, float theScale, RDC::OCC::Graphic3d_Vec4^ theColor);
			/// <summary>
			/// Return marker image.
			/// If an instance of the class has been initialized with a bitmap, it will be converted to image.
			/// </summary>
			RDC::OCC::Image_PixMap^ GetImage();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Image_PixMap^ GetImageAlpha();
			/// <summary>
			/// Return an unique ID.
			/// This ID will be used to manage resource in graphic driver.
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ GetImageId();
			/// <summary>
			/// Return an unique ID.
			/// This ID will be used to manage resource in graphic driver.
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ GetImageAlphaId();
			/// <summary>
			/// Return texture size
			/// </summary>
			...
			/// </param>
			RDC::OCC::TColStd_HArray1OfByte^ GetBitMapArray(double theAlphaValue, bool theIsTopDown);
			/// <summary>
			/// Return marker image as array of bytes.
			/// If an instance of the class has been initialized with image, it will be converted to bitmap based on the parameter theAlphaValue.
			/// </summary>
			...
			/// [in] flag indicating expected rows order in returned bitmap, which is bottom-up by default
			/// </param>
			RDC::OCC::TColStd_HArray1OfByte^ GetBitMapArray(double theAlphaValue);
			/// <summary>
			/// Return marker image as array of bytes.
			/// If an instance of the class has been initialized with image, it will be converted to bitmap based on the parameter theAlphaValue.
			/// </summary>
			...
			/// [in] flag indicating expected rows order in returned bitmap, which is bottom-up by default
			/// </param>
			RDC::OCC::TColStd_HArray1OfByte^ GetBitMapArray();
			static RDC::OCC::Graphic3d_MarkerImage^ CreateDowncasted(::Graphic3d_MarkerImage* instance);
		}; // class Graphic3d_MarkerImage
		...
		public ref class Graphic3d_PBRMaterial sealed
			: public RDC::OCC::BaseClass<::Graphic3d_PBRMaterial>
		{
		...
		public:
			Graphic3d_PBRMaterial(::Graphic3d_PBRMaterial* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_PBRMaterial>(nativeInstance, true)
			{}

			Graphic3d_PBRMaterial(::Graphic3d_PBRMaterial& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_PBRMaterial>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			Graphic3d_PBRMaterial(RDC::OCC::Graphic3d_BSDF^ theBSDF);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Quantity_ColorRGBA^ Color();
			/// <summary>
			/// Modifies albedo color with alpha component.
			/// </summary>
			void SetColor(RDC::OCC::Quantity_ColorRGBA^ theColor);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_Vec3^ Emission();
			/// <summary>
			/// Modifies light intensity emitted by material.
			/// </summary>
			void SetEmission(RDC::OCC::Graphic3d_Vec3^ theEmission);
			/// <summary>
			/// Generates material in Metallic-Roughness system from Graphic3d_BSDF.
			/// </summary>
			void SetBSDF(RDC::OCC::Graphic3d_BSDF^ theBSDF);
			/// <summary>
			...
			/// </param>
			static void GenerateEnvLUT(RDC::OCC::Image_PixMap^ theLUT, unsigned int theNbIntegralSamples);
			/// <summary>
			/// Generates 2D look up table of scale and bias for fresnell zero coefficient.
			/// It is needed for calculation reflectance part of environment lighting.
			/// </summary>
			...
			/// theNbIntegralSamples number of importance samples in hemisphere integral calculation for every table item.
			/// </param>
			static void GenerateEnvLUT(RDC::OCC::Image_PixMap^ theLUT);
			/// <summary>
			...
			/// </returns>
			static float RoughnessFromSpecular(RDC::OCC::Quantity_Color^ theSpecular, double theShiness);
			/// <summary>
			...
			/// </returns>
			static float MetallicFromSpecular(RDC::OCC::Quantity_Color^ theSpecular);
			/// <summary>
		...
		public ref class Graphic3d_Fresnel sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Fresnel>
		{
		...
		public:
			Graphic3d_Fresnel(::Graphic3d_Fresnel* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Fresnel>(nativeInstance, true)
			{}

			Graphic3d_Fresnel(::Graphic3d_Fresnel& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Fresnel>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			static RDC::OCC::Graphic3d_Fresnel^ CreateSchlick(RDC::OCC::Graphic3d_Vec3^ theSpecularColor);
			/// <summary>
			/// Creates Fresnel factor for constant reflection.
			/// </summary>
			static RDC::OCC::Graphic3d_Fresnel^ CreateConstant(float theReflection);
			/// <summary>
			/// Creates Fresnel factor for physical-based dielectric model.
			/// </summary>
			static RDC::OCC::Graphic3d_Fresnel^ CreateDielectric(float theRefractionIndex);
			/// <summary>
			/// Creates Fresnel factor for physical-based conductor model.
			/// </summary>
			static RDC::OCC::Graphic3d_Fresnel^ CreateConductor(float theRefractionIndex, float theAbsorptionIndex);
			/// <summary>
			/// Creates Fresnel factor for physical-based conductor model (spectral version).
			/// </summary>
			static RDC::OCC::Graphic3d_Fresnel^ CreateConductor(RDC::OCC::Graphic3d_Vec3^ theRefractionIndex, RDC::OCC::Graphic3d_Vec3^ theAbsorptionIndex);
			/// <summary>
			/// Returns serialized representation of Fresnel factor.
			/// </summary>
			RDC::OCC::Graphic3d_Vec4^ Serialize();
			/// <summary>
			/// Returns type of Fresnel.
			/// </summary>
			RDC::OCC::Graphic3d_FresnelModel FresnelType();
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
		...
		public ref class Graphic3d_BSDF sealed
			: public RDC::OCC::BaseClass<::Graphic3d_BSDF>
		{
		...
		public:
			Graphic3d_BSDF(::Graphic3d_BSDF* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_BSDF>(nativeInstance, true)
			{}

			Graphic3d_BSDF(::Graphic3d_BSDF& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_BSDF>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			static RDC::OCC::Graphic3d_BSDF^ CreateDiffuse(RDC::OCC::Graphic3d_Vec3^ theWeight);
			/// <summary>
			/// Creates BSDF describing polished metallic-like surface.
			/// </summary>
			static RDC::OCC::Graphic3d_BSDF^ CreateMetallic(RDC::OCC::Graphic3d_Vec3^ theWeight, RDC::OCC::Graphic3d_Fresnel^ theFresnel, float theRoughness);
			/// <summary>
			...
			/// </summary>
			static RDC::OCC::Graphic3d_BSDF^ CreateTransparent(RDC::OCC::Graphic3d_Vec3^ theWeight, RDC::OCC::Graphic3d_Vec3^ theAbsorptionColor, float theAbsorptionCoeff);
			/// <summary>
			...
			/// </summary>
			static RDC::OCC::Graphic3d_BSDF^ CreateGlass(RDC::OCC::Graphic3d_Vec3^ theWeight, RDC::OCC::Graphic3d_Vec3^ theAbsorptionColor, float theAbsorptionCoeff, float theRefractionIndex);
			/// <summary>
			/// Creates BSDF from PBR metallic-roughness material.
			/// </summary>
			static RDC::OCC::Graphic3d_BSDF^ CreateMetallicRoughness(RDC::OCC::Graphic3d_PBRMaterial^ thePbr);
			/// <summary>
		...
		public ref class Graphic3d_MaterialAspect sealed
			: public RDC::OCC::BaseClass<::Graphic3d_MaterialAspect>
		{
		...
		public:
			Graphic3d_MaterialAspect(::Graphic3d_MaterialAspect* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MaterialAspect>(nativeInstance, true)
			{}

			Graphic3d_MaterialAspect(::Graphic3d_MaterialAspect& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_MaterialAspect>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			Graphic3d_MaterialAspect(RDC::OCC::Graphic3d_NameOfMaterial theName);
			/// <summary>
			...
			/// </summary>
			static RDC::OCC::Graphic3d_TypeOfMaterial MaterialType(int theRank);
			/// <summary>
			...
			/// </returns>
			static bool MaterialFromName(System::String^ theName, RDC::OCC::Graphic3d_NameOfMaterial% theMat);
			/// <summary>
			/// Returns the material for specified name or Graphic3d_NameOfMaterial_DEFAULT if name is unknown.
			/// </summary>
			static RDC::OCC::Graphic3d_NameOfMaterial MaterialFromName(System::String^ theName);
			/// <summary>
			/// Returns the material name (within predefined enumeration).
			/// </summary>
			RDC::OCC::Graphic3d_NameOfMaterial Name();
			/// <summary>
			/// Returns the material name within predefined enumeration which has been requested (before modifications).
			/// </summary>
			RDC::OCC::Graphic3d_NameOfMaterial RequestedName();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ StringName();
			/// <summary>
			/// Returns the given name of this material. This might be:
			/// </summary>
			...
			/// </summary>
			void SetMaterialName(RDC::OCC::TCollection_AsciiString^ theName);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Quantity_Color^ AmbientColor();
			/// <summary>
			/// Modifies the ambient color of the surface.
			/// </summary>
			void SetAmbientColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Returns the diffuse color of the surface.
			/// </summary>
			RDC::OCC::Quantity_Color^ DiffuseColor();
			/// <summary>
			/// Modifies the diffuse color of the surface.
			/// </summary>
			void SetDiffuseColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Returns the specular color of the surface.
			/// </summary>
			RDC::OCC::Quantity_Color^ SpecularColor();
			/// <summary>
			/// Modifies the specular color of the surface.
			/// </summary>
			void SetSpecularColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Returns the emissive color of the surface.
			/// </summary>
			RDC::OCC::Quantity_Color^ EmissiveColor();
			/// <summary>
			/// Modifies the emissive color of the surface.
			/// </summary>
			void SetEmissiveColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_PBRMaterial^ PBRMaterial();
			/// <summary>
			/// Modifies the physically based representation of material
			/// </summary>
			void SetPBRMaterial(RDC::OCC::Graphic3d_PBRMaterial^ thePBRMaterial);
			/// <summary>
			/// Returns TRUE if the reflection mode is active, FALSE otherwise.
			/// </summary>
			bool ReflectionMode(RDC::OCC::Graphic3d_TypeOfReflection theType);
			/// <summary>
			/// Returns material type.
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfMaterial MaterialType();
			/// <summary>
			/// Returns TRUE if type of this material is equal to specified type.
			/// </summary>
			bool MaterialType(RDC::OCC::Graphic3d_TypeOfMaterial theType);
			/// <summary>
			/// Set material type.
			/// </summary>
			void SetMaterialType(RDC::OCC::Graphic3d_TypeOfMaterial theType);
			/// <summary>
			/// Returns TRUE if this material differs from specified one.
			/// </summary>
			bool IsDifferent(RDC::OCC::Graphic3d_MaterialAspect^ theOther);
			/// <summary>
			/// Returns TRUE if this material is identical to specified one.
			/// </summary>
			bool IsEqual(RDC::OCC::Graphic3d_MaterialAspect^ theOther);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			/// </summary>
			void SetReflectionModeOff(RDC::OCC::Graphic3d_TypeOfReflection theType);
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_MaterialAspect
		...
		public:
			...
			Graphic3d_HatchStyle(RDC::OCC::Image_PixMap^ thePattern);
			/// <summary>
			...
			/// </summary>
			Graphic3d_HatchStyle(RDC::OCC::Aspect_HatchStyle theType);
			/// <summary>
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_HatchStyle^ CreateDowncasted(::Graphic3d_HatchStyle* instance);
		}; // class Graphic3d_HatchStyle
		...
		public:
			...
			/// </summary>
			Graphic3d_ShaderAttribute(RDC::OCC::TCollection_AsciiString^ theName, int theLocation);
			/// <summary>
			...
			/// </summary>
			int Location();
			static RDC::OCC::Graphic3d_ShaderAttribute^ CreateDowncasted(::Graphic3d_ShaderAttribute* instance);
		}; // class Graphic3d_ShaderAttribute
		...
		public:
			...
			/// </summary>
			static RDC::OCC::Graphic3d_ShaderObject^ CreateFromFile(RDC::OCC::Graphic3d_TypeOfShaderObject theType, RDC::OCC::TCollection_AsciiString^ thePath);
			/// <summary>
			/// Creates new shader object from specified source.
			/// </summary>
			static RDC::OCC::Graphic3d_ShaderObject^ CreateFromSource(RDC::OCC::Graphic3d_TypeOfShaderObject theType, RDC::OCC::TCollection_AsciiString^ theSource);
			...
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ Source();
			/// <summary>
			/// Returns type of the shader object.
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfShaderObject Type();
			/// <summary>
			/// Returns unique ID used to manage resource in graphic driver.
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ GetId();
			static RDC::OCC::Graphic3d_ShaderObject^ CreateDowncasted(::Graphic3d_ShaderObject* instance);
		}; // class Graphic3d_ShaderObject
		...
		public:
			...
			/// </summary>
			RDC::OCC::Graphic3d_ValueInterface^ Value();
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, float theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::gp_Vec2f^ theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::gp_Vec3f^ theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec4^ theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, int theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec2i^ theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec3i^ theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ Create(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec4i^ theValue);
			static RDC::OCC::Graphic3d_ShaderVariable^ CreateDowncasted(::Graphic3d_ShaderVariable* instance);
		}; // class Graphic3d_ShaderVariable
		...
		public:
			...
			/// </summary>
			RDC::OCC::Graphic3d_TextureUnit TextureUnit();
			/// <summary>
			/// Setup default texture unit.
			/// </summary>
			void SetTextureUnit(RDC::OCC::Graphic3d_TextureUnit theUnit);
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// </returns>
			RDC::OCC::Graphic3d_TypeOfTextureFilter Filter();
			/// <summary>
			/// </summary>
			/// <param name="theFilter">
			/// texture interpolation filter.
			/// </param>
			void SetFilter(RDC::OCC::Graphic3d_TypeOfTextureFilter theFilter);
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// </returns>
			RDC::OCC::Graphic3d_LevelOfTextureAnisotropy AnisoFilter();
			/// <summary>
			/// </summary>
			/// <param name="theLevel">
			/// level of anisontropy texture filter.
			/// </param>
			void SetAnisoFilter(RDC::OCC::Graphic3d_LevelOfTextureAnisotropy theLevel);
			/// <summary>
			...
			/// Complete transformation matrix: Rotation -> Translation -> Scale.
			/// </summary>
			RDC::OCC::Graphic3d_Vec2^ Scale();
			/// <summary>
			/// </summary>
			/// <param name="theScale">
			/// scale factor.
			/// </param>
			void SetScale(RDC::OCC::Graphic3d_Vec2^ theScale);
			/// <summary>
			/// Return translation vector; (0.0; 0.0), which means no translation.
			/// Complete transformation matrix: Rotation -> Translation -> Scale.
			/// </summary>
			RDC::OCC::Graphic3d_Vec2^ Translation();
			/// <summary>
			/// </summary>
			/// <param name="theVec">
			/// translation vector.
			/// </param>
			void SetTranslation(RDC::OCC::Graphic3d_Vec2^ theVec);
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// </returns>
			RDC::OCC::Graphic3d_TypeOfTextureMode GenMode();
			/// <summary>
			/// </summary>
			/// <returns>
			/// texture coordinates generation plane S.
			/// </returns>
			RDC::OCC::Graphic3d_Vec4^ GenPlaneS();
			/// <summary>
			/// </summary>
			/// <returns>
			/// texture coordinates generation plane T.
			/// </returns>
			RDC::OCC::Graphic3d_Vec4^ GenPlaneT();
			/// <summary>
			/// Setup texture coordinates generation mode.
			/// </summary>
			void SetGenMode(RDC::OCC::Graphic3d_TypeOfTextureMode theMode, RDC::OCC::Graphic3d_Vec4^ thePlaneS, RDC::OCC::Graphic3d_Vec4^ thePlaneT);
			/// <summary>
			/// </summary>
			/// <returns>
			...
			static RDC::OCC::Graphic3d_TextureParams^ CreateDowncasted(::Graphic3d_TextureParams* instance);
		}; // class Graphic3d_TextureParams
		...
		public:
			...
			/// </summary>
			void SetId(RDC::OCC::TCollection_AsciiString^ theId);
			/// <summary>
			/// Returns GLSL header (version code and extensions).
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ Header();
			/// <summary>
			...
			/// @endcode
			void SetHeader(RDC::OCC::TCollection_AsciiString^ theHeader);
			/// <summary>
			/// Append line to GLSL header.
			/// </summary>
			void AppendToHeader(RDC::OCC::TCollection_AsciiString^ theHeaderLine);
			/// <summary>
			...
			/// </summary>
			bool AttachShader(RDC::OCC::Graphic3d_ShaderObject^ theShader);
			/// <summary>
			/// Detaches shader object from the program object.
			/// </summary>
			bool DetachShader(RDC::OCC::Graphic3d_ShaderObject^ theShader);
			/// <summary>
			/// Returns list of attached shader objects.
			/// </summary>
			RDC::OCC::Graphic3d_ShaderObjectList^ ShaderObjects();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_ShaderVariableList^ Variables();
			/// <summary>
			/// Return the list of custom vertex attributes.
			/// </summary>
			RDC::OCC::Graphic3d_ShaderAttributeList^ VertexAttributes();
			/// <summary>
			/// Assign the list of custom vertex attributes.
			/// Should be done before GLSL program initialization.
			/// </summary>
			void SetVertexAttributes(RDC::OCC::Graphic3d_ShaderAttributeList^ theAttributes);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_RenderTransparentMethod OitOutput();
			/// <summary>
			...
			/// </summary>
			void SetOitOutput(RDC::OCC::Graphic3d_RenderTransparentMethod theOutput);
			/// <summary>
			...
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, float theValue);
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::gp_Vec2f^ theValue);
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::gp_Vec3f^ theValue);
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec4^ theValue);
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, int theValue);
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec2i^ theValue);
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec3i^ theValue);
			bool PushVariable(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec4i^ theValue);
			/// <summary>
			...
			/// </summary>
			bool PushVariableFloat(RDC::OCC::TCollection_AsciiString^ theName, float theValue);
			/// <summary>
			/// Pushes vec2 uniform.
			/// </summary>
			bool PushVariableVec2(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec2^ theValue);
			/// <summary>
			/// Pushes vec3 uniform.
			/// </summary>
			bool PushVariableVec3(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec3^ theValue);
			/// <summary>
			/// Pushes vec4 uniform.
			/// </summary>
			bool PushVariableVec4(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec4^ theValue);
			/// <summary>
			/// Pushes int uniform.
			/// </summary>
			bool PushVariableInt(RDC::OCC::TCollection_AsciiString^ theName, int theValue);
			/// <summary>
			/// Pushes vec2i uniform.
			/// </summary>
			bool PushVariableVec2i(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec2i^ theValue);
			/// <summary>
			/// Pushes vec3i uniform.
			/// </summary>
			bool PushVariableVec3i(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec3i^ theValue);
			/// <summary>
			/// Pushes vec4i uniform.
			/// </summary>
			bool PushVariableVec4i(RDC::OCC::TCollection_AsciiString^ theName, RDC::OCC::Graphic3d_Vec4i^ theValue);
			/// <summary>
			...
			/// </returns>
			static RDC::OCC::TCollection_AsciiString^ ShadersFolder();
			static RDC::OCC::Graphic3d_ShaderProgram^ CreateDowncasted(::Graphic3d_ShaderProgram* instance);
		}; // class Graphic3d_ShaderProgram
		...
		public:
			...
			/// </returns>
			static RDC::OCC::TCollection_AsciiString^ TexturesFolder();
			/// <summary>
			...
			/// the texture type.
			/// </returns>
			RDC::OCC::Graphic3d_TypeOfTexture Type();
			/// <summary>
			/// This ID will be used to manage resource in graphic driver.
			/// 
			...
			/// </returns>
			RDC::OCC::Image_CompressedPixMap^ GetCompressedImage(RDC::OCC::Image_SupportedFormats^ theSupported);
			/// <summary>
			/// This method will be called by graphic driver each time when texture resource should be created.
			...
			/// </returns>
			RDC::OCC::Image_PixMap^ GetImage(RDC::OCC::Image_SupportedFormats^ theSupported);
			/// <summary>
			/// </summary>
			/// <returns>
			/// low-level texture parameters
			/// </returns>
			RDC::OCC::Graphic3d_TextureParams^ GetParams();
			/// <summary>
			...
			/// </summary>
			bool IsTopDown();
			static RDC::OCC::Graphic3d_TextureRoot^ CreateDowncasted(::Graphic3d_TextureRoot* instance);
		}; // class Graphic3d_TextureRoot
		...
		public ref class Graphic3d_TextureMap
			: public RDC::OCC::Graphic3d_TextureRoot
		{
		...
		protected:
			Graphic3d_TextureMap(InitMode init)
				: RDC::OCC::Graphic3d_TextureRoot(init)
			{}

		public:
			Graphic3d_TextureMap(::Graphic3d_TextureMap* nativeInstance)
				: RDC::OCC::Graphic3d_TextureRoot(nativeInstance)
			{}
		...
		public:
			...
			/// </param>
			void SetAnisoFilter(RDC::OCC::Graphic3d_LevelOfTextureAnisotropy theLevel);
			static RDC::OCC::Graphic3d_TextureMap^ CreateDowncasted(::Graphic3d_TextureMap* instance);
		}; // class Graphic3d_TextureMap
		...
		public ref class Graphic3d_TextureSet sealed
			: public RDC::OCC::Standard_Transient
			, public IIndexEnumerable<RDC::OCC::Graphic3d_TextureMap^>
		{
		...
		public:
			...
			/// </summary>
			Graphic3d_TextureSet(RDC::OCC::Graphic3d_TextureMap^ theTexture);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_TextureMap^ First();
			/// <summary>
			/// Return the first texture.
			/// </summary>
			void SetFirst(RDC::OCC::Graphic3d_TextureMap^ theTexture);
			/// <summary>
			/// Return the texture at specified position within [0, Size()) range.
			/// </summary>
			virtual RDC::OCC::Graphic3d_TextureMap^ Value(int theIndex);
			/// <summary>
			/// Return the texture at specified position within [0, Size()) range.
			/// </summary>
			void SetValue(int theIndex, RDC::OCC::Graphic3d_TextureMap^ theTexture);
			static RDC::OCC::Graphic3d_TextureSet^ CreateDowncasted(::Graphic3d_TextureSet* instance);
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_TextureMap^>^ GetEnumerator();
			virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
		}; // class Graphic3d_TextureSet
		...
		public:
			...
			/// </summary>
			RDC::OCC::Aspect_InteriorStyle InteriorStyle();
			/// <summary>
			/// Modifies the interior type used for rendering
			/// </summary>
			void SetInteriorStyle(RDC::OCC::Aspect_InteriorStyle theStyle);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfShadingModel ShadingModel();
			/// <summary>
			/// Sets shading model
			/// </summary>
			void SetShadingModel(RDC::OCC::Graphic3d_TypeOfShadingModel theShadingModel);
			/// <summary>
			/// Returns the way how alpha value should be treated (Graphic3d_AlphaMode_BlendAuto by default, for backward compatibility).
			/// </summary>
			RDC::OCC::Graphic3d_AlphaMode AlphaMode();
			/// <summary>
			...
			/// </summary>
			void SetAlphaMode(RDC::OCC::Graphic3d_AlphaMode theMode, float theAlphaCutoff);
			/// <summary>
			/// Defines the way how alpha value should be treated.
			/// </summary>
			void SetAlphaMode(RDC::OCC::Graphic3d_AlphaMode theMode);
			/// <summary>
			/// Return color
			/// </summary>
			RDC::OCC::Quantity_ColorRGBA^ ColorRGBA();
			/// <summary>
			/// Return the color.
			/// </summary>
			RDC::OCC::Quantity_Color^ Color();
			...
			/// </summary>
			RDC::OCC::Quantity_Color^ InteriorColor();
			/// <summary>
			/// Return interior color.
			/// </summary>
			RDC::OCC::Quantity_ColorRGBA^ InteriorColorRGBA();
			/// <summary>
			/// Modifies the color of the interior of the face
			/// </summary>
			void SetInteriorColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Modifies the color of the interior of the face
			/// </summary>
			void SetInteriorColor(RDC::OCC::Quantity_ColorRGBA^ theColor);
			/// <summary>
			/// Return back interior color.
			/// </summary>
			RDC::OCC::Quantity_Color^ BackInteriorColor();
			/// <summary>
			/// Return back interior color.
			/// </summary>
			RDC::OCC::Quantity_ColorRGBA^ BackInteriorColorRGBA();
			/// <summary>
			/// Modifies the color of the interior of the back face
			/// </summary>
			void SetBackInteriorColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Modifies the color of the interior of the back face
			/// </summary>
			void SetBackInteriorColor(RDC::OCC::Quantity_ColorRGBA^ theColor);
			/// <summary>
			/// Returns the surface material of external faces
			/// </summary>
			RDC::OCC::Graphic3d_MaterialAspect^ FrontMaterial();
			/// <summary>
			/// Returns the surface material of external faces
			/// </summary>
			RDC::OCC::Graphic3d_MaterialAspect^ ChangeFrontMaterial();
			/// <summary>
			/// Modifies the surface material of external faces
			/// </summary>
			void SetFrontMaterial(RDC::OCC::Graphic3d_MaterialAspect^ theMaterial);
			/// <summary>
			/// Returns the surface material of internal faces
			/// </summary>
			RDC::OCC::Graphic3d_MaterialAspect^ BackMaterial();
			/// <summary>
			/// Returns the surface material of internal faces
			/// </summary>
			RDC::OCC::Graphic3d_MaterialAspect^ ChangeBackMaterial();
			/// <summary>
			/// Modifies the surface material of internal faces
			/// </summary>
			void SetBackMaterial(RDC::OCC::Graphic3d_MaterialAspect^ theMaterial);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfBackfacingModel FaceCulling();
			/// <summary>
			/// Set face culling mode.
			/// </summary>
			void SetFaceCulling(RDC::OCC::Graphic3d_TypeOfBackfacingModel theCulling);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_ShaderProgram^ ShaderProgram();
			/// <summary>
			/// Sets up OpenGL/GLSL shader program.
			/// </summary>
			void SetShaderProgram(RDC::OCC::Graphic3d_ShaderProgram^ theProgram);
			/// <summary>
			/// Return texture array to be mapped.
			/// </summary>
			RDC::OCC::Graphic3d_TextureSet^ TextureSet();
			/// <summary>
			/// Setup texture array to be mapped.
			/// </summary>
			void SetTextureSet(RDC::OCC::Graphic3d_TextureSet^ theTextures);
			/// <summary>
			/// Return texture to be mapped.
			/// </summary>
			RDC::OCC::Graphic3d_TextureMap^ TextureMap();
			/// <summary>
			/// Assign texture to be mapped.
			/// See also SetTextureMapOn() to actually activate texture mapping.
			/// </summary>
			void SetTextureMap(RDC::OCC::Graphic3d_TextureMap^ theTexture);
			/// <summary>
			...
			/// </summary>
			void SetPolygonOffset(RDC::OCC::Graphic3d_PolygonOffset^ theOffset);
			/// <summary>
			/// Returns current polygon offsets settings.
			/// </summary>
			...
			/// </summary>
			RDC::OCC::Aspect_TypeOfLine LineType();
			/// <summary>
			/// Modifies the line type
			/// </summary>
			void SetLineType(RDC::OCC::Aspect_TypeOfLine theType);
			/// <summary>
			...
			/// </summary>
			static short unsigned int DefaultLinePatternForType(RDC::OCC::Aspect_TypeOfLine theType);
			/// <summary>
			/// Return line type for stipple line pattern.
			/// </summary>
			static RDC::OCC::Aspect_TypeOfLine DefaultLineTypeForPattern(short unsigned int thePattern);
			/// <summary>
			/// Return marker type; Aspect_TOM_POINT by default.
			/// </summary>
			RDC::OCC::Aspect_TypeOfMarker MarkerType();
			/// <summary>
			/// Modifies the type of marker.
			/// </summary>
			void SetMarkerType(RDC::OCC::Aspect_TypeOfMarker theType);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_MarkerImage^ MarkerImage();
			/// <summary>
			/// Set marker's image texture.
			/// </summary>
			void SetMarkerImage(RDC::OCC::Graphic3d_MarkerImage^ theImage);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TCollection_HAsciiString^ TextFont();
			/// <summary>
			/// Modifies the font.
			/// </summary>
			void SetTextFont(RDC::OCC::TCollection_HAsciiString^ theFont);
			...
			/// </summary>
			RDC::OCC::Aspect_TypeOfDisplayText TextDisplayType();
			/// <summary>
			/// Sets display type.
			/// </summary>
			void SetTextDisplayType(RDC::OCC::Aspect_TypeOfDisplayText theType);
			/// <summary>
			/// Returns text background/shadow color; equals to EdgeColor() property.
			/// </summary>
			RDC::OCC::Quantity_ColorRGBA^ ColorSubTitleRGBA();
			/// <summary>
			/// Return text background/shadow color; equals to EdgeColor() property.
			/// </summary>
			RDC::OCC::Quantity_Color^ ColorSubTitle();
			/// <summary>
			/// Modifies text background/shadow color; equals to EdgeColor() property.
			/// </summary>
			void SetColorSubTitle(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Modifies text background/shadow color; equals to EdgeColor() property.
			/// </summary>
			void SetColorSubTitle(RDC::OCC::Quantity_ColorRGBA^ theColor);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Aspect_TypeOfStyleText TextStyle();
			/// <summary>
			/// Modifies the style of the text.
			/// </summary>
			void SetTextStyle(RDC::OCC::Aspect_TypeOfStyleText theStyle);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Quantity_Color^ EdgeColor();
			/// <summary>
			/// Return color of edges.
			/// </summary>
			RDC::OCC::Quantity_ColorRGBA^ EdgeColorRGBA();
			/// <summary>
			/// Modifies the color of the edge of the face
			/// </summary>
			void SetEdgeColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			/// Modifies the color of the edge of the face
			/// </summary>
			void SetEdgeColor(RDC::OCC::Quantity_ColorRGBA^ theColor);
			/// <summary>
			/// Return edges line type (same as LineType()).
			/// </summary>
			RDC::OCC::Aspect_TypeOfLine EdgeLineType();
			/// <summary>
			/// Modifies the edge line type (same as SetLineType())
			/// </summary>
			void SetEdgeLineType(RDC::OCC::Aspect_TypeOfLine theType);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_HatchStyle^ HatchStyle();
			/// <summary>
			/// Modifies the hatch type used when InteriorStyle is IS_HATCH
			/// </summary>
			void SetHatchStyle(RDC::OCC::Graphic3d_HatchStyle^ theStyle);
			/// <summary>
			/// Modifies the hatch type used when InteriorStyle is IS_HATCH
			/// </summary>
			/// @warning This method always creates a new handle for a given hatch style
			void SetHatchStyle(RDC::OCC::Aspect_HatchStyle theStyle);
			/// <summary>
			/// Check for equality with another aspects.
			/// </summary>
			bool IsEqual(RDC::OCC::Graphic3d_Aspects^ theOther);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			static RDC::OCC::Graphic3d_Aspects^ CreateDowncasted(::Graphic3d_Aspects* instance);
			bool Equals(System::Object^ obj) override;
		}; // class Graphic3d_Aspects
		...
		public ref class Graphic3d_AspectFillArea3d sealed
			: public RDC::OCC::Graphic3d_Aspects
		{
		...
		public:
			Graphic3d_AspectFillArea3d(::Graphic3d_AspectFillArea3d* nativeInstance)
				: RDC::OCC::Graphic3d_Aspects(nativeInstance)
			{}
		...
		public:
			...
			/// Polygon offset parameters: mode = Aspect_POM_None, factor = 1., units = 0.
			/// </summary>
			Graphic3d_AspectFillArea3d(RDC::OCC::Aspect_InteriorStyle theInterior, RDC::OCC::Quantity_Color^ theInteriorColor, RDC::OCC::Quantity_Color^ theEdgeColor, RDC::OCC::Aspect_TypeOfLine theEdgeLineType, double theEdgeWidth, RDC::OCC::Graphic3d_MaterialAspect^ theFrontMaterial, RDC::OCC::Graphic3d_MaterialAspect^ theBackMaterial);
			bool Edge();
			static RDC::OCC::Graphic3d_AspectFillArea3d^ CreateDowncasted(::Graphic3d_AspectFillArea3d* instance);
		}; // class Graphic3d_AspectFillArea3d
		...
		public:
			...
			/// </summary>
			Graphic3d_AspectLine3d(RDC::OCC::Quantity_Color^ theColor, RDC::OCC::Aspect_TypeOfLine theType, double theWidth);
			/// <summary>
			/// Return line type.
			/// </summary>
			RDC::OCC::Aspect_TypeOfLine Type();
			/// <summary>
			/// Modifies the type of line.
			/// </summary>
			void SetType(RDC::OCC::Aspect_TypeOfLine theType);
			/// <summary>
			/// Return line width.
			/// </summary>
			float Width();
			...
			static RDC::OCC::Graphic3d_AspectLine3d^ CreateDowncasted(::Graphic3d_AspectLine3d* instance);
		}; // class Graphic3d_AspectLine3d
		...
		public:
			...
			Graphic3d_AspectMarker3d(RDC::OCC::Aspect_TypeOfMarker theType, RDC::OCC::Quantity_Color^ theColor, double theScale);
			/// <summary>
			/// Creates a context table for marker primitives
			/// defined with the specified values.
			/// </summary>
			Graphic3d_AspectMarker3d(RDC::OCC::Quantity_Color^ theColor, int theWidth, int theHeight, RDC::OCC::TColStd_HArray1OfByte^ theTextureBitmap);
			/// <summary>
			/// Creates a context table for marker primitives
			/// defined with the specified values.
			/// </summary>
			Graphic3d_AspectMarker3d(RDC::OCC::Image_PixMap^ theTextureImage);
			/// <summary>
			/// Return scale factor.
			/// </summary>
			float Scale();
			...
			/// Return marker type.
			/// </summary>
			RDC::OCC::Aspect_TypeOfMarker Type();
			/// <summary>
			/// Modifies the type of marker.
			/// </summary>
			void SetType(RDC::OCC::Aspect_TypeOfMarker theType);
			/// <summary>
			...
			/// Could be null handle if marker aspect has been initialized as default type of marker.
			/// </summary>
			RDC::OCC::Graphic3d_MarkerImage^ GetMarkerImage();
			void SetBitMap(int theWidth, int theHeight, RDC::OCC::TColStd_HArray1OfByte^ theTexture);
			static RDC::OCC::Graphic3d_AspectMarker3d^ CreateDowncasted(::Graphic3d_AspectMarker3d* instance);
		}; // class Graphic3d_AspectMarker3d
		...
		public:
			...
			/// [in] display mode
			/// </param>
			Graphic3d_AspectText3d(RDC::OCC::Quantity_Color^ theColor, System::String^ theFont, double theExpansionFactor, double theSpace, RDC::OCC::Aspect_TypeOfStyleText theStyle, RDC::OCC::Aspect_TypeOfDisplayText theDisplayType);
			/// <summary>
			/// Creates a context table for text primitives defined with the specified values.
			/// </summary>
			/// <param name="theColor">
			...
			/// [in] display mode
			/// </param>
			Graphic3d_AspectText3d(RDC::OCC::Quantity_Color^ theColor, System::String^ theFont, double theExpansionFactor, double theSpace, RDC::OCC::Aspect_TypeOfStyleText theStyle);
			/// <summary>
			/// Creates a context table for text primitives defined with the specified values.
			/// </summary>
			/// <param name="theColor">
			...
			/// [in] display mode
			/// </param>
			Graphic3d_AspectText3d(RDC::OCC::Quantity_Color^ theColor, System::String^ theFont, double theExpansionFactor, double theSpace);
			/// <summary>
			...
			/// Return the font.
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ Font();
			/// <summary>
			/// Modifies the font.
			/// </summary>
			void SetFont(RDC::OCC::TCollection_AsciiString^ theFont);
			/// <summary>
			/// Modifies the font.
			/// </summary>
			...
			/// </summary>
			RDC::OCC::Aspect_TypeOfStyleText Style();
			/// <summary>
			/// Modifies the style of the text.
			/// </summary>
			void SetStyle(RDC::OCC::Aspect_TypeOfStyleText theStyle);
			/// <summary>
			/// Return display type.
			/// </summary>
			RDC::OCC::Aspect_TypeOfDisplayText DisplayType();
			/// <summary>
			/// Define the display type of the text.
			/// </summary>
			void SetDisplayType(RDC::OCC::Aspect_TypeOfDisplayText theDisplayType);
			/// <summary>
			/// Returns TRUE when the Text Zoomable is on.
			/// </summary>
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_AspectText3d^ CreateDowncasted(::Graphic3d_AspectText3d* instance);
		}; // class Graphic3d_AspectText3d
		...
		public:
			...
			/// </returns>
			RDC::OCC::Graphic3d_GraphicDriver^ GraphicDriver();
			/// <summary>
			/// </summary>
			/// <returns>
			/// graphic groups
			/// </returns>
			RDC::OCC::Graphic3d_SequenceOfGroup^ Groups();
			/// <summary>
			/// Return transformation.
			/// </summary>
			RDC::OCC::TopLoc_Datum3D^ Transformation();
			/// <summary>
			/// Assign transformation.
			/// </summary>
			void SetTransformation(RDC::OCC::TopLoc_Datum3D^ theTrsf);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_PresentationAttributes^ HighlightStyle();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_DisplayPriority Priority();
			/// <summary>
			/// Set structure display priority.
			/// </summary>
			void SetPriority(RDC::OCC::Graphic3d_DisplayPriority thePriority);
			/// <summary>
			/// Return previous structure display priority.
			/// </summary>
			RDC::OCC::Graphic3d_DisplayPriority PreviousPriority();
			/// <summary>
			/// Set previous structure display priority.
			/// </summary>
			void SetPreviousPriority(RDC::OCC::Graphic3d_DisplayPriority thePriority);
			/// <summary>
			...
			/// </summary>
			void Connect(RDC::OCC::Graphic3d_CStructure^ theStructure);
			/// <summary>
			/// Disconnect other structure to this one
			/// </summary>
			void Disconnect(RDC::OCC::Graphic3d_CStructure^ theStructure);
			/// <summary>
			/// Highlights structure with the given style
			/// </summary>
			void GraphicHighlight(RDC::OCC::Graphic3d_PresentationAttributes^ theStyle);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_CStructure^ ShadowLink(RDC::OCC::Graphic3d_StructureManager^ theManager);
			/// <summary>
			/// Create new group within this structure
			/// </summary>
			RDC::OCC::Graphic3d_Group^ NewGroup(RDC::OCC::Graphic3d_Structure^ theStruct);
			/// <summary>
			/// Remove group from this structure
			/// </summary>
			void RemoveGroup(RDC::OCC::Graphic3d_Group^ theGroup);
			/// <summary>
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_CStructure^ CreateDowncasted(::Graphic3d_CStructure* instance);
		}; // class Graphic3d_CStructure
		...
		public ref class Graphic3d_WorldViewProjState sealed
			: public RDC::OCC::BaseClass<::Graphic3d_WorldViewProjState>
		{
		...
		public:
			Graphic3d_WorldViewProjState(::Graphic3d_WorldViewProjState* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_WorldViewProjState>(nativeInstance, true)
			{}

			Graphic3d_WorldViewProjState(::Graphic3d_WorldViewProjState& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_WorldViewProjState>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </param>
			Graphic3d_WorldViewProjState(long long unsigned int theProjectionState, long long unsigned int theWorldViewState, RDC::OCC::Standard_Transient^ theCamera);
			/// <summary>
			/// Constructor for custom projector type.
			/// </summary>
			/// <param name="theProjectionState">
			...
			/// </summary>
			void Initialize(long long unsigned int theProjectionState, long long unsigned int theWorldViewState, RDC::OCC::Standard_Transient^ theCamera);
			/// <summary>
			/// Initialize world view projection state.
			/// </summary>
			...
			/// Initialize world view projection state.
			/// </summary>
			void Initialize(RDC::OCC::Standard_Transient^ theCamera);
			/// <summary>
			/// Initialize world view projection state.
			/// </summary>
			void Initialize();
			...
			/// </returns>
			bool IsProjectionChanged(RDC::OCC::Graphic3d_WorldViewProjState^ theState);
			/// <summary>
			...
			/// </returns>
			bool IsWorldViewChanged(RDC::OCC::Graphic3d_WorldViewProjState^ theState);
			/// <summary>
			...
			/// true when the projection of the given camera state differs from this one.
			/// </returns>
			bool IsChanged(RDC::OCC::Graphic3d_WorldViewProjState^ theState);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
		...
		public:
			...
			/// </param>
			static void Interpolate(RDC::OCC::Graphic3d_Camera^ theStart, RDC::OCC::Graphic3d_Camera^ theEnd, double theT, RDC::OCC::Graphic3d_Camera^ theCamera);
			/// <summary>
			/// Initialize mapping related parameters from other camera handle.
			/// </summary>
			void CopyMappingData(RDC::OCC::Graphic3d_Camera^ theOtherCamera);
			/// <summary>
			/// Initialize orientation related parameters from other camera handle.
			/// </summary>
			void CopyOrientationData(RDC::OCC::Graphic3d_Camera^ theOtherCamera);
			/// <summary>
			...
			/// </param>
			void Copy(RDC::OCC::Graphic3d_Camera^ theOther);
			/// <summary>
			...
			/// [in] the direction.
			/// </param>
			void SetDirectionFromEye(RDC::OCC::Dir theDir);
			/// <summary>
			...
			/// [in] the direction.
			/// </param>
			void SetDirection(RDC::OCC::Dir theDir);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Dir OrthogonalizedUp();
			/// <summary>
			/// Right side direction.
			/// </summary>
			RDC::OCC::Dir SideRight();
			/// <summary>
			...
			/// </param>
			/// @sa SetEye()
			void MoveEyeTo(RDC::OCC::Pnt theEye);
			/// <summary>
			...
			/// </param>
			void SetEyeAndCenter(RDC::OCC::Pnt theEye, RDC::OCC::Pnt theCenter);
			/// <summary>
			/// Sets camera Eye position.
			...
			void SetEye(RDC::OCC::Pnt theEye);
			/// <summary>
			...
			/// </param>
			void SetAxialScale(RDC::OCC::XYZ theAxialScale);
			/// <summary>
			...
			/// </param>
			void SetProjectionType(RDC::OCC::Graphic3d_Camera::Projection theProjection);
			/// <summary>
			/// </summary>
			/// <returns>
			/// camera projection type.
			/// </returns>
			RDC::OCC::Graphic3d_Camera::Projection ProjectionType();
			/// <summary>
			...
			/// </summary>
			bool FitMinMax(RDC::OCC::Bnd_Box^ theBox, double theResolution, bool theToEnlargeIfLine);
			/// <summary>
			...
			/// </param>
			bool ZFitAll(double theScaleFactor, RDC::OCC::Bnd_Box^ theMinMax, RDC::OCC::Bnd_Box^ theGraphicBB, double% theZNear, double% theZFar);
			/// <summary>
			/// Change Z-min and Z-max planes of projection volume to match the displayed objects.
			/// </summary>
			void ZFitAll(double theScaleFactor, RDC::OCC::Bnd_Box^ theMinMax, RDC::OCC::Bnd_Box^ theGraphicBB);
			/// <summary>
			...
			/// </param>
			void SetZFocus(RDC::OCC::Graphic3d_Camera::FocusType theType, double theZFocus);
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Graphic3d_Camera::FocusType ZFocusType();
			/// <summary>
			...
			/// </param>
			void SetIOD(RDC::OCC::Graphic3d_Camera::IODType theType, double theIOD);
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Graphic3d_Camera::IODType GetIODType();
			/// <summary>
			/// Get current tile.
			/// </summary>
			RDC::OCC::Graphic3d_CameraTile^ Tile();
			/// <summary>
			...
			/// tile definition
			/// </param>
			void SetTile(RDC::OCC::Graphic3d_CameraTile^ theTile);
			/// <summary>
			...
			/// </param>
			void Transform(RDC::OCC::Trsf theTrsf);
			/// <summary>
			...
			/// values in form of gp_Pnt (Width, Height, Depth).
			/// </returns>
			RDC::OCC::XYZ ViewDimensions(double theZValue);
			/// <summary>
			...
			/// </param>
			void Frustum(RDC::OCC::Pln% theLeft, RDC::OCC::Pln% theRight, RDC::OCC::Pln% theBottom, RDC::OCC::Pln% theTop, RDC::OCC::Pln% theNear, RDC::OCC::Pln% theFar);
			/// <summary>
			...
			/// mapped point in NDC.
			/// </returns>
			RDC::OCC::Pnt Project(RDC::OCC::Pnt thePnt);
			/// <summary>
			...
			/// 3D point in WCS.
			/// </returns>
			RDC::OCC::Pnt UnProject(RDC::OCC::Pnt thePnt);
			/// <summary>
			...
			/// point in NDC.
			/// </returns>
			RDC::OCC::Pnt ConvertView2Proj(RDC::OCC::Pnt thePnt);
			/// <summary>
			...
			/// point in VCS.
			/// </returns>
			RDC::OCC::Pnt ConvertProj2View(RDC::OCC::Pnt thePnt);
			/// <summary>
			...
			/// point in VCS.
			/// </returns>
			RDC::OCC::Pnt ConvertWorld2View(RDC::OCC::Pnt thePnt);
			/// <summary>
			/// Convert point from view coordinate space to
			/// world coordinates.
			/// </summary>
			...
			/// point in WCS.
			/// </returns>
			RDC::OCC::Pnt ConvertView2World(RDC::OCC::Pnt thePnt);
			/// <summary>
			/// </summary>
			/// <returns>
			/// projection modification state of the camera.
			/// </returns>
			RDC::OCC::Graphic3d_WorldViewProjState^ WorldViewProjState();
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Graphic3d_Mat4d^ OrientationMatrix();
			/// <summary>
			...
			/// camera orientation matrix.
			/// </returns>
			RDC::OCC::Graphic3d_Mat4^ OrientationMatrixF();
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Graphic3d_Mat4d^ ProjectionMatrix();
			/// <summary>
			...
			/// monographic projection matrix.
			/// </returns>
			RDC::OCC::Graphic3d_Mat4^ ProjectionMatrixF();
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// </returns>
			RDC::OCC::Graphic3d_Mat4d^ ProjectionStereoLeft();
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// </returns>
			RDC::OCC::Graphic3d_Mat4^ ProjectionStereoLeftF();
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// that this method is used for rendering for <i>Projection_Stereo</i>.
			/// </returns>
			RDC::OCC::Graphic3d_Mat4d^ ProjectionStereoRight();
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// Please note that this method is used for rendering for <i>Projection_Stereo</i>.
			/// </returns>
			RDC::OCC::Graphic3d_Mat4^ ProjectionStereoRightF();
			/// <summary>
			...
			/// </param>
			void StereoProjection(RDC::OCC::Graphic3d_Mat4d^ theProjL, RDC::OCC::Graphic3d_Mat4d^ theHeadToEyeL, RDC::OCC::Graphic3d_Mat4d^ theProjR, RDC::OCC::Graphic3d_Mat4d^ theHeadToEyeR);
			/// <summary>
			/// Get stereo projection matrices.
			/// </summary>
			/// <param name="theProjL">
			...
			/// [out] right head to eye translation matrix
			/// </param>
			void StereoProjectionF(RDC::OCC::Graphic3d_Mat4^ theProjL, RDC::OCC::Graphic3d_Mat4^ theHeadToEyeL, RDC::OCC::Graphic3d_Mat4^ theProjR, RDC::OCC::Graphic3d_Mat4^ theHeadToEyeR);
			/// <summary>
			...
			/// </param>
			void SetCustomStereoProjection(RDC::OCC::Graphic3d_Mat4d^ theProjL, RDC::OCC::Graphic3d_Mat4d^ theHeadToEyeL, RDC::OCC::Graphic3d_Mat4d^ theProjR, RDC::OCC::Graphic3d_Mat4d^ theHeadToEyeR);
			/// <summary>
			...
			/// </summary>
			void SetCustomMonoProjection(RDC::OCC::Graphic3d_Mat4d^ theProj);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			/* Method skipped due to unknown mapping: void FrustumPoints(NCollection_Array1<NCollection_Vec3<double>> thePoints, Graphic3d_Mat4d theModelWorld, ) */
			static RDC::OCC::Graphic3d_Camera^ CreateDowncasted(::Graphic3d_Camera* instance);
		}; // class Graphic3d_Camera
		...
		public ref class Graphic3d_CameraTile sealed
			: public RDC::OCC::BaseClass<::Graphic3d_CameraTile>
		{
		...
		public:
			Graphic3d_CameraTile(::Graphic3d_CameraTile* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CameraTile>(nativeInstance, true)
			{}

			Graphic3d_CameraTile(::Graphic3d_CameraTile& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CameraTile>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			RDC::OCC::Graphic3d_Vec2i^ OffsetLowerLeft();
			/// <summary>
			/// Return the copy cropped by total size
			/// </summary>
			RDC::OCC::Graphic3d_CameraTile^ Cropped();
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
		...
		public:
			...
			/// </summary>
			Graphic3d_CLight(RDC::OCC::Graphic3d_TypeOfLightSource theType);
			/// <summary>
			/// Copy parameters from another light source excluding source type.
			/// </summary>
			void CopyFrom(RDC::OCC::Graphic3d_CLight^ theLight);
			/// <summary>
			/// Returns the Type of the Light, cannot be changed after object construction.
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfLightSource Type();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Pnt Position();
			/// <summary>
			/// Setup location of positional/spot light.
			/// </summary>
			void SetPosition(RDC::OCC::Pnt thePosition);
			/// <summary>
			...
			/// </summary>
			void SetDisplayPosition(RDC::OCC::Pnt thePosition);
			/// <summary>
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_CLight^ CreateDowncasted(::Graphic3d_CLight* instance);
		}; // class Graphic3d_CLight
		...
		public:
			...
			/// </param>
			Graphic3d_ClipPlane(RDC::OCC::Graphic3d_Vec4d^ theEquation);
			/// <summary>
			...
			/// [in] the plane.
			/// </param>
			Graphic3d_ClipPlane(RDC::OCC::Pln thePlane);
			/// <summary>
			...
			/// [in] the plane.
			/// </param>
			void SetEquation(RDC::OCC::Pln thePlane);
			/// <summary>
			...
			/// </param>
			void SetEquation(RDC::OCC::Graphic3d_Vec4d^ theEquation);
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Graphic3d_Vec4d^ GetEquation();
			/// <summary>
			/// Get 4-component equation vector for clipping plane.
			/// </summary>
			/// <returns>
			/// clipping plane equation vector.
			/// </returns>
			RDC::OCC::Graphic3d_Vec4d^ ReversedEquation();
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Graphic3d_ClipPlane^ Clone();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_ClipPlane^ ChainPreviousPlane();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_ClipPlane^ ChainNextPlane();
			/// <summary>
			...
			/// </summary>
			void SetChainNextPlane(RDC::OCC::Graphic3d_ClipPlane^ thePlane);
			/// <summary>
			/// Return color for rendering capping surface.
			/// </summary>
			RDC::OCC::Quantity_Color^ CappingColor();
			/// <summary>
			/// Set color for rendering capping surface.
			/// </summary>
			void SetCappingColor(RDC::OCC::Quantity_Color^ theColor);
			/// <summary>
			...
			/// [in] the material.
			/// </param>
			void SetCappingMaterial(RDC::OCC::Graphic3d_MaterialAspect^ theMat);
			/// <summary>
			/// </summary>
			/// <returns>
			/// capping material.
			/// </returns>
			RDC::OCC::Graphic3d_MaterialAspect^ CappingMaterial();
			/// <summary>
			...
			/// [in] the texture.
			/// </param>
			void SetCappingTexture(RDC::OCC::Graphic3d_TextureMap^ theTexture);
			/// <summary>
			/// </summary>
			/// <returns>
			/// capping texture map.
			/// </returns>
			RDC::OCC::Graphic3d_TextureMap^ CappingTexture();
			/// <summary>
			...
			/// [in] the hatch style.
			/// </param>
			void SetCappingHatch(RDC::OCC::Aspect_HatchStyle theStyle);
			/// <summary>
			/// </summary>
			/// <returns>
			/// hatching style.
			/// </returns>
			RDC::OCC::Aspect_HatchStyle CappingHatch();
			/// <summary>
			...
			/// </param>
			void SetCappingCustomHatch(RDC::OCC::Graphic3d_HatchStyle^ theStyle);
			/// <summary>
			/// </summary>
			/// <returns>
			/// hatching style.
			/// </returns>
			RDC::OCC::Graphic3d_HatchStyle^ CappingCustomHatch();
			/// <summary>
			/// Turn on hatching.
			/// </summary>
			...
			/// </returns>
			RDC::OCC::Graphic3d_AspectFillArea3d^ CappingAspect();
			/// <summary>
			/// Assign capping aspect.
			/// </summary>
			void SetCappingAspect(RDC::OCC::Graphic3d_AspectFillArea3d^ theAspect);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_ClipState ProbePoint(RDC::OCC::Graphic3d_Vec4d^ thePoint);
			...
			/// </summary>
			RDC::OCC::Graphic3d_ClipState ProbePointHalfspace(RDC::OCC::Graphic3d_Vec4d^ thePoint);
			/* Method skipped due to unknown mapping: Graphic3d_ClipState ProbeBoxHalfspace(Graphic3d_BndBox3d theBox, ) */
			/// <summary>
			/// Check if the given point is outside of the half-space (e.g. should be discarded by clipping plane).
			/// </summary>
			bool IsPointOutHalfspace(RDC::OCC::Graphic3d_Vec4d^ thePoint);
			...
			static RDC::OCC::Graphic3d_ClipPlane^ CreateDowncasted(::Graphic3d_ClipPlane* instance);
		}; // class Graphic3d_ClipPlane
		...
		public:
			...
			/// </summary>
			RDC::OCC::Aspect_TypeOfHighlightMethod Method();
			/// <summary>
			/// Changes highlight method to the given one.
			/// </summary>
			void SetMethod(RDC::OCC::Aspect_TypeOfHighlightMethod theMethod);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_AspectFillArea3d^ BasicFillAreaAspect();
			/// <summary>
			/// Sets basic presentation fill area aspect.
			/// </summary>
			void SetBasicFillAreaAspect(RDC::OCC::Graphic3d_AspectFillArea3d^ theAspect);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_PresentationAttributes^ CreateDowncasted(::Graphic3d_PresentationAttributes* instance);
		}; // class Graphic3d_PresentationAttributes
		...
		public ref class Graphic3d_Vertex sealed
			: public RDC::OCC::BaseClass<::Graphic3d_Vertex>
		{
		...
		public:
			Graphic3d_Vertex(::Graphic3d_Vertex* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vertex>(nativeInstance, true)
			{}

			Graphic3d_Vertex(::Graphic3d_Vertex& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_Vertex>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			float Distance(RDC::OCC::Graphic3d_Vertex^ theOther);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
		...
		public:
			...
			/// </param>
			Graphic3d_Structure(RDC::OCC::Graphic3d_StructureManager^ theManager, RDC::OCC::Graphic3d_Structure^ theLinkPrs);
			/// <summary>
			/// Creates a graphic object in the manager theManager.
			/// It will appear in all the views of the visualiser.
			/// The structure is not displayed when it is created.
			...
			/// another structure for creating a shadow (linked) structure
			/// </param>
			Graphic3d_Structure(RDC::OCC::Graphic3d_StructureManager^ theManager);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_DisplayPriority DisplayPriority();
			/// <summary>
			...
			/// </summary>
			void SetDisplayPriority(RDC::OCC::Graphic3d_DisplayPriority thePriority);
			...
			/// </param>
			void Highlight(RDC::OCC::Graphic3d_PresentationAttributes^ theStyle, bool theToUpdateMgr);
			/// <summary>
			/// Highlights the structure in all the views with the given style
			/// </summary>
			/// <param name="theStyle">
			...
			/// highlighted via structure manager or not
			/// </param>
			void Highlight(RDC::OCC::Graphic3d_PresentationAttributes^ theStyle);
			/// <summary>
			...
			/// </summary>
			void SetVisual(RDC::OCC::Graphic3d_TypeOfStructure AVisual);
			/// <summary>
			...
			/// </summary>
			void computeHLR(RDC::OCC::Graphic3d_Camera^ theProjector, RDC::OCC::Graphic3d_Structure^ theStructure);
			/// <summary>
			...
			/// </summary>
			void ReCompute(RDC::OCC::Graphic3d_DataStructureManager^ aProjector);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_Group^ NewGroup();
			/// <summary>
			/// Returns the last created group or creates new one if list is empty.
			/// </summary>
			RDC::OCC::Graphic3d_Group^ CurrentGroup();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Bnd_Box^ MinMaxValues(bool theToIgnoreInfiniteFlag);
			/// <summary>
			/// Returns the coordinates of the boundary box of the structure <me>.
			/// If <theToIgnoreInfiniteFlag> is TRUE, the method returns actual graphical
			/// boundaries of the Graphic3d_Group components. Otherwise, the
			...
			/// If the structure <me> is infinite then the whole box is returned.
			/// </summary>
			RDC::OCC::Bnd_Box^ MinMaxValues();
			/// <summary>
			/// Returns the visualisation mode for the structure <me>.
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfStructure Visual();
			/// <summary>
			...
			/// </summary>
			static bool AcceptConnection(RDC::OCC::Graphic3d_Structure^ theStructure1, RDC::OCC::Graphic3d_Structure^ theStructure2, RDC::OCC::Graphic3d_TypeOfConnection theType);
			/// <summary>
			/// Returns the group of structures to which <me> is connected.
			/// </summary>
			void Ancestors(RDC::OCC::Graphic3d_MapOfStructure^ SG);
			/// <summary>
			...
			/// </summary>
			void Connect(RDC::OCC::Graphic3d_Structure^ theStructure, RDC::OCC::Graphic3d_TypeOfConnection theType, bool theWithCheck);
			/// <summary>
			/// If Atype is TOC_DESCENDANT then add <AStructure>
			/// as a child structure of  <me>.
			/// If Atype is TOC_ANCESTOR then add <AStructure>
			...
			/// contains a cycle and <WithCheck> is Standard_True;
			/// </summary>
			void Connect(RDC::OCC::Graphic3d_Structure^ theStructure, RDC::OCC::Graphic3d_TypeOfConnection theType);
			void Connect(RDC::OCC::Graphic3d_Structure^ thePrs);
			/// <summary>
			/// Returns the group of structures connected to <me>.
			/// </summary>
			void Descendants(RDC::OCC::Graphic3d_MapOfStructure^ SG);
			/// <summary>
			/// Suppress the connection between <AStructure> and <me>.
			/// </summary>
			void Disconnect(RDC::OCC::Graphic3d_Structure^ theStructure);
			void Remove(RDC::OCC::Graphic3d_Structure^ thePrs);
			/// <summary>
			...
			/// </summary>
			void DisconnectAll(RDC::OCC::Graphic3d_TypeOfConnection AType);
			void RemoveAll();
			...
			/// </summary>
			bool IsMutable();
			RDC::OCC::Graphic3d_TypeOfStructure ComputeVisual();
			/// <summary>
			/// Clears the structure <me>.
			/// </summary>
			void GraphicClear(bool WithDestruction);
			void GraphicConnect(RDC::OCC::Graphic3d_Structure^ theDaughter);
			void GraphicDisconnect(RDC::OCC::Graphic3d_Structure^ theDaughter);
			/// <summary>
			/// Internal method which sets new transformation without calling graphic manager callbacks.
			/// </summary>
			void GraphicTransform(RDC::OCC::TopLoc_Datum3D^ theTrsf);
			/// <summary>
			...
			/// </summary>
			static void PrintNetwork(RDC::OCC::Graphic3d_Structure^ AStructure, RDC::OCC::Graphic3d_TypeOfConnection AType);
			/// <summary>
			/// Suppress the structure in the list of descendants or in the list of ancestors.
			/// </summary>
			void Remove(RDC::OCC::Graphic3d_Structure^ thePtr, RDC::OCC::Graphic3d_TypeOfConnection theType);
			void SetComputeVisual(RDC::OCC::Graphic3d_TypeOfStructure theVisual);
			/// <summary>
			/// Transforms theX, theY, theZ with the transformation theTrsf.
			/// </summary>
			static void Transforms(RDC::OCC::Trsf theTrsf, double theX, double theY, double theZ, double% theNewX, double% theNewY, double% theNewZ);
			/// <summary>
			/// Returns the low-level structure
			/// </summary>
			RDC::OCC::Graphic3d_CStructure^ CStructure();
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_Structure^ CreateDowncasted(::Graphic3d_Structure* instance);
		}; // class Graphic3d_Structure
		...
		public:
			...
			/// Sets text value.
			/// </summary>
			void SetText(RDC::OCC::TCollection_AsciiString^ theText);
			/// <summary>
			/// Sets text value.
			/// </summary>
			...
			/// Sets text point.
			/// </summary>
			void SetPosition(RDC::OCC::Pnt thePoint);
			/// <summary>
			/// Returns text orientation in 3D space.
			/// </summary>
			RDC::OCC::Ax2 Orientation();
			/// <summary>
			...
			/// </summary>
			void SetOrientation(RDC::OCC::Ax2 theOrientation);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_HorizontalTextAlignment HorizontalAlignment();
			/// <summary>
			/// Sets horizontal alignment of text.
			/// </summary>
			void SetHorizontalAlignment(RDC::OCC::Graphic3d_HorizontalTextAlignment theJustification);
			/// <summary>
			/// Returns vertical alignment of text.
			/// </summary>
			RDC::OCC::Graphic3d_VerticalTextAlignment VerticalAlignment();
			/// <summary>
			/// Sets vertical alignment of text.
			/// </summary>
			void SetVerticalAlignment(RDC::OCC::Graphic3d_VerticalTextAlignment theJustification);
			static RDC::OCC::Graphic3d_Text^ CreateDowncasted(::Graphic3d_Text* instance);
		}; // class Graphic3d_Text
		...
		public:
			...
			/// Set transformation persistence.
			/// </summary>
			Graphic3d_TransformPers(RDC::OCC::Graphic3d_TransModeFlags theMode);
			/// <summary>
			...
			/// </summary>
			Graphic3d_TransformPers(RDC::OCC::Graphic3d_TransModeFlags theMode, RDC::OCC::Pnt thePnt);
			/// <summary>
			...
			/// </summary>
			Graphic3d_TransformPers(RDC::OCC::Graphic3d_TransModeFlags theMode, RDC::OCC::Aspect_TypeOfTriedronPosition theCorner, RDC::OCC::Graphic3d_Vec2i^ theOffset);
			/// <summary>
			/// Set 2d/trihedron transformation persistence with a corner and 2D offset.
			/// 2D offset defines the origin of Local Coordinate system as projection of 2D point on screen plane into World Coordinate system.
			/// Throws an exception if persistence mode is not Graphic3d_TMF_TriedronPers or Graphic3d_TMF_2d.
			/// The offset is a positive displacement from the view corner in pixels.
			/// </summary>
			Graphic3d_TransformPers(RDC::OCC::Graphic3d_TransModeFlags theMode, RDC::OCC::Aspect_TypeOfTriedronPosition theCorner);
			/// <summary>
			/// Return true if specified mode is zoom/rotate transformation persistence.
			/// </summary>
			static bool IsZoomOrRotate(RDC::OCC::Graphic3d_TransModeFlags theMode);
			/// <summary>
			/// Return true if specified mode is 2d/trihedron transformation persistence.
			/// </summary>
			static bool IsTrihedronOr2d(RDC::OCC::Graphic3d_TransModeFlags theMode);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_TransModeFlags Mode();
			/// <summary>
			/// Transformation persistence mode flags.
			/// </summary>
			RDC::OCC::Graphic3d_TransModeFlags Flags();
			/// <summary>
			/// Set Zoom/Rotate transformation persistence with an anchor 3D point.
			/// Throws an exception if persistence mode is not Graphic3d_TMF_ZoomPers, Graphic3d_TMF_ZoomRotatePers or Graphic3d_TMF_RotatePers.
			/// </summary>
			void SetPersistence(RDC::OCC::Graphic3d_TransModeFlags theMode, RDC::OCC::Pnt thePnt);
			/// <summary>
			/// Set 2d/trihedron transformation persistence with a corner and 2D offset.
			/// Throws an exception if persistence mode is not Graphic3d_TMF_TriedronPers or Graphic3d_TMF_2d.
			/// </summary>
			void SetPersistence(RDC::OCC::Graphic3d_TransModeFlags theMode, RDC::OCC::Aspect_TypeOfTriedronPosition theCorner, RDC::OCC::Graphic3d_Vec2i^ theOffset);
			/// <summary>
			/// Return the anchor point for zoom/rotate transformation persistence.
			/// </summary>
			RDC::OCC::Pnt AnchorPoint();
			/// <summary>
			/// Set the anchor point for zoom/rotate transformation persistence.
			/// </summary>
			void SetAnchorPoint(RDC::OCC::Pnt thePnt);
			/// <summary>
			/// Return the corner for 2d/trihedron transformation persistence.
			/// </summary>
			RDC::OCC::Aspect_TypeOfTriedronPosition Corner2d();
			/// <summary>
			/// Set the corner for 2d/trihedron transformation persistence.
			/// </summary>
			void SetCorner2d(RDC::OCC::Aspect_TypeOfTriedronPosition thePos);
			/// <summary>
			/// Return the offset from the corner for 2d/trihedron transformation persistence.
			/// </summary>
			RDC::OCC::Graphic3d_Vec2i^ Offset2d();
			/// <summary>
			/// Set the offset from the corner for 2d/trihedron transformation persistence.
			/// </summary>
			void SetOffset2d(RDC::OCC::Graphic3d_Vec2i^ theOffset);
			/// <summary>
			...
			/// </param>
			double persistentScale(RDC::OCC::Graphic3d_Camera^ theCamera, int theViewportWidth, int theViewportHeight);
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_TransformPers^ CreateDowncasted(::Graphic3d_TransformPers* instance);
		}; // class Graphic3d_TransformPers
		...
		public:
			...
			/// </summary>
			RDC::OCC::Graphic3d_Aspects^ Aspects();
			/// <summary>
			/// Modifies the context for all the face primitives of the group.
			/// </summary>
			void SetGroupPrimitivesAspect(RDC::OCC::Graphic3d_Aspects^ theAspect);
			/// <summary>
			...
			/// </summary>
			void SetPrimitivesAspect(RDC::OCC::Graphic3d_Aspects^ theAspect);
			/// <summary>
			...
			/// </summary>
			void ReplaceAspects(RDC::OCC::Graphic3d_MapOfAspectsToAspects^ theMap);
			/// <summary>
			/// Adds a text for display
			/// </summary>
			void AddText(RDC::OCC::Graphic3d_Text^ theTextParams, bool theToEvalMinMax);
			/// <summary>
			/// Adds a text for display
			/// </summary>
			void AddText(RDC::OCC::Graphic3d_Text^ theTextParams);
			...
			/// </summary>
			void AddPrimitiveArray(RDC::OCC::Graphic3d_ArrayOfPrimitives^ thePrim, bool theToEvalMinMax);
			/// <summary>
			/// Adds an array of primitives for display
			/// </summary>
			void AddPrimitiveArray(RDC::OCC::Graphic3d_ArrayOfPrimitives^ thePrim);
			/// <summary>
			...
			/// </summary>
			void SetFlippingOptions(bool theIsEnabled, RDC::OCC::Ax2 theRefPlane);
			/// <summary>
			/// Return transformation persistence.
			/// </summary>
			RDC::OCC::Graphic3d_TransformPers^ TransformPersistence();
			...
			/// </summary>
			RDC::OCC::Graphic3d_Structure^ Structure();
			/// <summary>
			...
			void Marker(RDC::OCC::Graphic3d_Vertex^ thePoint, bool theToEvalMinMax);
			/// <summary>
			/// </summary>
			/// @name obsolete methods
			void Marker(RDC::OCC::Graphic3d_Vertex^ thePoint);
			/// <summary>
			...
			/// </summary>
			void Text(System::String^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight, double AAngle, RDC::OCC::Graphic3d_TextPath ATp, RDC::OCC::Graphic3d_HorizontalTextAlignment AHta, RDC::OCC::Graphic3d_VerticalTextAlignment AVta, bool EvalMinMax);
			/// <summary>
			/// Creates the string <AText> at position <APoint>.
			/// The 3D point of attachment is projected. The text is
			/// written in the plane of projection.
			...
			/// (with respect to the horizontal).
			/// </summary>
			void Text(System::String^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight, double AAngle, RDC::OCC::Graphic3d_TextPath ATp, RDC::OCC::Graphic3d_HorizontalTextAlignment AHta, RDC::OCC::Graphic3d_VerticalTextAlignment AVta);
			/// <summary>
			/// Creates the string <AText> at position <APoint>.
			/// The 3D point of attachment is projected. The text is
			/// written in the plane of projection.
			...
			/// AVta    : VTA_BOTTOM
			/// </summary>
			void Text(System::String^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight, bool EvalMinMax);
			/// <summary>
			/// Creates the string <AText> at position <APoint>.
			/// The 3D point of attachment is projected. The text is
			/// written in the plane of projection.
			...
			/// AVta    : VTA_BOTTOM
			/// </summary>
			void Text(System::String^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight);
			/// <summary>
			/// Creates the string <AText> at position <APoint>.
			/// The 3D point of attachment is projected. The text is
			/// written in the plane of projection.
			...
			/// (with respect to the horizontal).
			/// </summary>
			void Text(RDC::OCC::TCollection_ExtendedString^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight, double AAngle, RDC::OCC::Graphic3d_TextPath ATp, RDC::OCC::Graphic3d_HorizontalTextAlignment AHta, RDC::OCC::Graphic3d_VerticalTextAlignment AVta, bool EvalMinMax);
			/// <summary>
			/// Creates the string <AText> at position <APoint>.
			/// The 3D point of attachment is projected. The text is
			/// written in the plane of projection.
			...
			/// (with respect to the horizontal).
			/// </summary>
			void Text(RDC::OCC::TCollection_ExtendedString^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight, double AAngle, RDC::OCC::Graphic3d_TextPath ATp, RDC::OCC::Graphic3d_HorizontalTextAlignment AHta, RDC::OCC::Graphic3d_VerticalTextAlignment AVta);
			/// <summary>
			/// Creates the string <AText> at position <APoint>.
			/// The 3D point of attachment is projected. The text is
			/// written in the plane of projection.
			...
			/// AVta    : VTA_BOTTOM
			/// </summary>
			void Text(RDC::OCC::TCollection_ExtendedString^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight, bool EvalMinMax);
			/// <summary>
			/// Creates the string <AText> at position <APoint>.
			/// The 3D point of attachment is projected. The text is
			/// written in the plane of projection.
			...
			/// AVta    : VTA_BOTTOM
			/// </summary>
			void Text(RDC::OCC::TCollection_ExtendedString^ AText, RDC::OCC::Graphic3d_Vertex^ APoint, double AHeight);
			/// <summary>
			/// Creates the string <theText> at orientation <theOrientation> in 3D space.
			/// </summary>
			void Text(System::String^ theTextUtf, RDC::OCC::Ax2 theOrientation, double theHeight, double theAngle, RDC::OCC::Graphic3d_TextPath theTp, RDC::OCC::Graphic3d_HorizontalTextAlignment theHTA, RDC::OCC::Graphic3d_VerticalTextAlignment theVTA, bool theToEvalMinMax, bool theHasOwnAnchor);
			/// <summary>
			/// Creates the string <theText> at orientation <theOrientation> in 3D space.
			/// </summary>
			void Text(System::String^ theTextUtf, RDC::OCC::Ax2 theOrientation, double theHeight, double theAngle, RDC::OCC::Graphic3d_TextPath theTp, RDC::OCC::Graphic3d_HorizontalTextAlignment theHTA, RDC::OCC::Graphic3d_VerticalTextAlignment theVTA, bool theToEvalMinMax);
			/// <summary>
			/// Creates the string <theText> at orientation <theOrientation> in 3D space.
			/// </summary>
			void Text(System::String^ theTextUtf, RDC::OCC::Ax2 theOrientation, double theHeight, double theAngle, RDC::OCC::Graphic3d_TextPath theTp, RDC::OCC::Graphic3d_HorizontalTextAlignment theHTA, RDC::OCC::Graphic3d_VerticalTextAlignment theVTA);
			/// <summary>
			/// Creates the string <theText> at orientation <theOrientation> in 3D space.
			/// </summary>
			void Text(RDC::OCC::TCollection_ExtendedString^ theText, RDC::OCC::Ax2 theOrientation, double theHeight, double theAngle, RDC::OCC::Graphic3d_TextPath theTp, RDC::OCC::Graphic3d_HorizontalTextAlignment theHTA, RDC::OCC::Graphic3d_VerticalTextAlignment theVTA, bool theToEvalMinMax, bool theHasOwnAnchor);
			/// <summary>
			/// Creates the string <theText> at orientation <theOrientation> in 3D space.
			/// </summary>
			void Text(RDC::OCC::TCollection_ExtendedString^ theText, RDC::OCC::Ax2 theOrientation, double theHeight, double theAngle, RDC::OCC::Graphic3d_TextPath theTp, RDC::OCC::Graphic3d_HorizontalTextAlignment theHTA, RDC::OCC::Graphic3d_VerticalTextAlignment theVTA, bool theToEvalMinMax);
			/// <summary>
			/// Creates the string <theText> at orientation <theOrientation> in 3D space.
			/// </summary>
			void Text(RDC::OCC::TCollection_ExtendedString^ theText, RDC::OCC::Ax2 theOrientation, double theHeight, double theAngle, RDC::OCC::Graphic3d_TextPath theTp, RDC::OCC::Graphic3d_HorizontalTextAlignment theHTA, RDC::OCC::Graphic3d_VerticalTextAlignment theVTA);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_Group^ CreateDowncasted(::Graphic3d_Group* instance);
		}; // class Graphic3d_Group
		...
		public:
			...
			/// </returns>
			bool Append(RDC::OCC::Graphic3d_ClipPlane^ theItem);
			/// <summary>
			/// Remove a plane.
			/// </summary>
			/// <returns>
			...
			/// </returns>
			bool Remove(RDC::OCC::Graphic3d_ClipPlane^ theItem);
			...
			/// </summary>
			RDC::OCC::Graphic3d_ClipPlane^ First();
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_SequenceOfHClipPlane^ CreateDowncasted(::Graphic3d_SequenceOfHClipPlane* instance);
		}; // class Graphic3d_SequenceOfHClipPlane
		...
		public:
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_ViewAffinity^ CreateDowncasted(::Graphic3d_ViewAffinity* instance);
		}; // class Graphic3d_ViewAffinity
		...
		public:
			...
			/// </summary>
			int InquireLimit(RDC::OCC::Graphic3d_TypeOfLimit theType);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_CStructure^ CreateStructure(RDC::OCC::Graphic3d_StructureManager^ theManager);
			/// <summary>
			/// Removes structure from graphic driver and releases its resources.
			/// </summary>
			void RemoveStructure(RDC::OCC::Graphic3d_CStructure^ theCStructure);
			/// <summary>
			/// Creates new view for this graphic driver.
			/// </summary>
			RDC::OCC::Graphic3d_CView^ CreateView(RDC::OCC::Graphic3d_StructureManager^ theMgr);
			/// <summary>
			/// Removes view from graphic driver and releases its resources.
			/// </summary>
			void RemoveView(RDC::OCC::Graphic3d_CView^ theView);
			/// <summary>
			...
			/// </summary>
			bool MemoryInfo(long long unsigned int% theFreeBytes, RDC::OCC::TCollection_AsciiString^ theInfo);
			float DefaultTextHeight();
			/// <summary>
			/// Computes text width.
			/// </summary>
			void TextSize(RDC::OCC::Graphic3d_CView^ theView, System::String^ theText, float theHeight, float% theWidth, float% theAscent, float% theDescent);
			/// <summary>
			...
			/// </param>
			void InsertLayerBefore(int theNewLayerId, RDC::OCC::Graphic3d_ZLayerSettings^ theSettings, int theLayerAfter);
			/// <summary>
			/// Adds a layer to all views.
			/// </summary>
			/// <param name="theNewLayerId">
			...
			/// </param>
			void InsertLayerAfter(int theNewLayerId, RDC::OCC::Graphic3d_ZLayerSettings^ theSettings, int theLayerBefore);
			/// <summary>
			...
			/// </summary>
			void ZLayers(RDC::OCC::TColStd_SequenceOfInteger^ theLayerSeq);
			/// <summary>
			/// Sets the settings for a single Z layer.
			/// </summary>
			void SetZLayerSettings(int theLayerId, RDC::OCC::Graphic3d_ZLayerSettings^ theSettings);
			/// <summary>
			/// Returns the settings of a single Z layer.
			/// </summary>
			RDC::OCC::Graphic3d_ZLayerSettings^ ZLayerSettings(int theLayerId);
			/// <summary>
			...
			/// </summary>
			bool ViewExists(RDC::OCC::Aspect_Window^ theWindow, RDC::OCC::Graphic3d_CView^ theView);
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_GraphicDriver^ CreateDowncasted(::Graphic3d_GraphicDriver* instance);
			/// <summary>
			/// 创建 OpenGlDriver 的方法，非自动生成方法
			/// </summary>
			/// <returns></returns>
			static RDC::OCC::Graphic3d_GraphicDriver^ CreateOpenGlDriver();
		}; // class Graphic3d_GraphicDriver
		...
		public:
			...
			/// </summary>
			Graphic3d_StructureManager(RDC::OCC::Graphic3d_GraphicDriver^ theDriver);
			/// <summary>
			...
			/// visualiser <me>.
			/// </summary>
			void DisplayedStructures(RDC::OCC::Graphic3d_MapOfStructure^ SG);
			/// <summary>
			/// Returns the set of highlighted structures
			/// in a visualiser <me>.
			/// </summary>
			void HighlightedStructures(RDC::OCC::Graphic3d_MapOfStructure^ SG);
			/// <summary>
			/// Forces a new construction of the structure.
			/// if <theStructure> is displayed and TOS_COMPUTED.
			/// </summary>
			void ReCompute(RDC::OCC::Graphic3d_Structure^ theStructure);
			/// <summary>
			/// Forces a new construction of the structure.
			/// if <theStructure> is displayed in <theProjector> and TOS_COMPUTED.
			/// </summary>
			void ReCompute(RDC::OCC::Graphic3d_Structure^ theStructure, RDC::OCC::Graphic3d_DataStructureManager^ theProjector);
			/// <summary>
			/// Clears the structure.
			/// </summary>
			void Clear(RDC::OCC::Graphic3d_Structure^ theStructure, bool theWithDestruction);
			/// <summary>
			/// Connects the structures.
			/// </summary>
			void Connect(RDC::OCC::Graphic3d_Structure^ theMother, RDC::OCC::Graphic3d_Structure^ theDaughter);
			/// <summary>
			/// Disconnects the structures.
			/// </summary>
			void Disconnect(RDC::OCC::Graphic3d_Structure^ theMother, RDC::OCC::Graphic3d_Structure^ theDaughter);
			/// <summary>
			/// Display the structure.
			/// </summary>
			void Display(RDC::OCC::Graphic3d_Structure^ theStructure);
			/// <summary>
			/// Erases the structure.
			/// </summary>
			void Erase(RDC::OCC::Graphic3d_Structure^ theStructure);
			/// <summary>
			/// Highlights the structure.
			/// </summary>
			void Highlight(RDC::OCC::Graphic3d_Structure^ theStructure);
			/// <summary>
			/// Transforms the structure.
			/// </summary>
			void SetTransform(RDC::OCC::Graphic3d_Structure^ theStructure, RDC::OCC::TopLoc_Datum3D^ theTrsf);
			/// <summary>
			/// Changes the display priority of the structure <AStructure>.
			/// </summary>
			void ChangeDisplayPriority(RDC::OCC::Graphic3d_Structure^ theStructure, RDC::OCC::Graphic3d_DisplayPriority theOldPriority, RDC::OCC::Graphic3d_DisplayPriority theNewPriority);
			/// <summary>
			...
			/// </summary>
			void ChangeZLayer(RDC::OCC::Graphic3d_Structure^ theStructure, int theLayerId);
			/// <summary>
			...
			/// </summary>
			int Identification(RDC::OCC::Graphic3d_CView^ theView);
			/// <summary>
			/// Detach the view from this structure manager and release its identification.
			/// </summary>
			void UnIdentification(RDC::OCC::Graphic3d_CView^ theView);
			/// <summary>
			/// Returns the group of views defined in the structure manager.
			/// </summary>
			RDC::OCC::Graphic3d_IndexedMapOfView^ DefinedViews();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_Structure^ Identification(int AId);
			/// <summary>
			/// Suppress the highlighting on the structure <AStructure>.
			/// </summary>
			void UnHighlight(RDC::OCC::Graphic3d_Structure^ AStructure);
			/// <summary>
			...
			void RegisterObject(RDC::OCC::Standard_Transient^ theObject, RDC::OCC::Graphic3d_ViewAffinity^ theAffinity);
			void UnregisterObject(RDC::OCC::Standard_Transient^ theObject);
			RDC::OCC::Graphic3d_ViewAffinity^ ObjectAffinity(RDC::OCC::Standard_Transient^ theObject);
			/// <summary>
			...
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream);
			static RDC::OCC::Graphic3d_StructureManager^ CreateDowncasted(::Graphic3d_StructureManager* instance);
		}; // class Graphic3d_StructureManager
		...
		public ref class Graphic3d_ValidatedCubeMapOrder sealed
			: public RDC::OCC::BaseClass<::Graphic3d_ValidatedCubeMapOrder>
		{
		...
		public:
			Graphic3d_ValidatedCubeMapOrder(::Graphic3d_ValidatedCubeMapOrder* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ValidatedCubeMapOrder>(nativeInstance, true)
			{}

			Graphic3d_ValidatedCubeMapOrder(::Graphic3d_ValidatedCubeMapOrder& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_ValidatedCubeMapOrder>(&nativeInstance, false)
			{}
		...
		public ref class Graphic3d_CubeMapOrder sealed
			: public RDC::OCC::BaseClass<::Graphic3d_CubeMapOrder>
		{
		...
		public:
			Graphic3d_CubeMapOrder(::Graphic3d_CubeMapOrder* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CubeMapOrder>(nativeInstance, true)
			{}

			Graphic3d_CubeMapOrder(::Graphic3d_CubeMapOrder& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CubeMapOrder>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			Graphic3d_CubeMapOrder(RDC::OCC::Graphic3d_ValidatedCubeMapOrder^ theOrder);
			/// <summary>
			/// Alias of 'operator='.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ Set(RDC::OCC::Graphic3d_CubeMapOrder^ theOrder);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_ValidatedCubeMapOrder^ Validated();
			/// <summary>
			/// Sets number of tile in packed cubemap image according passed cubemap side.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ Set(RDC::OCC::Graphic3d_CubeMapSide theCubeMapSide, unsigned char theValue);
			/// <summary>
			/// Sets default order (just from 0 to 5)
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ SetDefault();
			/// <summary>
			/// Applies another cubemap order as permutation for the current one.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ Permute(RDC::OCC::Graphic3d_ValidatedCubeMapOrder^ anOrder);
			/// <summary>
			/// Returns permuted by other cubemap order copy of current one.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ Permuted(RDC::OCC::Graphic3d_ValidatedCubeMapOrder^ anOrder);
			/// <summary>
			/// Swaps values of two cubemap sides.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ Swap(RDC::OCC::Graphic3d_CubeMapSide theFirstSide, RDC::OCC::Graphic3d_CubeMapSide theSecondSide);
			/// <summary>
			/// Returns copy of current order with swapped values of two cubemap sides.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ Swapped(RDC::OCC::Graphic3d_CubeMapSide theFirstSide, RDC::OCC::Graphic3d_CubeMapSide theSecondSide);
			/// <summary>
			/// Returns value of passed cubemap side.
			/// </summary>
			unsigned char Get(RDC::OCC::Graphic3d_CubeMapSide theCubeMapSide);
			/// <summary>
			/// Makes order empty.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapOrder^ Clear();
			/// <summary>
			...
			/// </summary>
			static RDC::OCC::Graphic3d_ValidatedCubeMapOrder^ Default();
		}; // class Graphic3d_CubeMapOrder
		...
		public ref class Graphic3d_CubeMap
			: public RDC::OCC::Graphic3d_TextureMap
		{
		...
		protected:
			Graphic3d_CubeMap(InitMode init)
				: RDC::OCC::Graphic3d_TextureMap(init)
			{}

		public:
			Graphic3d_CubeMap(::Graphic3d_CubeMap* nativeInstance)
				: RDC::OCC::Graphic3d_TextureMap(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			Graphic3d_CubeMap(RDC::OCC::TCollection_AsciiString^ theFileName, bool theToGenerateMipmaps);
			/// <summary>
			/// Constructor defining loading cubemap from file.
			/// </summary>
			Graphic3d_CubeMap(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Constructor defining direct cubemap initialization from PixMap.
			/// </summary>
			Graphic3d_CubeMap(RDC::OCC::Image_PixMap^ thePixmap, bool theToGenerateMipmaps);
			/// <summary>
			/// Constructor defining direct cubemap initialization from PixMap.
			/// </summary>
			Graphic3d_CubeMap(RDC::OCC::Image_PixMap^ thePixmap);
			/// <summary>
			/// Constructor defining direct cubemap initialization from PixMap.
			/// </summary>
			Graphic3d_CubeMap();
			...
			/// </summary>
			RDC::OCC::Graphic3d_CubeMapSide CurrentSide();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Image_CompressedPixMap^ CompressedValue(RDC::OCC::Image_SupportedFormats^ theSupported);
			/// <summary>
			/// Returns PixMap containing current side of cubemap.
			/// Returns null handle if current side is invalid.
			/// </summary>
			RDC::OCC::Image_PixMap^ Value(RDC::OCC::Image_SupportedFormats^ theSupported);
			/// <summary>
			/// Sets iterator state to +X cubemap side.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMap^ Reset();
			static RDC::OCC::Graphic3d_CubeMap^ CreateDowncasted(::Graphic3d_CubeMap* instance);
		}; // class Graphic3d_CubeMap
		...
		public ref class Graphic3d_CubeMapPacked sealed
			: public RDC::OCC::Graphic3d_CubeMap
		{
		...
		public:
			Graphic3d_CubeMapPacked(::Graphic3d_CubeMapPacked* nativeInstance)
				: RDC::OCC::Graphic3d_CubeMap(nativeInstance)
			{}
		...
		public:
			...
			Graphic3d_CubeMapPacked(RDC::OCC::TCollection_AsciiString^ theFileName, RDC::OCC::Graphic3d_ValidatedCubeMapOrder^ theOrder);
			/// <summary>
			/// Initialization to load cubemap from file.
			/// </summary>
			/// @theFileName - path to the cubemap image
			/// @theOrder - array containing six different indexes of cubemap sides which maps tile grid to cubemap sides
			Graphic3d_CubeMapPacked(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Initialization to set cubemap directly by PixMap.
			/// </summary>
			/// @thePixMap - origin PixMap
			/// @theOrder - array containing six different indexes of cubemap sides which maps tile grid to cubemap sides
			Graphic3d_CubeMapPacked(RDC::OCC::Image_PixMap^ theImage, RDC::OCC::Graphic3d_ValidatedCubeMapOrder^ theOrder);
			/// <summary>
			/// Initialization to set cubemap directly by PixMap.
			/// </summary>
			/// @thePixMap - origin PixMap
			/// @theOrder - array containing six different indexes of cubemap sides which maps tile grid to cubemap sides
			Graphic3d_CubeMapPacked(RDC::OCC::Image_PixMap^ theImage);
			/// <summary>
			/// Returns current cubemap side as compressed PixMap.
			/// </summary>
			RDC::OCC::Image_CompressedPixMap^ CompressedValue(RDC::OCC::Image_SupportedFormats^ theSupported);
			...
			/// </summary>
			RDC::OCC::Image_PixMap^ Value(RDC::OCC::Image_SupportedFormats^ theSupported);
			static RDC::OCC::Graphic3d_CubeMapPacked^ CreateDowncasted(::Graphic3d_CubeMapPacked* instance);
		}; // class Graphic3d_CubeMapPacked
		...
		public:
			...
			Graphic3d_CubeMapSeparate(RDC::OCC::TColStd_Array1OfAsciiString^ thePaths);
			...
			/// Returns NULL.
			/// </summary>
			RDC::OCC::Image_PixMap^ GetImage(RDC::OCC::Image_SupportedFormats^ parameter1);
			/// <summary>
			/// Checks if a texture class is valid or not.
			/// Returns true if the construction of the class is correct.
			/// </summary>
			bool IsDone();
			static RDC::OCC::Graphic3d_CubeMapSeparate^ CreateDowncasted(::Graphic3d_CubeMapSeparate* instance);
		}; // class Graphic3d_CubeMapSeparate
		...
		public ref class Graphic3d_CullingTool sealed
			: public RDC::OCC::BaseClass<::Graphic3d_CullingTool>
		{
		...
		public:
			Graphic3d_CullingTool(::Graphic3d_CullingTool* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CullingTool>(nativeInstance, true)
			{}

			Graphic3d_CullingTool(::Graphic3d_CullingTool& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_CullingTool>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </param>
			void SetViewVolume(RDC::OCC::Graphic3d_Camera^ theCamera, RDC::OCC::Graphic3d_Mat4d^ theModelWorld);
			/// <summary>
			/// Retrieves view volume's planes equations and its vertices from projection and world-view matrices.
			/// </summary>
			/// <param name="theCamera">
			...
			/// [in] optional object transformation for computing frustum in object local coordinate system
			/// </param>
			void SetViewVolume(RDC::OCC::Graphic3d_Camera^ theCamera);
			...
			/// </summary>
			RDC::OCC::Graphic3d_Mat4d^ WorldViewMatrix();
			int ViewportWidth();
			int ViewportHeight();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_Vec3d^ CameraEye();
			/// <summary>
			/// Returns camera direction.
			/// </summary>
			RDC::OCC::Graphic3d_Vec3d^ CameraDirection();
			/// <summary>
			...
			///    [in]
			/// </param>
			double SignedPlanePointDistance(RDC::OCC::Graphic3d_Vec4d^ theNormal, RDC::OCC::Graphic3d_Vec4d^ thePnt);
			/// <summary>
			...
			bool IsOutFrustum(RDC::OCC::Graphic3d_Vec3d^ theMinPnt, RDC::OCC::Graphic3d_Vec3d^ theMaxPnt, bool% theIsInside);
			/// <summary>
			/// Detects if AABB overlaps view volume using separating axis theorem (SAT).
			/// </summary>
			/// <param name="theMinPnt">
			...
			/// </returns>
			/// @sa SelectMgr_Frustum::hasOverlap()
			bool IsOutFrustum(RDC::OCC::Graphic3d_Vec3d^ theMinPnt, RDC::OCC::Graphic3d_Vec3d^ theMaxPnt);
		...
		public:
			static RDC::OCC::Graphic3d_DataStructureManager^ CreateDowncasted(::Graphic3d_DataStructureManager* instance);
		}; // class Graphic3d_DataStructureManager
		...
		public ref class Graphic3d_CView
			: public RDC::OCC::Graphic3d_DataStructureManager
		{
		...
		public:
			Graphic3d_CView(::Graphic3d_CView* nativeInstance)
				: RDC::OCC::Graphic3d_DataStructureManager(nativeInstance)
			{}
		...
		public:
			...
			/// Constructor.
			/// </summary>
			Graphic3d_CView(RDC::OCC::Graphic3d_StructureManager^ theMgr);
			/// <summary>
			...
			/// </summary>
			void SetShadingModel(RDC::OCC::Graphic3d_TypeOfShadingModel theModel);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfBackfacingModel BackfacingModel();
			/// <summary>
			/// Sets backfacing model for the view.
			/// </summary>
			void SetBackfacingModel(RDC::OCC::Graphic3d_TypeOfBackfacingModel theModel);
			/// <summary>
			/// Returns visualization type of the view.
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfVisualization VisualizationType();
			/// <summary>
			/// Sets visualization type of the view.
			/// </summary>
			void SetVisualizationType(RDC::OCC::Graphic3d_TypeOfVisualization theType);
			/// <summary>
			...
			/// </summary>
			void DisplayedStructures(RDC::OCC::Graphic3d_MapOfStructure^ theStructures);
			/// <summary>
			...
			/// </summary>
			bool IsComputed(int theStructId, RDC::OCC::Graphic3d_Structure^ theComputedStruct);
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Bnd_Box^ MinMaxValues(bool theToIncludeAuxiliary);
			/// <summary>
			/// Returns the bounding box of all structures displayed in the view.
			/// If theToIncludeAuxiliary is TRUE, then the boundary box also includes minimum and maximum limits
			/// of graphical elements forming parts of infinite and other auxiliary structures.
			...
			/// </summary>
			RDC::OCC::Bnd_Box^ MinMaxValues(RDC::OCC::Graphic3d_MapOfStructure^ theSet, bool theToIncludeAuxiliary);
			/// <summary>
			/// Returns the coordinates of the boundary box of all structures in the set <theSet>.
			/// If <theToIgnoreInfiniteFlag> is TRUE, then the boundary box
			/// also includes minimum and maximum limits of graphical elements
			/// forming parts of infinite structures.
			/// </summary>
			RDC::OCC::Bnd_Box^ MinMaxValues(RDC::OCC::Graphic3d_MapOfStructure^ theSet);
			/// <summary>
			...
			/// </param>
			void SetWindow(RDC::OCC::Graphic3d_CView^ theParentVIew, RDC::OCC::Aspect_Window^ theWindow, System::IntPtr theContext);
			/// <summary>
			/// Returns the window associated to the view.
			/// </summary>
			RDC::OCC::Aspect_Window^ Window();
			/// <summary>
			...
			/// </summary>
			bool BufferDump(RDC::OCC::Image_PixMap^ theImage, RDC::OCC::Graphic3d_BufferType theBufferType);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Standard_Transient^ FBO();
			/// <summary>
			/// Sets framebuffer object for offscreen rendering.
			/// </summary>
			void SetFBO(RDC::OCC::Standard_Transient^ theFbo);
			/// <summary>
			/// Generate offscreen FBO in the graphic library.
			/// If not supported on hardware returns NULL.
			/// </summary>
			RDC::OCC::Standard_Transient^ FBOCreate(int theWidth, int theHeight);
			/// <summary>
			/// Remove offscreen FBO from the graphic library
			/// </summary>
			void FBORelease(RDC::OCC::Standard_Transient^ theFbo);
			/// <summary>
			/// Read offscreen FBO configuration.
			/// </summary>
			void FBOGetDimensions(RDC::OCC::Standard_Transient^ theFbo, int% theWidth, int% theHeight, int% theWidthMax, int% theHeightMax);
			/// <summary>
			/// Change offscreen FBO viewport.
			/// </summary>
			void FBOChangeViewport(RDC::OCC::Standard_Transient^ theFbo, int theWidth, int theHeight);
			/// <summary>
			...
			/// </summary>
			void CopySettings(RDC::OCC::Graphic3d_CView^ theOther);
			/// <summary>
			/// Returns current rendering parameters and effect settings.
			/// </summary>
			RDC::OCC::Graphic3d_RenderingParams^ RenderingParams();
			/// <summary>
			/// Returns reference to current rendering parameters and effect settings.
			/// </summary>
			RDC::OCC::Graphic3d_RenderingParams^ ChangeRenderingParams();
			/// <summary>
			/// Returns background  fill color.
			/// </summary>
			RDC::OCC::Aspect_Background^ Background();
			/// <summary>
			/// Sets background fill color.
			/// </summary>
			void SetBackground(RDC::OCC::Aspect_Background^ theBackground);
			/// <summary>
			/// Returns gradient background fill colors.
			/// </summary>
			RDC::OCC::Aspect_GradientBackground^ GradientBackground();
			/// <summary>
			/// Sets gradient background fill colors.
			/// </summary>
			void SetGradientBackground(RDC::OCC::Aspect_GradientBackground^ theBackground);
			/// <summary>
			/// Returns background image texture map.
			/// </summary>
			RDC::OCC::Graphic3d_TextureMap^ BackgroundImage();
			/// <summary>
			/// Returns cubemap being set last time on background.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMap^ BackgroundCubeMap();
			/// <summary>
			/// Returns cubemap being set last time on background.
			/// </summary>
			RDC::OCC::Graphic3d_CubeMap^ IBLCubeMap();
			/// <summary>
			...
			/// </param>
			void SetBackgroundImage(RDC::OCC::Graphic3d_TextureMap^ theTextureMap, bool theToUpdatePBREnv);
			/// <summary>
			/// Sets image texture or environment cubemap as background.
			/// </summary>
			/// <param name="theTextureMap">
			...
			/// (see GeneratePBREnvironment())
			/// </param>
			void SetBackgroundImage(RDC::OCC::Graphic3d_TextureMap^ theTextureMap);
			/// <summary>
			/// Returns background image fill style.
			/// </summary>
			RDC::OCC::Aspect_FillMethod BackgroundImageStyle();
			/// <summary>
			/// Sets background image fill style.
			/// </summary>
			void SetBackgroundImageStyle(RDC::OCC::Aspect_FillMethod theFillStyle);
			/// <summary>
			/// Returns background type.
			/// </summary>
			RDC::OCC::Graphic3d_TypeOfBackground BackgroundType();
			/// <summary>
			/// Sets background type.
			/// </summary>
			void SetBackgroundType(RDC::OCC::Graphic3d_TypeOfBackground theType);
			/// <summary>
			/// Returns skydome aspect;
			/// </summary>
			RDC::OCC::Aspect_SkydomeBackground^ BackgroundSkydome();
			/// <summary>
			/// Sets skydome aspect
			/// </summary>
			void SetBackgroundSkydome(RDC::OCC::Aspect_SkydomeBackground^ theAspect, bool theToUpdatePBREnv);
			/// <summary>
			/// Sets skydome aspect
			/// </summary>
			void SetBackgroundSkydome(RDC::OCC::Aspect_SkydomeBackground^ theAspect);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_TextureEnv^ TextureEnv();
			/// <summary>
			/// Sets environment texture for the view.
			/// </summary>
			void SetTextureEnv(RDC::OCC::Graphic3d_TextureEnv^ theTextureEnv);
			/// <summary>
			...
			/// </summary>
			void DiagnosticInformation(RDC::OCC::TColStd_IndexedDataMapOfStringString^ theDict, RDC::OCC::Graphic3d_DiagnosticInfo theFlags);
			/// <summary>
			/// Returns string with statistic performance info.
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ StatisticInformation();
			/// <summary>
			/// Fills in the dictionary with statistic performance info.
			/// </summary>
			void StatisticInformation(RDC::OCC::TColStd_IndexedDataMapOfStringString^ theDict);
			/// <summary>
			...
			/// Return XR session.
			/// </summary>
			RDC::OCC::Aspect_XRSession^ XRSession();
			/// <summary>
			/// Set XR session.
			/// </summary>
			void SetXRSession(RDC::OCC::Aspect_XRSession^ theSession);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_Camera^ PosedXRCamera();
			/// <summary>
			/// Sets transient XR camera position with tracked head orientation applied.
			/// </summary>
			void SetPosedXRCamera(RDC::OCC::Graphic3d_Camera^ theCamera);
			/// <summary>
			/// Returns anchor camera definition (without tracked head orientation).
			/// </summary>
			RDC::OCC::Graphic3d_Camera^ BaseXRCamera();
			/// <summary>
			/// Sets anchor camera definition.
			/// </summary>
			void SetBaseXRCamera(RDC::OCC::Graphic3d_Camera^ theCamera);
			/// <summary>
			...
			/// </returns>
			RDC::OCC::Trsf PoseXRToWorld(RDC::OCC::Trsf thePoseXR);
			/// <summary>
			...
			/// oriented as Y-up, X-right and -Z-forward
			/// </param>
			RDC::OCC::Ax1 ViewAxisInWorld(RDC::OCC::Trsf thePoseXR);
			/// <summary>
			...
			/// </summary>
			void ComputeXRPosedCameraFromBase(RDC::OCC::Graphic3d_Camera^ theCam, RDC::OCC::Trsf theXRTrsf);
			/// <summary>
			/// Update based camera from posed camera by applying reversed transformation.
			/// </summary>
			void ComputeXRBaseCameraFromPosed(RDC::OCC::Graphic3d_Camera^ theCamPosed, RDC::OCC::Trsf thePoseTrsf);
			/// <summary>
			/// Turn XR camera direction using current (head) eye position as anchor.
			/// </summary>
			void TurnViewXRCamera(RDC::OCC::Trsf theTrsfTurn);
			/// <summary>
			/// Returns data of a graduated trihedron
			/// </summary>
			RDC::OCC::Graphic3d_GraduatedTrihedron^ GetGraduatedTrihedron();
			/// <summary>
			/// Displays Graduated Trihedron.
			/// </summary>
			void GraduatedTrihedronDisplay(RDC::OCC::Graphic3d_GraduatedTrihedron^ theTrihedronData);
			/// <summary>
			...
			/// </param>
			void GraduatedTrihedronMinMaxValues(RDC::OCC::Graphic3d_Vec3^ theMin, RDC::OCC::Graphic3d_Vec3^ theMax);
			/// <summary>
			/// Dumps the content of me into the stream
			/// </summary>
			void DumpJson(System::IO::TextWriter^ theOStream, int theDepth);
			...
			/// </summary>
			RDC::OCC::Graphic3d_CView^ ParentView();
			/// <summary>
			...
			/// </summary>
			void AddSubview(RDC::OCC::Graphic3d_CView^ theView);
			/// <summary>
			/// Remove subview from the list.
			/// </summary>
			bool RemoveSubview(RDC::OCC::Graphic3d_CView^ theView);
			/// <summary>
			/// Return subview position within parent view; Aspect_TOTP_LEFT_UPPER by default.
			/// </summary>
			RDC::OCC::Aspect_TypeOfTriedronPosition SubviewCorner();
			/// <summary>
			/// Set subview position within parent view.
			/// </summary>
			void SetSubviewCorner(RDC::OCC::Aspect_TypeOfTriedronPosition thePos);
			/// <summary>
			/// Return subview top-left position relative to parent view in pixels.
			/// </summary>
			RDC::OCC::Graphic3d_Vec2i^ SubviewTopLeft();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_Vec2d^ SubviewSize();
			/// <summary>
			/// Set subview size relative to parent view.
			/// </summary>
			void SetSubviewSize(RDC::OCC::Graphic3d_Vec2d^ theSize);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_Vec2d^ SubviewOffset();
			/// <summary>
			/// Set corner offset within parent view.
			/// </summary>
			void SetSubviewOffset(RDC::OCC::Graphic3d_Vec2d^ theOffset);
			/// <summary>
			/// Return subview margins in pixels; (0,0) by default
			/// </summary>
			RDC::OCC::Graphic3d_Vec2i^ SubviewMargins();
			/// <summary>
			/// Set subview margins in pixels.
			/// </summary>
			void SetSubviewMargins(RDC::OCC::Graphic3d_Vec2i^ theMargins);
			/* Method skipped due to unknown mapping: void SubviewResized(Aspect_NeutralWindow theWindow, ) */
			static RDC::OCC::Graphic3d_CView^ CreateDowncasted(::Graphic3d_CView* instance);
		}; // class Graphic3d_CView
		...
		public ref class Graphic3d_GraduatedTrihedron sealed
			: public RDC::OCC::BaseClass<::Graphic3d_GraduatedTrihedron>
		{
		...
		public:
			Graphic3d_GraduatedTrihedron(::Graphic3d_GraduatedTrihedron* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_GraduatedTrihedron>(nativeInstance, true)
			{}

			Graphic3d_GraduatedTrihedron(::Graphic3d_GraduatedTrihedron& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_GraduatedTrihedron>(&nativeInstance, false)
			{}
		...
		public:
			...
			ref class AxisAspect sealed
				: public RDC::OCC::BaseClass<::Graphic3d_GraduatedTrihedron::AxisAspect>
			{
			...
			public:
				AxisAspect(::Graphic3d_GraduatedTrihedron::AxisAspect* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_GraduatedTrihedron::AxisAspect>(nativeInstance, true)
				{}

				AxisAspect(::Graphic3d_GraduatedTrihedron::AxisAspect& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_GraduatedTrihedron::AxisAspect>(&nativeInstance, false)
				{}
			...
			public:
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor, int theValuesOffset, int theNameOffset, int theTickmarksNumber, int theTickmarksLength, bool theToDrawName, bool theToDrawValues, bool theToDrawTickmarks);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor, int theValuesOffset, int theNameOffset, int theTickmarksNumber, int theTickmarksLength, bool theToDrawName, bool theToDrawValues);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor, int theValuesOffset, int theNameOffset, int theTickmarksNumber, int theTickmarksLength, bool theToDrawName);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor, int theValuesOffset, int theNameOffset, int theTickmarksNumber, int theTickmarksLength);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor, int theValuesOffset, int theNameOffset, int theTickmarksNumber);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor, int theValuesOffset, int theNameOffset);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor, int theValuesOffset);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor, RDC::OCC::Quantity_Color^ theColor);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName, RDC::OCC::Quantity_Color^ theNameColor);
				AxisAspect(RDC::OCC::TCollection_ExtendedString^ theName);
				AxisAspect();
				void SetName(RDC::OCC::TCollection_ExtendedString^ theName);
				RDC::OCC::TCollection_ExtendedString^ Name();
				bool ToDrawName();
				...
				RDC::OCC::Quantity_Color^ NameColor();
				void SetNameColor(RDC::OCC::Quantity_Color^ theColor);
				/// <summary>
			...
			/// </summary>
			Graphic3d_GraduatedTrihedron(RDC::OCC::TCollection_AsciiString^ theNamesFont);
			/// <summary>
			/// Default constructor
			/// Constructs the default graduated trihedron with grid, X, Y, Z axes, and tickmarks
			/// </summary>
			Graphic3d_GraduatedTrihedron();
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ ChangeXAxisAspect();
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ ChangeYAxisAspect();
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ ChangeZAxisAspect();
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ ChangeAxisAspect(int theIndex);
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ XAxisAspect();
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ YAxisAspect();
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ ZAxisAspect();
			RDC::OCC::Graphic3d_GraduatedTrihedron::AxisAspect^ AxisAspectAt(int theIndex);
			float ArrowsLength();
			void SetArrowsLength(float theValue);
			RDC::OCC::Quantity_Color^ GridColor();
			void SetGridColor(RDC::OCC::Quantity_Color^ theColor);
			bool ToDrawGrid();
			void SetDrawGrid(bool theToDraw);
			bool ToDrawAxes();
			void SetDrawAxes(bool theToDraw);
			RDC::OCC::TCollection_AsciiString^ NamesFont();
			void SetNamesFont(RDC::OCC::TCollection_AsciiString^ theFont);
			...
			RDC::OCC::TCollection_AsciiString^ ValuesFont();
			void SetValuesFont(RDC::OCC::TCollection_AsciiString^ theFont);
			...
			bool CubicAxesCallback(RDC::OCC::Graphic3d_CView^ theView);
		}; // class Graphic3d_GraduatedTrihedron
		...
		public ref class Graphic3d_RenderingParams sealed
			: public RDC::OCC::BaseClass<::Graphic3d_RenderingParams>
		{
		...
		public:
			Graphic3d_RenderingParams(::Graphic3d_RenderingParams* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_RenderingParams>(nativeInstance, true)
			{}

			Graphic3d_RenderingParams(::Graphic3d_RenderingParams& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_RenderingParams>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			property RDC::OCC::Graphic3d_RenderingMode Method {
				RDC::OCC::Graphic3d_RenderingMode get() {
					return (RDC::OCC::Graphic3d_RenderingMode)(((::Graphic3d_RenderingParams*)_NativeInstance)->Method);
				}
				void set(RDC::OCC::Graphic3d_RenderingMode value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_TypeOfShadingModel ShadingModel {
				RDC::OCC::Graphic3d_TypeOfShadingModel get() {
					return (RDC::OCC::Graphic3d_TypeOfShadingModel)(((::Graphic3d_RenderingParams*)_NativeInstance)->ShadingModel);
				}
				void set(RDC::OCC::Graphic3d_TypeOfShadingModel value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_RenderTransparentMethod TransparencyMethod {
				RDC::OCC::Graphic3d_RenderTransparentMethod get() {
					return (RDC::OCC::Graphic3d_RenderTransparentMethod)(((::Graphic3d_RenderingParams*)_NativeInstance)->TransparencyMethod);
				}
				void set(RDC::OCC::Graphic3d_RenderTransparentMethod value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_RenderingParams::FrustumCulling FrustumCullingState {
				RDC::OCC::Graphic3d_RenderingParams::FrustumCulling get() {
					return (RDC::OCC::Graphic3d_RenderingParams::FrustumCulling)(((::Graphic3d_RenderingParams*)_NativeInstance)->FrustumCullingState);
				}
				void set(RDC::OCC::Graphic3d_RenderingParams::FrustumCulling value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_ToneMappingMethod ToneMappingMethod {
				RDC::OCC::Graphic3d_ToneMappingMethod get() {
					return (RDC::OCC::Graphic3d_ToneMappingMethod)(((::Graphic3d_RenderingParams*)_NativeInstance)->ToneMappingMethod);
				}
				void set(RDC::OCC::Graphic3d_ToneMappingMethod value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_StereoMode StereoMode {
				RDC::OCC::Graphic3d_StereoMode get() {
					return (RDC::OCC::Graphic3d_StereoMode)(((::Graphic3d_RenderingParams*)_NativeInstance)->StereoMode);
				}
				void set(RDC::OCC::Graphic3d_StereoMode value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_RenderingParams::Anaglyph AnaglyphFilter {
				RDC::OCC::Graphic3d_RenderingParams::Anaglyph get() {
					return (RDC::OCC::Graphic3d_RenderingParams::Anaglyph)(((::Graphic3d_RenderingParams*)_NativeInstance)->AnaglyphFilter);
				}
				void set(RDC::OCC::Graphic3d_RenderingParams::Anaglyph value) {
			...
			/// </summary>
			property RDC::OCC::Graphic3d_RenderingParams::PerfCounters CollectedStats {
				RDC::OCC::Graphic3d_RenderingParams::PerfCounters get() {
					return (RDC::OCC::Graphic3d_RenderingParams::PerfCounters)(((::Graphic3d_RenderingParams*)_NativeInstance)->CollectedStats);
				}
				void set(RDC::OCC::Graphic3d_RenderingParams::PerfCounters value) {
		...
		public:
			...
			/// </summary>
			Graphic3d_TextureEnv(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Creates an environment texture from a predefined texture name set.
			/// </summary>
			Graphic3d_TextureEnv(RDC::OCC::Graphic3d_NameOfTextureEnv theName);
			/// <summary>
			/// Creates an environment texture from the pixmap.
			/// </summary>
			Graphic3d_TextureEnv(RDC::OCC::Image_PixMap^ thePixMap);
			/// <summary>
			/// Returns the name of the predefined textures or NOT_ENV_UNKNOWN
			/// when the name is given as a filename.
			/// </summary>
			RDC::OCC::Graphic3d_NameOfTextureEnv Name();
			/// <summary>
			/// Returns the number of predefined textures.
			/// </summary>
			...
			/// </summary>
			static RDC::OCC::TCollection_AsciiString^ TextureName(int theRank);
			static RDC::OCC::Graphic3d_TextureEnv^ CreateDowncasted(::Graphic3d_TextureEnv* instance);
		}; // class Graphic3d_TextureEnv
		...
		public ref class Graphic3d_LightSet sealed
			: public RDC::OCC::Standard_Transient
			, public IIndexEnumerable<RDC::OCC::Graphic3d_CLight^>
		{
		...
		public:
			...
			/// </summary>
			ref class Iterator sealed
				: public RDC::OCC::BaseClass<::Graphic3d_LightSet::Iterator>
			{
			...
			public:
				Iterator(::Graphic3d_LightSet::Iterator* nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_LightSet::Iterator>(nativeInstance, true)
				{}

				Iterator(::Graphic3d_LightSet::Iterator& nativeInstance)
					: RDC::OCC::BaseClass<::Graphic3d_LightSet::Iterator>(&nativeInstance, false)
				{}
			...
			public:
				...
				/// </summary>
				Iterator(RDC::OCC::Graphic3d_LightSet^ theSet, RDC::OCC::Graphic3d_LightSet::IterationFilter theFilter);
				/// <summary>
				/// Constructor with initialization.
				/// </summary>
				Iterator(RDC::OCC::Graphic3d_LightSet^ theSet);
				/// <summary>
				...
				/// </summary>
				RDC::OCC::Graphic3d_CLight^ Value();
				/// <summary>
			...
			/// </summary>
			virtual RDC::OCC::Graphic3d_CLight^ Value(int theIndex);
			/// <summary>
			/// Return TRUE if light source is defined in this set.
			/// </summary>
			bool Contains(RDC::OCC::Graphic3d_CLight^ theLight);
			/// <summary>
			/// Append new light source.
			/// </summary>
			bool Add(RDC::OCC::Graphic3d_CLight^ theLight);
			/// <summary>
			/// Remove light source.
			/// </summary>
			bool Remove(RDC::OCC::Graphic3d_CLight^ theLight);
			/// <summary>
			/// Returns total amount of lights of specified type.
			/// </summary>
			int NbLightsOfType(RDC::OCC::Graphic3d_TypeOfLightSource theType);
			/// <summary>
			...
			/// </summary>
			/// @sa UpdateRevision()
			int NbEnabledLightsOfType(RDC::OCC::Graphic3d_TypeOfLightSource theType);
			/// <summary>
			...
			/// </summary>
			/// @sa UpdateRevision()
			RDC::OCC::Graphic3d_Vec4^ AmbientColor();
			/// <summary>
			...
			/// </summary>
			/// @sa UpdateRevision()
			RDC::OCC::TCollection_AsciiString^ KeyEnabledLong();
			/// <summary>
			/// Returns a string defining a list of enabled light sources as concatenation of letters 'd' (Directional), 'p' (Point), 's' (Spot)
			...
			/// </summary>
			/// @sa UpdateRevision()
			RDC::OCC::TCollection_AsciiString^ KeyEnabledShort();
			static RDC::OCC::Graphic3d_LightSet^ CreateDowncasted(::Graphic3d_LightSet* instance);
			virtual System::Collections::Generic::IEnumerator<RDC::OCC::Graphic3d_CLight^>^ GetEnumerator();
			virtual System::Collections::IEnumerator^ GetEnumerator2() = System::Collections::IEnumerable::GetEnumerator;
		}; // class Graphic3d_LightSet
		...
		public ref class Graphic3d_FrameStatsData
			: public RDC::OCC::BaseClass<::Graphic3d_FrameStatsData>
		{
		...
		protected:
			Graphic3d_FrameStatsData(InitMode init)
				: RDC::OCC::BaseClass<::Graphic3d_FrameStatsData>(init)
			{}

		public:
			Graphic3d_FrameStatsData(::Graphic3d_FrameStatsData* nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_FrameStatsData>(nativeInstance, true)
			{}

			Graphic3d_FrameStatsData(::Graphic3d_FrameStatsData& nativeInstance)
				: RDC::OCC::BaseClass<::Graphic3d_FrameStatsData>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// Get counter value.
			/// </summary>
			long long unsigned int CounterValue(RDC::OCC::Graphic3d_FrameStatsCounter theIndex);
			/// <summary>
			/// Get timer value.
			/// </summary>
			double TimerValue(RDC::OCC::Graphic3d_FrameStatsTimer theIndex);
			/// <summary>
			/// Reset data.
			/// </summary>
			void Reset();
			...
			/// </summary>
			void FillMax(RDC::OCC::Graphic3d_FrameStatsData^ theOther);
		}; // class Graphic3d_FrameStatsData
		...
		public ref class Graphic3d_FrameStatsDataTmp sealed
			: public RDC::OCC::Graphic3d_FrameStatsData
		{
		...
		public:
			Graphic3d_FrameStatsDataTmp(::Graphic3d_FrameStatsDataTmp* nativeInstance)
				: RDC::OCC::Graphic3d_FrameStatsData(nativeInstance)
			{}
		...
		public:
			...
			/// Get counter value.
			/// </summary>
			long long unsigned int ChangeCounterValue(RDC::OCC::Graphic3d_FrameStatsCounter theIndex);
			/// <summary>
			/// Modify timer value.
			/// </summary>
			double ChangeTimerValue(RDC::OCC::Graphic3d_FrameStatsTimer theIndex);
		}; // class Graphic3d_FrameStatsDataTmp
		...
		public:
			...
			/// </summary>
			void FrameStart(RDC::OCC::Graphic3d_CView^ theView, bool theIsImmediateOnly);
			/// <summary>
			/// Frame redraw finished.
			/// </summary>
			void FrameEnd(RDC::OCC::Graphic3d_CView^ theView, bool theIsImmediateOnly);
			/// <summary>
			/// Returns formatted string.
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ FormatStats(RDC::OCC::Graphic3d_RenderingParams::PerfCounters theFlags);
			/// <summary>
			/// Fill in the dictionary with formatted statistic info.
			/// </summary>
			void FormatStats(RDC::OCC::TColStd_IndexedDataMapOfStringString^ theDict, RDC::OCC::Graphic3d_RenderingParams::PerfCounters theFlags);
			/// <summary>
			...
			/// </summary>
			long long unsigned int CounterValue(RDC::OCC::Graphic3d_FrameStatsCounter theCounter);
			/// <summary>
			/// Returns value of specified timer for modification, should be called between ::FrameStart() and ::FrameEnd() calls.
			/// Should NOT be called between ::FrameStart() and ::FrameEnd() calls.
			/// </summary>
			double TimerValue(RDC::OCC::Graphic3d_FrameStatsTimer theTimer);
			/// <summary>
			...
			/// Should NOT be called between ::FrameStart() and ::FrameEnd() calls.
			/// </summary>
			RDC::OCC::Graphic3d_FrameStatsData^ LastDataFrame();
			/// <summary>
			...
			/// </summary>
			long long unsigned int ChangeCounter(RDC::OCC::Graphic3d_FrameStatsCounter theCounter);
			/// <summary>
			/// Returns value of specified timer for modification, should be called between ::FrameStart() and ::FrameEnd() calls.
			/// </summary>
			double ChangeTimer(RDC::OCC::Graphic3d_FrameStatsTimer theTimer);
			/// <summary>
			/// Returns currently filling data frame for modification, should be called between ::FrameStart() and ::FrameEnd() calls.
			/// </summary>
			RDC::OCC::Graphic3d_FrameStatsDataTmp^ ActiveDataFrame();
			static RDC::OCC::Graphic3d_FrameStats^ CreateDowncasted(::Graphic3d_FrameStats* instance);
		}; // class Graphic3d_FrameStats
		...
		public:
			...
			/// </param>
			static void RegisterFactory(RDC::OCC::Graphic3d_GraphicDriverFactory^ theFactory, bool theIsPreferred);
			/// <summary>
			/// Registers factory.
			/// </summary>
			/// <param name="theFactory">
			...
			/// [in] add to the beginning of the list when TRUE, or add to the end otherwise
			/// </param>
			static void RegisterFactory(RDC::OCC::Graphic3d_GraphicDriverFactory^ theFactory);
			/// <summary>
			/// Unregisters factory.
			/// </summary>
			static void UnregisterFactory(RDC::OCC::TCollection_AsciiString^ theName);
			/// <summary>
			/// Return default driver factory or NULL if no one was registered.
			/// </summary>
			static RDC::OCC::Graphic3d_GraphicDriverFactory^ DefaultDriverFactory();
			/// <summary>
			/// Return the global map of registered driver factories.
			/// </summary>
			static RDC::OCC::Graphic3d_GraphicDriverFactoryList^ DriverFactories();
			...
			/// </summary>
			RDC::OCC::TCollection_AsciiString^ Name();
			static RDC::OCC::Graphic3d_GraphicDriverFactory^ CreateDowncasted(::Graphic3d_GraphicDriverFactory* instance);
		}; // class Graphic3d_GraphicDriverFactory
		...
		public ref class Graphic3d_GroupDefinitionError sealed
			: public RDC::OCC::Standard_OutOfRange
		{
		...
		public:
			Graphic3d_GroupDefinitionError(::Graphic3d_GroupDefinitionError* nativeInstance)
				: RDC::OCC::Standard_OutOfRange(nativeInstance)
			{}
		...
		public:
			...
			static RDC::OCC::Graphic3d_GroupDefinitionError^ NewInstance(System::String^ theMessage);
			static RDC::OCC::Graphic3d_GroupDefinitionError^ NewInstance();
			static RDC::OCC::Graphic3d_GroupDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
			static RDC::OCC::Graphic3d_GroupDefinitionError^ CreateDowncasted(::Graphic3d_GroupDefinitionError* instance);
		}; // class Graphic3d_GroupDefinitionError
		...
		public:
			...
			static void Raise();
			/* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
			static RDC::OCC::Graphic3d_MaterialDefinitionError^ NewInstance(System::String^ theMessage);
			static RDC::OCC::Graphic3d_MaterialDefinitionError^ NewInstance();
			static RDC::OCC::Graphic3d_MaterialDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
			static RDC::OCC::Graphic3d_MaterialDefinitionError^ CreateDowncasted(::Graphic3d_MaterialDefinitionError* instance);
		}; // class Graphic3d_MaterialDefinitionError
		...
		public:
			...
			/// </summary>
			Graphic3d_Texture2D(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Creates a texture from a predefined texture name set.
			/// MipMaps levels will be automatically generated if needed.
			/// </summary>
			Graphic3d_Texture2D(RDC::OCC::Graphic3d_NameOfTexture2D theNOT);
			/// <summary>
			/// Creates a texture from the pixmap.
			/// MipMaps levels will be automatically generated if needed.
			/// </summary>
			Graphic3d_Texture2D(RDC::OCC::Image_PixMap^ thePixMap);
			/// <summary>
			/// Returns the number of predefined textures.
			/// </summary>
			static int NumberOfTextures();
			...
			/// when the name is given as a filename.
			/// </summary>
			RDC::OCC::Graphic3d_NameOfTexture2D Name();
			/// <summary>
			...
			/// </summary>
			void SetImage(RDC::OCC::Image_PixMap^ thePixMap);
			static RDC::OCC::Graphic3d_Texture2D^ CreateDowncasted(::Graphic3d_Texture2D* instance);
		}; // class Graphic3d_Texture2D
		...
		public ref class Graphic3d_MediaTexture sealed
			: public RDC::OCC::Graphic3d_Texture2D
		{
		...
		public:
			Graphic3d_MediaTexture(::Graphic3d_MediaTexture* nativeInstance)
				: RDC::OCC::Graphic3d_Texture2D(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			void GenerateNewId();
			static RDC::OCC::Graphic3d_MediaTexture^ CreateDowncasted(::Graphic3d_MediaTexture* instance);
		}; // class Graphic3d_MediaTexture
		...
		public:
			...
			static void Raise();
			/* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
			static RDC::OCC::Graphic3d_PriorityDefinitionError^ NewInstance(System::String^ theMessage);
			static RDC::OCC::Graphic3d_PriorityDefinitionError^ NewInstance();
			static RDC::OCC::Graphic3d_PriorityDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
			static RDC::OCC::Graphic3d_PriorityDefinitionError^ CreateDowncasted(::Graphic3d_PriorityDefinitionError* instance);
		}; // class Graphic3d_PriorityDefinitionError
		...
		public:
			...
			/// </summary>
			Graphic3d_ShaderManager(RDC::OCC::Aspect_GraphicsLibrary theGapi);
			/// <summary>
			/// </summary>
			/// <returns>
			...
			/// </summary>
			bool HasGlslExtension(RDC::OCC::Graphic3d_GlslExtension theExt);
			/// <summary>
			/// Set if specified extension is available or not.
			/// </summary>
			void EnableGlslExtension(RDC::OCC::Graphic3d_GlslExtension theExt, bool theToEnable);
			/// <summary>
			/// Set if specified extension is available or not.
			/// </summary>
			void EnableGlslExtension(RDC::OCC::Graphic3d_GlslExtension theExt);
			static RDC::OCC::Graphic3d_ShaderManager^ CreateDowncasted(::Graphic3d_ShaderManager* instance);
		}; // class Graphic3d_ShaderManager
		...
		public:
			...
			static void Raise();
			/* Method skipped due to unknown mapping: void Raise(stringstream theMessage, ) */
			static RDC::OCC::Graphic3d_StructureDefinitionError^ NewInstance(System::String^ theMessage);
			static RDC::OCC::Graphic3d_StructureDefinitionError^ NewInstance();
			static RDC::OCC::Graphic3d_StructureDefinitionError^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
			static RDC::OCC::Graphic3d_StructureDefinitionError^ CreateDowncasted(::Graphic3d_StructureDefinitionError* instance);
		}; // class Graphic3d_StructureDefinitionError
		...
		public:
			...
			/// when the name is given as a filename.
			/// </summary>
			RDC::OCC::Graphic3d_NameOfTexture1D Name();
			/// <summary>
			/// Returns the number of predefined textures.
			/// </summary>
			static int NumberOfTextures();
			...
			/// Returns the name of the predefined texture of rank <aRank>
			/// </summary>
			static RDC::OCC::TCollection_AsciiString^ TextureName(int aRank);
			static RDC::OCC::Graphic3d_Texture1D^ CreateDowncasted(::Graphic3d_Texture1D* instance);
		}; // class Graphic3d_Texture1D
		...
		public ref class Graphic3d_Texture1Dmanual sealed
			: public RDC::OCC::Graphic3d_Texture1D
		{
		...
		public:
			Graphic3d_Texture1Dmanual(::Graphic3d_Texture1Dmanual* nativeInstance)
				: RDC::OCC::Graphic3d_Texture1D(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			Graphic3d_Texture1Dmanual(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Create a texture from a predefined texture name set.
			/// </summary>
			Graphic3d_Texture1Dmanual(RDC::OCC::Graphic3d_NameOfTexture1D theNOT);
			/// <summary>
			/// Creates a texture from the pixmap.
			/// </summary>
			Graphic3d_Texture1Dmanual(RDC::OCC::Image_PixMap^ thePixMap);
			static RDC::OCC::Graphic3d_Texture1Dmanual^ CreateDowncasted(::Graphic3d_Texture1Dmanual* instance);
		}; // class Graphic3d_Texture1Dmanual
		...
		public:
			...
			/// Creates a texture from a file
			/// </summary>
			Graphic3d_Texture1Dsegment(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Creates a texture from a predefined texture name set.
			/// </summary>
			Graphic3d_Texture1Dsegment(RDC::OCC::Graphic3d_NameOfTexture1D theNOT);
			/// <summary>
			/// Creates a texture from the pixmap.
			/// </summary>
			Graphic3d_Texture1Dsegment(RDC::OCC::Image_PixMap^ thePixMap);
			/// <summary>
			...
			static RDC::OCC::Graphic3d_Texture1Dsegment^ CreateDowncasted(::Graphic3d_Texture1Dsegment* instance);
		}; // class Graphic3d_Texture1Dsegment
		...
		public:
			...
			/// Creates a texture from a file
			/// </summary>
			Graphic3d_Texture2Dplane(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Creates a texture from a predefined texture name set.
			/// </summary>
			Graphic3d_Texture2Dplane(RDC::OCC::Graphic3d_NameOfTexture2D theNOT);
			/// <summary>
			/// Creates a texture from the pixmap.
			/// </summary>
			Graphic3d_Texture2Dplane(RDC::OCC::Image_PixMap^ thePixMap);
			/// <summary>
			...
			/// </summary>
			void SetPlane(RDC::OCC::Graphic3d_NameOfTexturePlane thePlane);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::Graphic3d_NameOfTexturePlane Plane();
			/// <summary>
			...
			static RDC::OCC::Graphic3d_Texture2Dplane^ CreateDowncasted(::Graphic3d_Texture2Dplane* instance);
		}; // class Graphic3d_Texture2Dplane
		...
		public:
			...
			/// Creates a texture from a file.
			/// </summary>
			Graphic3d_Texture3D(RDC::OCC::TCollection_AsciiString^ theFileName);
			/// <summary>
			/// Creates a texture from the pixmap.
			/// </summary>
			Graphic3d_Texture3D(RDC::OCC::Image_PixMap^ thePixMap);
			/// <summary>
			/// Creates a texture from a file.
			/// </summary>
			Graphic3d_Texture3D(RDC::OCC::TColStd_Array1OfAsciiString^ theFiles);
			/// <summary>
			/// Assign new image to the texture.
			/// Note that this method does not invalidate already uploaded resources - consider calling ::UpdateRevision() if needed.
			/// </summary>
			...
			/// </summary>
			RDC::OCC::Image_PixMap^ GetImage(RDC::OCC::Image_SupportedFormats^ theSupported);
			static RDC::OCC::Graphic3d_Texture3D^ CreateDowncasted(::Graphic3d_Texture3D* instance);
		}; // class Graphic3d_Texture3D
		...
		public ref class Graphic3d_TransformPersScaledAbove sealed
			: public RDC::OCC::Graphic3d_TransformPers
		{
		...
		public:
			Graphic3d_TransformPersScaledAbove(::Graphic3d_TransformPersScaledAbove* nativeInstance)
				: RDC::OCC::Graphic3d_TransformPers(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			Graphic3d_TransformPersScaledAbove(double theScale, RDC::OCC::Pnt thePnt);
			/// <summary>
			/// Find scale value based on the camera position and view dimensions
			...
			/// </param>
			double persistentScale(RDC::OCC::Graphic3d_Camera^ theCamera, int theViewportWidth, int theViewportHeight);
			static RDC::OCC::Graphic3d_TransformPersScaledAbove^ CreateDowncasted(::Graphic3d_TransformPersScaledAbove* instance);
		}; // class Graphic3d_TransformPersScaledAbove
