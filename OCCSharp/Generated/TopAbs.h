...
public ref class TopAbs sealed
    : public RDC::OCC::BaseClass<::TopAbs>
{
...
public:
    TopAbs(::TopAbs* nativeInstance)
        : RDC::OCC::BaseClass<::TopAbs>( nativeInstance, true )
    {}

    TopAbs(::TopAbs& nativeInstance)
        : RDC::OCC::BaseClass<::TopAbs>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static RDC::OCC::TopAbs_Orientation Compose(RDC::OCC::TopAbs_Orientation Or1, RDC::OCC::TopAbs_Orientation Or2);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::TopAbs_Orientation Reverse(RDC::OCC::TopAbs_Orientation Or);
    /// <summary>
    ...
    /// becomes outside.
    /// </summary>
    static RDC::OCC::TopAbs_Orientation Complement(RDC::OCC::TopAbs_Orientation Or);
    /// <summary>
    /// Prints the name of Shape type as a String on the Stream.
    /// </summary>
    static System::IO::TextWriter^ Print(RDC::OCC::TopAbs_ShapeEnum theShapeType, System::IO::TextWriter^ theStream);
    /// <summary>
    /// Prints the name of the Orientation as a String on the Stream.
    /// </summary>
    static System::IO::TextWriter^ Print(RDC::OCC::TopAbs_Orientation theOrientation, System::IO::TextWriter^ theStream);
    /// <summary>
    /// Prints the name of the State <St> as a String on
    /// the Stream <S> and returns <S>.
    /// </summary>
    static System::IO::TextWriter^ Print(RDC::OCC::TopAbs_State St, System::IO::TextWriter^ S);
    /// <summary>
    ...
    /// </returns>
    static System::String^ ShapeTypeToString(RDC::OCC::TopAbs_ShapeEnum theType);
    /// <summary>
    ...
    /// </returns>
    static RDC::OCC::TopAbs_ShapeEnum ShapeTypeFromString(System::String^ theTypeString);
    /// <summary>
    ...
    /// </returns>
    static bool ShapeTypeFromString(System::String^ theTypeString, RDC::OCC::TopAbs_ShapeEnum% theType);
    /// <summary>
    ...
    /// </returns>
    static System::String^ ShapeOrientationToString(RDC::OCC::TopAbs_Orientation theOrientation);
    /// <summary>
    ...
    /// </returns>
    static RDC::OCC::TopAbs_Orientation ShapeOrientationFromString(System::String^ theOrientationString);
    /// <summary>
    ...
    /// TRUE if string identifier is known
    /// </returns>
    static bool ShapeOrientationFromString(System::String^ theOrientationString, RDC::OCC::TopAbs_Orientation% theOrientation);
}; // class TopAbs
