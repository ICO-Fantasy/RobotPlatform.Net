...
public ref class GeomConvert sealed
    : public RDC::OCC::BaseClass<::GeomConvert>
{
...
public:
    GeomConvert(::GeomConvert* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert>( nativeInstance, true )
    {}

    GeomConvert(::GeomConvert& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom_BSplineCurve^ C, int FromK1, int ToK2, bool SameOrientation);
    /// <summary>
    /// Convert a curve from Geom by an approximation method
    /// 
    /// This method computes the arc of B-spline curve between the two
    ...
    /// [FirstUKnotIndex, LastUKnotIndex]
    /// </summary>
    static RDC::OCC::Geom_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom_BSplineCurve^ C, int FromK1, int ToK2);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom_BSplineCurve^ C, double FromU1, double ToU2, double ParametricTolerance, bool SameOrientation);
    /// <summary>
    /// This function computes the segment of B-spline curve between the
    /// parametric values FromU1, ToU2.
    /// If C is periodic the arc has the same orientation as C if
    ...
    /// Raised if ParametricTolerance < Resolution from gp.
    /// </summary>
    static RDC::OCC::Geom_BSplineCurve^ SplitBSplineCurve(RDC::OCC::Geom_BSplineCurve^ C, double FromU1, double ToU2, double ParametricTolerance);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, int FromUK1, int ToUK2, int FromVK1, int ToVK2, bool SameUOrientation, bool SameVOrientation);
    /// <summary>
    /// Computes the B-spline surface patche between the knots values
    /// FromUK1, ToUK2, FromVK1, ToVK2.
    /// If S is periodic in one direction the patche has the same
    ...
    /// [FirstVKnotIndex, LastVKnotIndex]
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, int FromUK1, int ToUK2, int FromVK1, int ToVK2, bool SameUOrientation);
    /// <summary>
    /// Computes the B-spline surface patche between the knots values
    /// FromUK1, ToUK2, FromVK1, ToVK2.
    /// If S is periodic in one direction the patche has the same
    ...
    /// [FirstVKnotIndex, LastVKnotIndex]
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, int FromUK1, int ToUK2, int FromVK1, int ToVK2);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, int FromK1, int ToK2, bool USplit, bool SameOrientation);
    /// <summary>
    /// This method splits a B-spline surface patche between the
    /// knots values FromK1, ToK2 in one direction.
    /// If USplit = True then the splitting direction is the U parametric
    ...
    /// considered parametric direction.
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, int FromK1, int ToK2, bool USplit);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, double FromU1, double ToU2, double FromV1, double ToV2, double ParametricTolerance, bool SameUOrientation, bool SameVOrientation);
    /// <summary>
    /// This method computes the B-spline surface patche between the
    /// parametric values FromU1, ToU2, FromV1, ToV2.
    /// If S is periodic in one direction the patche has the same
    ...
    /// Raised if ParametricTolerance < Resolution.
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, double FromU1, double ToU2, double FromV1, double ToV2, double ParametricTolerance, bool SameUOrientation);
    /// <summary>
    /// This method computes the B-spline surface patche between the
    /// parametric values FromU1, ToU2, FromV1, ToV2.
    /// If S is periodic in one direction the patche has the same
    ...
    /// Raised if ParametricTolerance < Resolution.
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, double FromU1, double ToU2, double FromV1, double ToV2, double ParametricTolerance);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, double FromParam1, double ToParam2, bool USplit, double ParametricTolerance, bool SameOrientation);
    /// <summary>
    /// This method splits the B-spline surface S in one direction
    /// between the parametric values FromParam1, ToParam2.
    /// If USplit = True then the Splitting direction is the U parametric
    ...
    /// Raises if Abs (FromParam1 - ToParam2) <= ParametricTolerance.
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SplitBSplineSurface(RDC::OCC::Geom_BSplineSurface^ S, double FromParam1, double ToParam2, bool USplit, double ParametricTolerance);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineCurve^ CurveToBSplineCurve(RDC::OCC::Geom_Curve^ C, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// This function converts a non infinite curve from
    /// Geom into a  B-spline curve.  C must be   an ellipse or  a
    /// circle  or a trimmed conic  or a trimmed  line or a Bezier
    ...
    /// cannot be used to convert a quasi-complete circle or ellipse).
    /// </summary>
    static RDC::OCC::Geom_BSplineCurve^ CurveToBSplineCurve(RDC::OCC::Geom_Curve^ C);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_BSplineSurface^ SurfaceToBSplineSurface(RDC::OCC::Geom_Surface^ S);
    ...
    /// </summary>
    static void C0BSplineToC1BSplineCurve(RDC::OCC::Geom_BSplineCurve^ BS, double tolerance, double AngularTolerance);
    /// <summary>
    /// This  Method reduces as far as   it is possible the
    /// multiplicities of  the  knots of  the BSpline BS.(keeping  the
    /// geometry).  It returns a new BSpline which  could still be C0.
    ...
    /// curve is G1 or not at a given point
    /// </summary>
    static void C0BSplineToC1BSplineCurve(RDC::OCC::Geom_BSplineCurve^ BS, double tolerance);
...
public ref class GeomConvert_ApproxCurve sealed
    : public RDC::OCC::BaseClass<::GeomConvert_ApproxCurve>
{
...
public:
    GeomConvert_ApproxCurve(::GeomConvert_ApproxCurve* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_ApproxCurve>( nativeInstance, true )
    {}

    GeomConvert_ApproxCurve(::GeomConvert_ApproxCurve& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_ApproxCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomConvert_ApproxCurve(RDC::OCC::Geom_Curve^ Curve, double Tol3d, RDC::OCC::GeomAbs_Shape Order, int MaxSegments, int MaxDegree);
    /// <summary>
    /// Constructs a curve approximation framework defined by -
    /// -      the Curve,
    /// -      the tolerance value Tol3d,
    ...
    /// polynomial defining the BSpline curve may have.
    /// </summary>
    GeomConvert_ApproxCurve(RDC::OCC::Adaptor3d_Curve^ Curve, double Tol3d, RDC::OCC::GeomAbs_Shape Order, int MaxSegments, int MaxDegree);
    /// <summary>
...
public ref class GeomConvert_ApproxSurface sealed
    : public RDC::OCC::BaseClass<::GeomConvert_ApproxSurface>
{
...
public:
    GeomConvert_ApproxSurface(::GeomConvert_ApproxSurface* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_ApproxSurface>( nativeInstance, true )
    {}

    GeomConvert_ApproxSurface(::GeomConvert_ApproxSurface& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_ApproxSurface>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomConvert_ApproxSurface(RDC::OCC::Geom_Surface^ Surf, double Tol3d, RDC::OCC::GeomAbs_Shape UContinuity, RDC::OCC::GeomAbs_Shape VContinuity, int MaxDegU, int MaxDegV, int MaxSegments, int PrecisCode);
    /// <summary>
    /// Constructs a surface approximation framework defined by
    /// -   the Surf
    /// -   the tolerance value Tol3d
    ...
    /// -   the index of precision PrecisCode.
    /// </summary>
    GeomConvert_ApproxSurface(RDC::OCC::Adaptor3d_Surface^ Surf, double Tol3d, RDC::OCC::GeomAbs_Shape UContinuity, RDC::OCC::GeomAbs_Shape VContinuity, int MaxDegU, int MaxDegV, int MaxSegments, int PrecisCode);
    /// <summary>
...
public ref class GeomConvert_BSplineCurveKnotSplitting sealed
    : public RDC::OCC::BaseClass<::GeomConvert_BSplineCurveKnotSplitting>
{
...
public:
    GeomConvert_BSplineCurveKnotSplitting(::GeomConvert_BSplineCurveKnotSplitting* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineCurveKnotSplitting>( nativeInstance, true )
    {}

    GeomConvert_BSplineCurveKnotSplitting(::GeomConvert_BSplineCurveKnotSplitting& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineCurveKnotSplitting>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomConvert_BSplineCurveKnotSplitting(RDC::OCC::Geom_BSplineCurve^ BasisCurve, int ContinuityRange);
    /// <summary>
    ...
    /// </summary>
    void Splitting(RDC::OCC::TColStd_Array1OfInteger^ SplitValues);
    /// <summary>
...
public ref class GeomConvert_BSplineCurveToBezierCurve sealed
    : public RDC::OCC::BaseClass<::GeomConvert_BSplineCurveToBezierCurve>
{
...
public:
    GeomConvert_BSplineCurveToBezierCurve(::GeomConvert_BSplineCurveToBezierCurve* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineCurveToBezierCurve>( nativeInstance, true )
    {}

    GeomConvert_BSplineCurveToBezierCurve(::GeomConvert_BSplineCurveToBezierCurve& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineCurveToBezierCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomConvert_BSplineCurveToBezierCurve(RDC::OCC::Geom_BSplineCurve^ BasisCurve);
    /// <summary>
    ...
    /// </summary>
    GeomConvert_BSplineCurveToBezierCurve(RDC::OCC::Geom_BSplineCurve^ BasisCurve, double U1, double U2, double ParametricTolerance);
    /// <summary>
    ...
    /// computed by this algorithm.
    /// </summary>
    RDC::OCC::Geom_BezierCurve^ Arc(int Index);
    ...
    /// NbArcs +  1.
    /// </summary>
    void Knots(RDC::OCC::TColStd_Array1OfReal^ TKnots);
    /// <summary>
...
public ref class GeomConvert_BSplineSurfaceKnotSplitting sealed
    : public RDC::OCC::BaseClass<::GeomConvert_BSplineSurfaceKnotSplitting>
{
...
public:
    GeomConvert_BSplineSurfaceKnotSplitting(::GeomConvert_BSplineSurfaceKnotSplitting* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineSurfaceKnotSplitting>( nativeInstance, true )
    {}

    GeomConvert_BSplineSurfaceKnotSplitting(::GeomConvert_BSplineSurfaceKnotSplitting& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineSurfaceKnotSplitting>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomConvert_BSplineSurfaceKnotSplitting(RDC::OCC::Geom_BSplineSurface^ BasisSurface, int UContinuityRange, int VContinuityRange);
    /// <summary>
    ...
    /// </summary>
    void Splitting(RDC::OCC::TColStd_Array1OfInteger^ USplit, RDC::OCC::TColStd_Array1OfInteger^ VSplit);
    /// <summary>
...
public ref class GeomConvert_BSplineSurfaceToBezierSurface sealed
    : public RDC::OCC::BaseClass<::GeomConvert_BSplineSurfaceToBezierSurface>
{
...
public:
    GeomConvert_BSplineSurfaceToBezierSurface(::GeomConvert_BSplineSurfaceToBezierSurface* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineSurfaceToBezierSurface>( nativeInstance, true )
    {}

    GeomConvert_BSplineSurfaceToBezierSurface(::GeomConvert_BSplineSurfaceToBezierSurface& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_BSplineSurfaceToBezierSurface>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Note: ParametricTolerance is not used.
    /// </summary>
    GeomConvert_BSplineSurfaceToBezierSurface(RDC::OCC::Geom_BSplineSurface^ BasisSurface);
    /// <summary>
    /// Computes all the data needed to convert
    ...
    /// </summary>
    GeomConvert_BSplineSurfaceToBezierSurface(RDC::OCC::Geom_BSplineSurface^ BasisSurface, double U1, double U2, double V1, double V2, double ParametricTolerance);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom_BezierSurface^ Patch(int UIndex, int VIndex);
    ...
    /// NbUPatches +  1.
    /// </summary>
    void UKnots(RDC::OCC::TColStd_Array1OfReal^ TKnots);
    /// <summary>
    ...
    /// NbVPatches +  1.
    /// </summary>
    void VKnots(RDC::OCC::TColStd_Array1OfReal^ TKnots);
    /// <summary>
...
public ref class GeomConvert_CompBezierSurfacesToBSplineSurface sealed
    : public RDC::OCC::BaseClass<::GeomConvert_CompBezierSurfacesToBSplineSurface>
{
...
public:
    GeomConvert_CompBezierSurfacesToBSplineSurface(::GeomConvert_CompBezierSurfacesToBSplineSurface* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_CompBezierSurfacesToBSplineSurface>( nativeInstance, true )
    {}

    GeomConvert_CompBezierSurfacesToBSplineSurface(::GeomConvert_CompBezierSurfacesToBSplineSurface& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_CompBezierSurfacesToBSplineSurface>( &nativeInstance, false )
    {}
...
public:
    ...
    /// direction of the BSpline surface whose data is computed in this framework.
    /// </summary>
    RDC::OCC::TColStd_HArray1OfReal^ VKnots();
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::TColStd_HArray1OfInteger^ UMultiplicities();
    /// <summary>
    /// -- Returns the multiplicities table for the v
    /// parametric direction of the knots of the BSpline
    /// surface whose data is computed in this framework.
    /// </summary>
    RDC::OCC::TColStd_HArray1OfInteger^ VMultiplicities();
    /// <summary>
...
public ref class GeomConvert_CompCurveToBSplineCurve sealed
    : public RDC::OCC::BaseClass<::GeomConvert_CompCurveToBSplineCurve>
{
...
public:
    GeomConvert_CompCurveToBSplineCurve(::GeomConvert_CompCurveToBSplineCurve* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_CompCurveToBSplineCurve>( nativeInstance, true )
    {}

    GeomConvert_CompCurveToBSplineCurve(::GeomConvert_CompCurveToBSplineCurve& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_CompCurveToBSplineCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomConvert_CompCurveToBSplineCurve(RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// Initialize the algorithme
    /// - Parameterisation is used to convert
    /// </summary>
    ...
    /// - Parameterisation is used to convert
    /// </summary>
    GeomConvert_CompCurveToBSplineCurve(RDC::OCC::Geom_BoundedCurve^ BasisCurve, RDC::OCC::Convert_ParameterisationType Parameterisation);
    /// <summary>
    /// Initialize the algorithme with one curve
    /// - Parameterisation is used to convert
    /// </summary>
    GeomConvert_CompCurveToBSplineCurve(RDC::OCC::Geom_BoundedCurve^ BasisCurve);
    /// <summary>
    ...
    /// </summary>
    bool Add(RDC::OCC::Geom_BoundedCurve^ NewCurve, double Tolerance, bool After, bool WithRatio, int MinM);
    /// <summary>
    /// Append a curve in  the BSpline Return False if the
    /// curve is not G0  with the BSplineCurve.  Tolerance
    /// is   used to   check   continuity  and decrease
    ...
    /// when applied to the resulting curve.
    /// </summary>
    bool Add(RDC::OCC::Geom_BoundedCurve^ NewCurve, double Tolerance, bool After, bool WithRatio);
    /// <summary>
    /// Append a curve in  the BSpline Return False if the
    /// curve is not G0  with the BSplineCurve.  Tolerance
    /// is   used to   check   continuity  and decrease
    ...
    /// when applied to the resulting curve.
    /// </summary>
    bool Add(RDC::OCC::Geom_BoundedCurve^ NewCurve, double Tolerance, bool After);
    /// <summary>
    /// Append a curve in  the BSpline Return False if the
    /// curve is not G0  with the BSplineCurve.  Tolerance
    /// is   used to   check   continuity  and decrease
    ...
    /// when applied to the resulting curve.
    /// </summary>
    bool Add(RDC::OCC::Geom_BoundedCurve^ NewCurve, double Tolerance);
    RDC::OCC::Geom_BSplineCurve^ BSplineCurve();
    /// <summary>
...
public ref class GeomConvert_CurveToAnaCurve sealed
    : public RDC::OCC::BaseClass<::GeomConvert_CurveToAnaCurve>
{
...
public:
    GeomConvert_CurveToAnaCurve(::GeomConvert_CurveToAnaCurve* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_CurveToAnaCurve>( nativeInstance, true )
    {}

    GeomConvert_CurveToAnaCurve(::GeomConvert_CurveToAnaCurve& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_CurveToAnaCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    GeomConvert_CurveToAnaCurve(RDC::OCC::Geom_Curve^ C);
    ...
    /// </summary>
    bool ConvertToAnalytical(double theTol, RDC::OCC::Geom_Curve^ theResultCurve, double F, double L, double% newF, double% newL);
    static RDC::OCC::Geom_Curve^ ComputeCurve(RDC::OCC::Geom_Curve^ curve, double tolerance, double c1, double c2, double% cf, double% cl, double% theGap, RDC::OCC::GeomConvert_ConvType theCurvType, RDC::OCC::GeomAbs_CurveType theTarget);
    static RDC::OCC::Geom_Curve^ ComputeCurve(RDC::OCC::Geom_Curve^ curve, double tolerance, double c1, double c2, double% cf, double% cl, double% theGap, RDC::OCC::GeomConvert_ConvType theCurvType);
    static RDC::OCC::Geom_Curve^ ComputeCurve(RDC::OCC::Geom_Curve^ curve, double tolerance, double c1, double c2, double% cf, double% cl, double% theGap);
    /// <summary>
    /// Tries to convert the given curve to circle with given
    /// tolerance. Returns NULL curve if conversion is
    /// not possible.
    /// </summary>
    static RDC::OCC::Geom_Curve^ ComputeCircle(RDC::OCC::Geom_Curve^ curve, double tolerance, double c1, double c2, double% cf, double% cl, double% Deviation);
    /// <summary>
    /// Tries to convert the given curve to ellipse with given
    /// tolerance. Returns NULL curve if conversion is
    /// not possible.
    /// </summary>
    static RDC::OCC::Geom_Curve^ ComputeEllipse(RDC::OCC::Geom_Curve^ curve, double tolerance, double c1, double c2, double% cf, double% cl, double% Deviation);
    /// <summary>
    /// Tries to convert the given curve to line with given
    /// tolerance. Returns NULL curve if conversion is
    /// not possible.
    /// </summary>
    static RDC::OCC::Geom_Line^ ComputeLine(RDC::OCC::Geom_Curve^ curve, double tolerance, double c1, double c2, double% cf, double% cl, double% Deviation);
    /// <summary>
    /// Returns true if the set of points is linear with given
    /// tolerance
    /// </summary>
    static bool IsLinear(RDC::OCC::TColgp_Array1OfPnt^ aPoints, double tolerance, double% Deviation);
    /// <summary>
    /// Creates line on two points.
    /// Resulting parameters returned
    /// </summary>
    static RDC::OCC::gp_Lin^ GetLine(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double% cf, double% cl);
    /// <summary>
    /// Creates circle on points. Returns true if OK.
    /// </summary>
    static bool GetCircle(RDC::OCC::gp_Circ^ Circ, RDC::OCC::Pnt P0, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::GeomConvert_ConvType GetConvType();
    /// <summary>
    /// Sets type of convertion
    /// </summary>
    void SetConvType(RDC::OCC::GeomConvert_ConvType theConvType);
    /// <summary>
    /// Returns target curve type
    /// </summary>
    RDC::OCC::GeomAbs_CurveType GetTarget();
    /// <summary>
    /// Sets target curve type
    /// </summary>
    void SetTarget(RDC::OCC::GeomAbs_CurveType theTarget);
}; // class GeomConvert_CurveToAnaCurve
...
public ref class GeomConvert_SurfToAnaSurf sealed
    : public RDC::OCC::BaseClass<::GeomConvert_SurfToAnaSurf>
{
...
public:
    GeomConvert_SurfToAnaSurf(::GeomConvert_SurfToAnaSurf* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_SurfToAnaSurf>( nativeInstance, true )
    {}

    GeomConvert_SurfToAnaSurf(::GeomConvert_SurfToAnaSurf& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_SurfToAnaSurf>( &nativeInstance, false )
    {}
...
public:
    ...
    GeomConvert_SurfToAnaSurf(RDC::OCC::Geom_Surface^ S);
    void Init(RDC::OCC::Geom_Surface^ S);
    void SetConvType(RDC::OCC::GeomConvert_ConvType theConvType);
    void SetConvType();
    void SetTarget(RDC::OCC::GeomAbs_SurfaceType theSurfType);
    void SetTarget();
    /// <summary>
    /// Returns maximal deviation of converted surface from the original
    /// one computed by last call to ConvertToAnalytical
    ...
    /// 
    /// </summary>
    RDC::OCC::Geom_Surface^ ConvertToAnalytical(double InitialToler);
    RDC::OCC::Geom_Surface^ ConvertToAnalytical(double InitialToler, double Umin, double Umax, double Vmin, double Vmax);
    /// <summary>
    /// Returns true if surfaces is same with the given tolerance
    /// </summary>
    static bool IsSame(RDC::OCC::Geom_Surface^ S1, RDC::OCC::Geom_Surface^ S2, double tol);
    /// <summary>
    /// Returns true, if surface is canonical
    /// </summary>
    static bool IsCanonical(RDC::OCC::Geom_Surface^ S);
}; // class GeomConvert_SurfToAnaSurf
...
public ref class GeomConvert_Units sealed
    : public RDC::OCC::BaseClass<::GeomConvert_Units>
{
...
public:
    GeomConvert_Units(::GeomConvert_Units* nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_Units>( nativeInstance, true )
    {}

    GeomConvert_Units(::GeomConvert_Units& nativeInstance)
        : RDC::OCC::BaseClass<::GeomConvert_Units>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static RDC::OCC::Geom2d_Curve^ RadianToDegree(RDC::OCC::Geom2d_Curve^ theCurve, RDC::OCC::Geom_Surface^ theSurface, double theLengthFactor, double theFactorRadianDegree);
    /// <summary>
    /// Convert 2d curve for change angle unit from degree to radian
    /// </summary>
    static RDC::OCC::Geom2d_Curve^ DegreeToRadian(RDC::OCC::Geom2d_Curve^ theCurve, RDC::OCC::Geom_Surface^ theSurface, double theLengthFactor, double theFactorRadianDegree);
    /// <summary>
    /// return 2d curve as 'mirror' for given
    /// </summary>
    static RDC::OCC::Geom2d_Curve^ MirrorPCurve(RDC::OCC::Geom2d_Curve^ theCurve);
}; // class GeomConvert_Units
