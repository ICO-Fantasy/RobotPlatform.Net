...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class BRepLib sealed
			: public RDC::OCC::BaseClass<::BRepLib>
		{
		...
		public:
			BRepLib(::BRepLib* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib>(nativeInstance, true)
			{}

			BRepLib(::BRepLib& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			static void Plane(RDC::OCC::Geom_Plane^ P);
			/// <summary>
			/// Returns the current plane.
			/// </summary>
			static RDC::OCC::Geom_Plane^ Plane();
			/// <summary>
			...
			/// </summary>
			static bool CheckSameRange(RDC::OCC::TopoDS_Edge^ E, double Confusion);
			/// <summary>
			/// checks if the Edge is same range IGNORING
			/// the same range flag of the edge
			/// Confusion argument is to compare real numbers
			/// idenpendently of any model space tolerance
			/// </summary>
			static bool CheckSameRange(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			...
			/// </summary>
			static void SameRange(RDC::OCC::TopoDS_Edge^ E, double Tolerance);
			/// <summary>
			/// will make all the curve representation have
			/// the same range domain for the parameters.
			/// This will IGNORE the same range flag value
			...
			/// the all the other curves.
			/// </summary>
			static void SameRange(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			...
			/// </summary>
			static bool BuildCurve3d(RDC::OCC::TopoDS_Edge^ E, double Tolerance, RDC::OCC::GeomAbs_Shape Continuity, int MaxDegree, int MaxSegment);
			/// <summary>
			/// Computes the 3d curve for the edge  <E> if it does
			/// not exist. Returns True  if the curve was computed
			/// or  existed. Returns False  if there is no  planar
			...
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurve3d(RDC::OCC::TopoDS_Edge^ E, double Tolerance, RDC::OCC::GeomAbs_Shape Continuity, int MaxDegree);
			/// <summary>
			/// Computes the 3d curve for the edge  <E> if it does
			/// not exist. Returns True  if the curve was computed
			/// or  existed. Returns False  if there is no  planar
			...
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurve3d(RDC::OCC::TopoDS_Edge^ E, double Tolerance, RDC::OCC::GeomAbs_Shape Continuity);
			/// <summary>
			/// Computes the 3d curve for the edge  <E> if it does
			/// not exist. Returns True  if the curve was computed
			/// or  existed. Returns False  if there is no  planar
			...
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurve3d(RDC::OCC::TopoDS_Edge^ E, double Tolerance);
			/// <summary>
			/// Computes the 3d curve for the edge  <E> if it does
			/// not exist. Returns True  if the curve was computed
			/// or  existed. Returns False  if there is no  planar
			...
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurve3d(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			/// Computes  the 3d curves  for all the  edges of <S>
			/// return False if one of the computation failed.
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurves3d(RDC::OCC::TopoDS_Shape^ S, double Tolerance, RDC::OCC::GeomAbs_Shape Continuity, int MaxDegree, int MaxSegment);
			/// <summary>
			/// Computes  the 3d curves  for all the  edges of <S>
			/// return False if one of the computation failed.
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurves3d(RDC::OCC::TopoDS_Shape^ S, double Tolerance, RDC::OCC::GeomAbs_Shape Continuity, int MaxDegree);
			/// <summary>
			/// Computes  the 3d curves  for all the  edges of <S>
			/// return False if one of the computation failed.
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurves3d(RDC::OCC::TopoDS_Shape^ S, double Tolerance, RDC::OCC::GeomAbs_Shape Continuity);
			/// <summary>
			/// Computes  the 3d curves  for all the  edges of <S>
			/// return False if one of the computation failed.
			/// <MaxSegment> >= 30 in approximation
			/// </summary>
			static bool BuildCurves3d(RDC::OCC::TopoDS_Shape^ S, double Tolerance);
			/// <summary>
			/// Computes  the 3d curves  for all the  edges of <S>
			/// return False if one of the computation failed.
			/// </summary>
			static bool BuildCurves3d(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Builds pcurve of edge on face if the surface is plane, and updates the edge.
			/// </summary>
			static void BuildPCurveForEdgeOnPlane(RDC::OCC::TopoDS_Edge^ theE, RDC::OCC::TopoDS_Face^ theF);
			/// <summary>
			...
			/// </summary>
			static void BuildPCurveForEdgeOnPlane(RDC::OCC::TopoDS_Edge^ theE, RDC::OCC::TopoDS_Face^ theF, RDC::OCC::Geom2d_Curve^ aC2D, bool% bToUpdate);
			/// <summary>
			...
			/// </summary>
			static bool UpdateEdgeTol(RDC::OCC::TopoDS_Edge^ E, double MinToleranceRequest, double MaxToleranceToCheck);
			/// <summary>
			...
			/// </summary>
			static bool UpdateEdgeTolerance(RDC::OCC::TopoDS_Shape^ S, double MinToleranceRequest, double MaxToleranceToCheck);
			/// <summary>
			...
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Edge^ theEdge, double Tolerance);
			/// <summary>
			/// Computes new 2d curve(s)  for the edge <theEdge> to have
			/// the same parameter  as  the  3d curve.
			/// The algorithm is not done if the flag SameParameter
			/// was True  on the  Edge.
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Edge^ theEdge);
			/// <summary>
			/// Computes new 2d curve(s)  for the edge <theEdge> to have
			/// the same parameter  as  the  3d curve.
			/// The algorithm is not done if the flag SameParameter
			...
			/// </summary>
			static RDC::OCC::TopoDS_Edge^ SameParameter(RDC::OCC::TopoDS_Edge^ theEdge, double theTolerance, double% theNewTol, bool IsUseOldEdge);
			/// <summary>
			...
			/// was True  on an  Edge.
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Shape^ S, double Tolerance, bool forced);
			/// <summary>
			/// Computes new 2d curve(s) for all the edges of  <S>
			/// to have the same parameter  as  the  3d curve.
			/// The algorithm is not done if the flag SameParameter
			/// was True  on an  Edge.
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Shape^ S, double Tolerance);
			/// <summary>
			/// Computes new 2d curve(s) for all the edges of  <S>
			/// to have the same parameter  as  the  3d curve.
			/// The algorithm is not done if the flag SameParameter
			/// was True  on an  Edge.
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Computes new 2d curve(s) for all the edges of  <S>
			/// to have the same parameter  as  the  3d curve.
			/// The algorithm is not done if the flag SameParameter
			...
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::BRepTools_ReShape^ theReshaper, double Tolerance, bool forced);
			/// <summary>
			/// Computes new 2d curve(s) for all the edges of  <S>
			/// to have the same parameter  as  the  3d curve.
			/// The algorithm is not done if the flag SameParameter
			...
			/// contain a modified empty-copies of original subshapes as substitutions.
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::BRepTools_ReShape^ theReshaper, double Tolerance);
			/// <summary>
			/// Computes new 2d curve(s) for all the edges of  <S>
			/// to have the same parameter  as  the  3d curve.
			/// The algorithm is not done if the flag SameParameter
			...
			/// contain a modified empty-copies of original subshapes as substitutions.
			/// </summary>
			static void SameParameter(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::BRepTools_ReShape^ theReshaper);
			/// <summary>
			...
			/// </summary>
			static void UpdateTolerances(RDC::OCC::TopoDS_Shape^ S, bool verifyFaceTolerance);
			/// <summary>
			/// Replaces tolerance   of  FACE EDGE VERTEX  by  the
			/// tolerance Max of their connected handling shapes.
			/// It is not necessary to use this call after
			/// SameParameter. (called in)
			/// </summary>
			static void UpdateTolerances(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Replaces tolerance   of  FACE EDGE VERTEX  by  the
			/// tolerance Max of their connected handling shapes.
			/// It is not necessary to use this call after
			...
			/// contain a modified empty-copies of original subshapes as substitutions.
			/// </summary>
			static void UpdateTolerances(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::BRepTools_ReShape^ theReshaper, bool verifyFaceTolerance);
			/// <summary>
			/// Replaces tolerance   of  FACE EDGE VERTEX  by  the
			/// tolerance Max of their connected handling shapes.
			/// It is not necessary to use this call after
			...
			/// contain a modified empty-copies of original subshapes as substitutions.
			/// </summary>
			static void UpdateTolerances(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::BRepTools_ReShape^ theReshaper);
			/// <summary>
			...
			/// </summary>
			static void UpdateInnerTolerances(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			...
			/// </summary>
			static bool OrientClosedSolid(RDC::OCC::TopoDS_Solid^ solid);
			/// <summary>
			/// Returns the order of continuity between two faces
			/// connected by an edge
			/// </summary>
			static RDC::OCC::GeomAbs_Shape ContinuityOfFaces(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace1, RDC::OCC::TopoDS_Face^ theFace2, double theAngleTol);
			/// <summary>
			...
			/// is done.
			/// </summary>
			static void EncodeRegularity(RDC::OCC::TopoDS_Shape^ S, double TolAng);
			/// <summary>
			/// Encodes the Regularity of edges on a Shape.
			/// Warning: <TolAng> is an angular tolerance, expressed in Rad.
			/// Warning: If the edges's regularity are coded before, nothing
			/// is done.
			/// </summary>
			static void EncodeRegularity(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			...
			/// is done.
			/// </summary>
			static void EncodeRegularity(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ LE, double TolAng);
			/// <summary>
			/// Encodes the Regularity of edges in list <LE> on the shape <S>
			/// Warning: <TolAng> is an angular tolerance, expressed in Rad.
			/// Warning: If the edges's regularity are coded before, nothing
			/// is done.
			/// </summary>
			static void EncodeRegularity(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ LE);
			/// <summary>
			...
			/// is done.
			/// </summary>
			static void EncodeRegularity(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F1, RDC::OCC::TopoDS_Face^ F2, double TolAng);
			/// <summary>
			/// Encodes the Regularity between <F1> and <F2> by <E>
			/// Warning: <TolAng> is an angular tolerance, expressed in Rad.
			/// Warning: If the edge's regularity is coded before, nothing
			/// is done.
			/// </summary>
			static void EncodeRegularity(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F1, RDC::OCC::TopoDS_Face^ F2);
			/// <summary>
			/// Sorts in  LF the Faces of   S on the  complexity of
			/// their                  surfaces
			/// (Plane,Cylinder,Cone,Sphere,Torus,other)
			/// </summary>
			static void SortFaces(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ LF);
			/// <summary>
			/// Sorts in  LF  the   Faces  of S   on the reverse
			/// complexity       of       their      surfaces
			/// (other,Torus,Sphere,Cone,Cylinder,Plane)
			/// </summary>
			static void ReverseSortFaces(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopTools_ListOfShape^ LF);
			/// <summary>
			...
			/// </summary>
			static bool EnsureNormalConsistency(RDC::OCC::TopoDS_Shape^ S, double theAngTol, bool ForceComputeNormals);
			/// <summary>
			/// Corrects the normals in Poly_Triangulation of faces,
			/// in such way that normals at nodes lying along smooth
			/// edges have the same value on both adjacent triangulations.
			/// Returns TRUE if any correction is done.
			/// </summary>
			static bool EnsureNormalConsistency(RDC::OCC::TopoDS_Shape^ S, double theAngTol);
			/// <summary>
			/// Corrects the normals in Poly_Triangulation of faces,
			/// in such way that normals at nodes lying along smooth
			/// edges have the same value on both adjacent triangulations.
			...
			/// other vertices.
			/// </summary>
			static void BoundingVertex(RDC::OCC::TopoDS_ListOfShape^ theLV, RDC::OCC::Pnt% theNewCenter, double% theNewTol);
			/// <summary>
			...
			/// </summary>
			static bool FindValidRange(RDC::OCC::Adaptor3d_Curve^ theCurve, double theTolE, double theParV1, RDC::OCC::Pnt thePntV1, double theTolV1, double theParV2, RDC::OCC::Pnt thePntV2, double theTolV2, double% theFirst, double% theLast);
			/// <summary>
			/// Finds a range of 3d curve of the edge not covered by vertices tolerances.
			/// Returns false if there is no such range. Otherwise, sets theFirst and
			/// theLast as its bounds.
			/// </summary>
			static bool FindValidRange(RDC::OCC::TopoDS_Edge^ theEdge, double% theFirst, double% theLast);
			/// <summary>
			...
			/// </param>
			static void ExtendFace(RDC::OCC::TopoDS_Face^ theF, double theExtVal, bool theExtUMin, bool theExtUMax, bool theExtVMin, bool theExtVMax, RDC::OCC::TopoDS_Face^ theFExtended);
		}; // class BRepLib
		...
		public ref class BRepLib_CheckCurveOnSurface sealed
			: public RDC::OCC::BaseClass<::BRepLib_CheckCurveOnSurface>
		{
		...
		public:
			BRepLib_CheckCurveOnSurface(::BRepLib_CheckCurveOnSurface* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_CheckCurveOnSurface>(nativeInstance, true)
			{}

			BRepLib_CheckCurveOnSurface(::BRepLib_CheckCurveOnSurface& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_CheckCurveOnSurface>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// Constructor
			/// </summary>
			BRepLib_CheckCurveOnSurface(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace);
			/// <summary>
			/// Sets the data for the algorithm
			/// </summary>
			void Init(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace);
			/// <summary>
		...
		public ref class BRepLib_Command
			: public RDC::OCC::BaseClass<::BRepLib_Command>
		{
		...
		protected:
			BRepLib_Command(InitMode init)
				: RDC::OCC::BaseClass<::BRepLib_Command>(init)
			{}

		public:
			BRepLib_Command(::BRepLib_Command* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_Command>(nativeInstance, true)
			{}

			BRepLib_Command(::BRepLib_Command& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_Command>(&nativeInstance, false)
			{}
		...
		public ref class BRepLib_FindSurface sealed
			: public RDC::OCC::BaseClass<::BRepLib_FindSurface>
		{
		...
		public:
			BRepLib_FindSurface(::BRepLib_FindSurface* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_FindSurface>(nativeInstance, true)
			{}

			BRepLib_FindSurface(::BRepLib_FindSurface& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_FindSurface>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			BRepLib_FindSurface(RDC::OCC::TopoDS_Shape^ S, double Tol, bool OnlyPlane, bool OnlyClosed);
			/// <summary>
			/// Computes the Surface from the edges of  <S> with the
			/// given tolerance.
			/// if <OnlyPlane> is true, the computed surface will be
			...
			/// closed in 2D, will be ignored.
			/// </summary>
			BRepLib_FindSurface(RDC::OCC::TopoDS_Shape^ S, double Tol, bool OnlyPlane);
			/// <summary>
			/// Computes the Surface from the edges of  <S> with the
			/// given tolerance.
			/// if <OnlyPlane> is true, the computed surface will be
			...
			/// closed in 2D, will be ignored.
			/// </summary>
			BRepLib_FindSurface(RDC::OCC::TopoDS_Shape^ S, double Tol);
			/// <summary>
			/// Computes the Surface from the edges of  <S> with the
			/// given tolerance.
			/// if <OnlyPlane> is true, the computed surface will be
			...
			/// closed in 2D, will be ignored.
			/// </summary>
			BRepLib_FindSurface(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Computes the Surface from the edges of  <S> with the
			/// given tolerance.
			/// if <OnlyPlane> is true, the computed surface will be
			...
			/// closed in 2D, will be ignored.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ S, double Tol, bool OnlyPlane, bool OnlyClosed);
			/// <summary>
			/// Computes the Surface from the edges of  <S> with the
			/// given tolerance.
			/// if <OnlyPlane> is true, the computed surface will be
			...
			/// closed in 2D, will be ignored.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ S, double Tol, bool OnlyPlane);
			/// <summary>
			/// Computes the Surface from the edges of  <S> with the
			/// given tolerance.
			/// if <OnlyPlane> is true, the computed surface will be
			...
			/// closed in 2D, will be ignored.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ S, double Tol);
			/// <summary>
			/// Computes the Surface from the edges of  <S> with the
			/// given tolerance.
			/// if <OnlyPlane> is true, the computed surface will be
			...
			/// closed in 2D, will be ignored.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Shape^ S);
			bool Found();
		...
		public ref class BRepLib_FuseEdges sealed
			: public RDC::OCC::BaseClass<::BRepLib_FuseEdges>
		{
		...
		public:
			BRepLib_FuseEdges(::BRepLib_FuseEdges* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_FuseEdges>(nativeInstance, true)
			{}

			BRepLib_FuseEdges(::BRepLib_FuseEdges& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_FuseEdges>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// of ancestors.
			/// </summary>
			BRepLib_FuseEdges(RDC::OCC::TopoDS_Shape^ theShape, bool PerformNow);
			/// <summary>
			/// Initialise members  and build  construction of map
			/// of ancestors.
			/// </summary>
			BRepLib_FuseEdges(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// set edges to avoid being fused
			/// </summary>
			void AvoidEdges(RDC::OCC::TopTools_IndexedMapOfShape^ theMapEdg);
			/// <summary>
			...
			/// that can be fused.
			/// </summary>
			void Edges(RDC::OCC::TopTools_DataMapOfIntegerListOfShape^ theMapLstEdg);
			/// <summary>
			...
			/// </summary>
			void ResultEdges(RDC::OCC::TopTools_DataMapOfIntegerShape^ theMapEdg);
			/// <summary>
			/// returns the map of modified faces.
			/// </summary>
			void Faces(RDC::OCC::TopTools_DataMapOfShapeShape^ theMapFac);
			/// <summary>
		...
		public ref class BRepLib_MakeShape
			: public RDC::OCC::BRepLib_Command
		{
		...
		protected:
			BRepLib_MakeShape(InitMode init)
				: RDC::OCC::BRepLib_Command(init)
			{}

		public:
			BRepLib_MakeShape(::BRepLib_MakeShape* nativeInstance)
				: RDC::OCC::BRepLib_Command(nativeInstance)
			{}
		...
		public:
			...
			/// the shape creation.
			/// </summary>
			RDC::OCC::BRepLib_ShapeModification FaceStatus(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Returns True if the Face generates new topology.
			/// </summary>
			bool HasDescendants(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// returns the list of generated Faces.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ DescendantFaces(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ NewFaces(int I);
			/// <summary>
			/// returns a list of the created faces
			/// from the edge <E>.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ FacesFromEdges(RDC::OCC::TopoDS_Edge^ E);
		}; // class BRepLib_MakeShape
		...
		public ref class BRepLib_MakeEdge sealed
			: public RDC::OCC::BRepLib_MakeShape
		{
		...
		public:
			BRepLib_MakeEdge(::BRepLib_MakeEdge* nativeInstance)
				: RDC::OCC::BRepLib_MakeShape(nativeInstance)
			{}
		...
		public:
			BRepLib_MakeEdge();
			BRepLib_MakeEdge(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::gp_Lin^ L);
			BRepLib_MakeEdge(RDC::OCC::gp_Lin^ L, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::gp_Lin^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::gp_Lin^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::gp_Circ^ L);
			BRepLib_MakeEdge(RDC::OCC::gp_Circ^ L, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::gp_Circ^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::gp_Circ^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::gp_Elips^ L);
			BRepLib_MakeEdge(RDC::OCC::gp_Elips^ L, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::gp_Elips^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::gp_Elips^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::gp_Hypr^ L);
			BRepLib_MakeEdge(RDC::OCC::gp_Hypr^ L, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::gp_Hypr^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::gp_Hypr^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::gp_Parab^ L);
			BRepLib_MakeEdge(RDC::OCC::gp_Parab^ L, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::gp_Parab^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::gp_Parab^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::Geom_Curve^ L);
			BRepLib_MakeEdge(RDC::OCC::Geom_Curve^ L, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S);
			BRepLib_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double p1, double p2);
			BRepLib_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			void Init(RDC::OCC::Geom_Curve^ C);
			void Init(RDC::OCC::Geom_Curve^ C, double p1, double p2);
			void Init(RDC::OCC::Geom_Curve^ C, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			void Init(RDC::OCC::Geom_Curve^ C, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			void Init(RDC::OCC::Geom_Curve^ C, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double p1, double p2);
			void Init(RDC::OCC::Geom_Curve^ C, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Geom_Surface^ S);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Geom_Surface^ S, double p1, double p2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Geom_Surface^ S, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Geom_Surface^ S, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double p1, double p2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			/// <summary>
			/// Returns the error description when NotDone.
			/// </summary>
			RDC::OCC::BRepLib_EdgeError Error();
			RDC::OCC::TopoDS_Edge^ Edge();
			/// <summary>
			/// Returns the first vertex of the edge. May be Null.
			/// </summary>
			RDC::OCC::TopoDS_Vertex^ Vertex1();
			/// <summary>
			/// Returns the second vertex of the edge. May be Null.
			/// </summary>
			RDC::OCC::TopoDS_Vertex^ Vertex2();
		}; // class BRepLib_MakeEdge
		...
		public:
			BRepLib_MakeEdge2d(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge2d(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Lin2d^ L);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Lin2d^ L, double p1, double p2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Lin2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Lin2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Circ2d^ L);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Circ2d^ L, double p1, double p2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Circ2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Circ2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Elips2d^ L);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Elips2d^ L, double p1, double p2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Elips2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Elips2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L, double p1, double p2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Parab2d^ L);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Parab2d^ L, double p1, double p2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Parab2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepLib_MakeEdge2d(RDC::OCC::gp_Parab2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L);
			BRepLib_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, double p1, double p2);
			BRepLib_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepLib_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2, double p1, double p2);
			BRepLib_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			void Init(RDC::OCC::Geom2d_Curve^ C);
			void Init(RDC::OCC::Geom2d_Curve^ C, double p1, double p2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2, double p1, double p2);
			void Init(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			/// <summary>
			/// Returns the error description when NotDone.
			/// </summary>
			RDC::OCC::BRepLib_EdgeError Error();
		...
		public:
			...
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Make a face from a plane.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Pln P);
			/// <summary>
			/// Make a face from a cylinder.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cylinder^ C);
			/// <summary>
			/// Make a face from a cone.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cone^ C);
			/// <summary>
			/// Make a face from a sphere.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Sphere^ S);
			/// <summary>
			/// Make a face from a torus.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Torus^ C);
			/// <summary>
			/// Make a face from a Surface. Accepts tolerance value (TolDegen)
			/// for resolution of degenerated edges.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Geom_Surface^ S, double TolDegen);
			/// <summary>
			/// Make a face from a plane.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Pln P, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a cylinder.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cylinder^ C, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a cone.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cone^ C, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a sphere.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Sphere^ S, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a torus.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Torus^ C, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			...
			/// for resolution of degenerated edges.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax, double TolDegen);
			/// <summary>
			...
			/// flag NotDone will be set.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::TopoDS_Wire^ W, bool OnlyPlane);
			/// <summary>
			/// Find a surface from the wire and make a face.
			/// if <OnlyPlane> is true, the computed surface will be
			/// a plane. If it is not possible to find a plane, the
			/// flag NotDone will be set.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a plane and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Pln P, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a plane and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Pln P, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a cylinder and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cylinder^ C, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a cylinder and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cylinder^ C, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a cone and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cone^ C, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a cone and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Cone^ C, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a sphere and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Sphere^ S, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a sphere and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Sphere^ S, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a torus and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Torus^ C, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a torus and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::gp_Torus^ C, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a Surface and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a Surface and a wire.
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Adds the wire <W> in the face <F>
			/// </summary>
			BRepLib_MakeFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Load the face.
			/// </summary>
			void Init(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			...
			/// </summary>
			void Init(RDC::OCC::Geom_Surface^ S, bool Bound, double TolDegen);
			/// <summary>
			/// Creates the face from the surface and the min-max
			/// values. Accepts tolerance value (TolDegen) for resolution
			/// of degenerated edges.
			/// </summary>
			void Init(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax, double TolDegen);
			/// <summary>
			/// Adds the wire <W> in the current face.
			/// </summary>
			void Add(RDC::OCC::TopoDS_Wire^ W);
			RDC::OCC::BRepLib_FaceError Error();
			/// <summary>
			...
			/// </summary>
			static bool IsDegenerated(RDC::OCC::Geom_Curve^ theCurve, double theMaxTol, double% theActTol);
		}; // class BRepLib_MakeFace
		...
		public:
			...
			/// </summary>
			BRepLib_MakePolygon();
			BRepLib_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepLib_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3, bool Close);
			BRepLib_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3);
			BRepLib_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3, RDC::OCC::Pnt P4, bool Close);
			BRepLib_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3, RDC::OCC::Pnt P4);
			BRepLib_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepLib_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3, bool Close);
			BRepLib_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3);
			BRepLib_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3, RDC::OCC::TopoDS_Vertex^ V4, bool Close);
			BRepLib_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3, RDC::OCC::TopoDS_Vertex^ V4);
			void Add(RDC::OCC::Pnt P);
			void Add(RDC::OCC::TopoDS_Vertex^ V);
			/// <summary>
			...
			bool Added();
			void Close();
			RDC::OCC::TopoDS_Vertex^ FirstVertex();
			RDC::OCC::TopoDS_Vertex^ LastVertex();
			/// <summary>
		...
		public:
			...
			/// </summary>
			BRepLib_MakeShell();
			BRepLib_MakeShell(RDC::OCC::Geom_Surface^ S, bool Segment);
			BRepLib_MakeShell(RDC::OCC::Geom_Surface^ S);
			BRepLib_MakeShell(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax, bool Segment);
			BRepLib_MakeShell(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Creates the shell from the surface  and the min-max
			/// values.
			/// </summary>
			void Init(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax, bool Segment);
			/// <summary>
			/// Creates the shell from the surface  and the min-max
			/// values.
			/// </summary>
			void Init(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax);
			RDC::OCC::BRepLib_ShellError Error();
			/// <summary>
		...
		public:
			...
			/// </summary>
			BRepLib_MakeSolid(RDC::OCC::TopoDS_CompSolid^ S);
			/// <summary>
			/// Make a solid from a shell.
			/// </summary>
			BRepLib_MakeSolid(RDC::OCC::TopoDS_Shell^ S);
			/// <summary>
			/// Make a solid from two shells.
			/// </summary>
			BRepLib_MakeSolid(RDC::OCC::TopoDS_Shell^ S1, RDC::OCC::TopoDS_Shell^ S2);
			/// <summary>
			/// Make a solid from three shells.
			/// </summary>
			BRepLib_MakeSolid(RDC::OCC::TopoDS_Shell^ S1, RDC::OCC::TopoDS_Shell^ S2, RDC::OCC::TopoDS_Shell^ S3);
			/// <summary>
			/// Make a solid from a solid. Useful for adding later.
			/// </summary>
			BRepLib_MakeSolid(RDC::OCC::TopoDS_Solid^ So);
			/// <summary>
			/// Add a shell to a solid.
			/// </summary>
			BRepLib_MakeSolid(RDC::OCC::TopoDS_Solid^ So, RDC::OCC::TopoDS_Shell^ S);
			/// <summary>
			/// Add the shell to the current solid.
			/// </summary>
			void Add(RDC::OCC::TopoDS_Shell^ S);
			/// <summary>
		...
		public:
			BRepLib_MakeVertex(RDC::OCC::Pnt P);
		...
		public:
			...
			/// </summary>
			BRepLib_MakeWire(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			/// Make a Wire from two edges.
			/// </summary>
			BRepLib_MakeWire(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
			/// <summary>
			/// Make a Wire from three edges.
			/// </summary>
			BRepLib_MakeWire(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, RDC::OCC::TopoDS_Edge^ E3);
			/// <summary>
			/// Make a Wire from four edges.
			/// </summary>
			BRepLib_MakeWire(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, RDC::OCC::TopoDS_Edge^ E3, RDC::OCC::TopoDS_Edge^ E4);
			/// <summary>
			/// Make a Wire from a Wire. Useful for adding later.
			/// </summary>
			BRepLib_MakeWire(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Add an edge to a wire.
			/// </summary>
			BRepLib_MakeWire(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			/// Add the edge <E> to the current wire.
			/// </summary>
			void Add(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			...
			/// </summary>
			void Add(RDC::OCC::TopTools_ListOfShape^ L);
			RDC::OCC::BRepLib_WireError Error();
			/// <summary>
		...
		public ref class BRepLib_PointCloudShape
			: public RDC::OCC::BaseClass<::BRepLib_PointCloudShape>
		{
		...
		public:
			BRepLib_PointCloudShape(::BRepLib_PointCloudShape* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_PointCloudShape>(nativeInstance, true)
			{}

			BRepLib_PointCloudShape(::BRepLib_PointCloudShape& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_PointCloudShape>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			BRepLib_PointCloudShape(RDC::OCC::TopoDS_Shape^ theShape, double theTol);
			/// <summary>
			/// Constructor initialized by shape
			/// </summary>
			BRepLib_PointCloudShape(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// Constructor initialized by shape
			/// </summary>
		...
		public ref class BRepLib_ToolTriangulatedShape sealed
			: public RDC::OCC::BaseClass<::BRepLib_ToolTriangulatedShape>
		{
		...
		public:
			BRepLib_ToolTriangulatedShape(::BRepLib_ToolTriangulatedShape* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_ToolTriangulatedShape>(nativeInstance, true)
			{}

			BRepLib_ToolTriangulatedShape(::BRepLib_ToolTriangulatedShape& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_ToolTriangulatedShape>(&nativeInstance, false)
			{}
		...
		public ref class BRepLib_ValidateEdge sealed
			: public RDC::OCC::BaseClass<::BRepLib_ValidateEdge>
		{
		...
		public:
			BRepLib_ValidateEdge(::BRepLib_ValidateEdge* nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_ValidateEdge>(nativeInstance, true)
			{}

			BRepLib_ValidateEdge(::BRepLib_ValidateEdge& nativeInstance)
				: RDC::OCC::BaseClass<::BRepLib_ValidateEdge>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			BRepLib_ValidateEdge(RDC::OCC::Adaptor3d_Curve^ theReferenceCurve, RDC::OCC::Adaptor3d_CurveOnSurface^ theOtherCurve, bool theSameParameter);
			/// <summary>
