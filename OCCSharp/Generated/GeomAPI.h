...
public ref class GeomAPI sealed
    : public RDC::OCC::BaseClass<::GeomAPI>
{
...
public:
    GeomAPI(::GeomAPI* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI>( nativeInstance, true )
    {}

    GeomAPI(::GeomAPI& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static RDC::OCC::Geom2d_Curve^ To2d(RDC::OCC::Geom_Curve^ C, RDC::OCC::Pln P);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Geom_Curve^ To3d(RDC::OCC::Geom2d_Curve^ C, RDC::OCC::Pln P);
}; // class GeomAPI
...
public ref class GeomAPI_ExtremaCurveCurve sealed
    : public RDC::OCC::BaseClass<::GeomAPI_ExtremaCurveCurve>
{
...
public:
    GeomAPI_ExtremaCurveCurve(::GeomAPI_ExtremaCurveCurve* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ExtremaCurveCurve>( nativeInstance, true )
    {}

    GeomAPI_ExtremaCurveCurve(::GeomAPI_ExtremaCurveCurve& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ExtremaCurveCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomAPI_ExtremaCurveCurve(RDC::OCC::Geom_Curve^ C1, RDC::OCC::Geom_Curve^ C2);
    /// <summary>
    ...
    /// </summary>
    GeomAPI_ExtremaCurveCurve(RDC::OCC::Geom_Curve^ C1, RDC::OCC::Geom_Curve^ C2, double U1min, double U1max, double U2min, double U2max);
    /// <summary>
    /// Initializes this algorithm with the given arguments
    /// and computes the extrema between the curves C1 and C2
    /// </summary>
    void Init(RDC::OCC::Geom_Curve^ C1, RDC::OCC::Geom_Curve^ C2);
    /// <summary>
    /// Initializes this algorithm with the given arguments
    ...
    /// of solutions. If this algorithm fails, NbExtrema returns 0.
    /// </summary>
    void Init(RDC::OCC::Geom_Curve^ C1, RDC::OCC::Geom_Curve^ C2, double U1min, double U1max, double U2min, double U2max);
    /// <summary>
    ...
    /// </summary>
    void Points(int Index, RDC::OCC::Pnt% P1, RDC::OCC::Pnt% P2);
    /// <summary>
    ...
    /// </summary>
    void NearestPoints(RDC::OCC::Pnt% P1, RDC::OCC::Pnt% P2);
    /// <summary>
    /// Returns the parameters U1 of the point on the first
    /// curve and U2 of the point on the second curve, which
    ...
    /// </summary>
    bool TotalNearestPoints(RDC::OCC::Pnt% P1, RDC::OCC::Pnt% P2);
    /// <summary>
...
public ref class GeomAPI_ExtremaCurveSurface sealed
    : public RDC::OCC::BaseClass<::GeomAPI_ExtremaCurveSurface>
{
...
public:
    GeomAPI_ExtremaCurveSurface(::GeomAPI_ExtremaCurveSurface* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ExtremaCurveSurface>( nativeInstance, true )
    {}

    GeomAPI_ExtremaCurveSurface(::GeomAPI_ExtremaCurveSurface& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ExtremaCurveSurface>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomAPI_ExtremaCurveSurface(RDC::OCC::Geom_Curve^ Curve, RDC::OCC::Geom_Surface^ Surface);
    /// <summary>
    /// Computes  the  extrema  distances  between  the
    ...
    /// of solutions. If this algorithm fails, NbExtrema returns 0.
    /// </summary>
    GeomAPI_ExtremaCurveSurface(RDC::OCC::Geom_Curve^ Curve, RDC::OCC::Geom_Surface^ Surface, double Wmin, double Wmax, double Umin, double Umax, double Vmin, double Vmax);
    /// <summary>
    /// Computes  the  extrema  distances  between  the
    /// curve <C> and the surface  <S>.
    /// </summary>
    void Init(RDC::OCC::Geom_Curve^ Curve, RDC::OCC::Geom_Surface^ Surface);
    /// <summary>
    /// Computes  the  extrema  distances  between  the
    /// curve <C>  and the  surface  <S>.  The solution
    /// point are computed in the domain [Wmin,Wmax] of
    ...
    /// of solutions. If this algorithm fails, NbExtrema returns 0.
    /// </summary>
    void Init(RDC::OCC::Geom_Curve^ Curve, RDC::OCC::Geom_Surface^ Surface, double Wmin, double Wmax, double Umin, double Umax, double Vmin, double Vmax);
    /// <summary>
    /// Returns the number of extrema computed by this algorithm.
    /// Note: if this algorithm fails, NbExtrema returns 0.
    /// </summary>
    ...
    /// Exceptions - StdFail_NotDone if this algorithm fails.
    /// </summary>
    void NearestPoints(RDC::OCC::Pnt% PC, RDC::OCC::Pnt% PS);
    /// <summary>
    /// Returns the parameters W of the point on the curve
    /// and (U,V) of the point on the surface, which are the
...
public ref class GeomAPI_ExtremaSurfaceSurface sealed
    : public RDC::OCC::BaseClass<::GeomAPI_ExtremaSurfaceSurface>
{
...
public:
    GeomAPI_ExtremaSurfaceSurface(::GeomAPI_ExtremaSurfaceSurface* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ExtremaSurfaceSurface>( nativeInstance, true )
    {}

    GeomAPI_ExtremaSurfaceSurface(::GeomAPI_ExtremaSurfaceSurface& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ExtremaSurfaceSurface>( &nativeInstance, false )
    {}
...
public:
    ...
    /// surfaces <S1>  and <S2>
    /// </summary>
    GeomAPI_ExtremaSurfaceSurface(RDC::OCC::Geom_Surface^ S1, RDC::OCC::Geom_Surface^ S2);
    /// <summary>
    ...
    /// </summary>
    GeomAPI_ExtremaSurfaceSurface(RDC::OCC::Geom_Surface^ S1, RDC::OCC::Geom_Surface^ S2, double U1min, double U1max, double V1min, double V1max, double U2min, double U2max, double V2min, double V2max);
    /// <summary>
    /// Initializes this algorithm with the given arguments
    /// and computes  the  extrema  distances  between  the
    /// surfaces <S1>  and <S2>
    /// </summary>
    void Init(RDC::OCC::Geom_Surface^ S1, RDC::OCC::Geom_Surface^ S2);
    /// <summary>
    /// Initializes this algorithm with the given arguments
    ...
    /// </summary>
    void Init(RDC::OCC::Geom_Surface^ S1, RDC::OCC::Geom_Surface^ S2, double U1min, double U1max, double V1min, double V1max, double U2min, double U2max, double V2min, double V2max);
    /// <summary>
    /// Returns the number of extrema computed by this algorithm.
    /// Note: if this algorithm fails, NbExtrema returns 0.
    /// </summary>
...
public ref class GeomAPI_IntCS sealed
    : public RDC::OCC::BaseClass<::GeomAPI_IntCS>
{
...
public:
    GeomAPI_IntCS(::GeomAPI_IntCS* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_IntCS>( nativeInstance, true )
    {}

    GeomAPI_IntCS(::GeomAPI_IntCS& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_IntCS>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomAPI_IntCS(RDC::OCC::Geom_Curve^ C, RDC::OCC::Geom_Surface^ S);
    /// <summary>
    ...
    /// Use function IsDone to verify that the intersections are computed successfully.
    /// </summary>
    void Perform(RDC::OCC::Geom_Curve^ C, RDC::OCC::Geom_Surface^ S);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom_Curve^ Segment(int Index);
    /// <summary>
...
public ref class GeomAPI_Interpolate sealed
    : public RDC::OCC::BaseClass<::GeomAPI_Interpolate>
{
...
public:
    GeomAPI_Interpolate(::GeomAPI_Interpolate* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_Interpolate>( nativeInstance, true )
    {}

    GeomAPI_Interpolate(::GeomAPI_Interpolate& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_Interpolate>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomAPI_Interpolate(RDC::OCC::TColgp_HArray1OfPnt^ Points, bool PeriodicFlag, double Tolerance);
    /// <summary>
    /// Initializes an algorithm for constructing a
    ...
    /// Points and Parameters are not respected.
    /// </summary>
    GeomAPI_Interpolate(RDC::OCC::TColgp_HArray1OfPnt^ Points, RDC::OCC::TColStd_HArray1OfReal^ Parameters, bool PeriodicFlag, double Tolerance);
    /// <summary>
    ...
    /// </summary>
    void Load(RDC::OCC::Vec InitialTangent, RDC::OCC::Vec FinalTangent, bool Scale);
    /// <summary>
    /// Assigns this constrained BSpline curve to be
    /// tangential to vectors InitialTangent and FinalTangent
    /// at its first and last points respectively (i.e.
    ...
    /// defined at the time of initialization).
    /// </summary>
    void Load(RDC::OCC::Vec InitialTangent, RDC::OCC::Vec FinalTangent);
    /// <summary>
    /// Assigns this constrained BSpline curve to be
    ...
    /// </summary>
    void Load(RDC::OCC::TColgp_Array1OfVec^ Tangents, RDC::OCC::TColStd_HArray1OfBoolean^ TangentFlags, bool Scale);
    /// <summary>
    /// Assigns this constrained BSpline curve to be
    /// tangential to vectors defined in the table Tangents,
    /// which is parallel to the table of points
    ...
    /// are set as tangency constraints.
    /// </summary>
    void Load(RDC::OCC::TColgp_Array1OfVec^ Tangents, RDC::OCC::TColStd_HArray1OfBoolean^ TangentFlags);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom_BSplineCurve^ Curve();
    /// <summary>
...
public ref class GeomAPI_IntSS sealed
    : public RDC::OCC::BaseClass<::GeomAPI_IntSS>
{
...
public:
    GeomAPI_IntSS(::GeomAPI_IntSS* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_IntSS>( nativeInstance, true )
    {}

    GeomAPI_IntSS(::GeomAPI_IntSS& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_IntSS>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomAPI_IntSS(RDC::OCC::Geom_Surface^ S1, RDC::OCC::Geom_Surface^ S2, double Tol);
    /// <summary>
    ...
    /// </summary>
    void Perform(RDC::OCC::Geom_Surface^ S1, RDC::OCC::Geom_Surface^ S2, double Tol);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::Geom_Curve^ Line(int Index);
}; // class GeomAPI_IntSS
...
public ref class GeomAPI_PointsToBSpline sealed
    : public RDC::OCC::BaseClass<::GeomAPI_PointsToBSpline>
{
...
public:
    GeomAPI_PointsToBSpline(::GeomAPI_PointsToBSpline* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_PointsToBSpline>( nativeInstance, true )
    {}

    GeomAPI_PointsToBSpline(::GeomAPI_PointsToBSpline& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_PointsToBSpline>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points);
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    ...
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    GeomAPI_PointsToBSpline(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, int DegMin);
    /// <summary>
    /// Approximate  a BSpline  Curve passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points);
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin, int DegMax);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters, int DegMin);
    /// <summary>
    /// Approximate  a  BSpline  Curve  passing through an
    /// array of Point,  which parameters are given by the
    /// array <Parameters>.
    ...
    /// BSpline will be lower to Tol3D
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, RDC::OCC::TColStd_Array1OfReal^ Parameters);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax);
    /// <summary>
    /// Approximate a BSpline Curve  passing through an
    /// array of Point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion
    /// </summary>
    void Init(RDC::OCC::TColgp_Array1OfPnt^ Points, double Weight1, double Weight2, double Weight3);
    /// <summary>
    /// Returns the computed BSpline curve.
...
public ref class GeomAPI_PointsToBSplineSurface sealed
    : public RDC::OCC::BaseClass<::GeomAPI_PointsToBSplineSurface>
{
...
public:
    GeomAPI_PointsToBSplineSurface(::GeomAPI_PointsToBSplineSurface* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_PointsToBSplineSurface>( nativeInstance, true )
    {}

    GeomAPI_PointsToBSplineSurface(::GeomAPI_PointsToBSplineSurface& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_PointsToBSplineSurface>( &nativeInstance, false )
    {}
...
public:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin, int DegMax);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points);
    ...
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  points using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  points using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  points using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin, int DegMax);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    GeomAPI_PointsToBSplineSurface(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin, int DegMax);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, int DegMin);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// BSpline will be lower to Tol3D.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points);
    /// <summary>
    ...
    /// </summary>
    void Interpolate(RDC::OCC::TColgp_Array2OfPnt^ Points, bool thePeriodic);
    /// <summary>
    /// Interpolates  a BSpline Surface passing  through  an
    /// array of  Point.  The resulting BSpline will  have
    /// the following properties:
    ...
    /// 2- his  continuity will be  C2.
    /// </summary>
    void Interpolate(RDC::OCC::TColgp_Array2OfPnt^ Points);
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    void Init(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    void Init(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    void Init(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin, int DegMax);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    void Init(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY, int DegMin);
    /// <summary>
    /// Approximates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    void Init(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY);
    /// <summary>
    /// Interpolates  a BSpline  Surface passing  through  an
    /// array of  Points.
    /// 
    ...
    /// S->Value( U, V) = gp_Pnt( U, V, Z(U,V) );
    /// </summary>
    void Interpolate(RDC::OCC::TColStd_Array2OfReal^ ZPoints, double X0, double dX, double Y0, double dY);
    ...
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity, double Tol3D);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax, RDC::OCC::GeomAbs_Shape Continuity);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3, int DegMax);
    /// <summary>
    /// Approximates  a BSpline Surface passing  through  an
    /// array of  point using variational smoothing algorithm,
    /// which tries to minimize additional criterium:
    /// Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
    /// </summary>
    void Init(RDC::OCC::TColgp_Array2OfPnt^ Points, double Weight1, double Weight2, double Weight3);
    /// <summary>
    /// Returns the approximate BSpline Surface
    /// </summary>
    RDC::OCC::Geom_BSplineSurface^ Surface();
    bool IsDone();
}; // class GeomAPI_PointsToBSplineSurface
...
public ref class GeomAPI_ProjectPointOnCurve sealed
    : public RDC::OCC::BaseClass<::GeomAPI_ProjectPointOnCurve>
{
...
public:
    GeomAPI_ProjectPointOnCurve(::GeomAPI_ProjectPointOnCurve* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ProjectPointOnCurve>( nativeInstance, true )
    {}

    GeomAPI_ProjectPointOnCurve(::GeomAPI_ProjectPointOnCurve& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ProjectPointOnCurve>( &nativeInstance, false )
    {}
...
public:
    ...
    /// <Curve>
    /// </summary>
    GeomAPI_ProjectPointOnCurve(RDC::OCC::Pnt P, RDC::OCC::Geom_Curve^ Curve);
    /// <summary>
    /// Create  the projection  of a point <P>  on a curve
    /// <Curve> limited by the two points of parameter Umin and Usup.
    /// </summary>
    GeomAPI_ProjectPointOnCurve(RDC::OCC::Pnt P, RDC::OCC::Geom_Curve^ Curve, double Umin, double Usup);
    /// <summary>
    /// Init the projection  of a  point  <P> on a curve
    /// <Curve>
    /// </summary>
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Curve^ Curve);
    /// <summary>
    /// Init  the  projection  of a  point <P>  on a curve
    /// <Curve> limited by the two points of parameter Umin and Usup.
    /// </summary>
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Curve^ Curve, double Umin, double Usup);
    /// <summary>
    /// Init  the  projection  of a  point <P>  on a curve
    /// <Curve> limited by the two points of parameter Umin and Usup.
    /// </summary>
    void Init(RDC::OCC::Geom_Curve^ Curve, double Umin, double Usup);
    /// <summary>
...
public ref class GeomAPI_ProjectPointOnSurf sealed
    : public RDC::OCC::BaseClass<::GeomAPI_ProjectPointOnSurf>
{
...
public:
    GeomAPI_ProjectPointOnSurf(::GeomAPI_ProjectPointOnSurf* nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ProjectPointOnSurf>( nativeInstance, true )
    {}

    GeomAPI_ProjectPointOnSurf(::GeomAPI_ProjectPointOnSurf& nativeInstance)
        : RDC::OCC::BaseClass<::GeomAPI_ProjectPointOnSurf>( &nativeInstance, false )
    {}
...
public:
    ...
    /// <Surface>
    /// </summary>
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, RDC::OCC::Extrema_ExtAlgo Algo);
    /// <summary>
    /// Create the projection  of a point <P> on a surface
    /// <Surface>
    /// </summary>
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface);
    /// <summary>
    /// Create the projection  of a point <P> on a surface
    /// <Surface>
    /// Create the projection of a point <P>  on a surface
    ...
    /// </summary>
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Tolerance, RDC::OCC::Extrema_ExtAlgo Algo);
    /// <summary>
    /// Create the projection  of a point <P> on a surface
    /// <Surface>
    /// Create the projection of a point <P>  on a surface
    ...
    /// [Umin,Usup] [Vmin,Vsup] of the surface.
    /// </summary>
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Tolerance);
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, double Tolerance, RDC::OCC::Extrema_ExtAlgo Algo);
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, double Tolerance);
    /// <summary>
    /// Init the projection  of a point <P> on a surface
    /// <Surface>
    /// </summary>
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, RDC::OCC::Extrema_ExtAlgo Algo);
    /// <summary>
    /// Init the projection  of a point <P> on a surface
    /// <Surface>
    /// </summary>
    GeomAPI_ProjectPointOnSurf(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup);
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Tolerance, RDC::OCC::Extrema_ExtAlgo Algo);
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Tolerance);
    /// <summary>
    /// Init the projection of a point <P>  on a surface
    /// <Surface>. The solution are computed in the domain
    /// [Umin,Usup] [Vmin,Vsup] of the surface.
    /// </summary>
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, RDC::OCC::Extrema_ExtAlgo Algo);
    /// <summary>
    /// Init the projection of a point <P>  on a surface
    /// <Surface>. The solution are computed in the domain
    /// [Umin,Usup] [Vmin,Vsup] of the surface.
    /// </summary>
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface);
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, double Tolerance, RDC::OCC::Extrema_ExtAlgo Algo);
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, double Tolerance);
    /// <summary>
    /// Init the projection for many points on a surface
    /// <Surface>. The solutions will be computed in the domain
    /// [Umin,Usup] [Vmin,Vsup] of the surface.
    /// </summary>
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, RDC::OCC::Extrema_ExtAlgo Algo);
    /// <summary>
    /// Init the projection for many points on a surface
    /// <Surface>. The solutions will be computed in the domain
    /// [Umin,Usup] [Vmin,Vsup] of the surface.
    /// </summary>
    void Init(RDC::OCC::Pnt P, RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup);
    void Init(RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, double Tolerance, RDC::OCC::Extrema_ExtAlgo Algo);
    void Init(RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, double Tolerance);
    void Init(RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup, RDC::OCC::Extrema_ExtAlgo Algo);
    void Init(RDC::OCC::Geom_Surface^ Surface, double Umin, double Usup, double Vmin, double Vsup);
    /// <summary>
    /// Sets the Extrema search algorithm - Grad or Tree. <br>
    /// By default the Extrema is initialized with Grad algorithm.
    /// </summary>
    void SetExtremaAlgo(RDC::OCC::Extrema_ExtAlgo theAlgo);
    /// <summary>
    /// Sets the Extrema search flag - MIN or MAX or MINMAX.<br>
    /// By default the Extrema is set to search the MinMax solutions.
    /// </summary>
    void SetExtremaFlag(RDC::OCC::Extrema_ExtFlag theExtFlag);
    /// <summary>
