...
public ref class BSplCLib_CacheParams sealed
    : public RDC::OCC::BaseClass<::BSplCLib_CacheParams>
{
...
public:
    BSplCLib_CacheParams(::BSplCLib_CacheParams* nativeInstance)
        : RDC::OCC::BaseClass<::BSplCLib_CacheParams>( nativeInstance, true )
    {}

    BSplCLib_CacheParams(::BSplCLib_CacheParams& nativeInstance)
        : RDC::OCC::BaseClass<::BSplCLib_CacheParams>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    BSplCLib_CacheParams(int theDegree, bool thePeriodic, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots);
    /// <summary>
    ...
    /// \param theFlatKnots  knots of Bezier / B-spline parameterization
    /// </summary>
    void LocateParameter(double% theParameter, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots);
}; // class BSplCLib_CacheParams
...
public ref class BSplCLib_EvaluatorFunction
    : public RDC::OCC::BaseClass<::BSplCLib_EvaluatorFunction>
{
...
public:
    BSplCLib_EvaluatorFunction(::BSplCLib_EvaluatorFunction* nativeInstance)
        : RDC::OCC::BaseClass<::BSplCLib_EvaluatorFunction>( nativeInstance, true )
    {}

    BSplCLib_EvaluatorFunction(::BSplCLib_EvaluatorFunction& nativeInstance)
        : RDC::OCC::BaseClass<::BSplCLib_EvaluatorFunction>( &nativeInstance, false )
    {}
...
public ref class BSplCLib sealed
    : public RDC::OCC::BaseClass<::BSplCLib>
{
...
public:
    BSplCLib(::BSplCLib* nativeInstance)
        : RDC::OCC::BaseClass<::BSplCLib>( nativeInstance, true )
    {}

    BSplCLib(::BSplCLib& nativeInstance)
        : RDC::OCC::BaseClass<::BSplCLib>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void Hunt(RDC::OCC::TColStd_Array1OfReal^ theArray, double theX, int% theXPos);
    /// <summary>
    /// Computes the index of the knots value which gives
    /// the start point of the curve.
    /// </summary>
    static int FirstUKnotIndex(int Degree, RDC::OCC::TColStd_Array1OfInteger^ Mults);
    /// <summary>
    /// Computes the index of the knots value which gives
    /// the end point of the curve.
    /// </summary>
    static int LastUKnotIndex(int Degree, RDC::OCC::TColStd_Array1OfInteger^ Mults);
    /// <summary>
    /// Computes the index  of  the  flats knots  sequence
    /// corresponding  to  <Index> in  the  knots sequence
    /// which multiplicities are <Mults>.
    /// </summary>
    static int FlatIndex(int Degree, int Index, RDC::OCC::TColStd_Array1OfInteger^ Mults, bool Periodic);
    /// <summary>
    ...
    /// </summary>
    static void LocateParameter(int Degree, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double U, bool IsPeriodic, int FromK1, int ToK2, int% KnotIndex, double% NewU);
    /// <summary>
    /// Locates  the parametric value    U  in the knots
    /// sequence  between  the  knot K1   and the knot  K2.
    /// The value return in Index verifies.
    ...
    /// </summary>
    static void LocateParameter(int Degree, RDC::OCC::TColStd_Array1OfReal^ Knots, double U, bool IsPeriodic, int FromK1, int ToK2, int% KnotIndex, double% NewU);
    static void LocateParameter(int Degree, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double U, bool Periodic, int% Index, double% NewU);
    /// <summary>
    ...
    /// </summary>
    static int MaxKnotMult(RDC::OCC::TColStd_Array1OfInteger^ Mults, int K1, int K2);
    /// <summary>
    /// Finds the lowest multiplicity in  a  set of knots
    /// between   K1  and K2.   Mults is  the  multiplicity
    /// associated with each knot value.
    /// </summary>
    static int MinKnotMult(RDC::OCC::TColStd_Array1OfInteger^ Mults, int K1, int K2);
    /// <summary>
    ...
    /// equal to the first.
    /// </summary>
    static int NbPoles(int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfInteger^ Mults);
    /// <summary>
    ...
    /// + 2 * Degree
    /// </summary>
    static int KnotSequenceLength(RDC::OCC::TColStd_Array1OfInteger^ Mults, int Degree, bool Periodic);
    static void KnotSequence(RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColStd_Array1OfReal^ KnotSeq, bool Periodic);
    static void KnotSequence(RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColStd_Array1OfReal^ KnotSeq);
    /// <summary>
    ...
    /// </summary>
    static void KnotSequence(RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ KnotSeq);
    /// <summary>
    /// Returns the  length  of the   sequence of  knots  (and
    /// Mults)  without repetition.
    /// </summary>
    static int KnotsLength(RDC::OCC::TColStd_Array1OfReal^ KnotSeq, bool Periodic);
    /// <summary>
    /// Returns the  length  of the   sequence of  knots  (and
    /// Mults)  without repetition.
    /// </summary>
    static int KnotsLength(RDC::OCC::TColStd_Array1OfReal^ KnotSeq);
    /// <summary>
    ...
    /// </summary>
    static void Knots(RDC::OCC::TColStd_Array1OfReal^ KnotSeq, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, bool Periodic);
    /// <summary>
    /// Computes  the  sequence   of knots Knots  without
    /// repetition  of the  knots  of multiplicity  greater
    /// than 1.
    ...
    /// KnotsLength(KnotSequence,Periodic)
    /// </summary>
    static void Knots(RDC::OCC::TColStd_Array1OfReal^ KnotSeq, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::BSplCLib_KnotDistribution KnotForm(RDC::OCC::TColStd_Array1OfReal^ Knots, int FromK1, int ToK2);
    /// <summary>
    /// Analyses the distribution of multiplicities between
    /// the knot FromK1 and the Knot ToK2.
    /// </summary>
    static RDC::OCC::BSplCLib_MultDistribution MultForm(RDC::OCC::TColStd_Array1OfInteger^ Mults, int FromK1, int ToK2);
    /// <summary>
    /// Analyzes the array of knots.
    /// Returns the form and the maximum knot multiplicity.
    /// </summary>
    static void KnotAnalysis(int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ CKnots, RDC::OCC::TColStd_Array1OfInteger^ CMults, RDC::OCC::GeomAbs_BSplKnotDistribution% KnotForm, int% MaxKnotMult);
    /// <summary>
    ...
    /// </summary>
    static void Reparametrize(double U1, double U2, RDC::OCC::TColStd_Array1OfReal^ Knots);
    /// <summary>
    /// Reverses  the  array   knots  to  become  the knots
    /// sequence of the reversed curve.
    /// </summary>
    static void Reverse(RDC::OCC::TColStd_Array1OfReal^ Knots);
    /// <summary>
    /// Reverses  the  array of multiplicities.
    /// </summary>
    static void Reverse(RDC::OCC::TColStd_Array1OfInteger^ Mults);
    /// <summary>
    ...
    /// - 1)
    /// </summary>
    static void Reverse(RDC::OCC::TColgp_Array1OfPnt^ Poles, int Last);
    /// <summary>
    /// Reverses the array of poles.
    /// </summary>
    static void Reverse(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, int Last);
    /// <summary>
    /// Reverses the array of poles.
    /// </summary>
    static void Reverse(RDC::OCC::TColStd_Array1OfReal^ Weights, int Last);
    /// <summary>
    ...
    /// </summary>
    static bool IsRational(RDC::OCC::TColStd_Array1OfReal^ Weights, int I1, int I2, double Epsilon);
    /// <summary>
    /// Returns False if all the weights  of the  array <Weights>
    /// between   I1 an I2   are  identic.   Epsilon  is used for
    /// comparing  weights. If Epsilon  is 0. the  Epsilon of the
    /// first weight is used.
    /// </summary>
    static bool IsRational(RDC::OCC::TColStd_Array1OfReal^ Weights, int I1, int I2);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::TColStd_Array1OfReal^ NoWeights();
    /// <summary>
    /// Used as argument for a flatknots evaluation.
    /// </summary>
    static RDC::OCC::TColStd_Array1OfInteger^ NoMults();
    /// <summary>
    /// Stores in LK the useful knots for the BoorSchem
    /// on the span Knots(Index) - Knots(Index+1)
    /// </summary>
    static void BuildKnots(int Degree, int Index, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double% LK);
    /// <summary>
    /// Return the index of the  first Pole to  use on the
    /// span  Mults(Index)  - Mults(Index+1).  This  index
    /// must be added to Poles.Lower().
    /// </summary>
    static int PoleIndex(int Degree, int Index, bool Periodic, RDC::OCC::TColStd_Array1OfInteger^ Mults);
    static void BuildEval(int Degree, int Index, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, double% LP);
    static void BuildEval(int Degree, int Index, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, double% LP);
    /// <summary>
    /// Copy in <LP>  the poles and  weights for  the Eval
    /// scheme. starting from  Poles(Poles.Lower()+Index)
    /// </summary>
    static void BuildEval(int Degree, int Index, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, double% LP);
    /// <summary>
    /// Copy in <LP>  poles for <Dimension>  Boor  scheme.
    /// Starting  from    <Index>     *  <Dimension>, copy
    /// <Length+1> poles.
    /// </summary>
    static void BuildBoor(int Index, int Length, int Dimension, RDC::OCC::TColStd_Array1OfReal^ Poles, double% LP);
    /// <summary>
    ...
    /// </summary>
    static void GetPole(int Index, int Length, int Depth, int Dimension, double% LocPoles, int% Position, RDC::OCC::TColStd_Array1OfReal^ Pole);
    /// <summary>
    ...
    /// </summary>
    static bool PrepareInsertKnots(int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColStd_Array1OfReal^ AddKnots, RDC::OCC::TColStd_Array1OfInteger^ AddMults, int% NbPoles, int% NbKnots, double Epsilon, bool Add);
    /// <summary>
    /// Returns in <NbPoles, NbKnots> the  new number of poles
    /// and  knots    if  the  sequence   of  knots <AddKnots,
    /// AddMults> is inserted in the sequence <Knots, Mults>.
    ...
    /// The new knots are not in the range.
    /// </summary>
    static bool PrepareInsertKnots(int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColStd_Array1OfReal^ AddKnots, RDC::OCC::TColStd_Array1OfInteger^ AddMults, int% NbPoles, int% NbKnots, double Epsilon);
    ...
    static void InsertKnot(int UIndex, double U, int UMult, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColgp_Array1OfPnt^ NewPoles, RDC::OCC::TColStd_Array1OfReal^ NewWeights);
    /// <summary>
    ...
    /// </summary>
    static void InsertKnot(int UIndex, double U, int UMult, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColgp_Array1OfPnt2d^ NewPoles, RDC::OCC::TColStd_Array1OfReal^ NewWeights);
    static void RaiseMultiplicity(int KnotIndex, int Mult, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColgp_Array1OfPnt^ NewPoles, RDC::OCC::TColStd_Array1OfReal^ NewWeights);
    /// <summary>
    ...
    /// not updated.
    /// </summary>
    static void RaiseMultiplicity(int KnotIndex, int Mult, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColgp_Array1OfPnt2d^ NewPoles, RDC::OCC::TColStd_Array1OfReal^ NewWeights);
    ...
    /// for more comments.
    /// </summary>
    static int IncreaseDegreeCountKnots(int Degree, int NewDegree, bool Periodic, RDC::OCC::TColStd_Array1OfInteger^ Mults);
    ...
    static void IncreaseDegree(int NewDegree, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColgp_Array1OfPnt^ NewPoles, RDC::OCC::TColStd_Array1OfReal^ NewWeights);
    /// <summary>
    ...
    static void IncreaseDegree(int theNewDegree, RDC::OCC::TColgp_Array1OfPnt2d^ thePoles, RDC::OCC::TColStd_Array1OfReal^ theWeights, RDC::OCC::TColgp_Array1OfPnt2d^ theNewPoles, RDC::OCC::TColStd_Array1OfReal^ theNewWeights);
    /// <summary>
    ...
    /// </summary>
    static void PrepareUnperiodize(int Degree, RDC::OCC::TColStd_Array1OfInteger^ Mults, int% NbKnots, int% NbPoles);
    static void Unperiodize(int Degree, int Dimension, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfInteger^ NewMults, RDC::OCC::TColStd_Array1OfReal^ NewKnots, RDC::OCC::TColStd_Array1OfReal^ NewPoles);
    ...
    /// </summary>
    static void PrepareTrimming(int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double U1, double U2, int% NbKnots, int% NbPoles);
    ...
    static void D0(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double% P);
    static void D0(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt% P);
    static void D0(double U, int UIndex, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt2d% P);
    static void D0(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% P);
    static void D0(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% P);
    static void D1(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double% P, double% V);
    static void D1(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt% P, RDC::OCC::Vec% V);
    static void D1(double U, int UIndex, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V);
    static void D1(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% P, RDC::OCC::Vec% V);
    static void D1(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V);
    static void D2(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double% P, double% V1, double% V2);
    static void D2(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt% P, RDC::OCC::Vec% V1, RDC::OCC::Vec% V2);
    static void D2(double U, int UIndex, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1, RDC::OCC::Vec2d% V2);
    static void D2(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% P, RDC::OCC::Vec% V1, RDC::OCC::Vec% V2);
    static void D2(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1, RDC::OCC::Vec2d% V2);
    static void D3(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double% P, double% V1, double% V2, double% V3);
    static void D3(double U, int Index, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt% P, RDC::OCC::Vec% V1, RDC::OCC::Vec% V2, RDC::OCC::Vec% V3);
    static void D3(double U, int UIndex, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1, RDC::OCC::Vec2d% V2, RDC::OCC::Vec2d% V3);
    static void D3(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% P, RDC::OCC::Vec% V1, RDC::OCC::Vec% V2, RDC::OCC::Vec% V3);
    static void D3(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% P, RDC::OCC::Vec2d% V1, RDC::OCC::Vec2d% V2, RDC::OCC::Vec2d% V3);
    static void DN(double U, int N, int Index, int Degree, bool Periodic, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, double% VN);
    static void DN(double U, int N, int Index, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Vec% VN);
    static void DN(double U, int N, int UIndex, int Degree, bool Periodic, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ Knots, RDC::OCC::TColStd_Array1OfInteger^ Mults, RDC::OCC::Vec2d% V);
    ...
    /// points of F(a(t))
    /// </summary>
    static void FunctionReparameterise(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, int PolesDimension, double% Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, double% NewPoles, int% theStatus);
    /// <summary>
    /// This function will compose  a given Vectorial BSpline F(t)
    /// defined  by its  BSplineDegree and BSplineFlatKnotsl,
    /// its Poles  array which are coded as  an array of Real
    ...
    /// points of F(a(t))
    /// </summary>
    static void FunctionReparameterise(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, RDC::OCC::TColStd_Array1OfReal^ NewPoles, int% theStatus);
    /// <summary>
    ...
    /// points of F(a(t))
    /// </summary>
    static void FunctionReparameterise(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, RDC::OCC::TColgp_Array1OfPnt^ NewPoles, int% theStatus);
    /// <summary>
    /// this will compose  a given Vectorial BSpline F(t)
    /// defined  by its  BSplineDegree and BSplineFlatKnotsl,
    /// its Poles  array which are coded as  an array of Real
    ...
    /// points of F(a(t))
    /// </summary>
    static void FunctionReparameterise(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, RDC::OCC::TColgp_Array1OfPnt2d^ NewPoles, int% theStatus);
    /// <summary>
    ...
    /// points of a(t)*F(t)
    /// </summary>
    static void FunctionMultiply(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, int PolesDimension, double% Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, double% NewPoles, int% theStatus);
    /// <summary>
    /// this will  multiply a given Vectorial BSpline F(t)
    /// defined  by its  BSplineDegree and BSplineFlatKnotsl,
    /// its Poles  array which are coded as  an array of Real
    ...
    /// points of a(t)*F(t)
    /// </summary>
    static void FunctionMultiply(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, RDC::OCC::TColStd_Array1OfReal^ Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, RDC::OCC::TColStd_Array1OfReal^ NewPoles, int% theStatus);
    /// <summary>
    /// this will  multiply a given Vectorial BSpline F(t)
    /// defined  by its  BSplineDegree and BSplineFlatKnotsl,
    /// its Poles  array which are coded as  an array of Real
    ...
    /// points of a(t)*F(t)
    /// </summary>
    static void FunctionMultiply(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, RDC::OCC::TColgp_Array1OfPnt2d^ NewPoles, int% theStatus);
    /// <summary>
    /// this will  multiply a given Vectorial BSpline F(t)
    /// defined  by its  BSplineDegree and BSplineFlatKnotsl,
    /// its Poles  array which are coded as  an array of Real
    ...
    /// points of a(t)*F(t)
    /// </summary>
    static void FunctionMultiply(RDC::OCC::BSplCLib_EvaluatorFunction^ Function, int BSplineDegree, RDC::OCC::TColStd_Array1OfReal^ BSplineFlatKnots, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int NewDegree, RDC::OCC::TColgp_Array1OfPnt^ NewPoles, int% theStatus);
    /// <summary>
    ...
    /// </summary>
    static void Eval(double U, bool PeriodicFlag, int DerivativeRequest, int% ExtrapMode, int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int ArrayDimension, double% Poles, double% Result);
    /// <summary>
    /// Perform the  De Boor algorithm  to evaluate a point at
    /// parameter   <U>,  with   <Degree>    and  <Dimension>.
    ...
    /// properly.
    /// </summary>
    static void Eval(double U, bool PeriodicFlag, int DerivativeRequest, int% ExtrapMode, int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int ArrayDimension, double% Poles, double% Weights, double% PolesResult, double% WeightsResult);
    /// <summary>
    /// Perform the evaluation of the Bspline Basis
    /// and then multiplies by the weights
    /// this just evaluates the current point
    /// </summary>
    static void Eval(double U, bool PeriodicFlag, bool HomogeneousFlag, int% ExtrapMode, int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point, double% Weight);
    /// <summary>
    /// Perform the evaluation of the Bspline Basis
    /// and then multiplies by the weights
    /// this just evaluates the current point
    /// </summary>
    static void Eval(double U, bool PeriodicFlag, bool HomogeneousFlag, int% ExtrapMode, int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point, double% Weight);
    /// <summary>
    ...
    /// properly.
    /// </summary>
    static void TangExtendToConstraint(RDC::OCC::TColStd_Array1OfReal^ FlatKnots, double C1Coefficient, int NumPoles, double% Poles, int Dimension, int Degree, RDC::OCC::TColStd_Array1OfReal^ ConstraintPoint, int Continuity, bool After, int% NbPolesResult, int% NbKnotsRsult, double% KnotsResult, double% PolesResult);
    /// <summary>
    ...
    /// effects
    /// </summary>
    static void CacheD0(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point);
    /// <summary>
    /// Perform the evaluation of the Bspline Basis
    /// and then multiplies by the weights
    /// this just evaluates the current point
    ...
    /// </summary>
    static void CacheD0(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point);
    /// <summary>
    /// Calls CacheD0 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD0(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point);
    /// <summary>
    /// Calls CacheD0 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD0(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point);
    /// <summary>
    /// Perform the evaluation of the of the cache
    /// the parameter must be normalized between
    /// the 0 and 1 for the span.
    ...
    /// effects
    /// </summary>
    static void CacheD1(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point, RDC::OCC::Vec% Vec);
    /// <summary>
    /// Perform the evaluation of the Bspline Basis
    /// and then multiplies by the weights
    /// this just evaluates the current point
    ...
    /// effectsis just evaluates the current point
    /// </summary>
    static void CacheD1(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point, RDC::OCC::Vec2d% Vec);
    /// <summary>
    /// Calls CacheD1 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD1(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point, RDC::OCC::Vec% Vec);
    /// <summary>
    /// Calls CacheD1 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD1(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point, RDC::OCC::Vec2d% Vec);
    /// <summary>
    /// Perform the evaluation of the of the cache
    /// the parameter must be normalized between
    /// the 0 and 1 for the span.
    ...
    /// effects
    /// </summary>
    static void CacheD2(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point, RDC::OCC::Vec% Vec1, RDC::OCC::Vec% Vec2);
    /// <summary>
    /// Perform the evaluation of the Bspline Basis
    /// and then multiplies by the weights
    /// this just evaluates the current point
    ...
    /// effectsis just evaluates the current point
    /// </summary>
    static void CacheD2(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point, RDC::OCC::Vec2d% Vec1, RDC::OCC::Vec2d% Vec2);
    /// <summary>
    /// Calls CacheD1 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD2(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point, RDC::OCC::Vec% Vec1, RDC::OCC::Vec% Vec2);
    /// <summary>
    /// Calls CacheD1 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD2(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point, RDC::OCC::Vec2d% Vec1, RDC::OCC::Vec2d% Vec2);
    /// <summary>
    /// Perform the evaluation of the of the cache
    /// the parameter must be normalized between
    /// the 0 and 1 for the span.
    ...
    /// effects
    /// </summary>
    static void CacheD3(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point, RDC::OCC::Vec% Vec1, RDC::OCC::Vec% Vec2, RDC::OCC::Vec% Vec3);
    /// <summary>
    /// Perform the evaluation of the Bspline Basis
    /// and then multiplies by the weights
    /// this just evaluates the current point
    ...
    /// effectsis just evaluates the current point
    /// </summary>
    static void CacheD3(double U, int Degree, double CacheParameter, double SpanLenght, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point, RDC::OCC::Vec2d% Vec1, RDC::OCC::Vec2d% Vec2, RDC::OCC::Vec2d% Vec3);
    /// <summary>
    /// Calls CacheD1 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD3(double U, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt% Point, RDC::OCC::Vec% Vec1, RDC::OCC::Vec% Vec2, RDC::OCC::Vec% Vec3);
    /// <summary>
    /// Calls CacheD1 for Bezier  Curves Arrays computed with
    /// the method PolesCoefficients.
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void CoefsD3(double U, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::Pnt2d% Point, RDC::OCC::Vec2d% Vec1, RDC::OCC::Vec2d% Vec2, RDC::OCC::Vec2d% Vec3);
    /// <summary>
    ...
    /// </summary>
    static void BuildCache(double U, double InverseOfSpanDomain, bool PeriodicFlag, int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColgp_Array1OfPnt^ CachePoles, RDC::OCC::TColStd_Array1OfReal^ CacheWeights);
    /// <summary>
    /// Perform the evaluation of the Taylor expansion
    /// of the Bspline normalized between 0 and 1.
    /// If rational computes the homogeneous Taylor expension
    /// for the numerator and stores it in CachePoles
    /// </summary>
    static void BuildCache(double U, double InverseOfSpanDomain, bool PeriodicFlag, int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColgp_Array1OfPnt2d^ CachePoles, RDC::OCC::TColStd_Array1OfReal^ CacheWeights);
    /// <summary>
    /// Perform the evaluation of the Taylor expansion
    /// of the Bspline normalized between 0 and 1.
    /// Structure of result optimized for BSplCLib_Cache.
    /// </summary>
    static void BuildCache(double theParameter, double theSpanDomain, bool thePeriodicFlag, int theDegree, int theSpanIndex, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt^ thePoles, RDC::OCC::TColStd_Array1OfReal^ theWeights, RDC::OCC::TColStd_Array2OfReal^ theCacheArray);
    /// <summary>
    /// Perform the evaluation of the Taylor expansion
    /// of the Bspline normalized between 0 and 1.
    /// Structure of result optimized for BSplCLib_Cache.
    /// </summary>
    static void BuildCache(double theParameter, double theSpanDomain, bool thePeriodicFlag, int theDegree, int theSpanIndex, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ thePoles, RDC::OCC::TColStd_Array1OfReal^ theWeights, RDC::OCC::TColStd_Array2OfReal^ theCacheArray);
    static void PolesCoefficients(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColgp_Array1OfPnt2d^ CachePoles);
    static void PolesCoefficients(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColgp_Array1OfPnt2d^ CachePoles, RDC::OCC::TColStd_Array1OfReal^ CacheWeights);
    static void PolesCoefficients(RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColgp_Array1OfPnt^ CachePoles);
    /// <summary>
    ...
    /// Warning: To be used for Beziercurves ONLY!!!
    /// </summary>
    static void PolesCoefficients(RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColgp_Array1OfPnt^ CachePoles, RDC::OCC::TColStd_Array1OfReal^ CacheWeights);
    /// <summary>
    ...
    /// </summary>
    static void BuildSchoenbergPoints(int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColStd_Array1OfReal^ Parameters);
    /// <summary>
    ...
    /// pivot
    /// </summary>
    static void Interpolate(int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColStd_Array1OfReal^ Parameters, RDC::OCC::TColStd_Array1OfInteger^ ContactOrderArray, RDC::OCC::TColgp_Array1OfPnt^ Poles, int% InversionProblem);
    /// <summary>
    /// Performs the interpolation of  the data given in
    /// the Poles  array  according  to the  requests in
    /// ContactOrderArray    that is      :           if
    ...
    /// pivot
    /// </summary>
    static void Interpolate(int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColStd_Array1OfReal^ Parameters, RDC::OCC::TColStd_Array1OfInteger^ ContactOrderArray, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, int% InversionProblem);
    /// <summary>
    /// Performs the interpolation of  the data given in
    /// the Poles  array  according  to the  requests in
    /// ContactOrderArray    that is      :           if
    ...
    /// pivot
    /// </summary>
    static void Interpolate(int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColStd_Array1OfReal^ Parameters, RDC::OCC::TColStd_Array1OfInteger^ ContactOrderArray, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, int% InversionProblem);
    /// <summary>
    /// Performs the interpolation of  the data given in
    /// the Poles  array  according  to the  requests in
    /// ContactOrderArray    that is      :           if
    ...
    /// </summary>
    static void Interpolate(int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColStd_Array1OfReal^ Parameters, RDC::OCC::TColStd_Array1OfInteger^ ContactOrderArray, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, int% InversionProblem);
    /// <summary>
    /// Performs the interpolation of  the data given in
    /// the Poles  array  according  to the  requests in
    /// ContactOrderArray    that is      :           if
    ...
    /// pivot
    /// </summary>
    static void Interpolate(int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColStd_Array1OfReal^ Parameters, RDC::OCC::TColStd_Array1OfInteger^ ContactOrderArray, int ArrayDimension, double% Poles, int% InversionProblem);
    static void Interpolate(int Degree, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, RDC::OCC::TColStd_Array1OfReal^ Parameters, RDC::OCC::TColStd_Array1OfInteger^ ContactOrderArray, int ArrayDimension, double% Poles, double% Weights, int% InversionProblem);
    /// <summary>
    ...
    /// </summary>
    static void MovePoint(double U, RDC::OCC::Vec2d Displ, int Index1, int Index2, int Degree, RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int% FirstIndex, int% LastIndex, RDC::OCC::TColgp_Array1OfPnt2d^ NewPoles);
    /// <summary>
    /// Find the new poles which allows  an old point (with a
    /// given  u as parameter) to reach a new position
    /// Index1 and Index2 indicate the range of poles we can move
    ...
    /// and FirstIndex, LastIndex = 0
    /// </summary>
    static void MovePoint(double U, RDC::OCC::Vec Displ, int Index1, int Index2, int Degree, RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int% FirstIndex, int% LastIndex, RDC::OCC::TColgp_Array1OfPnt^ NewPoles);
    /// <summary>
    ...
    /// </summary>
    static void MovePointAndTangent(double U, int ArrayDimension, double% Delta, double% DeltaDerivative, double Tolerance, int Degree, int StartingCondition, int EndingCondition, double% Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, double% NewPoles, int% ErrorStatus);
    /// <summary>
    /// This is the dimension free version of the utility
    /// U is the parameter  must be within the  first FlatKnots and the
    /// last FlatKnots  Delta is the amount the  curve has  to be moved
    ...
    /// </summary>
    static void Resolution(double% PolesArray, int ArrayDimension, int NumPoles, RDC::OCC::TColStd_Array1OfReal^ Weights, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int Degree, double Tolerance3D, double% UTolerance);
    /// <summary>
    /// given a tolerance in 3D space returns a
    /// tolerance    in U parameter space such that
    /// all u1 and u0 in the domain of the curve f(u)
    ...
    /// we have |f (u1) - f (u0)| < Tolerance3D
    /// </summary>
    static void Resolution(RDC::OCC::TColgp_Array1OfPnt^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, int NumPoles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int Degree, double Tolerance3D, double% UTolerance);
    /// <summary>
    /// given a tolerance in 3D space returns a
    /// tolerance    in U parameter space such that
    /// all u1 and u0 in the domain of the curve f(u)
    ...
    /// we have |f (u1) - f (u0)| < Tolerance3D
    /// </summary>
    static void Resolution(RDC::OCC::TColgp_Array1OfPnt2d^ Poles, RDC::OCC::TColStd_Array1OfReal^ Weights, int NumPoles, RDC::OCC::TColStd_Array1OfReal^ FlatKnots, int Degree, double Tolerance3D, double% UTolerance);
    /// <summary>
    ...
    /// </returns>
    static int Intervals(RDC::OCC::TColStd_Array1OfReal^ theKnots, RDC::OCC::TColStd_Array1OfInteger^ theMults, int theDegree, bool isPeriodic, int theContinuity, double theFirst, double theLast, double theTolerance, RDC::OCC::TColStd_Array1OfReal^ theIntervals);
}; // class BSplCLib
...
public:
    ...
    /// </summary>
    BSplCLib_Cache(int theDegree, bool thePeriodic, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ thePoles2d, RDC::OCC::TColStd_Array1OfReal^ theWeights);
    /// <summary>
    /// Constructor, prepares data structures for caching values on a 2d curve.
    /// \param theDegree     degree of the curve
    /// \param thePeriodic   identify whether the curve is periodic
    ...
    /// \param theWeights    array of weights of corresponding poles
    /// </summary>
    BSplCLib_Cache(int theDegree, bool thePeriodic, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ thePoles2d);
    /// <summary>
    ...
    /// \param theWeights    array of weights of corresponding poles
    /// </summary>
    BSplCLib_Cache(int theDegree, bool thePeriodic, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt^ thePoles, RDC::OCC::TColStd_Array1OfReal^ theWeights);
    /// <summary>
    /// Constructor, prepares data structures for caching values on a 3d curve.
    /// \param theDegree     degree of the curve
    /// \param thePeriodic   identify whether the curve is periodic
    ...
    /// \param theWeights    array of weights of corresponding poles
    /// </summary>
    BSplCLib_Cache(int theDegree, bool thePeriodic, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt^ thePoles);
    /// <summary>
    /// Verifies validity of the cache using flat parameter of the point
    /// \param theParameter parameter of the point placed in the span
    /// </summary>
    ...
    /// \param theWeights    array of weights of corresponding poles
    /// </summary>
    void BuildCache(double theParameter, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt2d^ thePoles2d, RDC::OCC::TColStd_Array1OfReal^ theWeights);
    /// <summary>
    ...
    /// \param theWeights    array of weights of corresponding poles
    /// </summary>
    void BuildCache(double theParameter, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt^ thePoles, RDC::OCC::TColStd_Array1OfReal^ theWeights);
    /// <summary>
    /// Recomputes the cache data for 3D curves. Does not verify validity of the cache
    /// \param theParameter  the value on the knot's axis to identify the span
    /// \param theFlatKnots  knots of Bezier/B-spline curve (with repetitions)
    ...
    /// \param theWeights    array of weights of corresponding poles
    /// </summary>
    void BuildCache(double theParameter, RDC::OCC::TColStd_Array1OfReal^ theFlatKnots, RDC::OCC::TColgp_Array1OfPnt^ thePoles);
    /// <summary>
    ...
    /// </summary>
    void D0(double theParameter, RDC::OCC::Pnt2d% thePoint);
    void D0(double theParameter, RDC::OCC::Pnt% thePoint);
    /// <summary>
    ...
    /// </summary>
    void D1(double theParameter, RDC::OCC::Pnt2d% thePoint, RDC::OCC::Vec2d% theTangent);
    void D1(double theParameter, RDC::OCC::Pnt% thePoint, RDC::OCC::Vec% theTangent);
    /// <summary>
    ...
    /// </summary>
    void D2(double theParameter, RDC::OCC::Pnt2d% thePoint, RDC::OCC::Vec2d% theTangent, RDC::OCC::Vec2d% theCurvature);
    void D2(double theParameter, RDC::OCC::Pnt% thePoint, RDC::OCC::Vec% theTangent, RDC::OCC::Vec% theCurvature);
    /// <summary>
    ...
    /// </summary>
    void D3(double theParameter, RDC::OCC::Pnt2d% thePoint, RDC::OCC::Vec2d% theTangent, RDC::OCC::Vec2d% theCurvature, RDC::OCC::Vec2d% theTorsion);
    void D3(double theParameter, RDC::OCC::Pnt% thePoint, RDC::OCC::Vec% theTangent, RDC::OCC::Vec% theCurvature, RDC::OCC::Vec% theTorsion);
    static RDC::OCC::BSplCLib_Cache^ CreateDowncasted(::BSplCLib_Cache* instance);
}; // class BSplCLib_Cache
