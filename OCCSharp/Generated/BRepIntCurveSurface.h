...
public ref class BRepIntCurveSurface_Inter sealed
    : public RDC::OCC::BaseClass<::BRepIntCurveSurface_Inter>
{
...
public:
    BRepIntCurveSurface_Inter(::BRepIntCurveSurface_Inter* nativeInstance)
        : RDC::OCC::BaseClass<::BRepIntCurveSurface_Inter>( nativeInstance, true )
    {}

    BRepIntCurveSurface_Inter(::BRepIntCurveSurface_Inter& nativeInstance)
        : RDC::OCC::BaseClass<::BRepIntCurveSurface_Inter>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::GeomAdaptor_Curve^ theCurve, double theTol);
    /// <summary>
    /// Load the Shape, the curve  and initialize the
    /// tolerance used for the classification.
    /// </summary>
    void Init(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::gp_Lin^ theLine, double theTol);
    /// <summary>
    /// Load the Shape,   and initialize the
    /// tolerance used for the classification.
    /// </summary>
    void Load(RDC::OCC::TopoDS_Shape^ theShape, double theTol);
    /// <summary>
    /// Method to find intersections of specified curve with loaded shape.
    /// </summary>
    void Init(RDC::OCC::GeomAdaptor_Curve^ theCurve);
    /// <summary>
