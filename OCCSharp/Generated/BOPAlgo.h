...
public ref class BOPAlgo_Options
    : public RDC::OCC::BaseClass<::BOPAlgo_Options>
{
...
protected:
    BOPAlgo_Options(InitMode init)
        : RDC::OCC::BaseClass<::BOPAlgo_Options>( init )
    {}

public:
    BOPAlgo_Options(::BOPAlgo_Options* nativeInstance)
        : RDC::OCC::BaseClass<::BOPAlgo_Options>( nativeInstance, true )
    {}

    BOPAlgo_Options(::BOPAlgo_Options& nativeInstance)
        : RDC::OCC::BaseClass<::BOPAlgo_Options>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    BOPAlgo_Options(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    /// <summary>
    /// Returns allocator
    /// </summary>
    ...
    /// </summary>
    RDC::OCC::Message_Report^ GetReport();
    /// <summary>
...
protected:
    BOPAlgo_BuilderShape(InitMode init)
        : RDC::OCC::BOPAlgo_Algo( init )
    {}

public:
    BOPAlgo_BuilderShape(::BOPAlgo_BuilderShape* nativeInstance)
        : RDC::OCC::BOPAlgo_Algo( nativeInstance )
    {}
...
public ref class BOPAlgo_Builder
    : public RDC::OCC::BOPAlgo_BuilderShape
{
...
protected:
    BOPAlgo_Builder(InitMode init)
        : RDC::OCC::BOPAlgo_BuilderShape( init )
    {}

public:
    BOPAlgo_Builder(::BOPAlgo_Builder* nativeInstance)
        : RDC::OCC::BOPAlgo_BuilderShape( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    BOPAlgo_Builder();
    BOPAlgo_Builder(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    /// <summary>
    ...
    /// </summary>
    void AddArgument(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    ...
    /// </param>
    void BuildBOP(RDC::OCC::TopTools_ListOfShape^ theObjects, RDC::OCC::TopAbs_State theObjState, RDC::OCC::TopTools_ListOfShape^ theTools, RDC::OCC::TopAbs_State theToolsState, RDC::OCC::Message_ProgressRange^ theRange, RDC::OCC::Message_Report^ theReport);
    /// <summary>
    /// Builds the result shape according to the given states for the objects
    /// and tools. These states can be unambiguously converted into the Boolean operation type.
    /// Thus, it performs the Boolean operation on the given groups of shapes.
    ...
    ///      - The alternative report to avoid pollution of the main one.
    /// </param>
    void BuildBOP(RDC::OCC::TopTools_ListOfShape^ theObjects, RDC::OCC::TopAbs_State theObjState, RDC::OCC::TopTools_ListOfShape^ theTools, RDC::OCC::TopAbs_State theToolsState, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    ...
    /// </param>
    void BuildBOP(RDC::OCC::TopTools_ListOfShape^ theObjects, RDC::OCC::TopTools_ListOfShape^ theTools, RDC::OCC::BOPAlgo_Operation theOperation, RDC::OCC::Message_ProgressRange^ theRange, RDC::OCC::Message_Report^ theReport);
    /// <summary>
    /// Builds the result of Boolean operation of given type
    /// basing on the result of Builder operation (GF or any other).
    /// 
    ...
    ///    - The alternative report to avoid pollution of the global one.
    /// </param>
    void BuildBOP(RDC::OCC::TopTools_ListOfShape^ theObjects, RDC::OCC::TopTools_ListOfShape^ theTools, RDC::OCC::BOPAlgo_Operation theOperation, RDC::OCC::Message_ProgressRange^ theRange);
    /// <summary>
    /// Returns the map of images.
    /// </summary>
    RDC::OCC::TopTools_DataMapOfShapeListOfShape^ Images();
    /// <summary>
    /// Returns the map of origins.
    /// </summary>
    RDC::OCC::TopTools_DataMapOfShapeListOfShape^ Origins();
    /// <summary>
    /// Returns the map of Same Domain (SD) shapes - coinciding shapes
    /// from different arguments.
    /// </summary>
    RDC::OCC::TopTools_DataMapOfShapeShape^ ShapesSD();
}; // class BOPAlgo_Builder
...
public ref class BOPAlgo_ToolsProvider
    : public RDC::OCC::BOPAlgo_Builder
{
...
protected:
    BOPAlgo_ToolsProvider(InitMode init)
        : RDC::OCC::BOPAlgo_Builder( init )
    {}

public:
    BOPAlgo_ToolsProvider(::BOPAlgo_ToolsProvider* nativeInstance)
        : RDC::OCC::BOPAlgo_Builder( nativeInstance )
    {}
...
public:
    ...
    BOPAlgo_ToolsProvider(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    /// <summary>
    ...
    /// </summary>
    void AddTool(RDC::OCC::TopoDS_Shape^ theShape);
    /// <summary>
    /// Adds the Tool arguments of the operation
    /// </summary>
    void SetTools(RDC::OCC::TopTools_ListOfShape^ theShapes);
    /// <summary>
...
public ref class BOPAlgo_BOP
    : public RDC::OCC::BOPAlgo_ToolsProvider
{
...
protected:
    BOPAlgo_BOP(InitMode init)
        : RDC::OCC::BOPAlgo_ToolsProvider( init )
    {}

public:
    BOPAlgo_BOP(::BOPAlgo_BOP* nativeInstance)
        : RDC::OCC::BOPAlgo_ToolsProvider( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    BOPAlgo_BOP();
    BOPAlgo_BOP(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
    /// <summary>
    /// Clears internal fields and arguments
    /// </summary>
    void Clear();
    void SetOperation(RDC::OCC::BOPAlgo_Operation theOperation);
...
public ref class BOPAlgo_Tools sealed
    : public RDC::OCC::BaseClass<::BOPAlgo_Tools>
{
...
public:
    BOPAlgo_Tools(::BOPAlgo_Tools* nativeInstance)
        : RDC::OCC::BaseClass<::BOPAlgo_Tools>( nativeInstance, true )
    {}

    BOPAlgo_Tools(::BOPAlgo_Tools& nativeInstance)
        : RDC::OCC::BaseClass<::BOPAlgo_Tools>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static int EdgesToWires(RDC::OCC::TopoDS_Shape^ theEdges, RDC::OCC::TopoDS_Shape^ theWires, bool theShared, double theAngTol);
    /// <summary>
    /// Creates planar wires from the given edges.<br>
    /// The input edges are expected to be planar. And for the performance
    /// sake the method does not check if the edges are really planar.<br>
    ...
    /// 2 - sharing of the edges has failed.<br>
    /// </summary>
    static int EdgesToWires(RDC::OCC::TopoDS_Shape^ theEdges, RDC::OCC::TopoDS_Shape^ theWires, bool theShared);
    /// <summary>
    /// Creates planar wires from the given edges.<br>
    /// The input edges are expected to be planar. And for the performance
    /// sake the method does not check if the edges are really planar.<br>
    ...
    /// 2 - sharing of the edges has failed.<br>
    /// </summary>
    static int EdgesToWires(RDC::OCC::TopoDS_Shape^ theEdges, RDC::OCC::TopoDS_Shape^ theWires);
    /// <summary>
    ...
    /// </summary>
    static bool WiresToFaces(RDC::OCC::TopoDS_Shape^ theWires, RDC::OCC::TopoDS_Shape^ theFaces, double theAngTol);
    /// <summary>
    /// Creates planar faces from given planar wires.<br>
    /// The method does not check if the wires are really planar.<br>
    /// The input wires may be non-manifold but should be shared.<br>
    ...
    /// Method returns TRUE in case of success, i.e. at least one face has been built.<br>
    /// </summary>
    static bool WiresToFaces(RDC::OCC::TopoDS_Shape^ theWires, RDC::OCC::TopoDS_Shape^ theFaces);
    /// <summary>
    /// Finds chains of intersecting vertices
    /// </summary>
    static void IntersectVertices(RDC::OCC::TopTools_IndexedDataMapOfShapeReal^ theVertices, double theFuzzyValue, RDC::OCC::TopTools_ListOfListOfShape^ theChains);
    ...
    /// </param>
    static bool TrsfToPoint(RDC::OCC::Bnd_Box^ theBox1, RDC::OCC::Bnd_Box^ theBox2, RDC::OCC::Trsf% theTrsf, RDC::OCC::Pnt thePoint, double theCriteria);
    /// <summary>
    /// Computes the transformation needed to move the objects
    /// to the given point to increase the quality of computations.
    /// Returns true if the objects are located far from the given point
    ...
    /// the Criteria to check whether thranformation is required
    /// </param>
    static bool TrsfToPoint(RDC::OCC::Bnd_Box^ theBox1, RDC::OCC::Bnd_Box^ theBox2, RDC::OCC::Trsf% theTrsf, RDC::OCC::Pnt thePoint);
    /// <summary>
    /// Computes the transformation needed to move the objects
    /// to the given point to increase the quality of computations.
    /// Returns true if the objects are located far from the given point
    ...
    /// the Criteria to check whether thranformation is required
    /// </param>
    static bool TrsfToPoint(RDC::OCC::Bnd_Box^ theBox1, RDC::OCC::Bnd_Box^ theBox2, RDC::OCC::Trsf% theTrsf);
}; // class BOPAlgo_Tools
