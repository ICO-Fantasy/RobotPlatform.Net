...
RDC::OCC::ShapeAnalysis_BoxBndTree::ShapeAnalysis_BoxBndTree()
    : RDC::OCC::BaseClass<::ShapeAnalysis_BoxBndTree>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_BoxBndTree();
}

RDC::OCC::ShapeAnalysis_BoxBndTree::ShapeAnalysis_BoxBndTree(RDC::OCC::NCollection_BaseAllocator^ theAllocator)
    : RDC::OCC::BaseClass<::ShapeAnalysis_BoxBndTree>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_BoxBndTree(Handle(::NCollection_BaseAllocator)(theAllocator->NativeInstance));
}

bool RDC::OCC::ShapeAnalysis_BoxBndTree::Add(int theObj, RDC::OCC::Bnd_Box^ theBnd)
{
...
void RDC::OCC::ShapeAnalysis_BoxBndTree::Clear(RDC::OCC::NCollection_BaseAllocator^ aNewAlloc)
{
    ((::ShapeAnalysis_BoxBndTree*)_NativeInstance)->Clear(Handle(::NCollection_BaseAllocator)(aNewAlloc->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_BoxBndTree::Clear()
{
    ((::ShapeAnalysis_BoxBndTree*)_NativeInstance)->Clear(0L);
}

bool RDC::OCC::ShapeAnalysis_BoxBndTree::IsEmpty()
{
    bool _result = ((::ShapeAnalysis_BoxBndTree*)_NativeInstance)->IsEmpty();
    return _result;
}

RDC::OCC::NCollection_BaseAllocator^ RDC::OCC::ShapeAnalysis_BoxBndTree::Allocator()
{
...
RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::ShapeAnalysis_DataMapOfShapeListOfReal()
    : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_DataMapOfShapeListOfReal();
}

RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::ShapeAnalysis_DataMapOfShapeListOfReal(int theNbBuckets, RDC::OCC::NCollection_BaseAllocator^ theAllocator)
    : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal>(BaseClass::InitMode::Uninitialized)
{
...
RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::ShapeAnalysis_DataMapOfShapeListOfReal(int theNbBuckets)
    : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_DataMapOfShapeListOfReal(theNbBuckets, 0L);
}

void RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Exchange(RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ theOther)
{
...
RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Assign(RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ theOther)
{
    ...
    *_result = ((::ShapeAnalysis_DataMapOfShapeListOfReal*)_NativeInstance)->Assign(*(::ShapeAnalysis_DataMapOfShapeListOfReal*)theOther->NativeInstance);
    return _result==nullptr ? nullptr : gcnew RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal(_result);
}

void RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::ReSize(int N)
{
    ((::ShapeAnalysis_DataMapOfShapeListOfReal*)_NativeInstance)->ReSize(N);
}

bool RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Bind(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::TColStd_ListOfReal^ theItem)
{
...
RDC::OCC::TColStd_ListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Bound(RDC::OCC::TopoDS_Shape^ theKey, RDC::OCC::TColStd_ListOfReal^ theItem)
{
...
bool RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::IsBound(RDC::OCC::TopoDS_Shape^ theKey)
{
    bool _result = ((::ShapeAnalysis_DataMapOfShapeListOfReal*)_NativeInstance)->IsBound(*(::TopoDS_Shape*)theKey->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::UnBind(RDC::OCC::TopoDS_Shape^ theKey)
{
    bool _result = ((::ShapeAnalysis_DataMapOfShapeListOfReal*)_NativeInstance)->UnBind(*(::TopoDS_Shape*)theKey->NativeInstance);
    return _result;
}

RDC::OCC::TColStd_ListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Seek(RDC::OCC::TopoDS_Shape^ theKey)
{
    ...
    return _result==nullptr ? nullptr : gcnew RDC::OCC::TColStd_ListOfReal((::TColStd_ListOfReal*)_result);
}

RDC::OCC::TColStd_ListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Find(RDC::OCC::TopoDS_Shape^ theKey)
{
...
RDC::OCC::TColStd_ListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::ChangeSeek(RDC::OCC::TopoDS_Shape^ theKey)
{
...
RDC::OCC::TColStd_ListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::ChangeFind(RDC::OCC::TopoDS_Shape^ theKey)
{
    ::TColStd_ListOfReal* _result = new ::TColStd_ListOfReal();
...
void RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Clear(bool doReleaseMemory)
{
    ((::ShapeAnalysis_DataMapOfShapeListOfReal*)_NativeInstance)->Clear(doReleaseMemory);
}

void RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Clear()
{
    ((::ShapeAnalysis_DataMapOfShapeListOfReal*)_NativeInstance)->Clear(false);
}

int RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Size()
{
...
RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator::Iterator()
    : RDC::OCC::BaseClass<::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator();
}

bool RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator::More()
{
    bool _result = ((::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator*)_NativeInstance)->More();
    return _result;
}

void RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator::Next()
{
    ((::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator*)_NativeInstance)->Next();
}

RDC::OCC::TColStd_ListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator::Value()
{
    ::TColStd_ListOfReal* _result = new ::TColStd_ListOfReal();
...
RDC::OCC::TColStd_ListOfReal^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator::ChangeValue()
{
    ::TColStd_ListOfReal* _result = new ::TColStd_ListOfReal();
...
RDC::OCC::TopoDS_Shape^ RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal::Iterator::Key()
{
...
RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::ShapeAnalysis_SequenceOfFreeBounds()
    : RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_SequenceOfFreeBounds();
}

RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::ShapeAnalysis_SequenceOfFreeBounds(RDC::OCC::NCollection_BaseAllocator^ theAllocator)
    : RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_SequenceOfFreeBounds(Handle(::NCollection_BaseAllocator)(theAllocator->NativeInstance));
}

int RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Size()
{
    int _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Size();
    return _result;
}

int RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Length()
{
    int _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Length();
    return _result;
}

int RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Lower()
{
    int _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Lower();
    return _result;
}

int RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Upper()
{
    int _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Upper();
    return _result;
}

bool RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::IsEmpty()
{
    bool _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->IsEmpty();
    return _result;
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Reverse()
{
    ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Reverse();
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Exchange(int I, int J)
{
    ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Exchange(I, J);
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator)
{
    ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Clear(Handle(::NCollection_BaseAllocator)(theAllocator->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Clear()
{
    ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Clear(0L);
}

RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Assign(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theOther)
{
    ...
    *_result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Assign(*(::ShapeAnalysis_SequenceOfFreeBounds*)theOther->NativeInstance);
    return _result==nullptr ? nullptr : gcnew RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds(_result);
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Remove(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator^ thePosition)
{
...
void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Append(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
    ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Append(Handle(::ShapeAnalysis_FreeBoundData)(theItem->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Prepend(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
    ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Prepend(Handle(::ShapeAnalysis_FreeBoundData)(theItem->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::InsertBefore(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
...
void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::InsertAfter(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator^ thePosition, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
...
void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Split(int theIndex, RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theSeq)
{
...
RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::First()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->First();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::ChangeFirst()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->ChangeFirst();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Last()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Last();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::ChangeLast()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->ChangeLast();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Value(int theIndex)
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->Value(theIndex);
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::ChangeValue(int theIndex)
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds*)_NativeInstance)->ChangeValue(theIndex);
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::SetValue(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
...
System::Collections::Generic::IEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::GetEnumerator()
{
    return gcnew IndexEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>(this, Lower(), Upper());
}

System::Collections::IEnumerator^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::GetEnumerator2()
{
    return gcnew IndexEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>(this, Lower(), Upper());
}
...
RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::Iterator()
    : RDC::OCC::BaseClass<::ShapeAnalysis_SequenceOfFreeBounds::Iterator>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_SequenceOfFreeBounds::Iterator();
}

bool RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::More()
{
    bool _result = ((::ShapeAnalysis_SequenceOfFreeBounds::Iterator*)_NativeInstance)->More();
    return _result;
}

void RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::Next()
{
    ((::ShapeAnalysis_SequenceOfFreeBounds::Iterator*)_NativeInstance)->Next();
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::Value()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds::Iterator*)_NativeInstance)->Value();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::ChangeValue()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_SequenceOfFreeBounds::Iterator*)_NativeInstance)->ChangeValue();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

bool RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::IsEqual(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator^ theOther)
{
...
bool RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::Equals(System::Object^ obj)
{
    ...
    System::Type^ myType = RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds::Iterator::GetType();
...
RDC::OCC::ShapeAnalysis::ShapeAnalysis()
    : RDC::OCC::BaseClass<::ShapeAnalysis>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis();
}

RDC::OCC::TopoDS_Wire^ RDC::OCC::ShapeAnalysis::OuterWire(RDC::OCC::TopoDS_Face^ theFace)
{
...
double RDC::OCC::ShapeAnalysis::ContourArea(RDC::OCC::TopoDS_Wire^ theWire)
{
    double _result = ::ShapeAnalysis::ContourArea(*(::TopoDS_Wire*)theWire->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis::IsOuterBound(RDC::OCC::TopoDS_Face^ face)
{
    bool _result = ::ShapeAnalysis::IsOuterBound(*(::TopoDS_Face*)face->NativeInstance);
    return _result;
}

double RDC::OCC::ShapeAnalysis::AdjustByPeriod(double Val, double ToVal, double Period)
{
    double _result = ::ShapeAnalysis::AdjustByPeriod(Val, ToVal, Period);
    return _result;
}

double RDC::OCC::ShapeAnalysis::AdjustToPeriod(double Val, double ValMin, double ValMax)
{
    double _result = ::ShapeAnalysis::AdjustToPeriod(Val, ValMin, ValMax);
    return _result;
}

void RDC::OCC::ShapeAnalysis::FindBounds(RDC::OCC::TopoDS_Shape^ shape, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2)
{
...
void RDC::OCC::ShapeAnalysis::GetFaceUVBounds(RDC::OCC::TopoDS_Face^ F, double% Umin, double% Umax, double% Vmin, double% Vmax)
{
...
RDC::OCC::ShapeAnalysis_CanonicalRecognition::ShapeAnalysis_CanonicalRecognition()
    : RDC::OCC::BaseClass<::ShapeAnalysis_CanonicalRecognition>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_CanonicalRecognition();
}

RDC::OCC::ShapeAnalysis_CanonicalRecognition::ShapeAnalysis_CanonicalRecognition(RDC::OCC::TopoDS_Shape^ theShape)
    : RDC::OCC::BaseClass<::ShapeAnalysis_CanonicalRecognition>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_CanonicalRecognition(*(::TopoDS_Shape*)theShape->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_CanonicalRecognition::SetShape(RDC::OCC::TopoDS_Shape^ theShape)
{
    ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->SetShape(*(::TopoDS_Shape*)theShape->NativeInstance);
}

RDC::OCC::TopoDS_Shape^ RDC::OCC::ShapeAnalysis_CanonicalRecognition::GetShape()
{
    ::TopoDS_Shape* _result = new ::TopoDS_Shape();
...
double RDC::OCC::ShapeAnalysis_CanonicalRecognition::GetGap()
{
    double _result = ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->GetGap();
    return _result;
}

int RDC::OCC::ShapeAnalysis_CanonicalRecognition::GetStatus()
{
    int _result = ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->GetStatus();
    return _result;
}

void RDC::OCC::ShapeAnalysis_CanonicalRecognition::ClearStatus()
{
    ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->ClearStatus();
}

bool RDC::OCC::ShapeAnalysis_CanonicalRecognition::IsPlane(double theTol, RDC::OCC::Pln% thePln)
{
...
bool RDC::OCC::ShapeAnalysis_CanonicalRecognition::IsCylinder(double theTol, RDC::OCC::gp_Cylinder^ theCyl)
{
    bool _result = ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->IsCylinder(theTol, *(::gp_Cylinder*)theCyl->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CanonicalRecognition::IsCone(double theTol, RDC::OCC::gp_Cone^ theCone)
{
    bool _result = ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->IsCone(theTol, *(::gp_Cone*)theCone->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CanonicalRecognition::IsSphere(double theTol, RDC::OCC::gp_Sphere^ theSphere)
{
    bool _result = ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->IsSphere(theTol, *(::gp_Sphere*)theSphere->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CanonicalRecognition::IsLine(double theTol, RDC::OCC::gp_Lin^ theLin)
{
    bool _result = ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->IsLine(theTol, *(::gp_Lin*)theLin->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CanonicalRecognition::IsCircle(double theTol, RDC::OCC::gp_Circ^ theCirc)
{
    bool _result = ((::ShapeAnalysis_CanonicalRecognition*)_NativeInstance)->IsCircle(theTol, *(::gp_Circ*)theCirc->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CanonicalRecognition::IsEllipse(double theTol, RDC::OCC::gp_Elips^ theElips)
{
...
RDC::OCC::ShapeAnalysis_CheckSmallFace::ShapeAnalysis_CheckSmallFace()
    : RDC::OCC::BaseClass<::ShapeAnalysis_CheckSmallFace>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_CheckSmallFace();
}

int RDC::OCC::ShapeAnalysis_CheckSmallFace::IsSpotFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Pnt% spot, double% spotol, double tol)
{
    pin_ptr<RDC::OCC::Pnt> pp_spot = &spot;
...
int RDC::OCC::ShapeAnalysis_CheckSmallFace::IsSpotFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::Pnt% spot, double% spotol)
{
    pin_ptr<RDC::OCC::Pnt> pp_spot = &spot;
    pin_ptr<double> pp_spotol = &spotol;
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckSpotFace(RDC::OCC::TopoDS_Face^ F, double tol)
{
    bool _result = ((::ShapeAnalysis_CheckSmallFace*)_NativeInstance)->CheckSpotFace(*(::TopoDS_Face*)F->NativeInstance, tol);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckSpotFace(RDC::OCC::TopoDS_Face^ F)
{
    bool _result = ((::ShapeAnalysis_CheckSmallFace*)_NativeInstance)->CheckSpotFace(*(::TopoDS_Face*)F->NativeInstance, -1.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CheckSmallFace::IsStripSupport(RDC::OCC::TopoDS_Face^ F, double tol)
{
    bool _result = ((::ShapeAnalysis_CheckSmallFace*)_NativeInstance)->IsStripSupport(*(::TopoDS_Face*)F->NativeInstance, tol);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CheckSmallFace::IsStripSupport(RDC::OCC::TopoDS_Face^ F)
{
    bool _result = ((::ShapeAnalysis_CheckSmallFace*)_NativeInstance)->IsStripSupport(*(::TopoDS_Face*)F->NativeInstance, -1.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckStripEdges(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol, double% dmax)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::FindStripEdges(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol, double% dmax)
{
    pin_ptr<double> pp_dmax = &dmax;
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckSingleStrip(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckSingleStrip(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckStripFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, double tol)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckStripFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2)
{
...
int RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckSplittingVertices(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ MapEdges, RDC::OCC::ShapeAnalysis_DataMapOfShapeListOfReal^ MapParam, RDC::OCC::TopoDS_Compound^ theAllVert)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckPin(RDC::OCC::TopoDS_Face^ F, int% whatrow, int% sence)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckTwisted(RDC::OCC::TopoDS_Face^ F, double% paramu, double% paramv)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckPinFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopTools_DataMapOfShapeShape^ mapEdges, double toler)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckPinFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopTools_DataMapOfShapeShape^ mapEdges)
{
...
bool RDC::OCC::ShapeAnalysis_CheckSmallFace::CheckPinEdges(RDC::OCC::TopoDS_Edge^ theFirstEdge, RDC::OCC::TopoDS_Edge^ theSecondEdge, double coef1, double coef2, double toler)
{
...
void RDC::OCC::ShapeAnalysis_CheckSmallFace::SetTolerance(double tol)
{
    ((::ShapeAnalysis_CheckSmallFace*)_NativeInstance)->SetTolerance(tol);
}

double RDC::OCC::ShapeAnalysis_CheckSmallFace::Tolerance()
{
...
RDC::OCC::ShapeAnalysis_Curve::ShapeAnalysis_Curve()
    : RDC::OCC::BaseClass<::ShapeAnalysis_Curve>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_Curve();
}

double RDC::OCC::ShapeAnalysis_Curve::Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, bool AdjustToEnds)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
...
double RDC::OCC::ShapeAnalysis_Curve::Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::Project(RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, bool AdjustToEnds)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::Project(RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl, bool AdjustToEnds)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::Project(RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::ProjectAct(RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::NextProject(double paramPrev, RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl, bool AdjustToEnds)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::NextProject(double paramPrev, RDC::OCC::Geom_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param, double cf, double cl)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
double RDC::OCC::ShapeAnalysis_Curve::NextProject(double paramPrev, RDC::OCC::Adaptor3d_Curve^ C3D, RDC::OCC::Pnt P3D, double preci, RDC::OCC::Pnt% proj, double% param)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
    pin_ptr<RDC::OCC::Pnt> pp_proj = &proj;
    pin_ptr<double> pp_param = &param;
...
bool RDC::OCC::ShapeAnalysis_Curve::ValidateRange(RDC::OCC::Geom_Curve^ Crv, double% First, double% Last, double prec)
{
...
void RDC::OCC::ShapeAnalysis_Curve::FillBndBox(RDC::OCC::Geom2d_Curve^ C2d, double First, double Last, int NPoints, bool Exact, RDC::OCC::Bnd_Box2d^ Box)
{
...
int RDC::OCC::ShapeAnalysis_Curve::SelectForwardSeam(RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2)
{
...
bool RDC::OCC::ShapeAnalysis_Curve::IsPlanar(RDC::OCC::TColgp_Array1OfPnt^ pnts, RDC::OCC::XYZ% Normal, double preci)
{
    pin_ptr<RDC::OCC::XYZ> pp_Normal = &Normal;
    bool _result = ::ShapeAnalysis_Curve::IsPlanar(*(::TColgp_Array1OfPnt*)pnts->NativeInstance, *(gp_XYZ*)pp_Normal, preci);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Curve::IsPlanar(RDC::OCC::TColgp_Array1OfPnt^ pnts, RDC::OCC::XYZ% Normal)
{
    pin_ptr<RDC::OCC::XYZ> pp_Normal = &Normal;
...
bool RDC::OCC::ShapeAnalysis_Curve::IsPlanar(RDC::OCC::Geom_Curve^ curve, RDC::OCC::XYZ% Normal, double preci)
{
    pin_ptr<RDC::OCC::XYZ> pp_Normal = &Normal;
...
bool RDC::OCC::ShapeAnalysis_Curve::IsPlanar(RDC::OCC::Geom_Curve^ curve, RDC::OCC::XYZ% Normal)
{
    pin_ptr<RDC::OCC::XYZ> pp_Normal = &Normal;
...
bool RDC::OCC::ShapeAnalysis_Curve::GetSamplePoints(RDC::OCC::Geom2d_Curve^ curve, double first, double last, RDC::OCC::TColgp_SequenceOfPnt2d^ seq)
{
...
bool RDC::OCC::ShapeAnalysis_Curve::GetSamplePoints(RDC::OCC::Geom_Curve^ curve, double first, double last, RDC::OCC::TColgp_SequenceOfPnt^ seq)
{
...
bool RDC::OCC::ShapeAnalysis_Curve::IsClosed(RDC::OCC::Geom_Curve^ curve, double preci)
{
    bool _result = ::ShapeAnalysis_Curve::IsClosed(Handle(::Geom_Curve)(curve->NativeInstance), preci);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Curve::IsClosed(RDC::OCC::Geom_Curve^ curve)
{
    bool _result = ::ShapeAnalysis_Curve::IsClosed(Handle(::Geom_Curve)(curve->NativeInstance), -1);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Curve::IsPeriodic(RDC::OCC::Geom_Curve^ curve)
{
    bool _result = ::ShapeAnalysis_Curve::IsPeriodic(Handle(::Geom_Curve)(curve->NativeInstance));
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Curve::IsPeriodic(RDC::OCC::Geom2d_Curve^ curve)
{
...
RDC::OCC::ShapeAnalysis_Edge::ShapeAnalysis_Edge()
    : RDC::OCC::BaseClass<::ShapeAnalysis_Edge>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_Edge();
}

bool RDC::OCC::ShapeAnalysis_Edge::HasCurve3d(RDC::OCC::TopoDS_Edge^ edge)
{
    bool _result = ((::ShapeAnalysis_Edge*)_NativeInstance)->HasCurve3d(*(::TopoDS_Edge*)edge->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Edge::Curve3d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Curve^ C3d, double% cf, double% cl, bool orient)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::Curve3d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Curve^ C3d, double% cf, double% cl)
{
    Handle(::Geom_Curve) h_C3d = C3d->NativeInstance;
    pin_ptr<double> pp_cf = &cf;
    pin_ptr<double> pp_cl = &cl;
...
bool RDC::OCC::ShapeAnalysis_Edge::IsClosed3d(RDC::OCC::TopoDS_Edge^ edge)
{
    bool _result = ((::ShapeAnalysis_Edge*)_NativeInstance)->IsClosed3d(*(::TopoDS_Edge*)edge->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Edge::HasPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::HasPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl, bool orient)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl)
{
    Handle(::Geom2d_Curve) h_C2d = C2d->NativeInstance;
    pin_ptr<double> pp_cf = &cf;
    pin_ptr<double> pp_cl = &cl;
...
bool RDC::OCC::ShapeAnalysis_Edge::PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl, bool orient)
{
    Handle(::Geom2d_Curve) h_C2d = C2d->NativeInstance;
    pin_ptr<double> pp_cf = &cf;
    pin_ptr<double> pp_cl = &cl;
...
bool RDC::OCC::ShapeAnalysis_Edge::PCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, RDC::OCC::Geom2d_Curve^ C2d, double% cf, double% cl)
{
    Handle(::Geom2d_Curve) h_C2d = C2d->NativeInstance;
    pin_ptr<double> pp_cf = &cf;
    pin_ptr<double> pp_cl = &cl;
...
bool RDC::OCC::ShapeAnalysis_Edge::BoundUV(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, RDC::OCC::Pnt2d% first, RDC::OCC::Pnt2d% last)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_first = &first;
    pin_ptr<RDC::OCC::Pnt2d> pp_last = &last;
...
bool RDC::OCC::ShapeAnalysis_Edge::BoundUV(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, RDC::OCC::Pnt2d% first, RDC::OCC::Pnt2d% last)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_first = &first;
    pin_ptr<RDC::OCC::Pnt2d> pp_last = &last;
...
bool RDC::OCC::ShapeAnalysis_Edge::IsSeam(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face)
{
    bool _result = ((::ShapeAnalysis_Edge*)_NativeInstance)->IsSeam(*(::TopoDS_Edge*)edge->NativeInstance, *(::TopoDS_Face*)face->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Edge::IsSeam(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location)
{
...
RDC::OCC::TopoDS_Vertex^ RDC::OCC::ShapeAnalysis_Edge::FirstVertex(RDC::OCC::TopoDS_Edge^ edge)
{
...
RDC::OCC::TopoDS_Vertex^ RDC::OCC::ShapeAnalysis_Edge::LastVertex(RDC::OCC::TopoDS_Edge^ edge)
{
    ::TopoDS_Vertex* _result = new ::TopoDS_Vertex();
...
bool RDC::OCC::ShapeAnalysis_Edge::GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang, double dparam)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_pos = &pos;
    pin_ptr<RDC::OCC::Vec2d> pp_tang = &tang;
...
bool RDC::OCC::ShapeAnalysis_Edge::GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_pos = &pos;
    pin_ptr<RDC::OCC::Vec2d> pp_tang = &tang;
...
bool RDC::OCC::ShapeAnalysis_Edge::GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang, double dparam)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_pos = &pos;
    pin_ptr<RDC::OCC::Vec2d> pp_tang = &tang;
...
bool RDC::OCC::ShapeAnalysis_Edge::GetEndTangent2d(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, bool atEnd, RDC::OCC::Pnt2d% pos, RDC::OCC::Vec2d% tang)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_pos = &pos;
    pin_ptr<RDC::OCC::Vec2d> pp_tang = &tang;
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithCurve3d(RDC::OCC::TopoDS_Edge^ edge, double preci, int vtx)
{
    bool _result = ((::ShapeAnalysis_Edge*)_NativeInstance)->CheckVerticesWithCurve3d(*(::TopoDS_Edge*)edge->NativeInstance, preci, vtx);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithCurve3d(RDC::OCC::TopoDS_Edge^ edge, double preci)
{
    bool _result = ((::ShapeAnalysis_Edge*)_NativeInstance)->CheckVerticesWithCurve3d(*(::TopoDS_Edge*)edge->NativeInstance, preci, 0);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithCurve3d(RDC::OCC::TopoDS_Edge^ edge)
{
    bool _result = ((::ShapeAnalysis_Edge*)_NativeInstance)->CheckVerticesWithCurve3d(*(::TopoDS_Edge*)edge->NativeInstance, -1, 0);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, double preci, int vtx)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, double preci)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, double preci, int vtx)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location, double preci)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVerticesWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVertexTolerance(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face, double% toler1, double% toler2)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckVertexTolerance(RDC::OCC::TopoDS_Edge^ edge, double% toler1, double% toler2)
{
    pin_ptr<double> pp_toler1 = &toler1;
    pin_ptr<double> pp_toler2 = &toler2;
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckCurve3dWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::TopoDS_Face^ face)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckCurve3dWithPCurve(RDC::OCC::TopoDS_Edge^ edge, RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckSameParameter(RDC::OCC::TopoDS_Edge^ edge, double% maxdev, int NbControl)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckSameParameter(RDC::OCC::TopoDS_Edge^ edge, double% maxdev)
{
    pin_ptr<double> pp_maxdev = &maxdev;
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckSameParameter(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace, double% theMaxdev, int theNbControl)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckSameParameter(RDC::OCC::TopoDS_Edge^ theEdge, RDC::OCC::TopoDS_Face^ theFace, double% theMaxdev)
{
    pin_ptr<double> pp_theMaxdev = &theMaxdev;
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckPCurveRange(double theFirst, double theLast, RDC::OCC::Geom2d_Curve^ thePC)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckOverlapping(RDC::OCC::TopoDS_Edge^ theEdge1, RDC::OCC::TopoDS_Edge^ theEdge2, double% theTolOverlap, double theDomainDist)
{
...
bool RDC::OCC::ShapeAnalysis_Edge::CheckOverlapping(RDC::OCC::TopoDS_Edge^ theEdge1, RDC::OCC::TopoDS_Edge^ theEdge2, double% theTolOverlap)
{
    pin_ptr<double> pp_theTolOverlap = &theTolOverlap;
...
RDC::OCC::ShapeAnalysis_FreeBoundData::ShapeAnalysis_FreeBoundData()
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_FreeBoundData();
}

RDC::OCC::ShapeAnalysis_FreeBoundData::ShapeAnalysis_FreeBoundData(RDC::OCC::TopoDS_Wire^ freebound)
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_FreeBoundData(*(::TopoDS_Wire*)freebound->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_FreeBoundData::Clear()
{
    ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->Clear();
}

void RDC::OCC::ShapeAnalysis_FreeBoundData::SetFreeBound(RDC::OCC::TopoDS_Wire^ freebound)
{
    ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->SetFreeBound(*(::TopoDS_Wire*)freebound->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_FreeBoundData::SetArea(double area)
{
    ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->SetArea(area);
}

void RDC::OCC::ShapeAnalysis_FreeBoundData::SetPerimeter(double perimeter)
{
    ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->SetPerimeter(perimeter);
}

void RDC::OCC::ShapeAnalysis_FreeBoundData::SetRatio(double ratio)
{
    ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->SetRatio(ratio);
}

void RDC::OCC::ShapeAnalysis_FreeBoundData::SetWidth(double width)
{
    ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->SetWidth(width);
}

void RDC::OCC::ShapeAnalysis_FreeBoundData::AddNotch(RDC::OCC::TopoDS_Wire^ notch, double width)
{
    ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->AddNotch(*(::TopoDS_Wire*)notch->NativeInstance, width);
}

RDC::OCC::TopoDS_Wire^ RDC::OCC::ShapeAnalysis_FreeBoundData::FreeBound()
{
    ::TopoDS_Wire* _result = new ::TopoDS_Wire();
...
double RDC::OCC::ShapeAnalysis_FreeBoundData::Area()
{
    double _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->Area();
    return _result;
}

double RDC::OCC::ShapeAnalysis_FreeBoundData::Perimeter()
{
    double _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->Perimeter();
    return _result;
}

double RDC::OCC::ShapeAnalysis_FreeBoundData::Ratio()
{
    double _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->Ratio();
    return _result;
}

double RDC::OCC::ShapeAnalysis_FreeBoundData::Width()
{
    double _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->Width();
    return _result;
}

int RDC::OCC::ShapeAnalysis_FreeBoundData::NbNotches()
{
    int _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->NbNotches();
    return _result;
}

RDC::OCC::TopTools_HSequenceOfShape^ RDC::OCC::ShapeAnalysis_FreeBoundData::Notches()
{
    Handle(::TopTools_HSequenceOfShape) _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->Notches();
    return _result.IsNull() ? nullptr : RDC::OCC::TopTools_HSequenceOfShape::CreateDowncasted(_result.get());
}

RDC::OCC::TopoDS_Wire^ RDC::OCC::ShapeAnalysis_FreeBoundData::Notch(int index)
{
    ::TopoDS_Wire* _result = new ::TopoDS_Wire();
...
double RDC::OCC::ShapeAnalysis_FreeBoundData::NotchWidth(int index)
{
    double _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->NotchWidth(index);
    return _result;
}

double RDC::OCC::ShapeAnalysis_FreeBoundData::NotchWidth(RDC::OCC::TopoDS_Wire^ notch)
{
    double _result = ((::ShapeAnalysis_FreeBoundData*)_NativeInstance)->NotchWidth(*(::TopoDS_Wire*)notch->NativeInstance);
    return _result;
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(::ShapeAnalysis_FreeBoundData* instance)
{
    return gcnew RDC::OCC::ShapeAnalysis_FreeBoundData( instance );
}
...
RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds()
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds();
}

RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double toler, bool splitclosed, bool splitopen)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds(*(::TopoDS_Shape*)shape->NativeInstance, toler, splitclosed, splitopen);
}

RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double toler, bool splitclosed)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds(*(::TopoDS_Shape*)shape->NativeInstance, toler, splitclosed, true);
}

RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, double toler)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds(*(::TopoDS_Shape*)shape->NativeInstance, toler, false, true);
}

RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed, bool splitopen, bool checkinternaledges)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds(*(::TopoDS_Shape*)shape->NativeInstance, splitclosed, splitopen, checkinternaledges);
}

RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed, bool splitopen)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds(*(::TopoDS_Shape*)shape->NativeInstance, splitclosed, splitopen, false);
}

RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds(*(::TopoDS_Shape*)shape->NativeInstance, splitclosed, true, false);
}

RDC::OCC::ShapeAnalysis_FreeBounds::ShapeAnalysis_FreeBounds(RDC::OCC::TopoDS_Shape^ shape)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBounds>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBounds(*(::TopoDS_Shape*)shape->NativeInstance, false, true, false);
}

RDC::OCC::TopoDS_Compound^ RDC::OCC::ShapeAnalysis_FreeBounds::GetClosedWires()
{
...
RDC::OCC::TopoDS_Compound^ RDC::OCC::ShapeAnalysis_FreeBounds::GetOpenWires()
{
    ::TopoDS_Compound* _result = new ::TopoDS_Compound();
...
void RDC::OCC::ShapeAnalysis_FreeBounds::ConnectEdgesToWires(RDC::OCC::TopTools_HSequenceOfShape^ edges, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ wires)
{
...
void RDC::OCC::ShapeAnalysis_FreeBounds::ConnectWiresToWires(RDC::OCC::TopTools_HSequenceOfShape^ iwires, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ owires)
{
...
void RDC::OCC::ShapeAnalysis_FreeBounds::ConnectWiresToWires(RDC::OCC::TopTools_HSequenceOfShape^ iwires, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ owires, RDC::OCC::TopTools_DataMapOfShapeShape^ vertices)
{
    Handle(::TopTools_HSequenceOfShape) h_iwires = iwires->NativeInstance;
    Handle(::TopTools_HSequenceOfShape) h_owires = owires->NativeInstance;
...
void RDC::OCC::ShapeAnalysis_FreeBounds::SplitWires(RDC::OCC::TopTools_HSequenceOfShape^ wires, double toler, bool shared, RDC::OCC::TopTools_HSequenceOfShape^ closed, RDC::OCC::TopTools_HSequenceOfShape^ open)
{
...
void RDC::OCC::ShapeAnalysis_FreeBounds::DispatchWires(RDC::OCC::TopTools_HSequenceOfShape^ wires, RDC::OCC::TopoDS_Compound^ closed, RDC::OCC::TopoDS_Compound^ open)
{
...
RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::ShapeAnalysis_HSequenceOfFreeBounds()
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_HSequenceOfFreeBounds();
}

RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::ShapeAnalysis_HSequenceOfFreeBounds(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theOther)
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_HSequenceOfFreeBounds(*(::ShapeAnalysis_SequenceOfFreeBounds*)theOther->NativeInstance);
}

RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Sequence()
{
    ::ShapeAnalysis_SequenceOfFreeBounds* _result = new ::ShapeAnalysis_SequenceOfFreeBounds();
...
void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Append(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Append(Handle(::ShapeAnalysis_FreeBoundData)(theItem->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Append(RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ theSequence)
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Append(*(::ShapeAnalysis_SequenceOfFreeBounds*)theSequence->NativeInstance);
}

RDC::OCC::ShapeAnalysis_SequenceOfFreeBounds^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::ChangeSequence()
{
    ::ShapeAnalysis_SequenceOfFreeBounds* _result = new ::ShapeAnalysis_SequenceOfFreeBounds();
...
int RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Size()
{
    int _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Size();
    return _result;
}

int RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Length()
{
    int _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Length();
    return _result;
}

int RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Lower()
{
    int _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Lower();
    return _result;
}

int RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Upper()
{
    int _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Upper();
    return _result;
}

bool RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::IsEmpty()
{
    bool _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->IsEmpty();
    return _result;
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Reverse()
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Reverse();
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Exchange(int I, int J)
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Exchange(I, J);
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Clear(RDC::OCC::NCollection_BaseAllocator^ theAllocator)
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Clear(Handle(::NCollection_BaseAllocator)(theAllocator->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Clear()
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Clear(0L);
}

RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Assign(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ theOther)
{
    throw gcnew System::NotImplementedException();
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Remove(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator^ thePosition)
{
...
void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Prepend(RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Prepend(Handle(::ShapeAnalysis_FreeBoundData)(theItem->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::InsertBefore(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
...
void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::InsertAfter(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator^ thePosition, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
...
void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Split(int theIndex, RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ theSeq)
{
...
RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::First()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->First();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::ChangeFirst()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->ChangeFirst();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Last()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Last();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::ChangeLast()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->ChangeLast();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Value(int theIndex)
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->Value(theIndex);
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::ChangeValue(int theIndex)
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds*)_NativeInstance)->ChangeValue(theIndex);
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::SetValue(int theIndex, RDC::OCC::ShapeAnalysis_FreeBoundData^ theItem)
{
...
RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::CreateDowncasted(::ShapeAnalysis_HSequenceOfFreeBounds* instance)
{
    return gcnew RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds( instance );
}

System::Collections::Generic::IEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::GetEnumerator()
{
    return gcnew IndexEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>(this, Lower(), Upper());
}

System::Collections::IEnumerator^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::GetEnumerator2()
{
    return gcnew IndexEnumerator<RDC::OCC::ShapeAnalysis_FreeBoundData^>(this, Lower(), Upper());
}
...
RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::Iterator()
    : RDC::OCC::BaseClass<::ShapeAnalysis_HSequenceOfFreeBounds::Iterator>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_HSequenceOfFreeBounds::Iterator();
}

bool RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::More()
{
    bool _result = ((::ShapeAnalysis_HSequenceOfFreeBounds::Iterator*)_NativeInstance)->More();
    return _result;
}

void RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::Next()
{
    ((::ShapeAnalysis_HSequenceOfFreeBounds::Iterator*)_NativeInstance)->Next();
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::Value()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds::Iterator*)_NativeInstance)->Value();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::ChangeValue()
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_HSequenceOfFreeBounds::Iterator*)_NativeInstance)->ChangeValue();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

bool RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::IsEqual(RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator^ theOther)
{
...
bool RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::Equals(System::Object^ obj)
{
    if(ReferenceEquals(this, obj))
    {
        return true;
    ...
    System::Type^ myType = RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::Iterator::GetType();
    System::Type^ objType = obj->GetType();
    if (myType->Equals(objType) || objType->IsSubclassOf(myType))
    {
        return NativeInstance->IsEqual(*((Iterator^)obj)->NativeInstance);
...
RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ShapeAnalysis_FreeBoundsProperties()
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBoundsProperties();
}

RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, double tolerance, bool splitclosed, bool splitopen)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBoundsProperties(*(::TopoDS_Shape*)shape->NativeInstance, tolerance, splitclosed, splitopen);
}

RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, double tolerance, bool splitclosed)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBoundsProperties(*(::TopoDS_Shape*)shape->NativeInstance, tolerance, splitclosed, false);
}

RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, double tolerance)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBoundsProperties(*(::TopoDS_Shape*)shape->NativeInstance, tolerance, false, false);
}

RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed, bool splitopen)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBoundsProperties(*(::TopoDS_Shape*)shape->NativeInstance, splitclosed, splitopen);
}

RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape, bool splitclosed)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBoundsProperties(*(::TopoDS_Shape*)shape->NativeInstance, splitclosed, false);
}

RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ShapeAnalysis_FreeBoundsProperties(RDC::OCC::TopoDS_Shape^ shape)
    : RDC::OCC::BaseClass<::ShapeAnalysis_FreeBoundsProperties>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_FreeBoundsProperties(*(::TopoDS_Shape*)shape->NativeInstance, false, false);
}

void RDC::OCC::ShapeAnalysis_FreeBoundsProperties::Init(RDC::OCC::TopoDS_Shape^ shape, double tolerance, bool splitclosed, bool splitopen)
{
...
double RDC::OCC::ShapeAnalysis_FreeBoundsProperties::Tolerance()
{
    double _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->Tolerance();
    return _result;
}

int RDC::OCC::ShapeAnalysis_FreeBoundsProperties::NbFreeBounds()
{
    int _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->NbFreeBounds();
    return _result;
}

int RDC::OCC::ShapeAnalysis_FreeBoundsProperties::NbClosedFreeBounds()
{
    int _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->NbClosedFreeBounds();
    return _result;
}

int RDC::OCC::ShapeAnalysis_FreeBoundsProperties::NbOpenFreeBounds()
{
    int _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->NbOpenFreeBounds();
    return _result;
}

RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ClosedFreeBounds()
{
    Handle(::ShapeAnalysis_HSequenceOfFreeBounds) _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->ClosedFreeBounds();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds^ RDC::OCC::ShapeAnalysis_FreeBoundsProperties::OpenFreeBounds()
{
    Handle(::ShapeAnalysis_HSequenceOfFreeBounds) _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->OpenFreeBounds();
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_HSequenceOfFreeBounds::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_FreeBoundsProperties::ClosedFreeBound(int index)
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->ClosedFreeBound(index);
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

RDC::OCC::ShapeAnalysis_FreeBoundData^ RDC::OCC::ShapeAnalysis_FreeBoundsProperties::OpenFreeBound(int index)
{
    Handle(::ShapeAnalysis_FreeBoundData) _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->OpenFreeBound(index);
    return _result.IsNull() ? nullptr : RDC::OCC::ShapeAnalysis_FreeBoundData::CreateDowncasted(_result.get());
}

bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::DispatchBounds()
{
    bool _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->DispatchBounds();
    return _result;
}

bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckContours(double prec)
{
    bool _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->CheckContours(prec);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckContours()
{
    bool _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->CheckContours(0.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckNotches(double prec)
{
    bool _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->CheckNotches(prec);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckNotches()
{
    bool _result = ((::ShapeAnalysis_FreeBoundsProperties*)_NativeInstance)->CheckNotches(0.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckNotches(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData, double prec)
{
...
bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckNotches(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData)
{
    Handle(::ShapeAnalysis_FreeBoundData) h_fbData = fbData->NativeInstance;
...
bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckNotches(RDC::OCC::TopoDS_Wire^ freebound, int num, RDC::OCC::TopoDS_Wire^ notch, double% distMax, double prec)
{
...
bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::CheckNotches(RDC::OCC::TopoDS_Wire^ freebound, int num, RDC::OCC::TopoDS_Wire^ notch, double% distMax)
{
    pin_ptr<double> pp_distMax = &distMax;
...
bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::FillProperties(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData, double prec)
{
    Handle(::ShapeAnalysis_FreeBoundData) h_fbData = fbData->NativeInstance;
...
bool RDC::OCC::ShapeAnalysis_FreeBoundsProperties::FillProperties(RDC::OCC::ShapeAnalysis_FreeBoundData^ fbData)
{
    Handle(::ShapeAnalysis_FreeBoundData) h_fbData = fbData->NativeInstance;
...
RDC::OCC::ShapeAnalysis_Geom::ShapeAnalysis_Geom()
    : RDC::OCC::BaseClass<::ShapeAnalysis_Geom>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_Geom();
}

bool RDC::OCC::ShapeAnalysis_Geom::NearestPlane(RDC::OCC::TColgp_Array1OfPnt^ Pnts, RDC::OCC::Pln% aPln, double% Dmax)
{
    pin_ptr<RDC::OCC::Pln> pp_aPln = &aPln;
    pin_ptr<double> pp_Dmax = &Dmax;
    bool _result = ::ShapeAnalysis_Geom::NearestPlane(*(::TColgp_Array1OfPnt*)Pnts->NativeInstance, *(gp_Pln*)pp_aPln, *(double*)pp_Dmax);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Geom::PositionTrsf(RDC::OCC::TColStd_HArray2OfReal^ coefs, RDC::OCC::Trsf% trsf, double unit, double prec)
{
    pin_ptr<RDC::OCC::Trsf> pp_trsf = &trsf;
...
RDC::OCC::ShapeAnalysis_ShapeTolerance::ShapeAnalysis_ShapeTolerance()
    : RDC::OCC::BaseClass<::ShapeAnalysis_ShapeTolerance>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_ShapeTolerance();
}

double RDC::OCC::ShapeAnalysis_ShapeTolerance::Tolerance(RDC::OCC::TopoDS_Shape^ shape, int mode, RDC::OCC::TopAbs_ShapeEnum type)
{
...
double RDC::OCC::ShapeAnalysis_ShapeTolerance::Tolerance(RDC::OCC::TopoDS_Shape^ shape, int mode)
{
...
RDC::OCC::TopTools_HSequenceOfShape^ RDC::OCC::ShapeAnalysis_ShapeTolerance::OverTolerance(RDC::OCC::TopoDS_Shape^ shape, double value, RDC::OCC::TopAbs_ShapeEnum type)
{
...
RDC::OCC::TopTools_HSequenceOfShape^ RDC::OCC::ShapeAnalysis_ShapeTolerance::OverTolerance(RDC::OCC::TopoDS_Shape^ shape, double value)
{
...
RDC::OCC::TopTools_HSequenceOfShape^ RDC::OCC::ShapeAnalysis_ShapeTolerance::InTolerance(RDC::OCC::TopoDS_Shape^ shape, double valmin, double valmax, RDC::OCC::TopAbs_ShapeEnum type)
{
...
RDC::OCC::TopTools_HSequenceOfShape^ RDC::OCC::ShapeAnalysis_ShapeTolerance::InTolerance(RDC::OCC::TopoDS_Shape^ shape, double valmin, double valmax)
{
...
void RDC::OCC::ShapeAnalysis_ShapeTolerance::InitTolerance()
{
    ((::ShapeAnalysis_ShapeTolerance*)_NativeInstance)->InitTolerance();
}

void RDC::OCC::ShapeAnalysis_ShapeTolerance::AddTolerance(RDC::OCC::TopoDS_Shape^ shape, RDC::OCC::TopAbs_ShapeEnum type)
{
    ((::ShapeAnalysis_ShapeTolerance*)_NativeInstance)->AddTolerance(*(::TopoDS_Shape*)shape->NativeInstance, (::TopAbs_ShapeEnum)type);
}

void RDC::OCC::ShapeAnalysis_ShapeTolerance::AddTolerance(RDC::OCC::TopoDS_Shape^ shape)
{
    ((::ShapeAnalysis_ShapeTolerance*)_NativeInstance)->AddTolerance(*(::TopoDS_Shape*)shape->NativeInstance, TopAbs_SHAPE);
}

double RDC::OCC::ShapeAnalysis_ShapeTolerance::GlobalTolerance(int mode)
{
...
RDC::OCC::ShapeAnalysis_Shell::ShapeAnalysis_Shell()
    : RDC::OCC::BaseClass<::ShapeAnalysis_Shell>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_Shell();
}

void RDC::OCC::ShapeAnalysis_Shell::Clear()
{
    ((::ShapeAnalysis_Shell*)_NativeInstance)->Clear();
}

void RDC::OCC::ShapeAnalysis_Shell::LoadShells(RDC::OCC::TopoDS_Shape^ shape)
{
    ((::ShapeAnalysis_Shell*)_NativeInstance)->LoadShells(*(::TopoDS_Shape*)shape->NativeInstance);
}

bool RDC::OCC::ShapeAnalysis_Shell::CheckOrientedShells(RDC::OCC::TopoDS_Shape^ shape, bool alsofree, bool checkinternaledges)
{
...
bool RDC::OCC::ShapeAnalysis_Shell::HasBadEdges()
{
    bool _result = ((::ShapeAnalysis_Shell*)_NativeInstance)->HasBadEdges();
    return _result;
}

RDC::OCC::TopoDS_Compound^ RDC::OCC::ShapeAnalysis_Shell::BadEdges()
{
    ::TopoDS_Compound* _result = new ::TopoDS_Compound();
...
bool RDC::OCC::ShapeAnalysis_Shell::HasFreeEdges()
{
    bool _result = ((::ShapeAnalysis_Shell*)_NativeInstance)->HasFreeEdges();
    return _result;
}

RDC::OCC::TopoDS_Compound^ RDC::OCC::ShapeAnalysis_Shell::FreeEdges()
{
    ::TopoDS_Compound* _result = new ::TopoDS_Compound();
...
bool RDC::OCC::ShapeAnalysis_Shell::HasConnectedEdges()
{
...
RDC::OCC::ShapeAnalysis_Surface::ShapeAnalysis_Surface(RDC::OCC::Geom_Surface^ S)
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_Surface(Handle(::Geom_Surface)(S->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_Surface::Init(RDC::OCC::Geom_Surface^ S)
{
    ((::ShapeAnalysis_Surface*)_NativeInstance)->Init(Handle(::Geom_Surface)(S->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_Surface::Init(RDC::OCC::ShapeAnalysis_Surface^ other)
{
    ((::ShapeAnalysis_Surface*)_NativeInstance)->Init(Handle(::ShapeAnalysis_Surface)(other->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_Surface::SetDomain(double U1, double U2, double V1, double V2)
{
    ((::ShapeAnalysis_Surface*)_NativeInstance)->SetDomain(U1, U2, V1, V2);
}

RDC::OCC::Geom_Surface^ RDC::OCC::ShapeAnalysis_Surface::Surface()
{
...
RDC::OCC::GeomAdaptor_Surface^ RDC::OCC::ShapeAnalysis_Surface::Adaptor3d()
{
    Handle(::GeomAdaptor_Surface) _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->Adaptor3d();
    return _result.IsNull() ? nullptr : RDC::OCC::GeomAdaptor_Surface::CreateDowncasted(_result.get());
}

RDC::OCC::GeomAdaptor_Surface^ RDC::OCC::ShapeAnalysis_Surface::TrueAdaptor3d()
{
    Handle(::GeomAdaptor_Surface) _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->TrueAdaptor3d();
    return _result.IsNull() ? nullptr : RDC::OCC::GeomAdaptor_Surface::CreateDowncasted(_result.get());
}

double RDC::OCC::ShapeAnalysis_Surface::Gap()
{
    double _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->Gap();
    return _result;
}

RDC::OCC::Pnt RDC::OCC::ShapeAnalysis_Surface::Value(double u, double v)
{
    ::gp_Pnt _nativeResult = ((::ShapeAnalysis_Surface*)_NativeInstance)->Value(u, v);
    return RDC::OCC::Pnt(_nativeResult);
}

RDC::OCC::Pnt RDC::OCC::ShapeAnalysis_Surface::Value(RDC::OCC::Pnt2d p2d)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_p2d = &p2d;
    ::gp_Pnt _nativeResult = ((::ShapeAnalysis_Surface*)_NativeInstance)->Value(*(gp_Pnt2d*)pp_p2d);
    return RDC::OCC::Pnt(_nativeResult);
}

bool RDC::OCC::ShapeAnalysis_Surface::HasSingularities(double preci)
{
    bool _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->HasSingularities(preci);
    return _result;
}

int RDC::OCC::ShapeAnalysis_Surface::NbSingularities(double preci)
{
    int _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->NbSingularities(preci);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Surface::Singularity(int num, double% preci, RDC::OCC::Pnt% P3d, RDC::OCC::Pnt2d% firstP2d, RDC::OCC::Pnt2d% lastP2d, double% firstpar, double% lastpar, bool% uisodeg)
{
    pin_ptr<double> pp_preci = &preci;
    pin_ptr<RDC::OCC::Pnt> pp_P3d = &P3d;
    pin_ptr<RDC::OCC::Pnt2d> pp_firstP2d = &firstP2d;
    pin_ptr<RDC::OCC::Pnt2d> pp_lastP2d = &lastP2d;
...
bool RDC::OCC::ShapeAnalysis_Surface::IsDegenerated(RDC::OCC::Pnt P3d, double preci)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3d = &P3d;
...
bool RDC::OCC::ShapeAnalysis_Surface::DegeneratedValues(RDC::OCC::Pnt P3d, double preci, RDC::OCC::Pnt2d% firstP2d, RDC::OCC::Pnt2d% lastP2d, double% firstpar, double% lastpar, bool forward)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3d = &P3d;
    pin_ptr<RDC::OCC::Pnt2d> pp_firstP2d = &firstP2d;
    pin_ptr<RDC::OCC::Pnt2d> pp_lastP2d = &lastP2d;
...
bool RDC::OCC::ShapeAnalysis_Surface::DegeneratedValues(RDC::OCC::Pnt P3d, double preci, RDC::OCC::Pnt2d% firstP2d, RDC::OCC::Pnt2d% lastP2d, double% firstpar, double% lastpar)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3d = &P3d;
    pin_ptr<RDC::OCC::Pnt2d> pp_firstP2d = &firstP2d;
    pin_ptr<RDC::OCC::Pnt2d> pp_lastP2d = &lastP2d;
...
bool RDC::OCC::ShapeAnalysis_Surface::ProjectDegenerated(RDC::OCC::Pnt P3d, double preci, RDC::OCC::Pnt2d neighbour, RDC::OCC::Pnt2d% result)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3d = &P3d;
    pin_ptr<RDC::OCC::Pnt2d> pp_neighbour = &neighbour;
    pin_ptr<RDC::OCC::Pnt2d> pp_result = &result;
...
bool RDC::OCC::ShapeAnalysis_Surface::ProjectDegenerated(int nbrPnt, RDC::OCC::TColgp_SequenceOfPnt^ points, RDC::OCC::TColgp_SequenceOfPnt2d^ pnt2d, double preci, bool direct)
{
...
bool RDC::OCC::ShapeAnalysis_Surface::IsDegenerated(RDC::OCC::Pnt2d p2d1, RDC::OCC::Pnt2d p2d2, double tol, double ratio)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_p2d1 = &p2d1;
    pin_ptr<RDC::OCC::Pnt2d> pp_p2d2 = &p2d2;
    bool _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->IsDegenerated(*(gp_Pnt2d*)pp_p2d1, *(gp_Pnt2d*)pp_p2d2, tol, ratio);
    return _result;
}

void RDC::OCC::ShapeAnalysis_Surface::Bounds(double% ufirst, double% ulast, double% vfirst, double% vlast)
{
...
void RDC::OCC::ShapeAnalysis_Surface::ComputeBoundIsos()
{
    ((::ShapeAnalysis_Surface*)_NativeInstance)->ComputeBoundIsos();
}

RDC::OCC::Geom_Curve^ RDC::OCC::ShapeAnalysis_Surface::UIso(double U)
{
...
RDC::OCC::Geom_Curve^ RDC::OCC::ShapeAnalysis_Surface::VIso(double V)
{
    Handle(::Geom_Curve) _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->VIso(V);
    return _result.IsNull() ? nullptr : RDC::OCC::Geom_Curve::CreateDowncasted(_result.get());
}

bool RDC::OCC::ShapeAnalysis_Surface::IsUClosed(double preci)
{
    bool _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->IsUClosed(preci);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Surface::IsUClosed()
{
    bool _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->IsUClosed(-1);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Surface::IsVClosed(double preci)
{
    bool _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->IsVClosed(preci);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Surface::IsVClosed()
{
    bool _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->IsVClosed(-1);
    return _result;
}

RDC::OCC::Pnt2d RDC::OCC::ShapeAnalysis_Surface::ValueOfUV(RDC::OCC::Pnt P3D, double preci)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
...
RDC::OCC::Pnt2d RDC::OCC::ShapeAnalysis_Surface::NextValueOfUV(RDC::OCC::Pnt2d p2dPrev, RDC::OCC::Pnt P3D, double preci, double maxpreci)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_p2dPrev = &p2dPrev;
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
...
RDC::OCC::Pnt2d RDC::OCC::ShapeAnalysis_Surface::NextValueOfUV(RDC::OCC::Pnt2d p2dPrev, RDC::OCC::Pnt P3D, double preci)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_p2dPrev = &p2dPrev;
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
...
double RDC::OCC::ShapeAnalysis_Surface::UVFromIso(RDC::OCC::Pnt P3D, double preci, double% U, double% V)
{
    pin_ptr<RDC::OCC::Pnt> pp_P3D = &P3D;
...
double RDC::OCC::ShapeAnalysis_Surface::UCloseVal()
{
    double _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->UCloseVal();
    return _result;
}

double RDC::OCC::ShapeAnalysis_Surface::VCloseVal()
{
    double _result = ((::ShapeAnalysis_Surface*)_NativeInstance)->VCloseVal();
    return _result;
}

RDC::OCC::Bnd_Box^ RDC::OCC::ShapeAnalysis_Surface::GetBoxUF()
{
...
RDC::OCC::Bnd_Box^ RDC::OCC::ShapeAnalysis_Surface::GetBoxUL()
{
    ::Bnd_Box* _result = new ::Bnd_Box();
...
RDC::OCC::Bnd_Box^ RDC::OCC::ShapeAnalysis_Surface::GetBoxVF()
{
    ::Bnd_Box* _result = new ::Bnd_Box();
...
RDC::OCC::Bnd_Box^ RDC::OCC::ShapeAnalysis_Surface::GetBoxVL()
{
    ::Bnd_Box* _result = new ::Bnd_Box();
...
RDC::OCC::ShapeAnalysis_Surface^ RDC::OCC::ShapeAnalysis_Surface::CreateDowncasted(::ShapeAnalysis_Surface* instance)
{
    return gcnew RDC::OCC::ShapeAnalysis_Surface( instance );
}
...
RDC::OCC::ShapeAnalysis_TransferParameters::ShapeAnalysis_TransferParameters()
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_TransferParameters();
}

RDC::OCC::ShapeAnalysis_TransferParameters::ShapeAnalysis_TransferParameters(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F)
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_TransferParameters(*(::TopoDS_Edge*)E->NativeInstance, *(::TopoDS_Face*)F->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_TransferParameters::Init(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F)
{
    ((::ShapeAnalysis_TransferParameters*)_NativeInstance)->Init(*(::TopoDS_Edge*)E->NativeInstance, *(::TopoDS_Face*)F->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_TransferParameters::SetMaxTolerance(double maxtol)
{
    ((::ShapeAnalysis_TransferParameters*)_NativeInstance)->SetMaxTolerance(maxtol);
}

RDC::OCC::TColStd_HSequenceOfReal^ RDC::OCC::ShapeAnalysis_TransferParameters::Perform(RDC::OCC::TColStd_HSequenceOfReal^ Params, bool To2d)
{
...
double RDC::OCC::ShapeAnalysis_TransferParameters::Perform(double Param, bool To2d)
{
    double _result = ((::ShapeAnalysis_TransferParameters*)_NativeInstance)->Perform(Param, To2d);
    return _result;
}

void RDC::OCC::ShapeAnalysis_TransferParameters::TransferRange(RDC::OCC::TopoDS_Edge^ newEdge, double prevPar, double currPar, bool To2d)
{
    ((::ShapeAnalysis_TransferParameters*)_NativeInstance)->TransferRange(*(::TopoDS_Edge*)newEdge->NativeInstance, prevPar, currPar, To2d);
}

bool RDC::OCC::ShapeAnalysis_TransferParameters::IsSameRange()
{
    bool _result = ((::ShapeAnalysis_TransferParameters*)_NativeInstance)->IsSameRange();
    return _result;
}

RDC::OCC::ShapeAnalysis_TransferParameters^ RDC::OCC::ShapeAnalysis_TransferParameters::CreateDowncasted(::ShapeAnalysis_TransferParameters* instance)
{
    if( instance == nullptr )
        return nullptr;
    
    if (instance->IsKind(STANDARD_TYPE(::ShapeAnalysis_TransferParametersProj)))
        return RDC::OCC::ShapeAnalysis_TransferParametersProj::CreateDowncasted((::ShapeAnalysis_TransferParametersProj*)instance);
    
    return gcnew RDC::OCC::ShapeAnalysis_TransferParameters( instance );
}
...
RDC::OCC::ShapeAnalysis_TransferParametersProj::ShapeAnalysis_TransferParametersProj()
    : RDC::OCC::ShapeAnalysis_TransferParameters(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_TransferParametersProj();
}

RDC::OCC::ShapeAnalysis_TransferParametersProj::ShapeAnalysis_TransferParametersProj(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F)
    : RDC::OCC::ShapeAnalysis_TransferParameters(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_TransferParametersProj(*(::TopoDS_Edge*)E->NativeInstance, *(::TopoDS_Face*)F->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_TransferParametersProj::Init(RDC::OCC::TopoDS_Edge^ E, RDC::OCC::TopoDS_Face^ F)
{
    ((::ShapeAnalysis_TransferParametersProj*)_NativeInstance)->Init(*(::TopoDS_Edge*)E->NativeInstance, *(::TopoDS_Face*)F->NativeInstance);
}

RDC::OCC::TColStd_HSequenceOfReal^ RDC::OCC::ShapeAnalysis_TransferParametersProj::Perform(RDC::OCC::TColStd_HSequenceOfReal^ Papams, bool To2d)
{
...
double RDC::OCC::ShapeAnalysis_TransferParametersProj::Perform(double Param, bool To2d)
{
    double _result = ((::ShapeAnalysis_TransferParametersProj*)_NativeInstance)->Perform(Param, To2d);
    return _result;
}

void RDC::OCC::ShapeAnalysis_TransferParametersProj::TransferRange(RDC::OCC::TopoDS_Edge^ newEdge, double prevPar, double currPar, bool Is2d)
{
...
bool RDC::OCC::ShapeAnalysis_TransferParametersProj::IsSameRange()
{
    bool _result = ((::ShapeAnalysis_TransferParametersProj*)_NativeInstance)->IsSameRange();
    return _result;
}

RDC::OCC::TopoDS_Vertex^ RDC::OCC::ShapeAnalysis_TransferParametersProj::CopyNMVertex(RDC::OCC::TopoDS_Vertex^ theVert, RDC::OCC::TopoDS_Edge^ toedge, RDC::OCC::TopoDS_Edge^ fromedge)
{
    ::TopoDS_Vertex* _result = new ::TopoDS_Vertex();
...
RDC::OCC::TopoDS_Vertex^ RDC::OCC::ShapeAnalysis_TransferParametersProj::CopyNMVertex(RDC::OCC::TopoDS_Vertex^ theVert, RDC::OCC::TopoDS_Face^ toFace, RDC::OCC::TopoDS_Face^ fromFace)
{
    ::TopoDS_Vertex* _result = new ::TopoDS_Vertex();
...
RDC::OCC::ShapeAnalysis_TransferParametersProj^ RDC::OCC::ShapeAnalysis_TransferParametersProj::CreateDowncasted(::ShapeAnalysis_TransferParametersProj* instance)
{
    return gcnew RDC::OCC::ShapeAnalysis_TransferParametersProj( instance );
}
...
RDC::OCC::ShapeAnalysis_WireOrder::ShapeAnalysis_WireOrder()
    : RDC::OCC::BaseClass<::ShapeAnalysis_WireOrder>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_WireOrder();
}

RDC::OCC::ShapeAnalysis_WireOrder::ShapeAnalysis_WireOrder(bool theMode3D, double theTolerance, bool theModeBoth)
    : RDC::OCC::BaseClass<::ShapeAnalysis_WireOrder>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_WireOrder(theMode3D, theTolerance, theModeBoth);
}

RDC::OCC::ShapeAnalysis_WireOrder::ShapeAnalysis_WireOrder(bool theMode3D, double theTolerance)
    : RDC::OCC::BaseClass<::ShapeAnalysis_WireOrder>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_WireOrder(theMode3D, theTolerance, false);
}

void RDC::OCC::ShapeAnalysis_WireOrder::SetMode(bool theMode3D, double theTolerance, bool theModeBoth)
{
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->SetMode(theMode3D, theTolerance, theModeBoth);
}

void RDC::OCC::ShapeAnalysis_WireOrder::SetMode(bool theMode3D, double theTolerance)
{
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->SetMode(theMode3D, theTolerance, false);
}

double RDC::OCC::ShapeAnalysis_WireOrder::Tolerance()
{
    double _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Tolerance();
    return _result;
}

void RDC::OCC::ShapeAnalysis_WireOrder::Clear()
{
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Clear();
}

void RDC::OCC::ShapeAnalysis_WireOrder::Add(RDC::OCC::XYZ theStart3d, RDC::OCC::XYZ theEnd3d)
{
    pin_ptr<RDC::OCC::XYZ> pp_theStart3d = &theStart3d;
    pin_ptr<RDC::OCC::XYZ> pp_theEnd3d = &theEnd3d;
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Add(*(gp_XYZ*)pp_theStart3d, *(gp_XYZ*)pp_theEnd3d);
}

void RDC::OCC::ShapeAnalysis_WireOrder::Add(RDC::OCC::XY theStart2d, RDC::OCC::XY theEnd2d)
{
    pin_ptr<RDC::OCC::XY> pp_theStart2d = &theStart2d;
    pin_ptr<RDC::OCC::XY> pp_theEnd2d = &theEnd2d;
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Add(*(gp_XY*)pp_theStart2d, *(gp_XY*)pp_theEnd2d);
}

void RDC::OCC::ShapeAnalysis_WireOrder::Add(RDC::OCC::XYZ theStart3d, RDC::OCC::XYZ theEnd3d, RDC::OCC::XY theStart2d, RDC::OCC::XY theEnd2d)
{
    pin_ptr<RDC::OCC::XYZ> pp_theStart3d = &theStart3d;
    pin_ptr<RDC::OCC::XYZ> pp_theEnd3d = &theEnd3d;
    pin_ptr<RDC::OCC::XY> pp_theStart2d = &theStart2d;
...
int RDC::OCC::ShapeAnalysis_WireOrder::NbEdges()
{
    int _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->NbEdges();
    return _result;
}

void RDC::OCC::ShapeAnalysis_WireOrder::Perform(bool closed)
{
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Perform(closed);
}

void RDC::OCC::ShapeAnalysis_WireOrder::Perform()
{
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Perform(true);
}

bool RDC::OCC::ShapeAnalysis_WireOrder::IsDone()
{
    bool _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->IsDone();
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireOrder::Status()
{
    int _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Status();
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireOrder::Ordered(int theIdx)
{
    int _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Ordered(theIdx);
    return _result;
}

void RDC::OCC::ShapeAnalysis_WireOrder::XYZ(int theIdx, RDC::OCC::XYZ% theStart3D, RDC::OCC::XYZ% theEnd3D)
{
    pin_ptr<RDC::OCC::XYZ> pp_theStart3D = &theStart3D;
    pin_ptr<RDC::OCC::XYZ> pp_theEnd3D = &theEnd3D;
...
void RDC::OCC::ShapeAnalysis_WireOrder::XY(int theIdx, RDC::OCC::XY% theStart2D, RDC::OCC::XY% theEnd2D)
{
    pin_ptr<RDC::OCC::XY> pp_theStart2D = &theStart2D;
    pin_ptr<RDC::OCC::XY> pp_theEnd2D = &theEnd2D;
...
double RDC::OCC::ShapeAnalysis_WireOrder::Gap(int num)
{
    double _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Gap(num);
    return _result;
}

double RDC::OCC::ShapeAnalysis_WireOrder::Gap()
{
    double _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->Gap(0);
    return _result;
}

void RDC::OCC::ShapeAnalysis_WireOrder::SetChains(double gap)
{
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->SetChains(gap);
}

int RDC::OCC::ShapeAnalysis_WireOrder::NbChains()
{
    int _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->NbChains();
    return _result;
}

void RDC::OCC::ShapeAnalysis_WireOrder::Chain(int num, int% n1, int% n2)
{
...
void RDC::OCC::ShapeAnalysis_WireOrder::SetCouples(double gap)
{
    ((::ShapeAnalysis_WireOrder*)_NativeInstance)->SetCouples(gap);
}

int RDC::OCC::ShapeAnalysis_WireOrder::NbCouples()
{
    int _result = ((::ShapeAnalysis_WireOrder*)_NativeInstance)->NbCouples();
    return _result;
}

void RDC::OCC::ShapeAnalysis_WireOrder::Couple(int num, int% n1, int% n2)
{
    pin_ptr<int> pp_n1 = &n1;
    pin_ptr<int> pp_n2 = &n2;
...
RDC::OCC::ShapeAnalysis_Wire::ShapeAnalysis_Wire()
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_Wire();
}

RDC::OCC::ShapeAnalysis_Wire::ShapeAnalysis_Wire(RDC::OCC::TopoDS_Wire^ wire, RDC::OCC::TopoDS_Face^ face, double precision)
    : RDC::OCC::Standard_Transient(BaseClass::InitMode::Uninitialized)
{
    NativeInstance = new ::ShapeAnalysis_Wire(*(::TopoDS_Wire*)wire->NativeInstance, *(::TopoDS_Face*)face->NativeInstance, precision);
}

void RDC::OCC::ShapeAnalysis_Wire::Init(RDC::OCC::TopoDS_Wire^ wire, RDC::OCC::TopoDS_Face^ face, double precision)
{
    ((::ShapeAnalysis_Wire*)_NativeInstance)->Init(*(::TopoDS_Wire*)wire->NativeInstance, *(::TopoDS_Face*)face->NativeInstance, precision);
}

void RDC::OCC::ShapeAnalysis_Wire::Load(RDC::OCC::TopoDS_Wire^ wire)
{
    ((::ShapeAnalysis_Wire*)_NativeInstance)->Load(*(::TopoDS_Wire*)wire->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_Wire::SetFace(RDC::OCC::TopoDS_Face^ face)
{
    ((::ShapeAnalysis_Wire*)_NativeInstance)->SetFace(*(::TopoDS_Face*)face->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_Wire::SetSurface(RDC::OCC::Geom_Surface^ surface)
{
    ((::ShapeAnalysis_Wire*)_NativeInstance)->SetSurface(Handle(::Geom_Surface)(surface->NativeInstance));
}

void RDC::OCC::ShapeAnalysis_Wire::SetSurface(RDC::OCC::Geom_Surface^ surface, RDC::OCC::TopLoc_Location^ location)
{
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckOrder(RDC::OCC::ShapeAnalysis_WireOrder^ sawo, bool isClosed, bool theMode3D)
{
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckOrder(RDC::OCC::ShapeAnalysis_WireOrder^ sawo, bool isClosed)
{
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckOrder(RDC::OCC::ShapeAnalysis_WireOrder^ sawo)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckOrder(*(::ShapeAnalysis_WireOrder*)sawo->NativeInstance, true, true, false);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckConnected(int num, double prec)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckConnected(num, prec);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckConnected(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckConnected(num, 0.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckSmall(int num, double precsmall)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckSmall(num, precsmall);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckSmall(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckSmall(num, 0.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckSeam(int num, RDC::OCC::Geom2d_Curve^ C1, RDC::OCC::Geom2d_Curve^ C2, double% cf, double% cl)
{
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckSeam(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckSeam(num);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckDegenerated(int num, RDC::OCC::Pnt2d% dgnr1, RDC::OCC::Pnt2d% dgnr2)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_dgnr1 = &dgnr1;
    pin_ptr<RDC::OCC::Pnt2d> pp_dgnr2 = &dgnr2;
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckDegenerated(num, *(gp_Pnt2d*)pp_dgnr1, *(gp_Pnt2d*)pp_dgnr2);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckDegenerated(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckDegenerated(num);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckGap3d(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckGap3d(num);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckGap3d()
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckGap3d(0);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckGap2d(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckGap2d(num);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckGap2d()
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckGap2d(0);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckCurveGap(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckCurveGap(num);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckCurveGap()
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckCurveGap(0);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckSelfIntersectingEdge(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckSelfIntersectingEdge(num);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckIntersectingEdges(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckIntersectingEdges(num);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckIntersectingEdges(int num1, int num2)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckIntersectingEdges(num1, num2);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckLacking(int num, double Tolerance, RDC::OCC::Pnt2d% p2d1, RDC::OCC::Pnt2d% p2d2)
{
    pin_ptr<RDC::OCC::Pnt2d> pp_p2d1 = &p2d1;
    pin_ptr<RDC::OCC::Pnt2d> pp_p2d2 = &p2d2;
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckLacking(int num, double Tolerance)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckLacking(num, Tolerance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckLacking(int num)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckLacking(num, 0.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckOuterBound(bool APIMake)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckOuterBound(APIMake);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckOuterBound()
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckOuterBound(true);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckNotchedEdges(int num, int% shortNum, double% param, double Tolerance)
{
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckNotchedEdges(int num, int% shortNum, double% param)
{
    pin_ptr<int> pp_shortNum = &shortNum;
    pin_ptr<double> pp_param = &param;
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckSmallArea(RDC::OCC::TopoDS_Wire^ theWire)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckSmallArea(*(::TopoDS_Wire*)theWire->NativeInstance);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckShapeConnect(RDC::OCC::TopoDS_Shape^ shape, double prec)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckShapeConnect(*(::TopoDS_Shape*)shape->NativeInstance, prec);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckShapeConnect(RDC::OCC::TopoDS_Shape^ shape)
{
    bool _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->CheckShapeConnect(*(::TopoDS_Shape*)shape->NativeInstance, 0.);
    return _result;
}

bool RDC::OCC::ShapeAnalysis_Wire::CheckShapeConnect(double% tailhead, double% tailtail, double% headtail, double% headhead, RDC::OCC::TopoDS_Shape^ shape, double prec)
{
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckShapeConnect(double% tailhead, double% tailtail, double% headtail, double% headhead, RDC::OCC::TopoDS_Shape^ shape)
{
    pin_ptr<double> pp_tailhead = &tailhead;
    pin_ptr<double> pp_tailtail = &tailtail;
    pin_ptr<double> pp_headtail = &headtail;
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckLoop(RDC::OCC::TopTools_IndexedMapOfShape^ aMapLoopVertices, RDC::OCC::TopTools_DataMapOfShapeListOfShape^ aMapVertexEdges, RDC::OCC::TopTools_MapOfShape^ aMapSmallEdges, RDC::OCC::TopTools_MapOfShape^ aMapSeemEdges)
{
...
bool RDC::OCC::ShapeAnalysis_Wire::CheckTail(RDC::OCC::TopoDS_Edge^ theEdge1, RDC::OCC::TopoDS_Edge^ theEdge2, double theMaxSine, double theMaxWidth, double theMaxTolerance, RDC::OCC::TopoDS_Edge^ theEdge11, RDC::OCC::TopoDS_Edge^ theEdge12, RDC::OCC::TopoDS_Edge^ theEdge21, RDC::OCC::TopoDS_Edge^ theEdge22)
{
...
double RDC::OCC::ShapeAnalysis_Wire::MinDistance3d()
{
    double _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->MinDistance3d();
    return _result;
}

double RDC::OCC::ShapeAnalysis_Wire::MinDistance2d()
{
    double _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->MinDistance2d();
    return _result;
}

double RDC::OCC::ShapeAnalysis_Wire::MaxDistance3d()
{
    double _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->MaxDistance3d();
    return _result;
}

double RDC::OCC::ShapeAnalysis_Wire::MaxDistance2d()
{
    double _result = ((::ShapeAnalysis_Wire*)_NativeInstance)->MaxDistance2d();
    return _result;
}

RDC::OCC::ShapeAnalysis_Wire^ RDC::OCC::ShapeAnalysis_Wire::CreateDowncasted(::ShapeAnalysis_Wire* instance)
{
    return gcnew RDC::OCC::ShapeAnalysis_Wire( instance );
}
...
RDC::OCC::ShapeAnalysis_WireVertex::ShapeAnalysis_WireVertex()
    : RDC::OCC::BaseClass<::ShapeAnalysis_WireVertex>(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::ShapeAnalysis_WireVertex();
}

void RDC::OCC::ShapeAnalysis_WireVertex::Init(RDC::OCC::TopoDS_Wire^ wire, double preci)
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->Init(*(::TopoDS_Wire*)wire->NativeInstance, preci);
}

void RDC::OCC::ShapeAnalysis_WireVertex::Load(RDC::OCC::TopoDS_Wire^ wire)
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->Load(*(::TopoDS_Wire*)wire->NativeInstance);
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetPrecision(double preci)
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetPrecision(preci);
}

void RDC::OCC::ShapeAnalysis_WireVertex::Analyze()
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->Analyze();
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetSameVertex(int num)
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetSameVertex(num);
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetSameCoords(int num)
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetSameCoords(num);
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetClose(int num)
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetClose(num);
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetEnd(int num, RDC::OCC::XYZ pos, double ufol)
{
    pin_ptr<RDC::OCC::XYZ> pp_pos = &pos;
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetEnd(num, *(gp_XYZ*)pp_pos, ufol);
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetStart(int num, RDC::OCC::XYZ pos, double upre)
{
    pin_ptr<RDC::OCC::XYZ> pp_pos = &pos;
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetStart(num, *(gp_XYZ*)pp_pos, upre);
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetInters(int num, RDC::OCC::XYZ pos, double upre, double ufol)
{
    pin_ptr<RDC::OCC::XYZ> pp_pos = &pos;
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetInters(num, *(gp_XYZ*)pp_pos, upre, ufol);
}

void RDC::OCC::ShapeAnalysis_WireVertex::SetDisjoined(int num)
{
    ((::ShapeAnalysis_WireVertex*)_NativeInstance)->SetDisjoined(num);
}

bool RDC::OCC::ShapeAnalysis_WireVertex::IsDone()
{
    bool _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->IsDone();
    return _result;
}

double RDC::OCC::ShapeAnalysis_WireVertex::Precision()
{
    double _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->Precision();
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireVertex::NbEdges()
{
    int _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->NbEdges();
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireVertex::Status(int num)
{
    int _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->Status(num);
    return _result;
}

RDC::OCC::XYZ RDC::OCC::ShapeAnalysis_WireVertex::Position(int num)
{
    ::gp_XYZ _nativeResult = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->Position(num);
    return RDC::OCC::XYZ(_nativeResult);
}

double RDC::OCC::ShapeAnalysis_WireVertex::UPrevious(int num)
{
    double _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->UPrevious(num);
    return _result;
}

double RDC::OCC::ShapeAnalysis_WireVertex::UFollowing(int num)
{
    double _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->UFollowing(num);
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireVertex::Data(int num, RDC::OCC::XYZ% pos, double% upre, double% ufol)
{
    pin_ptr<RDC::OCC::XYZ> pp_pos = &pos;
...
int RDC::OCC::ShapeAnalysis_WireVertex::NextStatus(int stat, int num)
{
    int _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->NextStatus(stat, num);
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireVertex::NextStatus(int stat)
{
    int _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->NextStatus(stat, 0);
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireVertex::NextCriter(int crit, int num)
{
    int _result = ((::ShapeAnalysis_WireVertex*)_NativeInstance)->NextCriter(crit, num);
    return _result;
}

int RDC::OCC::ShapeAnalysis_WireVertex::NextCriter(int crit)
{
