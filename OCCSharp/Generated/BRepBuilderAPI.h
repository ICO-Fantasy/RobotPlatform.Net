...
namespace RDC
{
	namespace OCC
	{
		...
		public ref class BRepBuilderAPI_BndBoxTree sealed
			: public RDC::OCC::BaseClass<::BRepBuilderAPI_BndBoxTree>
		{
		...
		public:
			BRepBuilderAPI_BndBoxTree(::BRepBuilderAPI_BndBoxTree* nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_BndBoxTree>(nativeInstance, true)
			{}

			BRepBuilderAPI_BndBoxTree(::BRepBuilderAPI_BndBoxTree& nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_BndBoxTree>(&nativeInstance, false)
			{}
		...
		public:
			...
			BRepBuilderAPI_BndBoxTree(RDC::OCC::NCollection_BaseAllocator^ theAllocator);
		...
		public ref class BRepBuilderAPI sealed
			: public RDC::OCC::BaseClass<::BRepBuilderAPI>
		{
		...
		public:
			BRepBuilderAPI(::BRepBuilderAPI* nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI>(nativeInstance, true)
			{}

			BRepBuilderAPI(::BRepBuilderAPI& nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI>(&nativeInstance, false)
			{}
		...
		public ref class BRepBuilderAPI_VertexInspector sealed
			: public RDC::OCC::BaseClass<::BRepBuilderAPI_VertexInspector>
		{
		...
		public:
			BRepBuilderAPI_VertexInspector(::BRepBuilderAPI_VertexInspector* nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_VertexInspector>(nativeInstance, true)
			{}

			BRepBuilderAPI_VertexInspector(::BRepBuilderAPI_VertexInspector& nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_VertexInspector>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			void SetCurrent(RDC::OCC::XYZ theCurPnt);
			/// <summary>
			/// Get list of indexes of points adjacent with the current
			/// </summary>
			RDC::OCC::TColStd_ListOfInteger^ ResInd();
			/// <summary>
			/// Implementation of inspection method
			/// </summary>
			RDC::OCC::NCollection_CellFilter_Action Inspect(int theTarget);
		}; // class BRepBuilderAPI_VertexInspector
		...
		public ref class BRepBuilderAPI_Command
			: public RDC::OCC::BaseClass<::BRepBuilderAPI_Command>
		{
		...
		protected:
			BRepBuilderAPI_Command(InitMode init)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_Command>(init)
			{}

		public:
			BRepBuilderAPI_Command(::BRepBuilderAPI_Command* nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_Command>(nativeInstance, true)
			{}

			BRepBuilderAPI_Command(::BRepBuilderAPI_Command& nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_Command>(&nativeInstance, false)
			{}
		...
		public ref class BRepBuilderAPI_Collect sealed
			: public RDC::OCC::BaseClass<::BRepBuilderAPI_Collect>
		{
		...
		public:
			BRepBuilderAPI_Collect(::BRepBuilderAPI_Collect* nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_Collect>(nativeInstance, true)
			{}

			BRepBuilderAPI_Collect(::BRepBuilderAPI_Collect& nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_Collect>(&nativeInstance, false)
			{}
		...
		public:
			...
			void Add(RDC::OCC::TopoDS_Shape^ SI, RDC::OCC::BRepBuilderAPI_MakeShape^ MKS);
			void AddGenerated(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopoDS_Shape^ Gen);
			void AddModif(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::TopoDS_Shape^ Mod);
			void Filter(RDC::OCC::TopoDS_Shape^ SF);
			RDC::OCC::TopTools_DataMapOfShapeListOfShape^ Modification();
			RDC::OCC::TopTools_DataMapOfShapeListOfShape^ Generated();
		}; // class BRepBuilderAPI_Collect
		...
		public ref class BRepBuilderAPI_MakeShape
			: public RDC::OCC::BRepBuilderAPI_Command
		{
		...
		protected:
			BRepBuilderAPI_MakeShape(InitMode init)
				: RDC::OCC::BRepBuilderAPI_Command(init)
			{}

		public:
			BRepBuilderAPI_MakeShape(::BRepBuilderAPI_MakeShape* nativeInstance)
				: RDC::OCC::BRepBuilderAPI_Command(nativeInstance)
			{}
		...
		public:
			...
			/// <S>.
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ Modified(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
		...
		public:
			...
			/// </summary>
			RDC::OCC::TopoDS_Shape^ ModifiedShape(RDC::OCC::TopoDS_Shape^ S);
		}; // class BRepBuilderAPI_ModifyShape
		...
		public ref class BRepBuilderAPI_Copy sealed
			: public RDC::OCC::BRepBuilderAPI_ModifyShape
		{
		...
		public:
			BRepBuilderAPI_Copy(::BRepBuilderAPI_Copy* nativeInstance)
				: RDC::OCC::BRepBuilderAPI_ModifyShape(nativeInstance)
			{}
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_Copy(RDC::OCC::TopoDS_Shape^ S, bool copyGeom, bool copyMesh);
			/// <summary>
			/// Constructs a copy framework and copies the shape S.
			/// Use the function Shape to access the result.
			/// If copyMesh is True, triangulation contained in original shape will be
			...
			/// other shapes: just specify them with the function Perform.
			/// </summary>
			BRepBuilderAPI_Copy(RDC::OCC::TopoDS_Shape^ S, bool copyGeom);
			/// <summary>
			/// Constructs a copy framework and copies the shape S.
			/// Use the function Shape to access the result.
			/// If copyMesh is True, triangulation contained in original shape will be
			...
			/// other shapes: just specify them with the function Perform.
			/// </summary>
			BRepBuilderAPI_Copy(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Copies the shape S.
			/// Use the function Shape to access the result.
			/// If copyMesh is True, triangulation contained in original shape will be
			...
			/// geometry and triangulation will be shared with original shape.
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ S, bool copyGeom, bool copyMesh);
			/// <summary>
			/// Copies the shape S.
			/// Use the function Shape to access the result.
			/// If copyMesh is True, triangulation contained in original shape will be
			...
			/// geometry and triangulation will be shared with original shape.
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ S, bool copyGeom);
			/// <summary>
			/// Copies the shape S.
			/// Use the function Shape to access the result.
			/// If copyMesh is True, triangulation contained in original shape will be
			...
			/// geometry and triangulation will be shared with original shape.
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ S);
		}; // class BRepBuilderAPI_Copy
		...
		public:
			...
			/// </summary>
			bool Add(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// Adds a surface
			/// </summary>
			bool Add(RDC::OCC::Geom_Surface^ theSurface);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Shape^ GetResult();
			/// <summary>
			...
			static RDC::OCC::BRepBuilderAPI_FastSewing^ CreateDowncasted(::BRepBuilderAPI_FastSewing* instance);
		}; // class BRepBuilderAPI_FastSewing
		...
		public ref class BRepBuilderAPI_FindPlane sealed
			: public RDC::OCC::BaseClass<::BRepBuilderAPI_FindPlane>
		{
		...
		public:
			BRepBuilderAPI_FindPlane(::BRepBuilderAPI_FindPlane* nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_FindPlane>(nativeInstance, true)
			{}

			BRepBuilderAPI_FindPlane(::BRepBuilderAPI_FindPlane& nativeInstance)
				: RDC::OCC::BaseClass<::BRepBuilderAPI_FindPlane>(&nativeInstance, false)
			{}
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_FindPlane(RDC::OCC::TopoDS_Shape^ S, double Tol);
			/// <summary>
			/// Constructs the plane containing the edges of the shape S.
			/// A plane is built only if all the edges are within a distance
			/// of less than or equal to tolerance from a planar surface.
			...
			/// The resulting plane is then retrieved using the function Plane.
			/// </summary>
			BRepBuilderAPI_FindPlane(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Constructs the plane containing the edges of the shape S.
			/// A plane is built only if all the edges are within a distance
			/// of less than or equal to tolerance from a planar surface.
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_GTransform(RDC::OCC::gp_GTrsf^ T);
			/// <summary>
			/// Constructs a framework for applying the geometric
			...
			/// </summary>
			BRepBuilderAPI_GTransform(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::gp_GTrsf^ T, bool Copy);
			/// <summary>
			/// Constructs a framework for applying the geometric
			/// transformation T to a shape, and applies it to the shape S.
			/// -   If the transformation T is direct and isometric (i.e. if
			...
			/// shapes: just specify them with the function Perform.
			/// </summary>
			BRepBuilderAPI_GTransform(RDC::OCC::TopoDS_Shape^ S, RDC::OCC::gp_GTrsf^ T);
			/// <summary>
			...
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ S, bool Copy);
			/// <summary>
			/// Applies the geometric transformation defined at the
			/// time of construction of this framework to the shape S.
			/// -   If the transformation T is direct and isometric (i.e. if
		...
		public:
			...
			BRepBuilderAPI_MakeEdge(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Lin^ L);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Lin^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Lin^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Lin^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Circ^ L);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Circ^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Circ^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Circ^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Elips^ L);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Elips^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Elips^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Elips^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Hypr^ L);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Hypr^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Hypr^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Hypr^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Parab^ L);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Parab^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Parab^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::gp_Parab^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom_Curve^ L);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom_Curve^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, double p1, double p2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, double p1, double p2);
			/// <summary>
			...
			/// Auxiliary methods
			/// </summary>
			BRepBuilderAPI_MakeEdge(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
			...
			/// </summary>
			RDC::OCC::BRepBuilderAPI_EdgeError Error();
			/// <summary>
		...
		public:
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Lin2d^ L);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Lin2d^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Lin2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Lin2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Circ2d^ L);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Circ2d^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Circ2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Circ2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Elips2d^ L);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Elips2d^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Elips2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Elips2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Hypr2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Parab2d^ L);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Parab2d^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Parab2d^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::gp_Parab2d^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, double p1, double p2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::Pnt2d P1, RDC::OCC::Pnt2d P2, double p1, double p2);
			BRepBuilderAPI_MakeEdge2d(RDC::OCC::Geom2d_Curve^ L, RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, double p1, double p2);
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::TopoDS_Face^ F);
			/// <summary>
			/// Make a face from a plane.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Pln P);
			/// <summary>
			/// Make a face from a cylinder.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cylinder^ C);
			/// <summary>
			/// Make a face from a cone.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cone^ C);
			/// <summary>
			/// Make a face from a sphere.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Sphere^ S);
			/// <summary>
			/// Make a face from a torus.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Torus^ C);
			/// <summary>
			/// Make a face from a Surface. Accepts tolerance value (TolDegen)
			/// for resolution of degenerated edges.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Geom_Surface^ S, double TolDegen);
			/// <summary>
			/// Make a face from a plane.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Pln P, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a cylinder.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cylinder^ C, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a cone.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cone^ C, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a sphere.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Sphere^ S, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a torus.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Torus^ C, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			/// Make a face from a Surface. Accepts tolerance value (TolDegen)
			/// for resolution of degenerated edges.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax, double TolDegen);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::TopoDS_Wire^ W, bool OnlyPlane);
			/// <summary>
			/// Find a surface from the wire and make a face.
			/// if <OnlyPlane> is true, the computed surface will be
			/// a plane. If it is not possible to find a plane, the
			/// flag NotDone will be set.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a plane and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Pln P, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a plane and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Pln P, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a cylinder and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cylinder^ C, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a cylinder and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cylinder^ C, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a cone and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cone^ C, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a cone and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Cone^ C, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a sphere and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Sphere^ S, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a sphere and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Sphere^ S, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Make a face from a torus and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Torus^ C, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a torus and a wire.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::gp_Torus^ C, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Wire^ W, bool Inside);
			/// <summary>
			/// Make a face from a Surface and a wire.
			/// If the surface S is not plane,
			/// it must contain pcurves for all edges in W,
			/// otherwise the wrong shape will be created.
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::Geom_Surface^ S, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakeFace(RDC::OCC::TopoDS_Face^ F, RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::BRepBuilderAPI_FaceError Error();
			/// <summary>
		...
		public:
			...
			BRepBuilderAPI_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2);
			BRepBuilderAPI_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3, bool Close);
			BRepBuilderAPI_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3, RDC::OCC::Pnt P4, bool Close);
			/// <summary>
			/// Constructs a polygonal wire from 2, 3 or 4 points. Vertices are
			/// automatically created on the given points. The polygonal wire is
			/// closed if Close is true; otherwise it is open. Further vertices can
			...
			/// consecutive coincident edges.
			/// </summary>
			BRepBuilderAPI_MakePolygon(RDC::OCC::Pnt P1, RDC::OCC::Pnt P2, RDC::OCC::Pnt P3, RDC::OCC::Pnt P4);
			BRepBuilderAPI_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2);
			BRepBuilderAPI_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3, bool Close);
			BRepBuilderAPI_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3, RDC::OCC::TopoDS_Vertex^ V4, bool Close);
			/// <summary>
			/// Constructs a polygonal wire from
			/// 2, 3 or 4 vertices. The polygonal wire is closed if Close is true;
			/// otherwise it is open (default value). Further vertices can be
			...
			/// constructor's arguments.
			/// </summary>
			BRepBuilderAPI_MakePolygon(RDC::OCC::TopoDS_Vertex^ V1, RDC::OCC::TopoDS_Vertex^ V2, RDC::OCC::TopoDS_Vertex^ V3, RDC::OCC::TopoDS_Vertex^ V4);
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_MakeShell(RDC::OCC::Geom_Surface^ S, bool Segment);
			/// <summary>
			/// Constructs a shell from the surface S.
			/// </summary>
			BRepBuilderAPI_MakeShell(RDC::OCC::Geom_Surface^ S);
			/// <summary>
			/// Constructs a shell from the surface S,
			...
			/// </summary>
			BRepBuilderAPI_MakeShell(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax, bool Segment);
			/// <summary>
			/// Constructs a shell from the surface S,
			/// limited in the u parametric direction by the two
			/// parameter values UMin and UMax, and limited in the v
			/// parametric direction by the two parameter values VMin and VMax.
			/// </summary>
			BRepBuilderAPI_MakeShell(RDC::OCC::Geom_Surface^ S, double UMin, double UMax, double VMin, double VMax);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::BRepBuilderAPI_ShellError Error();
			/// <summary>
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_MakeSolid(RDC::OCC::TopoDS_CompSolid^ S);
			/// <summary>
			/// Make a solid from a shell.
			/// </summary>
			BRepBuilderAPI_MakeSolid(RDC::OCC::TopoDS_Shell^ S);
			/// <summary>
			/// Make a solid from two shells.
			/// </summary>
			BRepBuilderAPI_MakeSolid(RDC::OCC::TopoDS_Shell^ S1, RDC::OCC::TopoDS_Shell^ S2);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakeSolid(RDC::OCC::TopoDS_Shell^ S1, RDC::OCC::TopoDS_Shell^ S2, RDC::OCC::TopoDS_Shell^ S3);
			/// <summary>
			/// Make a solid from a solid. useful for adding later.
			/// </summary>
			BRepBuilderAPI_MakeSolid(RDC::OCC::TopoDS_Solid^ So);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakeSolid(RDC::OCC::TopoDS_Solid^ So, RDC::OCC::TopoDS_Shell^ S);
			/// <summary>
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_MakeVertex(RDC::OCC::Pnt P);
			/// <summary>
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_MakeWire(RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			/// Make a Wire from two edges.
			/// </summary>
			BRepBuilderAPI_MakeWire(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2);
			/// <summary>
			/// Make a Wire from three edges.
			/// </summary>
			BRepBuilderAPI_MakeWire(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, RDC::OCC::TopoDS_Edge^ E3);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_MakeWire(RDC::OCC::TopoDS_Edge^ E1, RDC::OCC::TopoDS_Edge^ E2, RDC::OCC::TopoDS_Edge^ E3, RDC::OCC::TopoDS_Edge^ E4);
			/// <summary>
			/// Make a Wire from a Wire. useful for adding later.
			/// </summary>
			BRepBuilderAPI_MakeWire(RDC::OCC::TopoDS_Wire^ W);
			/// <summary>
			/// Add an edge to a wire.
			/// </summary>
			BRepBuilderAPI_MakeWire(RDC::OCC::TopoDS_Wire^ W, RDC::OCC::TopoDS_Edge^ E);
			/// <summary>
			...
			/// enumeration indicating why the construction failed.
			/// </summary>
			RDC::OCC::BRepBuilderAPI_WireError Error();
			/// <summary>
		...
		public:
			...
			/// function Perform.
			/// </summary>
			BRepBuilderAPI_NurbsConvert(RDC::OCC::TopoDS_Shape^ S, bool Copy);
			/// <summary>
			/// Builds a new shape by converting the geometry of the
			/// shape S into NURBS geometry. Specifically, all curves
			/// supporting edges of S are converted into BSpline
			...
			/// function Perform.
			/// </summary>
			BRepBuilderAPI_NurbsConvert(RDC::OCC::TopoDS_Shape^ S);
			/// <summary>
			/// Builds a new shape by converting the geometry of the
		...
		public:
			...
			/// </summary>
			void Load(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			/// Defines the shapes to be sewed or controlled
			/// </summary>
			void Add(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			/// Computing
			/// theProgress - progress indicator of algorithm
			/// </summary>
			void Perform(RDC::OCC::Message_ProgressRange^ theProgress);
			/// <summary>
			/// Computing
			/// theProgress - progress indicator of algorithm
			/// </summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Shape^ SewedShape();
			/// <summary>
			/// set context
			/// </summary>
			void SetContext(RDC::OCC::BRepTools_ReShape^ theContext);
			/// <summary>
			/// return context
			/// </summary>
			RDC::OCC::BRepTools_ReShape^ GetContext();
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Edge^ FreeEdge(int index);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Edge^ MultipleEdge(int index);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Edge^ ContigousEdge(int index);
			/// <summary>
			/// Gives the sections (edge) belonging to a contiguous edge
			/// </summary>
			RDC::OCC::TopTools_ListOfShape^ ContigousEdgeCouple(int index);
			/// <summary>
			/// Indicates if a section is bound (before use SectionToBoundary)
			/// </summary>
			bool IsSectionBound(RDC::OCC::TopoDS_Edge^ section);
			/// <summary>
			...
			/// is attached.
			/// </summary>
			RDC::OCC::TopoDS_Edge^ SectionToBoundary(RDC::OCC::TopoDS_Edge^ section);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Shape^ DegeneratedShape(int index);
			/// <summary>
			/// Indicates if a input shape is degenerated
			/// </summary>
			bool IsDegenerated(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			/// Indicates if a input shape has been modified
			/// </summary>
			bool IsModified(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			/// Gives a modifieded shape
			/// </summary>
			RDC::OCC::TopoDS_Shape^ Modified(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			/// Indicates if a input subshape has been modified
			/// </summary>
			bool IsModifiedSubShape(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			/// Gives a modifieded subshape
			/// </summary>
			RDC::OCC::TopoDS_Shape^ ModifiedSubShape(RDC::OCC::TopoDS_Shape^ shape);
			/// <summary>
			...
			/// </summary>
			RDC::OCC::TopoDS_Face^ DeletedFace(int index);
			/// <summary>
			/// Gives a modified shape
			/// </summary>
			RDC::OCC::TopoDS_Face^ WhichFace(RDC::OCC::TopoDS_Edge^ theEdg, int index);
			/// <summary>
			/// Gives a modified shape
			/// </summary>
			RDC::OCC::TopoDS_Face^ WhichFace(RDC::OCC::TopoDS_Edge^ theEdg);
			/// <summary>
			...
			static RDC::OCC::BRepBuilderAPI_Sewing^ CreateDowncasted(::BRepBuilderAPI_Sewing* instance);
		}; // class BRepBuilderAPI_Sewing
		...
		public:
			...
			/// </summary>
			BRepBuilderAPI_Transform(RDC::OCC::Trsf T);
			/// <summary>
			...
			/// </summary>
			BRepBuilderAPI_Transform(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::Trsf theTrsf, bool theCopyGeom, bool theCopyMesh);
			/// <summary>
			/// Creates a transformation from the gp_Trsf <theTrsf>, and
			/// applies it to the shape <theShape>. If the transformation
			/// is  direct   and isometric (determinant  =  1) and
			...
			/// and the copy will be assigned to the result shape.
			/// </summary>
			BRepBuilderAPI_Transform(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::Trsf theTrsf, bool theCopyGeom);
			/// <summary>
			/// Creates a transformation from the gp_Trsf <theTrsf>, and
			/// applies it to the shape <theShape>. If the transformation
			/// is  direct   and isometric (determinant  =  1) and
			...
			/// and the copy will be assigned to the result shape.
			/// </summary>
			BRepBuilderAPI_Transform(RDC::OCC::TopoDS_Shape^ theShape, RDC::OCC::Trsf theTrsf);
			/// <summary>
			/// Applies the geometric transformation defined at the
			/// time of construction of this framework to the shape S.
			...
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ theShape, bool theCopyGeom, bool theCopyMesh);
			/// <summary>
			/// Applies the geometric transformation defined at the
			/// time of construction of this framework to the shape S.
			/// - If the transformation T is direct and isometric, in
			...
			/// need to specify them by calling the function Perform again.
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ theShape, bool theCopyGeom);
			/// <summary>
			/// Applies the geometric transformation defined at the
			/// time of construction of this framework to the shape S.
			/// - If the transformation T is direct and isometric, in
			...
			/// need to specify them by calling the function Perform again.
			/// </summary>
			void Perform(RDC::OCC::TopoDS_Shape^ theShape);
			/// <summary>
			/// Returns the modified shape corresponding to <S>.
			/// </summary>
			RDC::OCC::TopoDS_Shape^ ModifiedShape(RDC::OCC::TopoDS_Shape^ S);
