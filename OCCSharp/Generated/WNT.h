...
public:
    ...
    /// </summary>
    WNT_WClass(RDC::OCC::TCollection_AsciiString^ theClassName, System::IntPtr theWndProc, unsigned int theStyle, int theClassExtra, int theWindowExtra, System::IntPtr theCursor, System::IntPtr theIcon, RDC::OCC::TCollection_AsciiString^ theMenuName);
    /// <summary>
    /// Creates a Windows NT window class and registers it.
    /// </summary>
    WNT_WClass(RDC::OCC::TCollection_AsciiString^ theClassName, System::IntPtr theWndProc, unsigned int theStyle, int theClassExtra, int theWindowExtra, System::IntPtr theCursor, System::IntPtr theIcon);
    /// <summary>
    /// Creates a Windows NT window class and registers it.
    /// </summary>
    WNT_WClass(RDC::OCC::TCollection_AsciiString^ theClassName, System::IntPtr theWndProc, unsigned int theStyle, int theClassExtra, int theWindowExtra, System::IntPtr theCursor);
    /// <summary>
    /// Creates a Windows NT window class and registers it.
    /// </summary>
    WNT_WClass(RDC::OCC::TCollection_AsciiString^ theClassName, System::IntPtr theWndProc, unsigned int theStyle, int theClassExtra, int theWindowExtra);
    /// <summary>
    /// Creates a Windows NT window class and registers it.
    /// </summary>
    WNT_WClass(RDC::OCC::TCollection_AsciiString^ theClassName, System::IntPtr theWndProc, unsigned int theStyle, int theClassExtra);
    /// <summary>
    /// Creates a Windows NT window class and registers it.
    /// </summary>
    WNT_WClass(RDC::OCC::TCollection_AsciiString^ theClassName, System::IntPtr theWndProc, unsigned int theStyle);
    /// <summary>
    ...
    static RDC::OCC::WNT_WClass^ CreateDowncasted(::WNT_WClass* instance);
}; // class WNT_WClass
...
public:
    WNT_Window(::WNT_Window* nativeInstance)
        : RDC::OCC::Aspect_Window( nativeInstance )
    {}
...
public:
    ...
    /// </summary>
    WNT_Window(System::String^ theTitle, RDC::OCC::WNT_WClass^ theClass, long unsigned int theStyle, int thePxLeft, int thePxTop, int thePxWidth, int thePxHeight, RDC::OCC::Quantity_NameOfColor theBackColor, System::IntPtr theParent, System::IntPtr theMenu, System::IntPtr theClientStruct);
    /// <summary>
    /// Creates a Window defined by his position and size in pixels from the Parent Window.
    /// Trigger: Raises WindowDefinitionError if the Position out of the Screen Space or the window creation failed.
    /// </summary>
    WNT_Window(System::String^ theTitle, RDC::OCC::WNT_WClass^ theClass, long unsigned int theStyle, int thePxLeft, int thePxTop, int thePxWidth, int thePxHeight, RDC::OCC::Quantity_NameOfColor theBackColor, System::IntPtr theParent, System::IntPtr theMenu);
    /// <summary>
    /// Creates a Window defined by his position and size in pixels from the Parent Window.
    /// Trigger: Raises WindowDefinitionError if the Position out of the Screen Space or the window creation failed.
    /// </summary>
    WNT_Window(System::String^ theTitle, RDC::OCC::WNT_WClass^ theClass, long unsigned int theStyle, int thePxLeft, int thePxTop, int thePxWidth, int thePxHeight, RDC::OCC::Quantity_NameOfColor theBackColor, System::IntPtr theParent);
    /// <summary>
    /// Creates a Window defined by his position and size in pixels from the Parent Window.
    /// Trigger: Raises WindowDefinitionError if the Position out of the Screen Space or the window creation failed.
    /// </summary>
    WNT_Window(System::String^ theTitle, RDC::OCC::WNT_WClass^ theClass, long unsigned int theStyle, int thePxLeft, int thePxTop, int thePxWidth, int thePxHeight, RDC::OCC::Quantity_NameOfColor theBackColor);
    /// <summary>
    /// Creates a Window defined by his position and size in pixels from the Parent Window.
    /// Trigger: Raises WindowDefinitionError if the Position out of the Screen Space or the window creation failed.
    /// </summary>
    WNT_Window(System::String^ theTitle, RDC::OCC::WNT_WClass^ theClass, long unsigned int theStyle, int thePxLeft, int thePxTop, int thePxWidth, int thePxHeight);
    /// <summary>
    /// Creates a Window based on the existing window handle.
    /// </summary>
    WNT_Window(System::IntPtr theHandle, RDC::OCC::Quantity_NameOfColor theBackColor);
    /// <summary>
    /// Creates a Window based on the existing window handle.
    /// </summary>
    ...
    static RDC::OCC::WNT_Window^ CreateDowncasted(::WNT_Window* instance);
}; // class WNT_Window
