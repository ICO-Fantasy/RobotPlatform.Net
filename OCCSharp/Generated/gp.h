...
public ref class gp_TrsfNLerp sealed
    : public RDC::OCC::BaseClass<::gp_TrsfNLerp>
{
...
public:
    gp_TrsfNLerp(::gp_TrsfNLerp* nativeInstance)
        : RDC::OCC::BaseClass<::gp_TrsfNLerp>( nativeInstance, true )
    {}

    gp_TrsfNLerp(::gp_TrsfNLerp& nativeInstance)
        : RDC::OCC::BaseClass<::gp_TrsfNLerp>( &nativeInstance, false )
    {}
...
public:
    gp_TrsfNLerp();
    gp_TrsfNLerp(RDC::OCC::Trsf theStart, RDC::OCC::Trsf theEnd);
    void Init(RDC::OCC::Trsf theStart, RDC::OCC::Trsf theEnd);
    void Interpolate(double theT, RDC::OCC::Trsf% theResult);
}; // class gp_TrsfNLerp
...
public ref class gp_Vec2f sealed
    : public RDC::OCC::BaseClass<::gp_Vec2f>
{
...
public:
    gp_Vec2f(::gp_Vec2f* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Vec2f>( nativeInstance, true )
    {}

    gp_Vec2f(::gp_Vec2f& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Vec2f>( &nativeInstance, false )
    {}
...
public:
    ...
    RDC::OCC::gp_Vec2f^ xy();
    RDC::OCC::gp_Vec2f^ yx();
    bool IsEqual(RDC::OCC::gp_Vec2f^ theOther);
    float GetData();
    float ChangeData();
    void Multiply(float theFactor);
    RDC::OCC::gp_Vec2f^ Multiplied(float theFactor);
    RDC::OCC::gp_Vec2f^ cwiseMin(RDC::OCC::gp_Vec2f^ theVec);
    RDC::OCC::gp_Vec2f^ cwiseMax(RDC::OCC::gp_Vec2f^ theVec);
    RDC::OCC::gp_Vec2f^ cwiseAbs();
    float maxComp();
    float minComp();
    float Dot(RDC::OCC::gp_Vec2f^ theOther);
    float Modulus();
    float SquareModulus();
    static RDC::OCC::gp_Vec2f^ DX();
    static RDC::OCC::gp_Vec2f^ DY();
...
public ref class gp_Vec3f sealed
    : public RDC::OCC::BaseClass<::gp_Vec3f>
{
...
public:
    gp_Vec3f(::gp_Vec3f* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Vec3f>( nativeInstance, true )
    {}

    gp_Vec3f(::gp_Vec3f& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Vec3f>( &nativeInstance, false )
    {}
...
public:
    ...
    gp_Vec3f(RDC::OCC::gp_Vec2f^ theVec2, float theZ);
    gp_Vec3f(RDC::OCC::gp_Vec2f^ theVec2);
    static int Length();
    ...
    bool IsEqual(RDC::OCC::gp_Vec3f^ theOther);
    float GetData();
    float ChangeData();
    void Multiply(float theFactor);
    RDC::OCC::gp_Vec3f^ Multiplied(float theFactor);
    RDC::OCC::gp_Vec3f^ cwiseMin(RDC::OCC::gp_Vec3f^ theVec);
    RDC::OCC::gp_Vec3f^ cwiseMax(RDC::OCC::gp_Vec3f^ theVec);
    RDC::OCC::gp_Vec3f^ cwiseAbs();
    float maxComp();
    float minComp();
    float Dot(RDC::OCC::gp_Vec3f^ theOther);
    float Modulus();
    float SquareModulus();
    void Normalize();
    RDC::OCC::gp_Vec3f^ Normalized();
    static RDC::OCC::gp_Vec3f^ Cross(RDC::OCC::gp_Vec3f^ theVec1, RDC::OCC::gp_Vec3f^ theVec2);
    static RDC::OCC::gp_Vec3f^ GetLERP(RDC::OCC::gp_Vec3f^ theFrom, RDC::OCC::gp_Vec3f^ theTo, float theT);
    static RDC::OCC::gp_Vec3f^ DX();
    static RDC::OCC::gp_Vec3f^ DY();
    static RDC::OCC::gp_Vec3f^ DZ();
    /* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
    /* Method skipped due to unknown mapping: void DumpJson(ostream theOStream, int theDepth, ) */
    bool Equals(System::Object^ obj) override;
}; // class gp_Vec3f
...
public:
    ...
    static RDC::OCC::gp_VectorWithNullMagnitude^ NewInstance(System::String^ theMessage);
    static RDC::OCC::gp_VectorWithNullMagnitude^ NewInstance();
    static RDC::OCC::gp_VectorWithNullMagnitude^ NewInstance(System::String^ theMessage, System::String^ theStackTrace);
    static RDC::OCC::gp_VectorWithNullMagnitude^ CreateDowncasted(::gp_VectorWithNullMagnitude* instance);
}; // class gp_VectorWithNullMagnitude
...
public ref class gp_Circ sealed
    : public RDC::OCC::BaseClass<::gp_Circ>
{
...
public:
    gp_Circ(::gp_Circ* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Circ>( nativeInstance, true )
    {}

    gp_Circ(::gp_Circ& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Circ>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Circ(RDC::OCC::Ax2 theA2, double theRadius);
    /// <summary>
    ...
    /// </summary>
    double Distance(RDC::OCC::Pnt theP);
    /// <summary>
    /// Computes the square distance between <me> and the point theP.
    /// </summary>
    double SquareDistance(RDC::OCC::Pnt theP);
    /// <summary>
    ...
    /// </summary>
    bool Contains(RDC::OCC::Pnt theP, double theLinearTolerance);
    void Mirror(RDC::OCC::Pnt theP);
    /// <summary>
    /// Performs the symmetrical transformation of a circle
    /// with respect to the point theP which is the center of the
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Circ^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    /// Performs the symmetrical transformation of a circle with
    /// respect to an axis placement which is the axis of the
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Circ^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
    /// Performs the symmetrical transformation of a circle with respect
    /// to a plane. The axis placement theA2 locates the plane of the
    /// of the symmetry : (Location, XDirection, YDirection).
    /// </summary>
    RDC::OCC::gp_Circ^ Mirrored(RDC::OCC::Ax2 theA2);
    void Rotate(RDC::OCC::Ax1 theA1, double theAng);
    /// <summary>
    /// Rotates a circle. theA1 is the axis of the rotation.
    /// theAng is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Circ^ Rotated(RDC::OCC::Ax1 theA1, double theAng);
    void Scale(RDC::OCC::Pnt theP, double theS);
    /// <summary>
    ...
    /// an ellipse.
    /// </summary>
    RDC::OCC::gp_Circ^ Scaled(RDC::OCC::Pnt theP, double theS);
    void Transform(RDC::OCC::Trsf theT);
    /// <summary>
    /// Transforms a circle with the transformation theT from class Trsf.
    /// </summary>
    RDC::OCC::gp_Circ^ Transformed(RDC::OCC::Trsf theT);
    void Translate(RDC::OCC::Vec theV);
    /// <summary>
    /// Translates a circle in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Circ^ Translated(RDC::OCC::Vec theV);
    void Translate(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
    /// <summary>
    /// Translates a circle from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Circ^ Translated(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
}; // class gp_Circ
...
public ref class gp_Circ2d sealed
    : public RDC::OCC::BaseClass<::gp_Circ2d>
{
...
public:
    gp_Circ2d(::gp_Circ2d* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Circ2d>( nativeInstance, true )
    {}

    gp_Circ2d(::gp_Circ2d& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Circ2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Circ2d(RDC::OCC::Ax2d theXAxis, double theRadius, bool theIsSense);
    /// <summary>
    /// The location point of theXAxis is the center of the circle.
    /// Warnings :
    /// It is not forbidden to create a circle with theRadius = 0.0   Raises ConstructionError if theRadius < 0.0.
    /// Raised if theRadius < 0.0.
    /// </summary>
    gp_Circ2d(RDC::OCC::Ax2d theXAxis, double theRadius);
    /// <summary>
    ...
    /// Raised if theRadius < 0.0.
    /// </summary>
    gp_Circ2d(RDC::OCC::Ax22d theAxis, double theRadius);
    /// <summary>
    /// Changes the location point (center) of the circle.
    /// </summary>
    void SetLocation(RDC::OCC::Pnt2d theP);
    /// <summary>
    /// Changes the X axis of the circle.
    /// </summary>
    void SetXAxis(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Changes the X axis of the circle.
    /// </summary>
    void SetAxis(RDC::OCC::Ax22d theA);
    /// <summary>
    /// Changes the Y axis of the circle.
    /// </summary>
    void SetYAxis(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Modifies the radius of this circle.
    ...
    /// <theLinearTolerance>.
    /// </summary>
    bool Contains(RDC::OCC::Pnt2d theP, double theLinearTolerance);
    /// <summary>
    /// Computes the minimum of distance between the point theP and any
    /// point on the circumference of the circle.
    /// </summary>
    double Distance(RDC::OCC::Pnt2d theP);
    /// <summary>
    /// Computes the square distance between <me> and the point theP.
    /// </summary>
    double SquareDistance(RDC::OCC::Pnt2d theP);
    /// <summary>
    /// computes the circumference of the circle.
    /// </summary>
    double Length();
    ...
    /// </summary>
    RDC::OCC::gp_Circ2d^ Reversed();
    /// <summary>
    /// Returns true if the local coordinate system is direct
    /// and false in the other case.
    /// </summary>
    bool IsDirect();
    void Mirror(RDC::OCC::Pnt2d theP);
    /// <summary>
    /// Performs the symmetrical transformation of a circle with respect
    /// to the point theP which is the center of the symmetry
    /// </summary>
    RDC::OCC::gp_Circ2d^ Mirrored(RDC::OCC::Pnt2d theP);
    void Mirror(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Performs the symmetrical transformation of a circle with respect
    /// to an axis placement which is the axis of the symmetry.
    /// </summary>
    RDC::OCC::gp_Circ2d^ Mirrored(RDC::OCC::Ax2d theA);
    void Rotate(RDC::OCC::Pnt2d theP, double theAng);
    /// <summary>
    /// Rotates a circle. theP is the center of the rotation.
    /// Ang is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Circ2d^ Rotated(RDC::OCC::Pnt2d theP, double theAng);
    void Scale(RDC::OCC::Pnt2d theP, double theS);
    /// <summary>
    /// Scales a circle. theS is the scaling value.
    /// Warnings :
    /// If theS is negative the radius stay positive but
    ...
    /// an ellipse.
    /// </summary>
    RDC::OCC::gp_Circ2d^ Scaled(RDC::OCC::Pnt2d theP, double theS);
    void Transform(RDC::OCC::Trsf2d theT);
    /// <summary>
    /// Transforms a circle with the transformation theT from class Trsf2d.
    /// </summary>
    RDC::OCC::gp_Circ2d^ Transformed(RDC::OCC::Trsf2d theT);
    void Translate(RDC::OCC::Vec2d theV);
    /// <summary>
    /// Translates a circle in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Circ2d^ Translated(RDC::OCC::Vec2d theV);
    void Translate(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
    /// <summary>
    /// Translates a circle from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Circ2d^ Translated(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
}; // class gp_Circ2d
...
public ref class gp_Cone sealed
    : public RDC::OCC::BaseClass<::gp_Cone>
{
...
public:
    gp_Cone(::gp_Cone* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Cone>( nativeInstance, true )
    {}

    gp_Cone(::gp_Cone& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Cone>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Cone(RDC::OCC::Ax3 theA3, double theAng, double theRadius);
    /// <summary>
    ...
    /// </summary>
    void SetPosition(RDC::OCC::Ax3 theA3);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Cone^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Cone^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
    ...
    /// of the symmetry : (Location, XDirection, YDirection).
    /// </summary>
    RDC::OCC::gp_Cone^ Mirrored(RDC::OCC::Ax2 theA2);
    void Rotate(RDC::OCC::Ax1 theA1, double theAng);
    /// <summary>
    /// Rotates a cone. theA1 is the axis of the rotation.
    /// Ang is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Cone^ Rotated(RDC::OCC::Ax1 theA1, double theAng);
    void Scale(RDC::OCC::Pnt theP, double theS);
    /// <summary>
    /// Scales a cone. theS is the scaling value.
    /// The absolute value of theS is used to scale the cone
    /// </summary>
    RDC::OCC::gp_Cone^ Scaled(RDC::OCC::Pnt theP, double theS);
    void Transform(RDC::OCC::Trsf theT);
    /// <summary>
    /// Transforms a cone with the transformation theT from class Trsf.
    /// </summary>
    RDC::OCC::gp_Cone^ Transformed(RDC::OCC::Trsf theT);
    void Translate(RDC::OCC::Vec theV);
    /// <summary>
    /// Translates a cone in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Cone^ Translated(RDC::OCC::Vec theV);
    void Translate(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
    /// <summary>
    /// Translates a cone from the point P1 to the point P2.
    /// </summary>
    RDC::OCC::gp_Cone^ Translated(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
}; // class gp_Cone
...
public ref class gp_Cylinder sealed
    : public RDC::OCC::BaseClass<::gp_Cylinder>
{
...
public:
    gp_Cylinder(::gp_Cylinder* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Cylinder>( nativeInstance, true )
    {}

    gp_Cylinder(::gp_Cylinder& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Cylinder>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Cylinder(RDC::OCC::Ax3 theA3, double theRadius);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Cylinder^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Cylinder^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
...
public ref class gp_Elips sealed
    : public RDC::OCC::BaseClass<::gp_Elips>
{
...
public:
    gp_Elips(::gp_Elips* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Elips>( nativeInstance, true )
    {}

    gp_Elips(::gp_Elips& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Elips>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Elips(RDC::OCC::Ax2 theA2, double theMajorRadius, double theMinorRadius);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::gp_Elips^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    /// Performs the symmetrical transformation of an ellipse with
    /// respect to an axis placement which is the axis of the symmetry.
    /// </summary>
    RDC::OCC::gp_Elips^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
    /// Performs the symmetrical transformation of an ellipse with
    ...
    /// of the symmetry (Location, XDirection, YDirection).
    /// </summary>
    RDC::OCC::gp_Elips^ Mirrored(RDC::OCC::Ax2 theA2);
    void Rotate(RDC::OCC::Ax1 theA1, double theAng);
    /// <summary>
    /// Rotates an ellipse. theA1 is the axis of the rotation.
    /// theAng is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Elips^ Rotated(RDC::OCC::Ax1 theA1, double theAng);
    void Scale(RDC::OCC::Pnt theP, double theS);
    /// <summary>
    /// Scales an ellipse. theS is the scaling value.
    /// </summary>
    RDC::OCC::gp_Elips^ Scaled(RDC::OCC::Pnt theP, double theS);
    void Transform(RDC::OCC::Trsf theT);
    /// <summary>
    /// Transforms an ellipse with the transformation theT from class Trsf.
    /// </summary>
    RDC::OCC::gp_Elips^ Transformed(RDC::OCC::Trsf theT);
    void Translate(RDC::OCC::Vec theV);
    /// <summary>
    /// Translates an ellipse in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Elips^ Translated(RDC::OCC::Vec theV);
    void Translate(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
    /// <summary>
    /// Translates an ellipse from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Elips^ Translated(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
}; // class gp_Elips
...
public ref class gp_Elips2d sealed
    : public RDC::OCC::BaseClass<::gp_Elips2d>
{
...
public:
    gp_Elips2d(::gp_Elips2d* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Elips2d>( nativeInstance, true )
    {}

    gp_Elips2d(::gp_Elips2d& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Elips2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Elips2d(RDC::OCC::Ax2d theMajorAxis, double theMajorRadius, double theMinorRadius, bool theIsSense);
    /// <summary>
    /// Creates an ellipse with the major axis, the major and the
    /// minor radius. The location of the theMajorAxis is the center
    /// of the  ellipse.
    ...
    /// Raises ConstructionError if theMajorRadius < theMinorRadius or theMinorRadius < 0.0
    /// </summary>
    gp_Elips2d(RDC::OCC::Ax2d theMajorAxis, double theMajorRadius, double theMinorRadius);
    /// <summary>
    ...
    /// Raises ConstructionError if theMajorRadius < theMinorRadius or theMinorRadius < 0.0
    /// </summary>
    gp_Elips2d(RDC::OCC::Ax22d theA, double theMajorRadius, double theMinorRadius);
    /// <summary>
    ...
    /// to the point theP which is the center of the symmetry
    /// </summary>
    RDC::OCC::gp_Elips2d^ Mirrored(RDC::OCC::Pnt2d theP);
    void Mirror(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Performs the symmetrical transformation of a ellipse with respect
    /// to an axis placement which is the axis of the symmetry.
    /// </summary>
    RDC::OCC::gp_Elips2d^ Mirrored(RDC::OCC::Ax2d theA);
    void Rotate(RDC::OCC::Pnt2d theP, double theAng);
    RDC::OCC::gp_Elips2d^ Rotated(RDC::OCC::Pnt2d theP, double theAng);
    void Scale(RDC::OCC::Pnt2d theP, double theS);
    /// <summary>
    /// Scales a ellipse. theS is the scaling value.
    /// </summary>
    RDC::OCC::gp_Elips2d^ Scaled(RDC::OCC::Pnt2d theP, double theS);
    void Transform(RDC::OCC::Trsf2d theT);
    /// <summary>
    /// Transforms an ellipse with the transformation theT from class Trsf2d.
    /// </summary>
    RDC::OCC::gp_Elips2d^ Transformed(RDC::OCC::Trsf2d theT);
    void Translate(RDC::OCC::Vec2d theV);
    /// <summary>
    /// Translates a ellipse in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Elips2d^ Translated(RDC::OCC::Vec2d theV);
    void Translate(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
    /// <summary>
    /// Translates a ellipse from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Elips2d^ Translated(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
}; // class gp_Elips2d
...
public ref class gp_GTrsf sealed
    : public RDC::OCC::BaseClass<::gp_GTrsf>
{
...
public:
    gp_GTrsf(::gp_GTrsf* nativeInstance)
        : RDC::OCC::BaseClass<::gp_GTrsf>( nativeInstance, true )
    {}

    gp_GTrsf(::gp_GTrsf& nativeInstance)
        : RDC::OCC::BaseClass<::gp_GTrsf>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_GTrsf(RDC::OCC::Mat theM, RDC::OCC::XYZ theV);
    /// <summary>
    ...
    /// HP' = theRatio * HP.
    /// </summary>
    void SetAffinity(RDC::OCC::Ax1 theA1, double theRatio);
    /// <summary>
    /// Changes this transformation into an affinity of ratio theRatio
    ...
    /// HP' = theRatio * HP.
    /// </summary>
    void SetAffinity(RDC::OCC::Ax2 theA2, double theRatio);
    /// <summary>
    ...
    /// @endcode
    RDC::OCC::gp_GTrsf^ Multiplied(RDC::OCC::gp_GTrsf^ theT);
    /// <summary>
    /// Computes the transformation composed with <me> and theT.
    /// <me> = <me> * theT
    /// </summary>
    void Multiply(RDC::OCC::gp_GTrsf^ theT);
    /// <summary>
    /// Computes the product of the transformation theT and this
    /// transformation and assigns the result to this transformation.
    /// this = theT * this
    /// </summary>
    void PreMultiply(RDC::OCC::gp_GTrsf^ theT);
    void Power(int theN);
    /// <summary>
    /// Computes:
    ...
    /// </summary>
    RDC::OCC::gp_GTrsf^ Powered(int theN);
    void Transforms(RDC::OCC::XYZ% theCoord);
    /// <summary>
...
public ref class gp_GTrsf2d sealed
    : public RDC::OCC::BaseClass<::gp_GTrsf2d>
{
...
public:
    gp_GTrsf2d(::gp_GTrsf2d* nativeInstance)
        : RDC::OCC::BaseClass<::gp_GTrsf2d>( nativeInstance, true )
    {}

    gp_GTrsf2d(::gp_GTrsf2d& nativeInstance)
        : RDC::OCC::BaseClass<::gp_GTrsf2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    void SetAffinity(RDC::OCC::Ax2d theA, double theRatio);
    /// <summary>
    /// Replaces   the coefficient (theRow, theCol) of the matrix representing
    ...
    /// </summary>
    void SetTranslationPart(RDC::OCC::XY theCoord);
    /// <summary>
    /// Assigns the vectorial and translation parts of theT to this transformation.
    /// </summary>
    void SetTrsf2d(RDC::OCC::Trsf2d theT);
    /// <summary>
    /// Replaces the vectorial part of this transformation by theMatrix.
    /// </summary>
    void SetVectorialPart(RDC::OCC::Mat2d theMatrix);
    /// <summary>
    /// Returns true if the determinant of the vectorial part of
    /// this transformation is negative.
    /// </summary>
    ...
    /// T2.Transforms(P2);                  // P1 = P2 !!!
    /// @endcode
    RDC::OCC::gp_GTrsf2d^ Multiplied(RDC::OCC::gp_GTrsf2d^ theT);
    void Multiply(RDC::OCC::gp_GTrsf2d^ theT);
    /// <summary>
    /// Computes the product of the transformation theT and this
    /// transformation, and assigns the result to this transformation:
    /// this = theT * this
    /// </summary>
    void PreMultiply(RDC::OCC::gp_GTrsf2d^ theT);
    void Power(int theN);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::gp_GTrsf2d^ Powered(int theN);
    void Transforms(RDC::OCC::XY% theCoord);
    RDC::OCC::XY Transformed(RDC::OCC::XY theCoord);
    /// <summary>
...
public ref class gp_Hypr sealed
    : public RDC::OCC::BaseClass<::gp_Hypr>
{
...
public:
    gp_Hypr(::gp_Hypr* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Hypr>( nativeInstance, true )
    {}

    gp_Hypr(::gp_Hypr& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Hypr>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Hypr(RDC::OCC::Ax2 theA2, double theMajorRadius, double theMinorRadius);
    /// <summary>
    ...
    /// respect  to the point theP which is the center of the symmetry.
    /// </summary>
    RDC::OCC::gp_Hypr^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    /// Performs the symmetrical transformation of an hyperbola with
    /// respect to an axis placement which is the axis of the symmetry.
    /// </summary>
    RDC::OCC::gp_Hypr^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
    /// Performs the symmetrical transformation of an hyperbola with
    /// respect to a plane. The axis placement theA2 locates the plane
    /// of the symmetry (Location, XDirection, YDirection).
    /// </summary>
    RDC::OCC::gp_Hypr^ Mirrored(RDC::OCC::Ax2 theA2);
    void Rotate(RDC::OCC::Ax1 theA1, double theAng);
    /// <summary>
    /// Rotates an hyperbola. theA1 is the axis of the rotation.
    /// theAng is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Hypr^ Rotated(RDC::OCC::Ax1 theA1, double theAng);
    void Scale(RDC::OCC::Pnt theP, double theS);
    /// <summary>
    /// Scales an hyperbola. theS is the scaling value.
    /// </summary>
    RDC::OCC::gp_Hypr^ Scaled(RDC::OCC::Pnt theP, double theS);
    void Transform(RDC::OCC::Trsf theT);
    /// <summary>
    /// Transforms an hyperbola with the transformation theT from
    /// class Trsf.
    /// </summary>
    RDC::OCC::gp_Hypr^ Transformed(RDC::OCC::Trsf theT);
    void Translate(RDC::OCC::Vec theV);
    /// <summary>
    /// Translates an hyperbola in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Hypr^ Translated(RDC::OCC::Vec theV);
    void Translate(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
    /// <summary>
    /// Translates an hyperbola from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Hypr^ Translated(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
}; // class gp_Hypr
...
public ref class gp_Hypr2d sealed
    : public RDC::OCC::BaseClass<::gp_Hypr2d>
{
...
public:
    gp_Hypr2d(::gp_Hypr2d* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Hypr2d>( nativeInstance, true )
    {}

    gp_Hypr2d(::gp_Hypr2d& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Hypr2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Raises ConstructionError if theMajorRadius < 0.0 or theMinorRadius < 0.0
    /// </summary>
    gp_Hypr2d(RDC::OCC::Ax2d theMajorAxis, double theMajorRadius, double theMinorRadius, bool theIsSense);
    /// <summary>
    /// Creates a hyperbola with radii theMajorRadius and
    /// theMinorRadius, centered on the origin of theMajorAxis
    /// and where the unit vector of theMajorAxis is the "X
    ...
    /// Raises ConstructionError if theMajorRadius < 0.0 or theMinorRadius < 0.0
    /// </summary>
    gp_Hypr2d(RDC::OCC::Ax2d theMajorAxis, double theMajorRadius, double theMinorRadius);
    /// <summary>
    ...
    /// Raises ConstructionError if theMajorRadius < 0.0 or theMinorRadius < 0.0
    /// </summary>
    gp_Hypr2d(RDC::OCC::Ax22d theA, double theMajorRadius, double theMinorRadius);
    /// <summary>
    ...
    /// "YAxis" of <me>.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ ConjugateBranch1();
    /// <summary>
    /// Computes the branch of hyperbola which is on the negative side of the
    /// "YAxis" of <me>.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ ConjugateBranch2();
    /// <summary>
    ...
    /// respect  to the point theP which is the center of the symmetry.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ Mirrored(RDC::OCC::Pnt2d theP);
    void Mirror(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Performs the symmetrical transformation of an hyperbola with
    /// respect to an axis placement which is the axis of the symmetry.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ Mirrored(RDC::OCC::Ax2d theA);
    void Rotate(RDC::OCC::Pnt2d theP, double theAng);
    /// <summary>
    /// Rotates an hyperbola. theP is the center of the rotation.
    /// theAng is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ Rotated(RDC::OCC::Pnt2d theP, double theAng);
    void Scale(RDC::OCC::Pnt2d theP, double theS);
    /// <summary>
    /// Scales an hyperbola. <theS> is the scaling value.
    ...
    /// </summary>
    RDC::OCC::gp_Hypr2d^ Scaled(RDC::OCC::Pnt2d theP, double theS);
    void Transform(RDC::OCC::Trsf2d theT);
    /// <summary>
    /// Transforms an hyperbola with the transformation theT from
    /// class Trsf2d.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ Transformed(RDC::OCC::Trsf2d theT);
    void Translate(RDC::OCC::Vec2d theV);
    /// <summary>
    /// Translates an hyperbola in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ Translated(RDC::OCC::Vec2d theV);
    void Translate(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
    /// <summary>
    /// Translates an hyperbola from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Hypr2d^ Translated(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
}; // class gp_Hypr2d
...
public ref class gp_Lin sealed
    : public RDC::OCC::BaseClass<::gp_Lin>
{
...
public:
    gp_Lin(::gp_Lin* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Lin>( nativeInstance, true )
    {}

    gp_Lin(::gp_Lin& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Lin>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Lin(RDC::OCC::Pnt theP, RDC::OCC::Dir theV);
    void Reverse();
    /// <summary>
    ...
    /// -   Reversed creates a new one.
    /// </summary>
    RDC::OCC::gp_Lin^ Reversed();
    /// <summary>
    /// Changes the direction of the line.
    /// </summary>
    void SetDirection(RDC::OCC::Dir theV);
    /// <summary>
    ...
    /// </summary>
    void SetPosition(RDC::OCC::Ax1 theA1);
    /// <summary>
    ...
    /// </summary>
    double Angle(RDC::OCC::gp_Lin^ theOther);
    /// <summary>
    ...
    /// </summary>
    double Distance(RDC::OCC::gp_Lin^ theOther);
    /// <summary>
    /// Computes the square distance between <me> and the point theP.
    /// </summary>
    double SquareDistance(RDC::OCC::Pnt theP);
    ...
    /// </summary>
    double SquareDistance(RDC::OCC::gp_Lin^ theOther);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::gp_Lin^ Normal(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Pnt theP);
    /// <summary>
    ...
    /// the symmetry.
    /// </summary>
    RDC::OCC::gp_Lin^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    /// Performs the symmetrical transformation of a line
    ...
    /// of the symmetry.
    /// </summary>
    RDC::OCC::gp_Lin^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
    /// Performs the symmetrical transformation of a line
    ...
    /// </summary>
    RDC::OCC::gp_Lin^ Mirrored(RDC::OCC::Ax2 theA2);
    void Rotate(RDC::OCC::Ax1 theA1, double theAng);
    /// <summary>
    /// Rotates a line. A1 is the axis of the rotation.
    /// Ang is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Lin^ Rotated(RDC::OCC::Ax1 theA1, double theAng);
    void Scale(RDC::OCC::Pnt theP, double theS);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::gp_Lin^ Scaled(RDC::OCC::Pnt theP, double theS);
    void Transform(RDC::OCC::Trsf theT);
    /// <summary>
    /// Transforms a line with the transformation theT from class Trsf.
    /// </summary>
    RDC::OCC::gp_Lin^ Transformed(RDC::OCC::Trsf theT);
    void Translate(RDC::OCC::Vec theV);
    /// <summary>
    /// Translates a line in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Lin^ Translated(RDC::OCC::Vec theV);
    void Translate(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
    /// <summary>
    /// Translates a line from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Lin^ Translated(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
}; // class gp_Lin
...
public ref class gp_Lin2d sealed
    : public RDC::OCC::BaseClass<::gp_Lin2d>
{
...
public:
    gp_Lin2d(::gp_Lin2d* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Lin2d>( nativeInstance, true )
    {}

    gp_Lin2d(::gp_Lin2d& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Lin2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// -   Reversed creates a new one.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Reversed();
    /// <summary>
    /// Changes the direction of the line.
    /// </summary>
    void SetDirection(RDC::OCC::Dir2d theV);
    /// <summary>
    ...
    /// </summary>
    void SetPosition(RDC::OCC::Ax2d theA);
    /// <summary>
    ...
    /// location and direction as <me>.
    /// </summary>
    RDC::OCC::Ax2d Position();
    /// <summary>
    /// Computes the angle between two lines in radians.
    /// </summary>
    double Angle(RDC::OCC::gp_Lin2d^ theOther);
    /// <summary>
    /// Returns true if this line contains the point theP, that is, if the
    /// distance between point theP and this line is less than or
    /// equal to theLinearTolerance.
    ...
    /// Computes the distance between two lines.
    /// </summary>
    double Distance(RDC::OCC::gp_Lin2d^ theOther);
    /// <summary>
    ...
    /// Computes the square distance between two lines.
    /// </summary>
    double SquareDistance(RDC::OCC::gp_Lin2d^ theOther);
    /// <summary>
    /// Computes the line normal to the direction of <me>,
    /// passing through the point <theP>.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Normal(RDC::OCC::Pnt2d theP);
    void Mirror(RDC::OCC::Pnt2d theP);
    /// <summary>
    /// Performs the symmetrical transformation of a line
    ...
    /// of the symmetry
    /// </summary>
    RDC::OCC::gp_Lin2d^ Mirrored(RDC::OCC::Pnt2d theP);
    void Mirror(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Performs the symmetrical transformation of a line
    /// with respect to an axis placement which is the axis
    /// of the symmetry.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Mirrored(RDC::OCC::Ax2d theA);
    void Rotate(RDC::OCC::Pnt2d theP, double theAng);
    /// <summary>
    /// Rotates a line. theP is the center of the rotation.
    /// theAng is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Rotated(RDC::OCC::Pnt2d theP, double theAng);
    void Scale(RDC::OCC::Pnt2d theP, double theS);
    /// <summary>
    /// Scales a line. theS is the scaling value. Only the
    /// origin of the line is modified.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Scaled(RDC::OCC::Pnt2d theP, double theS);
    void Transform(RDC::OCC::Trsf2d theT);
    /// <summary>
    /// Transforms a line with the transformation theT from class Trsf2d.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Transformed(RDC::OCC::Trsf2d theT);
    void Translate(RDC::OCC::Vec2d theV);
    /// <summary>
    /// Translates a line in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Translated(RDC::OCC::Vec2d theV);
    void Translate(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
    /// <summary>
    /// Translates a line from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Lin2d^ Translated(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
}; // class gp_Lin2d
...
public ref class gp_Parab sealed
    : public RDC::OCC::BaseClass<::gp_Parab>
{
...
public:
    gp_Parab(::gp_Parab* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Parab>( nativeInstance, true )
    {}

    gp_Parab(::gp_Parab& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Parab>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Parab(RDC::OCC::Ax2 theA2, double theFocal);
    /// <summary>
    ...
    /// YAxis.
    /// </summary>
    gp_Parab(RDC::OCC::Ax1 theD, RDC::OCC::Pnt theF);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Parab^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    /// Performs the symmetrical transformation of a parabola
    ...
    /// the symmetry.
    /// </summary>
    RDC::OCC::gp_Parab^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
    /// Performs the symmetrical transformation of a parabola
    ...
    /// </summary>
    RDC::OCC::gp_Parab^ Mirrored(RDC::OCC::Ax2 theA2);
    void Rotate(RDC::OCC::Ax1 theA1, double theAng);
    /// <summary>
    /// Rotates a parabola. theA1 is the axis of the rotation.
    /// Ang is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Parab^ Rotated(RDC::OCC::Ax1 theA1, double theAng);
    void Scale(RDC::OCC::Pnt theP, double theS);
    /// <summary>
    ...
    /// </summary>
    RDC::OCC::gp_Parab^ Scaled(RDC::OCC::Pnt theP, double theS);
    void Transform(RDC::OCC::Trsf theT);
    /// <summary>
    /// Transforms a parabola with the transformation theT from class Trsf.
    /// </summary>
    RDC::OCC::gp_Parab^ Transformed(RDC::OCC::Trsf theT);
    void Translate(RDC::OCC::Vec theV);
    /// <summary>
    /// Translates a parabola in the direction of the vector theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Parab^ Translated(RDC::OCC::Vec theV);
    void Translate(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
    /// <summary>
    /// Translates a parabola from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Parab^ Translated(RDC::OCC::Pnt theP1, RDC::OCC::Pnt theP2);
}; // class gp_Parab
...
public ref class gp_Parab2d sealed
    : public RDC::OCC::BaseClass<::gp_Parab2d>
{
...
public:
    gp_Parab2d(::gp_Parab2d* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Parab2d>( nativeInstance, true )
    {}

    gp_Parab2d(::gp_Parab2d& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Parab2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Parab2d(RDC::OCC::Ax2d theMirrorAxis, double theFocalLength, bool theSense);
    /// <summary>
    /// Creates a parabola with its vertex point, its axis of symmetry
    /// ("XAxis") and its focal length.
    /// The sense of parametrization is given by theSense. If theSense == TRUE
    ...
    /// Raises ConstructionError if FocalLength < 0.0
    /// </summary>
    gp_Parab2d(RDC::OCC::Ax2d theMirrorAxis, double theFocalLength);
    /// <summary>
    /// Creates a parabola with its vertex point, its axis of symmetry
    ...
    /// </summary>
    gp_Parab2d(RDC::OCC::Ax22d theAxes, double theFocalLength);
    /// <summary>
    ...
    /// </summary>
    gp_Parab2d(RDC::OCC::Ax2d theDirectrix, RDC::OCC::Pnt2d theFocus, bool theSense);
    /// <summary>
    /// Creates a parabola with the directrix and the focus point.
    /// Y-axis of the parabola (in User Coordinate System - UCS) is
    /// the direction of theDirectrix. X-axis always directs from theDirectrix
    ...
    /// like a line, which is perpendicular to the directrix.
    /// </summary>
    gp_Parab2d(RDC::OCC::Ax2d theDirectrix, RDC::OCC::Pnt2d theFocus);
    /// <summary>
    /// Changes the focal distance of the parabola
    ...
    /// </summary>
    void SetMirrorAxis(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Changes the local coordinate system of the parabola.
    ...
    /// to the point theP which is the center of the symmetry
    /// </summary>
    RDC::OCC::gp_Parab2d^ Mirrored(RDC::OCC::Pnt2d theP);
    void Mirror(RDC::OCC::Ax2d theA);
    /// <summary>
    /// Performs the symmetrical transformation of a parabola with respect
    /// to an axis placement which is the axis of the symmetry.
    /// </summary>
    RDC::OCC::gp_Parab2d^ Mirrored(RDC::OCC::Ax2d theA);
    void Rotate(RDC::OCC::Pnt2d theP, double theAng);
    /// <summary>
    /// Rotates a parabola. theP is the center of the rotation.
    /// theAng is the angular value of the rotation in radians.
    /// </summary>
    RDC::OCC::gp_Parab2d^ Rotated(RDC::OCC::Pnt2d theP, double theAng);
    void Scale(RDC::OCC::Pnt2d theP, double theS);
    /// <summary>
    /// Scales a parabola. theS is the scaling value.
    /// If theS is negative the direction of the symmetry axis
    /// "XAxis" is reversed and the direction of the "YAxis" too.
    /// </summary>
    RDC::OCC::gp_Parab2d^ Scaled(RDC::OCC::Pnt2d theP, double theS);
    void Transform(RDC::OCC::Trsf2d theT);
    /// <summary>
    /// Transforms an parabola with the transformation theT from class Trsf2d.
    /// </summary>
    RDC::OCC::gp_Parab2d^ Transformed(RDC::OCC::Trsf2d theT);
    void Translate(RDC::OCC::Vec2d theV);
    /// <summary>
    /// Translates a parabola in the direction of the vectorthe theV.
    /// The magnitude of the translation is the vector's magnitude.
    /// </summary>
    RDC::OCC::gp_Parab2d^ Translated(RDC::OCC::Vec2d theV);
    void Translate(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
    /// <summary>
    /// Translates a parabola from the point theP1 to the point theP2.
    /// </summary>
    RDC::OCC::gp_Parab2d^ Translated(RDC::OCC::Pnt2d theP1, RDC::OCC::Pnt2d theP2);
}; // class gp_Parab2d
...
public ref class gp_QuaternionNLerp sealed
    : public RDC::OCC::BaseClass<::gp_QuaternionNLerp>
{
...
public:
    gp_QuaternionNLerp(::gp_QuaternionNLerp* nativeInstance)
        : RDC::OCC::BaseClass<::gp_QuaternionNLerp>( nativeInstance, true )
    {}

    gp_QuaternionNLerp(::gp_QuaternionNLerp& nativeInstance)
        : RDC::OCC::BaseClass<::gp_QuaternionNLerp>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_QuaternionNLerp(RDC::OCC::Quaternion theQStart, RDC::OCC::Quaternion theQEnd);
    /// <summary>
    ...
    /// </param>
    static RDC::OCC::Quaternion Interpolate(RDC::OCC::Quaternion theQStart, RDC::OCC::Quaternion theQEnd, double theT);
    /// <summary>
    /// Initialize the tool with Start and End values.
    /// </summary>
    void Init(RDC::OCC::Quaternion theQStart, RDC::OCC::Quaternion theQEnd);
    /// <summary>
    /// Initialize the tool with Start and End unit quaternions.
    /// </summary>
    void InitFromUnit(RDC::OCC::Quaternion theQStart, RDC::OCC::Quaternion theQEnd);
    /// <summary>
    /// Set interpolated quaternion for theT position (from 0.0 to 1.0)
    /// </summary>
    void Interpolate(double theT, RDC::OCC::Quaternion% theResultQ);
}; // class gp_QuaternionNLerp
...
public ref class gp_QuaternionSLerp sealed
    : public RDC::OCC::BaseClass<::gp_QuaternionSLerp>
{
...
public:
    gp_QuaternionSLerp(::gp_QuaternionSLerp* nativeInstance)
        : RDC::OCC::BaseClass<::gp_QuaternionSLerp>( nativeInstance, true )
    {}

    gp_QuaternionSLerp(::gp_QuaternionSLerp& nativeInstance)
        : RDC::OCC::BaseClass<::gp_QuaternionSLerp>( &nativeInstance, false )
    {}
...
public:
    ...
    /// Constructor with initialization.
    /// </summary>
    gp_QuaternionSLerp(RDC::OCC::Quaternion theQStart, RDC::OCC::Quaternion theQEnd);
    /// <summary>
    /// Compute interpolated quaternion between two quaternions.
    /// </summary>
    /// <param name="theStart">
...
public ref class gp_Sphere sealed
    : public RDC::OCC::BaseClass<::gp_Sphere>
{
...
public:
    gp_Sphere(::gp_Sphere* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Sphere>( nativeInstance, true )
    {}

    gp_Sphere(::gp_Sphere& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Sphere>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Sphere(RDC::OCC::Ax3 theA3, double theRadius);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Sphere^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Sphere^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
...
public ref class gp_Torus sealed
    : public RDC::OCC::BaseClass<::gp_Torus>
{
...
public:
    gp_Torus(::gp_Torus* nativeInstance)
        : RDC::OCC::BaseClass<::gp_Torus>( nativeInstance, true )
    {}

    gp_Torus(::gp_Torus& nativeInstance)
        : RDC::OCC::BaseClass<::gp_Torus>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    gp_Torus(RDC::OCC::Ax3 theA3, double theMajorRadius, double theMinorRadius);
    /// <summary>
    ...
    void Coefficients(RDC::OCC::TColStd_Array1OfReal^ theCoef);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Torus^ Mirrored(RDC::OCC::Pnt theP);
    void Mirror(RDC::OCC::Ax1 theA1);
    /// <summary>
    ...
    /// symmetry.
    /// </summary>
    RDC::OCC::gp_Torus^ Mirrored(RDC::OCC::Ax1 theA1);
    void Mirror(RDC::OCC::Ax2 theA2);
    /// <summary>
