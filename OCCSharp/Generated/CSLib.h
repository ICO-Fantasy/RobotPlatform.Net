...
public ref class CSLib sealed
    : public RDC::OCC::BaseClass<::CSLib>
{
...
public:
    CSLib(::CSLib* nativeInstance)
        : RDC::OCC::BaseClass<::CSLib>( nativeInstance, true )
    {}

    CSLib(::CSLib& nativeInstance)
        : RDC::OCC::BaseClass<::CSLib>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    static void Normal(RDC::OCC::Vec D1U, RDC::OCC::Vec D1V, double SinTol, RDC::OCC::CSLib_DerivativeStatus% theStatus, RDC::OCC::Dir% Normal);
    /// <summary>
    ...
    /// </summary>
    static void Normal(RDC::OCC::Vec D1U, RDC::OCC::Vec D1V, RDC::OCC::Vec D2U, RDC::OCC::Vec D2V, RDC::OCC::Vec D2UV, double SinTol, bool% Done, RDC::OCC::CSLib_NormalStatus% theStatus, RDC::OCC::Dir% Normal);
    /// <summary>
    /// Computes the normal direction of a surface as the cross product
    /// between D1U and D1V.
    /// </summary>
    static void Normal(RDC::OCC::Vec D1U, RDC::OCC::Vec D1V, double MagTol, RDC::OCC::CSLib_NormalStatus% theStatus, RDC::OCC::Dir% Normal);
    /// <summary>
    ...
    /// </summary>
    static void Normal(int MaxOrder, RDC::OCC::TColgp_Array2OfVec^ DerNUV, double MagTol, double U, double V, double Umin, double Umax, double Vmin, double Vmax, RDC::OCC::CSLib_NormalStatus% theStatus, RDC::OCC::Dir% Normal, int% OrderU, int% OrderV);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Vec DNNUV(int Nu, int Nv, RDC::OCC::TColgp_Array2OfVec^ DerSurf);
    /// <summary>
    ...
    /// </summary>
    static RDC::OCC::Vec DNNUV(int Nu, int Nv, RDC::OCC::TColgp_Array2OfVec^ DerSurf1, RDC::OCC::TColgp_Array2OfVec^ DerSurf2);
    /// <summary>
    /// -- Computes the derivative  of order Nu in the --
    ...
    /// </summary>
    static RDC::OCC::Vec DNNormal(int Nu, int Nv, RDC::OCC::TColgp_Array2OfVec^ DerNUV, int Iduref, int Idvref);
    /// <summary>
    /// -- Computes the derivative  of order Nu in the --
    /// direction   U and  Nv in the  direction  V  of the
    /// normalized normal vector  at the point P(U,V) array
    ...
    /// In the regular cases , Iduref=Idvref=0.
    /// </summary>
    static RDC::OCC::Vec DNNormal(int Nu, int Nv, RDC::OCC::TColgp_Array2OfVec^ DerNUV, int Iduref);
    /// <summary>
    /// -- Computes the derivative  of order Nu in the --
    /// direction   U and  Nv in the  direction  V  of the
    /// normalized normal vector  at the point P(U,V) array
    ...
    /// In the regular cases , Iduref=Idvref=0.
    /// </summary>
    static RDC::OCC::Vec DNNormal(int Nu, int Nv, RDC::OCC::TColgp_Array2OfVec^ DerNUV);
}; // class CSLib
...
public ref class CSLib_Class2d sealed
    : public RDC::OCC::BaseClass<::CSLib_Class2d>
{
...
public:
    CSLib_Class2d(::CSLib_Class2d* nativeInstance)
        : RDC::OCC::BaseClass<::CSLib_Class2d>( nativeInstance, true )
    {}

    CSLib_Class2d(::CSLib_Class2d& nativeInstance)
        : RDC::OCC::BaseClass<::CSLib_Class2d>( &nativeInstance, false )
    {}
...
public:
    ...
    /// </summary>
    CSLib_Class2d(RDC::OCC::TColgp_Array1OfPnt2d^ thePnts2d, double theTolU, double theTolV, double theUMin, double theVMin, double theUMax, double theVMax);
    /// <summary>
    /// Constructs the 2D-polygon.
    /// thePnts2d is the set of the vertices (closed polygon
    /// will always be created inside of this constructor;
    ...
    /// UV-bounds of the polygon.
    /// </summary>
    CSLib_Class2d(RDC::OCC::TColgp_SequenceOfPnt2d^ thePnts2d, double theTolU, double theTolV, double theUMin, double theVMin, double theUMax, double theVMax);
    int SiDans(RDC::OCC::Pnt2d P);
    int SiDans_OnMode(RDC::OCC::Pnt2d P, double Tol);
